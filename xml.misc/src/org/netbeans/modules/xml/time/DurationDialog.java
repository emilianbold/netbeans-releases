...
public final class DurationDialog extends AbstractDialog {
    ...
    public DurationDialog(String value) {
        super(value, i18n(DurationDialog.class, "LBL_Duration"), i18n(DurationDialog.class, "ACS_Duration")); // NOI18N
    }

    @Override
    protected Time parseValue(String value) {
        return TimeUtil.parseDuration(value, true, false);
    }

    @Override
    protected String createValue(Object year, Object month, Object day, Object hour, Object minute, Object second) {
        return TimeUtil.getForValue(year, month, day, hour, minute, second, myNegative.isSelected());
    }

    @Override
    protected void createComponent(JPanel panel, GridBagConstraints c) {
        myNegative = createCheckBox(
            new ButtonAction(i18n(DurationDialog.class, "LBL_Negative")) { // NOI18N
                public void actionPerformed(ActionEvent event) {}
            }
        );
        c.gridwidth = 2 + 2 + 2;
        panel.add(myNegative, c);
    }

    @Override
    protected void setTime(Time time) {
        if (time instanceof Duration) {
            myNegative.setSelected(((Duration) time).isNegative());
        }
    }
