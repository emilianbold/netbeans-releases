...
public final class ServerRegistry {
    ...
    public static synchronized ServerRegistry getInstance() {
        if (registry == null) {
            ...
            registry.result.addLookupListener(new ProviderLookupListener(registry));
        }
        return registry;
    }
    ...
    protected final void fireRegistryChanged() {
    ...
    private static class ProviderLookupListener implements LookupListener {
        ...
        public ProviderLookupListener(ServerRegistry registry) {
            this.registry = registry;
        }

        public void resultChanged(LookupEvent ev) {
            registry.fireRegistryChanged();
        }
