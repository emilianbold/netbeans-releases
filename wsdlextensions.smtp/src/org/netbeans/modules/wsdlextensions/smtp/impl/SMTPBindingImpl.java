 ...
 *
 */
public class SMTPBindingImpl extends SMTPComponentImpl implements SMTPBinding {
    public SMTPBindingImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
    public SMTPBindingImpl(WSDLModel model){
        this(model, createPrefixedElement(SMTPQName.BINDING.getQName(), model));
    }
