...
public class CalendarConverterTest extends NbTestCase {
     ...
     */
    public CalendarConverterTest(String testName) {
        super(testName);
    }
    ...
    public static NbTestSuite suite() {
        ...
        suite.addTest(new CalendarConverterTest("test1"));
        suite.addTest(new CalendarConverterTest("test2"));
        return suite;
    }
    ...
    public void setUp() {
        ...
        calendarConverter1 = new CalendarConverter();
    }

    /** Called after every test case. */
    public void tearDown() {
        calendarConverter1 = null;
    }
