...
public class THAMetric {

    public static final FunctionMetric DeadlockMetric = fm("e.deadlocks", Integer.class); // NOI18N
    public static final FunctionMetric RaceMetric = fm("e.raccess", Integer.class); // NOI18N
    ...
    static private FunctionMetric fm(String id, Class clazz) {
        return FunctionMetricsFactory.getInstance().getFunctionMetric(
                ...
                NbBundle.getMessage(THAMetric.class,
                "THAMetric." + id + ".uname"), clazz)); // NOI18N
    }
}
