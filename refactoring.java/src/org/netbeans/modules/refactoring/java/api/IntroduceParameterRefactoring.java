...
public final class IntroduceParameterRefactoring extends AbstractRefactoring {
     ...
     *
     * @param expression  refactored expression
     */
    public IntroduceParameterRefactoring(TreePathHandle expression) {
        super(Lookups.singleton(expression));
    }

    /**
     * introduces new method with new parameter, existing methods delegates to it:
     * e.g.
     * <pre>
     * int originalfoo() {
     *   return 1+1;
     * }
     * </pre>
     * if "1+1" is selected, code is converted to 
     * <pre>
     * int originalfoo() {
     *    return foo(1+1);
     * }
