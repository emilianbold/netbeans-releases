...
/** Action that invokes Move Inner to Outer Level refactoring.
 *
 * @author Jan Becicka
 */
...
public class InnerToOuterAction extends JavaRefactoringGlobalAction {
     ...
     */
    public InnerToOuterAction() {
        super(NbBundle.getMessage(ChangeParametersAction.class, "LBL_InnerToOuter_Action"), null); // NOI18N
