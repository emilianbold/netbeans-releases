...
public class PushDownRefactoringUI implements RefactoringUI {
    ...
    public CustomRefactoringPanel getPanel(ChangeListener parent) {
        if (panel == null) {
            panel = new PushDownPanel(refactoring, initialMembers);
        }
        return panel;
    }
    ...
    public String getDescription() {
        return NbBundle.getMessage(PushDownRefactoringUI.class, "DSC_PushDown", /*TODO: sourceType.getName()*/ "TODO"); // NOI18N
    }
