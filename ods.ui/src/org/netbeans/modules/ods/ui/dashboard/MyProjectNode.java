    ...
    protected JComponent getComponent(Color foreground, Color background, boolean isSelected, boolean hasFocus) {
        synchronized( LOCK ) {
            if( null == component ) {
                ...
                btnOpen = new LinkButton(ImageUtilities.loadImageIcon("org/netbeans/modules/ods/ui/resources/open.png", true), getOpenAction()); //NOI18N
                ...
                btnOpen.setRolloverIcon(ImageUtilities.loadImageIcon("org/netbeans/modules/ods/ui/resources/open_over.png", true)); // NOI18N
    ...
    private void setBugsLater(final QueryResultHandle bug) {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                btnBugs = new LinkButton(bug.getText(), ImageUtilities.loadImageIcon("org/netbeans/modules/ods/ui/resources/bug.png", true), qaccessor.getOpenQueryResultAction(bug)); // NOI18N
