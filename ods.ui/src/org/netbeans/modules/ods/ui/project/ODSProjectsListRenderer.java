...
/**
 * Renderer for list item to show found ODS project
 *
 * @author Milan Kubec
 * @author jpeska
 */
public class ODSProjectsListRenderer extends javax.swing.JPanel {

    private URL url;

    public ODSProjectsListRenderer(JList jlist, Object value, int index, boolean isSelected, boolean cellHasFocus) {

        initComponents();

        ODSSearchPanel.ODSProjectSearchInfo searchInfo = (ODSSearchPanel.ODSProjectSearchInfo) value;

        projectNameLabel.setText("<html><b>" + searchInfo.odsProject.getName() + // NOI18N
                " (" + searchInfo.odsProject.getId() + ")</b></html>"); // NOI18N
        String description = searchInfo.odsProject.getDescription();
        ...
        if (description.isEmpty()) {
            ...
            projectDescLabel.setText(NbBundle.getMessage(ODSProjectsListRenderer.class, "LBL_NoDescription"));
        } else {
            projectDescLabel.setText(description);
            projectDescLabel.setRows(searchInfo.odsProject.getDescription().length() / 100 + 1);
        }
        if (isSelected) {
        ...
        try {
            this.url = new URL(searchInfo.odsProject.getWebUrl());
    ...
    private void initComponents() {
        ...
        detailsButton = new LinkButton(NbBundle.getMessage(ODSProjectsListRenderer.class, "ODSProjectsListRenderer.detailsLabel.text"), new URLDisplayer());
        ...
        projectNameLabel.setText(NbBundle.getMessage(ODSProjectsListRenderer.class, "ODSProjectsListRenderer.projectNameLabel.text")); // NOI18N
