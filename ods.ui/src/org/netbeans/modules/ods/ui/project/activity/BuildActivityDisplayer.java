...
public class BuildActivityDisplayer extends ActivityDisplayer {
    ...
    public Icon getActivityIcon() {
        ...
        Icon icon = ImageUtilities.loadImageIcon("org/netbeans/modules/ods/ui/resources/activity_build_" + iconSuffix + ".png", true); //NOI18N
        if (icon == null) {
            icon = ImageUtilities.loadImageIcon("org/netbeans/modules/ods/ui/resources/activity_build_unknown.png", true); //NOI18N
        }
        return icon;
    }
