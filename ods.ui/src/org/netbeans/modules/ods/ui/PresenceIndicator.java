...
public class PresenceIndicator {
    private static final String ICON_LOGGED_IN = "org/netbeans/modules/ods/ui/resources/ods.png"; //NOI18N
    ...
    private class MouseL extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent event) {
            if (isLoggedIn()) {
                ...
                for (final CloudServer k: CloudServerManager.getDefault().getServers()) {
                    if (!k.isLoggedIn()) {
                        continue;
                    }
