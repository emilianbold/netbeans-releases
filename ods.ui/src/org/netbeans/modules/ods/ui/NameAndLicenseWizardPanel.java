...
public class NameAndLicenseWizardPanel implements WizardDescriptor.Panel,
    ...
    public NameAndLicenseWizardPanel (NewProjectWizardIterator iter, List<SharedItem> items) {
    ...
    public HelpCtx getHelp () {
        return new HelpCtx("org.netbeans.modules.ods.ui.NameAndLicenseWizardPanel"); //NOI18N
    }
    ...
    void setServer (CloudServer server) {
        iter.setServer(server);
    }
}
