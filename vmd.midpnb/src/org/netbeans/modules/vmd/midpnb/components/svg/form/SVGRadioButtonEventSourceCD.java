...
import org.netbeans.modules.vmd.midpnb.screen.display.SVGRadioButtonDisplayPresenter;
...
public class SVGRadioButtonEventSourceCD extends SVGComponentEventSourceCD {
    ...
    public static final TypeID TYPEID = new TypeID(TypeID.Kind.COMPONENT, 
            "#SVGRadioButtonEventEventSource"); // NOI18
    
    private static final String ICON_PATH = 
        "org/netbeans/modules/mobility/svgcore/resources/palette/form/radio_button_16.png"; // NOI18N                                                
    ...
    protected TypeID getPairTypeId() {
        return SVGRadioButtonCD.TYPEID;
    }
    /* (non-Javadoc)
    ...
    protected List<? extends Presenter> createPresenters() {
        ...
        result.add( new SVGRadioButtonDisplayPresenter() );
        return result;
    }
