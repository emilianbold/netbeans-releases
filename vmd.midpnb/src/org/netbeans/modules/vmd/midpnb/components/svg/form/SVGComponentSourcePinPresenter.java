...
class SVGComponentSourcePinPresenter extends FlowEventSourcePinPresenter {
    ...
    protected String getDisplayName() {
        return SVGComponentEventSourceCD.getInstanceName(getComponent());
    }
    ...
    protected void setRenameName(String name) {
        DesignComponent button = getComponent().readProperty(SVGComponentEventSourceCD.PROP_SVGCOMPONENT).getComponent();
