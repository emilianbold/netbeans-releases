...
public final class PIMBrowserOpenCommandCD extends ComponentDescriptor {

    public static final TypeID TYPEID = new TypeID(TypeID.Kind.COMPONENT, "#PIMBrowserOpenCommand"); // NOI18N
    ...
    public void postInitialize(DesignComponent component) {
        component.writeProperty(CommandCD.PROP_LABEL, MidpTypes.createStringValue("Open")); // NOI18N
    ...
    protected List<? extends Presenter> createPresenters() {
        return Arrays.asList(
            ...
            new CodeReferencePresenter() {
                ...
                protected String generateDirectAccessCode() { return "PIMBrowser.SELECT_PIM_ITEM"; } // NOI18N
