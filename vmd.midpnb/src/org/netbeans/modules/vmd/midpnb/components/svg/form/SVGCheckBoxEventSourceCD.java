...
import org.netbeans.modules.vmd.midpnb.screen.display.SVGCheckBoxDisplayPresenter;
 ...
 * @author ads
 */
public class SVGCheckBoxEventSourceCD extends SVGComponentEventSourceCD {

    public static final TypeID TYPEID = new TypeID(TypeID.Kind.COMPONENT, 
            "#SVGCheckBoxEventEventSource"); // NOI18
    
    private static final String ICON_PATH = 
        "org/netbeans/modules/mobility/svgcore/resources/palette/form/check_box_16.png"; // NOI18N                                                
    private static final Image ICON_SVG_CHECKBOX = ImageUtilities.loadImage(ICON_PATH);
    ...
    protected List<? extends Presenter> createPresenters() {
        ...
        result.add(new SVGCheckBoxDisplayPresenter());
        return result;
    }
