 ...
 */
public class SVGSplashScreenDismissCommandCD extends ComponentDescriptor {
    
    public static final TypeID TYPEID = new TypeID(TypeID.Kind.COMPONENT, "#SVGSplashScreenDismissCommand"); // NOI18N

    public TypeDescriptor getTypeDescriptor() {
        return new TypeDescriptor(CommandCD.TYPEID, SVGSplashScreenDismissCommandCD.TYPEID, true, true);
    }
    ...
    protected List<? extends Presenter> createPresenters() {
        return Arrays.asList(
            // general
            InfoPresenter.createStatic("DISMISS_COMMAND", "Command", "SVGSplashScreen.DISMISS_COMMAND", CommandCD.ICON_PATH), // NOI18N
            // code
            new CodeReferencePresenter() {
                protected String generateAccessCode() { return generateDirectAccessCode(); }
                protected String generateDirectAccessCode() { return "SVGSplashScreen.DISMISS_COMMAND"; } // NOI18N
