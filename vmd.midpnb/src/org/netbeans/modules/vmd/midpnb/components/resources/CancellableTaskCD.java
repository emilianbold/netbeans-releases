 ...
 */
public class CancellableTaskCD extends ComponentDescriptor {

    public static final TypeID TYPEID = new TypeID(TypeID.Kind.COMPONENT, "org.netbeans.microedition.util.CancellableTask"); // NOI18N
    ...
    public void postInitialize(DesignComponent component) {
        component.writeProperty (ClassCD.PROP_INSTANCE_NAME, InstanceNameResolver.createFromSuggested (component, "task")); // NOI18N
