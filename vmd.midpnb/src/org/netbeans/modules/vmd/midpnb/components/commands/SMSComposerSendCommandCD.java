...
public final class SMSComposerSendCommandCD extends ComponentDescriptor {
    ...
    public static final TypeID TYPEID = new TypeID(TypeID.Kind.COMPONENT, "#SMSComposerSendCommand"); // NOI18N
    ...
    public void postInitialize(DesignComponent component) {
        component.writeProperty(CommandCD.PROP_LABEL, MidpTypes.createStringValue("Send")); // NOI18N
    ...
    protected List<? extends Presenter> createPresenters() {
        return Arrays.asList(
            ...
            new CodeReferencePresenter() {
                ...
                protected String generateDirectAccessCode() { return "SMSComposer.SEND_COMMAND"; } // NOI18N
