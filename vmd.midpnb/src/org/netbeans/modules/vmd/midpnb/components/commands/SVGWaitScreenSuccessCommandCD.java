...
public class SVGWaitScreenSuccessCommandCD extends ComponentDescriptor {
    ...
    public static final TypeID TYPEID = new TypeID(TypeID.Kind.COMPONENT, "#SVGWaitScreenSuccessCommand"); // NOI18N
    ...
    protected List<? extends Presenter> createPresenters() {
        return Arrays.asList(
            // general
            InfoPresenter.createStatic("SUCCESS_COMMAND", "Command", "SVGWaitScreen.SUCCESS_COMMAND", CommandCD.ICON_PATH), // NOI18N
            // code
            new CodeReferencePresenter() {
                protected String generateAccessCode() { return generateDirectAccessCode(); }
                protected String generateDirectAccessCode() { return "SVGWaitScreen.SUCCESS_COMMAND"; } // NOI18N
