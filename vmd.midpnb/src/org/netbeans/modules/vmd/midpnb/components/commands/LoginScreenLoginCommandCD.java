...
public final class LoginScreenLoginCommandCD extends ComponentDescriptor {

    public static final TypeID TYPEID = new TypeID(TypeID.Kind.COMPONENT, "#LoginScreenLoginCommand"); // NOI18N
    ...
    public void postInitialize(DesignComponent component) {
        component.writeProperty(CommandCD.PROP_LABEL, MidpTypes.createStringValue("Login")); // NOI18N
    ...
    protected List<? extends Presenter> createPresenters() {
        return Arrays.asList(
            ...
            new CodeReferencePresenter() {
                ...
                protected String generateDirectAccessCode() { return "LoginScreen.LOGIN_COMMAND"; } // NOI18N
