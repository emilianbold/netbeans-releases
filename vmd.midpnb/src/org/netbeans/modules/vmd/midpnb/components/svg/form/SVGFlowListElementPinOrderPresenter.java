...
public final class SVGFlowListElementPinOrderPresenter extends FlowPinOrderPresenter {
    ...
    public static final String CATEGORY_ID = "SVGListElement"; // NOI18N
    ...
    public String getCategoryDisplayName() {
        return NbBundle.getMessage(SVGFlowListElementPinOrderPresenter.class, "DISP_FlowCategory_SVGListElements"); // NOI18N
    }
    ...
    public List<FlowPinDescriptor> sortCategory(ArrayList<FlowPinDescriptor> descriptors) {
        ...
        for (DesignComponent child : getComponent().getComponents()) {
            if (child.getType() == SVGListCD.TYPEID) {
                List<PropertyValue> listElements = child.readProperty(SVGListCD.PROP_ELEMENTS).getArray();
