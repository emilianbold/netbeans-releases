...
public interface SourcePathImplementationCustomization {
    ...
    /**
     * Get classpath entries for given classpath roots.
     * @param roots classpath roots.
     * @param evaluator {@link AntProjectHelper} used for resolving files etc.
     * @return list of classpath entries.
     */
    List<PathResourceImplementation> getResources(URL[] roots, PropertyEvaluator evaluator);
}
