...
public enum CMReferenceKind {
  ...
  LastExtraDecl                 (ModuleImportDecl.value);
    ...
    public static CMReferenceKind valueOf(int val) {
        // FIXME: make constant
        short kindVal = (short) val;
        for (CMReferenceKind kind : CMReferenceKind.values()) {
    ...
    private CMReferenceKind(int val) {
