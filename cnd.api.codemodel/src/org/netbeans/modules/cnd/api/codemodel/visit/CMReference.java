...
public final class CMReference extends CMObject {
    ...
    private final CMReferenceImplementation impl;

    private CMReference(CMReferenceImplementation impl) {
        this.impl = impl;
    }

    /*package*/
    static CMReference fromImpl(CMReferenceImplementation impl) {
        return new CMReference(impl);
    }

    /*package*/
    static Iterable<CMReference> fromImpls(Iterable<CMReferenceImplementation> impls) {
        return IterableFactory.convert(impls, CONV);
    }

    /*package*/
    CMReferenceImplementation getImpl() {
        return impl;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CMReference) {
            return this.impl.equals(((CMReference) obj).impl);
        }
        return false;
    }
    ...
    private static final IterableFactory.Converter<CMReferenceImplementation, CMReference> CONV
            = new IterableFactory.Converter<CMReferenceImplementation, CMReference>() {

                @Override
                public CMReference convert(CMReferenceImplementation in) {
                    return fromImpl(in);
                }
            };
    //</editor-fold>
