 ...
 */
public final class CMCompletionResultList {
    private final CMCompletionResultListImplementation impl;

    /*package*/CMCompletionResultList(CMCompletionResultListImplementation impl) {
        this.impl = impl;
    }
     ...
     * container
     */
    public CMCursorKind getContextContainerKind() {
        return impl.getContextContainerKind();
    }
     ...
     */
    public CMUnifiedSymbolResolution getContextContainerUSR() {
        return impl.getContextContainerUSR();
    }
    
    public Iterable<CMCompletionResult> getItems() {
        return CMCompletionResult.fromImpls(impl.getItems());
    }
}
