 ...
 */
public final class CMStorage {
    private final CMStorageImplementation impl;

    /*package*/CMStorage(CMStorageImplementation impl) {
      this.impl = impl;
    }
  
    /*package*/CMStorageImplementation getImpl() {
        return impl;
    }

    public void addDeclaration(CMDeclaration declaration) {
      impl.addDeclaration(declaration);
    }

    public void addEntityReference(CMEntityReference reference) {
      impl.addEntityReference(reference);
    }

    public void addInclude(CMInclude include) {
      impl.addInclude(include);
    }
