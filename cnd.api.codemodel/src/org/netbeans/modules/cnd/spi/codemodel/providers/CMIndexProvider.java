 ...
 */
public abstract class CMIndexProvider {

    public static final String PATH = "CND/CMIndexProvider";

    public boolean canCreate(CMCompilationDataBase db) {
        return canCreate(db.getEntries());
    }

    public abstract boolean canCreate(Collection<CMCompilationDataBase.Entry> entries);

    public CMIndexImplementation create(CMCompilationDataBase db) {
        return create(db.getEntries());
    }
