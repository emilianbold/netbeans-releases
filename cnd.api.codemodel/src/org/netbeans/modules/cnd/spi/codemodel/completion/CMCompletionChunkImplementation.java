...
import org.netbeans.modules.cnd.api.codemodel.completion.CMCompletionChunk.Kind;

/**
 * @see CMCompletionChunkKind documentation
 * @author Vladimir Voskresensky
 * @author Vladimir Kvashin
 */
public interface CMCompletionChunkImplementation {
     ...
     * chunk within a completion string.
     *
     * @return the chunk list associated with the chunk
     */
    Iterable<CMCompletionChunkImplementation> getEmbedded();

    boolean equals(CMCompletionChunkImplementation other);
