 ...
 */
public abstract class APICompletionAccessor {
    private static APICompletionAccessor INSTANCE;

    public static synchronized APICompletionAccessor get() {
        if (INSTANCE == null) {
            Class<?> c = CMCompletionQuery.class;
            try {
    ...
    public static synchronized void register(APICompletionAccessor accessor) {
        assert INSTANCE == null : "must be registered once " + INSTANCE;
        INSTANCE = accessor;
    }    

    public abstract CMCompletionResultList createCompletionResultList(CMCompletionResultListImplementation impl);

    public abstract CMCompletionResult createCompletionResult(CMCompletionResultImplementation impl);
    
    public abstract CMCompletionChunk createCompletionChunk(CMCompletionChunkImplementation impl);
}
