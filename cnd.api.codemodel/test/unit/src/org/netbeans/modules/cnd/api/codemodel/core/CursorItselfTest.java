 ...
 * @author petrk
 */
public class CursorItselfTest extends CoreTestBase<CMCursor, CoreUtils.PositionData> {
    
    public CursorItselfTest(String testName) {
        super(testName);
    }

    @Override
    protected CMCursor[] provide(CMTranslationUnit tu, URI sourceFile, CoreUtils.PositionData data) {
    ...
    public void testCursors_1() throws Exception {
        performTest("cursors_test_1.cpp", new CoreUtils.PositionData(12, 10));
    }        
    
    public void testCursors_2() throws Exception {
        performTest("cursors_test_1.cpp", new CoreUtils.PositionData(9, 1));
    }
