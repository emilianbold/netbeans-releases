...
import org.netbeans.modules.cnd.api.codemodel.test.CMProjectBasedTestCase;
 ...
 * @author mtishkov
 */
public class CursorVisitorProjectTest extends CMProjectBasedTestCase {
    
    static {
        System.setProperty("cnd.codemodel.storage.trace", "true");
    ...
    public CursorVisitorProjectTest(String test) {
        super(test);
    }
    ...
    public void testIndexOnParseH2() throws Exception {
        doTestIndexProject("jdbc:h2", TEST_PROJECT, true, printOut, storeInDatabase);
    }
    ...
    public void doTestProject(String odbcUrl) throws Exception {
        ...
        final FileObject projectFileObject = FileUtil.toFileObject(file);

        ProjectData projectData = prepareProject(projectFileObject, odbcUrl);
