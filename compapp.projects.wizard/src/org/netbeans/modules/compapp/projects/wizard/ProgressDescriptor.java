...
/**
 * A description of a progress indicator.
 *
...
public interface ProgressDescriptor {
    /**
     * Get the graphical user interface component that is or contains the
     * visual progress indicator.
     */
    Component getGUIComponent();
    
    /**
     * Get a task/progress management object.
     */
    ProgressController getController();
}
