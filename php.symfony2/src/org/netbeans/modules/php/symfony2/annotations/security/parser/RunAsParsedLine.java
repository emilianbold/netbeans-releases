 ...
 */
public class RunAsParsedLine extends BaseParsedLine {

    public RunAsParsedLine(String description, Map<OffsetRange, String> types) {
        super(description, types);
    }

    @Override
    public String getName() {
        return RunAsLineParser.ANNOTATION_NAME;
    }
