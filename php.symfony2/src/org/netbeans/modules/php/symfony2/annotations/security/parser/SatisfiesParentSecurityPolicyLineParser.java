 ...
 */
class SatisfiesParentSecurityPolicyLineParser implements AnnotationLineParser {

    static final String ANNOTATION_NAME = "SatisfiesParentSecurityPolicy"; //NOI18N
    ...
    public AnnotationParsedLine parse(String line) {
        ...
        if (tokens.length > 0 && AnnotationUtils.isTypeAnnotation(tokens[0], ANNOTATION_NAME)) {
            ...
            result = new SatisfiesParentSecurityPolicyParsedLine(description, types);
        }
        return result;
    }
