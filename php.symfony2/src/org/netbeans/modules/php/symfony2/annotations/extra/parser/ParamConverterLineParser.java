 ...
 */
class ParamConverterLineParser implements AnnotationLineParser {

    static final String ANNOTATION_NAME = "ParamConverter"; //NOI18N
    ...
    public AnnotationParsedLine parse(String line) {
        ...
        if (tokens.length > 0 && AnnotationUtils.isTypeAnnotation(tokens[0], ANNOTATION_NAME)) {
            ...
            result = new ParamConverterParsedLine(description, types);
        }
        return result;
    }
