 ...
 */
class SecureReturnLineParser implements AnnotationLineParser {

    static final String ANNOTATION_NAME = "SecureReturn"; //NOI18N
    ...
    public AnnotationParsedLine parse(final String line) {
        ...
        if (tokens.length > 0 && AnnotationUtils.isTypeAnnotation(tokens[0], ANNOTATION_NAME)) {
            ...
            result = new SecureReturnParsedLine(description, types);
        }
        return result;
    }
