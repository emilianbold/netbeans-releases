...
/**
 * Symfony2 run command action.
 */
public class Symfony2RunCommandAction extends RunCommandAction {

    private static final long serialVersionUID = -874654676213L;
    private static final Symfony2RunCommandAction INSTANCE = new Symfony2RunCommandAction();


    private Symfony2RunCommandAction() {
    }

    public static Symfony2RunCommandAction getInstance() {
        return INSTANCE;
    }
