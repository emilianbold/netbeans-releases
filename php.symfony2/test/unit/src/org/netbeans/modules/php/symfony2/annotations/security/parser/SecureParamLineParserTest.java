...
public class SecureParamLineParserTest extends NbTestCase {
    private SecureParamLineParser parser;
    ...
    protected void setUp() throws Exception {
        super.setUp();
        this.parser = new SecureParamLineParser();
    }
    ...
    public void testReturnValueIsSecureParamParsedLine_01() throws Exception {
        assertTrue(parser.parse("SecureParam") instanceof SecureParamParsedLine);
    }

    public void testReturnValueIsSecureParamParsedLine_02() throws Exception {
        assertTrue(parser.parse("Annotations\\SecureParam") instanceof SecureParamParsedLine);
    }

    public void testReturnValueIsSecureParamParsedLine_03() throws Exception {
        assertTrue(parser.parse("\\Sensio\\Bundle\\FrameworkExtraBundle\\Configuration\\SecureParam") instanceof SecureParamParsedLine);
    }

    public void testReturnValueIsSecureParamParsedLine_04() throws Exception {
        assertTrue(parser.parse("Annotations\\SecureParam(name=\"comment\", permissions=\"EDIT, DELETE\")") instanceof SecureParamParsedLine);
    }
    ...
    public void testValidUseCase_01() throws Exception {
        ...
        assertEquals(SecureParamLineParser.ANNOTATION_NAME, parsedLine.getName());
