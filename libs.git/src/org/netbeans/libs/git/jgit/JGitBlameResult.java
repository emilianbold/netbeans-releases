 ...
 * @author ondra
 */
public class JGitBlameResult implements GitBlameResult {

    private final File blamedFile;
    private final int lineCount;
    private GitLineDetails[] lineDetails;

    public JGitBlameResult (BlameResult result, Repository repository) {
        ...
        for (int i = 0; i < lineCount; ++i) {
            ...
            if (commit == null) {
                ...
                if (revInfo == null) {
                    revInfo = new JGitRevisionInfo(commit, repository);
