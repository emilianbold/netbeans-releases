 ...
 * @author ondra
 */
public class JGitRevertResult implements GitRevertResult {
    private Status status;
    private GitRevisionInfo revertCommit;

    public static final GitRevertResult NO_CHANGE_INSTANCE = new JGitRevertResult (Status.NO_CHANGE, null, null, null);
    private final List<File> conflicts;
    private final List<File> failures;

    public JGitRevertResult (Status status, GitRevisionInfo commit, List<File> conflicts, List<File> failures) {
        this.status = status;
