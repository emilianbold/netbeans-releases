 ...
 * @author ondra
 */
public final class ODCSClientImpl implements ODCSClient {
    ...
    @Override
    public Project getProjectById (final String projectId) throws ODCSException {
    ...
    @Override
    public boolean isWatchingProject (final String projectId) throws ODCSException {
    ...
    @Override
    public List<Project> searchProjects (final String pattern) throws ODCSException {
        return run(new Callable<List<Project>> () {
            @Override
            public List<Project> call () throws Exception {
    ...
    @Override
    public void unwatchProject (final String projectId) throws ODCSException {
    ...
    @Override
    public void watchProject (final String projectId) throws ODCSException {
        run(new Callable<Void> () {
            @Override
            public Void call () throws Exception {
    ...
    @Override
    public List<ProjectActivity> getRecentActivities (final String projectId) throws ODCSException {
    ...
    @Override
    public List<ProjectActivity> getRecentShortActivities (final String projectId) throws ODCSException {
        return run(new Callable<List<ProjectActivity>> () {
            @Override
            public List<ProjectActivity> call () throws Exception {
    ...
    @Override
    public Project createProject (final Project project) throws ODCSException {
        return run(new Callable<Project> () {
            @Override
            public Project call () throws Exception {
    ...
    @Override
    public SavedTaskQuery createQuery(String projectId, final SavedTaskQuery query) throws ODCSException {
    ...
    @Override
    public SavedTaskQuery updateQuery(String projectId, final SavedTaskQuery query) throws ODCSException {
        return run(new Callable<SavedTaskQuery> () {
            @Override
            public SavedTaskQuery call () throws Exception {
    ...
    @Override
    public void deleteQuery(String projectId, final Integer queryId) throws ODCSException {
        run(new Callable<Void> () {
            @Override
            public Void call () throws Exception {
