...
@OptionsPanelController.Keywords(keywords={"php phpdoc phpdocumentor", "#PhpDocOptionsPanel.keywords.documentation"}, location=UiUtils.OPTIONS_PATH, tabTitle= "#LBL_OptionsName")
