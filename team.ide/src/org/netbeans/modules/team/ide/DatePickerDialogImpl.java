 ...
 * @author jpeska
 */
public class DatePickerDialogImpl extends javax.swing.JPanel implements IDEServices.DatePickerDialog{

    /**
     * Creates new form DatePickerDialogImpl
     */
    public DatePickerDialogImpl(Date schedule) {
        initComponents();
        if (schedule == null) {
            schedule = new Date();
        }
        monthView.setTraversable(true);
        monthView.setSelectionDate(schedule);
    }
