...
public class MoveRefactoringPlugin extends JsRefactoringPlugin {
    ...
    public Problem preCheck() {
        ...
        for (FileObject file:filesToMove) {
            if (!RetoucheUtils.isElementInOpenProject(file)) {
                preCheckProblem = createProblem(preCheckProblem, true, NbBundle.getMessage(JsRefactoringPlugin.class, "ERR_ProjectNotOpened"));
            }
        }
