...
public class MoveClassUI implements RefactoringUI, RefactoringUIBypass {
    ...
    public MoveClassUI (DataObject javaObject) {
        this(javaObject, null, null, Collections.<JsElementCtx>emptyList());
    }
    
    public MoveClassUI (DataObject javaObject, FileObject targetFolder, PasteType pasteType, Collection<JsElementCtx> handles) {
