...
/**
 * 
 * JsRefactoringGlobalAction
 * This class is copy of RefactoringGlobalAction, which is not in public packages
 * @author Jan Becicka
 */
public abstract class JsRefactoringGlobalAction extends NodeAction {

    /** Creates a new JsRefactoringGlobalActiongGlobalAction */
    public JsRefactoringGlobalAction(String name, Icon icon) {
        setName(name);
        setIcon(icon);
    }
    ...
    public class ContextAction implements Action, Presenter.Menu, Presenter.Popup, Presenter.Toolbar {
        ...
        public Object getValue(String arg0) {
            return JsRefactoringGlobalAction.this.getValue(arg0);
        }
        
        public void putValue(String arg0, Object arg1) {
            JsRefactoringGlobalAction.this.putValue(arg0, arg1);
        }
        
        public void setEnabled(boolean arg0) {
            JsRefactoringGlobalAction.this.setEnabled(arg0);
        }
        ...
        public void addPropertyChangeListener(PropertyChangeListener arg0) {
            JsRefactoringGlobalAction.this.addPropertyChangeListener(arg0);
        }
        
        public void removePropertyChangeListener(PropertyChangeListener arg0) {
            JsRefactoringGlobalAction.this.removePropertyChangeListener(arg0);
        }
        
        public void actionPerformed(ActionEvent arg0) {
            JsRefactoringGlobalAction.this.performAction(context);
        }
        public JMenuItem getMenuPresenter() {
            if (isMethodOverridden(JsRefactoringGlobalAction.this, "getMenuPresenter")) { // NOI18N

                return JsRefactoringGlobalAction.this.getMenuPresenter();
            } else {
        ...
        public JMenuItem getPopupPresenter() {
            if (isMethodOverridden(JsRefactoringGlobalAction.this, "getPopupPresenter")) { // NOI18N

                return JsRefactoringGlobalAction.this.getPopupPresenter();
            } else {
        ...
        public Component getToolbarPresenter() {
            if (isMethodOverridden(JsRefactoringGlobalAction.this, "getToolbarPresenter")) { // NOI18N

                return JsRefactoringGlobalAction.this.getToolbarPresenter();
            } else {
