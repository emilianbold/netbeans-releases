...
public class RenameElExpressionReferencesRefactoringElement extends MarkupRefactoringElement {
    ...
    protected void doChange(Document document) {
    ...
    protected void initDisplayText() {
        displayText = MessageFormat.format(FacesRenameClassRefactoringPlugin.getString("LBL_RenameElExpressionReferences"), new Object[] {oldName, newName}); // NOI18N
    }
