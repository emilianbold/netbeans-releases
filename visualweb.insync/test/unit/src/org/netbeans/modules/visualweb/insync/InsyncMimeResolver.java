 ...
 */
public class InsyncMimeResolver extends MIMEResolver {

    public InsyncMimeResolver() {
        super();
    }
    ...
    public String findMIMEType(FileObject fo) {
        ...
        if (fo.getExt().equals("jsp") || fo.getExt().equals("jspf")) {
            return "text/x-jsp";
        } else if (fo.getExt().equals("java")) {
            return "text/x-java";
        } else if (fo.getExt().equals("xml")) {
