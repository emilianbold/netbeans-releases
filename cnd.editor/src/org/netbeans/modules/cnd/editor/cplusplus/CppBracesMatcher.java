...
/**
 * This is the org.netbeans.modules.editor.bracesmatching.LegacyEssMatcher
...
public class CppBracesMatcher implements BracesMatcher, BracesMatcherFactory {
    ...
    private CppBracesMatcher(MatcherContext context, ExtSyntaxSupport ess) {
    ...
    public int[] findOrigin() throws BadLocationException {
        ...
        return block == null ? null : new int[]{offset, offset + 1};
    }
    ...
    public BracesMatcher createMatcher(MatcherContext context) {
        ...
        if (d instanceof BaseDocument) {
            ...
            if (ss instanceof ExtSyntaxSupport && ss.getClass() != ExtSyntaxSupport.class) {
                return new CppBracesMatcher(context, (ExtSyntaxSupport) ss);
            }
        }
