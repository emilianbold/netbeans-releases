...
public class CCSyntax extends Syntax {
    ...
    protected CCSyntax(Language lang, TokenContextPath tokenPath) {
        tokenContextPath = tokenPath;
        this.lang = lang;
    }

    public CCSyntax() {
        this(Language.CPLUSPLUS, CCTokenContext.contextPath);
    }
...
// was commented in java                    return CCTokenContext.INCOMPLETE_CHAR_LITERAL;
                ...
                case ISI_SYS_INCLUDE:
                    switch (actChar) {
                        case '>':
                            ...
                            return ((offset - tokenOffset) <= 2) ? CCTokenContext.INCOMPLETE_SYS_INCLUDE : CCTokenContext.SYS_INCLUDE;
                        case '\n':
                ...
                case ISI_USR_INCLUDE:
                    switch (actChar) {
                        case '"':
                            ...
                            // check non-empty included file #include ""
                            return ((offset - tokenOffset) <= 2) ? CCTokenContext.INCOMPLETE_USR_INCLUDE : CCTokenContext.USR_INCLUDE;
                        case '\n':
                            // does not consume actChar, as it is part of next token
                            state = INIT;
                            supposedTokenID = CCTokenContext.USR_INCLUDE;
                ...
                case ISI_HEX:
                    if (!((actChar >= 'a' && actChar <= 'f') || (actChar >= 'A' && actChar <= 'F') || Character.isDigit(actChar))) {
...
//        System.err.println("matchKeyword[" + lang + "]: " + kw);
        ...
        switch (buffer[offset++]) {
            case 'a':
                ...
                switch (buffer[offset++]) {
                    case 's':   // keyword "asm" (C++ only)
                        return (lang == Language.CPLUSPLUS && len == 3 && buffer[offset++] == 'm') ? CCTokenContext.ASM : null;
                    case 'u':   // keyword "auto"
            ...
            case 'b':
                ...
                switch (buffer[offset++]) {
                    case 'o':   // keyword "bool" (C++ only)
                        return (lang == Language.CPLUSPLUS && len == 4 && buffer[offset++] == 'o' && buffer[offset++] == 'l')
                                ? CCTokenContext.BOOLEAN : null;
                    case 'r':   // keyword "break"
                        return (len == 5 && buffer[offset++] == 'e' && buffer[offset++] == 'a' && buffer[offset++] == 'k')
                    ...
                    case 'a':
                        switch (buffer[offset++]) {
                            ...
                            case 't': // keyword "catch" (C++ only)
                                return (lang == Language.CPLUSPLUS && len == 5 && buffer[offset++] == 'c' && buffer[offset++] == 'h')
                                        ? CCTokenContext.CATCH : null;
                            default:
                                return null;
                        }
                    case 'h': // keyword "char"
                        return (len == 4 && buffer[offset++] == 'a' && buffer[offset++] == 'r')
                                ? CCTokenContext.CHAR : null;
                    case 'l': // keyword "class" (C++ only)
                        return (lang == Language.CPLUSPLUS && len == 5 && buffer[offset++] == 'a' && buffer[offset++] == 's' && buffer[offset++] == 's')
                    ...
                    case 'o':
                        ...
                        switch (buffer[offset++]) {
                            case 's':
                                ...
                                } else if (lang == Language.CPLUSPLUS && len == 10) { // keyword "const_cast" (C++ only)
                                    return (buffer[offset++] == 't' && buffer[offset++] == '_' && buffer[offset++] == 'c' && buffer[offset++] == 'a' && buffer[offset++] == 's' && buffer[offset++] == 't')
                                            ? CCTokenContext.CONST_CAST : null;
                                } else {
                                    return null;
                                }
                            case 't': // keyword "continue"
                                return (len == 8 && buffer[offset++] == 'i' && buffer[offset++] == 'n' && buffer[offset++] == 'u' && buffer[offset++] == 'e')
                ...
                switch (buffer[offset++]) {
                    case 'e':
                        ...
                        switch (buffer[offset++]) {
                            case 'f': // keyword "default"
                                return (len == 7 && buffer[offset++] == 'a' && buffer[offset++] == 'u' && buffer[offset++] == 'l' && buffer[offset++] == 't')
                                        ? CCTokenContext.DEFAULT : null;
                            case 'l': // keyword "delete" (C++ only)
                                return (lang == Language.CPLUSPLUS && len == 6 && buffer[offset++] == 'e' && buffer[offset++] == 't' && buffer[offset++] == 'e')
                    ...
                    case 'o':
                        ...
                        return (len == 6 // keyword "double"
                                && buffer[offset++] == 'u' && buffer[offset++] == 'b' && buffer[offset++] == 'l' && buffer[offset++] == 'e')
                                ? CCTokenContext.DOUBLE : null;
                    case 'y': // keyword "dynamic_cast" (C++ only)
                        return (lang == Language.CPLUSPLUS && len == 12 && buffer[offset++] == 'n' && buffer[offset++] == 'a' && buffer[offset++] == 'm' && buffer[offset++] == 'i' && buffer[offset++] == 'c' && buffer[offset++] == '_' && buffer[offset++] == 'c' && buffer[offset++] == 'a' && buffer[offset++] == 's' && buffer[offset++] == 't')
            ...
            case 'e':
                ...
                switch (buffer[offset++]) {
                    case 'l': // keyword "else"
                        return (len == 4 && buffer[offset++] == 's' && buffer[offset++] == 'e')
                                ? CCTokenContext.ELSE : null;
                    case 'n': // keyword "enum"
                        return (len == 4 && buffer[offset++] == 'u' && buffer[offset++] == 'm')
                            ...
                            case 'p':
                                switch (buffer[offset++]) {
                                    case 'l': // keyword "explicit" (C++ only)
                                        return (lang == Language.CPLUSPLUS && len == 8 && buffer[offset++] == 'i' && buffer[offset++] == 'c' && buffer[offset++] == 'i' && buffer[offset++] == 't')
                                                ? CCTokenContext.EXPLICIT : null;
                                    case 'o': // keyword "export" (C++ only)
                                        return (lang == Language.CPLUSPLUS && len == 6 && buffer[offset++] == 'r' && buffer[offset++] == 't')
                                                ? CCTokenContext.EXPORT : null;
                                    default:
                                        return null;
                                }
                            case 't': // keyword "extern"
                                return (len == 6 && buffer[offset++] == 'e' && buffer[offset++] == 'r' && buffer[offset++] == 'n')
            ...
            case 'f':
                ...
                switch (buffer[offset++]) {
                    case 'a': // keyword "false" (C++ only)
                        return (lang == Language.CPLUSPLUS && len == 5 && buffer[offset++] == 'l' && buffer[offset++] == 's' && buffer[offset++] == 'e')
                                ? CCTokenContext.FALSE : null;
                    case 'l': // keyword "float"
                        return (len == 5 && buffer[offset++] == 'o' && buffer[offset++] == 'a' && buffer[offset++] == 't')
                                ? CCTokenContext.FLOAT : null;
                    case 'o': // keyword "for"
                        return (len == 3 && buffer[offset++] == 'r')
                                ? CCTokenContext.FOR : null;
                    case 'r': // keyword "friend" (C++ only)
                        return (lang == Language.CPLUSPLUS && len == 6 && buffer[offset++] == 'i' && buffer[offset++] == 'e' && buffer[offset++] == 'n' && buffer[offset++] == 'd')
                                ? CCTokenContext.FRIEND : null;
                    default:
                        return null;
                }
            case 'g': // keyword "goto"
                return (len == 4 && buffer[offset++] == 'o' && buffer[offset++] == 't' && buffer[offset++] == 'o')
                    ...
                    case 'n':
                        ...
                        switch (buffer[offset++]) {
                            ...
                            case 'l': // keyword "inline"
                                return (len == 6 && buffer[offset++] == 'i' && buffer[offset++] == 'n' && buffer[offset++] == 'e')
            ...
            case 'l': // keyword "long"
                return (len == 4 && buffer[offset++] == 'o' && buffer[offset++] == 'n' && buffer[offset++] == 'g')
                        ? CCTokenContext.LONG : null;
            case 'm': // keyword "mutable" (C++ only)
                return (lang == Language.CPLUSPLUS && len == 7 && buffer[offset++] == 'u' && buffer[offset++] == 't' && buffer[offset++] == 'a' && buffer[offset++] == 'b' && buffer[offset++] == 'l' && buffer[offset++] == 'e')
            ...
            case 'n':
                ...
                switch (buffer[offset++]) {
                    case 'a': // keyword "namespace" (C++ only)
                        return (lang == Language.CPLUSPLUS && len == 9 && buffer[offset++] == 'm' && buffer[offset++] == 'e' && buffer[offset++] == 's' && buffer[offset++] == 'p' && buffer[offset++] == 'a' && buffer[offset++] == 'c' && buffer[offset++] == 'e')
                                ? CCTokenContext.NAMESPACE : null;
                    case 'e': // keyword "new" (C++ only)
                        return (lang == Language.CPLUSPLUS && len == 3 && buffer[offset++] == 'w')
                                ? CCTokenContext.NEW : null;
                    default:
                        return null;
                }
            case 'o': // keyword "operator" (C++ only)
                return (lang == Language.CPLUSPLUS && len == 8 && buffer[offset++] == 'p' && buffer[offset++] == 'e' && buffer[offset++] == 'r' && buffer[offset++] == 'a' && buffer[offset++] == 't' && buffer[offset++] == 'o' && buffer[offset++] == 'r')
                        ? CCTokenContext.OPERATOR : null;
            case 'p':
                if (lang == Language.C || len <= 5) {
                    return null;
                }
                switch (buffer[offset++]) {
                    case 'r':
                        ...
                        switch (buffer[offset++]) {
                            case 'i': // keyword "private" (C++ only)
                                return (len == 7 && buffer[offset++] == 'v' && buffer[offset++] == 'a' && buffer[offset++] == 't' && buffer[offset++] == 'e')
                                        ? CCTokenContext.PRIVATE : null;
                            case 'o': // keyword "protected" (C++ only)
                                return (len == 9 && buffer[offset++] == 't' && buffer[offset++] == 'e' && buffer[offset++] == 'c' && buffer[offset++] == 't' && buffer[offset++] == 'e' && buffer[offset++] == 'd')
                                        ? CCTokenContext.PROTECTED : null;
                            default:
                                return null;
                        }
                    case 'u': // keyword "public" (C++ only)
                        return (len == 6 && buffer[offset++] == 'b' && buffer[offset++] == 'l' && buffer[offset++] == 'i' && buffer[offset++] == 'c')
            ...
            case 'r':
                ...
                switch (buffer[offset++]) {
                    case 'g': // keyword "register"
                        return (len == 8 && buffer[offset++] == 'i' && buffer[offset++] == 's' && buffer[offset++] == 't' && buffer[offset++] == 'e' && buffer[offset++] == 'r')
                                ? CCTokenContext.REGISTER : null;
                    case 'i': // keyword "reinterpret_cast" (C++ only)
                        return (lang == Language.CPLUSPLUS && len == 16 && buffer[offset++] == 'n' && buffer[offset++] == 't' && buffer[offset++] == 'e' && buffer[offset++] == 'r' && buffer[offset++] == 'p' && buffer[offset++] == 'r' && buffer[offset++] == 'e' && buffer[offset++] == 't' && buffer[offset++] == '_' && buffer[offset++] == 'c' && buffer[offset++] == 'a' && buffer[offset++] == 's' && buffer[offset++] == 't')
                                ? CCTokenContext.REINTERPRET_CAST : null;
                    case 's': // keyword "restrict"
                        return (lang == Language.C && len == 8 && buffer[offset++] == 't' && buffer[offset++] == 'r' && buffer[offset++] == 'i' && buffer[offset++] == 'c' && buffer[offset++] == 't')
                                ? CCTokenContext.RESTRICT : null;
                    case 't': // keyword "return"
                        return (len == 6 && buffer[offset++] == 'u' && buffer[offset++] == 'r' && buffer[offset++] == 'n')
            ...
            case 's':
                ...
                switch (buffer[offset++]) {
                    case 'h': // keyword "short"
                        return (len == 5 && buffer[offset++] == 'o' && buffer[offset++] == 'r' && buffer[offset++] == 't')
                                ? CCTokenContext.SHORT : null;
                    case 'i':
                        switch (buffer[offset++]) {
                            case 'z': // keyword "sizeof"
                                return (len == 6 && buffer[offset++] == 'e' && buffer[offset++] == 'o' && buffer[offset++] == 'f')
                                        ? CCTokenContext.SIZEOF : null;
                            case 'g': // keyword "signed"
                                return (len == 6 && buffer[offset++] == 'n' && buffer[offset++] == 'e' && buffer[offset++] == 'd')
                    ...
                    case 't':
                        switch (buffer[offset++]) {
                            case 'r': // keyword "struct"
                                return (len == 6 && buffer[offset++] == 'u' && buffer[offset++] == 'c' && buffer[offset++] == 't')
                                        ? CCTokenContext.STRUCT : null;
                            case 'a':
                                if (len == 6) { // keyword "static"
                                    return (buffer[offset++] == 't' && buffer[offset++] == 'i' && buffer[offset++] == 'c')
                                            ? CCTokenContext.STATIC : null;
                                } else if (lang == Language.CPLUSPLUS && len == 11) { // keyword "static_cast" (C++ only)
                                    return (buffer[offset++] == 't' && buffer[offset++] == 'i' && buffer[offset++] == 'c' && buffer[offset++] == '_' && buffer[offset++] == 'c' && buffer[offset++] == 'a' && buffer[offset++] == 's' && buffer[offset++] == 't')
                    ...
                    case 'w': // keyword "switch"
                        return (len == 6 && buffer[offset++] == 'i' && buffer[offset++] == 't' && buffer[offset++] == 'c' && buffer[offset++] == 'h')
            ...
            case 't':
                ...
                switch (buffer[offset++]) {
                    case 'e': // keyword "template" (C++ only)
                        return (lang == Language.CPLUSPLUS && len == 8 && buffer[offset++] == 'm' && buffer[offset++] == 'p' && buffer[offset++] == 'l' && buffer[offset++] == 'a' && buffer[offset++] == 't' && buffer[offset++] == 'e')
                                ? CCTokenContext.TEMPLATE : null;
                    case 'h':
                        switch (buffer[offset++]) {
                            case 'i': // keyword "this" (C++ only)
                                return (lang == Language.CPLUSPLUS && len == 4 && buffer[offset++] == 's')
                                        ? CCTokenContext.THIS : null;
                            case 'r': // keyword "throw" (C++ only)
                                return (lang == Language.CPLUSPLUS && len == 5 && buffer[offset++] == 'o' && buffer[offset++] == 'w')
                    ...
                    case 'r':
                        switch (buffer[offset++]) {
                            case 'u': // keyword "true" (C++ only)
                                return (lang == Language.CPLUSPLUS && len == 4 && buffer[offset++] == 'e')
                                        ? CCTokenContext.TRUE : null;
                            case 'y': // keyword "try" (C++ only)
                                return (lang == Language.CPLUSPLUS && len == 3)
                        ...
                        if (len <= 5 || buffer[offset++] != 'p' || buffer[offset++] != 'e') {
                            ...
                            switch (buffer[offset++]) {
                                case 'd':    // keyword "typedef"
                                    return (len == 7 && buffer[offset++] == 'e' && buffer[offset++] == 'f')
                                            ? CCTokenContext.TYPEDEF : null;
                                case 'i': // keyword "typeid" (C++ only)
                                    return (lang == Language.CPLUSPLUS && len == 6 && buffer[offset++] == 'd')
                                            ? CCTokenContext.TYPEID : null;
                                case 'n': // keyword "typename" (C++ only)
                                    return (lang == Language.CPLUSPLUS && len == 8 && buffer[offset++] == 'a' && buffer[offset++] == 'm' && buffer[offset++] == 'e')
                                            ? CCTokenContext.TYPENAME : null;
                                case 'o': // keyword "typeof" (C++ only)
                                    return (lang == Language.CPLUSPLUS && len == 6 && buffer[offset++] == 'f')
            ...
            case 'u':
                ...
                switch (buffer[offset++]) {
                    case 's': // keyword "using" (C++ only)
                        return (lang == Language.CPLUSPLUS && len == 5 && buffer[offset++] == 'i' && buffer[offset++] == 'n' && buffer[offset++] == 'g')
                                ? CCTokenContext.USING : null;
                    case 'n':
                        switch (buffer[offset++]) {
                            case 'i': // keyword "union"
                                return (len == 5 && buffer[offset++] == 'o' && buffer[offset++] == 'n')
                                        ? CCTokenContext.UNION : null;
                            case 's': // keyword "unsigned"
                                return (len == 8 && buffer[offset++] == 'i' && buffer[offset++] == 'g' && buffer[offset++] == 'n' && buffer[offset++] == 'e' && buffer[offset++] == 'd')
            ...
            case 'v':
                ...
                switch (buffer[offset++]) {
                    case 'i': // keyword "virtual" (C++ only)
                        return (lang == Language.CPLUSPLUS && len == 7 && buffer[offset++] == 'r' && buffer[offset++] == 't' && buffer[offset++] == 'u' && buffer[offset++] == 'a' && buffer[offset++] == 'l')
                                ? CCTokenContext.VIRTUAL : null;
                    case 'o':
                        switch (buffer[offset++]) {
                            case 'i': // keyword "void"
                                return (len == 4 && buffer[offset++] == 'd')
                                        ? CCTokenContext.VOID : null;
                            case 'l': // keyword "volatile"
                                return (len == 8 && buffer[offset++] == 'a' && buffer[offset++] == 't' && buffer[offset++] == 'i' && buffer[offset++] == 'l' && buffer[offset++] == 'e')
            ...
            case 'w':
                ...
                switch (buffer[offset++]) {
                    case 'c': // keyword "wchar_t" (C++ only)
                        return (lang == Language.CPLUSPLUS && len == 7 && buffer[offset++] == 'h' && buffer[offset++] == 'a' && buffer[offset++] == 'r' && buffer[offset++] == '_' && buffer[offset++] == 't')
                                ? CCTokenContext.WCHAR_T : null;
                    case 'h': // keyword "while"
                        return (len == 5 && buffer[offset++] == 'i' && buffer[offset++] == 'l' && buffer[offset++] == 'e')
            ...
            case '_':
                ...
                switch (buffer[offset++]) {
                    case 'B': // keyword "_Bool" (C only)
                        return (lang == Language.C && len == 5 && buffer[offset++] == 'o' && buffer[offset++] == 'o' && buffer[offset++] == 'l')
                                ? CCTokenContext._BOOL : null;
                    case 'C': // keyword "_Complex" (C only)
                        return (lang == Language.C && len == 8 && buffer[offset++] == 'o' && buffer[offset++] == 'm' && buffer[offset++] == 'p' && buffer[offset++] == 'l' && buffer[offset++] == 'e' && buffer[offset++] == 'x')
                                ? CCTokenContext._COMPLEX : null;
                    case 'I': // keyword "_Imaginary" (C only)
                        return (lang == Language.C && len == 10 && buffer[offset++] == 'm' && buffer[offset++] == 'a' && buffer[offset++] == 'g' && buffer[offset++] == 'i' && buffer[offset++] == 'n' && buffer[offset++] == 'a' && buffer[offset++] == 'r' && buffer[offset++] == 'y')
                    ...
                    case '_': // keywords starting with __
                        ...
                        switch (buffer[offset++]) {
                            case 'a': // __attribute__
                                return ((len == 13) && buffer[offset++] == 't' && buffer[offset++] == 't' && buffer[offset++] == 'r' && buffer[offset++] == 'i' && buffer[offset++] == 'b' && buffer[offset++] == 'u' && buffer[offset++] == 't' && buffer[offset++] == 'e' && buffer[offset++] == '_' && buffer[offset++] == '_')
                                        ? CCTokenContext.__ATTRIBUTE__ : null;
                            case 'u': // __unused__
                                return ((len == 10) && buffer[offset++] == 'n' && buffer[offset++] == 'u' && buffer[offset++] == 's' && buffer[offset++] == 'e' && buffer[offset++] == 'd' && buffer[offset++] == '_' && buffer[offset++] == '_')
...
//	System.err.println("");
        ...
        switch (buffer[offset++]) {
            case 'd': // define
                return (len == 6 && buffer[offset++] == 'e' && buffer[offset++] == 'f' && buffer[offset++] == 'i' && buffer[offset++] == 'n' && buffer[offset++] == 'e')
            ...
            case 'e': // elif, else, endif, error
                ...
                switch (buffer[offset++]) {
                    case 'l': // elif, else
                        switch (buffer[offset++]) {
                            case 's': // else
                                return (len == 4 && buffer[offset++] == 'e')
                                        ? CCTokenContext.CPPELSE : defCPPToken;
                            case 'i': // endif
                                return (len == 4 && buffer[offset++] == 'f')
                                        ? CCTokenContext.CPPELIF : defCPPToken;
                            default:
                                return defCPPToken;
                        }
                    case 'n': // endif
                        return (len == 5 && buffer[offset++] == 'd' && buffer[offset++] == 'i' && buffer[offset++] == 'f')
                                ? CCTokenContext.CPPENDIF : defCPPToken;
                    case 'r': // error
                        return (len == 5 && buffer[offset++] == 'r' && buffer[offset++] == 'o' && buffer[offset++] == 'r')
            ...
            case 'i': // if, ifdef, ifndef, include
                switch (buffer[offset++]) {
                    case 'f': // if, ifdef, ifndef
                        ...
                        switch (buffer[offset++]) {
                            case 'd':
                                return (len == 5 && buffer[offset++] == 'e' && buffer[offset++] == 'f')
                                        ? CCTokenContext.CPPIFDEF : defCPPToken;
                            case 'n':
                                return (len == 6 && buffer[offset++] == 'd' && buffer[offset++] == 'e' && buffer[offset++] == 'f')
                                        ? CCTokenContext.CPPIFNDEF : defCPPToken;
                            default:
                                return defCPPToken;
                        }
                    case 'n': // include
                        if (len >= 7 && buffer[offset++] == 'c' && buffer[offset++] == 'l' && buffer[offset++] == 'u' && buffer[offset++] == 'd' && buffer[offset++] == 'e') {
                            if (len == 7) {
                                return CCTokenContext.CPPINCLUDE;
                            } else if (len == 12 && buffer[offset++] == '_' && buffer[offset++] == 'n' && buffer[offset++] == 'e' && buffer[offset++] == 'x' && buffer[offset++] == 't') {
            ...
            case 'l': // line
                ...
                return (buffer[offset++] == 'i' && buffer[offset++] == 'n' && buffer[offset++] == 'e')
                        ? CCTokenContext.CPPLINE : defCPPToken;
            case 'p': // pragma
                return (len == 6 && buffer[offset++] == 'r' && buffer[offset++] == 'a' && buffer[offset++] == 'g' && buffer[offset++] == 'm' && buffer[offset++] == 'a')
                        ? CCTokenContext.CPPPRAGMA : defCPPToken;
            case 'u': // undef
                if (len != 5) {
                    return defCPPToken;
                }
                return (buffer[offset++] == 'n' && buffer[offset++] == 'd' && buffer[offset++] == 'e' && buffer[offset++] == 'f')
                        ? CCTokenContext.CPPUNDEF : defCPPToken;
            case 'w': // warning
                if (len != 7) {
                    return defCPPToken;
                }
                return (buffer[offset++] == 'a' && buffer[offset++] == 'r' && buffer[offset++] == 'n' && buffer[offset++] == 'i' && buffer[offset++] == 'n' && buffer[offset++] == 'g')
