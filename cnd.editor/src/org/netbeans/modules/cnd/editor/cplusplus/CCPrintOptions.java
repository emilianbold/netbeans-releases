...
public class CCPrintOptions extends BasePrintOptions {

    public static final String CC = "cc"; //NOI18N

    static final long serialVersionUID = 1283265597555453839L;

    public CCPrintOptions() {
        this(CCKit.class, CC);
    }

    public CCPrintOptions(Class kitClass, String typeName) {
