...
public class IMSBindingImpl extends IMSComponentImpl implements IMSBinding {
    public IMSBindingImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
    public IMSBindingImpl(WSDLModel model){
        this(model, createPrefixedElement(IMSQName.BINDING.getQName(), model));
    }
