...
public abstract class IMSComponentImpl extends GenericExtensibilityElement implements IMSComponent {

    protected String getNamespaceURI() {
        return IMSQName.IMS_NS_URI;
    }

	public IMSComponentImpl(WSDLModel model, Element e) {
        super(model, e);
    }    
}
