        ...
        try {
            ...
            if (e != null && e.getKind() == ElementKind.METHOD) {
                ...
                if (addHint) {
                    ...
                    ErrorDescription ed = ErrorDescriptionFactory.createErrorDescription(getSeverity().toEditorSeverity(), "Add Override Annotation", fixes, doc, doc.createPosition((int) span[0]), doc.createPosition((int) span[1]));
