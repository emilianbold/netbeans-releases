...
public class HTTPAddressImpl extends HTTPComponentImpl implements HTTPAddress {
    
    public HTTPAddressImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
    public HTTPAddressImpl(WSDLModel model){
        this(model, createPrefixedElement(HTTPQName.ADDRESS.getQName(), model));
    }
