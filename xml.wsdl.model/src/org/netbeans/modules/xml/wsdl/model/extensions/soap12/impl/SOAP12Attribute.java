 ...
 *
 */
public enum SOAP12Attribute implements Attribute {
        ...
        SOAP_ACTION_REQUIRED("soapActionRequired"),
    ...
    SOAP12Attribute(String name) {
        this(name, String.class);
    }
    SOAP12Attribute(String name, Class type) {
        this(name, type, null);
    }
    SOAP12Attribute(String name, Class type, Class subtype) {
        this.name = name;
        this.type = type;
