 ...
 * @author jyang
 */
public class MIMEContentImpl extends MIMEComponentImpl implements MIMEContent {

    /** Creates a new instance of MIMEContentImpl */
    public MIMEContentImpl(WSDLModel model, Element e) {
        super(model, e);
    }

    public MIMEContentImpl(WSDLModel model) {
        this(model, createPrefixedElement(MIMEQName.CONTENT.getQName(), model));
    }
    ...
    public void setType(String type) {
        setAttribute(PART_PROPERTY, WSDLAttribute.TYPE, type);
    }
    ...
    public String getType() {
        return getAttribute(WSDLAttribute.TYPE);
    }
