 ...
 * @author jyang
 */
public abstract class MIMEComponentImpl extends GenericExtensibilityElement
        implements MIMEComponent, ExtensibilityElement.UpdaterProvider {

    /** Creates a new instance of SOAPComponentImpl */
    public MIMEComponentImpl(WSDLModel model, Element e) {
        super(model, e);
    }
