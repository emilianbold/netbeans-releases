...
public interface Collablet extends PropertyChangeListener {
    ...
    /**
     * Returns the conversation associated with this channel
     *
     */
    ...
    /**
     *
     * @return        true if this channel wants to handle the message
     */
    public boolean acceptMessage(CollabMessage message);

    /**
     *
     * @return        true if the message handling is complete
     */
