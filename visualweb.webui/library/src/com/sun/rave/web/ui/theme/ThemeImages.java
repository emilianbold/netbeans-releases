...
public class ThemeImages {
    ...
    public static final String ALARM_CRITICAL_MEDIUM_HEIGHT =
         "ALARM_CRITICAL_MEDIUM_HEIGHT";
    public static final String ALARM_CRITICAL_MEDIUM_WIDTH =
         "ALARM_CRITICAL_MEDIUM_WIDTH";
    ...
    public static final String ALARM_MAJOR_MEDIUM_WIDTH =
         "ALARM_MAJOR_MEDIUM_WIDTH";
    ...
    public static final String ALARM_MASTHEAD_CRITICAL_MEDIUM_HEIGHT =
         "ALARM_MASTHEAD_CRITICAL_MEDIUM_HEIGHT";
    public static final String ALARM_MASTHEAD_CRITICAL_MEDIUM_WIDTH =
         "ALARM_MASTHEAD_CRITICAL_MEDIUM_WIDTH";
    public static final String ALARM_MASTHEAD_CRITICAL_DIMMED =
         "ALARM_MASTHEAD_CRITICAL_DIMMED";
    public static final String ALARM_MASTHEAD_CRITICAL_DIMMED_HEIGHT =
         "ALARM_MASTHEAD_CRITICAL_DIMMED_HEIGHT";
    public static final String ALARM_MASTHEAD_CRITICAL_DIMMED_WIDTH =
         "ALARM_MASTHEAD_CRITICAL_DIMMED_WIDTH";
    public static final String ALARM_MASTHEAD_DOWN_MEDIUM =
         "ALARM_MASTHEAD_DOWN_MEDIUM";
    public static final String ALARM_MASTHEAD_DOWN_MEDIUM_HEIGHT =
         "ALARM_MASTHEAD_DOWN_MEDIUM_HEIGHT";
    public static final String ALARM_MASTHEAD_DOWN_MEDIUM_WIDTH =
         "ALARM_MASTHEAD_DOWN_MEDIUM_WIDTH";
    public static final String ALARM_MASTHEAD_DOWN_DIMMED =
         "ALARM_MASTHEAD_DOWN_DIMMED";
    public static final String ALARM_MASTHEAD_DOWN_DIMMED_HEIGHT =
         "ALARM_MASTHEAD_DOWN_DIMMED_HEIGHT";
    public static final String ALARM_MASTHEAD_DOWN_DIMMED_WIDTH =
         "ALARM_MASTHEAD_DOWN_DIMMED_WIDTH";
    public static final String ALARM_MASTHEAD_MAJOR_MEDIUM =
         "ALARM_MASTHEAD_MAJOR_MEDIUM";
    public static final String ALARM_MASTHEAD_MAJOR_MEDIUM_HEIGHT =
         "ALARM_MASTHEAD_MAJOR_MEDIUM_HEIGHT";
    public static final String ALARM_MASTHEAD_MAJOR_MEDIUM_WIDTH =
         "ALARM_MASTHEAD_MAJOR_MEDIUM_WIDTH";
    public static final String ALARM_MASTHEAD_MAJOR_DIMMED =
         "ALARM_MASTHEAD_MAJOR_DIMMED";
    public static final String ALARM_MASTHEAD_MAJOR_DIMMED_HEIGHT =
         "ALARM_MASTHEAD_MAJOR_DIMMED_HEIGHT";
    public static final String ALARM_MASTHEAD_MAJOR_DIMMED_WIDTH =
         "ALARM_MASTHEAD_MAJOR_DIMMED_WIDTH";
    public static final String ALARM_MASTHEAD_MINOR_MEDIUM =
         "ALARM_MASTHEAD_MINOR_MEDIUM";
    public static final String ALARM_MASTHEAD_MINOR_MEDIUM_HEIGHT =
         "ALARM_MASTHEAD_MINOR_MEDIUM_HEIGHT";
    public static final String ALARM_MASTHEAD_MINOR_MEDIUM_WIDTH =
         "ALARM_MASTHEAD_MINOR_MEDIUM_WIDTH";
    public static final String ALARM_MASTHEAD_MINOR_DIMMED =
         "ALARM_MASTHEAD_MINOR_DIMMED";
    public static final String ALARM_MASTHEAD_MINOR_DIMMED_HEIGHT =
    ...
    public static final String ALERT_OK_LARGE_HEIGHT = "ALERT_OK_LARGE_HEIGHT";
    public static final String ALERT_OK_LARGE_WIDTH = "ALERT_OK_LARGE_WIDTH";
    public static final String ALERT_OK_MEDIUM = "ALERT_OK_MEDIUM";
    public static final String ALERT_OK_MEDIUM_HEIGHT =
         "ALERT_OK_MEDIUM_HEIGHT";
    public static final String ALERT_OK_MEDIUM_WIDTH = "ALERT_OK_MEDIUM_WIDTH";
    public static final String ALERT_OK_SMALL = "ALERT_OK_SMALL";
    public static final String ALERT_OK_SMALL_HEIGHT = "ALERT_OK_SMALL_HEIGHT";
    public static final String ALERT_OK_SMALL_WIDTH = "ALERT_OK_SMALL_WIDTH";
    public static final String ALERT_SUCCESS_LARGE = "ALERT_SUCCESS_LARGE";
    public static final String ALERT_SUCCESS_LARGE_HEIGHT =
    ...
    public static final String PRIMARY_MINI_ROLL = "PRIMARY_MINI_ROLL";
    public static final String PRIMARY_MINI_ROLL_HEIGHT =
         "PRIMARY_MINI_ROLL_HEIGHT";

    public static final String PRIMARY_ROLL = "PRIMARY_ROLL";
    public static final String PRIMARY_ROLL_HEIGHT = "PRIMARY_ROLL_HEIGHT";
    ...
    public static final String SECONDARY_MINI_ROLL_HEIGHT =
    ...
    public static final String HELP_BACK_DISABLED = "HELP_BACK_DISABLED";
    public static final String HELP_BACK_DISABLED_HEIGHT =
         "HELP_BACK_DISABLED_HEIGHT";
    public static final String HELP_BACK_DISABLED_WIDTH =
         "HELP_BACK_DISABLED_WIDTH";

    public static final String HELP_FORWARD = "HELP_FORWARD";
    public static final String HELP_FORWARD_HEIGHT = "HELP_FORWARD_HEIGHT";
    public static final String HELP_FORWARD_WIDTH = "HELP_FORWARD_WIDTH";

    public static final String HELP_FORWARD_DISABLED = "HELP_FORWARD_DISABLED";
    public static final String HELP_FORWARD_DISABLED_HEIGHT =
         "HELP_FORWARD_DISABLED_HEIGHT";
    public static final String HELP_FORWARD_DISABLED_WIDTH =
         "HELP_FORWARD_DISABLED_WIDTH";

    public static final String HELP_PRINT = "HELP_PRINT";
    public static final String HELP_PRINT_HEIGHT = "HELP_PRINT_HEIGHT";
    public static final String HELP_PRINT_WIDTH = "HELP_PRINT_WIDTH";

    public static final String HELP_PRINT_DISABLED = "HELP_PRINT_DISABLED";
    public static final String HELP_PRINT_DISABLED_HEIGHT =
         "HELP_PRINT_DISABLED_HEIGHT";
    public static final String HELP_PRINT_DISABLED_WIDTH =
    ...
    public static final String HREF_TOP = "HREF_TOP";
    public static final String HREF_TOP_HEIGHT = "HREF_TOP_HEIGHT";
    public static final String HREF_TOP_WIDTH = "HREF_TOP_WIDTH";
    public static final String HREF_LINK = "HREF_LINK";
    ...
    public static final String LABEL_INVALID_ICON_WIDTH = 
	"LABEL_INVALID_ICO_WIDTHN";
    public static final String LABEL_REQUIRED_ICON = "LABEL_REQUIRED_ICON";
    public static final String LABEL_REQUIRED_ICON_HEIGHT = 
	"LABEL_REQUIRED_ICON_HEIGHT";
    public static final String LABEL_REQUIRED_ICON_WIDTH = 
    ...
    public static final String MASTHEAD_STATUS_ICON_HEIGHT =
         "MASTHEAD_STATUS_ICON_HEIGHT";

    public static final String MASTHEAD_BACKGROUND = "MASTHEAD_BACKGROUND";
    public static final String MASTHEAD_BACKGROUND_HEIGHT =
         "MASTHEAD_BACKGROUND_HEIGHT";

    public static final String MASTHEAD_SEPARATOR = "MASTHEAD_SEPARATOR";
    public static final String MASTHEAD_SEPARATOR_WIDTH =
         "MASTHEAD_SEPARATOR_WIDTH";
    public static final String MASTHEAD_SEPARATOR_HEIGHT =
         "MASTHEAD_SEPARATOR_HEIGHT";

    public static final String MASTHEAD_LINK_ENABLED = "MASTHEAD_LINK_ENABLED";
    public static final String MASTHEAD_LINK_ENABLED_HEIGHT =
         "MASTHEAD_LINK_ENABLED_HEIGHT";
    ...
    public static final String MASTHEAD_STATUS_AREA_SEPARATOR_WIDTH =
         "MASTHEAD_STATUS_AREA_SEPARATOR_WIDTH";
    public static final String MASTHEAD_STATUS_AREA_SEPARATOR_HEIGHT =
         "MASTHEAD_STATUS_AREA_SEPARATOR_HEIGHT";
     ...
     */
    public static final String JAVALOGO = "JAVALOGO";
    public static final String JAVALOGO_HEIGHT = "JAVALOGO_HEIGHT";
    public static final String JAVALOGO_WIDTH = "JAVALOGO_WIDTH";
	...
	"TABLE_ACTIONS_SEPARATOR_HEIGHT";
    public static final String TABLE_ACTIONS_SEPARATOR_WIDTH =
        "TABLE_ACTIONS_SEPARATOR_WIDTH";
    public static final String TABLE_DESELECT_MULTIPLE =
        "TABLE_DESELECT_MULTIPLE";
    public static final String TABLE_DESELECT_MULTIPLE_HEIGHT =
        "TABLE_DESELECT_MULTIPLE_HEIGHT";
    public static final String TABLE_DESELECT_MULTIPLE_WIDTH =
        "TABLE_DESELECT_MULTIPLE_WIDTH";
    public static final String TABLE_DESELECT_SINGLE =
        "TABLE_DESELECT_SINGLE";
    public static final String TABLE_DESELECT_SINGLE_HEIGHT =
        "TABLE_DESELECT_SINGLE_HEIGHT";
    public static final String TABLE_DESELECT_SINGLE_WIDTH =
        "TABLE_DESELECT_SINGLE_WIDTH";
    public static final String TABLE_EMBEDDED_ACTIONS_SEPARATOR =
        "TABLE_EMBEDDED_ACTIONS_SEPARATOR";
    public static final String TABLE_EMBEDDED_ACTIONS_SEPARATOR_HEIGHT =
	  "TABLE_EMBEDDED_ACTIONS_SEPARATOR_HEIGHT";
    public static final String TABLE_EMBEDDED_ACTIONS_SEPARATOR_WIDTH =
        "TABLE_EMBEDDED_ACTIONS_SEPARATOR_WIDTH";
    public static final String TABLE_EMPTY_CELL =
        "TABLE_EMPTY_CELL";
    public static final String TABLE_EMPTY_CELL_HEIGHT =
        "TABLE_EMPTY_CELL_HEIGHT";
    public static final String TABLE_EMPTY_CELL_WIDTH =
        "TABLE_EMPTY_CELL_WIDTH";
    public static final String TABLE_GROUP_PANEL =
        "TABLE_GROUP_PANEL";
    public static final String TABLE_GROUP_PANEL_HEIGHT =
        "TABLE_GROUP_PANEL_HEIGHT";
    public static final String TABLE_GROUP_PANEL_WIDTH =
        "TABLE_GROUP_PANEL_WIDTH";
    public static final String TABLE_GROUP_PANEL_FLIP =
        "TABLE_GROUP_PANEL_FLIP";
    public static final String TABLE_GROUP_PANEL_FLIP_HEIGHT =
        "TABLE_GROUP_PANEL_FLIP_HEIGHT";
    public static final String TABLE_GROUP_PANEL_FLIP_WIDTH =
        "TABLE_GROUP_PANEL_FLIP_WIDTH";
    public static final String TABLE_PAGINATE =
        "TABLE_PAGINATE";
    public static final String TABLE_PAGINATE_HEIGHT =
        "TABLE_PAGINATE_HEIGHT";
    public static final String TABLE_PAGINATE_WIDTH =
        "TABLE_PAGINATE_WIDTH";
    public static final String TABLE_PAGINATION_FIRST =
        "TABLE_PAGINATION_FIRST";
    public static final String TABLE_PAGINATION_FIRST_HEIGHT =
        "TABLE_PAGINATION_FIRST_HEIGHT";
    public static final String TABLE_PAGINATION_FIRST_WIDTH =
        "TABLE_PAGINATION_FIRST_WIDTH"; 
    public static final String TABLE_PAGINATION_FIRST_DISABLED =
        "TABLE_PAGINATION_FIRST_DISABLED";
    public static final String TABLE_PAGINATION_FIRST_DISABLED_HEIGHT =
        "TABLE_PAGINATION_FIRST_DISABLED_HEIGHT";
    public static final String TABLE_PAGINATION_FIRST_DISABLED_WIDTH =
        "TABLE_PAGINATION_FIRST_DISABLED_WIDTH";
    public static final String TABLE_PAGINATION_LAST =
        "TABLE_PAGINATION_LAST";
    public static final String TABLE_PAGINATION_LAST_HEIGHT =
        "TABLE_PAGINATION_LAST_HEIGHT";
    public static final String TABLE_PAGINATION_LAST_WIDTH =
        "TABLE_PAGINATION_LAST_WIDTH";
    public static final String TABLE_PAGINATION_LAST_DISABLED =
        "TABLE_PAGINATION_LAST_DISABLED";
    public static final String TABLE_PAGINATION_LAST_DISABLED_HEIGHT =
        "TABLE_PAGINATION_LAST_DISABLED_HEIGHT";
    public static final String TABLE_PAGINATION_LAST_DISABLED_WIDTH =
        "TABLE_PAGINATION_LAST_DISABLED_WIDTH";
    public static final String TABLE_PAGINATION_NEXT =
        "TABLE_PAGINATION_NEXT";
    public static final String TABLE_PAGINATION_NEXT_HEIGHT =
        "TABLE_PAGINATION_NEXT_HEIGHT";
    public static final String TABLE_PAGINATION_NEXT_WIDTH =
        "TABLE_PAGINATION_NEXT_WIDTH";
    public static final String TABLE_PAGINATION_NEXT_DISABLED =
        "TABLE_PAGINATION_NEXT_DISABLED";
    public static final String TABLE_PAGINATION_NEXT_DISABLED_HEIGHT =
        "TABLE_PAGINATION_NEXT_DISABLED_HEIGHT";
    public static final String TABLE_PAGINATION_NEXT_DISABLED_WIDTH =
        "TABLE_PAGINATION_NEXT_DISABLED_WIDTH";
    public static final String TABLE_PAGINATION_PREV =
        "TABLE_PAGINATION_PREV";
    public static final String TABLE_PAGINATION_PREV_HEIGHT =
        "TABLE_PAGINATION_PREV_HEIGHT";
    public static final String TABLE_PAGINATION_PREV_WIDTH =
        "TABLE_PAGINATION_PREV_WIDTH";
    public static final String TABLE_PAGINATION_PREV_DISABLED =
        "TABLE_PAGINATION_PREV_DISABLED";
    public static final String TABLE_PAGINATION_PREV_DISABLED_HEIGHT =
        "TABLE_PAGINATION_PREV_DISABLED_HEIGHT";
    public static final String TABLE_PAGINATION_PREV_DISABLED_WIDTH =
        "TABLE_PAGINATION_PREV_DISABLED_WIDTH";
    public static final String TABLE_PREFERENCES_PANEL =
        "TABLE_PREFERENCES_PANEL";
    public static final String TABLE_PREFERENCES_PANEL_HEIGHT =
        "TABLE_PREFERENCES_PANEL_HEIGHT";
    public static final String TABLE_PREFERENCES_PANEL_WIDTH =
        "TABLE_PREFERENCES_PANEL_WIDTH";
    public static final String TABLE_PREFERENCES_PANEL_FLIP =
        "TABLE_PREFERENCES_PANEL_FLIP";
    public static final String TABLE_PREFERENCES_PANEL_FLIP_HEIGHT =
        "TABLE_PREFERENCES_PANEL_FLIP_HEIGHT";
    public static final String TABLE_PREFERENCES_PANEL_FLIP_WIDTH =
        "TABLE_PREFERENCES_PANEL_FLIP_WIDTH";
    public static final String TABLE_SCROLL_PAGE =
        "TABLE_SCROLL_PAGE";
    public static final String TABLE_SCROLL_PAGE_HEIGHT =
        "TABLE_SCROLL_PAGE_HEIGHT";
    public static final String TABLE_SCROLL_PAGE_WIDTH =
        "TABLE_SCROLL_PAGE_WIDTH";
    public static final String TABLE_SELECT_MULTIPLE =
        "TABLE_SELECT_MULTIPLE";
    public static final String TABLE_SELECT_MULTIPLE_HEIGHT =
        "TABLE_SELECT_MULTIPLE_HEIGHT";
    public static final String TABLE_SELECT_MULTIPLE_WIDTH =
        "TABLE_SELECT_MULTIPLE_WIDTH";
    public static final String TABLE_SORT_ADD =
        "TABLE_SORT_ADD";
    public static final String TABLE_SORT_ADD_HEIGHT =
        "TABLE_SORT_ADD_HEIGHT";
    public static final String TABLE_SORT_ADD_WIDTH =
        "TABLE_SORT_ADD_WIDTH";
    public static final String TABLE_SORT_ASCENDING =
        "TABLE_SORT_ASCENDING";
    public static final String TABLE_SORT_ASCENDING_HEIGHT =
        "TABLE_SORT_ASCENDING_HEIGHT";
    public static final String TABLE_SORT_ASCENDING_WIDTH =
        "TABLE_SORT_ASCENDING_WIDTH";
    public static final String TABLE_SORT_CLEAR =
        "TABLE_SORT_CLEAR";
    public static final String TABLE_SORT_CLEAR_HEIGHT =
        "TABLE_SORT_CLEAR_HEIGHT";
    public static final String TABLE_SORT_CLEAR_WIDTH =
        "TABLE_SORT_CLEAR_WIDTH";
    public static final String TABLE_SORT_DESCENDING =
        "TABLE_SORT_DESCENDING";
    public static final String TABLE_SORT_DESCENDING_HEIGHT =
        "TABLE_SORT_DESCENDING_HEIGHT";
    public static final String TABLE_SORT_DESCENDING_WIDTH =
        "TABLE_SORT_DESCENDING_WIDTH";
    public static final String TABLE_SORT_DESCENDING_DISABLED =
        "TABLE_SORT_DESCENDING_DISABLED";
    public static final String TABLE_SORT_DESCENDING_DISABLED_HEIGHT =
        "TABLE_SORT_DESCENDING_DISABLED_HEIGHT";
    public static final String TABLE_SORT_DESCENDING_DISABLED_WIDTH =
        "TABLE_SORT_DESCENDING_DISABLED_WIDTH";
    public static final String TABLE_SORT_PANEL =
        "TABLE_SORT_PANEL";
    public static final String TABLE_SORT_PANEL_HEIGHT =
        "TABLE_SORT_PANEL_HEIGHT";
    public static final String TABLE_SORT_PANEL_WIDTH =
        "TABLE_SORT_PANEL_WIDTH";
    public static final String TABLE_SORT_PANEL_FLIP =
        "TABLE_SORT_PANEL_FLIP";
    public static final String TABLE_SORT_PANEL_FLIP_HEIGHT =
        "TABLE_SORT_PANEL_FLIP_HEIGHT";
    public static final String TABLE_SORT_PANEL_FLIP_WIDTH =
        "TABLE_SORT_PANEL_FLIP_WIDTH";
    public static final String TABLE_SORT_PRIMARY =
        "TABLE_SORT_PRIMARY";
    public static final String TABLE_SORT_PRIMARY_HEIGHT =
        "TABLE_SORT_PRIMARY_HEIGHT";
    public static final String TABLE_SORT_PRIMARY_WIDTH =
        "TABLE_SORT_PRIMARY_WIDTH";
    public static final String TABLE_SORT_SELECT =
        "TABLE_SORT_SELECT";
    public static final String TABLE_SORT_SELECTCOL_TITLE_HEIGHT =
    ...
    public static final String TABS_LEVEL1_DESELECT_HEIGHT =
         "TABS_LEVEL1_DESELECT_HEIGHT";

    public static final String TABS_LEVEL1_SELECTED = "TABS_LEVEL1_SELECTED";
    public static final String TABS_LEVEL1_SELECTED_HEIGHT =
         "TABS_LEVEL1_SELECTED_HEIGHT";

    public static final String TABS_LEVEL1_SELECTED_1LEV =
    ...
    public static final String TABS_LEVEL2_DESELECT_HEIGHT =
         "TABS_LEVEL2_DESELECT_HEIGHT";
    ...
    public static final String TABS_MINITAB_DESELECT_HEIGHT =
         "TABS_MINITAB_DESELECT_HEIGHT";

    public static final String TABS_MINITAB_SELECTED = "TABS_MINITAB_SELECTED";
    public static final String TABS_MINITAB_SELECTED_HEIGHT =
         "TABS_MINITAB_SELECTED_HEIGHT";
    ...
    public static final String TITLEDBOX_HILIGHTBOX_GRADIENT="TITLEDBOX_HILIGHTBOX_GRADIENT";
    ...
    public static final String TITLEDBOX_HELP="TITLEDBOX_HELP";
    public static final String TITLEDBOX_HELP_FLIP="TITLEDBOX_HELP_FLIP";
    ...
    public static final String TITLEDBOX_MENU_CHECK_ROLL="TITLEDBOX_MENU_CHECK_ROLL";
    ...
    public static final String TOPOLOGY_SERVER_MEDIUM_WIDTH =
         "TOPOLOGY_SERVER_MEDIUM_WIDTH";
    public static final String TOPOLOGY_SWITCH_SMALL = "TOPOLOGY_SWITCH_SMALL";
    public static final String TOPOLOGY_SWITCH_SMALL_HEIGHT =
     ...
     * Tree images.
     */
    public static final String ROOT_SPACER_HEIGHT = "ROOT_SPACER_HEIGHT";
    ...
    public static final String TREE_HANDLE_RIGHT_MIDDLE =
         "TREE_HANDLE_RIGHT_MIDDLE";
    public static final String TREE_HANDLE_RIGHT_TOP_NOSIBLING =
    ...
    public static final String TREE_SERVER_CRITICAL = "TREE_SERVER_CRITICAL";
    public static final String TREE_SERVER_DOWN = "TREE_SERVER_DOWN";
    public static final String TREE_SERVER_MAJOR = "TREE_SERVER_MAJOR";
    ...
    public static final String VERSION_JAVALOGO = "VERSION_JAVALOGO";
    public static final String VERSION_JAVALOGO_HEIGHT = "VERSION_JAVALOGO_HEIGHT";
    public static final String VERSION_JAVALOGO_WIDTH = "VERSION_JAVALOGO_WIDTH";
    ...
    public static final String WIZARD_SUBTITLE_BACKGROUND =
