...
public class LabelTag extends UIComponentTag {
    ...
    protected void setProperties(UIComponent _component) {
        ...
        if (hideIndicators != null) {
            if (isValueReference(hideIndicators)) {
                ValueBinding _vb = getFacesContext().getApplication().createValueBinding(hideIndicators);
                _component.setValueBinding("hideIndicators", _vb);
            } else {
                _component.getAttributes().put("hideIndicators", Boolean.valueOf(hideIndicators));
            }
        }
        if (labelLevel != null) {
        ...
        if (requiredIndicator != null) {
            if (isValueReference(requiredIndicator)) {
                ValueBinding _vb = getFacesContext().getApplication().createValueBinding(requiredIndicator);
                _component.setValueBinding("requiredIndicator", _vb);
            } else {
                _component.getAttributes().put("requiredIndicator", Boolean.valueOf(requiredIndicator));
            }
        }
        if (style != null) {
    ...
    // hideIndicators
    private String hideIndicators = null;
    public void setHideIndicators(String hideIndicators) {
    ...
    // requiredIndicator
    private String requiredIndicator = null;
