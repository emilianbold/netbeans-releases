...
/**
 *  <P>	This factory is responsible for instantiating a legend
 *	UIComponent.</P>
 */
public class LegendFactory extends ComponentFactoryBase {
     ...
     *
     *	@return	The newly created {@link Legend}
     */
	...
	if (parent != null) {
	    addChild(context, descriptor, parent, legend);
	}

	// Set all the attributes / properties
	setOptions(context, descriptor, legend);
