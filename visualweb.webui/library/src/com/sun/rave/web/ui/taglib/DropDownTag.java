...
public class DropDownTag extends UIComponentTag {
    ...
    protected void setProperties(UIComponent _component) {
        ...
        if (forgetValue != null) {
            if (isValueReference(forgetValue)) {
                ValueBinding _vb = getFacesContext().getApplication().createValueBinding(forgetValue);
                _component.setValueBinding("forgetValue", _vb);
            } else {
                _component.getAttributes().put("forgetValue", Boolean.valueOf(forgetValue));
            }
        }
        if (navigateToValue != null) {
            if (isValueReference(navigateToValue)) {
                ValueBinding _vb = getFacesContext().getApplication().createValueBinding(navigateToValue);
                _component.setValueBinding("navigateToValue", _vb);
            } else {
                _component.getAttributes().put("navigateToValue", Boolean.valueOf(navigateToValue));
            }
        }
        if (submitForm != null) {
            if (isValueReference(submitForm)) {
                ValueBinding _vb = getFacesContext().getApplication().createValueBinding(submitForm);
                _component.setValueBinding("submitForm", _vb);
            } else {
                _component.getAttributes().put("submitForm", Boolean.valueOf(submitForm));
            }
        }
        if (labelOnTop != null) {
    ...
    // forgetValue
    private String forgetValue = null;
    public void setForgetValue(String forgetValue) {
        this.forgetValue = forgetValue;
    }

    // navigateToValue
    private String navigateToValue = null;
    public void setNavigateToValue(String navigateToValue) {
