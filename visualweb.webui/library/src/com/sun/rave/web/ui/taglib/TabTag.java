...
public class TabTag extends UIComponentTag {
    ...
    protected void setProperties(UIComponent _component) {
        ...
        if (selectedChildId != null) {
            if (isValueReference(selectedChildId)) {
                ValueBinding _vb = getFacesContext().getApplication().createValueBinding(selectedChildId);
                _component.setValueBinding("selectedChildId", _vb);
            } else {
                _component.getAttributes().put("selectedChildId", selectedChildId);
            }
        }
        if (action != null) {
