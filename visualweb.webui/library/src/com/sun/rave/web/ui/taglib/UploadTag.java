...
public class UploadTag extends UIComponentTag {
    ...
    protected void setProperties(UIComponent _component) {
        ...
        if (uploadedFile != null) {
            if (isValueReference(uploadedFile)) {
                ValueBinding _vb = getFacesContext().getApplication().createValueBinding(uploadedFile);
                _component.setValueBinding("uploadedFile", _vb);
            } else {
                _component.getAttributes().put("uploadedFile", uploadedFile);
            }
        }
        if (disabled != null) {
