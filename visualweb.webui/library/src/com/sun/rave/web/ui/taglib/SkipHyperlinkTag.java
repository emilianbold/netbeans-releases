...
public class SkipHyperlinkTag extends UIComponentTag {
    ...
    protected void setProperties(UIComponent _component) {
        ...
        if (description != null) {
            if (isValueReference(description)) {
                ValueBinding _vb = getFacesContext().getApplication().createValueBinding(description);
                _component.setValueBinding("description", _vb);
            } else {
                _component.getAttributes().put("description", description);
            }
        }
        if (style != null) {
