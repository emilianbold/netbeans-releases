...
public abstract class TablePanelsBase extends javax.faces.component.UIComponentBase {

    /**
     * <p>Construct a new <code>TablePanelsBase</code>.</p>
     */
    public TablePanelsBase() {
        super();
        setRendererType("com.sun.rave.web.ui.TablePanels");
    }
    ...
    public String getFamily() {
        return "com.sun.rave.web.ui.TablePanels";
    }
 ...
 * <p>Extra HTML to be appended to the tag output by this renderer.</p>
    ...
    /**
 * <p>Flag indicating this component should also render a filter panel, in addition to
 * the sort and preferences panels. The default renders a sort panel.</p>
     */
    public boolean isFilterPanel() {
        if (this.filterPanel_set) {
            return this.filterPanel;
        }
        ValueBinding _vb = getValueBinding("filterPanel");
        if (_vb != null) {
            Object _result = _vb.getValue(getFacesContext());
            if (_result == null) {
                return false;
 ...
 *     the mouse pointer is on the component.</p>
    ...
    /**
 * <p>Flag indicating this component should also render a preferences panel, in 
 * addition to the sort and filter panels. The default renders a sort panel.</p>
     */
    public boolean isPreferencesPanel() {
        if (this.preferencesPanel_set) {
            return this.preferencesPanel;
        }
        ValueBinding _vb = getValueBinding("preferencesPanel");
        if (_vb != null) {
            Object _result = _vb.getValue(getFacesContext());
            if (_result == null) {
                return false;
