...
public class PasswordFieldTag extends UIComponentTag {
    ...
    protected void setProperties(UIComponent _component) {
        ...
        if (password != null) {
            if (isValueReference(password)) {
                ValueBinding _vb = getFacesContext().getApplication().createValueBinding(password);
                _component.setValueBinding("password", _vb);
            } else {
                _component.getAttributes().put("password", password);
            }
        }
        if (columns != null) {
        ...
        if (trim != null) {
            if (isValueReference(trim)) {
                ValueBinding _vb = getFacesContext().getApplication().createValueBinding(trim);
                _component.setValueBinding("trim", _vb);
            } else {
                _component.getAttributes().put("trim", Boolean.valueOf(trim));
            }
        }
        if (visible != null) {
