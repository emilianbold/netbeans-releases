 ...
 */
public final class PartPK implements java.io.Serializable {
    ...
    public boolean equals(java.lang.Object otherOb) {
        ...
        if (!(otherOb instanceof dataregistry.PartPK)) {
            return false;
        }
        dataregistry.PartPK other = (dataregistry.PartPK) otherOb;
        return (
