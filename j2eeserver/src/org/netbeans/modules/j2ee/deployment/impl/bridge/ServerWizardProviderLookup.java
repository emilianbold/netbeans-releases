...
public class ServerWizardProviderLookup extends AbstractServerLookup<BridgingServerWizardProvider> {
    ...
    private ServerWizardProviderLookup(InstanceContent content) {
        super(content);
    }
    ...
    @Override
    protected void afterAddition(BridgingServerWizardProvider instance) {
        // nothing to do
    }

    @Override
    protected void beforeFinish(BridgingServerWizardProvider instance) {
        // nothing to do
    }

    @Override
    protected void finishBridgingInstance(Server server, BridgingServerWizardProvider instance) {
        // nothing to do
    }
