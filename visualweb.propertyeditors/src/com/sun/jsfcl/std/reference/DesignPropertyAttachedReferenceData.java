...
public class DesignPropertyAttachedReferenceData extends ReferenceData {
     ...
     * @param definer
     */
    public DesignPropertyAttachedReferenceData(ReferenceDataManager manager,
        ReferenceDataDefiner definer, String name, DesignProperty liveProperty) {
    ...
    protected void defineItems() {
        ...
        getDefiner().addDesignPropertyItems(liveProperty, items);
    }
