...
public class ResultSetTargetNodeFactory implements BindingTargetNodeFactory {
    ...
    public class ResultSetTargetNode extends PropertyTargetNode {
        ...
        public void lazyLoadCustomTargetNodes() {
            if (resultSet != null) {
                                    ...
                                    try{
                                        ...
                                        if (cols > 0) {
                                            for (int i = 0; i < cols; i++) {
                                                ...
                                                ResultSetTargetNode.super.add(new ColumnNode(ResultSetTargetNode.this,
                ...
                resuleSetNodeThread.setPriority(Thread.MIN_PRIORITY);
