...
public class BorderStyleEditor extends StyleEditor {
    ...
    public BorderStyleEditor(CssStyleData styleData) {
        setName("borderStyleEditor"); //NOI18N
        setDisplayName(NbBundle.getMessage(StyleBuilderDialog.class, "BORDER_EDITOR_DISPNAME"));
        initComponents();
        borderPanel.add(new BorderDataTable(styleData), BorderLayout.CENTER);
    }
