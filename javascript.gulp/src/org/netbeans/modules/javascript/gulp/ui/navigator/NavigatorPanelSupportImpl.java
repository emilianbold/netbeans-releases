 ...
 */
package org.netbeans.modules.javascript.gulp.ui.navigator;
...
@NbBundle.Messages({
    "NavigatorPanelSupportImpl.name=Gulp Tasks",
    "NavigatorPanelSupportImpl.hint=Displays tasks in the current gulpfile.js script.",
})
public class NavigatorPanelSupportImpl implements BuildTools.NavigatorPanelSupport, ChangeListener {
    ...
    @NavigatorPanel.Registration(mimeType = "text/gulp+javascript", displayName = "#NavigatorPanelSupportImpl.name", position = 100)
