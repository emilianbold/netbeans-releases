...
/**
 * DataSource usage (in a project) change event
 *
 * @author John Kline
 */
public class ProjectDataSourceChangeEvent {
    private String[] dynamicDataSources;
    private String[] hardcodedDataSources;

    ProjectDataSourceChangeEvent(String[] dynamicDataSources, String[] hardcodedDataSources) {
        this.dynamicDataSources = dynamicDataSources;
        this.hardcodedDataSources = hardcodedDataSources;
    }
