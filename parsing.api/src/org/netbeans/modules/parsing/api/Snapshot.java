 ...
 * file. Snapshot is read only and immutable. It means that Snapshot created 
 ...
 *
 * Following example shows how to create Snapshot for block of code 
 * embedded in other source:
 * {@link org.netbeans.modules.parsing.spi.EmbeddingProviderder}:
 * 
 * <pre> 
...
public final class Snapshot {
     ...
     *                      a offset related to original source
     * @return              position of given offset in original document or file
     */
