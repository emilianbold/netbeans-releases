...
*/
public abstract class RESTComponentImpl extends GenericExtensibilityElement 
        implements RESTComponent {

    public RESTComponentImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
    @Override
    protected String getNamespaceURI() {
        return RESTQName.REST_NS_URI;
    }
}
