...
public class RESTTemplateProvider extends ExtensibilityElementTemplateProvider {
    
    static final String restTemplateUrl = "/org/netbeans/modules/wsdlextensions/rest/template/template.xml";

    public InputStream getTemplateInputStream() {
        return RESTTemplateProvider.class.getResourceAsStream(restTemplateUrl);
    }

    public String getLocalizedMessage(String str, Object[] objects) {
        return NbBundle.getMessage(RESTTemplateProvider.class, str, objects);
    }

    @Override
     public InputStream getTemplateFileInputStream(String filePath) {
         return RESTTemplateProvider.class.getResourceAsStream("/org/netbeans/modules/wsdlextensions/rest/template/" + filePath);
     }
    
     @Override
     public WSDLWizardExtensionIterator getWSDLWizardExtensionIterator(WSDLWizardContext context) {
         return new RESTWSDLWizardExtensionIterator(context);
     }
