...
public interface AddressURL {
    public static final String  REST_URL_PLACEHOLDER = "rest://[rest_host]:[rest_port]";
    ...
    public boolean parse(Collection<ResultItem> results, Validator validator, RESTAddress target);
}
