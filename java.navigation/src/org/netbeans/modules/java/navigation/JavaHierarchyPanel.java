          ...
          layout.setHorizontalGroup(
               ...
               .add(layout.createSequentialGroup()
                    ...
                    .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                         .add(splitPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 717, Short.MAX_VALUE)
                         .add(layout.createSequentialGroup()
                              .add(filterLabel)
                         ...
                         .add(signatureEditorPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 717, Short.MAX_VALUE)
                         .add(layout.createSequentialGroup()
                              .add(filtersLabel)
                              .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                              .add(filtersToolbar, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 610, Short.MAX_VALUE)
                              .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                              .add(closeButton)))
                    .addContainerGap())
          );
