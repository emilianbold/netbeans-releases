...
public class ElementNode extends AbstractNode {
    ...
    public ElementNode( Description description ) {
        super(description.subs == null ? Children.LEAF: new ElementChilren(description.subs, description.ui.getFilters()), description.treePathHandle==null?null:Lookups.fixed(description.treePathHandle, description.treePathHandle.getFileObject()));
