...
public class ParseProjectXmlTest extends NbTestCase {
    ...
    private void doScanBinariesForOSGi(String whereTo, String cnb) throws Exception {
        ...
        fakeproj.setProperty("cluster.path.final", filePath(nball, "nbbuild/netbeans/platform10")
        ...
        fakeproj.setProperty("suite.dir", filePath(nball, "apisupport.project/test/unit/data/example-external-projects/suite1"));
