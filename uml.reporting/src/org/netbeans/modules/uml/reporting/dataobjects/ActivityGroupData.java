 ...
 * @author Sheryl
 */
public class ActivityGroupData extends ElementDataObject
{
    
    private IActivityGroup element;
    /** Creates a new instance of ActivityGroupData */
    public ActivityGroupData()
    {
    }
    ...
    {
        if (e instanceof IActivityGroup)
        {
            this.element = (IActivityGroup)e;
        }
    }
    
    
    public IActivityGroup getElement()
    {
        return element;
    }
