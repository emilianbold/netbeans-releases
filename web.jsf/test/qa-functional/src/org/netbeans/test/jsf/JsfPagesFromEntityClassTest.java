...
public class JsfPagesFromEntityClassTest extends J2eeTestCase{
    ...
    public static Test suite() {
        return NbModuleSuite.create(addServerTests(Server.GLASSFISH, NbModuleSuite.createConfiguration(JsfPagesFromEntityClassTest.class), "testCreateEntityClassAndPU").enableModules(".*").clusters(".*")); 
    }
