...
import static org.netbeans.modules.web.jsf.wizards.PersistenceClientSetupPanelVisual.BASE_TEMPLATE_PATH;
import static org.netbeans.modules.web.jsf.wizards.PersistenceClientSetupPanelVisual.STANDARD_TEMPLATE_PATH;
...
//                                assert !jsf2Generator : "jsf2 generator works only with EJBs";
    ...
    private static void generateJsfControllers2(
        ...
        for (int i = 0; i < UTIL_CLASS_NAMES2.length; i++){
            if (utilFolder.getFileObject(UTIL_CLASS_NAMES2[i], JAVA_EXT) == null) {
                ...
                progressContributor.progress(progressMsg, progressIndex++);
                progressPanel.setText(progressMsg);
                FileObject tableTemplate = FileUtil.getConfigRoot().getFileObject(BASE_TEMPLATE_PATH + "/" + STANDARD_TEMPLATE_PATH + "/"+ UTIL_CLASS_NAMES2[i] + ".ftl");
    ...
    private static void expandSingleJSFTemplate(String templateName, String entityClass,
        ...
        FileObject template = FileUtil.getConfigRoot().getFileObject(BASE_TEMPLATE_PATH + "/" + STANDARD_TEMPLATE_PATH + "/" + templateName);
