...
import org.netbeans.modules.xslt.core.text.completion.support.XSLDataObject;
 ...
 * @author  Petr Kuzel
 */
public class XSLTGrammarQueryProvider extends GrammarQueryManager {
...
//                }
    ...
    public GrammarQuery getGrammar(GrammarEnvironment input) {
        ...
        try {
            ...
            if (fo == null) throw new IllegalStateException(
                "GrammarEnvironment has changed between enabled() and getGrammar()!"); // NOI18N
            DataObject dataObj = DataObject.find(fo);
            return new XSLGrammarQuery(dataObj);
        } catch (DataObjectNotFoundException e) {
            throw new IllegalStateException("Missing DataObject " + 
                e.getFileObject() + "!"); // NOI18N
        } 
    }
}