...
//                                    new ComponentChangeListenerImpl();
    ...
    private ProjectsFilesChangeListener myProjectsFilesChangeListener = 
                                    new ProjectsFilesChangeListenerImpl();
    ...
    // TODO m
    public MapperContextImpl(Transform transform, 
            XslModel xslModel, 
            ...
            AXIComponent targetComponent) 
    {
        ...
        myXslFo = myXslModel == null 
                ? null : org.netbeans.modules.xslt.core.util.Util.getFileObjectByModel(myXslModel);
    }
    ...
    private void init(
            ...
            AXIComponent targetComponent) 
    {
        init(transform == null ? null : transform.getModel(),
                transform, xslModel, sourceComponent, targetComponent);
    }
    ...
    public void setTransformContextComponent(TMapModel tMapModel, Transform context) {
        ...
        if ((myTMapModel != null && !myTMapModel.equals(oldTMapModel))
                || (oldTMapModel != null && !oldTMapModel.equals(myTMapModel))) 
        {
        ...
        if ((myTransformContextComponent != null && !myTransformContextComponent.equals(oldTransform))
                || (oldTransform != null && !oldTransform.equals(myTransformContextComponent))) 
        {
            if (myTMapFo != null) {
    ...
    public void setXslModel(XslModel xslModel) {
        ...
        if ((myXslModel != null && !myXslModel.equals(oldXslModel))
                || (oldXslModel != null && !oldXslModel.equals(myXslModel))) 
        {
            if (myXslFo != null) {
    ...
    protected void setTargetType(AXIComponent axiComp) {
        ...
        if ((myTargetComponent != null && !myTargetComponent.equals(oldValue))
                || (oldValue != null && !oldValue.equals(myTargetComponent))) 
        {
            if (oldValue != null) {
    ...
    protected void setSourceType(AXIComponent axiComp) {
        ...
        if ((mySourceComponent != null && !mySourceComponent.equals(oldValue))
                || (oldValue != null && !oldValue.equals(mySourceComponent))) 
        {
            if (oldValue != null) {
                oldValue.removePropertyChangeListener(myContextChangeListener);
            }
    ...
    private void setSourcePart(WSDLReference<Part> sourcePart) {
        ...
        if ((mySourceModel != null && !mySourceModel.equals(oldSourceModel))
                || (oldSourceModel != null && !oldSourceModel.equals(mySourcePart))) 
        {
    ...
    private WSDLReference<Part> getSourcePart(Transform transform) {
        VariableReference varRef = transform == null 
                ? null : transform.getSource();
    ...
    private void setTargetPart(WSDLReference<Part> targetPart) {
        ...
        if ((myTargetModel != null && !myTargetModel.equals(oldTargetModel))
                || (oldTargetModel != null && !oldTargetModel.equals(myTargetPart))) 
        {
...
//            myTMapModel.addComponentListener(myContextComponentListener);
        ...
        if (myXslFo != null) {
            ...
            myProjectsFilesChangeHandler =  xsltProject.getLookup().
                    lookup(ProjectsFilesChangeHandler.class);
            if (myProjectsFilesChangeHandler != null) {
                myProjectsFilesChangeHandler.
                    addProjectsFilesChangeListener(myProjectsFilesChangeListener);
            }
        }
...
//            myTMapModel.removeComponentListener(myContextComponentListener);
        ...
        if (myProjectsFilesChangeHandler != null) {
            myProjectsFilesChangeHandler.
                    removeProjectsFilesChangeListener(myProjectsFilesChangeListener);
        }
...
//                myChangeSupport.fireTargetTypeChanged(myTargetComponent, myTargetComponent);
                ...
                reinitContext();
            } else if (sourceObj instanceof WSDLComponent 
                    && (newValue instanceof Part || oldValue instanceof Part) ) 
            {
                reinitContext();
            } else {
