 ...
 * @author marekfukala
 */
public class BorderTest extends CssTestBase {
...
//        dumpTree(root);
        ...
        ModelBuilderNodeVisitor<NodeModel> modelvisitor = new ModelBuilderNodeVisitor<NodeModel>(PropertyModelId.BORDER);
        ...
        assertEquals(3, borderColor.getColorModels().size());
        Color colorModel1 = borderColor.getColorModels().get(0);
        Color colorModel2 = borderColor.getColorModels().get(1);
        Color colorModel3 = borderColor.getColorModels().get(2);
...
//        dumpTree(root);
    ...
    private static void dumpBox(Box<BoxEdgeBorder> box) {
        Utils.dumpBox(box);
    }

    private static void assertBox(Box<BoxEdgeBorder> box, String top, String right, String bottom, String left) {
