...
import org.netbeans.modules.wsdlextensions.sap.wizard.ConnectionChooserStepWizardPanel;
import org.netbeans.modules.wsdlextensions.sap.wizard.ObjectSelectionStepWizardPanel;
 ...
 * @author jqian
 */
public class SAPWSDLWizardExtensionIterator extends WSDLWizardExtensionIterator {
    ...
    public SAPWSDLWizardExtensionIterator(WSDLWizardContext context) {
        super(context);
    }
    ...
    public void setTemplateName(String templateName) {
        ...
        if (templateName.equals(NbBundle.getMessage(
                SAPWSDLWizardExtensionIterator.class,
                "TEMPLATE_name_SAP_IN_OR_OUT"))) {
            panels = new WSDLWizardDescriptorPanel[]{
                        new ConnectionChooserStepWizardPanel(context),
                        new ObjectSelectionStepWizardPanel(context)
                    };
        }
    ...
    public boolean commit() {
        ...
        for (WSDLWizardDescriptorPanel panel : panels) {
            if (panel instanceof ObjectSelectionStepWizardPanel) {
                status = ((ObjectSelectionStepWizardPanel) panel).commit();
                break;
            }
        }
