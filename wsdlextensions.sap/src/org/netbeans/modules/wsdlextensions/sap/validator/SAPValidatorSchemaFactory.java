...
public class SAPValidatorSchemaFactory extends ValidatorSchemaFactory {
    ...
    private static final String SAP_XSD_URL =
            "/org/netbeans/modules/wsdlextensions/sap/resources/sap-ext.xsd"; // NOI18N
    ...
    public InputStream getSchemaInputStream() {
        return SAPValidatorSchemaFactory.class.getResourceAsStream(SAP_XSD_URL);
    }
    ...
    public Source getSchemaSource() {
        InputStream in = SAPValidatorSchemaFactory.class.getResourceAsStream(SAP_XSD_URL);
        Source s = new StreamSource(in);
        s.setSystemId(SAPValidatorSchemaFactory.class.getResource(SAP_XSD_URL).toString());
        return s;
    }
}
