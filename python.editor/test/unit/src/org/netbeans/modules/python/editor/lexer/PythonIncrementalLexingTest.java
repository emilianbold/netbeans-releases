...
// Grr, this doesn't work outside the NB build tree!!! GRRRR
...
/**
 * Randomly edit the document and test the incremental operation
 *
 */
public class PythonIncrementalLexingTest extends TestCase {

    public PythonIncrementalLexingTest(String testName) {
        super(testName);
    }
    ...
    private void test(long seed) throws Exception {
        ...
        randomModify.setLanguage(PythonTokenId.language());
