...
/**
 * BeanInfo for textual diff visualizer.
 *
 * @author Martin Entlicher
 */
public class TextDiffVisualizerBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            contextMode.setDisplayName      (NbBundle.getMessage(TextDiffVisualizerBeanInfo.class, "PROP_contextMode"));
            contextMode.setShortDescription (NbBundle.getMessage(TextDiffVisualizerBeanInfo.class, "HINT_contextMode"));
            PropertyDescriptor contextNumLines = new PropertyDescriptor("contextNumLines", TextDiffVisualizer.class);
            contextNumLines.setDisplayName      (NbBundle.getMessage(TextDiffVisualizerBeanInfo.class, "PROP_contextNumLines"));
