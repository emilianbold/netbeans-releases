...
public class XMPPPersonalGroup extends XMPPPersonalStoreEntry implements org.netbeans.lib.collab.PersonalGroup {
    ...
    /** Creates a new instance of XMPPPersonalGroup */
    public XMPPPersonalGroup(XMPPSession s, String name, String jid) {
        super(s, name, PersonalStoreEntry.GROUP, jid);
    }

    public java.util.Collection expand() {
        return super._personalStoreService.expandGroup(this);
    }
    ...
    public CollaborationGroup getGroup() {
        return new XMPPGroup(new org.jabberstudio.jso.JID(_jid), _displayName);
    }
}
