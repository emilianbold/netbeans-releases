...
import org.netbeans.lib.collab.xmpp.jso.iface.x.muc.MUCQuery;
 ...
 *
 */
public class MUCQueryNode extends ExtensionNode implements MUCQuery {
    //"Constants"
    public static final NSI     ELEMNAME_PASSWD    = new NSI("password", null);
    
    /** Creates a new instance of MUCQueryNode */
    public MUCQueryNode(StreamDataFactory sdf) {
        super(sdf, NAME);
    }
    
    protected MUCQueryNode(StreamElement parent, MUCQueryNode base) {
        super(parent, base);
    }
    ...
    public StreamObject copy(StreamElement parent) {
        return new MUCQueryNode(parent, this);
    }
}
