...
public class MUCAdminQueryNode extends ExtensionNode implements MUCAdminQuery {
    ...
    /** Creates a new instance of MUCAdminQueryNode */
    public MUCAdminQueryNode(StreamDataFactory sdf) {
        super(sdf, NAME);
    }
    
    protected MUCAdminQueryNode(StreamElement parent, MUCAdminQueryNode base) {
        super(parent, base);
    }
    
    public StreamObject copy(StreamElement parent) {
        return new MUCAdminQueryNode(parent, this);
    }
