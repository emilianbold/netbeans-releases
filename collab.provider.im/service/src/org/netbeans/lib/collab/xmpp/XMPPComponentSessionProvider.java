...
public class XMPPComponentSessionProvider extends XMPPSessionProvider {
    ...
    public XMPPComponentSessionProvider() {
    }
    ...
    {
        return new XMPPComponentSession(this, serviceUrl, destination,
                                        loginName, password, loginType,
                                        collaborationSessionListener,
                    new SocketStreamSourceCreator(collaborationSessionListener));
    }

    String getNode(String loginName) {
        return null;
    }
