...
public class JSOSASLProviderFactory implements SASLClientProviderFactory{
    ...
    public JSOSASLProviderFactory(String mechanism) {
        if (null == mechanism){
            throw new NullPointerException("mechanism == null");
        }
     ...
     * authentication
     */
    public SASLClientProvider createInstance(String mech){
        if (null == mech || !mech.equals(mechanism)){
            throw new java.lang.IllegalArgumentException("Unspoorted mechanism : " + mech +
                    ", supported mechanism : " + mechanism);
        }
        return new JSOSASLProvider(mechanism);
    }
}
