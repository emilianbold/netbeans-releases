 ...
 *
 */
public interface PubSubEvent extends Extension {

    /**
     * Namespace governing <code>PubSubEvent</code>
     */
    ...
    public static final NSI NAME = new NSI("event", NAMESPACE);
    
    public StreamElement createDeleteElement(String node) throws IllegalArgumentException;
    public PubSubItems createPubSubItemsElement(String node) throws IllegalArgumentException;
