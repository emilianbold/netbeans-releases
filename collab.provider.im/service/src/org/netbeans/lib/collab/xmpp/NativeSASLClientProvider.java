...
/**
 * Private interface which signals that the client side provider wants to have
 * direct access to the native packets.
...
public interface NativeSASLClientProvider extends SASLClientProvider{
    ...
    /**
     * Opaque implementation dependent packet request will be passed in.
     * The response should be an implementation dependent packet.
     */
