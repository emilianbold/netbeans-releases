...
public class DestroyNode extends ElementNode implements Destroy {
    ...
    public DestroyNode(StreamDataFactory sdf, String namespace) {
        super(sdf, new NSI(Destroy.NAME, namespace));
    }
    
    protected DestroyNode(StreamElement parent, DestroyNode base) {
        super(parent, base);
    }
    ...
    public StreamObject copy(StreamElement parent) {
        return new DestroyNode(parent, this);
    }
}
