...
public class InviteNode extends ExtensionNode implements Invite {
    ...
    public static final NSI     ELEMNAME_CONTINUE = new NSI("continue", null);
    
    public InviteNode(StreamDataFactory sdf) {
        super(sdf, Invite.NAME);
    }
    
    
    protected InviteNode(StreamElement parent, InviteNode base) {
        super(parent, base);
    }
    ...
    public StreamObject copy(StreamElement parent) {
        return new InviteNode(parent, this);
    }
    ...
    public void setContinue() {
        StreamElement cont = getFirstElement(ELEMNAME_CONTINUE);
        if (cont == null)
            cont = addElement(ELEMNAME_CONTINUE);
    }
