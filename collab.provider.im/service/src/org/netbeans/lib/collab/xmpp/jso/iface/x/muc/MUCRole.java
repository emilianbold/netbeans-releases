...
public class MUCRole {
    ...
    /**
     * <p>
     * Class enumerating role types.</p>
     *
     */
    ...
    /** MODERATOR
     */
    public static final Type MODERATOR = new Type("moderator");

    /** PARTICIPANT
     */
    public static final Type PARTICIPANT = new Type("participant");
    
    /** VISITOR
     */
    public static final Type VISITOR = new Type("visitor");
