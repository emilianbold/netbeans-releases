...
public class AMPNodeFactory extends AbstractElementFactory {
    ...
    {
        putSupportedElement(AMPExtension.NAME,
                            new AMPExtensionNode(null));
        
        putSupportedElement(AMPExtension.NAME_ERROR,
                            new AMPExtensionNode(null, AMPExtension.NAME_ERROR));
        
        putSupportedElement(AMPRule.NAME,
			    new AMPRuleNode(null));
