...
public class AddressExtensionNode extends ExtensionNode implements AddressExtension 
{
    ...
    public AddressExtensionNode(StreamDataFactory sdf) {
        super(sdf, NAME);
    }
    
    public AddressExtensionNode(StreamDataFactory sdf, NSI nsi) {
        super(sdf,nsi);
    }

    public AddressExtensionNode(StreamElement parent,
                            AddressExtensionNode base) {
        super(parent, base);
    }
    ...
    {
        Address a = (Address)addElement("address", Address.class);
        a.setType(type);
        a.setJID(jid);
        return a;
    }
    ...
    public void removeAddress(Address a) {
        remove((AddressNode)a);
    }
    
    public List listAddresses() {
        return listElements("address");
    }
    
    public StreamObject copy(StreamElement parent) {
        return new AddressExtensionNode(parent,this);
    }
