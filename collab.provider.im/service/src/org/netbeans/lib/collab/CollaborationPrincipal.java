 ...
 *
 */
public interface CollaborationPrincipal extends java.security.Principal {
    ...
    /**
     * retrieve the names of all properties available,
     * both single and multi-valued.
     */
     ...
     */
    public Set getAttributeValues(String attribute);
