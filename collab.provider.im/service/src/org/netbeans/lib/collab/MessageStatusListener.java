...
/**
 * A MessageStatusListener is instantiated by the application, passed to the
 * alert method in Session and later used to convey statusses and responses
 * to the sender.
 *
 *
 * @since version 0.1
...
public interface MessageStatusListener {
     ...
     * @see MessageStatus
     * @return whether more status receipts are expected.  If false is returned
     * This method will no longer be invoked for this recipient.
     */ 
