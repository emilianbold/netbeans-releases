...
public interface StreamingServiceListener {
     ...
     * @param sender - The initiator of the stream
     * @param profile - The profile containing the meta data about the stream.
     * @param stream The ContentStream containing more information on the requested stream.
     */
