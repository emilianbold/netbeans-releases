...
public class AuthorizationException extends CollaborationException {
    ...
    public AuthorizationException(String msg, int condition) {
        super(msg, condition);
    }

    public AuthorizationException(Throwable t, int condition) {
        super(t, condition);
    }
    
    public AuthorizationException(String msg, Throwable t, int condition) {
        super(msg, t, condition);
    }
