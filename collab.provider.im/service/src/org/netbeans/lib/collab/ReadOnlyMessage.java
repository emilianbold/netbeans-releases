...
public interface ReadOnlyMessage extends ReadOnlyMessagePart {
    ...
    /**
     * provides the list of message processing rules contained 
     * in this message.
     * @return List of MessageProcessingRule objects.  The returned list 
     * may be null if no processing rule is attached to this message.
     */
