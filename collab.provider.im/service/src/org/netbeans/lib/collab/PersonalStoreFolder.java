...
public interface PersonalStoreFolder extends PersonalStoreEntry {
     ...
     * @param entryType  the type for filter on
     */
    public java.util.Collection getEntries(String entryType) throws CollaborationException;
     ...
     * @param displayName new display name for this folder
     */
