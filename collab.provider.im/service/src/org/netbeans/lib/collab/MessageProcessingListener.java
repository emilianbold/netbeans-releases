...
public interface MessageProcessingListener extends CollaborationSessionListener {
     ...
     * @param deliveryStatus delivery status(as defined in MessageStatus) of a previously sent message.
     * @param includedError if the received packet contains an error element
     *     this argument contains the error information.  null if the packet
     *     is not an error
     */
    public void onMessageStatus(Message message, int deliveryStatus, 
