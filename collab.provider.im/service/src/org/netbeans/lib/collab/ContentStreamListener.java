...
public interface ContentStreamListener {
     ...
     */
    public final int STATUS_STREAM_OK = 0;

    /**
     * Status which indicates that the stream was rejected
     */
    public final int STATUS_STREAM_REJECTED = 1;

    /**
     * Status which indicates that the stream was disconnected
     */
    public final int STATUS_STREAM_DISCONNECTED = 2;

    /**
     * Status which indicates that the stream was aborted
     */
    public final int STATUS_STREAM_ABORTED = 3;
     ...
     * @param status The status of the stream as defined in ContentStreamListener
