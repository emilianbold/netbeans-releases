...
import org.netbeans.modules.xslt.tmap.nodes.ImportNode;
 ...
 */
public class OpenInEditorAction extends TMapAbstractNodeAction {
    ...
    public void performAction(Node[] nodes) {
        ...
        Import imprt = ((ImportNode)nodes[0]).getReference().getReference();
        if (imprt == null) {
            return;
        }
