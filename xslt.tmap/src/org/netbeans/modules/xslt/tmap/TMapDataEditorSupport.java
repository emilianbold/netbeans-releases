        ...
        OpenCookie, EditCookie, EditorCookie.Observable, ShowCookie
{
    ...
    /**
     * @return TransformMap Model for this editor.
     */
    public TMapModel getTMapModel() {
        TMapDataObject dataObject = getEnv().getTMapDataObject();
...
//                }
    ...
    protected CloneableEditorSupport.Pane createPane() {
        TopComponent multiview = TMapMultiViewSupport
                .createMultiView((TMapDataObject) getDataObject());
...
//        getValidationController().detach();
     ...
     */
    private static class TMapEnv extends DataEditorSupport.Env {

        private static final long serialVersionUID = 835762240381934851L;
        
        public TMapEnv(TMapDataObject dObj) {
            super(dObj);
        }
        
        public TMapDataObject getTMapDataObject() {
            return (TMapDataObject) getDataObject();
        }
...
//        getValidationController().attach();
   ...
   @Override
    ...
    private TMapModelFactory getModelFactory() {
        TMapModelFactory factory = (TMapModelFactory) Lookup.getDefault()
            .lookup(TMapModelFactory.class);
        return factory;
    }
 ...
 */
            ...
            Serializable 
    {
        ...
        public CloseHandler( TMapDataObject obj ) {
            myDataObject = obj;
        }
        
        public boolean resolveCloseOperation( CloseOperationState[] elements ) {
            TMapDataEditorSupport support = myDataObject == null ? null
                    : (TMapDataEditorSupport) myDataObject
                    .getCookie(TMapDataEditorSupport.class);
            if (support == null) {
                return true;
            }
