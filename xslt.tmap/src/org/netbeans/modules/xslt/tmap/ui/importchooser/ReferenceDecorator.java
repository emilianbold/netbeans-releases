...
public class ReferenceDecorator extends AbstractReferenceDecorator {
    ...
    private TransformMap myTransformMap;
     ...
     */
    public ReferenceDecorator(TransformMap transformMap, ExternalReferenceCreator creator,
    ...
    public String validate(ExternalReferenceNode node) {
        if (node.hasModel()) {
            ...
            //
            // Component selectedModel always has to be the TMap selectedModel
            Model componentModel = myRefCreator.getComponentModel();
            if (componentModel instanceof TMapModel) {
                TMapModel tMapModel = (TMapModel)componentModel;
                if (ResolverUtility.isModelImported(selectedModel, tMapModel)) {
                    return NbBundle.getMessage(ReferenceDecorator.class,
