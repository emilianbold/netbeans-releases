 ...
 * @version 1.0
 */
public class InputVariableImpl extends AbstractVariable {
    OperationReference myOperationRef;
    
    public InputVariableImpl(TMapModelImpl model, String varName, OperationReference operationRef) {
    ...
    public Reference<Message> getMessage() {
        ...
        return getMessage(operation.getInput());
    }
