 ...
 * @version 1.0
 */
public class CompletionModelImpl extends CompletionModel {

    private SchemaModel myModel;
    
    public CompletionModelImpl(SchemaModel model) {
        myModel = model;
    }
    ...
    public String getTargetNamespace() {
        return myModel == null ? null : myModel.getSchema().getTargetNamespace();
    }
