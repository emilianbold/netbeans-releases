 ...
 * @version 1.0
 */
public abstract class NameableTMapComponentContainerImpl extends TMapComponentContainerImpl 
    implements Nameable 
{

    public NameableTMapComponentContainerImpl(TMapModelImpl model, Element element) {
        super(model, element);
    }
