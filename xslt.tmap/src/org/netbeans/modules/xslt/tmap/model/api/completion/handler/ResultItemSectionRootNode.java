 ...
 */
public class ResultItemSectionRootNode extends TMapCompletionResultItem {
    public ResultItemSectionRootNode(String itemText, Document document, int caretOffset) {
    ...
    public void render(Graphics g, Font defaultFont, Color defaultColor, 
        ...
        // draw a line, which should separate different sections
