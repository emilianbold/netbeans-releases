...
/**
 * @author Alex Petrov (12.07.2008)
 */
public class HandlerInvokeOpName extends HandlerOperationOpName {
    //<invoke name="Invoke1" inputVariable="inInvokeVar1" outputVariable="outInvokeVar1" 
    //        portType="ns2:commentWSDLPortType" opName="commentWSDLOperation"/>
    ...
    public List<TMapCompletionResultItem> getResultItemList(
        ...
        return getOperationNameList(TAG_NAME_INVOKE);
    }
}