 ...
 *
 */
class PhpParseResult extends ParserResult {

    PhpParseResult( ParserFile file, PhpModel model ) {
        super( file );
        myModel = model;
    }

    /* (non-Javadoc)
     * @see org.netbeans.fpi.gsf.ParserResult#getAst()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.netbeans.fpi.gsf.ParserResult#getRoot()
     */
    @Override
