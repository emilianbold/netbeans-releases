...
//            new ImageIcon(org.openide.util.Utilities.loadImage(ICON_FILE));
    ...
    public String getLhsHtml() {
        ...
        formatter.appendText(myKeyword.value());
