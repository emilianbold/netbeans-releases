...
public class J2SEProjectAntArtifact extends AntArtifact {
     ...
     */
    public J2SEProjectAntArtifact(J2SEProject project, String type, String locationProperty, String targetName, String cleanTargetName) {
    ...
    public File getScriptLocation() {
        return this.project.getAntProjectHelper().resolveFile(J2SEProjectUtil.getBuildXmlName(project));        
    }
