 ...
 * EditBinding.java
 *
 * Created on April 19, 2006, 5:59 PM
 */
...
public class EditBinding extends JPanel implements TableModelListener {
    ...
    public EditBinding(Base bean, MessageSecurityBinding binding, boolean asOperation, 
...
//        jLblMessageBinding.setLabelFor(messageSecurityTable);
        ...
        messageSecurityModel = new GenericTableModel(messageSecurityFactory, tableColumns);
    ...
    private void commit() {
        MessageSecurityBinding oldBinding = (MessageSecurityBinding) msBinding.clone();
        ...
        // Mark bean as dirty.  Note that property name here notes endpoint, but
