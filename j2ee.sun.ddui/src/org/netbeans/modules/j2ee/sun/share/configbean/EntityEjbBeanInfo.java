...
public class EntityEjbBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_beanPool = 1;
    private static final int PROPERTY_commitOption = 2;
    private static final int PROPERTY_ejbName = 3;
    private static final int PROPERTY_identity = 4;
    private static final int PROPERTY_iorSecurityConfig = 5;
    private static final int PROPERTY_isReadOnlyBean = 6;
    private static final int PROPERTY_jndiName = 7;
    private static final int PROPERTY_passByReference = 8;
    private static final int PROPERTY_refreshPeriodInSeconds = 9;
