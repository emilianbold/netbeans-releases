...
import org.netbeans.modules.j2ee.sun.ddloaders.multiview.jms.MessageDestinationRefNode;
 ...
 */
public class MessageDestinationRefPanel extends BaseSectionNodeInnerPanel {

    // data model & version
    private MessageDestinationRefNode msgDestRefNode;

    public MessageDestinationRefPanel(SectionNodeView sectionNodeView, final MessageDestinationRefNode msgDestRefNode, 
            final ASDDVersion version) {
        super(sectionNodeView, version);
        this.msgDestRefNode = msgDestRefNode;
    ...
    private void initUserComponents(SectionNodeView sectionNodeView) {
        ...
        addRefreshable(new ItemEditorHelper(jTxtName, new MsgDestRefTextFieldEditorModel(synchronizer, MessageDestinationRef.MESSAGE_DESTINATION_REF_NAME)));
        addRefreshable(new ItemEditorHelper(jTxtJndiName, new MsgDestRefTextFieldEditorModel(synchronizer, MessageDestinationRef.JNDI_NAME)));

        jTxtName.setEditable(!msgDestRefNode.getBinding().isBound());
    }
    ...
    private void initComponents() {
        ...
        jLblName.setText(customizerBundle.getString("LBL_MessageDestinationReferenceName_1")); // NOI18N
        ...
        jTxtName.getAccessibleContext().setAccessibleName(customizerBundle.getString("ACSN_MessageDestinationReferenceName")); // NOI18N
        jTxtName.getAccessibleContext().setAccessibleDescription(customizerBundle.getString("ACSD_MessageDestinationReferenceName")); // NOI18N
    ...
    private class MsgDestRefTextFieldEditorModel extends DDTextFieldEditorModel {

        public MsgDestRefTextFieldEditorModel(XmlMultiViewDataSynchronizer synchronizer, String propertyName) {
            super(synchronizer, propertyName);
        }
        
        protected CommonDDBean getBean() {
            return msgDestRefNode.getBinding().getSunBean();
        }
        ...
        protected void setValue(String value) {
            ...
            if(msgDestRefNode.addVirtualBean()) {
                // update if necessary
            }
        }
    }
