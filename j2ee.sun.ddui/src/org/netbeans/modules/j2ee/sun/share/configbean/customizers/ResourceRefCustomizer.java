...
public class ResourceRefCustomizer extends BaseCustomizer implements PropertyChangeListener {
    ...
    private void initComponents() {
        ...
        jLblPrincipalName.setText(customizerBundle.getString("LBL_ResPrincipalName_1"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.ipady = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        jTxtPrincipalName.getAccessibleContext().setAccessibleName(customizerBundle.getString("ACSN_ResPrincipalName"));
        jTxtPrincipalName.getAccessibleContext().setAccessibleDescription(customizerBundle.getString("ACSD_ResPrincipalName"));

        jLblPrincipalPassword.setLabelFor(jTxtPrincipalPassword);
        jLblPrincipalPassword.setText(customizerBundle.getString("LBL_ResPrincipalPassword_1"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.ipady = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        jTxtPrincipalPassword.getAccessibleContext().setAccessibleName(customizerBundle.getString("ACSN_ResPrincipalPassword"));
        jTxtPrincipalPassword.getAccessibleContext().setAccessibleDescription(customizerBundle.getString("ACSD_ResPrincipalPassword"));
	...
	private void jTxtPrincipalPasswordKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTxtPrincipalPasswordKeyReleased
        if(theBean != null) {
            String oldPrincipalPassword = theBean.getPrincipalPassword();
            try {
                String newPrincipalPassword = jTxtPrincipalPassword.getText().trim();
                if(!newPrincipalPassword.equals(oldPrincipalPassword)) {
                    theBean.setPrincipalPassword(newPrincipalPassword);
                }
            } catch(PropertyVetoException ex) {
                jTxtPrincipalPassword.setText(oldPrincipalPassword);
            }
        }		
	...
	private void jTxtPrincipalNameKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTxtPrincipalNameKeyReleased
        if(theBean != null) {
            String oldPrincipalName = theBean.getPrincipalName();
            try {
                String newPrincipalName = jTxtPrincipalName.getText().trim();
                if(!newPrincipalName.equals(oldPrincipalName)) {
                    theBean.setPrincipalName(newPrincipalName);
                }
            } catch(PropertyVetoException ex) {
                jTxtPrincipalName.setText(oldPrincipalName);
            }
        }
