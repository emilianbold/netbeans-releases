 ...
 */
public class SunWebOverviewMultiViewElement extends DDMultiViewElement {

    /**
     * Creates a new instance of DDMultiViewElement
     */
    public SunWebOverviewMultiViewElement(SunDescriptorDataObject dataObject) {
        super(dataObject);
    }

    protected SectionView createView() {
        return new SunWebView(dataObject);
    }
