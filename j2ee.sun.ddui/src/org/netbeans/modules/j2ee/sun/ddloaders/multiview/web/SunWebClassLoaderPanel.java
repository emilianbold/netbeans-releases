...
public class SunWebClassLoaderPanel extends BaseSectionNodeInnerPanel {
    ...
    private void initComponents() {
        ...
        getAccessibleContext().setAccessibleName(webappBundle.getString("ACSN_WebAppGeneralTab")); // NOI18N
        getAccessibleContext().setAccessibleDescription(webappBundle.getString("ACSD_WebAppGeneralTab")); // NOI18N
