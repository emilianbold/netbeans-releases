 ...
 */
public class ServletMultiViewElement extends DDMultiViewElement {

    /**
     * Creates a new instance of DDMultiViewElement
     */
    public ServletMultiViewElement(SunDescriptorDataObject dataObject) {
        super(dataObject);
    }

    protected SectionView createView() {
        return new ServletView(dataObject);
    }
