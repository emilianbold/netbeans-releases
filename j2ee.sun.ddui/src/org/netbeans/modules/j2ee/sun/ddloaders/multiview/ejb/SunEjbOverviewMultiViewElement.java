 ...
 */
public class SunEjbOverviewMultiViewElement extends DDMultiViewElement {

    /**
     * Creates a new instance of DDMultiViewElement
     */
    public SunEjbOverviewMultiViewElement(SunDescriptorDataObject dataObject) {
        super(dataObject);
    }

    protected SectionView createView() {
        return new SunEjbJarView(dataObject);
    }
