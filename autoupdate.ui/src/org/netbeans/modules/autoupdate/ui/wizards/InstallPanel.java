...
public class InstallPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pbPlaceHolder.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(InstallPanel.class, "InstallPanel_pbPlaceHolder_ACN")); // NOI18N
        pbPlaceHolder.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(InstallPanel.class, "InstallPanel_pbPlaceHolder_ACD")); // NOI18N
        ...
        rbRestartNow.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(InstallPanel.class, "InstallPanel_rbRestartNow_ACD")); // NOI18N
        rbRestartLater.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(InstallPanel.class, "InstallPanel_rbRestartLater_ACD")); // NOI18N
