...
public class MessageReceiversImpl extends ServicesComponentImpl implements MessageReceivers {
    
    public MessageReceiversImpl(ServicesModelImpl model, Element e) {
        super(model, e);
    }
    
    public MessageReceiversImpl(ServicesModelImpl model) {
        this(model, createElementNS(model, ServicesQNames.MESSAGE_RECEIVERS));
    }
    ...
    public List<MessageReceiver> getMessageReceivers() {
        return getChildren(MessageReceiver.class);
    }

    public void addMessageReceiver(MessageReceiver receiver) {
        appendChild(MESSAGE_RECEIVER_PROP,receiver);
    }

    public void removeMessageReceiver(MessageReceiver receiver) {
        removeChild(MESSAGE_RECEIVER_PROP,receiver);
    }
