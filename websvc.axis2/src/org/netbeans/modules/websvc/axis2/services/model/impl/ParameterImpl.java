...
public class ParameterImpl extends ServicesComponentImpl implements Parameter {
    
    public ParameterImpl(ServicesModelImpl model, Element e) {
        super(model, e);
    }
    
    public ParameterImpl(ServicesModelImpl model) {
        this(model, createElementNS(model, ServicesQNames.PARAMETER));
    }
    ...
    public void setValue(String paramValue) {
        setText(Service.PARAMETER_PROP, paramValue);
    }
