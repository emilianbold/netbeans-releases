...
public class ServiceGroupImpl extends ServicesComponentImpl implements ServiceGroup {
    
    public ServiceGroupImpl(ServicesModelImpl model, Element e) {
        super(model, e);
    }
    
    public ServiceGroupImpl(ServicesModelImpl model) {
        this(model, createElementNS(model, ServicesQNames.SERVICE_GROUP));
    }
    ...
    public void addService(Service service) {
        appendChild(Service.SERVICE_PROP, service);
    }

    public void removeService(Service service) {
        removeChild(Service.SERVICE_PROP, service);
    }
