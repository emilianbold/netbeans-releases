...
//                setAccessibleName(NbBundle.getMessage(SelectClassPanel.class,"LBL_Class_Tree"));
//        btv.getAccessibleContext().setAccessibleDescription
//                (NbBundle.getMessage(SelectClassPanel.class,"TTL_SelectHandler"));
//        String projectName = project.getProjectDirectory().getName();
        String classesLabel = //projectName + " " +
                NbBundle.getMessage(SelectClassPanel.class, "LBL_PROJECT_CLASSES");
