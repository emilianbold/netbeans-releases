...
-Dtest.run.args="-ea -XX:PermSize=32m -XX:MaxPermSize=200m -Xmx512m -Dnetbeans.keyring.no.master=true -Djava.io.tmpdir=/var/tmp/hudson${EXECUTOR_NUMBER} -Dcnd.remote.sync.root.postfix=hudson${EXECUTOR_NUMBER} $*"
