...
import org.netbeans.modules.ruby.rubyproject.rake.RakeRunner.DescriptorHolder;
...
public class RakeRunnerTest extends RubyProjectTestBase {
    ...
    public void testBuildExecutionDescriptorsNoParams() throws Exception {
        ...
        List<DescriptorHolder> executionDescriptors =
                rakeRunner.getDescriptors(Arrays.asList(task1, task2));

        RubyExecutionDescriptor task1Descriptor = executionDescriptors.get(0).rubyDescriptor;
        ...
        RubyExecutionDescriptor task2Descriptor = executionDescriptors.get(1).rubyDescriptor;
    ...
    public void testBuildExecutionDescriptorsWithParams() throws Exception {
        ...
        List<RakeRunner.DescriptorHolder> executionDescriptors =
                rakeRunner.getDescriptors(Arrays.asList(task1, task2));
    ...
    public void testBuildExecutionDescriptorsWithInitialParams() throws Exception {
        ...
        RubyExecutionDescriptor taskDescriptor = executionDescriptors.get(0).rubyDescriptor;
