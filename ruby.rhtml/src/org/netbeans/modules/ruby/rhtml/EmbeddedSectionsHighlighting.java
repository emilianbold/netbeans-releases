...
public class EmbeddedSectionsHighlighting extends AbstractHighlightsContainer implements TokenHierarchyListener {
    ...
    private static final Color DEFAULT_RUBY_SCRIPLET_BACKGROUND_COLOR = Color.decode("#D8EED2"); //NOI18N
                        ...
                        if (sequence.token().id() == RhtmlTokenId.DELIMITER) {
                            ...
                            try {
                                ...
                                if (startLine != endLine) {
                                    ...
                                    if (isWhitespace(document, firstLineStartOffset, sectionStart - delimiterSize)) { // always preceeded by the delimiter
