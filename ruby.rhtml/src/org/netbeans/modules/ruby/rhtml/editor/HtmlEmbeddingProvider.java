...
public class HtmlEmbeddingProvider extends EmbeddingProvider {
    ...
    public List<Embedding> getEmbeddings(Snapshot snapshot) {
        TokenHierarchy<CharSequence> th = TokenHierarchy.create(snapshot.getText(), RhtmlTokenId.language());
        TokenSequence<RhtmlTokenId> sequence = th.tokenSequence(RhtmlTokenId.language());
        sequence.moveStart();
