 ...
 * 
 * @author Jacob Hookom
 * @version $Id: TagLibraryConfig.java,v 1.2 2009/05/06 14:41:42 xinye22 Exp $
 */
    ...
    private static class LibraryHandler extends DefaultHandler {
        ...
        public InputSource resolveEntity(String publicId, String systemId)
            ...
            if ("-//Sun Microsystems, Inc.//DTD Facelet Taglib 1.0//EN"
                    .equals(publicId)) {
                FaceletsCatalog resolver = new FaceletsCatalog();
                try {
...
//    }
    ...
    private static final SAXParser createSAXParser(LibraryHandler handler)
        ...
        reader.setEntityResolver(new FaceletsCatalog());
        return parser;
    }
