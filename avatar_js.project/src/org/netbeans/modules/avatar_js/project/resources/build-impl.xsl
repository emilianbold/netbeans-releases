...
<xsl:stylesheet version="1.0"
                ...
                xmlns:avatarjsproject1="http://www.netbeans.org/ns/avatar-js-project/1"
                ...
                exclude-result-prefixes="xalan p projdeps projdeps2 avatarjsproject libs">
...
is divided into following sections:
  ...
  - cleanup
        ...
        <xsl:variable name="name" select="/p:project/p:configuration/avatarjsproject1:data/avatarjsproject1:name"/>
            ...
            <target name="-do-init">
                ...
                <xsl:choose>
                    <xsl:when test="/p:project/p:configuration/avatarjsproject1:data/avatarjsproject1:explicit-platform">
                        <avatarjsproject1:property name="platform.home" value="platforms.${{platform.active}}.home"/>
                        <avatarjsproject1:property name="platform.bootcp" value="platforms.${{platform.active}}.bootclasspath"/>
                        <avatarjsproject1:property name="platform.compiler" value="platforms.${{platform.active}}.compile"/>
                        <avatarjsproject1:property name="platform.javac.tmp" value="platforms.${{platform.active}}.javac"/>
                        <condition property="platform.javac" value="${{platform.home}}/bin/javac">
                            <equals arg1="${{platform.javac.tmp}}" arg2="$${{platforms.${{platform.active}}.javac}}"/>
                        </condition>
                        <property name="platform.javac" value="${{platform.javac.tmp}}"/>
                        <avatarjsproject1:property name="platform.java.tmp" value="platforms.${{platform.active}}.java"/>
                        <condition property="platform.java" value="${{platform.home}}/bin/java">
                            <equals arg1="${{platform.java.tmp}}" arg2="$${{platforms.${{platform.active}}.java}}"/>
                        </condition>
                        <property name="platform.java" value="${{platform.java.tmp}}"/>
                        <avatarjsproject1:property name="platform.javadoc.tmp" value="platforms.${{platform.active}}.javadoc"/>
 ...
 For example like this:
  ...
  or ant -Dplatforms.${platform.active}.home=&lt;path_to_JDK_home&gt; jar (where no properties file is used) 
                ...
                <xsl:call-template name="createRootAvailableTest">
                    <xsl:with-param name="roots" select="/p:project/p:configuration/avatarjsproject1:data/avatarjsproject1:test-roots"/>
                    <xsl:with-param name="propName">have.tests</xsl:with-param>
                </xsl:call-template>
                <xsl:call-template name="createRootAvailableTest">
                    <xsl:with-param name="roots" select="/p:project/p:configuration/avatarjsproject1:data/avatarjsproject1:source-roots"/>
                ...
                <xsl:if test="not(/p:project/p:configuration/avatarjsproject1:data/avatarjsproject1:explicit-platform)">
            ...
            <target name="-init-macrodef-property">
                <macrodef>
                    ...
                    <xsl:attribute name="uri">http://www.netbeans.org/ns/avatar-js-project/1</xsl:attribute>
                    <attribute>
                ...
                <macrodef>
                    ...
                    <sequential>
                        ...
                        <javac>
                            ...
                            <xsl:if test ="not(/p:project/p:configuration/avatarjsproject1:data/avatarjsproject1:explicit-platform/@explicit-source-supported ='false')">
            ...
            <target name="-init-macrodef-javac" depends="-init-macrodef-javac-with-processors,-init-macrodef-javac-without-processors">
                ...
                <macrodef> <!-- #85707 -->
                    ...
                    <xsl:attribute name="uri">http://www.netbeans.org/ns/avatar-js-project/3</xsl:attribute>
                    <attribute>
                        <xsl:attribute name="name">destdir</xsl:attribute>
                        <xsl:attribute name="default">${build.classes.dir}</xsl:attribute>
                    </attribute>
                ...
                <macrodef>
                    ...
                    <sequential>
                        ...
                        <junit>
                            ...
                            <xsl:if test="/p:project/p:configuration/avatarjsproject1:data/avatarjsproject1:explicit-platform">
            ...
            <target name="-init-macrodef-junit-impl" depends="-init-macrodef-junit" if="${{junit.available}}">
                <macrodef>
                    ...
                    <sequential>
                        <avatarjsproject1:junit includes="@{{includes}}" excludes="@{{excludes}}" testincludes="@{{testincludes}}" testmethods="@{{testmethods}}">
                            <customize/>
                        </avatarjsproject1:junit>
                    </sequential>
                </macrodef>
            </target>
            ...
            <target name="-init-macrodef-testng-impl" depends="-init-macrodef-testng" if="${{testng.available}}">
                <macrodef>
                    ...
                    <sequential>
                        <avatarjsproject1:testng includes="@{{includes}}" excludes="@{{excludes}}" testincludes="@{{testincludes}}" testmethods="@{{testmethods}}">
                            <customize/>
                        </avatarjsproject1:testng>
                    </sequential>
                </macrodef>
            </target>
            ...
            <target name="-init-macrodef-test" depends="-init-macrodef-test-impl,-init-macrodef-junit-impl,-init-macrodef-testng-impl">
                <macrodef>
                    ...
                    <sequential>
                        <avatarjsproject1:test-impl includes="@{{includes}}" excludes="@{{excludes}}" testincludes="@{{testincludes}}" testmethods="@{{testmethods}}">
                            <customize>
                                <classpath>
            ...
            <target name="-init-macrodef-junit-debug-impl" depends="-init-macrodef-junit-debug,-init-macrodef-junit-debug-batch" if="${{junit.available}}">
                <macrodef>
                    ...
                    <sequential>
                        <avatarjsproject1:junit-debug includes="@{{includes}}" excludes="@{{excludes}}" testincludes="@{{testincludes}}" testmethods="@{{testmethods}}">
                            <customize/>
                        </avatarjsproject1:junit-debug>
                    </sequential>
                </macrodef>
            </target>
            ...
            <target name="-init-macrodef-testng-debug" if="${{testng.available}}">
                <macrodef>
                    ...
                    <sequential>
                        ...
                        <avatarjsproject1:debug classname="org.testng.TestNG" classpath="${{debug.test.classpath}}">
                            <customize>
                                <customize2/>
                                <jvmarg value="-ea"/>
            ...
            <target name="-init-macrodef-testng-debug-impl" depends="-init-macrodef-testng-debug" if="${{testng.available}}">
                <macrodef>
                    ...
                    <sequential>
                        <avatarjsproject1:testng-debug testClass="@{{testClass}}" testMethod="@{{testMethod}}">
                            <customize2/>
                        </avatarjsproject1:testng-debug>
                    </sequential>
                </macrodef>
            </target>
            ...
            <target name="-init-macrodef-test-debug-junit" depends="-init-macrodef-junit-debug-impl" if="${{junit.available}}">
                <macrodef>
                    ...
                    <sequential>
                        <avatarjsproject1:test-debug-impl includes="@{{includes}}" excludes="@{{excludes}}" testincludes="@{{testincludes}}" testmethods="@{{testmethods}}">
                            <customize>
                                <classpath>
                                    <path path="${{run.test.classpath}}"/>
                                </classpath>
                        ...
                        </avatarjsproject1:test-debug-impl>
                    </sequential>
                </macrodef>
            </target>
            ...
            <target name="-init-macrodef-test-debug-testng" depends="-init-macrodef-testng-debug-impl" if="${{testng.available}}">
                <macrodef>
                    ...
                    <sequential>
                        <avatarjsproject1:testng-debug-impl testClass="@{{testClass}}" testMethod="@{{testMethod}}">
                            <customize2>
                                <syspropertyset>
                                    <propertyref prefix="test-sys-prop."/>
                                    <mapper from="test-sys-prop.*" to="*" type="glob"/>
                        ...
                        </avatarjsproject1:testng-debug-impl>
                    </sequential>
                </macrodef>
            </target>
            ...
            <target name="-init-macrodef-debug" depends="-init-debug-args">
                <macrodef>
                    ...
                    <xsl:attribute name="uri">http://www.netbeans.org/ns/avatar-js-project/1</xsl:attribute>
                    <attribute>
                        <xsl:attribute name="name">avatarjsjar</xsl:attribute>
                        <xsl:attribute name="default">${avatar.js.jar}</xsl:attribute>
                    </attribute>
                    <attribute>
                        <xsl:attribute name="name">filename</xsl:attribute>
                        <xsl:attribute name="default">${src.js.dir}/${main.file}</xsl:attribute>
                    </attribute>
                    <attribute>
                        <xsl:attribute name="name">classpath</xsl:attribute>
                        <xsl:attribute name="default">${debug.classpath}</xsl:attribute>
                    ...
                    <sequential>
                        <java fork="true" jar="@{{avatarjsjar}}">
            ...
            <target name="-init-macrodef-java">
                <macrodef>
                    ...
                    <sequential>
                        <java jar="@{{avatarjsjar}}" fork="true">
                            <xsl:attribute name="dir">${work.dir}</xsl:attribute>
                            <xsl:if test="/p:project/p:configuration/avatarjsproject1:data/avatarjsproject1:explicit-platform">
                                <xsl:attribute name="jvm">${platform.java}</xsl:attribute>
                            </xsl:if>
            ...
            <target name="-init-presetdef-jar">
                <presetdef>
                    ...
                    <jar jarfile="${{dist.jar}}" compress="${{jar.compress}}" index="${{jar.index}}">
                        <avatarjsproject1:fileset dir="${{build.classes.dir}}" excludes="${{dist.archive.excludes}}"/>
            ...
            <target name="-do-compile">
                ...
                <avatarjsproject1:javac gensrcdir="${{build.generated.sources.dir}}"/>
            ...
            <target name="-do-compile-single">
                ...
                <avatarjsproject1:force-recompile/>
                <xsl:element name="avatarjsproject1:javac">
            ...
            <target name="-do-jar-copylibs">
                ...
                <avatarjsproject1:copylibs manifest="${{tmp.manifest.file}}"/>
                <echo level="info">To run this application from the command line without Ant, try:</echo>
                <property name="dist.jar.resolved" location="${{dist.jar}}"/>
                <echo level="info"><xsl:choose>
                        <xsl:when test="/p:project/p:configuration/avatarjsproject1:data/avatarjsproject1:explicit-platform">${platform.java}</xsl:when>
            ...
            <target name="-do-jar-jar">
                ...
                <avatarjsproject1:jar manifest="${{tmp.manifest.file}}"/>
                <property location="${{build.classes.dir}}" name="build.classes.dir.resolved"/>
            ...
            <target name="run-single">
                <xsl:attribute name="depends">init</xsl:attribute>
                <fail unless="run.file">Must select one file in the IDE or set run.file</fail>
                <avatarjsproject1:java filename="${{src.js.dir}}/${{run.file}}"/>
            </target>

            <target name="run-test-with-main">
                <xsl:attribute name="depends">init,compile-test-single</xsl:attribute>
                <fail unless="run.file">Must select one file in the IDE or set run.file</fail>
                <avatarjsproject1:java filename="${{src.js.dir}}/${{run.file}}" classpath="${{run.test.classpath}}"/>
            </target>
            ...
            <target name="-debug-start-debugger">
                ...
                <xsl:attribute name="depends">init</xsl:attribute>
                <avatarjsproject1:nbjpdastart name="${{debug.class}}"/>
            </target>

            <target name="-debug-start-debugger-main-test">
                <xsl:attribute name="if">netbeans.home</xsl:attribute>
                <xsl:attribute name="depends">init</xsl:attribute>
                <avatarjsproject1:nbjpdastart name="${{debug.class}}" classpath="${{debug.test.classpath}}"/>
            </target>
            ...
            <target name="-debug-start-debugger-stepinto">
                <xsl:attribute name="if">netbeans.home</xsl:attribute>
                <xsl:attribute name="depends">init</xsl:attribute>
                <avatarjsproject1:nbjpdastart stopclassname="${{main.class}}"/>
            </target>
            ...
            <target name="-debug-start-debuggee-single">
                <xsl:attribute name="if">netbeans.home</xsl:attribute>
                <xsl:attribute name="depends">init</xsl:attribute>
                <fail unless="debug.file">Must select one file in the IDE or set debug.file</fail>
                <avatarjsproject1:debug filename="${{src.js.dir}}/${{debug.file}}"/>
            </target>
            
            <target name="debug-single">
                <xsl:attribute name="if">netbeans.home</xsl:attribute>
                <xsl:attribute name="depends">init,-debug-start-debugger,-debug-start-debuggee-single</xsl:attribute>
            </target>
            ...
            <target name="-debug-start-debuggee-main-test">
                ...
                <xsl:attribute name="depends">init,compile-test-single</xsl:attribute>
                <fail unless="debug.file">Must select one file in the IDE or set debug.file</fail>
                <avatarjsproject1:debug filename="${{src.js.dir}}/${{debug.file}}" classpath="${{debug.test.classpath}}"/>
            </target>
                ...
                <javadoc>
                    ...
                    <sourcepath>
                        <xsl:call-template name="createPathElements">
                            <xsl:with-param name="locations" select="/p:project/p:configuration/avatarjsproject1:data/avatarjsproject1:source-roots"/>
                        </xsl:call-template>
                    </sourcepath>
                    -->
            ...
            <target name="-compile-test-depend" if="do.depend.true">
                <xsl:element name="avatarjsproject1:depend">
                    <xsl:attribute name="srcdir">
                        <xsl:call-template name="createPath">
                            <xsl:with-param name="roots" select="/p:project/p:configuration/avatarjsproject1:data/avatarjsproject1:test-roots"/>
                        </xsl:call-template>
            ...
            <target name="-do-compile-test-single">
                ...
                <fail unless="javac.includes">Must select some files in the IDE or set javac.includes</fail>
                <xsl:element name="avatarjsproject1:force-recompile">
                    <xsl:attribute name="destdir">${build.test.classes.dir}</xsl:attribute>
                </xsl:element>
                <xsl:element name="avatarjsproject1:javac">
                    <xsl:attribute name="srcdir">
            ...
            <target name="-do-test-run">
                ...
                <avatarjsproject1:test testincludes="**/*Test.java"/>
            </target>
            ...
            <target name="-do-test-run-single">
                ...
                <fail unless="test.includes">Must select some files in the IDE or set test.includes</fail>
                <avatarjsproject1:test includes="${{test.includes}}" excludes="" testincludes="${{test.includes}}" />
            </target>
            ...
            <target name="-do-test-run-single-method">
                ...
                <avatarjsproject1:test includes="${{javac.includes}}" excludes="" testincludes="${{test.class}}" testmethods="${{test.method}}"/>
            </target>
            ...
            <target name="-debug-start-debuggee-test">
                ...
                <avatarjsproject1:test-debug includes="${{javac.includes}}" excludes="" testincludes="${{javac.includes}}" testClass="${{test.class}}"/>
            </target>
            ...
            <target name="-debug-start-debuggee-test-method">
                ...
                <fail unless="test.class">Must select one file in the IDE or set test.class</fail>
                <fail unless="test.method">Must select some method in the IDE or set test.method</fail>
                <avatarjsproject1:test-debug includes="${{javac.includes}}" excludes="" testincludes="${{test.class}}" testmethods="${{test.method}}" testClass="${{test.class}}" testMethod="${{test.method}}"/>
            </target>

            <target name="-debug-start-debugger-test">
                <xsl:attribute name="if">netbeans.home+have.tests</xsl:attribute>
                <xsl:attribute name="depends">init,compile-test</xsl:attribute>
                <avatarjsproject1:nbjpdastart name="${{test.class}}" classpath="${{debug.test.classpath}}"/>
            </target>
            ...
            <target name="-do-debug-fix-test">
                ...
                <avatarjsproject1:nbjpdareload dir="${{build.test.classes.dir}}"/>
            </target>
            ...
            <target name="run-applet">
                ...
                <fail unless="applet.url">Must select one file in the IDE or set applet.url</fail>
                <avatarjsproject1:java classname="sun.applet.AppletViewer">
                    <customize>
                        <arg value="${{applet.url}}"/>
                    </customize>
                </avatarjsproject1:java>
            ...
            <target name="-debug-start-debuggee-applet">
                ...
                <xsl:attribute name="depends">init,compile-single</xsl:attribute>
                <fail unless="applet.url">Must select one file in the IDE or set applet.url</fail>
                <avatarjsproject1:debug classname="sun.applet.AppletViewer">
                    <customize>
                        <arg value="${{applet.url}}"/>
                    </customize>
                </avatarjsproject1:debug>
    ...
    <xsl:template name="deps.target">
        ...
        <target name="-warn-already-built-{$kind}" if="already.built.{$kind}.${{basedir}}">
            <echo level="warn" message="Cycle detected: {/p:project/p:configuration/avatarjsproject1:data/avatarjsproject1:name} was already built"/>
        </target>
        <target name="deps-{$kind}" depends="init,-deps-{$kind}-init">
            ...
            <!--<echo message="from deps-{$kind} of {/p:project/p:configuration/avatarjsproject1:data/avatarjsproject1:name}:"/><echoproperties prefix="already.built.{$kind}."/>-->
    ...
    <xsl:template name="createRootAvailableTest">
        ...
        <xsl:element name="condition">
            ...
            <or>
                <xsl:for-each select="$roots/avatarjsproject1:root">
    ...
    <xsl:template name="createPathElements">
        ...
        <xsl:for-each select="$locations/avatarjsproject1:root">
