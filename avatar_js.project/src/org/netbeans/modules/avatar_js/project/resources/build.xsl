...
<xsl:stylesheet version="1.0"
                ...
                xmlns:avatarjsproject="http://www.netbeans.org/ns/avatar-js-project/1"
                xmlns:xalan="http://xml.apache.org/xslt"
                exclude-result-prefixes="xalan project avatarjsproject">
    ...
    <xsl:template match="/">
        ...
        <xsl:variable name="name" select="/project:project/project:configuration/avatarjsproject:data/avatarjsproject:name"/>
