...
public class PanelConfigureProject implements WizardDescriptor.Panel<WizardDescriptor>, WizardDescriptor.ValidatingPanel<WizardDescriptor>, WizardDescriptor.FinishablePanel<WizardDescriptor> {
    ...
    private PanelConfigureProjectComponent component;
    private final ChangeSupport changeSupport = new ChangeSupport(this);
    
    PanelConfigureProject(NewAvatarJSProjectWizardIterator.WizardType type) {
        this.type = type;
    }
    ...
    public Component getComponent() {
        if (component == null) {
            component = new PanelConfigureProjectComponent(this, type);
        }
        return component;
    }
