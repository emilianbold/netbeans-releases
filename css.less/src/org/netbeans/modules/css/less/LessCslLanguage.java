 ...
 * @author marekfukala
 */
@NbBundle.Messages("LessResolver=LESS CSS Files")
...
public class LessCslLanguage extends DefaultLanguageConfig {
    ...
    @MultiViewElement.Registration(displayName = "#LBL_LESSEditorTab",
            iconBase = "org/netbeans/modules/css/less/less.png",
    ...
    public StructureScanner getStructureScanner() {
        return new LessStructureScanner();
    }
    ...
    public class LessParser extends Parser {
        ...
        public void parse(Snapshot snapshot, Task task, SourceModificationEvent event) throws ParseException {
            result = new LessParserResult(snapshot);
        }
    ...
    public static class LessParserResult extends ParserResult {

        public LessParserResult(Snapshot snapshot) {
            super(snapshot);
        }
    ...
    public static class LessStructureScanner implements StructureScanner {
