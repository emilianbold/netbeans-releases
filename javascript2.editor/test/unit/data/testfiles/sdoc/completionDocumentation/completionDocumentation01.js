 ...
 * @classDescription This is the basic Shape class.
 ...
 * @inherits Shape
 * @classDescription Hexagon is a class that is a <i>logical</i> sublcass of
 ...
 * @exception {NonExistantColorException}
 * @see #getColor
 */
 ...
 * @exception any exception which can throw Shape constructor
 */
 ...
 * @classDescription A basic rectangle class, inherits from Shape.
 ...
 * @classDescription A Square is a subclass of Rectangle
 * @param {int} width The optional width for this Rectangle
 ...
 * @classDescription Circle class is another subclass of Shape
 * @inherits Shape
 ...
 * @type {Circle}
 * @example var circle = Circle.createCircle(5);
 */
 ...
 * @classDescription Coordinate is a class that can encapsulate location information.
...
/**
 * @classDescription This class exists to demonstrate the assignment of a class prototype
 ...
 * @classDescription This is the Foo class. It exists to demonstrate 'nested' classes.
 * @constructor
 * @see Foo.Bar
 */
function Foo(){}
 ...
 * @classDescription This class exists to demonstrate 'nested' classes.
 * @constructor
 * @see Foo.Bar
 */
function Bar(){}
