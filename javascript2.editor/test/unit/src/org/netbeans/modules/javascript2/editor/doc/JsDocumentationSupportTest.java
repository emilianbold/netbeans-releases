 ...
 */
public class JsDocumentationSupportTest extends JsDocumentationTestBase {

    JsParserResult parserResult;

    public JsDocumentationSupportTest(String testName) {
        super(testName);
    }
    ...
    public void testResolverForSDocCompleteFile() throws ParseException {
        parseSource(getTestSource(getTestFile("testfiles/sdoc/classWithSDoc.js")));
        JsDocumentationHolder documentationHolder = JsDocumentationSupport.getDocumentationHolder(parserResult);
