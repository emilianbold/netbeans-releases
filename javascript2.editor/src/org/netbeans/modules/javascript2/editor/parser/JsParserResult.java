 ...
 * @author Tomas Zezula
 */
public abstract class JsParserResult extends ParserResult {
    private static final Logger LOG = Logger.getLogger(JsParserResult.class.getName());
