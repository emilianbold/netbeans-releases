...
//                Element newRoot = doc.createElementNS (RailsProjectType.PROJECT_CONFIGURATION_NAMESPACE,"data"); //NOI18N
...
//                root = doc.createElementNS (RailsProjectType.PROJECT_CONFIGURATION_NAMESPACE,"root");   //NOI18N
        ...
        for (int i=0; i< length; i++) {
            ...
            switch (node.getNodeType()) {
                case Node.ELEMENT_NODE:
                    ...
                    newNode = doc.createElementNS(RailsProjectType.PROJECT_CONFIGURATION_NAMESPACE,oldElement.getTagName());
...
//        NodeList list = root.getElementsByTagNameNS (RailsProjectType.PROJECT_CONFIGURATION_NAMESPACE,MINIMUM_ANT_VERSION_ELEMENT);
//        if (list.getLength() == 1) {
//            Element me = (Element) list.item(0);
//            list = me.getChildNodes();
//            if (list.getLength() == 1) {
//                me.replaceChild (doc.createTextNode(RailsProjectGenerator.MINIMUM_ANT_VERSION), list.item(0));
//                return root;
//            }
//        }
