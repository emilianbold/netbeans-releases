...
/**
 * A server instance provider implementation that handles registering
 * Mongrel and WEBrick instances.
 * 
 * @author Erno Mononen
 */
public class ServerInstanceProviderImpl implements ServerInstanceProvider {

    private static final ServerInstanceProviderImpl INSTANCE = new ServerInstanceProviderImpl();
    private final ChangeSupport changeSupport = new ChangeSupport(this);

    public static final ServerInstanceProviderImpl getInstance() {
        return INSTANCE;
    }
