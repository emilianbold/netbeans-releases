...
import java.net.URL;
import org.netbeans.modules.gsfpath.spi.queries.MultipleRootsUnitTestForSourceQueryImplementation;
 ...
 *
 * @see org.netbeans.modules.gsfpath.spi.queries.MultipleRootsUnitTestForSourceQueryImplementation
...
public class UnitTestForSourceQuery {
    ...
    private static final Lookup.Result<? extends org.netbeans.modules.gsfpath.spi.queries.UnitTestForSourceQueryImplementation> implementations =
        Lookup.getDefault().lookupResult(org.netbeans.modules.gsfpath.spi.queries.UnitTestForSourceQueryImplementation.class);
     ...
     * @since org.netbeans.modules.gsfpath.api/1 1.7
     */
    @SuppressWarnings ("deprecation")   // NOI18N
    public static URL[] findUnitTests(FileObject source) {
        ...
        for (org.netbeans.modules.gsfpath.spi.queries.UnitTestForSourceQueryImplementation query : implementations.allInstances()) {
