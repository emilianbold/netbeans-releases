...
package org.netbeans.modules.gsfpath.platform.ui;
...
public class PlatformsCustomizer extends javax.swing.JPanel implements PropertyChangeListener, VetoableChangeListener, ExplorerManager.Provider {
    ...
    private static final String TEMPLATE = "Templates/Services/Platforms/org-netbeans-modules-gsfpath-api-Platform/javaplatform.xml";  //NOI18N
    private static final String STORAGE = "Services/Platforms/org-netbeans-modules-gsfpath-api-Platform";  //NOI18N   
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("org/netbeans/modules/gsfpath/platform/ui/Bundle"); // NOI18N
        ...
        addButton.setMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/gsfpath/platform/ui/Bundle").getString("MNE_AddPlatform").charAt(0));
        ...
        removeButton.setMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/gsfpath/platform/ui/Bundle").getString("MNE_Remove").charAt(0));
        ...
        jLabel1.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/gsfpath/platform/ui/Bundle").getString("MNE_PlatformName").charAt(0));
        ...
        jLabel2.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/gsfpath/platform/ui/Bundle").getString("MNE_PlatformHome").charAt(0));
