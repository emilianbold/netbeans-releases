...
public class LocationChooser extends JFileChooser implements PropertyChangeListener {
    ...
    private static class PlatformFileView extends FileView {
        ...
        private static final Icon BADGE = new ImageIcon(ImageUtilities.loadImage("org/netbeans/modules/gsfpath/platform/resources/platformBadge.gif")); // NOI18N
        private static final Icon EMPTY = new ImageIcon(ImageUtilities.loadImage("org/netbeans/modules/gsfpath/platform/resources/empty.gif")); // NOI18N
