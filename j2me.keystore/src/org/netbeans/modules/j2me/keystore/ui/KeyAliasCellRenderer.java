...
/**
 *
 * @author Adam Sotona, David Kaspar, rsvitanic
 */
public class KeyAliasCellRenderer extends DefaultListCellRenderer {

    private static final Image key = ImageUtilities.loadImage("org/netbeans/modules/j2me/keystore/ui/resources/key.gif"); //NOI18N
    private static final Icon ICON_OPENED = new ImageIcon(ImageUtilities.mergeImages(key, ImageUtilities.loadImage("org/netbeans/modules/j2me/keystore/ui/resources/unlockedBadge.gif"), 0, 0)); //NOI18N
    private static final Icon ICON_CLOSED = new ImageIcon(ImageUtilities.mergeImages(key, ImageUtilities.loadImage("org/netbeans/modules/j2me/keystore/ui/resources/lockedBadge.gif"), 0, 0)); //NOI18N
    private static final Icon ICON_INVALID = new ImageIcon(ImageUtilities.mergeImages(key, ImageUtilities.loadImage("org/netbeans/modules/j2me/keystore/ui/resources/invalidBadge.gif"), 0, 0)); //NOI18N
