...
class PanelProjectLocationVisual extends JPanel implements DocumentListener {
    ...
    private void initComponents() {
        ...
        projectNameLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/web/examples/Bundle").getString("LBL_NWP1_ProjectName_LabelMnemonic").charAt(0));
        ...
        projectLocationLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/web/examples/Bundle").getString("LBL_NWP1_ProjectLocation_LabelMnemonic").charAt(0));
        ...
        createdFolderLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/web/examples/Bundle").getString("LBL_NWP1_CreatedProjectFolder_LablelMnemonic").charAt(0));
