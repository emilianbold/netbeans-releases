 ...
 */
public class DeprecatedTypesSemanticAnalysisTest extends PHPCodeCompletionTestBase {

    public DeprecatedTypesSemanticAnalysisTest(String testName) {
        super(testName);
    }
    ...
    protected Map<String, ClassPath> createClassPathsForTest() {
        return Collections.singletonMap(
            ...
            ClassPathSupport.createClassPath(new FileObject[] {
                FileUtil.toFileObject(new File(getDataDir(), "/testfiles/semantic/deprecatedTypes"))
            })
        );
    }
