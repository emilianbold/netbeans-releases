...
public class PanelProjectLocationVisual extends SettingsPanel implements DocumentListener {
    ...
    public PanelProjectLocationVisual( PanelConfigureProject panel, int type, String preferredName ) {
        initComponents();
        this.panel = panel;
        this.type = type;
        ...
        if (projectName == null) {
            if (preferredName == null){
                if (this.type == NewCDCProjectWizardIterator.TYPE_APP) {
                    int baseCount = CDCFoldersListSettings.getNewApplicationCount() + 1;
                    ...
                    int baseCount = CDCFoldersListSettings.getNewLibraryCount() + 1;
