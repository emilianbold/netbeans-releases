...
public class ImportCDCProjectPanel extends javax.swing.JPanel implements DocumentListener {
    ...
    private void initComponents()
    {
        ...
        setName(org.openide.util.NbBundle.getMessage(ImportCDCProjectPanel.class, "TITLE_Project",prjType.equals(ImportCDCProjectWizardIterator.CDC55)?ImportCDCProjectWizardIterator.CDC55TYPE:ImportCDCProjectWizardIterator.CDCTOOLKITTYPE));
        jLabel1.setText(org.openide.util.NbBundle.getMessage(ImportCDCProjectPanel.class, "LBL_Import_Info",prjType.equals(ImportCDCProjectWizardIterator.CDC55)?ImportCDCProjectWizardIterator.CDC55TYPE:ImportCDCProjectWizardIterator.CDCTOOLKITTYPE));
        ...
        jLabel1.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(ImportCDCProjectPanel.class, "ASCD_Import_Info",prjType.equals(ImportCDCProjectWizardIterator.CDC55)?ImportCDCProjectWizardIterator.CDC55TYPE:ImportCDCProjectWizardIterator.CDCTOOLKITTYPE));

        jLabel2.setDisplayedMnemonic(org.openide.util.NbBundle.getBundle(ImportCDCProjectPanel.class).getString("MNM_Project_Location").charAt(0));
        jLabel2.setLabelFor(tLocation);
        jLabel2.setText(org.openide.util.NbBundle.getMessage(ImportCDCProjectPanel.class, "LBL_Project_Location"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        tLocation.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(ImportCDCProjectPanel.class, "ACSD_Project_Location",prjType.equals(ImportCDCProjectWizardIterator.CDC55)?ImportCDCProjectWizardIterator.CDC55TYPE:ImportCDCProjectWizardIterator.CDCTOOLKITTYPE));

        bBrowse.setMnemonic(org.openide.util.NbBundle.getBundle(ImportCDCProjectPanel.class).getString("MNM_Project_Browse").charAt(0));
        bBrowse.setText(org.openide.util.NbBundle.getMessage(ImportCDCProjectPanel.class, "LBL_Project_Browse"));
        ...
        bBrowse.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(ImportCDCProjectPanel.class, "ACSD_Project_Browse1"));
