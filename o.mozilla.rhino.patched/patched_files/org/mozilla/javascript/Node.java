...
// </netbeans>
    ...
    // <netbeans>
    // Used for object literals: the labels are assigned one of these
    // nodes (such that names can be tracked by the IDE)
    public static class LabelledNode extends StringNode
    {
        LabelledNode(String name, Node labelledNode) {
            super(Token.OBJLITNAME, name);
            assert labelledNode != null;
    ...
    public Node(int nodeType, Node left, Node right) {
        ...
        right.next = null;
        // <netbeans>
        //assert left.sourceEnd <= right.sourceStart : left + "," + right;
        if (left.sourceEnd > 0 && right.sourceStart > 0) {
...
//        assert left.sourceEnd <= right.sourceStart : left + "," + right;
//        assert mid.sourceStart >= left.sourceEnd : mid + "," + left;
//        assert mid.sourceEnd <= right.sourceStart : mid + "," + right;
        //sourceStart = left.sourceStart;
        //sourceEnd = right.sourceEnd;
        // </netbeans>
    }
    ...
    public void addChildToFront(Node child) {
        ...
        // <netbeans>
        if (sourceStart > child.sourceStart) {
    ...
    public void addChildrenToFront(Node children) {
        // <netbeans>
        if (sourceStart > children.sourceStart) {
            if (sourceStart == sourceEnd && sourceStart == 0) {
                sourceEnd =  children.getLastSibling().sourceStart;
            }
            sourceStart = children.sourceStart;
        }
        // </netbeans>
    ...
    public void addChildBefore(Node newChild, Node node) {
        ...
        // <netbeans>
        // This doesn't always work - in dojo.uncompressed I have some
        // Jump statements that aren't initialized.
        // Try setting the initial value of the source offsets to -1
        // to detect this.
//        if (sourceStart > newChild.sourceStart) {
//            sourceStart = newChild.sourceStart;
//        }
//        assert sourceEnd >= newChild.sourceEnd : newChild;
        // </netbeans>
    }
...
//            sourceEnd = last.sourceEnd;
//        }
//        assert sourceStart <= newChild.sourceStart : newChild;
        // </netbeans>
    }
    ...
    public void removeChild(Node child) {
        ...
        child.next = null;
        // <netbeans>
        // Do I have to adjust offsets here? There shouldn't be any removeChild calls during parsing!
        // </netbeans>
    }
    ...
    public void replaceChild(Node child, Node newChild) {
        ...
        child.next = null;
        // <netbeans>
        // Do I have to adjust offsets here? There shouldn't be any replaceChild calls during parsing!
        // </netbeans>
    }
    ...
    public void replaceChildAfter(Node prevChild, Node newChild) {
        ...
        child.next = null;
        // <netbeans>
        // Do I have to adjust offsets here? There shouldn't be any replaceChildAfter calls during parsing!
        // </netbeans>
    }
    ...
    public String toString()
    {
        ...
        return String.valueOf(type) +  ":" + Token.fullName(type) + s + "[" + sourceStart + "," + sourceEnd + "]" + "<" + Integer.toHexString(System.identityHashCode(this)) + ">";
        // </netbeans>
    }
...
// <netbeans>
    // The offsets returned by "getEncodedSourceStart/End are referring
    // to a decompiled source representation which does not match the real
    // source. We want the real source offsets (in the original parsed
    // source.)
