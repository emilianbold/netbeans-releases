...
// </netbeans>
    ...
    public static String name(int token)
    {
        ...
        switch (token) {
            // <netbeans>
          case 65535: // I SEEM TO GET UNSIGNED ISSUES - WHERE IS THE TRUNCATION?
            // </netbeans>
...
// <netbeans>
          ...
          case OBJLITNAME:      return "OBJLITNAME";
...
// <netbeans>
    public static String fullName(int token)
    {
        boolean oldPrintNames = printNames;
        printNames = true;
        String result = name(token);
        printNames = oldPrintNames;
