            ...
            <target name="init-taskdefs">
                    <taskdef name="generate-wsdl" classname="org.netbeans.modules.edm.project.anttasks.GenerateWSDL">
                        <classpath>
                                    ...
                                    <fileset dir="${{ide.module.install.dir}}"><include name="*.jar" /></fileset>
                                    <fileset dir="${{platform.module.dir}}"><include name="*.jar" /></fileset>
                                    <fileset dir="${{platform.core.dir}}"><include name="*.jar" /></fileset>
                                    <fileset dir="${{platform.lib.dir}}"><include name="*.jar" /></fileset>
                                    <fileset dir="${{soa.module.install.dir}}"><include name="org-netbeans-soa-libs-wsdl4j.jar"/></fileset>
                        </classpath>
                        </taskdef>
            </target>
			<target name="init">
