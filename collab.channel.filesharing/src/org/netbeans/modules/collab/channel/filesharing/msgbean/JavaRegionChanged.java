 ...
 */
/**
 *        This generated bean class JavaRegionChanged
 *        matches the schema element '_java-region-changed'.
 *
 *        Generated on Mon Sep 27 16:53:13 PDT 2004
 */
package org.netbeans.modules.collab.channel.filesharing.msgbean;

public class JavaRegionChanged {
    private JavaRegion _JavaRegion;
    private JavaChange _JavaChange;

    public JavaRegionChanged() {
        _JavaRegion = new JavaRegion();
        _JavaChange = new JavaChange();
    }

    // Deep copy
    public JavaRegionChanged(org.netbeans.modules.collab.channel.filesharing.msgbean.JavaRegionChanged source) {
        _JavaRegion = new org.netbeans.modules.collab.channel.filesharing.msgbean.JavaRegion(source._JavaRegion);
        _JavaChange = new org.netbeans.modules.collab.channel.filesharing.msgbean.JavaChange(source._JavaChange);
    }
    ...
    // This attribute is mandatory
    public void setJavaChange(org.netbeans.modules.collab.channel.filesharing.msgbean.JavaChange value) {
        _JavaChange = value;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.JavaChange getJavaChange() {
        return _JavaChange;
    }
    ...
    throws java.io.IOException {
        ...
        if (_JavaChange != null) {
            _JavaChange.writeNode(out, "java-change", nextIndent);
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "java-region") {
                _JavaRegion = new org.netbeans.modules.collab.channel.filesharing.msgbean.JavaRegion();
                _JavaRegion.readNode(childNode);
            } else if (childNodeName == "java-change") {
                _JavaChange = new org.netbeans.modules.collab.channel.filesharing.msgbean.JavaChange();
                _JavaChange.readNode(childNode);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        } else if (name == "javaChange") {
            setJavaChange((JavaChange) value);
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for JavaRegionChanged");
        }
    }
    ...
    public void childBeans(boolean recursive, java.util.List beans) {
        ...
        if (_JavaChange != null) {
            if (recursive) {
                _JavaChange.childBeans(true, beans);
            }

            beans.add(_JavaChange);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.JavaRegionChanged)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.JavaRegionChanged inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.JavaRegionChanged) o;

        if (!((_JavaRegion == null) ? (inst._JavaRegion == null) : _JavaRegion.equals(inst._JavaRegion))) {
            return false;
        }

        if (!((_JavaChange == null) ? (inst._JavaChange == null) : _JavaChange.equals(inst._JavaChange))) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = (37 * result) + ((_JavaChange == null) ? 0 : _JavaChange.hashCode());
