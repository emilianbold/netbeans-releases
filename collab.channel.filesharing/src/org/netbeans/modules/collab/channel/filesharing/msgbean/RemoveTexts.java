 ...
 */
/**
 *        This generated bean class RemoveTexts
 *        matches the schema element '_remove-texts'.
 *
...
public class RemoveTexts {
    private java.util.List _RemoveText = new java.util.ArrayList(); // List<RemoveText>

    public RemoveTexts() {
    }

    // Deep copy
    public RemoveTexts(org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveTexts source) {
        for (java.util.Iterator it = source._RemoveText.iterator(); it.hasNext();) {
            _RemoveText.add(
                new org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText(
                    (org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText) it.next()
                )
            );
        }
    }
    ...
    public void setRemoveText(org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText[] value) {
        if (value == null) {
            value = new RemoveText[0];
        }

        _RemoveText.clear();

        for (int i = 0; i < value.length; ++i) {
            _RemoveText.add(value[i]);
        }
    }

    public void setRemoveText(int index, org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText value) {
        _RemoveText.set(index, value);
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText[] getRemoveText() {
        RemoveText[] arr = new RemoveText[_RemoveText.size()];

        return (RemoveText[]) _RemoveText.toArray(arr);
    }

    public java.util.List fetchRemoveTextList() {
        return _RemoveText;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText getRemoveText(int index) {
        return (RemoveText) _RemoveText.get(index);
    }

    // Return the number of removeText
    public int sizeRemoveText() {
        return _RemoveText.size();
    }

    public int addRemoveText(org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText value) {
        _RemoveText.add(value);

        return _RemoveText.size() - 1;
    }

    // Search from the end looking for @param value, and then remove it.
    public int removeRemoveText(org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText value) {
        int pos = _RemoveText.indexOf(value);

        if (pos >= 0) {
            _RemoveText.remove(pos);
        }
    ...
    throws java.io.IOException {
        ...
        for (java.util.Iterator it = _RemoveText.iterator(); it.hasNext();) {
            org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText element = (org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText) it.next();

            if (element != null) {
                element.writeNode(out, "remove-text", nextIndent);
            }
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "remove-text") {
                RemoveText aRemoveText = new org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText();
                aRemoveText.readNode(childNode);
                _RemoveText.add(aRemoveText);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "removeText") {
            addRemoveText((RemoveText) value);
        } else if (name == "removeText[]") {
            setRemoveText((RemoveText[]) value);
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for RemoveTexts");
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveTexts)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveTexts inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveTexts) o;

        if (sizeRemoveText() != inst.sizeRemoveText()) {
            return false;
        }

        // Compare every element.
        for (
            java.util.Iterator it = _RemoveText.iterator(), it2 = inst._RemoveText.iterator();
                it.hasNext() && it2.hasNext();
        ) {
            org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText element = (org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText) it.next();
            org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText element2 = (org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText) it2.next();
    ...
    public int hashCode() {
        int result = 17;
        result = (37 * result) + ((_RemoveText == null) ? 0 : _RemoveText.hashCode());
