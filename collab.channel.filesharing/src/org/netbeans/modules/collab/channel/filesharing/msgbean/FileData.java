 ...
 */
/**
 *        This generated bean class FileData
 *        matches the schema element '_file-data'.
 *
...
public class FileData {
    ...
    // Deep copy
    public FileData(org.netbeans.modules.collab.channel.filesharing.msgbean.FileData source) {
    ...
    throws java.io.IOException {
        ...
        if (_ContentType != null) {
            out.write(nextIndent);
            out.write("<content-type"); // NOI18N
            out.write(">"); // NOI18N
            org.netbeans.modules.collab.channel.filesharing.msgbean.CCollab.writeXML(out, _ContentType, false);
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            } else if (childNodeName == "content-type") {
                _ContentType = childNodeValue;
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "fileName") {
            ...
            throw new IllegalArgumentException(name + " is not a valid property name for FileData");
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.FileData)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.FileData inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.FileData) o;

        if (!((_FileName == null) ? (inst._FileName == null) : _FileName.equals(inst._FileName))) {
            return false;
        }

        if (!((_ContentType == null) ? (inst._ContentType == null) : _ContentType.equals(inst._ContentType))) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = (37 * result) + ((_ContentType == null) ? 0 : _ContentType.hashCode());
