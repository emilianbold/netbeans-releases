 ...
 */
/**
 *        This generated bean class RemoveText
 *        matches the schema element '_remove-text'.
 *
...
public class RemoveText {
    private java.math.BigInteger _Offset;

    public RemoveText() {
        _Offset = new java.math.BigInteger("0");
    }

    // Deep copy
    public RemoveText(org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText source) {
    ...
    throws java.io.IOException {
        ...
        if (_Offset != null) {
            ...
            out.write("<offset"); // NOI18N
            out.write(">"); // NOI18N
            out.write(_Offset.toString());
            out.write("</offset>\n"); // NOI18N
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "offset") {
                _Offset = new java.math.BigInteger(childNodeValue);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "offset") {
            ...
            throw new IllegalArgumentException(name + " is not a valid property name for RemoveText");
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveText) o;

        if (!((_Offset == null) ? (inst._Offset == null) : _Offset.equals(inst._Offset))) {
            return false;
        }
    ...
    public int hashCode() {
        int result = 17;
        result = (37 * result) + ((_Offset == null) ? 0 : _Offset.hashCode());
