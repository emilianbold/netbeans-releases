 ...
 */
/**
 *        This generated bean class ChangeTexts
 *        matches the schema element '_change-texts'.
 *
...
public class ChangeTexts {
    ...
    public ChangeTexts() {
        _RemoveTexts = new RemoveTexts();
        _InsertTexts = new InsertTexts();
    }

    // Deep copy
    public ChangeTexts(org.netbeans.modules.collab.channel.filesharing.msgbean.ChangeTexts source) {
        _RemoveTexts = new org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveTexts(source._RemoveTexts);
        _InsertTexts = new org.netbeans.modules.collab.channel.filesharing.msgbean.InsertTexts(source._InsertTexts);
    }

    // This attribute is mandatory
    public void setRemoveTexts(org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveTexts value) {
        _RemoveTexts = value;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveTexts getRemoveTexts() {
        return _RemoveTexts;
    }

    // This attribute is mandatory
    public void setInsertTexts(org.netbeans.modules.collab.channel.filesharing.msgbean.InsertTexts value) {
        _InsertTexts = value;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.InsertTexts getInsertTexts() {
        return _InsertTexts;
    }
    ...
    throws java.io.IOException {
        ...
        if (_RemoveTexts != null) {
            _RemoveTexts.writeNode(out, "remove-texts", nextIndent);
        }

        if (_InsertTexts != null) {
            _InsertTexts.writeNode(out, "insert-texts", nextIndent);
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "remove-texts") {
                _RemoveTexts = new org.netbeans.modules.collab.channel.filesharing.msgbean.RemoveTexts();
                _RemoveTexts.readNode(childNode);
            } else if (childNodeName == "insert-texts") {
                _InsertTexts = new org.netbeans.modules.collab.channel.filesharing.msgbean.InsertTexts();
                _InsertTexts.readNode(childNode);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "removeTexts") {
            setRemoveTexts((RemoveTexts) value);
        } else if (name == "insertTexts") {
            setInsertTexts((InsertTexts) value);
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for ChangeTexts");
        }
    }
    ...
    public void childBeans(boolean recursive, java.util.List beans) {
        if (_RemoveTexts != null) {
            if (recursive) {
                _RemoveTexts.childBeans(true, beans);
            }

            beans.add(_RemoveTexts);
        }

        if (_InsertTexts != null) {
            if (recursive) {
                _InsertTexts.childBeans(true, beans);
            }

            beans.add(_InsertTexts);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.ChangeTexts)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.ChangeTexts inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.ChangeTexts) o;

        if (!((_RemoveTexts == null) ? (inst._RemoveTexts == null) : _RemoveTexts.equals(inst._RemoveTexts))) {
            return false;
        }

        if (!((_InsertTexts == null) ? (inst._InsertTexts == null) : _InsertTexts.equals(inst._InsertTexts))) {
            return false;
        }
    ...
    public int hashCode() {
        int result = 17;
        result = (37 * result) + ((_RemoveTexts == null) ? 0 : _RemoveTexts.hashCode());
        result = (37 * result) + ((_InsertTexts == null) ? 0 : _InsertTexts.hashCode());
