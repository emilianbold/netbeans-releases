 ...
 */
/**
 *        This generated bean class TextRegion
 *        matches the schema element '_text-region'.
 *
...
public class TextRegion {
    ...
    private java.math.BigInteger _BeginOffset;
    private java.math.BigInteger _Length;

    public TextRegion() {
        _RegionName = "";
        _BeginOffset = new java.math.BigInteger("0");
        _Length = new java.math.BigInteger("0");
    }

    // Deep copy
    public TextRegion(org.netbeans.modules.collab.channel.filesharing.msgbean.TextRegion source) {
        _RegionName = source._RegionName;
        _BeginOffset = source._BeginOffset;
    ...
    // This attribute is mandatory
    public void setBeginOffset(java.math.BigInteger value) {
        _BeginOffset = value;
    }

    public java.math.BigInteger getBeginOffset() {
        return _BeginOffset;
    }
    ...
    throws java.io.IOException {
        ...
        if (_RegionName != null) {
            ...
            out.write("<region-name"); // NOI18N
            out.write(">"); // NOI18N
            org.netbeans.modules.collab.channel.filesharing.msgbean.CCollab.writeXML(out, _RegionName, false);
            out.write("</region-name>\n"); // NOI18N
        }

        if (_BeginOffset != null) {
            out.write(nextIndent);
            out.write("<begin-offset"); // NOI18N
            out.write(">"); // NOI18N
            out.write(_BeginOffset.toString());
            out.write("</begin-offset>\n"); // NOI18N
        }

        if (_Length != null) {
            out.write(nextIndent);
            out.write("<length"); // NOI18N
            out.write(">"); // NOI18N
            out.write(_Length.toString());
            out.write("</length>\n"); // NOI18N
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "region-name") {
                _RegionName = childNodeValue;
            } else if (childNodeName == "begin-offset") {
                _BeginOffset = new java.math.BigInteger(childNodeValue);
            } else if (childNodeName == "length") {
                _Length = new java.math.BigInteger(childNodeValue);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        } else if (name == "beginOffset") {
            setBeginOffset((java.math.BigInteger) value);
        } else if (name == "length") {
            setLength((java.math.BigInteger) value);
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for TextRegion");
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.TextRegion)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.TextRegion inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.TextRegion) o;

        if (!((_RegionName == null) ? (inst._RegionName == null) : _RegionName.equals(inst._RegionName))) {
            return false;
        }

        if (!((_BeginOffset == null) ? (inst._BeginOffset == null) : _BeginOffset.equals(inst._BeginOffset))) {
            return false;
        }

        if (!((_Length == null) ? (inst._Length == null) : _Length.equals(inst._Length))) {
            return false;
        }
    ...
    public int hashCode() {
        int result = 17;
        result = (37 * result) + ((_RegionName == null) ? 0 : _RegionName.hashCode());
        result = (37 * result) + ((_BeginOffset == null) ? 0 : _BeginOffset.hashCode());
        result = (37 * result) + ((_Length == null) ? 0 : _Length.hashCode());
