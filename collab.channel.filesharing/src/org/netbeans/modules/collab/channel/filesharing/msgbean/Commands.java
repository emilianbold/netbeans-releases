 ...
 */
/**
 *        This generated bean class Commands
 *        matches the schema element '_commands'.
 *
 *        Generated on Tue Apr 05 19:30:30 PDT 2005
 */
package org.netbeans.modules.collab.channel.filesharing.msgbean;

public class Commands {
    private FilesystemCommand _FilesystemCommand;
    ...
    // Deep copy
    public Commands(org.netbeans.modules.collab.channel.filesharing.msgbean.Commands source) {
        _FilesystemCommand = new org.netbeans.modules.collab.channel.filesharing.msgbean.FilesystemCommand(
                source._FilesystemCommand
            );
        _ProjectCommand = new org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectCommand(
                source._ProjectCommand
            );
    }

    // This attribute is mandatory
    public void setFilesystemCommand(org.netbeans.modules.collab.channel.filesharing.msgbean.FilesystemCommand value) {
        _FilesystemCommand = value;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.FilesystemCommand getFilesystemCommand() {
        return _FilesystemCommand;
    }

    // This attribute is mandatory
    public void setProjectCommand(org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectCommand value) {
        _ProjectCommand = value;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectCommand getProjectCommand() {
    ...
    throws java.io.IOException {
        ...
        if (_FilesystemCommand != null) {
            _FilesystemCommand.writeNode(out, "filesystem-command", nextIndent);
        }

        if (_ProjectCommand != null) {
            _ProjectCommand.writeNode(out, "project-command", nextIndent);
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "filesystem-command") {
                _FilesystemCommand = new org.netbeans.modules.collab.channel.filesharing.msgbean.FilesystemCommand();
                _FilesystemCommand.readNode(childNode);
            } else if (childNodeName == "project-command") {
                _ProjectCommand = new org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectCommand();
                _ProjectCommand.readNode(childNode);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "filesystemCommand") {
            setFilesystemCommand((FilesystemCommand) value);
        } else if (name == "projectCommand") {
            setProjectCommand((ProjectCommand) value);
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for Commands");
        }
    }

    public Object fetchPropertyByName(String name) {
        if (name == "filesystemCommand") {
            return getFilesystemCommand();
        }
    ...
    public void childBeans(boolean recursive, java.util.List beans) {
        if (_FilesystemCommand != null) {
            if (recursive) {
                _FilesystemCommand.childBeans(true, beans);
            }

            beans.add(_FilesystemCommand);
        }

        if (_ProjectCommand != null) {
            if (recursive) {
                _ProjectCommand.childBeans(true, beans);
            }

            beans.add(_ProjectCommand);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.Commands)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.Commands inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.Commands) o;

        if (
            !((_FilesystemCommand == null) ? (inst._FilesystemCommand == null)
                                               : _FilesystemCommand.equals(inst._FilesystemCommand))
        ) {
            return false;
        }

        if (!((_ProjectCommand == null) ? (inst._ProjectCommand == null) : _ProjectCommand.equals(inst._ProjectCommand))) {
            return false;
        }
    ...
    public int hashCode() {
        int result = 17;
        result = (37 * result) + ((_FilesystemCommand == null) ? 0 : _FilesystemCommand.hashCode());
        result = (37 * result) + ((_ProjectCommand == null) ? 0 : _ProjectCommand.hashCode());
