 ...
 * @version 1.0
 */
public class LeaveFilesharingHandlerFactory extends Object implements EventHandlerFactory {
    ////////////////////////////////////////////////////////////////////////////
    // Class variables
    ////////////////////////////////////////////////////////////////////////////

    /* FileHandlerFactory ID */
    public static final String EventHandler_FACTORY_ID = "LeaveFilesharingHandlerFactory"; // NOI18N            

    /**
     * constructor
     *
     */
    public LeaveFilesharingHandlerFactory() {
        super();
    }
    ...
    public EventHandler createEventHandler(CollabContext context) {
        return new LeaveFilesharingHandler(context);
    }
    ...
    public static EventHandlerFactory getDefault() {
        ...
        return new LeaveFilesharingHandlerFactory();
    }
}
