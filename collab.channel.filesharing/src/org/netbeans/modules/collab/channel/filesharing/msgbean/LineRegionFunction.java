 ...
 */
/**
 *        This generated bean class LineRegionFunction
 *        matches the schema element '_line-region-function'.
 *
...
public class LineRegionFunction {
    ...
    private java.util.List _Arguments = new java.util.ArrayList(); // List<java.lang.String>
    ...
    // Deep copy
    public LineRegionFunction(org.netbeans.modules.collab.channel.filesharing.msgbean.LineRegionFunction source) {
        _FunctionName = source._FunctionName;

        for (java.util.Iterator it = source._Arguments.iterator(); it.hasNext();) {
            _Arguments.add((java.lang.String) it.next());
        }
    }
    ...
    public void setArguments(java.lang.String[] value) {
        ...
        for (int i = 0; i < value.length; ++i) {
            _Arguments.add(value[i]);
        }
    }

    public void setArguments(int index, java.lang.String value) {
        _Arguments.set(index, value);
    }

    public java.lang.String[] getArguments() {
        java.lang.String[] arr = new java.lang.String[_Arguments.size()];

        return (java.lang.String[]) _Arguments.toArray(arr);
    }

    public java.util.List fetchArgumentsList() {
        return _Arguments;
    }

    public java.lang.String getArguments(int index) {
        return (java.lang.String) _Arguments.get(index);
    }
    ...
    public int addArguments(java.lang.String value) {
    ...
    public int removeArguments(java.lang.String value) {
        int pos = _Arguments.indexOf(value);

        if (pos >= 0) {
            _Arguments.remove(pos);
        }
    ...
    throws java.io.IOException {
        ...
        if (_FunctionName != null) {
            ...
            out.write("<funtion-name"); // NOI18N
            out.write(">"); // NOI18N
            org.netbeans.modules.collab.channel.filesharing.msgbean.CCollab.writeXML(out, _FunctionName, false);
            out.write("</funtion-name>\n"); // NOI18N
        }

        for (java.util.Iterator it = _Arguments.iterator(); it.hasNext();) {
            java.lang.String element = (java.lang.String) it.next();

            if (element != null) {
                out.write(nextIndent);
                out.write("<arguments"); // NOI18N
                out.write(">"); // NOI18N
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "funtion-name") {
                _FunctionName = childNodeValue;
            } else if (childNodeName == "arguments") {
                java.lang.String aArguments;
                aArguments = childNodeValue;
                _Arguments.add(aArguments);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "funtionName") {
            ...
            throw new IllegalArgumentException(name + " is not a valid property name for LineRegionFunction");
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.LineRegionFunction)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.LineRegionFunction inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.LineRegionFunction) o;

        if (!((_FunctionName == null) ? (inst._FunctionName == null) : _FunctionName.equals(inst._FunctionName))) {
            return false;
        }

        if (sizeArguments() != inst.sizeArguments()) {
            return false;
        }

        // Compare every element.
        for (
            java.util.Iterator it = _Arguments.iterator(), it2 = inst._Arguments.iterator();
    ...
    public int hashCode() {
        int result = 17;
        result = (37 * result) + ((_FunctionName == null) ? 0 : _FunctionName.hashCode());
        result = (37 * result) + ((_Arguments == null) ? 0 : _Arguments.hashCode());
