 ...
 */
/**
 *        This generated bean class ProjectActionList
 *        matches the schema element '_project-action-list'.
 *
...
public class ProjectActionList {
    ...
    public ProjectActionList() {
        _ProjectName = "";
        _ProjectUser = new User();
    }

    // Deep copy
    public ProjectActionList(org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectActionList source) {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "projectName") {
            ...
            throw new IllegalArgumentException(name + " is not a valid property name for ProjectActionList");
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectActionList)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectActionList inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectActionList) o;
