 ...
 */
/**
 *        This generated bean class Content
 *        matches the schema element '_content'.
 *
...
public class Content {
    ...
    // Deep copy
    public Content(org.netbeans.modules.collab.channel.filesharing.msgbean.Content source) {
    ...
    throws java.io.IOException {
        ...
        if (_Encoding != null) {
            ...
            out.write(">"); // NOI18N
            org.netbeans.modules.collab.channel.filesharing.msgbean.CCollab.writeXML(out, _Encoding, false);
            out.write("</encoding>\n"); // NOI18N
        }
        ...
        if (_Data != null) {
            out.write(nextIndent);
            out.write("<data"); // NOI18N
            out.write(">"); // NOI18N
            org.netbeans.modules.collab.channel.filesharing.msgbean.CCollab.writeXML(out, _Data, false);
            out.write("</data>\n"); // NOI18N
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            } else if (childNodeName == "data") {
                _Data = childNodeValue;
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "encoding") {
            ...
            throw new IllegalArgumentException(name + " is not a valid property name for Content");
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.Content)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.Content inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.Content) o;
        ...
        if (!((_Data == null) ? (inst._Data == null) : _Data.equals(inst._Data))) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = (37 * result) + ((_Data == null) ? 0 : _Data.hashCode());
