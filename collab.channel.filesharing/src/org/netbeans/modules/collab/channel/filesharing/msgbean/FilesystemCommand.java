 ...
 */
/**
 *        This generated bean class FilesystemCommand
 *        matches the schema element '_filesystem-command'.
 *
 *        Generated on Sun May 15 18:41:28 PDT 2005
 */
...
public class FilesystemCommand {
    ...
    private RenameFile _RenameFile;

    public FilesystemCommand() {
    }

    // Deep copy
    public FilesystemCommand(org.netbeans.modules.collab.channel.filesharing.msgbean.FilesystemCommand source) {
        _DeleteFile = new org.netbeans.modules.collab.channel.filesharing.msgbean.DeleteFile(source._DeleteFile);
        _RenameFile = new org.netbeans.modules.collab.channel.filesharing.msgbean.RenameFile(source._RenameFile);
    }

    // This attribute is mandatory
    public void setDeleteFile(org.netbeans.modules.collab.channel.filesharing.msgbean.DeleteFile value) {
        _DeleteFile = value;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.DeleteFile getDeleteFile() {
        return _DeleteFile;
    }

    // This attribute is mandatory
    public void setRenameFile(org.netbeans.modules.collab.channel.filesharing.msgbean.RenameFile value) {
        _RenameFile = value;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.RenameFile getRenameFile() {
        return _RenameFile;
    }
    ...
    throws java.io.IOException {
        ...
        if (_DeleteFile != null) {
            _DeleteFile.writeNode(out, "delete-file", nextIndent);
        }

        if (_RenameFile != null) {
            _RenameFile.writeNode(out, "rename-file", nextIndent);
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "delete-file") {
                _DeleteFile = new org.netbeans.modules.collab.channel.filesharing.msgbean.DeleteFile();
                _DeleteFile.readNode(childNode);
            } else if (childNodeName == "rename-file") {
                _RenameFile = new org.netbeans.modules.collab.channel.filesharing.msgbean.RenameFile();
                _RenameFile.readNode(childNode);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "deleteFile") {
            setDeleteFile((DeleteFile) value);
        } else if (name == "renameFile") {
            setRenameFile((RenameFile) value);
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for FilesystemCommand");
        }
    }
    ...
    public void childBeans(boolean recursive, java.util.List beans) {
        if (_DeleteFile != null) {
            if (recursive) {
                _DeleteFile.childBeans(true, beans);
            }

            beans.add(_DeleteFile);
        }

        if (_RenameFile != null) {
            if (recursive) {
                _RenameFile.childBeans(true, beans);
            }

            beans.add(_RenameFile);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.FilesystemCommand)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.FilesystemCommand inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.FilesystemCommand) o;

        if (!((_DeleteFile == null) ? (inst._DeleteFile == null) : _DeleteFile.equals(inst._DeleteFile))) {
            return false;
        }

        if (!((_RenameFile == null) ? (inst._RenameFile == null) : _RenameFile.equals(inst._RenameFile))) {
            return false;
        }
    ...
    public int hashCode() {
        int result = 17;
        result = (37 * result) + ((_DeleteFile == null) ? 0 : _DeleteFile.hashCode());
        result = (37 * result) + ((_RenameFile == null) ? 0 : _RenameFile.hashCode());
