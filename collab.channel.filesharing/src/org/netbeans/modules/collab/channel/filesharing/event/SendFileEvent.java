...
import org.netbeans.modules.collab.channel.filesharing.mdc.event.FileCreated;
...
public class SendFileEvent extends FileCreated {
    ...
    /* LEAVEFILESHARING ID */
    public static final String EVENT_ID = "SendFile"; // NOI18N

    /**
     * constructor
     *
     */
    public SendFileEvent(EventContext evContext) {
        super(evContext);
    }
