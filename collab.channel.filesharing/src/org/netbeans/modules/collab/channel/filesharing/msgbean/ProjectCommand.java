 ...
 */
/**
 *        This generated bean class ProjectCommand
 *        matches the schema element '_project-command'.
 *
...
public class ProjectCommand {
    private ProjectActionList _ProjectActionList;
    private ProjectPerformAction _ProjectPerformAction;

    public ProjectCommand() {
    }

    // Deep copy
    public ProjectCommand(org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectCommand source) {
        _ProjectActionList = new org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectActionList(
                source._ProjectActionList
            );
        _ProjectPerformAction = new org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectPerformAction(
                source._ProjectPerformAction
            );
    }

    // This attribute is mandatory
    public void setProjectActionList(org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectActionList value) {
        _ProjectActionList = value;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectActionList getProjectActionList() {
        return _ProjectActionList;
    }

    // This attribute is mandatory
    public void setProjectPerformAction(
        org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectPerformAction value
    ) {
        _ProjectPerformAction = value;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectPerformAction getProjectPerformAction() {
        return _ProjectPerformAction;
    }
    ...
    throws java.io.IOException {
        ...
        if (_ProjectActionList != null) {
            _ProjectActionList.writeNode(out, "project-action-list", nextIndent);
        }

        if (_ProjectPerformAction != null) {
            _ProjectPerformAction.writeNode(out, "project-perform-action", nextIndent);
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "project-action-list") {
                _ProjectActionList = new org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectActionList();
                _ProjectActionList.readNode(childNode);
            } else if (childNodeName == "project-perform-action") {
                _ProjectPerformAction = new org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectPerformAction();
                _ProjectPerformAction.readNode(childNode);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "projectActionList") {
            setProjectActionList((ProjectActionList) value);
        } else if (name == "projectPerformAction") {
            setProjectPerformAction((ProjectPerformAction) value);
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for ProjectCommand");
        }
    }

    public Object fetchPropertyByName(String name) {
        if (name == "projectActionList") {
            return getProjectActionList();
        }

        if (name == "projectPerformAction") {
            return getProjectPerformAction();
        }
    ...
    public void childBeans(boolean recursive, java.util.List beans) {
        if (_ProjectActionList != null) {
            if (recursive) {
                _ProjectActionList.childBeans(true, beans);
            }

            beans.add(_ProjectActionList);
        }

        if (_ProjectPerformAction != null) {
            if (recursive) {
                _ProjectPerformAction.childBeans(true, beans);
            }

            beans.add(_ProjectPerformAction);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectCommand)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectCommand inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.ProjectCommand) o;

        if (
            !((_ProjectActionList == null) ? (inst._ProjectActionList == null)
                                               : _ProjectActionList.equals(inst._ProjectActionList))
        ) {
            return false;
        }

        if (
            !((_ProjectPerformAction == null) ? (inst._ProjectPerformAction == null)
                                                  : _ProjectPerformAction.equals(inst._ProjectPerformAction))
        ) {
            return false;
        }
    ...
    public int hashCode() {
        int result = 17;
        result = (37 * result) + ((_ProjectActionList == null) ? 0 : _ProjectActionList.hashCode());
        result = (37 * result) + ((_ProjectPerformAction == null) ? 0 : _ProjectPerformAction.hashCode());
