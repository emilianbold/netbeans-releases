 ...
 */
/**
 *        This generated bean class JoinFilesharing
 *        matches the schema element '_join-filesharing'.
 *
 *        Generated on Mon Sep 27 16:53:12 PDT 2004
 */
package org.netbeans.modules.collab.channel.filesharing.msgbean;

public class JoinFilesharing {
    private boolean _BeginJoin;
    private boolean _EndJoin;
    private User _User;

    public JoinFilesharing() {
        _User = new User();
    }

    // Deep copy
    public JoinFilesharing(org.netbeans.modules.collab.channel.filesharing.msgbean.JoinFilesharing source) {
        _BeginJoin = source._BeginJoin;
        _EndJoin = source._EndJoin;
        _User = new org.netbeans.modules.collab.channel.filesharing.msgbean.User(source._User);
    }

    // This attribute is optional
    public void setBeginJoin(boolean value) {
        _BeginJoin = value;
    }

    public boolean isBeginJoin() {
        return _BeginJoin;
    }

    // This attribute is optional
    public void setEndJoin(boolean value) {
        _EndJoin = value;
    }
    ...
    throws java.io.IOException {
        ...
        out.write("<begin-join"); // NOI18N
        out.write(">"); // NOI18N
        out.write(_BeginJoin ? "true" : "false");
        out.write("</begin-join>\n"); // NOI18N
        out.write(nextIndent);
        out.write("<end-join"); // NOI18N
        out.write(">"); // NOI18N
        out.write(_EndJoin ? "true" : "false");
        out.write("</end-join>\n"); // NOI18N
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "begin-join") {
                if (childNode.getFirstChild() == null) {
                    _BeginJoin = true;
                } else {
                    _BeginJoin = java.lang.Boolean.valueOf(childNodeValue).booleanValue();
                }
            } else if (childNodeName == "end-join") {
                if (childNode.getFirstChild() == null) {
                    _EndJoin = true;
                } else {
                    _EndJoin = java.lang.Boolean.valueOf(childNodeValue).booleanValue();
                }
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "beginJoin") {
            setBeginJoin(((java.lang.Boolean) value).booleanValue());
        } else if (name == "endJoin") {
            setEndJoin(((java.lang.Boolean) value).booleanValue());
        } else if (name == "user") {
            setUser((User) value);
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for JoinFilesharing");
        }
    }

    public Object fetchPropertyByName(String name) {
        if (name == "beginJoin") {
            return (isBeginJoin() ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE);
        }

        if (name == "endJoin") {
            return (isEndJoin() ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE);
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.JoinFilesharing)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.JoinFilesharing inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.JoinFilesharing) o;

        if (!(_BeginJoin == inst._BeginJoin)) {
            return false;
        }

        if (!(_EndJoin == inst._EndJoin)) {
            return false;
        }
    ...
    public int hashCode() {
        int result = 17;
        result = (37 * result) + (_BeginJoin ? 0 : 1);
        result = (37 * result) + (_EndJoin ? 0 : 1);
