 ...
 *
 */
public class NewFileAction extends CookieAction {
    ////////////////////////////////////////////////////////////////////////////
    // Class variables
    ////////////////////////////////////////////////////////////////////////////	
    public static final String NEW_FILE_ACTION = NbBundle.getMessage(
            NewFileAction.class, "LBL_NewFileAction_ActionName"
        ); //"Empty File"		
    ...
    public NewFileAction(FilesharingContext context, Node node) {
    ...
    protected void performAction(Node[] nodes) {
        Debug.out.println(NEW_FILE_ACTION + ", actionPerformed"); //NoI18n		

        NotifyDescriptor descriptor = new NotifyDescriptor.InputLine(
                NbBundle.getMessage(NewFileAction.class, "MSG_NewFileAction_NewFileName"),
                NbBundle.getMessage(NewFileAction.class, "MSG_NewFileAction_NewFileTitle"),
        ...
        final String fileName = ((NotifyDescriptor.InputLine) descriptor).getInputText();
