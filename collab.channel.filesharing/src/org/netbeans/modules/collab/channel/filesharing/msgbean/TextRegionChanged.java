 ...
 */
/**
 *        This generated bean class TextRegionChanged
 *        matches the schema element '_text-region-changed'.
 *
...
public class TextRegionChanged {
    ...
    public TextRegionChanged() {
        _TextRegion = new TextRegion();
        _TextChange = new TextChange();
    }

    // Deep copy
    public TextRegionChanged(org.netbeans.modules.collab.channel.filesharing.msgbean.TextRegionChanged source) {
        _TextRegion = new org.netbeans.modules.collab.channel.filesharing.msgbean.TextRegion(source._TextRegion);
        _TextChange = new org.netbeans.modules.collab.channel.filesharing.msgbean.TextChange(source._TextChange);
    }
    ...
    // This attribute is mandatory
    public void setTextChange(org.netbeans.modules.collab.channel.filesharing.msgbean.TextChange value) {
        _TextChange = value;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.TextChange getTextChange() {
        return _TextChange;
    }
    ...
    throws java.io.IOException {
        ...
        if (_TextChange != null) {
            _TextChange.writeNode(out, "text-change", nextIndent);
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "text-region") {
                _TextRegion = new org.netbeans.modules.collab.channel.filesharing.msgbean.TextRegion();
                _TextRegion.readNode(childNode);
            } else if (childNodeName == "text-change") {
                _TextChange = new org.netbeans.modules.collab.channel.filesharing.msgbean.TextChange();
                _TextChange.readNode(childNode);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        } else if (name == "textChange") {
            setTextChange((TextChange) value);
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for TextRegionChanged");
        }
    }
    ...
    public void childBeans(boolean recursive, java.util.List beans) {
        ...
        if (_TextChange != null) {
            if (recursive) {
                _TextChange.childBeans(true, beans);
            }

            beans.add(_TextChange);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.TextRegionChanged)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.TextRegionChanged inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.TextRegionChanged) o;

        if (!((_TextRegion == null) ? (inst._TextRegion == null) : _TextRegion.equals(inst._TextRegion))) {
            return false;
        }

        if (!((_TextChange == null) ? (inst._TextChange == null) : _TextChange.equals(inst._TextChange))) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = (37 * result) + ((_TextChange == null) ? 0 : _TextChange.hashCode());
