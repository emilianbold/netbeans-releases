 ...
 * @version 1.0
 */
public class PauseFilesharingHandlerFactory extends Object implements EventHandlerFactory {
    ////////////////////////////////////////////////////////////////////////////
    // Class variables
    ////////////////////////////////////////////////////////////////////////////

    /* FileHandlerFactory ID */
    public static final String EventHandler_FACTORY_ID = "PauseFilesharingHandlerFactory"; // NOI18N            

    /**
     * constructor
     *
     */
    public PauseFilesharingHandlerFactory() {
        super();
    }
    ...
    public EventHandler createEventHandler(CollabContext context) {
        return new PauseFilesharingHandler(context);
    }
    ...
    public static EventHandlerFactory getDefault() {
        ...
        return new PauseFilesharingHandlerFactory();
    }
}
