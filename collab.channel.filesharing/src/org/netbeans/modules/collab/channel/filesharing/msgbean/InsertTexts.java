 ...
 */
/**
 *        This generated bean class InsertTexts
 *        matches the schema element '_insert-texts'.
 *
...
public class InsertTexts {
    private java.util.List _InsertText = new java.util.ArrayList(); // List<InsertText>

    public InsertTexts() {
    }

    // Deep copy
    public InsertTexts(org.netbeans.modules.collab.channel.filesharing.msgbean.InsertTexts source) {
        for (java.util.Iterator it = source._InsertText.iterator(); it.hasNext();) {
            _InsertText.add(
                new org.netbeans.modules.collab.channel.filesharing.msgbean.InsertText(
                    (org.netbeans.modules.collab.channel.filesharing.msgbean.InsertText) it.next()
                )
            );
        }
    }
    ...
    public void setInsertText(org.netbeans.modules.collab.channel.filesharing.msgbean.InsertText[] value) {
        if (value == null) {
            value = new InsertText[0];
        }

        _InsertText.clear();

        for (int i = 0; i < value.length; ++i) {
            _InsertText.add(value[i]);
        }
    }

    public void setInsertText(int index, org.netbeans.modules.collab.channel.filesharing.msgbean.InsertText value) {
        _InsertText.set(index, value);
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.InsertText[] getInsertText() {
        InsertText[] arr = new InsertText[_InsertText.size()];

        return (InsertText[]) _InsertText.toArray(arr);
    }

    public java.util.List fetchInsertTextList() {
        return _InsertText;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.InsertText getInsertText(int index) {
        return (InsertText) _InsertText.get(index);
    }

    // Return the number of insertText
    public int sizeInsertText() {
        return _InsertText.size();
    }

    public int addInsertText(org.netbeans.modules.collab.channel.filesharing.msgbean.InsertText value) {
        _InsertText.add(value);

        return _InsertText.size() - 1;
    }

    // Search from the end looking for @param value, and then remove it.
    public int removeInsertText(org.netbeans.modules.collab.channel.filesharing.msgbean.InsertText value) {
        int pos = _InsertText.indexOf(value);

        if (pos >= 0) {
            _InsertText.remove(pos);
        }
    ...
    throws java.io.IOException {
        ...
        for (java.util.Iterator it = _InsertText.iterator(); it.hasNext();) {
            org.netbeans.modules.collab.channel.filesharing.msgbean.InsertText element = (org.netbeans.modules.collab.channel.filesharing.msgbean.InsertText) it.next();

            if (element != null) {
                element.writeNode(out, "insert-text", nextIndent);
            }
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "insert-text") {
                InsertText aInsertText = new org.netbeans.modules.collab.channel.filesharing.msgbean.InsertText();
                aInsertText.readNode(childNode);
                _InsertText.add(aInsertText);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "insertText") {
            addInsertText((InsertText) value);
        } else if (name == "insertText[]") {
            setInsertText((InsertText[]) value);
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for InsertTexts");
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.InsertTexts)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.InsertTexts inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.InsertTexts) o;

        if (sizeInsertText() != inst.sizeInsertText()) {
            return false;
        }

        // Compare every element.
        for (
            java.util.Iterator it = _InsertText.iterator(), it2 = inst._InsertText.iterator();
                it.hasNext() && it2.hasNext();
        ) {
            org.netbeans.modules.collab.channel.filesharing.msgbean.InsertText element = (org.netbeans.modules.collab.channel.filesharing.msgbean.InsertText) it.next();
            org.netbeans.modules.collab.channel.filesharing.msgbean.InsertText element2 = (org.netbeans.modules.collab.channel.filesharing.msgbean.InsertText) it2.next();
    ...
    public int hashCode() {
        int result = 17;
        result = (37 * result) + ((_InsertText == null) ? 0 : _InsertText.hashCode());
