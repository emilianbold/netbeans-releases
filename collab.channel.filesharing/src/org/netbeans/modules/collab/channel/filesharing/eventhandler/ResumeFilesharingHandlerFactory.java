...
public class ResumeFilesharingHandlerFactory extends Object implements EventHandlerFactory {
    ...
    public static final String EventHandler_FACTORY_ID = "ResumeFilesharingHandlerFactory"; // NOI18N            

    /**
     * constructor
     *
     */
    public ResumeFilesharingHandlerFactory() {
        super();
    }
    ...
    public EventHandler createEventHandler(CollabContext context) {
        return new ResumeFilesharingHandler(context);
    }
    ...
    public static EventHandlerFactory getDefault() {
        ...
        return new ResumeFilesharingHandlerFactory();
    }
}
