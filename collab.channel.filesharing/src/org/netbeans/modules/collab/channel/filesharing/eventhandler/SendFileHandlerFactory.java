 ...
 * @version 1.0
 */
public class SendFileHandlerFactory extends Object implements EventHandlerFactory {
    ////////////////////////////////////////////////////////////////////////////
    // Class variables
    ////////////////////////////////////////////////////////////////////////////

    /* FileHandlerFactory ID */
    public static final String EventHandler_FACTORY_ID = "SendFileHandlerFactory"; // NOI18N            

    /**
     * constructor
     *
     */
    public SendFileHandlerFactory() {
        super();
    }
    ...
    public EventHandler createEventHandler(CollabContext context) {
        return new SendFileHandler(context);
    }
    ...
    public static EventHandlerFactory getDefault() {
        ...
        return new SendFileHandlerFactory();
    }
}
