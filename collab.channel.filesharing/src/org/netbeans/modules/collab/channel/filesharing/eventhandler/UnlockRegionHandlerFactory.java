 ...
 * @version 1.0
 */
public class UnlockRegionHandlerFactory extends Object implements EventHandlerFactory {
    ////////////////////////////////////////////////////////////////////////////
    // Class variables
    ////////////////////////////////////////////////////////////////////////////

    /* FileHandlerFactory ID */
    public static final String EventHandler_FACTORY_ID = "UnlockRegionHandlerFactory"; // NOI18N            

    /**
     * constructor
     *
     */
    public UnlockRegionHandlerFactory() {
        super();
    }
    ...
    public EventHandler createEventHandler(CollabContext context) {
        return new UnlockRegionHandler(context);
    }
    ...
    public static EventHandlerFactory getDefault() {
        ...
        return new UnlockRegionHandlerFactory();
    }
}
