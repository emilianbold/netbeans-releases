 ...
 */
/**
 *        This generated bean class LineRegionChanged
 *        matches the schema element '_line-region-changed'.
 *
...
public class LineRegionChanged {
    ...
    public LineRegionChanged() {
        _LineRegion = new LineRegion();
        _LineChange = new LineChange();
    }

    // Deep copy
    public LineRegionChanged(org.netbeans.modules.collab.channel.filesharing.msgbean.LineRegionChanged source) {
        _LineRegion = new org.netbeans.modules.collab.channel.filesharing.msgbean.LineRegion(source._LineRegion);
        _LineChange = new org.netbeans.modules.collab.channel.filesharing.msgbean.LineChange(source._LineChange);
    }
    ...
    // This attribute is mandatory
    public void setLineChange(org.netbeans.modules.collab.channel.filesharing.msgbean.LineChange value) {
        _LineChange = value;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.LineChange getLineChange() {
        return _LineChange;
    }
    ...
    throws java.io.IOException {
        ...
        if (_LineRegion != null) {
            _LineRegion.writeNode(out, "line-region", nextIndent);
        }

        if (_LineChange != null) {
            _LineChange.writeNode(out, "line-change", nextIndent);
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "line-region") {
                _LineRegion = new org.netbeans.modules.collab.channel.filesharing.msgbean.LineRegion();
                _LineRegion.readNode(childNode);
            } else if (childNodeName == "line-change") {
                _LineChange = new org.netbeans.modules.collab.channel.filesharing.msgbean.LineChange();
                _LineChange.readNode(childNode);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        } else if (name == "lineChange") {
            setLineChange((LineChange) value);
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for LineRegionChanged");
        }
    }
    ...
    public void childBeans(boolean recursive, java.util.List beans) {
        if (_LineRegion != null) {
            if (recursive) {
                _LineRegion.childBeans(true, beans);
            }

            beans.add(_LineRegion);
        }

        if (_LineChange != null) {
            if (recursive) {
                _LineChange.childBeans(true, beans);
            }

            beans.add(_LineChange);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.LineRegionChanged)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.LineRegionChanged inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.LineRegionChanged) o;

        if (!((_LineRegion == null) ? (inst._LineRegion == null) : _LineRegion.equals(inst._LineRegion))) {
            return false;
        }

        if (!((_LineChange == null) ? (inst._LineChange == null) : _LineChange.equals(inst._LineChange))) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = (37 * result) + ((_LineChange == null) ? 0 : _LineChange.hashCode());
