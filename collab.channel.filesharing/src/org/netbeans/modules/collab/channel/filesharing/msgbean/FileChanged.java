 ...
 */
/**
 *        This generated bean class FileChanged
 *        matches the schema element '_file-changed'.
 *
...
public class FileChanged {
    ...
    private java.util.List _FileChangedData = new java.util.ArrayList(); // List<FileChangedData>
    ...
    // Deep copy
    public FileChanged(org.netbeans.modules.collab.channel.filesharing.msgbean.FileChanged source) {
        _FileGroups = new org.netbeans.modules.collab.channel.filesharing.msgbean.FileGroups(source._FileGroups);

        for (java.util.Iterator it = source._FileChangedData.iterator(); it.hasNext();) {
            _FileChangedData.add(
                new org.netbeans.modules.collab.channel.filesharing.msgbean.FileChangedData(
                    (org.netbeans.modules.collab.channel.filesharing.msgbean.FileChangedData) it.next()
                )
            );
        }
    }
    ...
    public void setFileChangedData(org.netbeans.modules.collab.channel.filesharing.msgbean.FileChangedData[] value) {
        if (value == null) {
            value = new FileChangedData[0];
        }

        _FileChangedData.clear();

        for (int i = 0; i < value.length; ++i) {
            _FileChangedData.add(value[i]);
        }
    }

    public void setFileChangedData(
        int index, org.netbeans.modules.collab.channel.filesharing.msgbean.FileChangedData value
    ) {
        _FileChangedData.set(index, value);
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.FileChangedData[] getFileChangedData() {
        FileChangedData[] arr = new FileChangedData[_FileChangedData.size()];

        return (FileChangedData[]) _FileChangedData.toArray(arr);
    }

    public java.util.List fetchFileChangedDataList() {
        return _FileChangedData;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.FileChangedData getFileChangedData(int index) {
        return (FileChangedData) _FileChangedData.get(index);
    }

    // Return the number of fileChangedData
    public int sizeFileChangedData() {
        return _FileChangedData.size();
    }

    public int addFileChangedData(org.netbeans.modules.collab.channel.filesharing.msgbean.FileChangedData value) {
        _FileChangedData.add(value);

        return _FileChangedData.size() - 1;
    }

    // Search from the end looking for @param value, and then remove it.
    public int removeFileChangedData(org.netbeans.modules.collab.channel.filesharing.msgbean.FileChangedData value) {
        int pos = _FileChangedData.indexOf(value);

        if (pos >= 0) {
            _FileChangedData.remove(pos);
        }
    ...
    throws java.io.IOException {
        ...
        for (java.util.Iterator it = _FileChangedData.iterator(); it.hasNext();) {
            org.netbeans.modules.collab.channel.filesharing.msgbean.FileChangedData element = (org.netbeans.modules.collab.channel.filesharing.msgbean.FileChangedData) it.next();

            if (element != null) {
                element.writeNode(out, "file-changed-data", nextIndent);
            }
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            } else if (childNodeName == "file-changed-data") {
                FileChangedData aFileChangedData = new org.netbeans.modules.collab.channel.filesharing.msgbean.FileChangedData();
                aFileChangedData.readNode(childNode);
                _FileChangedData.add(aFileChangedData);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        } else if (name == "fileChangedData") {
            addFileChangedData((FileChangedData) value);
        } else if (name == "fileChangedData[]") {
            setFileChangedData((FileChangedData[]) value);
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for FileChanged");
        }
    }
    ...
    public Object fetchPropertyByName(String name) {
        ...
        if (name == "fileChangedData[]") {
            return getFileChangedData();
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.FileChanged)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.FileChanged inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.FileChanged) o;

        if (!((_FileGroups == null) ? (inst._FileGroups == null) : _FileGroups.equals(inst._FileGroups))) {
            return false;
        }

        if (sizeFileChangedData() != inst.sizeFileChangedData()) {
            return false;
        }

        // Compare every element.
        for (
            java.util.Iterator it = _FileChangedData.iterator(), it2 = inst._FileChangedData.iterator();
                it.hasNext() && it2.hasNext();
        ) {
            org.netbeans.modules.collab.channel.filesharing.msgbean.FileChangedData element = (org.netbeans.modules.collab.channel.filesharing.msgbean.FileChangedData) it.next();
            org.netbeans.modules.collab.channel.filesharing.msgbean.FileChangedData element2 = (org.netbeans.modules.collab.channel.filesharing.msgbean.FileChangedData) it2.next();
    ...
    public int hashCode() {
        ...
        result = (37 * result) + ((_FileChangedData == null) ? 0 : _FileChangedData.hashCode());
