 ...
 * @version 1.0
 */
public class DocumentChangeHandlerFactory extends Object implements EventHandlerFactory {
    ////////////////////////////////////////////////////////////////////////////
    // Class variables
    ////////////////////////////////////////////////////////////////////////////

    /* FileHandlerFactory ID */
    public static final String EventHandler_FACTORY_ID = "SendChangeHandlerFactory"; // NOI18N            

    /**
     * constructor
     *
     */
    public DocumentChangeHandlerFactory() {
        super();
    }
    ...
    public EventHandler createEventHandler(CollabContext context) {
        return new DocumentChangeHandler(context);
    }
    ...
    public static EventHandlerFactory getDefault() {
        ...
        return new DocumentChangeHandlerFactory();
    }
}
