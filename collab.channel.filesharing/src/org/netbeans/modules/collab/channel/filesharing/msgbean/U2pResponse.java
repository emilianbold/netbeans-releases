...
/**
 *        This generated bean class U2pResponse
 *        matches the schema element '_u2p_response'.
 *
 *        Generated on Tue Aug 09 15:08:11 PDT 2005
 */
package org.netbeans.modules.collab.channel.filesharing.msgbean;

public class U2pResponse {
    private boolean _ContentionFound;
    private boolean _ContentionNotfound;

    public U2pResponse() {
    }

    // Deep copy
    public U2pResponse(org.netbeans.modules.collab.channel.filesharing.msgbean.U2pResponse source) {
        _ContentionFound = source._ContentionFound;
        _ContentionNotfound = source._ContentionNotfound;
    }

    // This attribute is mandatory
    public void setContentionFound(boolean value) {
        _ContentionFound = value;
    }

    public boolean isContentionFound() {
        return _ContentionFound;
    }

    // This attribute is mandatory
    public void setContentionNotfound(boolean value) {
        _ContentionNotfound = value;
    }

    public boolean isContentionNotfound() {
        return _ContentionNotfound;
    }
    ...
    throws java.io.IOException {
        ...
        out.write("<contention-found"); // NOI18N
        out.write(">"); // NOI18N
        out.write(_ContentionFound ? "true" : "false");
        out.write("</contention-found>\n"); // NOI18N
        out.write(nextIndent);
        out.write("<contention-notfound"); // NOI18N
        out.write(">"); // NOI18N
        out.write(_ContentionNotfound ? "true" : "false");
        out.write("</contention-notfound>\n"); // NOI18N
        out.write(indent);
        out.write("</" + nodeName + ">\n");
    }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "contention-found") {
                if (childNode.getFirstChild() == null) {
                    _ContentionFound = true;
                } else {
                    _ContentionFound = java.lang.Boolean.valueOf(childNodeValue).booleanValue();
                }
            } else if (childNodeName == "contention-notfound") {
                if (childNode.getFirstChild() == null) {
                    _ContentionNotfound = true;
                } else {
                    _ContentionNotfound = java.lang.Boolean.valueOf(childNodeValue).booleanValue();
                }
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "contentionFound") {
            setContentionFound(((java.lang.Boolean) value).booleanValue());
        } else if (name == "contentionNotfound") {
            setContentionNotfound(((java.lang.Boolean) value).booleanValue());
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for U2pResponse");
        }
    }

    public Object fetchPropertyByName(String name) {
        if (name == "contentionFound") {
            return (isContentionFound() ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE);
        }

        if (name == "contentionNotfound") {
            return (isContentionNotfound() ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE);
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.U2pResponse)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.U2pResponse inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.U2pResponse) o;

        if (!(_ContentionFound == inst._ContentionFound)) {
            return false;
        }

        if (!(_ContentionNotfound == inst._ContentionNotfound)) {
            return false;
        }
    ...
    public int hashCode() {
        int result = 17;
        result = (37 * result) + (_ContentionFound ? 0 : 1);
        result = (37 * result) + (_ContentionNotfound ? 0 : 1);
