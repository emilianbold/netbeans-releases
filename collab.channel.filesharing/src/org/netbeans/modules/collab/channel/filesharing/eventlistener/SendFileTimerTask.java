 ...
 */
public class SendFileTimerTask extends FilesharingTimerTask {
    /**
     *
     *
     */
    public SendFileTimerTask(EventNotifier eventNotifier, CollabEvent event, CollabContext context) {
