...
/**
 *        This generated bean class Use2phase
 *        matches the schema element '_use2phase'.
 *
 *        Generated on Tue Aug 09 15:08:11 PDT 2005
 */
package org.netbeans.modules.collab.channel.filesharing.msgbean;

public class Use2phase {
    private java.lang.String _Use2phaseId;
    private boolean _Request;
    private U2pResponse _Response;
    ...
    // Deep copy
    public Use2phase(org.netbeans.modules.collab.channel.filesharing.msgbean.Use2phase source) {
        _Use2phaseId = source._Use2phaseId;
        _Request = source._Request;
        _Response = new org.netbeans.modules.collab.channel.filesharing.msgbean.U2pResponse(source._Response);
        _Begin = source._Begin;
    }

    // This attribute is mandatory
    public void setUse2phaseId(java.lang.String value) {
        _Use2phaseId = value;
    }

    public java.lang.String getUse2phaseId() {
        return _Use2phaseId;
    }
    ...
    // This attribute is optional
    public void setResponse(org.netbeans.modules.collab.channel.filesharing.msgbean.U2pResponse value) {
        _Response = value;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.U2pResponse getResponse() {
        return _Response;
    }
    ...
    throws java.io.IOException {
        ...
        if (_Use2phaseId != null) {
            out.write(nextIndent);
            out.write("<use2phase-id"); // NOI18N
            out.write(">"); // NOI18N
            org.netbeans.modules.collab.channel.filesharing.msgbean.CCollab.writeXML(out, _Use2phaseId, false);
            out.write("</use2phase-id>\n"); // NOI18N
        }

        out.write(nextIndent);
        out.write("<request"); // NOI18N
        out.write(">"); // NOI18N
        out.write(_Request ? "true" : "false");
        out.write("</request>\n"); // NOI18N

        if (_Response != null) {
            _Response.writeNode(out, "response", nextIndent);
        }

        out.write(nextIndent);
        out.write("<begin"); // NOI18N
        out.write(">"); // NOI18N
        out.write(_Begin ? "true" : "false");
        out.write("</begin>\n"); // NOI18N
        out.write(indent);
        out.write("</" + nodeName + ">\n");
    }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "use2phase-id") {
                _Use2phaseId = childNodeValue;
            } else if (childNodeName == "request") {
                if (childNode.getFirstChild() == null) {
                    _Request = true;
                } else {
                    _Request = java.lang.Boolean.valueOf(childNodeValue).booleanValue();
                }
            } else if (childNodeName == "response") {
                _Response = new org.netbeans.modules.collab.channel.filesharing.msgbean.U2pResponse();
                _Response.readNode(childNode);
            } else if (childNodeName == "begin") {
                if (childNode.getFirstChild() == null) {
                    _Begin = true;
                } else {
                    _Begin = java.lang.Boolean.valueOf(childNodeValue).booleanValue();
                }
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "use2phaseId") {
            setUse2phaseId((java.lang.String) value);
        } else if (name == "request") {
            setRequest(((java.lang.Boolean) value).booleanValue());
        } else if (name == "response") {
            setResponse((U2pResponse) value);
        } else if (name == "begin") {
            setBegin(((java.lang.Boolean) value).booleanValue());
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for Use2phase");
        }
    }

    public Object fetchPropertyByName(String name) {
        if (name == "use2phaseId") {
            return getUse2phaseId();
        }

        if (name == "request") {
            return (isRequest() ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE);
        }
        ...
        if (name == "begin") {
            return (isBegin() ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE);
        }
    ...
    public void childBeans(boolean recursive, java.util.List beans) {
        if (_Response != null) {
            if (recursive) {
                _Response.childBeans(true, beans);
            }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.Use2phase)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.Use2phase inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.Use2phase) o;

        if (!((_Use2phaseId == null) ? (inst._Use2phaseId == null) : _Use2phaseId.equals(inst._Use2phaseId))) {
            return false;
        }

        if (!(_Request == inst._Request)) {
            return false;
        }

        if (!((_Response == null) ? (inst._Response == null) : _Response.equals(inst._Response))) {
            return false;
        }

        if (!(_Begin == inst._Begin)) {
            return false;
        }
    ...
    public int hashCode() {
        int result = 17;
        result = (37 * result) + ((_Use2phaseId == null) ? 0 : _Use2phaseId.hashCode());
        result = (37 * result) + (_Request ? 0 : 1);
        result = (37 * result) + ((_Response == null) ? 0 : _Response.hashCode());
        result = (37 * result) + (_Begin ? 0 : 1);
