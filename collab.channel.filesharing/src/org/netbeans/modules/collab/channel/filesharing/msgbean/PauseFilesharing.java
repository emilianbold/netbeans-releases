 ...
 */
/**
 *        This generated bean class PauseFilesharing
 *        matches the schema element '_pause-filesharing'.
 *
...
public class PauseFilesharing {
    ...
    public PauseFilesharing() {
        _JoinUser = new JoinUser();
        _Moderator = new Moderator();
        _FileOwners = new FileOwners();
        _Users = new Users();
        _FileGroups = new FileGroups();
    }

    // Deep copy
    public PauseFilesharing(org.netbeans.modules.collab.channel.filesharing.msgbean.PauseFilesharing source) {
        _JoinUser = new org.netbeans.modules.collab.channel.filesharing.msgbean.JoinUser(source._JoinUser);
        _Moderator = new org.netbeans.modules.collab.channel.filesharing.msgbean.Moderator(source._Moderator);
        _FileOwners = new org.netbeans.modules.collab.channel.filesharing.msgbean.FileOwners(source._FileOwners);
    ...
    public void setJoinUser(org.netbeans.modules.collab.channel.filesharing.msgbean.JoinUser value) {
        _JoinUser = value;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.JoinUser getJoinUser() {
        return _JoinUser;
    }

    // This attribute is mandatory
    public void setModerator(org.netbeans.modules.collab.channel.filesharing.msgbean.Moderator value) {
        _Moderator = value;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.Moderator getModerator() {
        return _Moderator;
    }

    // This attribute is mandatory
    public void setFileOwners(org.netbeans.modules.collab.channel.filesharing.msgbean.FileOwners value) {
        _FileOwners = value;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.FileOwners getFileOwners() {
        return _FileOwners;
    }
    ...
    throws java.io.IOException {
        ...
        if (_JoinUser != null) {
            _JoinUser.writeNode(out, "join-user", nextIndent);
        }

        if (_Moderator != null) {
            _Moderator.writeNode(out, "moderator", nextIndent);
        }

        if (_FileOwners != null) {
            _FileOwners.writeNode(out, "file-owners", nextIndent);
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "join-user") {
                _JoinUser = new org.netbeans.modules.collab.channel.filesharing.msgbean.JoinUser();
                _JoinUser.readNode(childNode);
            } else if (childNodeName == "moderator") {
                _Moderator = new org.netbeans.modules.collab.channel.filesharing.msgbean.Moderator();
                _Moderator.readNode(childNode);
            } else if (childNodeName == "file-owners") {
                _FileOwners = new org.netbeans.modules.collab.channel.filesharing.msgbean.FileOwners();
                _FileOwners.readNode(childNode);
            } else if (childNodeName == "users") {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "joinUser") {
            setJoinUser((JoinUser) value);
        } else if (name == "moderator") {
            setModerator((Moderator) value);
        } else if (name == "fileOwners") {
            setFileOwners((FileOwners) value);
        } else if (name == "users") {
            setUsers((Users) value);
        } else if (name == "fileGroups") {
            setFileGroups((FileGroups) value);
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for PauseFilesharing");
        }
    }
    ...
    public void childBeans(boolean recursive, java.util.List beans) {
        if (_JoinUser != null) {
            if (recursive) {
                _JoinUser.childBeans(true, beans);
            }
        ...
        if (_Moderator != null) {
            if (recursive) {
                _Moderator.childBeans(true, beans);
            }

            beans.add(_Moderator);
        }

        if (_FileOwners != null) {
            if (recursive) {
                _FileOwners.childBeans(true, beans);
            }

            beans.add(_FileOwners);
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.PauseFilesharing)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.PauseFilesharing inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.PauseFilesharing) o;

        if (!((_JoinUser == null) ? (inst._JoinUser == null) : _JoinUser.equals(inst._JoinUser))) {
            return false;
        }

        if (!((_Moderator == null) ? (inst._Moderator == null) : _Moderator.equals(inst._Moderator))) {
            return false;
        }

        if (!((_FileOwners == null) ? (inst._FileOwners == null) : _FileOwners.equals(inst._FileOwners))) {
            return false;
        }
    ...
    public int hashCode() {
        int result = 17;
        result = (37 * result) + ((_JoinUser == null) ? 0 : _JoinUser.hashCode());
        result = (37 * result) + ((_Moderator == null) ? 0 : _Moderator.hashCode());
        result = (37 * result) + ((_FileOwners == null) ? 0 : _FileOwners.hashCode());
