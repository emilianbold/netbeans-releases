 ...
 */
/**
 *        This generated bean class FileOwners
 *        matches the schema element '_file-owners'.
 *
...
public class FileOwners {
    ...
    // Deep copy
    public FileOwners(org.netbeans.modules.collab.channel.filesharing.msgbean.FileOwners source) {
        _Users = new org.netbeans.modules.collab.channel.filesharing.msgbean.Users(source._Users);
    }

    // This attribute is mandatory
    public void setUsers(org.netbeans.modules.collab.channel.filesharing.msgbean.Users value) {
        _Users = value;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.Users getUsers() {
        return _Users;
    }
    ...
    throws java.io.IOException {
        ...
        if (_Users != null) {
            _Users.writeNode(out, "users", nextIndent);
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "users") {
                _Users = new org.netbeans.modules.collab.channel.filesharing.msgbean.Users();
                _Users.readNode(childNode);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "users") {
            ...
            throw new IllegalArgumentException(name + " is not a valid property name for FileOwners");
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.FileOwners)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.FileOwners inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.FileOwners) o;

        if (!((_Users == null) ? (inst._Users == null) : _Users.equals(inst._Users))) {
            return false;
        }
    ...
    public int hashCode() {
        int result = 17;
        result = (37 * result) + ((_Users == null) ? 0 : _Users.hashCode());
