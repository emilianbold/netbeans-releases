 ...
 */
/**
 *        This generated bean class LineRange
 *        matches the schema element '_line-range'.
 *
...
public class LineRange {
    private java.math.BigInteger _FromLine;
    private java.math.BigInteger _ToLine;

    public LineRange() {
        _FromLine = new java.math.BigInteger("0");
        _ToLine = new java.math.BigInteger("0");
    }

    // Deep copy
    public LineRange(org.netbeans.modules.collab.channel.filesharing.msgbean.LineRange source) {
        _FromLine = source._FromLine;
        _ToLine = source._ToLine;
    }

    // This attribute is mandatory
    public void setFromLine(java.math.BigInteger value) {
        _FromLine = value;
    }

    public java.math.BigInteger getFromLine() {
        return _FromLine;
    }

    // This attribute is mandatory
    public void setToLine(java.math.BigInteger value) {
        _ToLine = value;
    }

    public java.math.BigInteger getToLine() {
        return _ToLine;
    }
    ...
    throws java.io.IOException {
        ...
        if (_FromLine != null) {
            ...
            out.write("<from-line"); // NOI18N
            out.write(">"); // NOI18N
            out.write(_FromLine.toString());
            out.write("</from-line>\n"); // NOI18N
        }

        if (_ToLine != null) {
            out.write(nextIndent);
            out.write("<to-line"); // NOI18N
            out.write(">"); // NOI18N
            out.write(_ToLine.toString());
            out.write("</to-line>\n"); // NOI18N
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "from-line") {
                _FromLine = new java.math.BigInteger(childNodeValue);
            } else if (childNodeName == "to-line") {
                _ToLine = new java.math.BigInteger(childNodeValue);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "fromLine") {
            setFromLine((java.math.BigInteger) value);
        } else if (name == "toLine") {
            setToLine((java.math.BigInteger) value);
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for LineRange");
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.LineRange)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.LineRange inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.LineRange) o;

        if (!((_FromLine == null) ? (inst._FromLine == null) : _FromLine.equals(inst._FromLine))) {
            return false;
        }

        if (!((_ToLine == null) ? (inst._ToLine == null) : _ToLine.equals(inst._ToLine))) {
            return false;
        }
    ...
    public int hashCode() {
        int result = 17;
        result = (37 * result) + ((_FromLine == null) ? 0 : _FromLine.hashCode());
        result = (37 * result) + ((_ToLine == null) ? 0 : _ToLine.hashCode());
