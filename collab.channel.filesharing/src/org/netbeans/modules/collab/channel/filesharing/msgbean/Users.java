 ...
 */
/**
 *        This generated bean class Users
 *        matches the schema element '_users'.
 *
...
public class Users {
    private java.util.List _User = new java.util.ArrayList(); // List<User>

    public Users() {
    }

    // Deep copy
    public Users(org.netbeans.modules.collab.channel.filesharing.msgbean.Users source) {
        for (java.util.Iterator it = source._User.iterator(); it.hasNext();) {
            _User.add(
                new org.netbeans.modules.collab.channel.filesharing.msgbean.User(
                    (org.netbeans.modules.collab.channel.filesharing.msgbean.User) it.next()
                )
            );
        }
    }
    ...
    public void setUser(int index, org.netbeans.modules.collab.channel.filesharing.msgbean.User value) {
        _User.set(index, value);
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.User[] getUser() {
        User[] arr = new User[_User.size()];

        return (User[]) _User.toArray(arr);
    }

    public java.util.List fetchUserList() {
        return _User;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.User getUser(int index) {
        return (User) _User.get(index);
    }
    ...
    public int addUser(org.netbeans.modules.collab.channel.filesharing.msgbean.User value) {
        _User.add(value);
    ...
    public int removeUser(org.netbeans.modules.collab.channel.filesharing.msgbean.User value) {
        int pos = _User.indexOf(value);
    ...
    throws java.io.IOException {
        ...
        for (java.util.Iterator it = _User.iterator(); it.hasNext();) {
            org.netbeans.modules.collab.channel.filesharing.msgbean.User element = (org.netbeans.modules.collab.channel.filesharing.msgbean.User) it.next();

            if (element != null) {
                element.writeNode(out, "user", nextIndent);
            }
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            if (childNodeName == "user") {
                User aUser = new org.netbeans.modules.collab.channel.filesharing.msgbean.User();
                aUser.readNode(childNode);
                _User.add(aUser);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        if (name == "user") {
            ...
            throw new IllegalArgumentException(name + " is not a valid property name for Users");
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.Users)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.Users inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.Users) o;

        if (sizeUser() != inst.sizeUser()) {
            return false;
        }

        // Compare every element.
        for (
            java.util.Iterator it = _User.iterator(), it2 = inst._User.iterator(); it.hasNext() && it2.hasNext();
        ) {
            org.netbeans.modules.collab.channel.filesharing.msgbean.User element = (org.netbeans.modules.collab.channel.filesharing.msgbean.User) it.next();
            org.netbeans.modules.collab.channel.filesharing.msgbean.User element2 = (org.netbeans.modules.collab.channel.filesharing.msgbean.User) it2.next();
