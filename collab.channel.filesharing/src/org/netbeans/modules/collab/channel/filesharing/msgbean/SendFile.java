 ...
 */
/**
 *        This generated bean class SendFile
 *        matches the schema element '_send-file'.
 *
...
public class SendFile {
    ...
    private java.util.List _SendFileData = new java.util.ArrayList(); // List<SendFileData>
    ...
    // Deep copy
    public SendFile(org.netbeans.modules.collab.channel.filesharing.msgbean.SendFile source) {
        _FileGroups = new org.netbeans.modules.collab.channel.filesharing.msgbean.FileGroups(source._FileGroups);

        for (java.util.Iterator it = source._SendFileData.iterator(); it.hasNext();) {
            _SendFileData.add(
                new org.netbeans.modules.collab.channel.filesharing.msgbean.SendFileData(
                    (org.netbeans.modules.collab.channel.filesharing.msgbean.SendFileData) it.next()
                )
            );
        }
    }
    ...
    public void setSendFileData(org.netbeans.modules.collab.channel.filesharing.msgbean.SendFileData[] value) {
        if (value == null) {
            value = new SendFileData[0];
        }

        _SendFileData.clear();

        for (int i = 0; i < value.length; ++i) {
            _SendFileData.add(value[i]);
        }
    }

    public void setSendFileData(int index, org.netbeans.modules.collab.channel.filesharing.msgbean.SendFileData value) {
        _SendFileData.set(index, value);
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.SendFileData[] getSendFileData() {
        SendFileData[] arr = new SendFileData[_SendFileData.size()];

        return (SendFileData[]) _SendFileData.toArray(arr);
    }

    public java.util.List fetchSendFileDataList() {
        return _SendFileData;
    }

    public org.netbeans.modules.collab.channel.filesharing.msgbean.SendFileData getSendFileData(int index) {
        return (SendFileData) _SendFileData.get(index);
    }

    // Return the number of sendFileData
    public int sizeSendFileData() {
        return _SendFileData.size();
    }

    public int addSendFileData(org.netbeans.modules.collab.channel.filesharing.msgbean.SendFileData value) {
        _SendFileData.add(value);

        return _SendFileData.size() - 1;
    }

    // Search from the end looking for @param value, and then remove it.
    public int removeSendFileData(org.netbeans.modules.collab.channel.filesharing.msgbean.SendFileData value) {
        int pos = _SendFileData.indexOf(value);

        if (pos >= 0) {
            _SendFileData.remove(pos);
        }
    ...
    throws java.io.IOException {
        ...
        for (java.util.Iterator it = _SendFileData.iterator(); it.hasNext();) {
            org.netbeans.modules.collab.channel.filesharing.msgbean.SendFileData element = (org.netbeans.modules.collab.channel.filesharing.msgbean.SendFileData) it.next();

            if (element != null) {
                element.writeNode(out, "send-file-data", nextIndent);
            }
        }
    ...
    public void readNode(org.w3c.dom.Node node) {
        ...
        for (int i = 0, size = children.getLength(); i < size; ++i) {
            ...
            } else if (childNodeName == "send-file-data") {
                SendFileData aSendFileData = new org.netbeans.modules.collab.channel.filesharing.msgbean.SendFileData();
                aSendFileData.readNode(childNode);
                _SendFileData.add(aSendFileData);
            } else {
    ...
    public void changePropertyByName(String name, Object value) {
        ...
        } else if (name == "sendFileData") {
            addSendFileData((SendFileData) value);
        } else if (name == "sendFileData[]") {
            setSendFileData((SendFileData[]) value);
        } else {
            throw new IllegalArgumentException(name + " is not a valid property name for SendFile");
        }
    }
    ...
    public Object fetchPropertyByName(String name) {
        ...
        if (name == "sendFileData[]") {
            return getSendFileData();
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.netbeans.modules.collab.channel.filesharing.msgbean.SendFile)) {
            return false;
        }

        org.netbeans.modules.collab.channel.filesharing.msgbean.SendFile inst = (org.netbeans.modules.collab.channel.filesharing.msgbean.SendFile) o;

        if (!((_FileGroups == null) ? (inst._FileGroups == null) : _FileGroups.equals(inst._FileGroups))) {
            return false;
        }

        if (sizeSendFileData() != inst.sizeSendFileData()) {
            return false;
        }

        // Compare every element.
        for (
            java.util.Iterator it = _SendFileData.iterator(), it2 = inst._SendFileData.iterator();
                it.hasNext() && it2.hasNext();
        ) {
            org.netbeans.modules.collab.channel.filesharing.msgbean.SendFileData element = (org.netbeans.modules.collab.channel.filesharing.msgbean.SendFileData) it.next();
            org.netbeans.modules.collab.channel.filesharing.msgbean.SendFileData element2 = (org.netbeans.modules.collab.channel.filesharing.msgbean.SendFileData) it2.next();
    ...
    public int hashCode() {
        ...
        result = (37 * result) + ((_SendFileData == null) ? 0 : _SendFileData.hashCode());
