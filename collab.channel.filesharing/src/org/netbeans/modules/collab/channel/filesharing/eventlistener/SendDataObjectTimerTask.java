 ...
 * @author  Owner
 */
public class SendDataObjectTimerTask extends FilesharingTimerTask {
    /**
     *
     *
     */
    public SendDataObjectTimerTask(EventNotifier eventNotifier, CollabEvent event, CollabContext context) {
