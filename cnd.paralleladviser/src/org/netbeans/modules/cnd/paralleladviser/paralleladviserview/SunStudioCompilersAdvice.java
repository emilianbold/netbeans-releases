 ...
 */
public class SunStudioCompilersAdvice implements Advice {

    public JComponent getComponent() {

        URL iconUrl = SunStudioCompilersAdvice.class.getClassLoader().getResource("org/netbeans/modules/cnd/paralleladviser/paralleladviserview/resources/info.png"); // NOI18N

        return ParallelAdviserAdviceUtils.createAdviceComponent(
                ParallelAdviserAdviceUtils.createAdviceHtml(iconUrl,
                getString("PAT_Sun_Studio_Compilers_Title"), // NOI18N
                getString("PAT_Sun_Studio_Compilers_Body"), // NOI18N
                800), null); // NOI18N
    }
