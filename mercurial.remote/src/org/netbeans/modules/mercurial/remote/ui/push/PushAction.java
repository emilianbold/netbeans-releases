...
public class PushAction extends ContextAction {
    ...
    public static void getDefaultAndPerformPush(VCSFileProxy root, String revisionToPush,
        ...
        try {
            ...
            VCSFileProxy sourceRoot = VCSFileProxy.createFileProxy(root, tmpPushPath);
            if (sourceRoot.isDirectory()) {
                pushTarget = new HgURL(sourceRoot.normalizeFile());
            } else {
    ...
    static void performPush(VCSFileProxy root, HgURL pushUrl, String fromPrjName,
        ...
        try {
            ...
            VCSFileProxy pushFile = bLocalPush ? VCSFileProxySupport.getResource(root, pushPath) : null;
            ...
            if (bNoChanges) {
                ...
                if(hooks.size() > 0) {
                    ...
                    context = new HgHookContext(new VCSFileProxy[] {root}, null, entries);
                }
