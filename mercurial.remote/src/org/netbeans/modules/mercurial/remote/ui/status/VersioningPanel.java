...
class VersioningPanel extends JPanel implements ExplorerManager.Provider, PreferenceChangeListener, PropertyChangeListener, ActionListener {
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        if (evt.getPropertyName() == Mercurial.PROP_CHANGESET_CHANGED) {
            ...
            VCSFileProxy root  = HgUtils.getRootFile(context);
...
//                    File root = HgUtils.getRootFile(HgUtils.getCurrentContext(null));
    ...
    private void refreshStatuses() {
        ...
        final VCSFileProxy repository  = HgUtils.getRootFile(context);
        if (repository == null) {
            return;
        }
...
//                }
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("org/netbeans/modules/mercurial/remote/ui/status/Bundle"); // NOI18N
