...
import org.netbeans.modules.mercurial.remote.ui.log.IncomingAction;
import org.netbeans.modules.mercurial.remote.ui.log.OutAction;
...
import org.netbeans.modules.mercurial.remote.ui.pull.PullCurrentBranchAction;
import org.netbeans.modules.mercurial.remote.ui.pull.PullOtherAction;
import org.netbeans.modules.mercurial.remote.ui.push.PushAction;
import org.netbeans.modules.mercurial.remote.ui.push.PushCurrentBranchAction;
import org.netbeans.modules.mercurial.remote.ui.push.PushOtherAction;
...
public class RemoteMenu extends DynamicMenu implements Presenter.Popup {
    ...
    protected JMenu createMenu() {
        ...
        if (lkp == null) {
            ...
            Action action = Utils.getAcceleratedAction("Actions/MercurialRemote/org-netbeans-modules-mercurial-ui-clone-CloneExternalAction.instance"); //NOI18N
            if (action != null) {
                item = new JMenuItem();
