...
import org.netbeans.modules.mercurial.remote.ui.branch.CloseBranchAction;
import org.netbeans.modules.mercurial.remote.ui.branch.CreateBranchAction;
import org.netbeans.modules.mercurial.remote.ui.branch.SwitchToBranchAction;
...
import org.netbeans.modules.mercurial.remote.ui.tag.CreateTagAction;
import org.netbeans.modules.mercurial.remote.ui.tag.ManageTagsAction;
    ...
    protected JMenu createMenu() {
        ...
        if (lkp == null) {
            ...
            if (ctx != null) {
                ...
                for (VCSFileProxy f : ctx.getRootFiles()) {
                ...
                if (repositoryRoot != null) {
                    List<String> recentlySwitched = Utils.getStringList(NbPreferences.forModule(BranchMenu.class), SwitchToBranchAction.PREF_KEY_RECENT_BRANCHES + repositoryRoot.getPath());
