...
class GoToPatch {
    ...
    private static final String ICON_QUEUE_PATH = "org/netbeans/modules/mercurial/remote/resources/icons/queue.png"; //NOI18N
    private static final Icon icon = ImageUtilities.loadImageIcon(ICON_QUEUE_PATH, true);

    public GoToPatch (VCSFileProxy repository) {
            ...
            if (comp instanceof JComponent) {
                ...
                if (isPatch) {
                    ...
                    if (comp instanceof JLabel && !isSelected) {
                        ((JLabel) comp).setForeground(UIManager.getColor("Label.disabledForeground")); //NOI18N
                    }
                }
            }
            return comp;
