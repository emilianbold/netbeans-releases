...
public final class Setup extends AbstractDiffSetup {
                ...
                | FileInformation.STATUS_VERSIONED_ADDEDLOCALLY)) {
                    ...
                    if (fileStatus != null && fileStatus.isCopied()) {
                        if (fileStatus.getOriginalFile() != null && !fileStatus.getOriginalFile().exists()) {
                            if (fileStatus.getOriginalFile().getParentFile().getPath()
                                    .equals(baseFile.getParentFile().getPath())) {
     ...
     */
    public Setup(VCSFileProxy baseFile, HgRevision firstRevision, HgRevision secondRevision, FileInformation info, final boolean forceNonEditable) {
