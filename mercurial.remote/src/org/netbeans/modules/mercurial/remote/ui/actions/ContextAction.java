...
public abstract class ContextAction extends NodeAction {
    ...
    protected String getContextDisplayName(VCSContext ctx) {
        ...
        if (objectCount == 0) {
            ...
            if (projectsOnly) {
                try {
                    return MessageFormat.format(NbBundle.getMessage(ContextAction.class, "MSG_ActionContext_MultipleProjects"), objectCount);  // NOI18N
                } catch (MissingResourceException ex) {
                    // ignore use files alternative bellow
                }
            }
            return MessageFormat.format(NbBundle.getMessage(ContextAction.class, "MSG_ActionContext_MultipleFiles"), objectCount);  // NOI18N
        }
    }
}
