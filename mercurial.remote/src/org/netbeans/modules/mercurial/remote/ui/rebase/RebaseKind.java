...
abstract class RebaseKind {
    ...
    public static class BasicKind extends RebaseKind {
        ...
        @Override
        @Messages("LBL_RebaseKind.basic.displayName=Current Revision To Tipmost Head")
        public String getDisplayName () {
            return Bundle.LBL_RebaseKind_basic_displayName();
        }

        @Override
        @Messages("LBL_RebaseKind.basic.description=Moves Working Directory parent and its ancestors to the tipmost current branch's head")
    ...
    public static class SelectDestinationKind extends RebaseKind implements ActionListener {
        ...
        public SelectDestinationKind (VCSFileProxy repository, Collection<HgLogMessage> branchHeads, HgLogMessage workingCopyParent) {
        ...
        @Override
        @Messages("LBL_RebaseKind.destination.displayName=Current Revision To Any Destination")
        public String getDisplayName () {
            return Bundle.LBL_RebaseKind_destination_displayName();
        }

        @Override
        @Messages("LBL_RebaseKind.destination.description=Moves Working Directory parent and its ancestors to an arbitrary destination changeset")
        public String getDescription () {
    ...
    public static class SelectBaseKind extends RebaseKind implements ActionListener {
        ...
        public SelectBaseKind (VCSFileProxy repository, Collection<HgLogMessage> branchHeads, HgLogMessage workingCopyParent) {
        ...
        @Override
        @Messages("LBL_RebaseKind.base.displayName=Revision To Any Destination")
        public String getDisplayName () {
            return Bundle.LBL_RebaseKind_base_displayName();
        }

        @Override
        @Messages("LBL_RebaseKind.base.description=Moves any changeset and its ancestors to an arbitrary destination changeset")
        public String getDescription () {
    ...
    public static class SelectSourceKind extends RebaseKind implements ActionListener {
        ...
        public SelectSourceKind (VCSFileProxy repository, Collection<HgLogMessage> branchHeads, HgLogMessage workingCopyParent) {
        ...
        @Override
        @Messages("LBL_RebaseKind.source.displayName=Tree To Any Destination")
        public String getDisplayName () {
            return Bundle.LBL_RebaseKind_source_displayName();
        }

        @Override
        @Messages("LBL_RebaseKind.source.description=Moves any changeset and all its descendants to an arbitrary destination changeset")
        public String getDescription () {
