 ...
 * <p>
 * Adds GlassFish Server item into Add Server wizard. This is top level class
 * connecting Add GlassFish user account wizard to common Add Server wizard.
 * <p/>
 * GlassFish User Account represents cloud access to deploy an application.
...
public class GlassFishAccountWizardProvider implements ServerWizardProvider {
    ...
    /** The display name of GlassFish user account wizard retrieved from
     *  message bundle. */
    ...
    /**
     * Creates an instance of GlassFish User Account Wizard.
     * <p/>
     * The display name of GlassFish Add User Account wizard is initialized
