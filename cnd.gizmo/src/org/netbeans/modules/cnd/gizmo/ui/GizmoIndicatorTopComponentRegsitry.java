...
final class GizmoIndicatorTopComponentRegsitry implements PropertyChangeListener {
    ...
    private GizmoIndicatorTopComponentRegsitry() {
        ...
        opened = new HashSet<GizmoIndicatorsTopComponent>();
    }

    static GizmoIndicatorTopComponentRegsitry getRegistry() {
        if (instance == null) {
    ...
    Set<GizmoIndicatorsTopComponent> getOpened() {
        return new HashSet<GizmoIndicatorsTopComponent>(opened);
    }

    GizmoIndicatorsTopComponent getActivated() {
        return getActive();
    }
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        if (TopComponent.Registry.PROP_ACTIVATED.equals(evt.getPropertyName())) {
            ...
            if (tc instanceof GizmoIndicatorsTopComponent) {
                opened.add((GizmoIndicatorsTopComponent) tc);
                setActive((GizmoIndicatorsTopComponent) tc);
                firePropertyChangeEvent(new PropertyChangeEvent(evt.getSource(), PROP_DLIGHT_TC_ACTIVATED, evt.getOldValue(), evt.getNewValue()));
    ...
    private synchronized void setActive(GizmoIndicatorsTopComponent tc) {
        active = new WeakReference<GizmoIndicatorsTopComponent>(tc);
