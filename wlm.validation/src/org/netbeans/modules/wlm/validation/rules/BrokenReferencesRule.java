 ...
 * @author anjeleevich
 */
public class BrokenReferencesRule extends WLMValidationRecursiveRule {

    public BrokenReferencesRule(WLMValidationResultBuilder builder) {
        super(builder);
    }
    ...
    public void visitLocalNotification(TLocalNotification localNotification) {
        WLMReference<TNotification> notificationRef = localNotification
                .getNotification();
        if (notificationRef != null && notificationRef.get() == null) {
            addError(localNotification, "REFERENCE_IS_BROKEN"); // NOI18N
        }
    }
}
