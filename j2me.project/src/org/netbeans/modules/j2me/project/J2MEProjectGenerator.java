...
/**
 * Creates a J2ME Project from scratch according to some initial configuration.
 *
...
public class J2MEProjectGenerator {
     ...
     *
     * @param dir the top-level directory (need not yet exist but if it does it
     * must be empty)
     * @param name the name for the project
     * @param librariesDefinition project relative or absolute OS path to
     * libraries definition; can be null
     * @return the helper object permitting it to be further customized
     * @throws IOException in case something went wrong
     */
    public static AntProjectHelper createProject(final File dir, final String name, final String midletName,
            final String midletTemplate, final JavaPlatform javaPlatform,
        ...
        AntProjectHelper h = new J2SEProjectBuilder(dir, name).
                addDefaultSourceRoots().
                skipTests(skipTests).
                setMainClass(midletName).
                setMainClassTemplate(midletTemplate).
    ...
    public static AntProjectHelper createProject(final File dir, final String name,
            final JavaPlatform javaPlatform,
    ...
    /**
     * Field used by unit tests.
     */
    private static SpecificationVersion defaultSourceLevel;

    /**
     * Unit test only method. Sets the default source level for tests where the
     * default platform is not available.
     *
