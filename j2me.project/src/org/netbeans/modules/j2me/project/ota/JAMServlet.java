...
package org.netbeans.modules.j2me.project.ota;
...
public class JAMServlet extends HttpServlet {
    ...
    /**
     * Handles a request to a repository item. Returns true if the request was
     * handled, i.e. if the URL corresponds to a repository FileObject.
     * According to whether this file object is a folder, either outputs the
     * file with appropriate content type or outputs a directory and file
