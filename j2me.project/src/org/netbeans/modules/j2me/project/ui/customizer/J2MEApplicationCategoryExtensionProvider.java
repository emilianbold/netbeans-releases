...
public class J2MEApplicationCategoryExtensionProvider implements J2SECategoryExtensionProvider {
    ...
    public JComponent createComponent(Project p, ConfigChangeListener listener) {
        ...
        return meDisabled ? null : J2MEProjectProperties.getInstance(p.getLookup()).getApplicationPanel();
    }
