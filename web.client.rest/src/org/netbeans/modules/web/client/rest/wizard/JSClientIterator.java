 ...
 *
 */
public class JSClientIterator implements InstantiatingIterator{
    ...
    public void initialize( WizardDescriptor descriptor ) {
        ...
        myPanels = new WizardDescriptor.Panel[]{
                ...
                sources.getSourceGroups(Sources.TYPE_GENERIC)).bottomPanel(myWadlPanel).create() };
    }
