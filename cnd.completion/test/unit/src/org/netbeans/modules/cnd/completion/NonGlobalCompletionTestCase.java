...
public class NonGlobalCompletionTestCase extends CompletionBaseTestCase {
     ...
     */
    public NonGlobalCompletionTestCase(String testName) {
        super(testName, true);
    }

    public void testIZ184085() throws Exception {
        // IZ#184085 -  Bit fields show up in multiple places in code completion
        super.performTest("iz184085.cc", 13, 4, "err_tmp.");
    }
}
