...
public class PropertyActionSettings extends SystemOption {
    ...
    public void setGenAccess (int access) {
        putProperty (PROP_ACCESS, new Integer (access), false);
    ...
    public void setGenBound (boolean bound) {
        putProperty (PROP_BOUND, bound ? Boolean.TRUE : Boolean.FALSE, false);
        if (!(initializing || isReadExternal()))
    ...
    public void setGenConstrained (boolean constrained ) {
        putProperty (PROP_CONSTR, constrained ? Boolean.TRUE : Boolean.FALSE, false);
        if (!(initializing || isReadExternal()))
    ...
    public void setGenIndexed (boolean indexed ) {
        putProperty (PROP_INDEXED, indexed ? Boolean.TRUE : Boolean.FALSE, false);
        if (!(initializing || isReadExternal()))
    ...
    public void setUseInherit (boolean inherit ) {
        putProperty (PROP_INHER, inherit ? Boolean.TRUE : Boolean.FALSE, false);
        if (!(initializing || isReadExternal()))
    ...
    public void setAskBeforeGen (boolean ask ) {
        putProperty (ASK_BEFORE, ask ? Boolean.TRUE : Boolean.FALSE, false);
        if (!(initializing || isReadExternal()))
