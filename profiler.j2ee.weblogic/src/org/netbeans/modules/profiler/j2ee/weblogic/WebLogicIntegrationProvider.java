...
@NbBundle.Messages({  
    ...
    "WebLogicIntegrationProvider_WindowsAnchorText=just after the <code>SETLOCAL</code> command:",
    "WebLogicIntegrationProvider_Wl81AnchorText=just after the line containing <code># Initialize the common environment.</code>:",
    "WebLogicIntegrationProvider_Wl9AnchorText=just before the line containing <code># --- Start Functions ---</code>:",
    ...
    "WebLogicIntegrationProvider_ManualRemoteStep4Msg=Put the following settings at the beginning of <code>startWebLogic_nbprofiler.{0}</code> {1}<br><code>{2}<br>{3}</code><br>For setting <code>JAVA_OPTIONS</code> the {4}.<br><br>{5}",
    ...
    "WebLogicIntegrationProvider_ManualDirectStep2Msg=Put the following settings at the beginning of <code>startWebLogic_nbprofiler.{0}</code> {1}<br><code>{2}<br>{3}</code><br><br>{4}",
    ...
    "WebLogicIntegrationProvider_ManualDynamicStep2Msg=Put the following settings at the beginning of <code>startWebLogic_nbprofiler.{0}</code> {1}<br><code>{2}</code><br><br>{3}",
