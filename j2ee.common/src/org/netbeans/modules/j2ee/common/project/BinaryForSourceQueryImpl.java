...
public class BinaryForSourceQueryImpl implements BinaryForSourceQueryImplementation {        
    ...
    private BinaryForSourceQueryImpl(SourceRoots src, SourceRoots test, AntProjectHelper helper, 
    ...
    public static BinaryForSourceQueryImplementation createBinaryForSourceQueryImplementation(SourceRoots src, SourceRoots test, 
            AntProjectHelper helper, PropertyEvaluator eval, String[] sourceProps, String[] testProps) {
        return new BinaryForSourceQueryImpl(src, test, helper, eval, sourceProps, testProps);
    }
