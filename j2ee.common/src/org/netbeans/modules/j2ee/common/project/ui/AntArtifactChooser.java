...
public final class AntArtifactChooser extends JPanel implements PropertyChangeListener {
    ...
    public static ArtifactItem[] showDialog( String[] artifactTypes, Project master, Component parent ) {
        ...
        chooser.setCurrentDirectory (UserProjectSettings.getDefault().getLastUsedArtifactFolder(defaultFolder));
        ...
        if ( option == JFileChooser.APPROVE_OPTION ) {
            ...
            UserProjectSettings.getDefault().setLastUsedArtifactFolder (FileUtil.normalizeFile(chooser.getCurrentDirectory()));
