 ...
 */
package org.netbeans.modules.cnd.codemodel.impl.jclank.visit;
...
import org.netbeans.modules.cnd.codemodel.impl.jclank.core.CMTranslationUnitJClank;
 ...
 */
@ServiceProvider(path = CMVisitQueryImplementation.PATH, service = CMVisitQueryImplementation.class, position = 500)
public class CMVisitQueryJClank implements CMVisitQueryImplementation {
  ...
  @Override
  public boolean visitReferences(CMIndexImplementation idx, IndexCallbackImplementation callback) {
    throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
  }
  ...
  public boolean canTokenizeSourceRange(CMTranslationUnitImplementation tu, CMSourceRangeImplementation range) {
    return tu instanceof CMTranslationUnitJClank;
  }
