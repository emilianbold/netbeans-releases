...
public class EjbChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabelDesc.setDisplayedMnemonic(org.openide.util.NbBundle.getMessage(EjbChooser.class, "MNE_SelectBeanDescription").charAt(0));
        jLabelDesc.setLabelFor(jPanelBeanTree);
        jLabelDesc.setText(org.openide.util.NbBundle.getMessage(EjbChooser.class, "LBL_SelectBeanDescription"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(11, 11, 0, 11);
        add(jLabelDesc, gridBagConstraints);
        jLabelDesc.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(EjbChooser.class, "LBL_SelectBeanDescription"));
        ...
        jPanelBeanTree.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(EjbChooser.class, "A11Y_BeanTree_Name"));
        jPanelBeanTree.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(EjbChooser.class, "A11Y_BeanTree_Name"));
        ...
        jLabelError.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(EjbChooser.class, "A11Y_BeanTreeError_Name"));
        jLabelError.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(EjbChooser.class, "A11Y_BeanTreeError_Name"));
