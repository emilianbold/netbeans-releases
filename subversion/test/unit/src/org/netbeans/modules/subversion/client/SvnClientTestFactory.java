 ...
 * @author Tomas Stupka
 */
public class SvnClientTestFactory {

    /** Creates a new instance of SvnClientFactory */
    private SvnClientTestFactory() {
    }
    ...
    private static SvnClientTestFactory instance;
     ...
     */
    public synchronized static SvnClientTestFactory getInstance() {
        init();
        return instance;
    }
    ...
    public synchronized static void init() {
        if(instance == null) {
            instance = new SvnClientTestFactory();
            instance.setup();
        }
    }
    ...
    public static void setClientType (final String clientType) {
    ...
    private boolean  setupSvnKit () {
        try {
            if(!SvnKitClientAdapterFactory.isAvailable() && !SvnClientAdapterFactory.getInstance().setup(SvnClientAdapterFactory.Client.svnkit)) {
