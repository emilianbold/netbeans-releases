...
//    private final transient RubyElementCtx element;
    private final transient CsmObject element;
...
//                    if (method != null) {
//                        m_isBaseClassText = new MessageFormat(NbBundle.getMessage(WhereUsedPanel.class, "LBL_UsagesOfBaseClass")).format(new Object[]{methodDeclaringSuperClass = method.getIn()});
