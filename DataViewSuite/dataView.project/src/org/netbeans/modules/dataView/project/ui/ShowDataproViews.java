...
class ShowDataproViews {

    private ShowDataproViews() {
    }
    ...
    static final class LogicalViewChildren extends Children.Keys implements FileChangeListener {
        ...
        private void createNodes() {
            ...
            DataFolder srcDir = getFolder(ShowDataproProjectProperties.SRC_DIR);
        ...
        protected Node[] createNodes(Object key) {
            ...
            if (key == KEY_SOURCE_DIR) {
                FileObject srcRoot = helper.resolveFileObject(evaluator.getProperty(ShowDataproProjectProperties.SRC_DIR));
                DataObject fileDO;
                try {
                    fileDO = DataObject.find(srcRoot);
                    n = new ViewItemNode((DataFolder) fileDO, "SQLStatements", "SQLStatements");
