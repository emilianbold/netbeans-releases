 ...
 */
package org.netbeans.modules.dataView.project.ui;
...
import org.netbeans.modules.dataView.project.ShowDataproProject;
 ...
 * @author Petr Hrebejk
 */
public class ShowDataproLogicalViewProvider implements LogicalViewProvider {
    ...
    public ShowDataproLogicalViewProvider(Project project, AntProjectHelper helper, PropertyEvaluator evaluator, SubprojectProvider spp, ReferenceHelper resolver) {
    ...
    public Node createLogicalView() {
        return new DVlLogicalViewRootNode();
    }
    ...
    private static final String[] BREAKABLE_PROPERTIES = new String[]{
        ShowDataproProjectProperties.JAVAC_CLASSPATH,
        ShowDataproProjectProperties.DEBUG_CLASSPATH,
        ShowDataproProjectProperties.SRC_DIR,
    };
    ...
    public static boolean hasBrokenLinks(AntProjectHelper helper, ReferenceHelper resolver) {
        return BrokenReferencesSupport.isBroken(helper, resolver, BREAKABLE_PROPERTIES,
                new String[]{ShowDataproProjectProperties.JAVA_PLATFORM});
    }

    /** Filter node containin additional features for the J2SE physical
     */
    private final class DVlLogicalViewRootNode extends AbstractNode {

        private Action brokenLinksAction;
        private boolean broken;

        public DVlLogicalViewRootNode() {
            super(new ShowDataproViews.LogicalViewChildren(helper, evaluator, project), createLookup(project));
            setIconBaseWithExtension("org/netbeans/modules/dataview/project/ui/resources/showdataproProjectIcon.gif"); // NOI18N
        ...
        public Action[] getActions(boolean context) {
            ShowDataproProject pro = (ShowDataproProject) project;
        ...
        protected Sheet createSheet() {
            ...
            String nbBundle9 = "Show Data Project Name";
        ...
        private Action[] getAdditionalActions() {
            ...
            return new Action[]{
                        ...
                        addFromLayers(),
                        //null,
                        //SystemAction.get(TestRunAction.class),
                        null,
        ...
        private class BrokenLinksAction extends AbstractAction implements PropertyChangeListener {
            ...
            public void actionPerformed(ActionEvent e) {
                /*BrokenReferencesSupport.showCustomizer(helper, resolver, BREAKABLE_PROPERTIES, new String[]{EtlproProjectProperties.JAVA_PLATFORM});
                if (!hasBrokenLinks(helper, resolver)) {
                disable();
                }*/
            }
