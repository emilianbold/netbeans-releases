...
import org.netbeans.modules.db.dataview.editor.*;
...
public class SimpleTargetChooserPanelGUI extends javax.swing.JPanel implements ActionListener,
    ...
    String nbBundle20 = "new";
    String nbBundle28 = "Browse...";
    String nbBundle30 = "Collaboration";
    private final String NEW_FILE_PREFIX = nbBundle20; // NOI18N
    ...
    public SimpleTargetChooserPanelGUI(
        ...
        String nbBundle1 = "Name and Location";
        setName(
           nbBundle1
        ); // NOI18N
    }
    ...
    public void initValues(FileObject template, FileObject preselectedFolder) {
        ...
        folderTextField.setText("SQLStatements");
        ...
        if (isFolder) {
            ...
            String nbBundle4 = "Parent Folder:";
            jLabel2.setText(
              nbBundle4
            ); // NOI18N
            String nbBundle5 = "r";
            ...
            String nbBundle6 = "Created Folder:";
            jLabel4.setText(
               nbBundle6
            ); // NOI18N
            String nbBundle7 = "C";
            ...
            String nbBundle8 = "File Name:";
            jLabel3.setText(
              nbBundle8
            ); // NOI18N
            String nbBundle9 = "Folder:";
            jLabel2.setText(
              nbBundle9
            ); // NOI18N
            String nbBundle10 = "Created File:";
            jLabel4.setText(
               nbBundle10
            ); // NOI18N
            String nbBundle11 ="N";
    ...
    private boolean existFileName(FileObject targetFolder, String relFileName) {
        ...
        if (fileForTargetFolder.exists()) {
            File f = new File(fileForTargetFolder + File.separator + getTargetFolder(), relFileName+".dv");            
            if (f.exists()) {
                fileExists = true;
            } else {
                fileExists = false;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        browseButton.setMnemonic(nbBundle28.charAt(0));
        browseButton.getAccessibleContext().setAccessibleName(nbBundle28);
        ...
        String nbBundle31= "Created File:";
        jLabel4.setText(
           nbBundle31
        );
        ...
        public Component getListCellRendererComponent(
            ...
            if (value instanceof SourceGroup) {
                ...
                if (projectDisplayName.equals(groupDisplayName)) {
                    ...
                    String nbBundle33 = groupDisplayName+"["+projectDisplayName+"]";
                    setText(
