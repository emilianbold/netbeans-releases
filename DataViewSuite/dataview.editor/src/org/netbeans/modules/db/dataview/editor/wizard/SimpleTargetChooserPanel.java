...
final class SimpleTargetChooserPanel implements WizardDescriptor.FinishablePanel, ChangeListener {
    ...
    private String canUseFileName(
        ...
        if (targetFolder == null) {
            String nbBundle1 = "The target folder does not exist.";
            return nbBundle1; // NOI18N
        }

        // target filesystem should be writable
        if (!targetFolder.canWrite()) {
            String nbBundle2 ="The target folder is read-only.";
            return nbBundle2; // NOI18N
        }

        if (existFileName(targetFolder, relFileName)) {
            String nbBundle3 = "The file {0} already exists."+ newObjectName;
            return nbBundle3; // NOI18N
        }
    ...
    public void readSettings(Object settings) {
        ...
        String nbBundle4 = "Choose File Type";
        String nbBundle5 = "Name and Location";
        if (substitute != null) {
        ...
        String collabName = (String) wizard.getProperty(DataViewCollaborationWizard.COLLABORATION_NAME);
    ...
    public void storeSettings(Object settings) {
        ...
        ((WizardDescriptor) settings).putProperty(DataViewCollaborationWizard.COLLABORATION_NAME, gui.getTargetName());
