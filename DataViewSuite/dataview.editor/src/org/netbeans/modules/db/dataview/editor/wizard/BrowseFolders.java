...
public class BrowseFolders extends javax.swing.JPanel implements ExplorerManager.Provider {
    ...
    public BrowseFolders( SourceGroup[] folders, Project project, String preselectedFileName ) {
        ...
        String nbBundle1 = "Folders:";
        btv.getAccessibleContext ().setAccessibleName (nbBundle1);
        String nbBundle2 = "The tree contains the folders contained in the project's directory";
        btv.getAccessibleContext ().setAccessibleDescription(nbBundle2);
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        String nbBundle3 = "Browse folders to choose a target folder";
        getAccessibleContext().setAccessibleName(nbBundle3);
        
        getAccessibleContext().setAccessibleDescription(nbBundle3);
        
        String nbBundle5 = "F";
        jLabel1.setDisplayedMnemonic(nbBundle5.charAt(0));
        jLabel1.setLabelFor(folderPanel);
        
        String nbBundle6 = "Folders:";
        jLabel1.setText(nbBundle6);
        jLabel1.getAccessibleContext().setAccessibleName(nbBundle6);
    ...
    public static FileObject showDialog( SourceGroup[] folders, Project project, String preselectedFileName ) {
        ...
        String nbBundle13 = "Select Folder";
        String nbBundle14 = "Cancel";
        JButton options[] = new JButton[] {
            new JButton(nbBundle13), // NOI18N
            new JButton(nbBundle14), // NOI18N
        };
        ...
        String nbBundle8 = "S";
        options[ 0 ].setMnemonic(nbBundle8.charAt(0));
        
        String nbBundle9 = "Select Folder";
        options[ 0 ].getAccessibleContext ().setAccessibleName(nbBundle9);
        
        String nbBundle10 = "N/A";
        options[ 0 ].getAccessibleContext ().setAccessibleDescription(nbBundle10);
        options[ 1 ].setActionCommand( OptionsListener.COMMAND_CANCEL );
        options[ 1 ].addActionListener( optionsListener );
        
        String nbBundle11 = "Cancel";
        options[ 1 ].getAccessibleContext ().setAccessibleName (nbBundle11);
        options[ 1 ].getAccessibleContext ().setAccessibleDescription(nbBundle11);
