...
/**
 * Accepts input of unique name for new DataView Collaboration instance.
 * 
 * @author Sanjeeth Duvuru
 * @version $Revision$
 */
public class DataViewCollaborationWizardNamePanel extends JPanel implements WizardDescriptor.Panel {
    ...
    class NameFieldKeyAdapter extends KeyAdapter {
        ...
        public void keyReleased(KeyEvent e) {
            String collaborationName = DataViewCollaborationWizardNamePanel.this.textField.getText();

            if (collaborationName != null && collaborationName.trim().length() != 0) {
                DataViewCollaborationWizardNamePanel.this.collabName = collaborationName.trim();
            } else {
                DataViewCollaborationWizardNamePanel.this.collabName = null;
            }

            DataViewCollaborationWizardNamePanel.this.fireChangeEvent();
        }
    }
    ...
    protected DataViewCollaborationWizard owner;
     ...
     */
    public DataViewCollaborationWizardNamePanel() {
        ...
        // Text field label.
        String nbBundle1 = "New Collaboration Name:";
        JLabel header = new JLabel(nbBundle1);
        header.setDisplayedMnemonic(nbBundle1.charAt(0));
        header.getAccessibleContext().setAccessibleName(nbBundle1);
     ...
     * 
     * @param myOwner DVWizard that owns this panel
     * @param panelTitle text to display as panel title
     */
    public DataViewCollaborationWizardNamePanel(DataViewCollaborationWizard myOwner, String panelTitle) {
        this();
    ...
    /**
     * @see DVWizardPanel#addChangeListener
     */
    ...
    /**
     * @see DVWizardPanel#fireChangeEvent
     */
    ...
    /**
     * @see DVWizardPanel#getComponent
     */
    ...
    public boolean isDuplicateCollabName() {
        ...
        if (fo != null) { // file exists
            duplicated = true;
            String nbBundle2 = "An object already exists in this project with the name "+collaborationName+".  Please enter a unique name.";
            NotifyDescriptor.Message d1 = new NotifyDescriptor.Message(nbBundle2, NotifyDescriptor.INFORMATION_MESSAGE);
    ...
    /**
     * @see DVWizardPanel#readSettings
     */
    public void readSettings(Object settings) {
        ...
        if (wd != null) {
            String myCollabName = (String) wd.getProperty(DataViewCollaborationWizard.COLLABORATION_NAME);
            textField.setText(myCollabName);
        }
    }

    /**
     * @see DVWizardPanel#removeChangeListener
     */
    ...
    /**
     * @see DVWizardPanel#storeSettings
     */
    public void storeSettings(Object settings) {
        ...
        if (wd != null) {
            ...
            wd.putProperty(DataViewCollaborationWizard.COLLABORATION_NAME, collabName);
        }
    }
}
