...
public class PhysicalView {
    ...
    static final class GroupNode extends FilterNode implements PropertyChangeListener {
         ...
         * DOCUMENT ME!
         */
        String nbBundle1 = NbBundle.getMessage(PhysicalView.class, " {1} - {0}", pi.getDisplayName(), dataFolder.getName());//mLoc.t("BUND083: {1} - {0}", pi.getDisplayName(), dataFolder.getName());
        final String GROUP_NAME_PATTERN =  nbBundle1; // NOI18N
