 ...
 */
public final class DataViewOutputWindowTopComponent extends JPanel {
    ...
    private static Logger mLogger = Logger.getLogger(DataViewOutputWindowTopComponent.class.getName());


    private DataViewOutputWindowTopComponent() {
        initComponents();
    ...
    private class PopupListener extends MouseUtils.PopupMouseAdapter {
        ...
        protected void showPopup(MouseEvent e) {
            pop.show(DataViewOutputWindowTopComponent.this, e.getX(), e.getY());
        }
