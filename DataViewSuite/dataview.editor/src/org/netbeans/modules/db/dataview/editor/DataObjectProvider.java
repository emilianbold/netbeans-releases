...
public class DataObjectProvider {
    ...
    public static DataViewDataObject activeDataObject;
    DataViewSourceMultiViewElement activeEditor;
    ...
    /**
     * Gets the active DataView data object.
     *
     */
    public DataViewDataObject getActiveDataObject() {
        Object obj = TopComponent.getRegistry().getActivated().getLookup().lookup(DataObject.class);
        if (obj instanceof DataViewDataObject) {
            activeDataObject = (DataViewDataObject) obj;
        }
