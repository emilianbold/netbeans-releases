 ...
 * @author  ctnguyen
 */
public class JavaScriptVolumeCustomizer extends javax.swing.JPanel implements Customizer {
     ...
     */
    JavaScriptVolumeCustomizer (String volumeType) {
        this.volumeType = volumeType;
        initComponents();
        postInitComponents ();
        this.setName (NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"TXT_"+volumeType));
    }
    ...
    private void postInitComponents () {
        ...
        /* else if (this.volumeType.equals(ThemeLibraryTypeProvider.VOLUME_TYPE_JAVADOC)) {  //NOI18N
            ...
            this.addButton.setMnemonic(NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"MNE_AddJavadoc").charAt(0));
            this.message.setText(NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"CTL_ContentJavadoc"));
            this.message.setDisplayedMnemonic(NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"MNE_ContentJavadoc").charAt(0));
            this.addButton.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"AD_AddJavadoc"));
            this.message.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"AD_ContentJavadoc"));
...
//            this.add (this.addURLButton);
            ...
            this.addButton.setText (NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"CTL_AddSources"));
            this.addButton.setMnemonic (NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"MNE_AddSources").charAt(0));
            this.message.setText(NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"CTL_ContentSources"));
            this.message.setDisplayedMnemonic(NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"MNE_ContentSources").charAt(0));
            this.addButton.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"AD_AddSources"));
            this.message.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"AD_ContentSources"));
        }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(message, org.openide.util.NbBundle.getBundle(JavaScriptVolumeCustomizer.class).getString("CTL_RemoveContent"));
        ...
        org.openide.awt.Mnemonics.setLocalizedText(addButton, org.openide.util.NbBundle.getBundle(JavaScriptVolumeCustomizer.class).getString("CTL_AddContent"));
        ...
        org.openide.awt.Mnemonics.setLocalizedText(removeButton, org.openide.util.NbBundle.getBundle(JavaScriptVolumeCustomizer.class).getString("CTL_RemoveContent"));
        ...
        org.openide.awt.Mnemonics.setLocalizedText(upButton, org.openide.util.NbBundle.getBundle(JavaScriptVolumeCustomizer.class).getString("CTL_UpContent"));
        ...
        org.openide.awt.Mnemonics.setLocalizedText(downButton, org.openide.util.NbBundle.getBundle(JavaScriptVolumeCustomizer.class).getString("CTL_DownContent"));
    ...
    private void addResource(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addResource
        ...
        if (this.volumeType.equalsIgnoreCase(JavaScriptLibraryTypeProvider.VOLUME_TYPE_SCRIPTPATH)) {        //NOI18N
            chooser.setMultiSelectionEnabled (true);
            chooser.setDialogTitle(NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"TXT_OpenClasses"));
        ...
        /* else if (this.volumeType.equalsIgnoreCase(ThemeLibraryTypeProvider.VOLUME_TYPE_JAVADOC)) {     //NOI18N
            ...
            chooser.setFileSelectionMode(JFileChooser.FILES_AND_DIRECTORIES);
            chooser.setFileFilter (new SimpleFileFilter(NbBundle.getMessage(
                    JavaScriptVolumeCustomizer.class,"TXT_Javadoc"),new String[] {"ZIP","JAR"}));     //NOI18N
            chooser.setApproveButtonText(NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"CTL_SelectJD"));
            chooser.setApproveButtonMnemonic(NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"MNE_SelectJD").charAt(0));
        }
        else if (this.volumeType.equalsIgnoreCase(ThemeLibraryTypeProvider.VOLUME_TYPE_SRC)) {         //NOI18N
            chooser.setDialogTitle(NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"TXT_OpenSources"));
            chooser.setFileSelectionMode(JFileChooser.FILES_AND_DIRECTORIES);
            chooser.setFileFilter (new SimpleFileFilter(NbBundle.getMessage(
                    JavaScriptVolumeCustomizer.class,"TXT_Sources"),new String[] {"ZIP","JAR"}));     //NOI18N
            chooser.setApproveButtonText(NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"CTL_SelectSRC"));
            chooser.setApproveButtonMnemonic(NbBundle.getMessage(JavaScriptVolumeCustomizer.class,"MNE_SelectSRC").charAt(0));
        }
        ...
        public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
            ...
            if (uri != null) {
                ...
                if (broken) {
                    ...
                    toolTip = NbBundle.getMessage (JavaScriptVolumeCustomizer.class,"TXT_BrokenFile");
                }
            }
