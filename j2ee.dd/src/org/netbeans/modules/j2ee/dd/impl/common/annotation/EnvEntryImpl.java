...
/**
 * Default implemetation of {@link EnvEntry}.
 * For getting all {@link EnvEntry}s use one of
 * {@link CommonAnnotationHelper#getEnvEntries CommonAnnotationHelper.getEnvEntries()} methods.
 * <p>
 * For more info see {@link ResourceImpl}.
 * @author Tomas Mysik
 */
public class EnvEntryImpl implements EnvEntry {
    
    private final ResourceImpl resource;
    
    /**
     * Create a new instance of EnvRefImpl.
     * @param resource {@link javax.annotation.Resource @Resource} implementation.
     */
    public EnvEntryImpl(ResourceImpl resource) {
