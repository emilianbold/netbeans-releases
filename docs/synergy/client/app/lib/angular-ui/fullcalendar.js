...
(function($, undefined) {
            ...
            if (!currentView || newViewName != currentView.name) {
                ...
                if (currentView) {
                    ...
                    currentView = viewInstances[newViewName] = new fcViews[newViewName](
                            newViewElement = absoluteViewElement = $("<div class='fc-view fc-view-" + newViewName + "' style='position:absolute'/>")
                            .appendTo(content),
    ...
    function AgendaView(element, calendar, viewName) {
        ...
        function buildSkeleton() {
            ...
            slotScroller = $("<div style='position:absolute;width:100%;overflow-x:hidden;overflow-y:auto'/>")
                    .appendTo(slotLayer);

            slotContent = $("<div style='position:relative;width:100%;overflow:hidden'/>")
                    .appendTo(slotScroller);

            slotSegmentContainer = $("<div style='position:absolute;z-index:8;top:0;left:0'/>")
                ...
                hoverListener.start(function(cell, origCell) {
                    ...
                    if (cell && cell.col == origCell.col && !cellIsAllDay(cell)) {
                        ...
                        dates = [
                            ...
                            d2,
                            addMinutes(cloneDate(d2), opt('slotMinutes'))].sort(cmp);
