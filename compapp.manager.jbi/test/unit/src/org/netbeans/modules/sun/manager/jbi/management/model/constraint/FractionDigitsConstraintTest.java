 ...
 * @author jqian
 */
public class FractionDigitsConstraintTest {

    public FractionDigitsConstraintTest() {
    }
    ...
    /**
     * Test of validate method, of class FractionDigitsConstraint.
     */
    @Test
    public void validate() {
        System.out.println("validate");
        String facet = JBIComponentConfigurationConstraintFactory.FRACTION_DIGITS;
        String value = "3";
        ...
        assertNotNull(constraint.validate("99.9999"));
        assertNull(constraint.validate("-99.99f"));
        assertNull(constraint.validate("-99.999f"));
        assertNotNull(constraint.validate("-99.9999f"));
