 ...
 * @author jqian
 */
public class ApplicationConfigurationsDefaultCustomEditor extends SimpleTabularDataCustomEditor {

    public ApplicationConfigurationsDefaultCustomEditor(SimpleTabularDataEditor editor,
