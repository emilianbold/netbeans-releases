...
/**
 * Length constraint for any type.
 *
 * @author jqian
 */
public class LengthConstraint implements JBIComponentConfigurationConstraint {
    ...
    LengthConstraint(int length) {
        if (length < 0) {
            String msg = NbBundle.getMessage(getClass(),
                    "MSG_ILLEGAL_LENGTH", length); // NOI18N
