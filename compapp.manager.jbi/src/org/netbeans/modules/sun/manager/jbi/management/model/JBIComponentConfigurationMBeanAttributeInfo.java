 ...
 * @author jqian
 */
public class JBIComponentConfigurationMBeanAttributeInfo 
        extends MBeanAttributeInfo {
    
    private JBIComponentConfigurationDescriptor descriptor;
    
    public JBIComponentConfigurationMBeanAttributeInfo(
    ...
    public boolean isEncrypted() {
        return descriptor.isEncrypted();
    }
    
    public boolean isApplicationRestartRequired() {
        return descriptor.isApplicationRestartRequired();
    }
    
    public boolean isComponentRestartRequired() {
        return descriptor.isComponentRestartRequired();
    }
    
    public boolean isServerRestartRequired() {
        return descriptor.isServerRestartRequired();
    }
}
