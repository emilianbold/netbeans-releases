...
public class WaitNode {
    ...
    public static Node createWaitNode() {
        ...
        node.setName(NbBundle.getMessage(WaitNode.class, "LBL_WaitNode_DisplayName")); //NOI18N
        node.setIconBaseWithExtension("org/netbeans/modules/sun/manager/jbi/nodes/resources/wait.gif"); // NOI18N
        return node;
    }
