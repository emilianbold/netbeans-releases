 ...
 */
public interface MapperLsm extends XPathSchemaContextHolder {
     ...
     * @return
     */
    XPathVariable getBaseVariable();

    /**
     * Modifies value of a predicate whotever it mentioning:
     *  -- modifies schema contex if it is cashed. It looks the specified
     * predicate in the SchemaContext and modifies it.
     *  -- modifies location steps with the predicate if relevant. 
     *
     * @param template
     * @param newExpressionsArr
     */
    void modifyPredicate(PredicatedSchemaContext template,
