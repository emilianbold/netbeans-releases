...
/**
 * It is special container for passing context information to popup menu items.
 *
 * @author nk160297
 */
public final class MapperTreeContext {

    private MapperStaticContext mTcContext;
    private boolean mInLeftTree;
    
    public MapperTreeContext(MapperStaticContext tcContext, boolean inLeftTree) {
        mTcContext = tcContext;
        mInLeftTree = inLeftTree;
    }
    
    public MapperStaticContext getStContext() {
        return mTcContext;
    }
