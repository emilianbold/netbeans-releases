 ...
 * @author nikita
 */
public interface PredicateMapperModelFactory {

    XPathMapperModel constructEmptyModel(MapperStaticContext sContext,
            ExtensionsManagerHolder.ReadOnly emhRo);

    XPathMapperModel constructModel(MapperStaticContext sContext,
