...
/**
 * Special static context for the predicate editor.
 *
 *
 * @author Nikita Krjukov
 */
public interface PredicateMapperStatContext extends MapperStaticContext {

    PredicateEditor getPredicateEditor();
    
    void setPredicateEditor(PredicateEditor pe);

    class Wrapper implements PredicateMapperStatContext {

        protected MapperStaticContext mWrapped;
        protected MapperModel mMapperModel;
        protected Mapper mMapper;
        private PredicateEditor mPredicateEditor;

        public Wrapper(MapperStaticContext wrapped) {
            mWrapped = wrapped;
        }

        public PredicateEditor getPredicateEditor() {
            return mPredicateEditor;
        }
