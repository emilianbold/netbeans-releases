...
/**
 * Describes a set of command which can be executed over a predicacate
 *
 * @author Nikita Krjukov
 */
public interface PredicateCommands {
     ...
     * @return
     */
    TreePath addPredicateCmd(MapperPredicate newPred, TreePath subjectTPath,
            boolean inLeftTree, MapperStaticContext stContext);

    boolean modifyPredicateCmd(MapperPredicate oldPred,
            XPathPredicateExpression[] newPredArr, TreePath subjectTPath,
            boolean inLeftTree, MapperStaticContext stContext);

    boolean deletePredicateCmd(MapperPredicate oldPred, TreeItem treeItem, 
