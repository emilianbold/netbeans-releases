...
public class TypeCastTreeModel implements SoaTreeModel, 
    ...
    public TypeCastTreeModel(MapperStaticContext sContext,
            GlobalType baseType, boolean simpleTypesOnly) {
        //
        mBaseType = baseType;
        //
        ExternalModelResolver modelResolver = 
                sContext.getMapperSpi().getExternalModelResolver(sContext);
        assert modelResolver != null;
        //
        mDerivationMap = TypeInheritanceUtil.populateDerivationMap(
                modelResolver, simpleTypesOnly);
    }
