...
public class InstaceRenameRefactoring extends AbstractRefactoring {
    ...
    public void setNewFieldName( String name ){
        myFieldName = name;
        getPlugin().setNewFieldName(name);
    }
    ...
    public void setNewGetterName( String name ){
        myGetterName = name;
        getPlugin().setNewGetterName(name);
    }
    ...
    synchronized ProgressListener getListener(){
        return myListener;
    }

    void setPlugin( InstanceRenamePlugin plugin ){
        myPlugin = plugin;
    }

    void setResult(Problem problem) {
        myProblem = problem;
    }
    ...
    private InstanceRenamePlugin myPlugin;
    private String myFieldName;
    private String myGetterName;
