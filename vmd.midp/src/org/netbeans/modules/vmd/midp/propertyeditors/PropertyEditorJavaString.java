...
public final class PropertyEditorJavaString extends DesignPropertyEditor {
    ...
    private PropertyEditorJavaString() {
        customEditor = new CustomEditor();
    }
    
    public static final PropertyEditorJavaString createInstance() {
        return new PropertyEditorJavaString();
    }
    ...
    private final class CustomEditor extends JPanel {
        ...
        private void initComponents() {
            ...
            JLabel label = new JLabel("Java expression:");
