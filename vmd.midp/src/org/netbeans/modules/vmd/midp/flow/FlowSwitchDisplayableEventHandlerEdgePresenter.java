...
public final class FlowSwitchDisplayableEventHandlerEdgePresenter extends FlowEventHandlerEdgePresenter {
    ...
    protected DesignComponent getTargetComponent () {
        ...
        if (alert != null)
            return alert;
        return component.readProperty (SwitchDisplayableEventHandlerCD.PROP_DISPLAYABLE).getComponent ();
    }
    ...
    protected String getEdgeID () {
        return FlowIDSupport.createSwitchDisplayableEventHandlerEdgeID (getComponent ());
    }
    
    protected boolean isDynamicTargetPin () {
        DesignComponent alert = getComponent ().readProperty (SwitchDisplayableEventHandlerCD.PROP_ALERT).getComponent ();
        if (alert != null)
            return false;
        return super.isDynamicTargetPin ();
    }
