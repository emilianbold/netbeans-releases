 ...
 */
public class ChildrenByTypePC implements InspectorPositionController {
    ...
    public boolean isInside(InspectorFolderPath path, InspectorFolder folder, DesignComponent component) {
        ...
        if (parentComponentID != null ) {
            ...
            for (TypeID typeID : typeIDs) {
                if ( component.getDocument().getDescriptorRegistry().isInHierarchy(typeID, parentComponent.getType()))
                    return true;
            }
        }
