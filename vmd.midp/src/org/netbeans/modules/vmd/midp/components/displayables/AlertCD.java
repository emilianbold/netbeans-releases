...
import java.util.*;
import org.netbeans.modules.vmd.midp.propertyeditors.api.resource.PropertyEditorResourceRE;
    ...
    private static DefaultPropertiesPresenter createPropertiesPresenter() {
        return new DefaultPropertiesPresenter()
                .addPropertiesCategory(MidpPropertiesCategories.CATEGORY_PROPERTIES)
                    .addProperty(NbBundle.getMessage(AlertCD.class, "DISP_Alert_Image"), PropertyEditorResourceRE.createImagePropertyEditor(), PROP_IMAGE) // NOI18N
