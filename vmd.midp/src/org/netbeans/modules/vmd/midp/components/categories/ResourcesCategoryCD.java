...
public final class ResourcesCategoryCD extends ComponentDescriptor {

    public static final TypeID TYPEID = new TypeID (TypeID.Kind.COMPONENT, "#ResourcesCategory"); // NOI18N
    ...
    protected List<? extends Presenter> createPresenters() {
        return Arrays.asList (
            ...
            // actions
            AddActionPresenter.create (AddActionPresenter.ADD_ACTION, 30, ResourceCD.TYPEID)
        );
    }
