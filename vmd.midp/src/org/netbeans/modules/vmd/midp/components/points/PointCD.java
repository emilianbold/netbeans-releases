...
import org.netbeans.modules.vmd.midp.inspector.controllers.PointPC;
...
public final class PointCD extends ComponentDescriptor {
    ...
    public static final TypeID TYPEID = new TypeID (TypeID.Kind.COMPONENT, "#Point"); // NOI18N

    public TypeDescriptor getTypeDescriptor () {
        return new TypeDescriptor (null, PointCD.TYPEID, false, true);
    }
