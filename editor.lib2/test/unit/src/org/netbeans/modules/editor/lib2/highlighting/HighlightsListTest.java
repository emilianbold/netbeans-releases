...
public class HighlightsListTest {
    ...
    public void testSimple() throws Exception {
        ...
        // Fetch first
        AttributeSet attrs = hList.cutSameFont(defaultFont, 10);
        ...
        attrs = hList.cutSameFont(defaultFont, 10);
        ...
        attrs = hList.cutSameFont(defaultFont, 2);
        assert !(attrs instanceof CompoundAttributes);
        assert (attrs == null);
        attrs = hList.cutSameFont(defaultFont, 10);
        assert (hList.startOffset() == 6);
        ...
        hList = highlightsListSimple(doc);
        attrs = hList.cutSameFont(defaultFont, 3);
        cAttrs = (CompoundAttributes) attrs;
        assert (cAttrs.startOffset() == 0) : "startOffset=" + cAttrs.startOffset();
        items = cAttrs.highlightItems();
        assert (items.length == 2);
        ...
        // Next
        attrs = hList.cutSameFont(defaultFont, 5);
        cAttrs = (CompoundAttributes) attrs;
        ...
        // Next
        attrs = hList.cutSameFont(defaultFont, 7);
        assert !(attrs instanceof CompoundAttributes);
        assert (attrs == null);
        assert (hList.startOffset() == 6);
        // Next
