...
public final class PrintUtils {
     ...
     * @return 
     */
    public static List<AttributedCharacterIterator> printDocument(Document doc, boolean printLineNumbers,
            int startOffset, int endOffset)
    {
        assert (SwingUtilities.isEventDispatchThread()) : "EDT required";
        Element lineRoot = doc.getDefaultRootElement();
        AttributedCharacterIterator[] ret = new AttributedCharacterIterator[0];
        ...
        List<AttributedCharacterIterator> attributedLines = new ArrayList<AttributedCharacterIterator>(endLineIndex - startLineIndex);
