...
public final class TypedTextInterceptorsManager {
    ...
    public final class Transaction {
        ...
        public boolean beforeInsertion() {
            for(TypedTextInterceptor i : interceptors) {
                try {
                    ...
                    LOG.log(Level.INFO, "TypedTextInterceptor crashed in beforeInsertion(): " + i, e); //NOI18N
                }
            }
        ...
        public Object [] textTyped() {
            ...
            for(TypedTextInterceptor i : interceptors) {
                ...
                data = TypingHooksSpiAccessor.get().getContextData(context);
                if (data != null) {
                    break;
                }
            }
        ...
        private Transaction(JTextComponent c, int offset, String typedText) {
            this.context = TypingHooksSpiAccessor.get().createContext(c, offset, typedText);
            this.interceptors = getInterceptors(MimePath.parse(DocumentUtilities.getMimeType(c.getDocument())));
        }
    ...
    private Collection<? extends TypedTextInterceptor> getInterceptors(MimePath mimePath) {
        synchronized (cache) {
            ...
            if (interceptors == null) {
                ...
                if (LOG.isLoggable(Level.FINE)) {
                    LOG.fine("TypedTextInterceptor.Factory instances for '" + mimePath.getPath() + "' {"); //NOI18N
                }
                ...
                for(TypedTextInterceptor.Factory f : factories) {
                    ...
                    if (LOG.isLoggable(Level.FINE)) {
                        LOG.fine(f + " created: " + interceptor); //NOI18N
                    }
                }
