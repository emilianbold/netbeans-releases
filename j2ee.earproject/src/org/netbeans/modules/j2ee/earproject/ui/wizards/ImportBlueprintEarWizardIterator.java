...
public class ImportBlueprintEarWizardIterator implements WizardDescriptor.InstantiatingIterator {
    ...
    private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[] {
            new org.netbeans.modules.j2ee.common.ui.wizards.PanelConfigureProject(PROP_NAME_INDEX, NbBundle.getBundle(NewEarProjectWizardIterator.class),true),
        };
    }
    ...
    public Set instantiate() throws IOException {
        ...
        AntProjectHelper h = EarProjectGenerator.importProject(dirF, srcF, name, "1.4");
        try {
