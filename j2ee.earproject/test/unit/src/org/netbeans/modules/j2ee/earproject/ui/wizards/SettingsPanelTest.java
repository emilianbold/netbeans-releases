 ...
 */
public final class SettingsPanelTest extends NbTestCase {
    
    public SettingsPanelTest(String testName) {
        super(testName);
    }
    ...
    public void testIsValidProjectName() {
        ...
        assertTrue("valid name", SettingsPanel.isValidProjectName("i am good name"));
    }
