...
package org.netbeans.modules.encoder.coco.ui.validation;
...
/**
 * Class that provides validation functionality for r.
 *
 * @author Jun Xu
 */
public class CocoEncoderValidator extends XsdBasedEncoderValidator {
    
    private static final ResourceBundle _bundle =
            ResourceBundle.getBundle("org/netbeans/modules/encoder/coco/ui/validation/Bundle");
     ...
     */
    public CocoEncoderValidator(SchemaModel model, ErrorHandler handler) {
        super(CocoEncodingConst.STYLE, model, handler);
    }
    ...
    protected void detectedRecursiveCondition(ValidationContext context,
        ...
        String msg = NbBundle.getMessage(CocoEncoderValidator.class,
                "coco_validator.exp.recursive_condition",  //NOI18N
    ...
    protected void prepareContext(ValidationContext context)
        ...
        if (objLevel == null) {
            throw new ValidationException(
                    _bundle.getString("coco_validator.exp.missing_level_prop"));
        }
    ...
    private void checkGroupWithinGroup(ValidationContext context,
        ...
        if ((sc instanceof LocalGroupDefinition)
            ...
            String msg = NbBundle.getMessage(CocoEncoderValidator.class,
                    "coco_validator.exp.grp_in_grp_not_supported", name);  //NOI18N
    ...
    private void validateLevel(ValidationContext context, Element elem)
        ...
        if (objLevel == null) {
            throw new ValidationException(
                    _bundle.getString("coco_validator.exp.missing_level_property"));
        }
        ...
        if (objLevel.intValue() > MAX_LEVEL) {
            ...
            String msg =
                    NbBundle.getMessage(
                        CocoEncoderValidator.class,
                        "coco_validator.exp.too_many_levels",  //NOI18N
    ...
    private void validateSupportedType(ValidationContext context, Element elem)
        ...
        if (SchemaUtility.isAnyType(getType((TypeContainer) elem))) {
            String msg =
                    NbBundle.getMessage(
                            CocoEncoderValidator.class,
                            "coco_validator.exp.anytype_not_supported",  //NOI18N
                            context.getElementNCNamePath(elem));
            _handler.error(
                new SAXParseException(
                    msg,
