 ...
 */
public class WssElementImpl extends SecurityPolicyComponentImpl implements WssElement {
    
    /**
     * Creates a new instance of WssElementImpl
     */
    public WssElementImpl(WSDLModel model, Element e) {
        super(model, e);
    }
