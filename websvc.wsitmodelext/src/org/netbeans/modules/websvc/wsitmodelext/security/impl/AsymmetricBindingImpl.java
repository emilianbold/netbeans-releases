 ...
 */
public class AsymmetricBindingImpl extends SecurityPolicyComponentImpl implements AsymmetricBinding {
    
    /**
     * Creates a new instance of AsymmetricBindingImpl
     */
    public AsymmetricBindingImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
    public AsymmetricBindingImpl(WSDLModel model){
        this(model, createPrefixedElement(SecurityPolicyQName.ASYMMETRICBINDING.getQName(), model));
    }
