 ...
 */
public class TimestampImpl extends ProprietarySecurityPolicyComponentImpl implements Timestamp {
    
    /**
     * Creates a new instance of TimestampImpl
     */
    public TimestampImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
    public TimestampImpl(WSDLModel model){
        this(model, createPrefixedElement(ProprietarySecurityPolicyServiceQName.TIMESTAMP.getQName(), model));
    }
    ...
    public void setTimeout(String timeout) {
        setAttribute(TIMEOUT, ProprietarySecurityPolicyAttribute.TIMEOUT, timeout);        
    }

    public String getTimeout() {
        return getAttribute(ProprietarySecurityPolicyAttribute.TIMEOUT);
    }
