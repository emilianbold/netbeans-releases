 ...
 */
public class EncryptedElementsImpl extends SecurityPolicyComponentImpl implements EncryptedElements {
    
    /**
     * Creates a new instance of EncryptedElementsImpl
     */
    public EncryptedElementsImpl(WSDLModel model, Element e) {
        super(model, e);
    }
