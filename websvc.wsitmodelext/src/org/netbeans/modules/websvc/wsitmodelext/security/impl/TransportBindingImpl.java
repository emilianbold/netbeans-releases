 ...
 */
public class TransportBindingImpl extends SecurityPolicyComponentImpl implements TransportBinding {
    
    /**
     * Creates a new instance of TransportBindingImpl
     */
    public TransportBindingImpl(WSDLModel model, Element e) {
        super(model, e);
    }
