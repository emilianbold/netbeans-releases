 ...
 */
public interface STSConfiguration extends ExtensibilityElement{
    public static final String ENCRYPTISSUEDKEY = "encryptissuedkey"; //NOI18N
    public static final String ENCRYPTISSUEDTOKEN = "encryptissuedtoken"; //NOI18N
