...
public class CallbackHandlerConfigurationImpl extends ProprietarySecurityPolicyComponentImpl implements CallbackHandlerConfiguration {
    ...
    public CallbackHandlerConfigurationImpl(WSDLModel model){
        this(model, createPrefixedElement(ProprietarySecurityPolicyServiceQName.CALLBACKHANDLERCONFIGURATION.getQName(), model));
    }
