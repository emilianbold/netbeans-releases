 ...
 */
public class BootstrapPolicyImpl extends SecurityPolicyComponentImpl implements BootstrapPolicy {
    
    /**
     * Creates a new instance of BootstrapPolicyImpl
     */
    public BootstrapPolicyImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
    public BootstrapPolicyImpl(WSDLModel model){
        this(model, createPrefixedElement(SecurityPolicyQName.BOOTSTRAPPOLICY.getQName(), model));
    }
