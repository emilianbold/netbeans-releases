 ...
 */
public class SCConfigurationServiceImpl extends ProprietarySCComponentServiceImpl implements SCConfiguration {
    
    /**
     * Creates a new instance of SCConfigurationServiceImpl
     */
    public SCConfigurationServiceImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
    public SCConfigurationServiceImpl(WSDLModel model){
        this(model, createPrefixedElement(ProprietarySCServiceQName.SCCONFIGURATION.getQName(), model));
    }
