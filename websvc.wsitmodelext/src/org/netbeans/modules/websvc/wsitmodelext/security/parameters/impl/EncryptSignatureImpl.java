 ...
 */
public class EncryptSignatureImpl extends SecurityPolicyComponentImpl implements EncryptSignature {
    
    /**
     * Creates a new instance of EncryptSignature
     */
    public EncryptSignatureImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
    public EncryptSignatureImpl(WSDLModel model){
        this(model, createPrefixedElement(SecurityPolicyQName.ENCRYPTSIGNATURE.getQName(), model));
    }
