 ...
 */
public class AddressingServiceNameImpl extends AddressingComponentImpl implements AddressingServiceName {
    
    /**
     * Creates a new instance of AddressingServiceNameImpl
     */
    public AddressingServiceNameImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    ...
    public String getPortName() {
        return getAttribute(AddressingAttribute.PORTNAME);
    }
