 ...
 */
public class TestPercentageGraph {

    public static void main(String[] args) {
        new TestPercentageGraph(64, 100).testPercentageGraph_1();
    }
    ...
    public TestPercentageGraph(int width, int height) {
    ...
    private void testPercentageGraph_1() {
        ...
        final JTextField freq = new JTextField("  100");
        ...
        currData = new short[] { 0, 0 };
        final PercentageGraphComponent graph = new PercentageGraphComponent(
                new PercentageGraph.Descriptor(Color.RED, "Red"),
                new PercentageGraph.Descriptor(Color.BLUE, "Blue"));
    ...
    private void addData(PercentageGraphComponent graph) {
    ...
    private void measure(PercentageGraphComponent graph, JCheckBox byTimer) {
