 ...
 * @author Venkat P
 */
public class DB2QueryGenerator implements DBQueryModel {
    ...
    private static final Logger mLog = Logger.getLogger(DB2QueryGenerator.class.getName());

    private static final String INSERT_QUERY = "insertQuery";

    private static final String UPDATE_QUERY = "updateQuery";

    private DB2QueryGenerator(){
    	
    }
    
    private static final DB2QueryGenerator instance = new DB2QueryGenerator();
    
    public static final DB2QueryGenerator getInstance(){
    	if(instance != null)
    		return instance;
    	else
    		return new DB2QueryGenerator();
    }
    ...
    public String createInsertQuery() throws Exception {
        ...
        DB2QueryGenerator.mLog.log(Level.INFO, "Generated Insert Query " + sb.toString());
        return sb.toString();
    }
    ...
    public String createUpdateQuery() throws Exception {
        ...
        DB2QueryGenerator.mLog.log(Level.INFO, "Generated Update Query " + sb.toString());
        return sb.toString();
    }
    ...
    public String createDeleteQuery() throws Exception {
        ...
        sb.append(".");
        sb.append("\"" + this.mtabName + "\"");
        DB2QueryGenerator.mLog.log(Level.INFO, "Generated Delete Query " + sb.toString());
        return sb.toString();
    }
    ...
    public String createFindQuery() throws Exception {
        ...
        DB2QueryGenerator.mLog.log(Level.INFO, "Generated Find Query " + sb.toString());
        return sb.toString();
    }
    ...
    public String createPoolQuery() throws Exception {
        ...
        sb.append(".");
        sb.append("\"" + this.mtabName + "\"");
        DB2QueryGenerator.mLog.log(Level.INFO, "Generated Pool Query " + sb.toString());
        return sb.toString();
    }
    ...
    public String getParamOrder(final String queryType) throws Exception {
        final StringBuffer sb = new StringBuffer();
        List tempList = null;
        if (DB2QueryGenerator.INSERT_QUERY.equals(queryType)) {
            tempList = this.mInsertColumns;
        }
        if (DB2QueryGenerator.UPDATE_QUERY.equals(queryType)) {
