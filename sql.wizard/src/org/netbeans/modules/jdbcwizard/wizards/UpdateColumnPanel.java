 ...
 */
public class UpdateColumnPanel extends JPanel implements JDBCTableColumnDisplayable {
    ...
    class MyTColumnModel extends AbstractTableModel {
        ...
        private final String[] tcolumnNames = { NbBundle.getMessage( UpdateColumnPanel.class, "LBL_Columns_Select"), NbBundle.getMessage( UpdateColumnPanel.class, "LBL_Columns_ColumnName")};
    ...
    class RowDataWrapper {
        ...
        public Boolean isSelected() {
            return this.tcolumn.isUpdateSelected() ? Boolean.TRUE : Boolean.FALSE;
        }
        ...
        public void setSelected(final Boolean isSelected) {
            this.tcolumn.setUpdateSelected(isSelected.booleanValue());
        }
    }
    ...
    public List getSelectedColumnTables() {
        ...
        for (int cnt = 0; cnt < allctabs.size(); cnt++) {
            if (((DBColumn) allctabs.get(cnt)).isUpdateSelected()) {
