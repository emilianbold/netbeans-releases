 ...
 * @author joelle
 */
public class NBJSFileObjectBreakpointType  extends BreakpointType{

    private final static String CATEGORY_NAME = NbBundle.getMessage(NBJSFileObjectBreakpointType.class, "LBL_CategoryName");
    private final static String TYPE_DISPLAY_NAME = NbBundle.getMessage(NBJSFileObjectBreakpointType.class, "LBL_FileBreakpointType");
    @Override
