...
public final class NbJSWatchesModel extends NbJSVariablesModel {
    ...
    public NbJSWatchesModel(final ContextProvider contextProvider) {
    ...
    public Object[] getChildren(Object parent, int from, int to)
        ...
        if (parent == ROOT) {
            ...
            Watch watch = (Watch)parent;
            JSProperty property = eval(watch.getExpression());
            return property == null ? new Object[0] : super.getChildren(property, from, to);
        } else {
    ...
    public boolean isLeaf(Object node) throws UnknownTypeException {
        if (node == ROOT) {
            ...
            JSProperty property = eval(watch.getExpression());
            return property == null ? true : super.isLeaf(property);
        } else {
    ...
    public int getChildrenCount(Object node) throws UnknownTypeException {
        ...
        if (node == ROOT) {
            ...
            JSProperty property = eval(watch.getExpression());
            return property == null ? 0 : super.getChildrenCount(property);
        } else {
            return super.getChildrenCount(node);
        }
    }
    
    private JSProperty eval(String expression) {
        JSCallStackFrame frame = debugger.getSelectedFrame();
        if(frame != null) {
    ...
    public String getShortDescription(Object node)
        ...
        if (node == ROOT) {
            ...
            Watch watch = (Watch)node;
            JSProperty property = eval(watch.getExpression());
            return property == null ? getMessage("CTL_WatchesModel.Unknown.Evaluation") : super.getShortDescription(property);
        } else {
    ...
    public Object getValueAt(Object node, String columnID) throws
        ...
        if(node instanceof Watch) {
            ...
            if (WATCH_VALUE_COLUMN_ID.equals(columnID)) {
                return super.getValueAt(property, LOCALS_VALUE_COLUMN_ID);
            } else if(WATCH_TYPE_COLUMN_ID.equals(columnID)) {
                return super.getValueAt(property, LOCALS_TYPE_COLUMN_ID);
            } else if (WATCH_TO_STRING_COLUMN_ID.equals(columnID)) {
                return super.getValueAt(property, LOCALS_TO_STRING_COLUMN_ID);
            }
        } else {
            if (WATCH_VALUE_COLUMN_ID.equals(columnID)) {
    ...
    private static class WatchesListener extends DebuggerManagerAdapter implements PropertyChangeListener {
        ...
        public WatchesListener(NbJSWatchesModel watchesModel) {
            modelRef = new WeakReference<NbJSWatchesModel>(watchesModel);
        ...
        private NbJSWatchesModel getModel() {
            NbJSWatchesModel model = modelRef.get();
            if (model == null) {
        ...
        public void watchAdded(Watch watch) {
            NbJSWatchesModel model = getModel();
            if (model == null) {
                return;
            }
            watch.addPropertyChangeListener(this);
