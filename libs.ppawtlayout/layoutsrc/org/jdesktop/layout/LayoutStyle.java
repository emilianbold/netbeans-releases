...
//                layoutStyle);
     ...
     * 
     * @param component1 the <code>Component</code>
     *               <code>component2</code> is being placed relative to
     * @param component2 the <code>Component</code> being placed
    ...
    public int getPreferredGap(Component component1, Component component2,
        ...
        if (position != 1 && //SwingConstants.NORTH &&
              position != 5 && //SwingConstants.SOUTH &&
              position != 7 && //SwingConstants.WEST &&
