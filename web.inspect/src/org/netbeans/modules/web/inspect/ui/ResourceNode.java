...
import org.netbeans.modules.web.inspect.actions.ReloadResourceAction;
...
/**
 * A node representing a web page resource.
 *
 * @author Jan Stola
 */
public class ResourceNode extends AbstractNode {
    ...
    /**
     * Creates a new {@code ResourceNode} representing the specified resource.
     * 
     * @param resource resource that the node should represent.
     */
    ResourceNode(ResourceInfo resource) {
        super(Children.LEAF, Lookups.singleton(resource));
        setDisplayName(resource.getURL());
    ...
    public Action[] getActions(boolean context) {
        if (actions == null) {
            actions = new Action[] {
                ...
                SystemAction.get(ReloadResourceAction.class)
            };
        }
        return actions;
    }
