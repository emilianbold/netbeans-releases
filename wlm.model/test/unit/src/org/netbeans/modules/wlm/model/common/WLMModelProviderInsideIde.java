 ...
 * @author radval
 */
public class WLMModelProviderInsideIde extends CatalogWriteModelImpl implements 
    WLMModelProvider {
    
    /** Creates a new instance of BPELModelProviderInsideIde */
    public WLMModelProviderInsideIde() {
    }

    public WLMModel getWLMModel(URI locationURI) throws Exception {
        System.out.println(toString() +" :" + locationURI);
        ModelSource source = getModelSource(locationURI);
        WLMModel model = WLMModelFactory.getDefault().getModel(source);
//        model.sync();
       return model;
    }
        ...
        Lookup proxyLookup = Lookups.proxy(
            ...
            public Lookup getLookup() {
                ...
                return Lookups.fixed(new Object[] {
                    ...
                    document,
                    dobj,
                    WLMModelProviderInsideIde.this
                });
            }
        }
        );
