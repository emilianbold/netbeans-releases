...
public class TimeoutImpl extends DeadLineOrDurationImpl implements TTimeout {

	public TimeoutImpl(WLMModel model, Element e) {
		super(model, e);
		// TODO Auto-generated constructor stub
	}

	public TimeoutImpl(WLMModel model) {
		this(model, createNewElement(WLMQNames.TIMEOUT.getQName(), model));
	}

	public void accept(WLMVisitor visitor) {
		// TODO Auto-generated method stub
		visitor.visitTimeout(this);
	}
