 ...
 * @author anjeleevich
 */
public class MessageBodyImpl extends ExpressionImpl implements 
        MessageBody
{
    MessageBodyImpl(WLMModel model, Element childElement) {
        super(model, childElement);
    }

    MessageBodyImpl(WLMModel model) {
        this(model, createNewElement(WLMQNames.BODY.getQName(), model));
    }
