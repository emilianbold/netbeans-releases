...
public class EmailAddressImpl extends ExpressionImpl implements EmailAddress {

    public EmailAddressImpl(WLMModel model, Element e) {
        super(model, e);
    }

    public EmailAddressImpl(WLMModel model) {
        this(model, createNewElement(WLMQNames.EMAIL_ADDRESS.getQName(), 
                model));
    }

    public void accept(WLMVisitor visitor) {
        visitor.visitEmailAddress(this);
    }
