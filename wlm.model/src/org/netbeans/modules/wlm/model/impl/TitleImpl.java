 ...
 */
public class TitleImpl extends ExpressionImpl implements TTitle {

	public TitleImpl(WLMModel model, Element e) {
		super(model, e);
	}

	public TitleImpl(WLMModel model) {
		this(model, createNewElement(WLMQNames.TITLE.getQName(), model));
	}
