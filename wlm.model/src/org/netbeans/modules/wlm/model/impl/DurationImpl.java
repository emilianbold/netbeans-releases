...
public class DurationImpl extends ExpressionImpl implements TDurationExpr {

	public DurationImpl(WLMModel model, Element e) {
		super(model, e);
		// TODO Auto-generated constructor stub
	}

	public DurationImpl(WLMModel model) {
		this(model, createNewElement(WLMQNames.DURATION.getQName(), model));
	}
