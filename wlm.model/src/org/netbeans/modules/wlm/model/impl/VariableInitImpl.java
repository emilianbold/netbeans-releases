 ...
 */
public class VariableInitImpl extends ChangeVariablesImpl implements 
        VariableInit 
{
    public VariableInitImpl(WLMModel model, Element e) {
        super(model, e);
    }

    public VariableInitImpl(WLMModel model) {
        this(model, createNewElement(WLMQNames.VARIABLE_INIT.getQName(), model));
    }
