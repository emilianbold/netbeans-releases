...
public interface EndpointReference {
    ...
    String PORT_TYPE_PROPERTY = "portType";
    String OPERATION_PROPERTY = "operation";
    
    WSDLReference<PortType> getPortType();

    String getPortTypeAsString();

    void setPortType(WSDLReference<PortType> portType);

    WSDLReference<Operation> getOperation();
    String getOperationAsString();

    void setOperation(WSDLReference<Operation> operation);
    void setOperation(WSDLReference<Operation> operation, String wsdlCatalogId);

    OperationReference createOperationReference(Operation referenced);
    PortTypeReference createPortTypeReference(PortType referenced);
}
