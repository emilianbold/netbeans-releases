 ...
 */
public class ActivityStartedRecord extends EventRecord {
    private final String myBranchId;
    private final String myActivityXpath;
    
    /** Creates a new instance of ActivityStartedEvent */
    public ActivityStartedRecord(String branchId, String activityXpath) {
        myBranchId = branchId;
