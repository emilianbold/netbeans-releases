 ...
 */
public class AttachingSourcePathSelectionProvider implements SourcePathSelectionProvider {
    
    private ContextProvider myContextProvider;
    
    /** Creates a new instance of AttachingSourcePathSelectionProvider */
    public AttachingSourcePathSelectionProvider(ContextProvider contextProvider) {
