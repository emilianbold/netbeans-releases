...
//    }
    ...
    public static WizardDescriptor.InstantiatingIterator<?> javafx() {
        return ArchetypeWizards.definedArchetype("org.codehaus.mojo.archetypes", "javafx", "0.3", null, LBL_Maven_JavaFx_Archetype());
    }
    ...
    public static WizardDescriptor.InstantiatingIterator<?> javafxSample() {
        return ArchetypeWizards.definedArchetype("org.codehaus.mojo.archetypes", "sample-javafx", "0.2", null, LBL_Maven_JavaFx_Sample_Archetype());
    }
