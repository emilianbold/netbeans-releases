...
public class MavenWizardIterator implements WizardDescriptor.BackgroundInstantiatingIterator<WizardDescriptor> {
    ...
    public static WizardDescriptor.InstantiatingIterator<?> javafxSample() {
        return ArchetypeWizards.definedArchetype("org.codehaus.mojo.archetypes", "javafx", "0.1-SNAPSHOT", "https://nexus.codehaus.org/content/groups/snapshots-group", LBL_Maven_JavaFx_Sample_Archetype());
    }
