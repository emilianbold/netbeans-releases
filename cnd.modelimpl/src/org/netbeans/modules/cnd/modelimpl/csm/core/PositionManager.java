...
public class PositionManager {
    ...
    public static CsmOffsetable.Position getPosition(CsmUID<CsmFile> uid, int posID) {
        return new LazyOffsPositionImpl((FileImpl) UIDCsmConverter.UIDtoFile(uid), posID);
    }
    ...
    private static Map<Integer, PositionManager.Position> getStorage(CsmUID<CsmFile> uid) {
        return null;
    }        
