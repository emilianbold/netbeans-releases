...
public final class LibProjectImpl extends ProjectBase {
    ...
    private LibProjectImpl(ModelImpl model, FileSystem fs, String includePathName, int sourceUnitId) {
    ...
    public static LibProjectImpl createInstance(ModelImpl model, FileSystem fs, String includePathName, int sourceUnitId) {
