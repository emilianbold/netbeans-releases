 ...
 */
public class LatteStateStack {
    public byte[] stack;
    private int lastIn = -1;

    public LatteStateStack() {
        this(5);
    }

    public LatteStateStack(int stackSize) {
    ...
    public LatteStateStack createClone() {
        LatteStateStack rv = new LatteStateStack(this.size());
        rv.copyFrom(this);
        return rv;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !(obj instanceof LatteStateStack)) {
            return false;
        }
        LatteStateStack s2 = (LatteStateStack) obj;
    ...
    public void copyFrom(LatteStateStack s) {
