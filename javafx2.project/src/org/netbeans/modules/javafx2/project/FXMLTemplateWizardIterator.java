 ...
 */
// TODO rootFolder? allow to select Java Controller and CSS file from source folder only?
...
public class FXMLTemplateWizardIterator implements WizardDescriptor.InstantiatingIterator<WizardDescriptor> {
    ...
    static final String ROOT_FOLDER = "rootFolder"; // NOI18N
    ...
    static final String CSS_CREATE = "cssCreate"; // NOI18N
    ...
    public Set instantiate() throws IOException, IllegalArgumentException {
        ...
        boolean createCSS = (Boolean) wizard.getProperty(FXMLTemplateWizardIterator.CSS_CREATE);
