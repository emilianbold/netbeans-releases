 ...
 */
public final class ProjectDefinitionWizardPanel implements
    ...
    private ProjectDefinitionPanel component;
    private final ChangeSupport supp = new ChangeSupport(this);
    private final ProjectKind kind;

    public ProjectDefinitionWizardPanel(ProjectKind kind) {
        this.kind = kind;
    }
    ...
    public Component getComponent() {
        if (component == null) {
            component = new ProjectDefinitionPanel(this);
            ...
            if (kind.isClassic()) {
                ...
                component.putClientProperty("WizardPanel_contentData", new String[] { stepName, nextStepName }); //NOI18N
            } else {
