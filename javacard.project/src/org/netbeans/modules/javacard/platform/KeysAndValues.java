...
public interface KeysAndValues<T> {
    ...
    public static final class EditablePropertiesAdapter implements KeysAndValues<EditableProperties> {
        private EditableProperties props;
        public EditablePropertiesAdapter (EditableProperties props) {
            this.props = props;
        }
