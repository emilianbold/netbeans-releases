...
@PlatformKind(kind = "RC") //NOI18N
public final class RCFactory implements CardInstanceFactory<RealCard> {
    public RealCard create(JavacardPlatform platform, Properties properties) {
        ...
        String username = ""; //PENDING - not supported yet //NOI18N
        String password = ""; //PENDING - not supported yet //NOI18N
        ...
        String cardUrl = properties.getProperty(
                JavacardDeviceKeyNames.DEVICE_CARDMANAGERURL);
        return new RealCard(platform, id, id, username, password,
                cardUrl, platform.getHome().getAbsolutePath());
    }
}
