...
public class ProjectDefinitionPanel extends JPanel implements DocumentListener, FocusListener, LookupListener, ActionListener {
    ...
    private void initComponents() {
        ...
        platformAndDevicePanel1 = new org.netbeans.modules.javacard.project.ui.PlatformAndDevicePanel();
    ...
    private org.netbeans.modules.javacard.project.ui.PlatformAndDevicePanel platformAndDevicePanel1;
    ...
    public void store(WizardDescriptor d) {
        ...
        if (!invalidPlatform) {
            Collection<? extends Card> serverColl = serverRes.allInstances();
            if (!serverColl.isEmpty()) {
                Card server = serverColl.iterator().next();
                d.putProperty(ProjectPropertyNames.PROJECT_PROP_ACTIVE_DEVICE, server.getId());
            }
        }
    ...
    public void read(WizardDescriptor settings) {
        ...
        platformAndDevicePanel1.setServerAndDevice (activePlatform, activeDevice);
