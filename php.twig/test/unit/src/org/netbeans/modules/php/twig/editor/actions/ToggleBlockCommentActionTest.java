...
public class ToggleBlockCommentActionTest extends TwigActionsTestBase {
    ...
    public void testWholeLine_01() throws Exception {
        TwigOptions.getInstance().setToggleCommentType(ToggleBlockCommentAction.ToggleCommentType.LINE_BY_TWIG);
    ...
    public void testTwigPart_01() throws Exception {
        TwigOptions.getInstance().setToggleCommentType(ToggleBlockCommentAction.ToggleCommentType.FOCUSED_TWIG_PART);
