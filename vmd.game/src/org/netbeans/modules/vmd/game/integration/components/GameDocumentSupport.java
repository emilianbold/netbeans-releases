...
public class GameDocumentSupport {
    ...
    public static void setSingleTile (DesignComponent tiledLayer, int y, int x, int newValue) {
        PropertyValue tilesPropertyValue = tiledLayer.readProperty (TiledLayerCD.PROP_TILES);
        int[][] tiles = GameTypes.getTiles (tilesPropertyValue);
        ...
        tiledLayer.writeProperty (TiledLayerCD.PROP_TILES, GameTypes.createTilesProperty (tiles));
    }
