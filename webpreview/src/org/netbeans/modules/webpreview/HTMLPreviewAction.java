...
import org.netbeans.modules.webpreview.HTMLWebPreviewable.HTMLWebPreviewableImpl;
...
public final class HTMLPreviewAction extends AbstractAction implements Presenter.Toolbar {
    ...
    public HTMLPreviewAction() {
        ...
        putValue(SHORT_DESCRIPTION, "HTML Preview");
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (previewable != null) {
            WebPreviewable.Impl previewImpl = Accessor.getDefault().getImpl(previewable);
            if (previewImpl instanceof HTMLWebPreviewableImpl) {
                ((HTMLWebPreviewableImpl) previewImpl).setPreviewEnabled(((JToggleButton) e.getSource()).isSelected());
            }
        }
    }
