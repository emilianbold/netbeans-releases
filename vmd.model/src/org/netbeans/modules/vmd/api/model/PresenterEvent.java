...
public interface PresenterEvent {
    ...
    /**
     * Returns whether a presenter is changed or not. The presenter is specified dynamically.
     * It means using a component and a presenter id.
     * @param component the component
     * @param presenterClass the presenter class
     * @return true, if the presenter is changed
     */
