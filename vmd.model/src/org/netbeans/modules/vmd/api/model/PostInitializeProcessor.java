...
public abstract class PostInitializeProcessor {
    ...
    private static final Lookup.Result<PostInitializeProcessor> result = Lookup.getDefault ().lookupResult (PostInitializeProcessor.class);

    private String projectType;

    protected PostInitializeProcessor (String projectType) {
