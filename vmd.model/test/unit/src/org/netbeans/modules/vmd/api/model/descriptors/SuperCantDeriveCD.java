 ...
 */
public final class SuperCantDeriveCD extends ComponentDescriptor {
    
    public static final TypeID TYPEID_CLASS = new TypeID(TypeID.Kind.COMPONENT, "#CantDeriveSuper"); // NOI18N
    
    public TypeDescriptor getTypeDescriptor() {
        return new TypeDescriptor(null, TYPEID_CLASS, true, false);
    }
