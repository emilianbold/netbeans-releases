...
public final class CantInstantiateCD extends ComponentDescriptor {

    public static final TypeID TYPEID_CLASS = new TypeID (TypeID.Kind.COMPONENT, "#CantInstatiante"); // NOI18N

    public TypeDescriptor getTypeDescriptor () {
        return new TypeDescriptor(SuperFirstCD.TYPEID_CLASS, TYPEID_CLASS, false, false);
    }
