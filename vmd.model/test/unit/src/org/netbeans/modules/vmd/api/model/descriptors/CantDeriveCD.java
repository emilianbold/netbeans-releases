...
public final class CantDeriveCD extends ComponentDescriptor {
    ...
    public static final TypeID TYPEID_CLASS = new TypeID(TypeID.Kind.COMPONENT, "#CantDerive"); // NOI18N
    
    public TypeDescriptor getTypeDescriptor() {
        return new TypeDescriptor(SuperCantDeriveCD.TYPEID_CLASS, TYPEID_CLASS, true, true);
    }
