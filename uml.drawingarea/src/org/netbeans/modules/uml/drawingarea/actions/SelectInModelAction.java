...
public final class SelectInModelAction extends CookieAction
{
    ...
    protected void performAction(Node[] activatedNodes)
    {
        ...
        if (obj != null)
        {
            ...
            ProjectUtil.selectInModel(UMLJavaAssociationUtil.getAllAssociatedUMLProjects(obj), obj);
        } else
        {
            IElement element = activatedNodes[0].getCookie(IElement.class);
            if (element != null)
            {
    ...
    {
        return NbBundle.getMessage(SelectInModelAction.class, "CTL_SelectInModel");
    }
    ...
    protected boolean enable(Node[] activatedNodes)
    {
        ...
        return activatedNodes[0].getCookie(IElement.class) == null ? false : true;
    }
