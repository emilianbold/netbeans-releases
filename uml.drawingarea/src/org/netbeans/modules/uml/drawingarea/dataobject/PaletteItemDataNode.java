...
public class PaletteItemDataNode extends DataNode
{
    ...
    public PaletteItemDataNode(PaletteItemDataObject obj)
    {
        ...
        paletteItem = obj.getLookup().lookup(PaletteItem.class);
    }
    PaletteItemDataNode(PaletteItemDataObject obj, Lookup lookup)
    {
    ...
    {
        PaletteItemDataObject dObj = (PaletteItemDataObject) getDataObject();
        if (displayName == null)
        {
            ...
            {
                // no explicit name
                if (dObj.isItemValid() == true)
                {
                    
                    displayName = paletteItem.getElementType();
                }
    ...
    public String getShortDescription()
    {
        ...
        if (tooltip == null)
        {
            ...
            if (tooltip == null)
            {
                ...
                if (paletteItem != null)
                {
                    tooltip = paletteItem.getElementType();
                }
                if (tooltip == null)
                {
