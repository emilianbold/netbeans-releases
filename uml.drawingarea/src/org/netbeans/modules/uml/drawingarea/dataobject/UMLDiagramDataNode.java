...
public class UMLDiagramDataNode extends DataNode {

    private static final String IMAGE_ICON_ATTR_NAME = "iconImage";

    public UMLDiagramDataNode(UMLDiagramDataObject obj) {
        super(obj, Children.LEAF);
        setIconBaseWithExtension(ImageUtil.DIAGRAM_ICON_DEFAULT);
    }

    public UMLDiagramDataNode(UMLDiagramDataObject obj, Lookup lookup) {
        super(obj, Children.LEAF, lookup);
        try {
            setIconBaseWithExtension(ImageUtil.DIAGRAM_ICON_DEFAULT);

            IProxyDiagramManager diagramMgr = ProxyDiagramManager.instance();
//        IProxyDiagram proxyDiagram = diagramMgr.getDiagram(FileUtil.getFileDisplayName(obj.getPrimaryFile()));
            String diagFileLoc = FileUtil.toFile(obj.getDiagramFile()).getCanonicalPath();
            IProxyDiagram proxyDiagram = diagramMgr.getDiagram(diagFileLoc);
