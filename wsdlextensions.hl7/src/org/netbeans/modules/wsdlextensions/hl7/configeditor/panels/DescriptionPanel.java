...
//        initListener();     
    ...
    private void setAccessibility() {
        ...
        editorPaneScrollPane.getAccessibleContext().setAccessibleName(SHOW_DESCRIPTION); // NOI18N                   
        editorPaneScrollPane.getAccessibleContext().setAccessibleDescription(SHOW_DESCRIPTION); // NOI18N                           
    ...
    void showPopup(MouseEvent evt) {
        if (evt.isPopupTrigger()) {
            if (mPopupAction == null) {
                ...
                mShowDescriptionMenu.setText("Show Description Area");
            }
    ...
    public  static void main(String[] args) {
        ...
        panel.setText("<html>hello<br><br>there world</html>");
        dlg.setSize(300,300);
        dlg.setVisible(true);
        dlg.pack();
    }
