...
import org.netbeans.modules.wsdlextensions.hl7.configeditor.CommunicationControlModel;
 ...
 */
public class CommunicationControlStepWizardPanel extends WSDLWizardDescriptorPanel {
    /**
     ...
     */
    CommunicationControlPersistenceController mController = null;
     ...
     */
    private CommunicationControlForm mPanel;
    private String templateConst;
    
    public CommunicationControlStepWizardPanel(WSDLWizardContext context, String templateConst){
        super(context);
    ...
    public String getName() {
        return NbBundle.getMessage(CommunicationControlStepWizardPanel.class,
                "CommunicationControlStepWizardPanel.StepLabel");
    }
    ...
    public Component getComponent() {
        if (mPanel == null) {
            ...
            CommunicationControlModel commCtrlModel = new CommunicationControlModel();
            mPanel = new CommunicationControlForm(commCtrlModel,this.templateConst);
        } 
        ...
        if (mController == null) {
            ...
            mController = new CommunicationControlPersistenceController(mComponent, mPanel, this.templateConst);
        }
