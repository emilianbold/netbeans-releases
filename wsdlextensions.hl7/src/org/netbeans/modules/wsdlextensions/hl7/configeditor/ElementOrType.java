...
public class ElementOrType {
    ...
    GlobalElement mElement = null;
    GlobalType mType = null;
    
    public ElementOrType(GlobalElement element, GlobalType type){
    ...
    public void setElement(GlobalElement element){
        this.mElement = element;
    }
