...
import org.netbeans.modules.wsdlextensions.hl7.configeditor.AbstractForm;
import org.netbeans.modules.wsdlextensions.hl7.configeditor.AbstractFormModel;
 ...
 */
public class AbstractStepWizardPanel  extends WSDLWizardDescriptorPanel{
     ...
     */
    AbstractStepPersistenceController mController = null;
     ...
     */
    private AbstractForm mPanel;
    
    private String templateNameConstant;
    
    public AbstractStepWizardPanel(WSDLWizardContext context, String templateNameConstant){
        super(context);
    ...
    public Component getComponent() {
        if (mPanel == null) {
            AbstractFormModel abstractFormModel = new AbstractFormModel();
            mPanel = new AbstractForm(abstractFormModel, this.templateNameConstant);
        } 
        ...
        if (mController == null) {
            ...
            mController = new AbstractStepPersistenceController(myContext.getWSDLModel(), mPanel);
        }
