...
import org.netbeans.modules.wsdlextensions.hl7.configeditor.GeneralEditorWsdlAdapter;
 ...
 */
public class GeneralStepPersistenceController {
    
    private GeneralEditorForm generalEditorPanel = null;
    ...
    public GeneralStepPersistenceController(WSDLComponent wsdlComponent,
            GeneralEditorForm visualComponent) {
        generalEditorPanel = visualComponent;
    ...
    public boolean commit() {
        ...
        /*HL7Error hl7Error = generalEditorPanel.validateMe(false);
        if (ExtensibilityElementConfigurationEditorComponent.
                PROPERTY_ERROR_EVT.equals(hl7Error.getErrorMode())) {
            return false;
        } */          
        generalEditorPanel.commit();
        GeneralEditorForm.Model model = (GeneralEditorForm.Model)generalEditorPanel.getModel();
        GeneralEditorWsdlAdapter modelAdapter = new GeneralEditorWsdlAdapter(mWSDLComponent.getModel());
        modelAdapter.focus(mWSDLComponent);
        try {
            GeneralEditorForm.syncGeneralPanel_ToFrom(modelAdapter, model);
