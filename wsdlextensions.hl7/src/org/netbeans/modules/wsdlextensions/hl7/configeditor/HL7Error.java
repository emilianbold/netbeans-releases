...
public class HL7Error {
    ...
    public HL7Error(String errMode, String errMessage) {
        mErrMode = errMode;
    ...
    public boolean isEmpty() {
        return ExtensibilityElementConfigurationEditorComponent.
            PROPERTY_CLEAR_MESSAGES_EVT.equals(getErrorMode());
    }
}
