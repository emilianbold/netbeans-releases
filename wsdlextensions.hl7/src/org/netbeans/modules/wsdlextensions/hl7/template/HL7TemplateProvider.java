...
public class HL7TemplateProvider extends ExtensibilityElementTemplateProvider {
    ...
    @Override
     public InputStream getTemplateFileInputStream(String filePath) {
         return HL7TemplateProvider.class.getResourceAsStream("/org/netbeans/modules/wsdlextensions/hl7/template/" + filePath);
     }
    
     @Override
     public WSDLWizardExtensionIterator getWSDLWizardExtensionIterator(WSDLWizardContext context) {
         return new HL7WSDLWizardExtensionIterator(context);
     }
