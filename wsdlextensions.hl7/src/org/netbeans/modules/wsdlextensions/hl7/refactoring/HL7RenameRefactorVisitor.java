 ...
 */
public class HL7RenameRefactorVisitor extends ChildVisitor implements WSDLVisitor, HL7Component.Visitor {
    private Referenceable referenced;
    private String oldName;
    
    public HL7RenameRefactorVisitor(Referenceable referenced, String oldName) {
