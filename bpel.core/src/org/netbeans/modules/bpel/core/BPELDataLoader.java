...
public class BPELDataLoader extends UniFileLoader {
    ...
    static final String PRIMARY_EXTENSION = "bpel";                 // NOI18N
    ...
    protected void initialize() {
		...
		//getExtensions().addExtension(PRIMARY_EXTENSION); // in case MIME is not recognized?
    }
    ...
    protected FileObject findPrimaryFile( FileObject fo ) {
        ...
        try {
            ...
            //
            // only recognize if in Orch Project Context
            // TODO: Identify Alaska project type. For now commenting below two
            // lines.
            //
            // if(result != null &&
            // !OrchProjectUtil.isOrchProjectContext(result))
            // result = null;
