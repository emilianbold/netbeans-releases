...
public abstract class AbstractDBTable extends AbstractSQLObject implements SQLDBTable {
    ...
    static class StringComparator implements Comparator {
        public int compare(Object o1, Object o2) {
            ...
            throw new ClassCastException(NbBundle.getMessage(AbstractDBTable.class, "ERROR_StringComparator"));
        }
    }
    ...
    protected AbstractDBTable(DBTable src) {
        ...
        if (src == null) {
            throw new IllegalArgumentException(NbBundle.getMessage(AbstractDBTable.class, "ERROR_null_DBTable_instance"));
        }
        copyFrom(src);
    }
    ...
    public void copyFrom(DBTable source) {
        if (source == null) {
            throw new IllegalArgumentException(NbBundle.getMessage(AbstractDBTable.class, "ERROR_null_ref_for_source"));
        } else if (source == this) {
            return;
        }
    ...
    public String getFullyQualifiedName() {
        ...
        if (tblName == null) {
            throw new IllegalArgumentException(NbBundle.getMessage(AbstractDBTable.class, "ERROR_table_name_is_null."));
        }
     ...
     */
    @Override
    public void parseXML(Element tableElement) throws EDMException {
        if (tableElement == null) {
            throw new EDMException(NbBundle.getMessage(AbstractDBTable.class, "ERROR_Null_ref_for_tableElement"));
        }

        if (!(tableElement.getNodeName().equals(getElementTagName()))) {
            throw new EDMException("No <" + getElementTagName() + "> element found.");
        }
