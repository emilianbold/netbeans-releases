...
public class SQLJoinOperatorImpl extends SQLConnectableObjectImpl implements SQLJoinOperator {
     ...
     *        instance
     * @throws EDMException if error occurs during instantiation
     */
    public SQLJoinOperatorImpl(SQLJoinOperator src) throws EDMException {
        this();

        if (src == null) {
            throw new IllegalArgumentException(NbBundle.getMessage(SQLJoinOperatorImpl.class, "ERROR_null_SQLJoinOperator"));
        }

        try {
            copyFrom(src);
        } catch (Exception ex) {
            throw new EDMException(NbBundle.getMessage(SQLJoinOperatorImpl.class, "ERROR_can_not_create_SQLJoinOperatorImpl"), ex);
        }
    }

    public void addInput(String argName, SQLObject newInput) throws EDMException {
        if (argName == null || newInput == null) {
            throw new EDMException(NbBundle.getMessage(SQLJoinOperatorImpl.class, "ERROR_Input_arguments_not_specified"));
        }
        ...
        switch (newType) {
            case SQLConstants.JOIN_TABLE:
                if (!(LEFT.equals(argName) || RIGHT.equals(argName))) {
                    throw new EDMException(objType + NbBundle.getMessage(SQLJoinOperatorImpl.class, "ERROR_objectType"));
                }
                break;
            ...
            default:
                ...
                throw new EDMException(NbBundle.getMessage(SQLJoinOperatorImpl.class, "ERROR_Cannot_link") + objType + " '" + newInput.getDisplayName() + NbBundle.getMessage(SQLJoinOperatorImpl.class, "ERROR_as_input") + argName + "' in " + TagParserUtility.getDisplayStringFor(this.type) + " '" + this.getDisplayName() + "'");
        }
        ...
        if (inputObject != null) {
            ...
            throw new EDMException(NbBundle.getMessage(SQLJoinOperatorImpl.class, "ERROR_Input_with_argName") + argName + NbBundle.getMessage(SQLJoinOperatorImpl.class, "ERROR_does_not_exist"));
        }
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        try {
            ...
            mLogger.log(Level.INFO,NbBundle.getMessage(SQLJoinOperatorImpl.class, "ERROR_can_not_create_clone")+this.toString(),ex);
            throw new CloneNotSupportedException(NbBundle.getMessage(SQLJoinOperatorImpl.class, "ERROR_can_not_create_clone") + this.toString());
        }
     ...
     * @exception EDMException while parsing
     */
    ...
    private void copyFrom(SQLJoinOperator src) throws EDMException {
        ...
        try {
            ...
            throw new EDMException("exception occured while cloning SQLJoinOperator", ex);
        }
    }
