...
public class SQLFilterImpl extends SQLConnectableObjectImpl implements SQLFilter {
     ...
     */
    public SQLFilterImpl(Element filterElement) throws EDMException {
        this();
     ...
     * @throws EDMException if error occurs during parsing and reconstitution.
     */
    private void parseNextFilter(Element elem) throws EDMException {
        ...
        if (elem != null) {
            ...
            if (refObj == null) {
                ...
                try {
                    ...
                    throw new EDMException("Caught invalid object type in lieu of SQLFilter.", e);
                }
            }
        }
    }
     ...
     * @throws EDMException if error occurs during parsing and reconstitution
     */
    private void parseNextFilterList(NodeList list) throws EDMException {
