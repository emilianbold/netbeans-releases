...
public class SQLJoinViewImpl extends AbstractSQLObject implements SQLJoinView {
    ...
    public SQLJoinViewImpl(SQLJoinView src) throws EDMException {
        this();

        if (src == null) {
            throw new IllegalArgumentException(NbBundle.getMessage(SQLJoinViewImpl.class, "ERROR_null_SQLJoinView_instance"));
        }

        try {
            copyFrom(src);
        } catch (Exception ex) {
            throw new EDMException(NbBundle.getMessage(SQLJoinViewImpl.class, "ERROR-can_not_create_SQLJoinViewImpl"), ex);
        }
    }
    ...
    public void addObject(SQLObject newObject) throws EDMException {
        if (newObject.getObjectType() == SQLConstants.JOIN_TABLE || newObject.getObjectType() == SQLConstants.JOIN) {
            ...
            throw new EDMException(NbBundle.getMessage(SQLJoinViewImpl.class, "ERROR_Addition_of_sqlobject") + TagParserUtility.getStringType(newObject.getObjectType()) + NbBundle.getMessage(SQLJoinViewImpl.class, "ERROR_not_supported."));
        }
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        try {
            ...
            mLogger.log(Level.INFO,NbBundle.getMessage(SQLJoinViewImpl.class, "ERROR_while_cloniing_SQLJoinViewImpl",new Object[] {this.toString()}),ex);
            throw new CloneNotSupportedException(NbBundle.getMessage(SQLJoinViewImpl.class, "ERROR_can_not_create_clone") + this.toString());
        }
        return cond;
    }
     ...
     */
    public SQLObject createObject(String objTag) throws EDMException {
     ...
     * @see #addObject(SQLObject)
     */
    public SQLObject createSQLObject(String className) throws EDMException {
     ...
     * @throws EDMException while removing
     */
    public void removeObject(SQLObject sqlObj) throws EDMException {
        // chec if it is a table object
        if (sqlObj == null) {
            throw new EDMException(NbBundle.getMessage(SQLJoinViewImpl.class, "ERROR_Can_not_delete_null_object"));
     ...
     * @throws EDMException while removing
     */
    public void removeObjects(Collection sqlObjs) throws EDMException {
        if (sqlObjs == null) {
            throw new EDMException(NbBundle.getMessage(SQLJoinViewImpl.class, "ERROR_Can_not_delete_null_object"));
        }
     ...
     * @throws EDMException if error occurs while setting parent object
     */
    ...
    private void add(SQLObject newObject) throws EDMException {
    ...
    private void copyFrom(SQLJoinView src) throws EDMException {
        ...
        while (it.hasNext()) {
            ...
            try {
                ...
                throw new EDMException(NbBundle.getMessage(SQLJoinViewImpl.class, "ERROR_Failed_to_clone") + obj, ex);
            }
        }
    ...
    private void doSecondPassParse() throws EDMException {
    ...
    private void parseXML(NodeList list) throws EDMException {
        for (int i = 0; i < list.getLength(); i++) {
            ...
            if (sqlObj != null) {
                ...
                throw new EDMException(NbBundle.getMessage(SQLJoinViewImpl.class, "ERROR_Failed_to_parse") + opeElem);
            }
        }
    }

    private void removeJoinReference(SQLJoinOperator join) throws EDMException {
        Collection joins = this.getObjectsOfType(SQLConstants.JOIN);
        Iterator it = joins.iterator();
        while (it.hasNext()) {
    ...
    private void setLinks(HashMap origToCloneMap) throws EDMException {
        setLinks(origToCloneMap, origToCloneMap.keySet());
    }

    private void setLinks(HashMap origToCloneMap, Collection expObjs) throws EDMException {
    ...
    private void setLinks(HashMap origToCloneMap, SQLConnectableObject origObj) throws EDMException {
