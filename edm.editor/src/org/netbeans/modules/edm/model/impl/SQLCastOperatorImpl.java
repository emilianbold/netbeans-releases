...
public final class SQLCastOperatorImpl extends SQLGenericOperatorImpl implements SQLCastOperator {
     ...
     * @throws EDMException
     */
    public SQLCastOperatorImpl(SQLCastOperator src) throws EDMException {
        super(src);
        initialize();
    }
     ...
     * @throws EDMException
     */
    public SQLCastOperatorImpl(String newName, String aType) throws EDMException {
        super(newName, aType);
        initialize();
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        try {
            ...
            throw new CloneNotSupportedException(NbBundle.getMessage(SQLCastOperatorImpl.class, "ERROR_Cannot_create_clone") + this.getOperatorType());
        }
    }
    ...
    public void setArguments(List opArgs) throws EDMException {
        if (operatorDefinition == null) {
            throw new EDMException(NbBundle.getMessage(SQLCastOperatorImpl.class, "ERROR_null_Operator_Definition"));
        }
        ...
        if (opArgs != null && opArgs.size() > 1) {
            ...
            if (SQLUtils.isPrecisionRequired(getJdbcType())) {
                try {
                    ...
                    throw new EDMException(NbBundle.getMessage(SQLCastOperatorImpl.class, "ERROR_precision_argument"));
                }
            }
