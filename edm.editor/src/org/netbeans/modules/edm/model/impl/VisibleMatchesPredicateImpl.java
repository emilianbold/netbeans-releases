...
public class VisibleMatchesPredicateImpl implements VisibleSQLPredicate {
    ...
    public VisibleMatchesPredicateImpl(VisibleMatchesPredicateImpl src) throws EDMException {
        this();
        if (src == null) {
            throw new IllegalArgumentException(NbBundle.getMessage(VisibleMatchesPredicateImpl.class, "ERROR_can_not_create_VisibleSQLPredicate_using_copy_constructor,_src_is_null"));
        }
        try {
    ...
    public Object clone() throws CloneNotSupportedException {
        try {
            ...
            throw new CloneNotSupportedException(NbBundle.getMessage(VisibleMatchesPredicateImpl.class, "ERROR_can_not_create_clone") + this.getOperatorType());
        }
    }
    ...
    public void setArguments(List args) throws EDMException {
        ...
        if (operatorDefinition == null) {
            throw new EDMException(NbBundle.getMessage(VisibleMatchesPredicateImpl.class, "ERROR_null_Operator_Definition"));
        }
