...
public class SQLLiteralImpl extends AbstractSQLObject implements SQLLiteral {
    ...
    public SQLLiteralImpl(SQLLiteral src) {
        ...
        if (src == null) {
            throw new IllegalArgumentException(NbBundle.getMessage(SQLLiteralImpl.class, "ERROR_src_is_null"));
        }
     ...
     * @throws EDMException if name is null or empty, or value is null.
     */
    public SQLLiteralImpl(String name, String value, int jdbcType) throws EDMException {
        this();
