...
public class VisibleSQLLiteralImpl extends SQLLiteralImpl implements VisibleSQLLiteral {
    ...
    public VisibleSQLLiteralImpl(String aDisplayName, String value, int jdbcType) throws EDMException {
    ...
    public VisibleSQLLiteralImpl(VisibleSQLLiteral src) {
        ...
        if (src == null) {
            throw new IllegalArgumentException(NbBundle.getMessage(VisibleSQLLiteralImpl.class, "ERROR_can_not_create_VisibleSQLLiteral"));
        }
