 ...
 * @version $Revision$
 */
public class SQLNormalizeOperatorImpl implements SQLGenericOperator {

    public static final String ARG_LOCALE = "locale";
    public static final String ARG_PART = "part";
    public static final String ARG_PERSONNAME = "PersonName";
    public static final String ARG_STR = "str";
    
    private SQLGenericOperator delegate = null;

    public SQLNormalizeOperatorImpl() {
        delegate = new SQLGenericOperatorImpl();
    }

    public SQLNormalizeOperatorImpl(SQLNormalizeOperatorImpl src) throws CloneNotSupportedException {
        this();
        if (src == null) {
            throw new IllegalArgumentException(NbBundle.getMessage(SQLNormalizeOperatorImpl.class, "ERROR_can_not_create_VisibleSQLPredicate_using_copy_constructor,_src_is_null"));
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        return new SQLNormalizeOperatorImpl(this);
    }
    ...
    public void setArguments(List opArgs) throws EDMException {
        ...
        if (operatorDefinition == null) {
            throw new EDMException(NbBundle.getMessage(SQLNormalizeOperatorImpl.class, "ERROR_null_Operator_Definition"));
        }
