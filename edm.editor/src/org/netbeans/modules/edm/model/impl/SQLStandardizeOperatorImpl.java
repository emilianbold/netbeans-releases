...
public class SQLStandardizeOperatorImpl implements SQLGenericOperator {
    ...
    public SQLStandardizeOperatorImpl(SQLStandardizeOperatorImpl src) throws CloneNotSupportedException {
        this();
        if (src == null) {
            throw new IllegalArgumentException(NbBundle.getMessage(SQLStandardizeOperatorImpl.class, "ERROR_can_not_create_VisibleSQLPredicate_using_copy_constructor,_src_is_null"));
        }
    ...
    public void setArguments(List opArgs) throws EDMException {
        ...
        if (operatorDefinition == null) {
            throw new EDMException(NbBundle.getMessage(SQLStandardizeOperatorImpl.class, "ERROR_null_Operator_Definition"));
        }
    ...
    public void setOperatorType(String newOperator) throws EDMException {
