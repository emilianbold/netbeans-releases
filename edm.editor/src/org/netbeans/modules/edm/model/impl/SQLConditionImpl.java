...
public class SQLConditionImpl implements SQLCondition, Cloneable {
    ...
    public SQLConditionImpl(SQLCondition src) throws EDMException {
        this(src.getDisplayName());
        if (src == null) {
            throw new IllegalArgumentException(NbBundle.getMessage(SQLConditionImpl.class, "ERROR_null_SQLCondition"));
        }

        try {
            copyFrom(src);
        } catch (Exception ex) {
            throw new EDMException(NbBundle.getMessage(SQLConditionImpl.class, "ERROR_can_not_create_SQLConditionImpl"), ex);
        }
    }
     ...
     * @param col
     */
    public void addEqualityPredicate(SQLObject input, SQLDBColumn col) throws EDMException {
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        try {
            ...
            throw new CloneNotSupportedException(NbBundle.getMessage(SQLConditionImpl.class, "ERROR_can_not_create_clone") + this.toString());
        }
     ...
     *        instance
     * @exception EDMException thrown while parsing XML, or if xmlElement is null
     */
     ...
     * @throws EDMException
     */
    public void removeEqualsPredicate(SQLDBColumn col, SQLObject value) throws EDMException {
        ColumnRefImpl leftCRef = new ColumnRefImpl(col);
    ...
    public void removeObject(SQLObject sqlObj) throws EDMException {
        ...
        if (sqlObj == null) {
            throw new EDMException(NbBundle.getMessage(SQLConditionImpl.class, "ERROR_Can_not_delete_null_object"));
        }
    ...
    private void copyFrom(SQLCondition src) throws EDMException {
        ...
        while (it.hasNext()) {
            ...
            if (attr != null) {
                try {
                    ...
                    mLogger.log(Level.INFO,NbBundle.getMessage(SQLConditionImpl.class, "LOG.INFO_Failed_to_copy_source_objects",new Object[] {LOG_CATEGORY}),ex);
                }
            }
        }
            ...
            if (sqlObj != null) {
                if (sqlObj instanceof SQLConnectableObject) {
                    ...
                    if (sqlObj instanceof ColumnRef) {
                        ...
                        if (sObj instanceof SourceColumn) {
                            columns.add(sObj);
                        }
                    }
                }
    ...
    private void parseXML(NodeList list) throws EDMException {
        for (int i = 0; i < list.getLength(); i++) {
            ...
            if (sqlObj != null) {
                ...
                throw new EDMException(NbBundle.getMessage(SQLConditionImpl.class, "ERROR_Failed_to_parse") + opeElem);
            }
        }
    }
    ...
    private void populateObjectsFromConditionText() {
        try {
            ...
            mLogger.log(Level.INFO,NbBundle.getMessage(SQLConditionImpl.class, "Error_finding_root_predicate",new Object[] {this.conditionText, LOG_CATEGORY}),ex);
        }
    }
    ...
    private String toXMLString(String prefix, Collection sqlObjects) throws EDMException {
