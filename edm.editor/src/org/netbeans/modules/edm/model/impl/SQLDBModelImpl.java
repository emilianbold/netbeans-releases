...
public class SQLDBModelImpl extends AbstractSQLObject implements Cloneable, SQLDBModel {
    ...
    private transient EDMParentObject mParent;
    /* Database that supplied metadata for this DatabaseModel instance. */
    protected transient SQLObject source;
     ...
     */
    public SQLDBModelImpl(DatabaseModel src, int modelType, EDMParentObject sqlParent) {
        this();

        if (src == null) {
            throw new IllegalArgumentException(
                    NbBundle.getMessage(SQLDBModelImpl.class, "ERROR_null_DatabseModel"));
        }
        ...
        if (table != null) {
            ...
            if (type == SQLConstants.SOURCE_DBMODEL && table.getObjectType() != SQLConstants.SOURCE_TABLE) {
                throw new IllegalStateException(
                        NbBundle.getMessage(SQLDBModelImpl.class, "ERROR_Cannot_add_TargetTable"));
            }
    ...
    public DBTable createTable(String tableName, String schemaName, String catalogName) {
        ...
        if (tableName == null || tableName.length() == 0) {
            throw new IllegalArgumentException(NbBundle.getMessage(SQLDBModelImpl.class, "ERROR_null_tableName"));
        }
    ...
    public DBConnectionDefinition getConnectionDefinition() {
        try {
            ...
            throw new IllegalStateException(NbBundle.getMessage(SQLDBModelImpl.class, "ERROR_Could_not_obtain_reference"));
        }
    }
     ...
     * @return ConnectionDefinition of the SQLDataSource object
     */
    public DBConnectionDefinition getETLDBConnectionDefinition() throws EDMException {
        if (connectionDefinition == null) {
            mLogger.log(Level.FINE,NbBundle.getMessage(SQLDBModelImpl.class, "LOG.INFO_Lazy_loading_connection",new Object[] {getDisplayName()}));
    ...
    public String getFullyQualifiedTableName(DBTable tbl) {
        ...
        if (tbl != null) {
            ...
            if (tblName == null) {
                throw new IllegalArgumentException(
                        NbBundle.getMessage(SQLDBModelImpl.class, "ERROR_table_name_is_null."));
            }
    ...
    public String getFullyQualifiedTableName(String tblName, String schName, String catName) {
        throw new IllegalAccessError(
                NbBundle.getMessage(SQLDBModelImpl.class, "ERROR_method_is_not_supported"));
    }
    ...
    public void parseXML(Element dbElement) throws EDMException {
        if (dbElement == null) {
            throw new EDMException(
                    NbBundle.getMessage(SQLDBModelImpl.class, "ERROR_ref_for_element") + MODEL_TAG + NbBundle.getMessage(SQLDBModelImpl.class, "ERROR_element_found"));
        }

        if (!MODEL_TAG.equals(dbElement.getNodeName())) {
            throw new EDMException(NbBundle.getMessage(SQLDBModelImpl.class, "ERROR_Invalid_root_element") + MODEL_TAG + ", got " + dbElement.getNodeName());
        }
        ...
        if (STRTYPE_SOURCE.equals(typeStr)) {
            type = SQLConstants.SOURCE_DBMODEL;
...
//        }
     ...
     *            held by a ETLObject.
     */
    public void setSource(SQLObject obj) {
        source = obj;
    }

    @SuppressWarnings("unchecked")
    public void setEDMParentObject(EDMParentObject aParent) {
        if (mParent == null) {
            mParent = aParent;
        }
    }
     ...
     */
    protected void parseSourceTables(NodeList tableNodeList) throws EDMException {
     ...
     *             exception
     */
    protected void writeTables(String prefix, StringBuilder xml) throws EDMException {
        ...
        Collections.sort(tblList, new Comparator() {
            ...
            public int compare(Object o1, Object o2) {
                ...
                throw new ClassCastException(NbBundle.getMessage(SQLDBModelImpl.class, "ERROR_Cannot_compare_objects"));
            }
        });
