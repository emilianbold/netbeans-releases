...
public abstract class AbstractSQLObject implements SQLObject {
    ...
    public void copyFromSource(SQLObject source) {
        if (source == null) {
            throw new java.lang.IllegalArgumentException(NbBundle.getMessage(AbstractSQLObject.class, "ERROR_null_SQLObject_instance") + source);
        }
        ...
        while (it.hasNext()) {
            ...
            if (attr != null) {
                try {
                    ...
                    // log me
                    mLogger.log(Level.INFO,NbBundle.getMessage(AbstractSQLObject.class, "LOG.INFO_Failed_to_copy_source_objects",new Object[] {LOG_CATEGORY}),ex);
                }
            }
        }
    }
    ...
    public String getHeader() {
        ...
        try {
            ...
            mLogger.log(Level.INFO,NbBundle.getMessage(AbstractSQLObject.class, "LOG.INFO_Failed_to_get_type_attr",new Object[] {LOG_CATEGORY}));
    ...
    public void setId(String newId) throws EDMException {
        ...
        if (newId == null) {
            throw new EDMException(NbBundle.getMessage(AbstractSQLObject.class, "ERROR_null_String_ref_for_newId"));
        }
    ...
    public void setParentObject(Object newParent) throws EDMException {
        if (newParent == null) {
            throw new EDMException(NbBundle.getMessage(AbstractSQLObject.class, "ERROR_null_Object_ref_for_newParent"));
        }
     ...
     */
    protected void parseCommonAttributesAndTags(Element xmlElement) throws EDMException {
        if (xmlElement == null) {
            throw new EDMException(NbBundle.getMessage(AbstractSQLObject.class, "ERROR_xmlElement_is_null"));
        }
        if (this.parentObject == null) {
            throw new EDMException(NbBundle.getMessage(AbstractSQLObject.class, "ERROR_ParentObject_is_null"));
        }
    ...
    private void parseAttributeList(NodeList list) throws EDMException {
