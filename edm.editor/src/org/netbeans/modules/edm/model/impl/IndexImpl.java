...
public class IndexImpl implements Cloneable, Index {
    ...
    public static class Column implements Comparable {
        ...
        public Column(String colName, int colSequence) {
            if (colName == null || colName.trim().length() == 0) {
                throw new IllegalArgumentException(NbBundle.getMessage(IndexImpl.class, "ERROR_empty_parameter_colName"));
            }

            if (colSequence <= 0) {
                throw new IllegalArgumentException(NbBundle.getMessage(IndexImpl.class, "ERROR_positive_Parameter_colSequence"));
            }
    ...
    IndexImpl(ResultSet rs) throws SQLException {
        if (rs == null) {
            ...
            ResourceBundle cMessages = ResourceBundle.getBundle("org/netbeans/modules/edm/model/impl/Bundle", locale); // NO i18n            
    ...
    public IndexImpl(String indexName, int indexType, boolean isUnique, String sortOrder, int indexCardinality) {
        ...
        if (indexName == null) {
            throw new IllegalArgumentException(NbBundle.getMessage(IndexImpl.class, "ERROR_empty_String_indexName"));
        }
     ...
     *            null
     */
    public void parseXML() throws EDMException {
        if (this.element == null) {
            throw new EDMException("No <" + ELEMENT_TAG + "> element found.");
        }
    ...
    public void setColumnNames(String[] newColNames) {
        if (newColNames == null) {
            throw new IllegalArgumentException(NbBundle.getMessage(IndexImpl.class, "ERROR_null_for_param_newColNames"));
        }
