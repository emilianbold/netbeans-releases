 ...
 * 
 */
public class OperatorNodeX extends CommonNodeX implements org.netbeans.modules.edm.editor.graph.jgo.IOperatorXmlInfo, Transferable {
     ...
     */
    public OperatorNodeX(Element opElement) throws EDMException {
        super(opElement);
            ...
            if (isStatic) {
                ...
                if (acceptableValStr != null && acceptableValStr.trim().length() != 0) {
                    ...
                    if (StringUtil.isNullString(defaultValue)) {
                        throw new EDMException(NbBundle.getMessage(OperatorNodeX.class, "ERROR_static_parameter"));
                    }
    ...
    public org.netbeans.modules.edm.editor.graph.jgo.IOperatorField getInputField(String tName) {
        Iterator it = this.inputList.iterator();
        while (it.hasNext()) {
            org.netbeans.modules.edm.editor.graph.jgo.IOperatorField field = (org.netbeans.modules.edm.editor.graph.jgo.IOperatorField) it.next();
