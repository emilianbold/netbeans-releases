...
public interface SQLCondition extends SQLContainerObject, SQLVisitedObject {
    ...
    public void addEqualityPredicate(SQLObject newInput, SQLDBColumn col) throws EDMException;
    ...
    public void removeDanglingColumnRef(SQLObject column) throws EDMException;
     ...
     * @throws EDMException
     */
    public void removeEqualsPredicate(SQLDBColumn col, SQLObject victim) throws EDMException;
     ...
     * @throws EDMException
     */
    public void replaceTargetColumnIsNullPredicate() throws EDMException;
