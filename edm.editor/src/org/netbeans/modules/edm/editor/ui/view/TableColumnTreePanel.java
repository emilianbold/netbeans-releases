...
public class TableColumnTreePanel extends JPanel {
    ...
    private void createColumnNodes(DBTable table, DefaultMutableTreeNode parentNode) {
        ...
        while (it.hasNext()) {
            ...
            /*if (column.isForeignKey() || column.isPrimaryKey() || !column.isNullable()) {
    ...
    private void init() {
        ...
        tree.getAccessibleContext().setAccessibleName("Table tree");
        tree.getAccessibleContext().setAccessibleDescription("Table tree");
