...
import org.netbeans.modules.edm.editor.ui.view.ConditionPropertyEditor;
...
public class SourceTableProperties extends TableProperties {
    ...
    public SourceTableProperties(SourceTable table, CollabSQLUIModel model) {
        this.model = model;
        this.table = table;
    ...
    public PropertyEditor getCustomEditor(Node.Property property) {
        if (property.getName().equals("filterCondition")) {
            ConditionPropertyEditor f = new ConditionPropertyEditor(model, table);
            return f;
    ...
    public SQLCondition getFilterCondition() {
        return table.getFilterCondition();
    }
    ...
    public String getFilterConditionText() {
        return table.getFilterConditionText();
    }
