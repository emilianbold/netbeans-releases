...
import org.netbeans.modules.edm.editor.utils.SQLParserUtil;
...
public class SQLConditionParser implements SQLConditionParserConstants {
    ...
    public SQLObject parse(String sql) throws EDMException {
        try {
    ...
    public SQLObject createPredicate(SQLObject left, String opName, SQLObject right) throws EDMException {
    ...
    private SQLObject createOperator(String opName, List args) throws EDMException {
...
//}
  ...
  Token t = null;
    ...
    throw new Error(NbBundle.getMessage(SQLConditionParser.class, "ERROR_Missing_return_statement"));
  }

  final public SQLObject SqlColumn() throws ParseException, EDMException {
    Token t = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case COLUMN1:
  ...
  final public SQLObject SqlColumnRef() throws ParseException, EDMException {
   String column = null;
  ...
  final public SQLObject SQLCurrentDate() throws ParseException, EDMException {
    Token t = null;
  ...
  final public SQLObject SqlSelectableElements() throws ParseException, EDMException {
   SQLObject sel = null;
   boolean openP = false;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case OPENPAREN:
  ...
  final public SQLObject SqlProductExprSelectable() throws ParseException, EDMException {
  ...
  final public SQLObject SqlSumExprSelectable() throws ParseException, EDMException {
    SQLObject parent = null;
    SQLObject left = null;
    SQLObject right = null;
    String function = null;
  ...
  final public SQLObject SqlCompareExpr() throws ParseException, EDMException {
    SQLObject left = null;
    SQLObject right = null;
    String symbol = null;
    SQLObject result = null;
  ...
  final public SQLObject SqlRootPredicate() throws ParseException, EDMException {
   SQLObject result = null;
    //    [<OPENPAREN>]
    //       result = SqlFunction() 
    //       [<CLOSEPAREN>]
  ...
  final public SQLObject SqlWhereOr() throws ParseException, EDMException {
   SQLObject parent = null;
   SQLObject left = null;
   SQLObject right = null;
   SQLObject result = null;
  ...
  final public SQLObject SqlWhereAnd() throws ParseException, EDMException {
   SQLObject parent = null;
   SQLObject left = null;
   SQLObject right = null;
   SQLObject result = null;
  ...
  final public SQLObject SqlWhereNot() throws ParseException, EDMException {
  ...
  final public SQLObject SqlWhereElt() throws ParseException, EDMException {
   SQLObject result = null;
  ...
  final public SQLObject SqlCastAs() throws ParseException, EDMException {
  ...
  final public Object[] SqlCastAsType() throws ParseException, EDMException {
      ...
      precision = jj_consume_token(INTEGER_LITERAL);
                        if (SQLUtils.isPrecisionRequired(jdbcType)) {
                            ...
                            tuple[1] = precision.image;
                                ...
                                {if (true) throw new EDMException(NbBundle.getMessage(SQLConditionParser.class, "ERROR_Precision_argument_required") + type.image);}
                            }
                        }
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case CLOSEPAREN:
                        ...
                        if (scale != null) {
                                if (SQLUtils.isScaleRequired(jdbcType)) {
                                    tuple[2] = scale.image;
                                        ...
                                        {if (true) throw new EDMException(NbBundle.getMessage(SQLConditionParser.class, "ERROR_Scale_argument_is_invalid") + type.image);}
                                }
                        }
        jj_consume_token(CLOSEPAREN);
        break;
  ...
  final public SQLObject SqlLiteral() throws ParseException, EDMException {
   ...
   boolean minus = false;
    ...
    case MINUS:
      ...
      case INTEGER_LITERAL:
        ...
        literal = SQLModelObjectFactory.getInstance().createVisibleSQLLiteral(t.image, new BigInteger((minus ? "-" : "") + t.image).toString(), Types.INTEGER);
        break;
      case FLOATING_POINT_LITERAL:
  ...
  final public SQLObject SqlSelectable() throws ParseException, EDMException {
    SQLObject sel = null;
    sel = SqlWhereOr();
        {if (true) return sel;}
    throw new Error(NbBundle.getMessage(SQLConditionParser.class, "ERROR_Missing_return_statement"));
  ...
  final public List SqlSelectList() throws ParseException, EDMException {
  ...
  final public List SqlSelectCols() throws ParseException, EDMException {
  List list = new ArrayList();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case FALSE:
    case NOT:
  ...
  final public List SqlFunctionArgs() throws ParseException, EDMException {
  ...
  final public SQLObject SqlFunction() throws ParseException, EDMException {
  String name = null;
  List fnargs = null;
    jj_consume_token(ID);
        name = token.image;
  ...
  final public SQLObject SqlRuntimeInput() throws ParseException, EDMException {
    Token t = null;
