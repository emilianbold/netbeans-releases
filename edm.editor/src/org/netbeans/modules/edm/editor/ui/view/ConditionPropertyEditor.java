...
public class ConditionPropertyEditor extends PropertyEditorSupport implements IPropertyEditor {
    ...
    public static class Validation extends ConditionPropertyEditor {
        ...
        public Validation(CollabSQLUIModel model, SQLDBTable table) {
            super(model, table);
        }

        protected Component getCustomEditorForSource() {
            return ConditionBuilderUtil.getValidationConditionBuilderView((SourceTable) table, model);
        }

        protected Component getCustomEditorForTarget() {
            throw new UnsupportedOperationException(NbBundle.getMessage(ConditionPropertyEditor.class, "MSG_Validation_Condition_is_not_supported"));
        }
    }

    public static class OuterFilter extends ConditionPropertyEditor {

        public OuterFilter(CollabSQLUIModel model, SQLDBTable table) {
            super(model, table);
        }

        protected Component getCustomEditorForSource() {
            throw new UnsupportedOperationException(NbBundle.getMessage(ConditionPropertyEditor.class, "MSG_ValidationCondition_is_not_supported"));
        }
    }
    ...
    public static class JoinConditionEditor extends ConditionPropertyEditor {
        ...
        public JoinConditionEditor(CollabSQLUIModel model, SQLJoinOperator joinOp) {
            super(model, null);
            this.joinOp = joinOp;
        }

        public Component getCustomEditor() {
            return ConditionBuilderUtil.getConditionBuilderView(joinOp, model);
        }
    ...
    public ConditionPropertyEditor(CollabSQLUIModel model, SQLDBTable table) {
        this.model = model;
        this.table = table;
    }
    ...
    public void setAsText(String text) {
        ...
        if (this.conditionContainer != null && text != null && !text.equals(oldText)) {
            try {
                ...
                mLogger.log(Level.INFO,NbBundle.getMessage(ConditionPropertyEditor.class, "MSG_error_cloning_the_condition",new Object[] {LOG_CATEGORY}),ex);
                return;
            }
            ...
            try {
                ...
                mLogger.log(Level.INFO,NbBundle.getMessage(ConditionPropertyEditor.class, "MSG_Error_finding_root_predicate",new Object[] {text}),ex);
                warnForInvalidCondition();
            }
            ...
            try {
                ...
                mLogger.log(Level.INFO,NbBundle.getMessage(ConditionPropertyEditor.class, "MSG_Error_occurred_in_setting_the_property",new Object[] {text}),ex);
            }
        }
    }
    ...
    protected Component getCustomEditorForSource() {
        return ConditionBuilderUtil.getConditionBuilderView((SourceTable) table, model);
    }
    ...
    private void warnForInvalidCondition() {
        DialogDisplayer.getDefault().notify(
                new NotifyDescriptor.Message(NbBundle.getMessage(ConditionPropertyEditor.class, "MSG_Invalid_condition"),
