...
public class JoinConditionValidationHandler implements ValidationHandler {
    ...
    public JoinConditionValidationHandler(SQLUIModel model) {
        this.model = model;
    }
    ...
    public void editValue(Object val) {
        ...
        ConditionBuilderView conditionView = ConditionBuilderUtil.getConditionBuilderView(join, model);
        DialogDescriptor dd = new DialogDescriptor(conditionView, NbBundle.getMessage(JoinConditionValidationHandler.class, "LBL_Edit_Join_Condition"), true, NotifyDescriptor.OK_CANCEL_OPTION, null, null);
