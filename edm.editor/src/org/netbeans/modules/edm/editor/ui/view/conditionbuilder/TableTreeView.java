...
public class TableTreeView extends JPanel {
            ...
            if (path != null) {
                ...
                if (obj instanceof SQLDBColumn) {
                    try {
                        ...
                        mLogger.log(Level.INFO,NbBundle.getMessage(TableTreeView.class, "LOG.INFO_invalid_drag_and_drop",new Object[] {LOG_CATEGORY}),ex);
                    }
                }
            }
        }
    ...
    private static URL columnImgUrl = TableTreeView.class.getResource("/org/netbeans/modules/edm/editor/resources/column.png");
    private static DataFlavor[] mDataFlavorArray = new DataFlavor[1];
    private static ImageIcon runtimeInputIcon;
    private static URL runtimeInputImgUrl = TableTreeView.class.getResource("/org/netbeans/modules/edm/editor/resources/RuntimeInput.png");
    private static ImageIcon srcTableIcon;
    private static URL srcTableImgUrl = TableTreeView.class.getResource("/org/netbeans/modules/edm/editor/resources/SourceTable.png");
    private static ImageIcon targetTableIcon;
    private static URL targetTableImgUrl = TableTreeView.class.getResource("/org/netbeans/modules/edm/editor/resources/TargetTable.png");
    ...
    private void initGui() {
        ...
        tree.getAccessibleContext().setAccessibleName("Table Tree View");
        tree.getAccessibleContext().setAccessibleDescription("Table Tree View");
