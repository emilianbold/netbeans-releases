...
public class GroupPanel extends JPanel {
    ...
    private static final URL DOWN_IMG_URL = GroupPanel.class.getResource("/org/netbeans/modules/edm/editor/resources/assignDown.png");

    private static final URL UP_IMG_URL = GroupPanel.class.getResource("/org/netbeans/modules/edm/editor/resources/assignUp.png");
    private JList list;
    ...
    private void initGui(String title) {
        ...
        upButton.getAccessibleContext().setAccessibleName("UP Button");
        ...
        downButton.getAccessibleContext().setAccessibleName("UP Button");
        downButton.setMnemonic('U');
