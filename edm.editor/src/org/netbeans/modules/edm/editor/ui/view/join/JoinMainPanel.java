...
public class JoinMainPanel extends JPanel {
    ...
    private URL tableImgUrl = getClass().getResource("/org/netbeans/modules/edm/editor/resources/SourceTable.png");
    ...
    private void initGUI() {
        ...
        if (showInstruction) {
            ...
            joinLabel.getAccessibleContext().setAccessibleName("Select which tables you would like to join.");
            joinLabel.setLabelFor(bottomTabPane);
        ...
        listPanel.getAccessibleContext().setAccessibleName("Tables");
        listPanel.getAccessibleContext().setAccessibleDescription("Tables");
        ...
        gc.weighty = 1.0;
        bottomTabPane.getAccessibleContext().setAccessibleName("Bottom Tab Panel");
        bottomTabPane.getAccessibleContext().setAccessibleDescription("Bottom Tab Panel");
    ...
    public void setSQLJoinView(SQLJoinView jView) {
        try {
            ...
            mLogger.log(Level.INFO,NbBundle.getMessage(JoinMainPanel.class, "LOG.INFO_cannot_clone",new Object[] {LOG_CATEGORY}),ex);
            DialogDisplayer.getDefault().notify(
                    new NotifyDescriptor.Message(NbBundle.getMessage(JoinMainPanel.class, "MSG_Join_View_model_is_corrupted") + ex.getMessage(), NotifyDescriptor.ERROR_MESSAGE));
    ...
    public void setEditSQLJoinView(SourceTable sTable, SQLJoinView jView) {
        try {
            ...
            mLogger.log(Level.INFO,NbBundle.getMessage(JoinMainPanel.class, "LOG.INFO_Join_View_model_corrupted",new Object[] {ex.getMessage(), NotifyDescriptor.ERROR_MESSAGE}),ex);
            DialogDisplayer.getDefault().notify(
                    new NotifyDescriptor.Message(NbBundle.getMessage(JoinMainPanel.class, "MSG_Join_View_model_is_corrupted") + ex.getMessage(), NotifyDescriptor.ERROR_MESSAGE));
