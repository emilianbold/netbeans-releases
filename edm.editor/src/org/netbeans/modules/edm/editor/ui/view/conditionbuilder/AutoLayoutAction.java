...
public class AutoLayoutAction extends GraphAction {
    ...
    private static final URL autoLayoutImgUrl = AutoLayoutAction.class.getResource("/org/netbeans/modules/edm/editor/resources/layout_edm.png");
    private static transient final Logger mLogger = Logger.getLogger(AutoLayoutAction.class.getName());

    public AutoLayoutAction() {
        //action name
        this.putValue(Action.NAME, NbBundle.getMessage(AutoLayoutAction.class, "LBL_AutoLayout"));
