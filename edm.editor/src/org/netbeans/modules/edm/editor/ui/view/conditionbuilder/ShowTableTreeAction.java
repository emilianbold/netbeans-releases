...
public class ShowTableTreeAction extends GraphAction {
    ...
    private static URL validateSqlUrl = ShowTableTreeAction.class.getResource("/org/netbeans/modules/edm/editor/resources/Show_Source_Columns.png");
    ...
    public ShowTableTreeAction() {
        ...
        // Action tooltip
        this.putValue(Action.NAME, NbBundle.getMessage(ShowTableTreeAction.class, "ACTION_SHOWTABLETREE_TOOLTIP"));
    ...
    protected String iconResource() {
        return "/org/netbeans/modules/edm/editor/resources/Show_Source_Columns.png";
    }
