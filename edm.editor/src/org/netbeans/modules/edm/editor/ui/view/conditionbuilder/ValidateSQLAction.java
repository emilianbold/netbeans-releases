...
import org.netbeans.modules.edm.editor.ui.view.conditionbuilder.ConditionViewManager;
...
public class ValidateSQLAction extends GraphAction {
    ...
    private static URL validateSqlUrl = ValidateSQLAction.class.getResource("/org/netbeans/modules/edm/editor/resources/validate.png");
    ...
    public ValidateSQLAction() {
        ...
        // Action tooltip
        this.putValue(Action.NAME, NbBundle.getMessage(ValidateSQLAction.class, "Validate_SQL_Condition"));
        this.putValue(Action.SHORT_DESCRIPTION, NbBundle.getMessage(ValidateSQLAction.class, "Validate_SQL_Condition"));
    ...
    protected String iconResource() {
        return "/org/netbeans/modules/edm/editor/resources/validate.png";
    }
