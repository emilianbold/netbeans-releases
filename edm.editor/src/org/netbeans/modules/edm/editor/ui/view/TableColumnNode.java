...
public class TableColumnNode extends DefaultMutableTreeNode implements Comparable {
    ...
    public TableColumnNode(Object model) {
        ...
        if (model instanceof SQLDBModel) {
            ...
            enabled = !field.isNullable();
            toolTip = UIUtil.getColumnToolTip(field);
        } else {
            throw new IllegalArgumentException(NbBundle.getMessage(TableColumnNode.class, "MSG_Unrecognized_model_type"));
        }
    ...
    public int compareTo(Object o) {
        ...
        switch (type) {
            ...
            default:
                throw new ClassCastException(NbBundle.getMessage(TableColumnNode.class, "MSG_Cannot_compare"));
        }
    }
    ...
    public Image getIcon(int imgType) {
        ...
        switch (type) {
            case DB:
                imgPath = "/org/netbeans/modules/edm/editor/resources/root.png";
                break;

            case TABLE:
                imgPath = "/org/netbeans/modules/edm/editor/resources/SourceTable.png";
                break;

            case COLUMN:
                imgPath = "/org/netbeans/modules/edm/editor/resources/column.png";
                break;
