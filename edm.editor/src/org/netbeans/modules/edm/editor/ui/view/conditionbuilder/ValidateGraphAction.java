...
public class ValidateGraphAction extends GraphAction {
    ...
    private static URL showSqlUrl = ValidateGraphAction.class.getResource("/org/netbeans/modules/edm/editor/resources/validate.png");
    ...
    public ValidateGraphAction() {
        ...
        // Action tooltip
        this.putValue(Action.SHORT_DESCRIPTION, NbBundle.getMessage(ValidateGraphAction.class, "ACTION_VALIDATEGRAPH"));
