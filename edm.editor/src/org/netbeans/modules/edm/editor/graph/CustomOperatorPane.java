...
//        this.args.add(new ColumnWrapper(arg1));
    ...
    private void initComponents() {
        ...
        JLabel nameLabel = new JLabel(NbBundle.getMessage(CustomOperatorPane.class, "LBL_function_name")); 
        nameLabel.getAccessibleContext().setAccessibleName("Function Name");
        this.add(nameLabel,
        ...
        this.add(nameField,
                ...
                new Insets(5, 5, 5, 5), 0, 0));
        JButton addButton = new JButton(NbBundle.getMessage(CustomOperatorPane.class, "BTN_Add"));
        ...
        JButton removeButton = new JButton(NbBundle.getMessage(CustomOperatorPane.class, "BTN_Remove"));
        ...
        this.add(removeButton,
                ...
                GridBagConstraints.NONE,
                new Insets(5, 5, 5, 5), 0, 0));
        JLabel argLabel = new JLabel(NbBundle.getMessage(CustomOperatorPane.class, "LBL_Arguments"));
        argLabel.getAccessibleContext().setAccessibleName("Arguments");
...
//            SQLDBColumn arg1 = SQLModelObjectFactory.getInstance().createTargetColumn(argName, Types.NUMERIC, 0, 0, true);
...
//            this.fireTableDataChanged();
        ...
        public void setValueAt(Object value, int row, int col) {
            ...
            switch (col) {
                case 1:
                    colWrapper.setJdbcType(org.netbeans.modules.edm.editor.utils.SQLUtils.getStdJdbcType((String) value));
                    set = true;
                    break;
                case 2:
                    try {
