...
public class OperatorXmlInfoModel implements IOperatorXmlInfoModel {
    ...
    private DataObject getRootOperatorGroupObject(String folderName) {
        try {
            ...
            if (fo == null) {
                throw new Exception(NbBundle.getMessage(OperatorXmlInfoModel.class, "MSG_Folder_not_found") + folderName);
            }

            return DataObject.find(fo);
        } catch (Exception ex) {
            throw new InternalError(NbBundle.getMessage(OperatorXmlInfoModel.class, "MSG_Folder_not_found") + folderName);
        }
    }
