...
public class LiteralDialog extends JDialog implements ActionListener {
    ...
    public LiteralDialog(Frame parent, String title, boolean modal) {
        ...
        try {
            mOkButton = new JButton(NbBundle.getMessage(LiteralDialog.class, "BTN_ok")); 
            mOkButton.getAccessibleContext().setAccessibleName("Ok Button");//NOI18N
            mCancelButton = new JButton(NbBundle.getMessage(LiteralDialog.class, "BTN_cancel")); 
            mCancelButton.getAccessibleContext().setAccessibleName("Cancel Button");//NOI18N
            initComponents();
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        switch (type) {
            ...
            case Types.BOOLEAN:
                if (!(Boolean.TRUE.toString().equals(literalVal) || Boolean.FALSE.toString().equalsIgnoreCase(literalVal))) {
                    errorMsg = NbBundle.getMessage(LiteralDialog.class, "ERROR_literal_trueorfalse");
                }
                break;
            ...
            case Types.REAL:
                try {
                    ...
                    errorMsg = NbBundle.getMessage(LiteralDialog.class, "ERROR_literal_validnumber");
                }
                break;
            ...
            case Types.TINYINT:
                try {
                    Integer.valueOf(literalVal);
                } catch (NumberFormatException e) {
                    errorMsg = NbBundle.getMessage(LiteralDialog.class, "ERROR_literal_validinteger");
                }
...
//                }
            ...
            case Types.DATE:
                try {
                    ...
                    errorMsg = NbBundle.getMessage(LiteralDialog.class, "ERROR_literal_validdate");
                }
                break;

            case Types.TIME:
                if (!StringUtil.isValid(literalVal, "[0-9]?[0-9]:[0-9][0-9].?[AP]?[M]?")) { //NOI18N
                    errorMsg = NbBundle.getMessage(LiteralDialog.class, "ERROR_literal_validtime"); 
                }
                break;
            ...
            case Types.TIMESTAMP:
                try {
                    ...
                    errorMsg = NbBundle.getMessage(LiteralDialog.class, "ERROR_literal_validtimestamp");
                }
                break;
            default:
                if (StringUtil.isNullString(literalVal)) {
                    errorMsg = NbBundle.getMessage(LiteralDialog.class, "ERROR_literal_valuerequired");
                }
        }
    ...
    private void initComponents() throws Exception {
        ...
        JLabel valueLabel = new JLabel("Value:"); //NOI18N
        valueLabel.getAccessibleContext().setAccessibleName("Value:");
