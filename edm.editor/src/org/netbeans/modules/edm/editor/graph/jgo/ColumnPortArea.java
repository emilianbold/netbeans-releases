...
public class ColumnPortArea extends CanvasArea {
    ...
    public void addPort(int row) {
        if (row < 0 || row > columnPorts.size()) {
            throw new IllegalArgumentException(NbBundle.getMessage(ColumnPortArea.class, "MSG_Can_not_add_row") + row + NbBundle.getMessage(ColumnPortArea.class, "MSG_does_not_exist"));
        }
    ...
    public void removePort(int row) {
        if (row < 0 || row >= columnPorts.size()) {
            throw new IllegalArgumentException(NbBundle.getMessage(ColumnPortArea.class, "MSG_Can_not_remove_port_row") + row + NbBundle.getMessage(ColumnPortArea.class, "MSG_does_not_exist"));
        }
