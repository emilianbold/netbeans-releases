...
public class FitToPageAction extends AbstractAction {
    ...
    public FitToPageAction(MashupDataObject dObj) {
        ...
        this.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke('F', InputEvent.CTRL_DOWN_MASK+InputEvent.ALT_DOWN_MASK));
        mObj = dObj;
    }
    ...
    public FitToPageAction(MashupDataObject dObj, String name) {
        super(name, new ImageIcon(
                MashupGraphUtil.getImage(ImageConstants.FITTOPAGE)));
        this.putValue(Action.SHORT_DESCRIPTION, NbBundle.getMessage(FitToPageAction.class, "TOOLTIP_Fit_To_Page"));
        //this.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke('F', InputEvent.CTRL_DOWN_MASK+InputEvent.ALT_DOWN_MASK));
        mObj = dObj;
    }
...
//        String nbBundle1 = mLoc.t("BUND171: Graph successfully fit to page.");
