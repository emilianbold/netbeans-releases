...
public class OperatorPaletteDialog extends JDialog implements ActionListener {
    ...
    /* cancel button */
    private JButton mBtnCancel = new JButton(NbBundle.getMessage(OperatorPaletteDialog.class, "LBL_Close"));
    ...
    public OperatorPaletteDialog(Frame aFrame, OperatorSelectionPanel sp) {
        ...
        mBtnCancel.getAccessibleContext().setAccessibleName(NbBundle.getMessage(OperatorPaletteDialog.class, "LBL_Close"));
        bp2.add(mBtnCancel);
