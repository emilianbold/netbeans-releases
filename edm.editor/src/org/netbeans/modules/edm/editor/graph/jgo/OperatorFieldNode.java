...
public class OperatorFieldNode implements IOperatorField {
    ...
    public void setDefaultValue(String newValue) throws EDMException {
        if (acceptables.contains(newValue)) {
            ...
            throw new EDMException(NbBundle.getMessage(OperatorFieldNode.class, "ERROR_not_exist_in_acceptables_list") + newValue);
        }
    }
        ...
        if (isStatic) {
            ...
            if (displayValues != null) {
                if (displayValues.isEmpty()) {
                    ...
                    throw new IllegalArgumentException(NbBundle.getMessage(OperatorFieldNode.class, "ERROR_values_should_match"));
                }
