...
public class ExpandAllAction extends AbstractAction {
    ...
    public ExpandAllAction(MashupDataObject dObj, String name) {
        ...
        this.putValue(Action.SHORT_DESCRIPTION, NbBundle.getMessage(ExpandAllAction.class, "TOOLTIP_Expand_All"));
...
//        String nbBundle1 = mLoc.t("BUND168: Expanded all widgets.");
