...
public class SQLToolBarMenu extends JToggleButton {
    ...
    public SQLToolBarMenu(IOperatorXmlInfoCategory catNode, IOperatorManager manager, SQLToolBar toolbar) {
        ...
        this.setToolTipText(catNode.getDisplayName() + " " + NbBundle.getMessage(SQLToolBarMenu.class, "TOOLTIP_Operator_Category_Menu"));
    }
    ...
    public void showButtonMenu(Point location) {
        if (mButtonMenu == null) {
            throw new IllegalStateException(NbBundle.getMessage(SQLToolBarMenu.class, "MSG_MenuButton_not_been_initialized"));
        }
    ...
    private class ButtonPopupMenu extends JWindow {
        ...
        public ButtonPopupMenu(Window parent) {
            ...
            AbstractButton setupButton = new JButton(NbBundle.getMessage(SQLToolBarMenu.class, "LBL_Category_Configuration_Item"));
            setupButton.getAccessibleContext().setAccessibleName("Settings");
            setupButton.getAccessibleContext().setAccessibleDescription("Settings");
        ...
        public void addButton(AbstractButton b, int index) {
            if (index < 0) {
                ...
                throw new IndexOutOfBoundsException(NbBundle.getMessage(SQLToolBarMenu.class, "MSG_component_count") + (mButtonList.getComponentCount() - 2) + NbBundle.getMessage(SQLToolBarMenu.class, "MSG_insert_index") + index);
            }
            addButton(index, b);
        }
