 ...
 * @author jawed
 */
public class EDMSQLLogView extends JPanel implements EDMIMessageView, EDMOutputPanel {

    private JTextArea textArea;
    private JButton refreshButton;
    private ActionListener aListener;
    private static final Logger mLogger = Logger.getLogger(EDMSQLLogView.class.getName());
    private JButton[] btn = new JButton[1];

    /** Creates a new instance of SQLLogView */
    public EDMSQLLogView() {
        String nbBundle1 = NbBundle.getMessage(EDMSQLLogView.class, "LBL_logview_tab");
        String viewLabel = nbBundle1;
        ...
        String nbBundle2 = NbBundle.getMessage(EDMSQLLogView.class, "LBL_Refresh_Log");
