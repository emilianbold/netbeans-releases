...
import org.netbeans.modules.edm.editor.property.IPropertyEditor;
...
public class BasicPropertySupport extends Node.Property implements IProperty, Comparable {
    ...
    public int compareTo(Object o) {
        if (!(o instanceof IProperty)) {
            throw new ClassCastException(NbBundle.getMessage(BasicPropertySupport.class, "MSG_Object") + o + NbBundle.getMessage(BasicPropertySupport.class, "MSG_not_same_as_this_object"));
        }
