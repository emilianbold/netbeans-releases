...
public class TemplateFactory {
    ...
    static {
        tagToClassMap.put("TemplateGroup", "org.netbeans.modules.edm.editor.property.impl.TemplateGroup");
        tagToClassMap.put("Template", "org.netbeans.modules.edm.editor.property.impl.Template");
        tagToClassMap.put("PropertyGroup", "org.netbeans.modules.edm.editor.property.impl.PropertyGroup");
        tagToClassMap.put("Property", "org.netbeans.modules.edm.editor.property.impl.BasicPropertySupport");
        tagToClassMap.put("OptionProperty", "org.netbeans.modules.edm.editor.property.impl.OptionPropertySupport");
        tagToClassMap.put("Option", "org.netbeans.modules.edm.editor.property.impl.BasicOption");
    }
    ...
    public void startElement(String uri, String localName, String qName, Attributes attrs) throws SAXException {
        try {
            ...
            ex.printStackTrace();
            throw new SAXException(NbBundle.getMessage(TemplateFactory.class, "MSG_Error_occured_while_parsing") + "\n uri = " + uri + "\n localName = " + localName + "\n qName = " + qName, ex);
        }
    }
