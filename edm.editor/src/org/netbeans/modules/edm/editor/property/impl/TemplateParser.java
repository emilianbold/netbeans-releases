...
public class TemplateParser extends DefaultHandler {
    ...
    public void endDocument() throws SAXException {
        try {
            ...
            throw new SAXException(NbBundle.getMessage(TemplateParser.class, "MSG_I/O_error"), e);
        }
    }
    ...
    private void init(InputStream stream) {
        ...
        try {
            ...
            if (Boolean.getBoolean("org.netbeans.modules.edm.editor.property.impl.TemplateParser.showOutput")) {
