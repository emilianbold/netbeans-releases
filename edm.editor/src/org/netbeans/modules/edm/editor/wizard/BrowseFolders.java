...
public class BrowseFolders extends javax.swing.JPanel implements ExplorerManager.Provider {
    ...
    private Project project;
     private static final Logger mLogger = Logger.getLogger(BrowseFolders.class.getName());
    ...
    public BrowseFolders( SourceGroup[] folders, Project project, String preselectedFileName ) { 
        ...
        btv.getAccessibleContext ().setAccessibleName ("Folders:");
        btv.getAccessibleContext ().setAccessibleDescription ("The tree contains the folders contained in the project's directory");
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        getAccessibleContext().setAccessibleName("Browse folders to choose a target folder");
        getAccessibleContext().setAccessibleDescription("Browse folders to choose a target folder");
        ...
        jLabel1.getAccessibleContext().setAccessibleName("Folders:");
    ...
    public static FileObject showDialog( SourceGroup[] folders, Project project, String preselectedFileName ) {
        ...
        JButton options[] = new JButton[] {
            new JButton(NbBundle.getMessage(BrowseFolders.class, "BTN_Select_Folder")), 
            new JButton(NbBundle.getMessage(BrowseFolders.class, "BTN_Cancel")), 
        };
        ...
        options[ 0 ].setMnemonic ('S' );
        options[ 0 ].getAccessibleContext ().setAccessibleName ("Select Folder");
        options[ 0 ].getAccessibleContext ().setAccessibleDescription ("N/A");
        options[ 1 ].setActionCommand( OptionsListener.COMMAND_CANCEL );
        options[ 1 ].addActionListener( optionsListener );
        options[ 1 ].getAccessibleContext ().setAccessibleName ("Cancel");
        options[ 1 ].getAccessibleContext ().setAccessibleDescription ("N/A");
        DialogDescriptor dialogDescriptor = new DialogDescriptor(
            bf,                                     // innerPane
            NbBundle.getMessage(BrowseFolders.class, "LBL_Browse_Folders"),                       // displayName
            true,                                   // modal
            options,                                // options
