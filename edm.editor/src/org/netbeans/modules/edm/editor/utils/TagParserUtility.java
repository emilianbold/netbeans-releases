...
public class TagParserUtility {
    ...
    public static String getDisplayStringFor(int type) throws EDMException {
        switch (type) {
            ...
            default:
                throw new EDMException("Undefined SQLObject type: " + type);
        }
    }

    public static int getIntType(String type) throws EDMException {
        if (type.equals(SQLConstants.STR_GENERIC_OPERATOR) || type.equals(SQLConstants.STR_SCALAR_OPERATOR)) {
            ...
            throw new EDMException("Failed to get Int type for '" + type + "'");
        }
    }
    ...
    public static String getStringType(int type) throws EDMException {
        switch (type) {
            case SQLConstants.GENERIC_OPERATOR:
            ...
            default:
                throw new EDMException("Undefined Operator Type" + type);
        }
    }

    public static Attribute parseAttribute(Element elem) throws EDMException {
        if (elem == null) {
    ...
    public static void parseAttributeList(Map attributes, NodeList list) throws EDMException {
        if (attributes == null) {
    ...
    public static void parseInputChildNodes(SQLConnectableObject sqlObj, NodeList inputArgList) throws EDMException {
    ...
    public static void parseInputTag(SQLConnectableObject sqlObj, Element elem) throws EDMException {
        if (elem != null) {
            ...
            do {
                ...
                if (parentObject instanceof SQLContainerObject) {
                    ...
                    throw new EDMException("Could not locate root SQLDefinition instance!");
                }
    ...
    public static void parseInputTagList(SQLConnectableObject sqlObj, NodeList inputArgList) throws EDMException {
        for (int i = 0; i < inputArgList.getLength(); i++) {
            Element elem = (Element) inputArgList.item(i);
            parseInputTag(sqlObj, elem);
        }
    ...
    public static SQLObject parseXMLObjectRefTag(SQLContainerObject definition, Element xmlElement) throws EDMException {
        if (definition == null) {
            throw new EDMException("Must supply non-null SQLDefinition ref for param 'definition'.");
        }

        if (xmlElement == null) {
            throw new EDMException("Must supply non-null Element ref for param 'xmlElement'.");
        }
    ...
    public static String toXMLInputTag(String prefix, List inputs) throws EDMException {
    ...
    public static String toXMLObjectRefTag(SQLObject object, String prefix) throws EDMException {
        if (object == null) {
            throw new EDMException("Must supply non-null SQLObject ref for param 'object'.");
        }
