 ...
 */
public class DesignTimeDBConnectionProvider {

    public DesignTimeDBConnectionProvider() {
    }

    public Connection getConnection(DBConnectionParameters conDef) throws EDMException {
    ...
    public Connection getConnection(Properties connProps) throws EDMException {
