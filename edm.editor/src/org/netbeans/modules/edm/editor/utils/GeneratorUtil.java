...
public class GeneratorUtil {
     ...
     */
    public static GeneratorUtil getInstance() throws EDMException {
        if (instance == null) {
    ...
    private GeneratorUtil() throws EDMException {
        db = DBFactory.getInstance().getDatabase(DBConstants.AXION);
        db.setQuoteAlways(false);
    ...
    public String getEvaluatedString(SQLObject sqlObj) {
        ...
        try {
            ...
            mLogger.log(Level.INFO,NbBundle.getMessage(GeneratorUtil.class, "LOG.INFO_Could_not_evaulate_object",new Object[] {sqlObj.getDisplayName(), GeneratorUtil.class.getName()}),ex);
