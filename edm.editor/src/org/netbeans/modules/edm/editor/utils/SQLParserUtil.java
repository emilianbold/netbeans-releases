...
public class SQLParserUtil {
     ...
     */
    public SQLObject getColumn(String fullName) throws EDMException {
     ...
     */
    public SQLObject getColumnForFullyQualifiedName(String fullName) throws EDMException {
        SQLDBColumn column = null;
        ColumnRef columnRef = null;
        ...
        if (column != null) {
            ...
            throw new EDMException("getColumnForFullyQualifiedName. Column \"" + fullName + "\"is not available in collaboration \"" + def.getDisplayName() + "\"");
        }
    ...
    public SQLObject getRuntimeInput(String argName) throws EDMException {
        SQLDBColumn column = null;
        ColumnRef columnRef = null;
        ...
        if (column != null) {
            ...
            throw new EDMException("Runtime input argument \"" + argumentName + "\"is not defined in collaboration \"" + def.getDisplayName() + "\"");
        }
