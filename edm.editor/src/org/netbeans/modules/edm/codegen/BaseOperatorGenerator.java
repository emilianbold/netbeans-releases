...
public class BaseOperatorGenerator extends AbstractOperatorGeneratorFactory {
    ...
    public Map<String, String> initializeOperatorSpecificGenerator() {
        ...
        operatorToGeneratorMap.put("castas", "org.netbeans.modules.edm.codegen.BaseCastAsOperatorGenerator");
        operatorToGeneratorMap.put("userFx", "org.netbeans.modules.edm.codegen.BaseUserFxGenerator");        
