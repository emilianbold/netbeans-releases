 ...
 * @author ondra
 */
@ActionID(id = "org.netbeans.modules.git.remote.ui.fetch.FetchFromUpstreamAction", category = "GitRemote")
...
public class FetchFromUpstreamAction extends MultipleRepositoryAction {
    ...
    private static final String ICON_RESOURCE = "org/netbeans/modules/git/remote/resources/icons/fetch.png"; //NOI18N
    ...
    private Task fetch (final VCSFileProxy repository) {
