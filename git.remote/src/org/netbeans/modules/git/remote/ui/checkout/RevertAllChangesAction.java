 ...
 * @author Ondra Vrabec
 */
@ActionID(id = "org.netbeans.modules.git.remote.ui.checkout.RevertAllChangesAction", category = "GitRemote")
...
public class RevertAllChangesAction extends SingleRepositoryAction {
    ...
    private static final String ICON_RESOURCE = "org/netbeans/modules/git/remote/resources/icons/get_clean.png"; //NOI18N
    ...
    protected void performAction (final VCSFileProxy repository, final VCSFileProxy[] roots, VCSContext context) {
        SystemAction.get(RevertChangesAction.class).performAction(repository, new VCSFileProxy[] { repository }, GitUtils.getContextForFile(repository));
    }
