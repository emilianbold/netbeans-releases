 ...
 * @author ondra
 */
@ActionID(id = "org.netbeans.modules.git.remote.ui.status.StatusAllAction", category = "GitRemote")
...
public class StatusAllAction extends GitAction {
    ...
    protected final void performContextAction (Node[] nodes) {
        ...
        SystemAction.get(StatusAction.class).performContextAction(GitUtils.getContextForFiles(roots.toArray(new VCSFileProxy[roots.size()])));
    }
