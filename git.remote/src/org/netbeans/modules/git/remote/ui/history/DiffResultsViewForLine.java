...
import org.netbeans.modules.git.remote.ui.history.RepositoryRevision.Event;
...
final class DiffResultsViewForLine extends DiffResultsView {
    ...
    private class ShowDiffTask extends GitProgressSupport {
        ...
        public ShowDiffTask (VCSFileProxy file, String revision, boolean showLastDifference) {
            this.file = file;
