...
public class Rebase implements ActionListener, PropertyChangeListener {
    ...
    public Rebase (VCSFileProxy repository, Map<String, GitBranch> branches, GitBranch activeBranch) {
    ...
    public boolean showDialog() {
        ...
        dialogDescriptor.setHelpCtx(new HelpCtx("org.netbeans.modules.git.remote.ui.rebase.RebasePanel")); //NOI18N
