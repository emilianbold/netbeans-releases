...
public class MergeRevision {
    ...
    MergeRevision (VCSFileProxy repository, VCSFileProxy[] roots, String initialRevision, FastForwardOption defaultFFOption) {
    ...
    boolean show() {
        ...
        dd = new DialogDescriptor(panel, NbBundle.getMessage(MergeRevision.class, "LBL_MergeRevision.title"), true,  //NOI18N
                ...
                new HelpCtx("org.netbeans.modules.git.remote.ui.merge.MergeRevision"), null); //NOI18N
        enableRevisionPanel();
