...
import org.netbeans.modules.git.remote.ui.push.PushMapping.PushBranchMapping;
import org.netbeans.modules.git.remote.ui.repository.remote.SelectUriStep;
...
class PushWizard  implements ChangeListener {
    ...
    public PushWizard (VCSFileProxy repository, Map<String, GitRemoteConfig> remotes) {
