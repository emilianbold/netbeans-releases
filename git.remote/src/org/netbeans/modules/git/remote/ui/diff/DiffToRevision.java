...
class DiffToRevision  implements ActionListener, PropertyChangeListener {
    ...
    public DiffToRevision (VCSFileProxy repository, GitBranch currentBranch) {
    ...
    public boolean showDialog() {
        ...
        dialogDescriptor.setHelpCtx(new HelpCtx("org.netbeans.modules.git.remote.ui.diff.DiffToRevisionPanel")); //NOI18N
