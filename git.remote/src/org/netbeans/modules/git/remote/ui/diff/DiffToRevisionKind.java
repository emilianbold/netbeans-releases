...
abstract class DiffToRevisionKind {
    ...
    public static class LocalToRevisionKind extends DiffToRevisionKind {
        ...
        public LocalToRevisionKind (VCSFileProxy repository, Revision preselectedRevision) {
            super(LocalToRevisionKind.class.getName());
            revisionPicker = new RevisionDialogController(repository, new VCSFileProxy[0], preselectedRevision.getRevision());
    ...
    public static class BaseToRevisionKind extends DiffToRevisionKind {
        ...
        public BaseToRevisionKind (VCSFileProxy repository, Revision preselectedRevision) {
