 ...
 * @author Ondra Vrabec
 */
@ActionID(id = "org.netbeans.modules.git.remote.ui.actions.AddAllAction", category = "GitRemote")
...
public class AddAllAction extends SingleRepositoryAction {
    ...
    protected void performAction (VCSFileProxy repository, final VCSFileProxy[] roots, VCSContext context) {
        SystemAction.get(AddAction.class).performAction(repository, new VCSFileProxy[] { repository }, GitUtils.getContextForFile(repository));
    }
