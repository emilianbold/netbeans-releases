...
public class CreatingPropertiesFileFromMainWindow2 extends PropertiesEditorTestCase {
     ...
     */
    public CreatingPropertiesFileFromMainWindow2(String name) {
        super(name);
    }

    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite();
        suite.addTest(new CreatingPropertiesFileFromMainWindow2("testCreatingPropertiesFileFromMainWindow2"));
        return suite;
    }
