 ...
 * @author Admin
 */
public class SimpleAndAdvanceEditor extends PropertiesEditorTestCase{
    ...
    public SimpleAndAdvanceEditor(String name) {
        super(name);
    }
    
    public static NbTestSuite suite(){
        NbTestSuite suite = new NbTestSuite();
        suite.addTest(new SimpleAndAdvanceEditor("testCreateNewBundle"));
        suite.addTest(new SimpleAndAdvanceEditor("testOpenningSimpleEditorFromFileExplorer"));
        suite.addTest(new SimpleAndAdvanceEditor("testOpenningAdvanceEditorFromFileExplorer")); 
        suite.addTest(new SimpleAndAdvanceEditor("testCreateNewBundleInDefaultPackage"));
        suite.addTest(new SimpleAndAdvanceEditor("testOpenningSimpleEditorFromProjectTab"));
        suite.addTest(new SimpleAndAdvanceEditor("testOpenningAdvanceEditorFromProjectTab"));
        return suite;
    }
