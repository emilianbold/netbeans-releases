...
public class LDAPTreeModel extends DefaultTreeModel {
    ...
    public LDAPTreeModel(LDAPConnection ldapConnection, 
            ...
            RequestProcessor requestProcessor)
    {
        ...
        setRoot(new LDAPTreeNode(this, (Rdn[]) null, null, null, null));
    }
    ...
    public void abortBackgroundTasks() {
        ...
        if (rootNode instanceof AbstractLDAPTreeNode) {
            ((AbstractLDAPTreeNode) rootNode).abortBackgroundTasks();
        }
    }
