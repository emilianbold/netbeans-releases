 ...
 *
 */
public class LDAPBindingImpl extends LDAPComponentImpl implements LDAPBinding {
    public LDAPBindingImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
    public LDAPBindingImpl(WSDLModel model){
        this(model, createPrefixedElement(LDAPQName.BINDING.getQName(), model));
    }
