 ...
 * @author skini
 */
public class LDAPRenameRefactorVisitor extends ChildVisitor implements WSDLVisitor, LDAPComponent.Visitor {
    private Referenceable referenced;
    private String oldName;
    
    public LDAPRenameRefactorVisitor(Referenceable referenced, String oldName) {
