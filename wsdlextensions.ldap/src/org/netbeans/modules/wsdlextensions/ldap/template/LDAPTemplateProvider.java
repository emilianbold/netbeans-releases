...
public class LDAPTemplateProvider extends ExtensibilityElementTemplateProvider {
    ...
    public InputStream getTemplateFileInputStream(String filePath) {
        return LDAPTemplateProvider.class.getResourceAsStream("/org/netbeans/modules/wsdlextensions/ldap/template/" + filePath);
    }

    @Override
    public WSDLWizardExtensionIterator getWSDLWizardExtensionIterator(WSDLWizardContext context) {
        return new org.netbeans.modules.wsdlextensions.ldap.LDAPBrowserWizardIterator(context);
    }      
}
