 ...
 */
public class GlassfishTestSuite extends GenericTestSuite {
    
    private static GlassfishConstantsProvider cProvider;
    private static GlassfishServerProvider sProvider;
    ...
    public synchronized ConstantsProvider getConstantsProvider() {
        if (null == cProvider)
            cProvider = new GlassfishConstantsProvider();
    ...
    public synchronized ServerProvider getServerProvider() {
        if (null == sProvider)
            sProvider = new GlassfishServerProvider((GlassfishConstantsProvider) getConstantsProvider());
