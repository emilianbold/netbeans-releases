...
/**
 * Weblogic  implementation of the ServerProvider
 *
 * @author Michal Mocnak
 */
public class WeblogicServerProvider implements ServerProvider {
    
    private WeblogicConstantsProvider cProvider;
    
    /**
     * Creates a new instance of WeblogicServerProvider
     *
     * @param cProvider instance of WeblogicConstantsProvider
     */
    public WeblogicServerProvider(WeblogicConstantsProvider cProvider) {
