...
public abstract class GenericTestSuite extends J2eeTestCase {
     ...
     */
    public GenericTestSuite(String name) {
        super(name);
    }
    
    /**
     * Returns instance of the ConstantsProvider
     * 
     * @return instance of the ConstantsProvider
     */
    public abstract ConstantsProvider getConstantsProvider();
    
    /**
     * Returns instance of the ServerProvider
     * 
     * @return instance of the ServerProvider
     */
