...
@Entity
@Table(name = "TABLE4")
@NamedQueries({@NamedQuery(name = "Table4.findAll", query = "SELECT t FROM Table4 t")})
public class Table4 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table4)) {
            return false;
        }
        Table4 other = (Table4) object;
