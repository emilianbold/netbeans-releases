...
@Entity
@Table(name = "TABLE0")
@NamedQueries({@NamedQuery(name = "Table0.findAll", query = "SELECT t FROM Table0 t")})
public class Table0 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table0)) {
            return false;
        }
        Table0 other = (Table0) object;
