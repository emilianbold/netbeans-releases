...
@Entity
@Table(name = "TABLE6")
@NamedQueries({@NamedQuery(name = "Table6.findAll", query = "SELECT t FROM Table6 t")})
public class Table6 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table6)) {
            return false;
        }
        Table6 other = (Table6) object;
