...
@Entity
@Table(name = "TABLE19")
@NamedQueries({@NamedQuery(name = "Table19.findAll", query = "SELECT t FROM Table19 t")})
public class Table19 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table19)) {
            return false;
        }
        Table19 other = (Table19) object;
