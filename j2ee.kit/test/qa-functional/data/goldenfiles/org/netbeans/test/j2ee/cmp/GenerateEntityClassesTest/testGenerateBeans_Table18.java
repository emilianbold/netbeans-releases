...
@Entity
@Table(name = "TABLE18")
@NamedQueries({@NamedQuery(name = "Table18.findAll", query = "SELECT t FROM Table18 t")})
public class Table18 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table18)) {
            return false;
        }
        Table18 other = (Table18) object;
