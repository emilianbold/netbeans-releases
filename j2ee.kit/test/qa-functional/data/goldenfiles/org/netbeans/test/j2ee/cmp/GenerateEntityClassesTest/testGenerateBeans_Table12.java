...
@Entity
@Table(name = "TABLE12")
@NamedQueries({@NamedQuery(name = "Table12.findAll", query = "SELECT t FROM Table12 t")})
public class Table12 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table12)) {
            return false;
        }
        Table12 other = (Table12) object;
