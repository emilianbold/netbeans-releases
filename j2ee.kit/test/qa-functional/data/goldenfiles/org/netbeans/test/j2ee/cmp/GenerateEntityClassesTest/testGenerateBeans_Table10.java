...
@Entity
@Table(name = "TABLE10")
@NamedQueries({@NamedQuery(name = "Table10.findAll", query = "SELECT t FROM Table10 t")})
public class Table10 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table10)) {
            return false;
        }
        Table10 other = (Table10) object;
