...
@Entity
@Table(name = "TABLE13")
@NamedQueries({@NamedQuery(name = "Table13.findAll", query = "SELECT t FROM Table13 t")})
public class Table13 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table13)) {
            return false;
        }
        Table13 other = (Table13) object;
