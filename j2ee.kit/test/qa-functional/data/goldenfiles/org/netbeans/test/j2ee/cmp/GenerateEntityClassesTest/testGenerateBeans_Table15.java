...
@Entity
@Table(name = "TABLE15")
@NamedQueries({@NamedQuery(name = "Table15.findAll", query = "SELECT t FROM Table15 t")})
public class Table15 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table15)) {
            return false;
        }
        Table15 other = (Table15) object;
