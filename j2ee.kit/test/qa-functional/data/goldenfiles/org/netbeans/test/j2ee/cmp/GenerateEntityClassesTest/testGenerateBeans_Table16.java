...
@Entity
@Table(name = "TABLE16")
@NamedQueries({@NamedQuery(name = "Table16.findAll", query = "SELECT t FROM Table16 t")})
public class Table16 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table16)) {
            return false;
        }
        Table16 other = (Table16) object;
