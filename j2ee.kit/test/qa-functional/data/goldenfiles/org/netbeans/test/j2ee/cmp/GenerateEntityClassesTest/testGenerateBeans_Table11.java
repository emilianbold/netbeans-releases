...
@Entity
@Table(name = "TABLE11")
@NamedQueries({@NamedQuery(name = "Table11.findAll", query = "SELECT t FROM Table11 t")})
public class Table11 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table11)) {
            return false;
        }
        Table11 other = (Table11) object;
