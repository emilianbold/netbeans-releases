...
@Entity
@Table(name = "TABLE9")
@NamedQueries({@NamedQuery(name = "Table9.findAll", query = "SELECT t FROM Table9 t")})
public class Table9 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table9)) {
            return false;
        }
        Table9 other = (Table9) object;
