...
@Entity
@Table(name = "TABLE7")
@NamedQueries({@NamedQuery(name = "Table7.findAll", query = "SELECT t FROM Table7 t")})
public class Table7 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table7)) {
            return false;
        }
        Table7 other = (Table7) object;
