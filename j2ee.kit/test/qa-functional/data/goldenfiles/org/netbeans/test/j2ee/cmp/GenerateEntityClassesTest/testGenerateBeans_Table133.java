...
@Entity
@Table(name = "TABLE133")
@NamedQueries({@NamedQuery(name = "Table133.findAll", query = "SELECT t FROM Table133 t")})
public class Table133 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table133)) {
            return false;
        }
        Table133 other = (Table133) object;
