...
@Entity
@Table(name = "TABLE8")
@NamedQueries({@NamedQuery(name = "Table8.findAll", query = "SELECT t FROM Table8 t")})
public class Table8 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table8)) {
            return false;
        }
        Table8 other = (Table8) object;
