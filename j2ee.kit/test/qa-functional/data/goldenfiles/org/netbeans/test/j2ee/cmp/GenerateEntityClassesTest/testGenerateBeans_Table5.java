...
@Entity
@Table(name = "TABLE5")
@NamedQueries({@NamedQuery(name = "Table5.findAll", query = "SELECT t FROM Table5 t")})
public class Table5 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table5)) {
            return false;
        }
        Table5 other = (Table5) object;
