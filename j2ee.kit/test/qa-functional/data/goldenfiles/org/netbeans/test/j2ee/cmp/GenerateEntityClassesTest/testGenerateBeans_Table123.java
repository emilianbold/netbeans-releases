...
@Entity
@Table(name = "TABLE123")
@NamedQueries({@NamedQuery(name = "Table123.findAll", query = "SELECT t FROM Table123 t")})
public class Table123 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Table123)) {
            return false;
        }
        Table123 other = (Table123) object;
