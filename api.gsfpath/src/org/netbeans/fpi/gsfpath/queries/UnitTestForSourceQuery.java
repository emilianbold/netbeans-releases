...
import java.net.URL;
import org.netbeans.sfpi.gsfpath.queries.MultipleRootsUnitTestForSourceQueryImplementation;
 ...
 *
 * @see org.netbeans.sfpi.gsfpath.queries.MultipleRootsUnitTestForSourceQueryImplementation
...
public class UnitTestForSourceQuery {
    ...
    private static final Lookup.Result<? extends org.netbeans.sfpi.gsfpath.queries.UnitTestForSourceQueryImplementation> implementations =
        Lookup.getDefault().lookupResult(org.netbeans.sfpi.gsfpath.queries.UnitTestForSourceQueryImplementation.class);
     ...
     * @since org.netbeans.fpi.gsfpath/1 1.7
     */
    @SuppressWarnings ("deprecation")   // NOI18N
    public static URL[] findUnitTests(FileObject source) {
        ...
        for (org.netbeans.sfpi.gsfpath.queries.UnitTestForSourceQueryImplementation query : implementations.allInstances()) {
