...
public class StopResolutionException  extends RuntimeException {
    ...
    /**
     * Adds text to initial message. Each addition is put to separate text line.
     * @param addition
     */
    public void setMsgAddition(String addition) {
        String lineSeparator = System.getProperty("line.separator");
        mMsgAddition = mMsgAddition + lineSeparator + addition;
    }

    @Override
    public String getMessage() {
        if (mMsgAddition == null || mMsgAddition.length() == 0) {
            return super.getMessage();
        } else {
            return super.getMessage() + mMsgAddition;
        }
    }
}
