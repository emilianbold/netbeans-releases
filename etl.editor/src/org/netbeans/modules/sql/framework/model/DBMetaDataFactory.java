...
public class DBMetaDataFactory {
     ...
     * @throws Exception 
     */
    public PrimaryKeyImpl getPrimaryKeys(String tcatalog, String tschema, String tname) throws Exception {
        ResultSet rs = null;
        try {
     ...
     * @throws Exception 
     */
    public Map<String, ForeignKey> getForeignKeys(DBTable table) throws Exception {
