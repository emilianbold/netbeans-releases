...
public class DBURL {
    ...
    public DBURL(String url, boolean level) {
        ...
        String prefixStripped = url.substring(DBExplorerUtil.AXION_URL_PREFIX.length());
        ...
        if (colon == -1 || (prefixStripped.length() - 1 == colon)) {
            ...
            if (projectLevel && workDir.startsWith(ETLEditorSupport.PRJ_PATH)) {
                int phome = ETLEditorSupport.PRJ_PATH.length();
