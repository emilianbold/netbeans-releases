 ...
 */
public class RuntimeInputProperties {

    RuntimeInput runIn;
    BasicTopView editor;
    SQLDefinition sqlDef;

    public RuntimeInputProperties(RuntimeInput runInput,SQLDefinition def, BasicTopView editor) {
        this.runIn = runInput;
        this.editor = editor;
        this.sqlDef = def;
    }
    ...
    public void setDisplayName(String newName) {
        this.runIn.setDisplayName(newName);
    }

   public String getModelName(){
       return this.sqlDef.getRuntimeDbModel().getModelName();
   }
