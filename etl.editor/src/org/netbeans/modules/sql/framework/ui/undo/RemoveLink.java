 ...
 * @author Ritesh Adval
 */
public class RemoveLink extends AbstractUndoableEdit {
    ...
    public RemoveLink(SQLUIModel model, SQLCanvasObject srcObject, String srcParam, SQLConnectableObject destObject, String destParam) {
