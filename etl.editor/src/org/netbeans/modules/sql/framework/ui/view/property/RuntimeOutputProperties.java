 ...
 */
public class RuntimeOutputProperties {

    RuntimeOutput runOut;
    BasicTopView editor;
    SQLDefinition sqlDef;

    public RuntimeOutputProperties(RuntimeOutput runOutput,SQLDefinition def, BasicTopView editor) {
        this.runOut = runOutput;
        this.editor = editor;
        this.sqlDef = def;
    }
    ...
    public String getDisplayName() {
        return this.runOut.getDisplayName();
    }
    ...
    public void setDisplayName(String newName) {
        this.runOut.setDisplayName(newName);
    }
