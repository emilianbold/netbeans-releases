 ...
 */
public class JoinViewDataPanel extends ETLDataOutputPanel {

    private static transient final Localizer mLoc = Localizer.get();

    public JoinViewDataPanel(SQLObject etlObject, SQLDefinition sqlDefinition) {
    ...
    public void generateResult(SQLObject aTable) {
        ...
        String nbBundle1 = mLoc.t("BUND350: Data: {0}", sqlObject.getDisplayName());
        ...
        generateOutput(sqlObject, this.sqlDef.getRuntimeDbModel().getRuntimeInput());
