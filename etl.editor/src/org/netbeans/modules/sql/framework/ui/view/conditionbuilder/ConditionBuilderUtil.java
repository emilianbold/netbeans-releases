...
public class ConditionBuilderUtil {
    ...
    public static ConditionBuilderView getHavingConditionBuilderView(TargetTable tTable, IGraphViewContainer gContainer) {
        ArrayList tables = new ArrayList(1);
        ...
        SQLGroupBy groupBy = tTable.getSQLGroupBy();
