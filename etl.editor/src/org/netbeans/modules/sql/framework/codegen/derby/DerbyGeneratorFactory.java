 ...
 * @author karthik
 */
public class DerbyGeneratorFactory extends BaseGeneratorFactory {
    public DerbyGeneratorFactory(AbstractDB database) {
        super(database);
    }
    @Override
    public Map<Integer, String> initializeObjectToGeneratorMap() {
        return super.initializeObjectToGeneratorMap();
    }
