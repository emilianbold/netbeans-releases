 ...
 * @version $Revision   $
 */
public class JdbcStatements extends BaseStatements {
    ...
    public JdbcStatements(AbstractDB database) {
        super(database);
    }
    ...
    protected void populateContextForUpdate(TargetTable targetTable, StatementContext context, VelocityContext vContext) throws BaseException {
        ...
        vContext.put(JdbcStatements.MAPPINGS, rMappings);
    ...
    private String mapDestinationCols(String sql, StatementContext context) {
        ...
        List directlyMappedSrcColsEval = (List) context.getClientProperty(JdbcStatements.DIRECTLY_MAPPED_SRC_COLS_EVAL) ;
        List additionalSelectColsEval = (List) context.getClientProperty(JdbcStatements.ADDITIONAL_SRC_COLS) ;
    ...
    public Map getCorrelatedUpdateStatement(TargetTable targetTable, final StatementContext sc) throws BaseException {
        ...
        if (targetTable.getSourceTableList().size() != 0) {
            ...
            vContext.put(JdbcStatements.ADDITIONAL_SRC_COLS, additionalSrcColsEval);
            ...
            context.putClientProperty(JdbcStatements.MAPPINGS, vContext.get(JdbcStatements.MAPPINGS));
            context.putClientProperty(JdbcStatements.ADDITIONAL_SRC_COLS, additionalSrcColsEval);
            context.putClientProperty(JdbcStatements.DIRECTLY_MAPPED_SRC_COLS_EVAL, directlyMappedSrcColsEval);
            context.putClientProperty(JdbcStatements.RUNTIME_INPUTS_MAP, runtimeInputsMap);
