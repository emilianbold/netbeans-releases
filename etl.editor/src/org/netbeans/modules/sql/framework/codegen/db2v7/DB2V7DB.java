 ...
 * @version $Revision$
 */
public class DB2V7DB extends BaseDB {

    /* Defines relative location of vendor-specific template configuration resource file. */
    private static final String TEMPLATE_FILE = "/org/netbeans/modules/sql/framework/codegen/db2v7/config/templates.xml";
    /* Reference to db2 operatordef info file. */
    private static final String DB2V7_OPERATOR_DEFINITION_FILE = "org/netbeans/modules/sql/" + "framework/codegen/db2v7/config/operator-script.xml";

    @Override
    public Statements createStatements() {
        return new DB2V7Statements(this);
    }
    ...
    public SQLOperatorFactory getOperatorFactory() {
        if (factory == null) {
            factory = new SQLOperatorFactory(DB2V7_OPERATOR_DEFINITION_FILE, super.getOperatorFactory());
        }
        return factory;
    }
