 ...
 * @version $Revision$
 */
public class Oracle8DateAddOperatorGenerator extends AbstractGenerator {
    ...
    public String generate(SQLObject obj, StatementContext context) throws BaseException {
        ...
        if (intervalType.equals("month") || intervalType.equals("quarter") || intervalType.equals("year")) {
            result = "ADD_MONTHS(" + resolvedparams.get("timestamp1") + ", " + resolvedparams.get("interval") + " * " + resolvedparams.get("type")
                + ")";
