...
/**
 * Oracle 8i-specific concrete implementation of DB interface.
 *
 * @author Ritesh Adval
 * @author Jonathan Giron
 * @version $Revision$
 */
public class Oracle8DB extends BaseDB {

    /* Defines relative location of vendor-specific template configuration resource file. */
    private static final String TEMPLATE_FILE = "/org/netbeans/modules/sql/framework/codegen/oracle8/config/templates.xml";

    /* Reference to oracle8 operatordef info file. */
    private static final String ORACLE8_OPERATOR_DEFINITION_FILE = "org/netbeans/modules/sql/framework/codegen/oracle8/config/operator-script.xml";

    public Statements createStatements() {
        return new Oracle8Statements(this);
    }
    ...
    public TypeGenerator createTypeGenerator() {
        return new Oracle8TypeGenerator();
    }
    ...
    /**
     * Gets Operator factory for Oracle
     *
     * @return SQLOperatorFactory
     */
    public SQLOperatorFactory getOperatorFactory() {
        if (factory == null) {
            factory = new SQLOperatorFactory(ORACLE8_OPERATOR_DEFINITION_FILE, super.getOperatorFactory());
        }
        return factory;
    }

    public AbstractGeneratorFactory createGeneratorFactory() {
        return new Oracle8GeneratorFactory(this);
    }
