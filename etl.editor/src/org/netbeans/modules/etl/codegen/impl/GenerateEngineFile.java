...
//    
//    // Holds a map of unique IDs (OTD OID + port type [either "-Source" or "-Target"]) to
...
//    private Map otdNamePoolNameMap = new HashMap(2);
//
//
//    /**
...
//
//                    if (portType != null) {
//                    	qualOtdId = portType.getOID() + suffix ;
//                        this.otdNamePoolNameMap.put(qualOtdId, poolName);
...
//	        flowgen.applyConnectionDefinitions(connDefs, this.otdNamePoolNameMap, internalDBConfigParams);
