 ...
 * @version $Revision$
 */
public class ETLNodePropertiesAction extends SystemAction {

    private static final URL propertiesUrl = ETLNodePropertiesAction.class.getResource("/org/netbeans/modules/sql/framework/ui/resources/images/properties.png");
    private static transient final Logger mLogger = Logger.getLogger(ETLNodePropertiesAction.class.getName());
    private static transient final Localizer mLoc = Localizer.get();
    ETLDataObject mObj;
    
    public ETLNodePropertiesAction() {
        //action name
