            ...
            if (key == KEY_SOURCE_DIR) {
                ...
                for (int i = 0; i < sgs.length; i++) {
                    if (sgs [i].contains(srcRoot)) {
                        // TODO r
//                        xsltmapFile = srcRoot.getFileObject("xsltmap.xml");
...
//            if (p != null && xsltmapFile != null) {
//                Children children = new TransformationsChildren(p);
////                nodes.add(new XsltTransformationsNode(children));
//                DataObject dObj;
//
//                try {
//                    dObj = DataObject.find(xsltmapFile);
//                    if (dObj != null) {
//                        nodes.add(new XsltTransformationsNode2(dObj, children));
//                    }
//                } catch (DataObjectNotFoundException ex) {
//                }
//            }
            ...
            return nodes.toArray(new Node[nodes.size()]);//n == null ? new Node[0] : new Node[] {n};
        }
        ...
        private FileObject getXsltmapFO() {
            ...
            if (srcDir != null) {
                ...
                // TODO m
                return srcFO.getFileObject("xsltmap.xml");
            }
            return null;
        }
...
//            refreshKey(KEY_SOURCE_DIR);
    ...
    static final class NoFoldersDataFilter implements ChangeListener, ChangeableDataFilter {
        ...
        private boolean isXsltMapFile(FileObject fo) {
            if (fo == null) {
                return false;
            }
            ...
            // TODO m
            return "xsltmap.xml".equals(fo.getNameExt()) 
                        && srcFolder != null 
