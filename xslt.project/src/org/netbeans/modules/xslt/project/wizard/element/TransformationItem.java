...
public class TransformationItem {
    ...
    public TransformationItem(String name, String inputPartName, String outputPartName, String xslFilePath) {
        this.name = name;
        this.inputPartName = inputPartName;
        this.outputPartName = outputPartName;
    ...
    public void setOutputPartName(String outputPartName) {
        this.outputPartName = outputPartName;
    }
    ...
    public String toString() {
        return getName()+":: "+getInputPartName()+" -( "+getXslFilePath()+") -> "+getOutputPartName();
    }
