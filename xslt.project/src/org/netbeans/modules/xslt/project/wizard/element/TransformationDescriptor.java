...
public interface TransformationDescriptor {
    /**
     * @return the inPartName
     */
    public String getInPartName();

    /**
     * @param inPartName the inPartName to set
     */
    public void setInPartName(String inPartName);

    /**
     * @return the outPartName
     */
    public String getOutPartName();

    /**
     * @param outPartName the outPartName to set
     */
