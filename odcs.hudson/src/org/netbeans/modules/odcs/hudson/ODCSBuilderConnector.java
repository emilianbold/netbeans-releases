 ...
 * @author jhavlin
 */
public class ODCSBuilderConnector extends BuilderConnector {
    ...
    private static final Logger LOG = Logger.getLogger(
            ODCSBuilderConnector.class.getName());
    private ProjectHandle<ODCSProject> projectHandle;

    public ODCSBuilderConnector(ProjectHandle<ODCSProject> projectHandle) {
    ...
    private ODCSClient getClient() {
        return ODCSHudsonUtils.getClient(projectHandle);
    }
