...
public class BluePrint4SampleWizardIterator extends BluePrintSampleWizardIterator {
    ...
    protected String[] createSteps() {
      return new String[] { NbBundle.getMessage(BluePrintSampleWizardIterator.class, "MSG_CreateBPELBluePrint4Project") }; // NOI18N
    }
    
    protected WizardDescriptor.Panel[] createPanels() {
      return new WizardDescriptor.Panel[] { new BluePrintSampleWizardPanel(BluePrintSampleWizardIterator.BLUE_PRINT4) };
    }
