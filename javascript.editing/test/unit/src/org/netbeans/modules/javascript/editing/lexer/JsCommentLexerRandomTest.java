...
/**
 * @todo for now it tests only JavaDoc-like behavior (as it is copy of JavadocLexerRandomTest)
 *
 * @author mmetelka
 * @author Martin Adamek
 */
public class JsCommentLexerRandomTest extends TestCase {

    public JsCommentLexerRandomTest(String testName) {
        super(testName);
    }
    ...
    private void test(long seed) throws Exception {
        ...
        randomModify.setLanguage(JsCommentTokenId.language());
