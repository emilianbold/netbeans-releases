...
/**
 * Node action to hide all connections connecting a service engine
 * service unit widget.
 *
 * @author jqian
 */
public class HideServiceUnitConnectionsAction extends NodeAction {
    ...
    protected void performAction(Node[] activatedNodes) {
        if (activatedNodes.length > 0 && activatedNodes[0] instanceof ServiceUnitNode) {
            ...
            widget.setConnectionHidden(true);
    ...
    public String getName() {
        return NbBundle.getMessage(LoadWSDLPortsAction.class, "LBL_HideServiceUnitConnectionsAction_Name"); // NOI18N
    }
