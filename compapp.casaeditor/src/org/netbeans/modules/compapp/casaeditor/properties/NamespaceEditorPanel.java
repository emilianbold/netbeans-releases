...
implements ActionListener, ListSelectionListener, DocumentListener {
    ...
    public void setEditable(boolean namespaceEditable, boolean localNameEditable) {
        schemaNamespaceRadioButton.setEnabled(namespaceEditable);
        otherNamespaceRadioButton.setEnabled(namespaceEditable);
        uriList.setEnabled(namespaceEditable && uriList.isEnabled());
        prefixTextField.setEditable(namespaceEditable);
        otherNamespaceTextField.setEditable(namespaceEditable);
        
        localNameTextField.setEditable(localNameEditable);
    }
