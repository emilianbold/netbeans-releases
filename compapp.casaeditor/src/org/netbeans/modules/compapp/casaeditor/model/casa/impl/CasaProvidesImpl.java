 ...
 * @author jqian
 */
public class CasaProvidesImpl extends CasaEndpointRefImpl implements CasaProvides {

    public CasaProvidesImpl(CasaModel model, Element element) {
        super(model, element);
    }
    
    public CasaProvidesImpl(CasaModel model) {
        this(model, createElementNS(model, CasaQName.PROVIDES)); 
    }
