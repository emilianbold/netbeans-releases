 ...
 * @author jqian
 */
public class CasaConsumesImpl extends CasaEndpointRefImpl implements CasaConsumes {

    public CasaConsumesImpl(CasaModel model, Element element) {
        super(model, element);
    }
    
    public CasaConsumesImpl(CasaModel model) {
        this(model, createElementNS(model, CasaQName.CONSUMES)); 
    }
