 ...
 * @author jqian
 */
public class CasaBindingsImpl extends CasaLinksContainerImpl implements CasaBindings {

    public CasaBindingsImpl(CasaModel model, Element element) {
        super(model, element);
    }
    
    public CasaBindingsImpl(CasaModel model) {
        this(model, createElementNS(model, CasaQName.BINDINGS)); 
    }
