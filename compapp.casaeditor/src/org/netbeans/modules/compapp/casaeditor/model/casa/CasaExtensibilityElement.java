...
/**
 * Interface for CASA extensibility elements
 *
 * @author rico
 * @author Nam Nguyen
 */
public interface CasaExtensibilityElement extends CasaComponent {
     ...
     */
    interface UpdaterProvider extends CasaExtensibilityElement {
        /**
         * @return component updater to be used in merge operations when source sync happens.
         */
        <T extends CasaExtensibilityElement> ComponentUpdater<T> getComponentUpdater();
    }
    
    /**
     * Interface for an extensibility element that is a root of an embedded model.
     */
    interface EmbeddedModel extends CasaExtensibilityElement {
