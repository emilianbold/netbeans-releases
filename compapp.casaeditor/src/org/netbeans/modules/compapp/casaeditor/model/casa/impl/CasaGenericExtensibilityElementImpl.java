 ...
 * @author Nam Nguyen
 */
public class CasaGenericExtensibilityElementImpl extends CasaComponentImpl 
        implements CasaExtensibilityElement {
    
    /** Creates a new instance of CasaGenericExtensibilityElement */
    public CasaGenericExtensibilityElementImpl(CasaModel model, Element e) {
        super(model, e);
    }
    ...
    public void addAnyElement(CasaExtensibilityElement anyElement, int index) {
        List<CasaComponent> all = getChildren();
    ...
    public void removeAnyElement(CasaExtensibilityElement any) {
        super.removeExtensibilityElement(any);
    }

    public List<CasaExtensibilityElement> getAnyElements() {
        List<CasaExtensibilityElement> result = new ArrayList<CasaExtensibilityElement>();
        List<CasaExtensibilityElement> allEEs = super.getExtensibilityElements();
        for (CasaExtensibilityElement ee : allEEs) {
