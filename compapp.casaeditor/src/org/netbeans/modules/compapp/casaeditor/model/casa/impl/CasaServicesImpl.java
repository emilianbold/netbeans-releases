 ...
 * @author jqian
 */
public class CasaServicesImpl extends CasaLinksContainerImpl implements CasaServices {

    public CasaServicesImpl(CasaModel model, Element element) {
        super(model, element);
    }
    
    public CasaServicesImpl(CasaModel model) {
        this(model, createElementNS(model, CasaQName.SERVICES)); 
    }
