 ...
 * @author jqian
 */
public class CasaPortTypesImpl extends CasaLinksContainerImpl implements CasaPortTypes {

    public CasaPortTypesImpl(CasaModel model, Element element) {
        super(model, element);
    }
    
    public CasaPortTypesImpl(CasaModel model) {
        this(model, createElementNS(model, CasaQName.PORTTYPES)); 
    }
