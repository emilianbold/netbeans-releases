...
import org.netbeans.modules.odcs.ui.project.ProjectDetailsTopComponent;
...
public class OdcsSettings {
    ...
    public static final String AUTO_SYNC_SETTINGS_CHANGED = "odcs.auto_sync_changed"; //NOI18N

    private static OdcsSettings instance = null;
    private static final String AUTO_SYNC = "odcs.auto_sync"; //NOI18N
    private static final String AUTO_SYNC_VALUE = "odcs.auto_sync_value"; //NOI18N
    /*
    ...
    private OdcsSettings() {
    }

    public static OdcsSettings getInstance(){
        if (instance == null) {
            instance = new OdcsSettings();
        }
        return instance;
    }
    ...
    private Preferences getPreferences() {
        return NbPreferences.forModule(OdcsSettings.class);
    }
