...
import static org.netbeans.modules.odcs.ui.utils.Bundle.*;
...
public class Utils {
    ...
    public static final Icon EXPAND_ICON = ImageUtilities.loadImageIcon("org/netbeans/modules/odcs/ui/resources/arrow-down.png", true);
    public static final Icon COLLAPSE_ICON = ImageUtilities.loadImageIcon("org/netbeans/modules/odcs/ui/resources/arrow-up.png", true);
    private final static int VISIBLE_START_CHARS = 20;
    private static final Logger LOG = Logger.getLogger("ODCS ui"); // NOI18N
    ...
    public static void logException (ODCSException ex, boolean notifyInUI) {
        if (ex instanceof ODCSException.ODCSCanceledException) {
    ...
    public static RequestProcessor getRequestProcessor () {
        if (RP == null) {
            RP = new RequestProcessor("ODCS tasks", 1); //NOI18N
        }
        return RP;
    }
