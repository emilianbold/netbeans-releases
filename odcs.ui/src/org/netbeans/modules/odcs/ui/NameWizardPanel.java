 ...
 * @author Milan Kubec
 */
public class NameWizardPanel implements WizardDescriptor.Panel,
        WizardDescriptor.ValidatingPanel, WizardDescriptor.FinishablePanel {

    private NameWizardPanelGUI component;
    private WizardDescriptor settings;
    private final ChangeSupport changeSupport = new ChangeSupport(this);
    private final List<SharedItem> initialItems;
    private NewProjectWizardIterator iter;

    public NameWizardPanel (NewProjectWizardIterator iter, List<SharedItem> items) {
    ...
    public Component getComponent () {
        if (component == null) {
            component = new NameWizardPanelGUI(this);
        }
        return component;
    }
    ...
    public HelpCtx getHelp () {
        return new HelpCtx("org.netbeans.modules.odcs.ui.NameAndLicenseWizardPanel"); //NOI18N
    }
    ...
    void setServer (ODCSServer server) {
