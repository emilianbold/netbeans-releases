...
public class RefreshEjbGroupAction extends NodeAction {
    ...
    private void refresh( EjbGroup ejbGroup )
    {
        ...
        try {
            ...
            EjbLibReferenceHelper.updateArchiveRefs( OpenProjects.getDefault().getOpenProjects(), ejbGroup ); 
        }
            ...
            if( ex.getExceptionType() == EjbLoadException.SYSTEM_EXCEPTION )
                msg = NbBundle.getMessage( RefreshEjbGroupAction.class, "FAILED_TO_LOAD_EJBS", ejbGroup.getName() );
