...
public class SchemaNewType extends NewType {
    ...
    public void create() throws IOException {
        ...
        //Set the targetnamespace to wsdl's targetnamespace.
        //if there is already a schema, then do not set any targetnamespace.
        String tns = model.getDefinitions().getTargetNamespace();
        if (tns != null) {
            if (model.findSchemas(tns).isEmpty()) {
                schema.getSchemaModel().getSchema().setTargetNamespace(tns);
            }
        }
