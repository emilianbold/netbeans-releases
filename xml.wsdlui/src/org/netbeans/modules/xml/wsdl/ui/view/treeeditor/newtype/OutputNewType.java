...
public class OutputNewType extends NewType {
    
    private Operation mOperation = null;
    
    public OutputNewType(Operation operation) {
    ...
    public String getName() {
        return NbBundle.getMessage(OutputNewType.class, "LBL_NewType_OperationOutput");
    }
    ...
    public void create() throws IOException {
        ...
        ActionHelper.selectNode(output);
    }
}
