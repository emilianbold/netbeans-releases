...
public class NotificationOperationNewType extends NewType {
    private PortType mPortType = null;
    
    public NotificationOperationNewType(WSDLComponent message) {
    ...
    public String getName() {
        return NbBundle.getMessage(NotificationOperationNewType.class, "LBL_NewType_NotificationOperation");
    }
    ...
    public void create() throws IOException {
        ...
        Operation operation = model.getFactory().createNotificationOperation();
