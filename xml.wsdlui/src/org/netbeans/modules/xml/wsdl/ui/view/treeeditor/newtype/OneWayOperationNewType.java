...
public class OneWayOperationNewType extends NewType {
    private PortType mPortType = null;
    
    public OneWayOperationNewType(WSDLComponent message) {
    ...
    public String getName() {
        return NbBundle.getMessage(OneWayOperationNewType.class, "LBL_NewType_OneWayOperation");
    }
    ...
    public void create() throws IOException {
        ...
        Operation operation = model.getFactory().createOneWayOperation();
