...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-SUN.mk dist/SUN/SunStudio-Solaris-x86/dlight_simple_tests

dist/SUN/SunStudio-Solaris-x86/dlight_simple_tests: ${OBJECTFILES}
	${MKDIR} -p dist/SUN/SunStudio-Solaris-x86
...
.clean-conf:
	${RM} -r build/SUN
	${RM} dist/SUN/SunStudio-Solaris-x86/dlight_simple_tests
	${CCADMIN} -clean
