...
abstract class UIParameterBeanInfoBase extends HtmlBeanInfoBase {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.faces.dt_1_2.component.Bundle-JSF", Locale.getDefault(), UIParameterBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>UIParameterBeanInfoBase</code>.</p>
     */
    public UIParameterBeanInfoBase() {

        beanClass = javax.faces.component.UIParameter.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/faces/dt_1_2/component/UIParameter_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/faces/dt_1_2/component/UIParameter_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/faces/dt_1_2/component/UIParameter_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/faces/dt_1_2/component/UIParameter_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("UIParameter_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("UIParameter_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"parameter");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"parameter");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_attributes.setDisplayName(resources.getString("UIParameter_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("UIParameter_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("UIParameter_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("UIParameter_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("UIParameter_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("UIParameter_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("UIParameter_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("UIParameter_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("UIParameter_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("UIParameter_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("UIParameter_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("UIParameter_id_Description"));
            ...
            PropertyDescriptor prop_name = new PropertyDescriptorBase("name",beanClass,"getName","setName");
            prop_name.setDisplayName(resources.getString("UIParameter_name_DisplayName"));
            prop_name.setShortDescription(resources.getString("UIParameter_name_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("UIParameter_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("UIParameter_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("UIParameter_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("UIParameter_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("UIParameter_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("UIParameter_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("UIParameter_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("UIParameter_rendersChildren_Description"));
            ...
            prop_value.setDisplayName(resources.getString("UIParameter_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("UIParameter_value_Description"));
            ...
            propertyDescriptorList.add(prop_name);
