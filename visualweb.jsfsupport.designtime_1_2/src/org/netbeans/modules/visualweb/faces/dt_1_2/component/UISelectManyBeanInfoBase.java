...
abstract class UISelectManyBeanInfoBase extends HtmlBeanInfoBase {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.faces.dt_1_2.component.Bundle-JSF", Locale.getDefault(), UISelectManyBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>UISelectManyBeanInfoBase</code>.</p>
     */
    public UISelectManyBeanInfoBase() {

        beanClass = javax.faces.component.UISelectMany.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/faces/dt_1_2/component/UISelectMany_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/faces/dt_1_2/component/UISelectMany_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/faces/dt_1_2/component/UISelectMany_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/faces/dt_1_2/component/UISelectMany_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("UISelectMany_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("UISelectMany_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_jsfstd_multi_listbox");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"multiSelectListbox");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_propsheets_jsfstd_multi_listbox_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"selectManyListbox");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_attributes.setDisplayName(resources.getString("UISelectMany_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("UISelectMany_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("UISelectMany_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("UISelectMany_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("UISelectMany_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("UISelectMany_children_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("UISelectMany_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("UISelectMany_converter_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("UISelectMany_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("UISelectMany_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("UISelectMany_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("UISelectMany_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("UISelectMany_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("UISelectMany_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("UISelectMany_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("UISelectMany_immediate_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("UISelectMany_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("UISelectMany_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("UISelectMany_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("UISelectMany_localValueSet_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("UISelectMany_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("UISelectMany_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("UISelectMany_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("UISelectMany_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("UISelectMany_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("UISelectMany_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("UISelectMany_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("UISelectMany_rendersChildren_Description"));
            ...
            prop_required.setDisplayName(resources.getString("UISelectMany_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("UISelectMany_required_Description"));
            ...
            prop_selectedValues.setDisplayName(resources.getString("UISelectMany_selectedValues_DisplayName"));
            prop_selectedValues.setShortDescription(resources.getString("UISelectMany_selectedValues_Description"));
            ...
            prop_submittedValue.setDisplayName(resources.getString("UISelectMany_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("UISelectMany_submittedValue_Description"));
