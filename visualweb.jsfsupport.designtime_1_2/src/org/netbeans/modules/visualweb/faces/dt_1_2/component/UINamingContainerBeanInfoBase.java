...
abstract class UINamingContainerBeanInfoBase extends HtmlBeanInfoBase {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.faces.dt_1_2.component.Bundle-JSF", Locale.getDefault(), UINamingContainerBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>UINamingContainerBeanInfoBase</code>.</p>
     */
    public UINamingContainerBeanInfoBase() {

        beanClass = javax.faces.component.UINamingContainer.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/faces/dt_1_2/component/UINamingContainer_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/faces/dt_1_2/component/UINamingContainer_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/faces/dt_1_2/component/UINamingContainer_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/faces/dt_1_2/component/UINamingContainer_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("UINamingContainer_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("UINamingContainer_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"namingContainer");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"namingContainer");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_attributes.setDisplayName(resources.getString("UINamingContainer_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("UINamingContainer_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("UINamingContainer_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("UINamingContainer_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("UINamingContainer_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("UINamingContainer_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("UINamingContainer_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("UINamingContainer_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("UINamingContainer_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("UINamingContainer_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("UINamingContainer_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("UINamingContainer_id_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("UINamingContainer_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("UINamingContainer_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("UINamingContainer_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("UINamingContainer_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("UINamingContainer_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("UINamingContainer_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("UINamingContainer_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("UINamingContainer_rendersChildren_Description"));
