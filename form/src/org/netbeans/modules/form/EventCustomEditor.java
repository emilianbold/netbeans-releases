...
public class EventCustomEditor extends javax.swing.JPanel {
    ...
    public EventCustomEditor(EventProperty eventProperty) {
        ...
        addButton.setMnemonic(FormEditor.getFormBundle().getString("CTL_EE_ADD_Mnemonic").charAt(0));
        removeButton.setMnemonic(FormEditor.getFormBundle().getString("CTL_EE_REMOVE_Mnemonic").charAt(0));
        editButton.setMnemonic(FormEditor.getFormBundle().getString("CTL_EE_RENAME_Mnemonic").charAt(0));
        handlersListLabel.setDisplayedMnemonic(FormEditor.getFormBundle().getString("CTL_EE_Handlers_Mnemonic").charAt(0));

        handlersList.getAccessibleContext().setAccessibleDescription(FormEditor.getFormBundle().getString("ACSD_CTL_EE_Handlers"));
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        handlersListLabel.setText(FormEditor.getFormBundle().getString("CTL_EE_Handlers"));
        handlersListLabel.setLabelFor(handlersList);
        gridBagConstraints1 = new java.awt.GridBagConstraints();
        gridBagConstraints1.insets = new java.awt.Insets(12, 12, 2, 0);
        gridBagConstraints1.anchor = java.awt.GridBagConstraints.WEST;
        add(handlersListLabel, gridBagConstraints1);
        ...
        gridBagConstraints1.insets = new java.awt.Insets(0, 0, 5, 11);
        ...
        gridBagConstraints1.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints1.insets = new java.awt.Insets(0, 0, 0, 11);
        gridBagConstraints1.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints1.weightx = 0.1;
