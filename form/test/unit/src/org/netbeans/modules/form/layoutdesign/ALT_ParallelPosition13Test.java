...
public class ALT_ParallelPosition13Test extends LayoutTestCase {
    ...
    public ALT_ParallelPosition13Test(String name) {
        super(name);
        try {
    ...
    // Resize first button to align left with the toggle button (eliminate
