...
public class ALT_SeqResizing02Test extends LayoutTestCase {

    public ALT_SeqResizing02Test(String name) {
        super(name);
        try {
...
// > UPDATE CURRENT STATE
        ...
        compBounds.put("jPanel1", new Rectangle(26, 30, 100, 100));
        baselinePosition.put("jPanel1-100-100", new Integer(0));
        compBounds.put("jButton1", new Rectangle(317, 40, 73, 23));
        ...
        compBounds.put("jButton2", new Rectangle(317, 170, 73, 23));
...
// > START RESIZING
        ...
        compMinSize.put("jPanel2", new Dimension(0, 0));
        {
            ...
            Point hotspot = new Point(232, 155);
...
// > MOVE
        {
            Point p = new Point(238, 47);
            String containerId = "Form";
            boolean autoPositioning = true;
            boolean lockDimension = false;
            Rectangle[] bounds = new Rectangle[]{new Rectangle(180, 48, 100, 208)};
...
// > MOVE
        {
            Point p = new Point(238, 46);
            String containerId = "Form";
            boolean autoPositioning = true;
            boolean lockDimension = false;
            Rectangle[] bounds = new Rectangle[]{new Rectangle(180, 40, 100, 216)};
            ld.move(p, containerId, autoPositioning, lockDimension, bounds);
        }
// < MOVE
// > END MOVING
        prefPaddingInParent.put("Form-jPanel1-1-1", new Integer(11));
        // parentId-compId-dimension-compAlignment
        ...
        prefPadding.put("jPanel2-jButton1-0-0-0", new Integer(6));
        // comp1Id-comp2Id-dimension-comp2Alignment-paddingType
        ...
        prefPadding.put("jPanel2-jButton2-0-0-0", new Integer(6));
        // comp1Id-comp2Id-dimension-comp2Alignment-paddingType
        contInterior.put("jPanel2", new Rectangle(-32588, -32728, 100, 216));
        compBounds.put("jPanel2", new Rectangle(-32588, -32728, 100, 216));
        baselinePosition.put("jPanel2-100-216", new Integer(0));
        compMinSize.put("jPanel2", new Dimension(0, 0));
        compPrefSize.put("jPanel2", new Dimension(100, 100));
        hasExplicitPrefSize.put("jPanel2", new Boolean(false));
        hasExplicitPrefSize.put("jPanel2", new Boolean(false));
...
// > UPDATE CURRENT STATE
        ...
        baselinePosition.put("jButton2-73-23", new Integer(15));
        compPrefSize.put("jButton2", new Dimension(73, 23));
        compBounds.put("jPanel2", new Rectangle(180, 40, 100, 216));
        baselinePosition.put("jPanel2-100-216", new Integer(0));
        contInterior.put("jPanel2", new Rectangle(180, 40, 100, 216));
        compBounds.put("jPanel2", new Rectangle(180, 40, 100, 216));
        baselinePosition.put("jPanel2-100-216", new Integer(0));
        compMinSize.put("jPanel2", new Dimension(0, 0));
        compPrefSize.put("jPanel2", new Dimension(100, 216));
        hasExplicitPrefSize.put("jPanel2", new Boolean(false));
        hasExplicitPrefSize.put("jPanel2", new Boolean(false));
        contInterior.put("jPanel1", new Rectangle(26, 30, 100, 100));
        contInterior.put("Form", new Rectangle(0, 0, 400, 300));
