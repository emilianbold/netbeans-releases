 ...
 * Created on January 9, 2004, 1:05 PM
 */

/**
 * @authorWinston Prakash
 */
...
// This is here just to start/stop the error handler server
...
public class ErrorHandlerModuleInstaller extends ModuleInstall {
    ...
    public void restored() {
        if (debugServerThread == null) debugServerThread = new DebugServerThread();
        debugServerThread.start();
    }

    public void close() {
        if (debugServerThread != null) debugServerThread.stopServer();
    }
