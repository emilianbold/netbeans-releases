 ...
 * @author echou
 */
public class GlobalRarPaletteActions extends PaletteActions {
    ...
    */
    ...
    private static class DefaultPaletteItemAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (target == null) {
                String msg = NbBundle.getMessage(GlobalRarPaletteActions.class, "MSG_ErrorNoFocusedDocument");
            ...
            PaletteController pc = GlobalRarPaletteFactory.getPalette();
            pc.clearSelection();
        }
    }
}
