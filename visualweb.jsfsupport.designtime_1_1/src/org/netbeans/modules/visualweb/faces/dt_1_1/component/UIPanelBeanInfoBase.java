...
abstract class UIPanelBeanInfoBase extends HtmlBeanInfoBase {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.faces.dt_1_1.component.Bundle-JSF", Locale.getDefault(), UIPanelBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>UIPanelBeanInfoBase</code>.</p>
     */
    public UIPanelBeanInfoBase() {

        beanClass = javax.faces.component.UIPanel.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/faces/dt_1_1/component/UIPanel_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/faces/dt_1_1/component/UIPanel_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/faces/dt_1_1/component/UIPanel_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/faces/dt_1_1/component/UIPanel_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("UIPanel_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("UIPanel_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"panel");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"panel");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_attributes.setDisplayName(resources.getString("UIPanel_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("UIPanel_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("UIPanel_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("UIPanel_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("UIPanel_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("UIPanel_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("UIPanel_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("UIPanel_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("UIPanel_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("UIPanel_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("UIPanel_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("UIPanel_id_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("UIPanel_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("UIPanel_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("UIPanel_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("UIPanel_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("UIPanel_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("UIPanel_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("UIPanel_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("UIPanel_rendersChildren_Description"));
