...
import org.netbeans.modules.visualweb.faces.dt_1_1.component.UIMessageBeanInfoBase;


public class HtmlMessageBeanInfo extends UIMessageBeanInfoBase {

    protected static ResourceBundle resources =
            ResourceBundle.getBundle("org.netbeans.modules.visualweb.faces.dt_1_1.component.html.Bundle-JSF", Locale.getDefault(), HtmlMessageBeanInfo.class.getClassLoader());


    public HtmlMessageBeanInfo() {
        beanClass = javax.faces.component.html.HtmlMessage.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/faces/dt_1_1/component/html/HtmlMessage_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/faces/dt_1_1/component/html/HtmlMessage_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/faces/dt_1_1/component/html/HtmlMessage_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/faces/dt_1_1/component/html/HtmlMessage_M32";
    }
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("HtmlMessage_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("HtmlMessage_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_jsfstd_inline_message");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"inlineMessage");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.FALSE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_propsheets_jsfstd_inline_message_props");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_errorClass.setDisplayName(resources.getString("HtmlMessage_errorClass_DisplayName"));
            prop_errorClass.setShortDescription(resources.getString("HtmlMessage_errorClass_Description"));
            ...
            prop_errorStyle.setDisplayName(resources.getString("HtmlMessage_errorStyle_DisplayName"));
            prop_errorStyle.setShortDescription(resources.getString("HtmlMessage_errorStyle_Description"));
            ...
            prop_fatalClass.setDisplayName(resources.getString("HtmlMessage_fatalClass_DisplayName"));
            prop_fatalClass.setShortDescription(resources.getString("HtmlMessage_fatalClass_Description"));
            ...
            prop_fatalStyle.setDisplayName(resources.getString("HtmlMessage_fatalStyle_DisplayName"));
            prop_fatalStyle.setShortDescription(resources.getString("HtmlMessage_fatalStyle_Description"));
            ...
            prop_infoClass.setDisplayName(resources.getString("HtmlMessage_infoClass_DisplayName"));
            prop_infoClass.setShortDescription(resources.getString("HtmlMessage_infoClass_Description"));
            ...
            prop_infoStyle.setDisplayName(resources.getString("HtmlMessage_infoStyle_DisplayName"));
            prop_infoStyle.setShortDescription(resources.getString("HtmlMessage_infoStyle_Description"));
            ...
            prop_title.setDisplayName(resources.getString("HtmlMessage_title_DisplayName"));
            prop_title.setShortDescription(resources.getString("HtmlMessage_title_Description"));
            ...
            prop_tooltip.setDisplayName(resources.getString("HtmlMessage_tooltip_DisplayName"));
            prop_tooltip.setShortDescription(resources.getString("HtmlMessage_tooltip_Description"));
            ...
            prop_warnClass.setDisplayName(resources.getString("HtmlMessage_warnClass_DisplayName"));
            prop_warnClass.setShortDescription(resources.getString("HtmlMessage_warnClass_Description"));
            ...
            prop_warnStyle.setDisplayName(resources.getString("HtmlMessage_warnStyle_DisplayName"));
            prop_warnStyle.setShortDescription(resources.getString("HtmlMessage_warnStyle_Description"));
