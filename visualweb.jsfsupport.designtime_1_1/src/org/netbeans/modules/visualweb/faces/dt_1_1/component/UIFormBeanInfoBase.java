...
abstract class UIFormBeanInfoBase extends HtmlBeanInfoBase {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.faces.dt_1_1.component.Bundle-JSF", Locale.getDefault(), UIFormBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>UIFormBeanInfoBase</code>.</p>
     */
    public UIFormBeanInfoBase() {

        beanClass = javax.faces.component.UIForm.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/faces/dt_1_1/component/UIForm_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/faces/dt_1_1/component/UIForm_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/faces/dt_1_1/component/UIForm_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/faces/dt_1_1/component/UIForm_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("UIForm_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("UIForm_Description"));
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_attributes.setDisplayName(resources.getString("UIForm_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("UIForm_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("UIForm_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("UIForm_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("UIForm_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("UIForm_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("UIForm_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("UIForm_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("UIForm_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("UIForm_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("UIForm_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("UIForm_id_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("UIForm_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("UIForm_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("UIForm_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("UIForm_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("UIForm_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("UIForm_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("UIForm_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("UIForm_rendersChildren_Description"));
            ...
            prop_submitted.setDisplayName(resources.getString("UIForm_submitted_DisplayName"));
            prop_submitted.setShortDescription(resources.getString("UIForm_submitted_Description"));
            ...
            propertyDescriptorList.add(prop_submitted);
