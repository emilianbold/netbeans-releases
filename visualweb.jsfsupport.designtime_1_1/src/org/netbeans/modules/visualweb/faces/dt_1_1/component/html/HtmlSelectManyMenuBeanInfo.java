...
public class HtmlSelectManyMenuBeanInfo extends UIInputBeanInfoBase {

    protected static ResourceBundle resources =
            ResourceBundle.getBundle("org.netbeans.modules.visualweb.faces.dt_1_1.component.html.Bundle-JSF", Locale.getDefault(), HtmlSelectManyMenuBeanInfo.class.getClassLoader());


    public HtmlSelectManyMenuBeanInfo() {
        beanClass = javax.faces.component.html.HtmlSelectManyMenu.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/faces/dt_1_1/component/html/HtmlSelectManyMenu_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/faces/dt_1_1/component/html/HtmlSelectManyMenu_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/faces/dt_1_1/component/html/HtmlSelectManyMenu_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/faces/dt_1_1/component/html/HtmlSelectManyMenu_M32";
    }
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("HtmlSelectManyMenu_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("HtmlSelectManyMenu_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_jsfstd_multi-select_menu");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"menu");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_propsheets_jsfstd_multi-select_menu_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"selectManyMenu");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_accesskey.setDisplayName(resources.getString("HtmlSelectManyMenu_accesskey_DisplayName"));
            prop_accesskey.setShortDescription(resources.getString("HtmlSelectManyMenu_accesskey_Description"));
            ...
            prop_dir.setDisplayName(resources.getString("HtmlSelectManyMenu_dir_DisplayName"));
            prop_dir.setShortDescription(resources.getString("HtmlSelectManyMenu_dir_Description"));
            ...
            prop_disabled.setDisplayName(resources.getString("HtmlSelectManyMenu_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("HtmlSelectManyMenu_disabled_Description"));
            ...
            prop_disabledClass.setDisplayName(resources.getString("HtmlSelectManyMenu_disabledClass_DisplayName"));
            prop_disabledClass.setShortDescription(resources.getString("HtmlSelectManyMenu_disabledClass_Description"));
            ...
            prop_disabledClass.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.GENERAL);

            PropertyDescriptor prop_enabledClass = new PropertyDescriptorBase("enabledClass",beanClass,"getEnabledClass","setEnabledClass");
            prop_enabledClass.setDisplayName(resources.getString("HtmlSelectManyMenu_enabledClass_DisplayName"));
            prop_enabledClass.setShortDescription(resources.getString("HtmlSelectManyMenu_enabledClass_Description"));
            ...
            prop_enabledClass.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.GENERAL);

            PropertyDescriptor prop_lang = new PropertyDescriptorBase("lang",beanClass,"getLang","setLang");
            prop_lang.setDisplayName(resources.getString("HtmlSelectManyMenu_lang_DisplayName"));
            prop_lang.setShortDescription(resources.getString("HtmlSelectManyMenu_lang_Description"));
            ...
            prop_readonly.setDisplayName(resources.getString("HtmlSelectManyMenu_readonly_DisplayName"));
            prop_readonly.setShortDescription(resources.getString("HtmlSelectManyMenu_readonly_Description"));
            ...
            prop_selectedValues.setDisplayName(resources.getString("HtmlSelectManyMenu_selectedValues_DisplayName"));
            prop_selectedValues.setShortDescription(resources.getString("HtmlSelectManyMenu_selectedValues_Description"));
            ...
            prop_title.setDisplayName(resources.getString("HtmlSelectManyMenu_title_DisplayName"));
            prop_title.setShortDescription(resources.getString("HtmlSelectManyMenu_title_Description"));
