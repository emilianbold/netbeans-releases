...
public class ImgBeanInfo extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.xhtml.Bundle-JSF", Locale.getDefault(), ImgBeanInfo.class.getClassLoader());

    /**
     * <p>Construct a new <code>ImgBeanInfo</code>.</p>
     */
    public ImgBeanInfo() {

        beanClass = org.netbeans.modules.visualweb.xhtml.Img.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/xhtml/Img_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/xhtml/Img_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/xhtml/Img_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/xhtml/Img_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("Img_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("Img_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_html_elements_img");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"img");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.FALSE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_propsheets_html_img_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"img");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_alt.setDisplayName(resources.getString("Img_alt_DisplayName"));
            prop_alt.setShortDescription(resources.getString("Img_alt_Description"));
            ...
            prop_dir.setDisplayName(resources.getString("Img_dir_DisplayName"));
            prop_dir.setShortDescription(resources.getString("Img_dir_Description"));
            ...
            prop_height.setDisplayName(resources.getString("Img_height_DisplayName"));
            prop_height.setShortDescription(resources.getString("Img_height_Description"));
            ...
            prop_id.setDisplayName(resources.getString("Img_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("Img_id_Description"));
            ...
            prop_lang.setDisplayName(resources.getString("Img_lang_DisplayName"));
            prop_lang.setShortDescription(resources.getString("Img_lang_Description"));
            ...
            prop_longdesc.setDisplayName(resources.getString("Img_longdesc_DisplayName"));
            prop_longdesc.setShortDescription(resources.getString("Img_longdesc_Description"));
            ...
            prop_onclick.setDisplayName(resources.getString("Img_onclick_DisplayName"));
            prop_onclick.setShortDescription(resources.getString("Img_onclick_Description"));
            ...
            prop_ondblclick.setDisplayName(resources.getString("Img_ondblclick_DisplayName"));
            prop_ondblclick.setShortDescription(resources.getString("Img_ondblclick_Description"));
            ...
            prop_onkeydown.setDisplayName(resources.getString("Img_onkeydown_DisplayName"));
            prop_onkeydown.setShortDescription(resources.getString("Img_onkeydown_Description"));
            ...
            prop_onkeypress.setDisplayName(resources.getString("Img_onkeypress_DisplayName"));
            prop_onkeypress.setShortDescription(resources.getString("Img_onkeypress_Description"));
            ...
            prop_onkeyup.setDisplayName(resources.getString("Img_onkeyup_DisplayName"));
            prop_onkeyup.setShortDescription(resources.getString("Img_onkeyup_Description"));
            ...
            prop_onmousedown.setDisplayName(resources.getString("Img_onmousedown_DisplayName"));
            prop_onmousedown.setShortDescription(resources.getString("Img_onmousedown_Description"));
            ...
            prop_onmousemove.setDisplayName(resources.getString("Img_onmousemove_DisplayName"));
            prop_onmousemove.setShortDescription(resources.getString("Img_onmousemove_Description"));
            ...
            prop_onmouseout.setDisplayName(resources.getString("Img_onmouseout_DisplayName"));
            prop_onmouseout.setShortDescription(resources.getString("Img_onmouseout_Description"));
            ...
            prop_onmouseover.setDisplayName(resources.getString("Img_onmouseover_DisplayName"));
            prop_onmouseover.setShortDescription(resources.getString("Img_onmouseover_Description"));
            ...
            prop_onmouseup.setDisplayName(resources.getString("Img_onmouseup_DisplayName"));
            prop_onmouseup.setShortDescription(resources.getString("Img_onmouseup_Description"));
            ...
            prop_src.setDisplayName(resources.getString("Img_src_DisplayName"));
            prop_src.setShortDescription(resources.getString("Img_src_Description"));
            ...
            prop_style.setDisplayName(resources.getString("Img_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("Img_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("Img_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("Img_styleClass_Description"));
            ...
            prop_title.setDisplayName(resources.getString("Img_title_DisplayName"));
            prop_title.setShortDescription(resources.getString("Img_title_Description"));
            ...
            prop_width.setDisplayName(resources.getString("Img_width_DisplayName"));
            prop_width.setShortDescription(resources.getString("Img_width_Description"));
            ...
            prop_xmlLang.setDisplayName(resources.getString("Img_xmlLang_DisplayName"));
            prop_xmlLang.setShortDescription(resources.getString("Img_xmlLang_Description"));
