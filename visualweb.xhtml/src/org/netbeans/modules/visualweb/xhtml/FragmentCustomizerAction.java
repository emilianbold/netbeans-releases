...
public class FragmentCustomizerAction extends BasicDisplayAction {
    ...
    public FragmentCustomizerAction(DesignBean bean) {
        super(NbBundle.getMessage(FragmentCustomizerAction.class, "fragmentCustTitleEllipse")); //NOI18N
    ...
    public Result invoke() {
        return new CustomizerResult(bean, new FragmentCustomizer("file"));
    }
}
