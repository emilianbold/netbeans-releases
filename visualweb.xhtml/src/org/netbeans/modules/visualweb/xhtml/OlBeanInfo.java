...
public class OlBeanInfo extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.xhtml.Bundle-JSF", Locale.getDefault(), OlBeanInfo.class.getClassLoader());

    /**
     * <p>Construct a new <code>OlBeanInfo</code>.</p>
     */
    public OlBeanInfo() {

        beanClass = org.netbeans.modules.visualweb.xhtml.Ol.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/xhtml/Ol_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/xhtml/Ol_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/xhtml/Ol_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/xhtml/Ol_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("Ol_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("Ol_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_html_elements_ol");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"ol");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_propsheets_html_ol_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"ol");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_compact.setDisplayName(resources.getString("Ol_compact_DisplayName"));
            prop_compact.setShortDescription(resources.getString("Ol_compact_Description"));
            ...
            prop_dir.setDisplayName(resources.getString("Ol_dir_DisplayName"));
            prop_dir.setShortDescription(resources.getString("Ol_dir_Description"));
            ...
            prop_id.setDisplayName(resources.getString("Ol_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("Ol_id_Description"));
            ...
            prop_lang.setDisplayName(resources.getString("Ol_lang_DisplayName"));
            prop_lang.setShortDescription(resources.getString("Ol_lang_Description"));
            ...
            prop_onclick.setDisplayName(resources.getString("Ol_onclick_DisplayName"));
            prop_onclick.setShortDescription(resources.getString("Ol_onclick_Description"));
            ...
            prop_ondblclick.setDisplayName(resources.getString("Ol_ondblclick_DisplayName"));
            prop_ondblclick.setShortDescription(resources.getString("Ol_ondblclick_Description"));
            ...
            prop_onkeydown.setDisplayName(resources.getString("Ol_onkeydown_DisplayName"));
            prop_onkeydown.setShortDescription(resources.getString("Ol_onkeydown_Description"));
            ...
            prop_onkeypress.setDisplayName(resources.getString("Ol_onkeypress_DisplayName"));
            prop_onkeypress.setShortDescription(resources.getString("Ol_onkeypress_Description"));
            ...
            prop_onkeyup.setDisplayName(resources.getString("Ol_onkeyup_DisplayName"));
            prop_onkeyup.setShortDescription(resources.getString("Ol_onkeyup_Description"));
            ...
            prop_onmousedown.setDisplayName(resources.getString("Ol_onmousedown_DisplayName"));
            prop_onmousedown.setShortDescription(resources.getString("Ol_onmousedown_Description"));
            ...
            prop_onmousemove.setDisplayName(resources.getString("Ol_onmousemove_DisplayName"));
            prop_onmousemove.setShortDescription(resources.getString("Ol_onmousemove_Description"));
            ...
            prop_onmouseout.setDisplayName(resources.getString("Ol_onmouseout_DisplayName"));
            prop_onmouseout.setShortDescription(resources.getString("Ol_onmouseout_Description"));
            ...
            prop_onmouseover.setDisplayName(resources.getString("Ol_onmouseover_DisplayName"));
            prop_onmouseover.setShortDescription(resources.getString("Ol_onmouseover_Description"));
            ...
            prop_onmouseup.setDisplayName(resources.getString("Ol_onmouseup_DisplayName"));
            prop_onmouseup.setShortDescription(resources.getString("Ol_onmouseup_Description"));
            ...
            PropertyDescriptor prop_start = new PropertyDescriptor("start",beanClass,"getStart","setStart");
            prop_start.setDisplayName(resources.getString("Ol_start_DisplayName"));
            prop_start.setShortDescription(resources.getString("Ol_start_Description"));
            prop_start.setExpert(false);
            prop_start.setHidden(false);
            prop_start.setPreferred(false);
            attrib = new AttributeDescriptor("start",false,null,true);
            prop_start.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_start.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.GENERAL);

            PropertyDescriptor prop_style = new PropertyDescriptor("style",beanClass,"getStyle","setStyle");
            prop_style.setDisplayName(resources.getString("Ol_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("Ol_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("Ol_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("Ol_styleClass_Description"));
            ...
            prop_title.setDisplayName(resources.getString("Ol_title_DisplayName"));
            prop_title.setShortDescription(resources.getString("Ol_title_Description"));
            ...
            prop_type.setDisplayName(resources.getString("Ol_type_DisplayName"));
            prop_type.setShortDescription(resources.getString("Ol_type_Description"));
            ...
            prop_xmlLang.setDisplayName(resources.getString("Ol_xmlLang_DisplayName"));
            prop_xmlLang.setShortDescription(resources.getString("Ol_xmlLang_Description"));
