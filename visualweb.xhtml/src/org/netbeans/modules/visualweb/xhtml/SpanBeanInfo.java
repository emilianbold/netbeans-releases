...
public class SpanBeanInfo extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.xhtml.Bundle-JSF", Locale.getDefault(), SpanBeanInfo.class.getClassLoader());

    /**
     * <p>Construct a new <code>SpanBeanInfo</code>.</p>
     */
    public SpanBeanInfo() {

        beanClass = org.netbeans.modules.visualweb.xhtml.Span.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/xhtml/Span_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/xhtml/Span_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/xhtml/Span_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/xhtml/Span_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("Span_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("Span_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_html_elements_span");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"span");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_propsheets_html_span_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"span");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_dir.setDisplayName(resources.getString("Span_dir_DisplayName"));
            prop_dir.setShortDescription(resources.getString("Span_dir_Description"));
            ...
            prop_id.setDisplayName(resources.getString("Span_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("Span_id_Description"));
            ...
            prop_lang.setDisplayName(resources.getString("Span_lang_DisplayName"));
            prop_lang.setShortDescription(resources.getString("Span_lang_Description"));
            ...
            prop_onclick.setDisplayName(resources.getString("Span_onclick_DisplayName"));
            prop_onclick.setShortDescription(resources.getString("Span_onclick_Description"));
            ...
            prop_ondblclick.setDisplayName(resources.getString("Span_ondblclick_DisplayName"));
            prop_ondblclick.setShortDescription(resources.getString("Span_ondblclick_Description"));
            ...
            prop_onkeydown.setDisplayName(resources.getString("Span_onkeydown_DisplayName"));
            prop_onkeydown.setShortDescription(resources.getString("Span_onkeydown_Description"));
            ...
            prop_onkeypress.setDisplayName(resources.getString("Span_onkeypress_DisplayName"));
            prop_onkeypress.setShortDescription(resources.getString("Span_onkeypress_Description"));
            ...
            prop_onkeyup.setDisplayName(resources.getString("Span_onkeyup_DisplayName"));
            prop_onkeyup.setShortDescription(resources.getString("Span_onkeyup_Description"));
            ...
            prop_onmousedown.setDisplayName(resources.getString("Span_onmousedown_DisplayName"));
            prop_onmousedown.setShortDescription(resources.getString("Span_onmousedown_Description"));
            ...
            prop_onmousemove.setDisplayName(resources.getString("Span_onmousemove_DisplayName"));
            prop_onmousemove.setShortDescription(resources.getString("Span_onmousemove_Description"));
            ...
            prop_onmouseout.setDisplayName(resources.getString("Span_onmouseout_DisplayName"));
            prop_onmouseout.setShortDescription(resources.getString("Span_onmouseout_Description"));
            ...
            prop_onmouseover.setDisplayName(resources.getString("Span_onmouseover_DisplayName"));
            prop_onmouseover.setShortDescription(resources.getString("Span_onmouseover_Description"));
            ...
            prop_onmouseup.setDisplayName(resources.getString("Span_onmouseup_DisplayName"));
            prop_onmouseup.setShortDescription(resources.getString("Span_onmouseup_Description"));
            ...
            prop_style.setDisplayName(resources.getString("Span_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("Span_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("Span_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("Span_styleClass_Description"));
            ...
            prop_title.setDisplayName(resources.getString("Span_title_DisplayName"));
            prop_title.setShortDescription(resources.getString("Span_title_Description"));
            ...
            prop_xmlLang.setDisplayName(resources.getString("Span_xmlLang_DisplayName"));
            prop_xmlLang.setShortDescription(resources.getString("Span_xmlLang_Description"));
