...
public class PBeanInfo extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.xhtml.Bundle-JSF", Locale.getDefault(), PBeanInfo.class.getClassLoader());

    /**
     * <p>Construct a new <code>PBeanInfo</code>.</p>
     */
    public PBeanInfo() {

        beanClass = org.netbeans.modules.visualweb.xhtml.P.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/xhtml/P_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/xhtml/P_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/xhtml/P_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/xhtml/P_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("P_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("P_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_html_elements_p");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"p");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_propsheets_html_p_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"p");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_align.setDisplayName(resources.getString("P_align_DisplayName"));
            prop_align.setShortDescription(resources.getString("P_align_Description"));
            ...
            prop_dir.setDisplayName(resources.getString("P_dir_DisplayName"));
            prop_dir.setShortDescription(resources.getString("P_dir_Description"));
            ...
            prop_id.setDisplayName(resources.getString("P_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("P_id_Description"));
            ...
            prop_lang.setDisplayName(resources.getString("P_lang_DisplayName"));
            prop_lang.setShortDescription(resources.getString("P_lang_Description"));
            ...
            prop_onclick.setDisplayName(resources.getString("P_onclick_DisplayName"));
            prop_onclick.setShortDescription(resources.getString("P_onclick_Description"));
            ...
            prop_ondblclick.setDisplayName(resources.getString("P_ondblclick_DisplayName"));
            prop_ondblclick.setShortDescription(resources.getString("P_ondblclick_Description"));
            ...
            prop_onkeydown.setDisplayName(resources.getString("P_onkeydown_DisplayName"));
            prop_onkeydown.setShortDescription(resources.getString("P_onkeydown_Description"));
            ...
            prop_onkeypress.setDisplayName(resources.getString("P_onkeypress_DisplayName"));
            prop_onkeypress.setShortDescription(resources.getString("P_onkeypress_Description"));
            ...
            prop_onkeyup.setDisplayName(resources.getString("P_onkeyup_DisplayName"));
            prop_onkeyup.setShortDescription(resources.getString("P_onkeyup_Description"));
            ...
            prop_onmousedown.setDisplayName(resources.getString("P_onmousedown_DisplayName"));
            prop_onmousedown.setShortDescription(resources.getString("P_onmousedown_Description"));
            ...
            prop_onmousemove.setDisplayName(resources.getString("P_onmousemove_DisplayName"));
            prop_onmousemove.setShortDescription(resources.getString("P_onmousemove_Description"));
            ...
            prop_onmouseout.setDisplayName(resources.getString("P_onmouseout_DisplayName"));
            prop_onmouseout.setShortDescription(resources.getString("P_onmouseout_Description"));
            ...
            prop_onmouseover.setDisplayName(resources.getString("P_onmouseover_DisplayName"));
            prop_onmouseover.setShortDescription(resources.getString("P_onmouseover_Description"));
            ...
            prop_onmouseup.setDisplayName(resources.getString("P_onmouseup_DisplayName"));
            prop_onmouseup.setShortDescription(resources.getString("P_onmouseup_Description"));
            ...
            prop_style.setDisplayName(resources.getString("P_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("P_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("P_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("P_styleClass_Description"));
            ...
            prop_title.setDisplayName(resources.getString("P_title_DisplayName"));
            prop_title.setShortDescription(resources.getString("P_title_Description"));
            ...
            prop_xmlLang.setDisplayName(resources.getString("P_xmlLang_DisplayName"));
            prop_xmlLang.setShortDescription(resources.getString("P_xmlLang_Description"));
