...
public class H2BeanInfo extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.xhtml.Bundle-JSF", Locale.getDefault(), H2BeanInfo.class.getClassLoader());

    /**
     * <p>Construct a new <code>H2BeanInfo</code>.</p>
     */
    public H2BeanInfo() {

        beanClass = org.netbeans.modules.visualweb.xhtml.H2.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/xhtml/H2_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/xhtml/H2_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/xhtml/H2_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/xhtml/H2_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("H2_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("H2_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_html_elements_h2");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"h2");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_propsheets_html_h2_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"h2");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_align.setDisplayName(resources.getString("H2_align_DisplayName"));
            prop_align.setShortDescription(resources.getString("H2_align_Description"));
            ...
            prop_dir.setDisplayName(resources.getString("H2_dir_DisplayName"));
            prop_dir.setShortDescription(resources.getString("H2_dir_Description"));
            ...
            prop_id.setDisplayName(resources.getString("H2_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("H2_id_Description"));
            ...
            prop_lang.setDisplayName(resources.getString("H2_lang_DisplayName"));
            prop_lang.setShortDescription(resources.getString("H2_lang_Description"));
            ...
            prop_onclick.setDisplayName(resources.getString("H2_onclick_DisplayName"));
            prop_onclick.setShortDescription(resources.getString("H2_onclick_Description"));
            ...
            prop_ondblclick.setDisplayName(resources.getString("H2_ondblclick_DisplayName"));
            prop_ondblclick.setShortDescription(resources.getString("H2_ondblclick_Description"));
            ...
            prop_onkeydown.setDisplayName(resources.getString("H2_onkeydown_DisplayName"));
            prop_onkeydown.setShortDescription(resources.getString("H2_onkeydown_Description"));
            ...
            prop_onkeypress.setDisplayName(resources.getString("H2_onkeypress_DisplayName"));
            prop_onkeypress.setShortDescription(resources.getString("H2_onkeypress_Description"));
            ...
            prop_onkeyup.setDisplayName(resources.getString("H2_onkeyup_DisplayName"));
            prop_onkeyup.setShortDescription(resources.getString("H2_onkeyup_Description"));
            ...
            prop_onmousedown.setDisplayName(resources.getString("H2_onmousedown_DisplayName"));
            prop_onmousedown.setShortDescription(resources.getString("H2_onmousedown_Description"));
            ...
            prop_onmousemove.setDisplayName(resources.getString("H2_onmousemove_DisplayName"));
            prop_onmousemove.setShortDescription(resources.getString("H2_onmousemove_Description"));
            ...
            prop_onmouseout.setDisplayName(resources.getString("H2_onmouseout_DisplayName"));
            prop_onmouseout.setShortDescription(resources.getString("H2_onmouseout_Description"));
            ...
            prop_onmouseover.setDisplayName(resources.getString("H2_onmouseover_DisplayName"));
            prop_onmouseover.setShortDescription(resources.getString("H2_onmouseover_Description"));
            ...
            prop_onmouseup.setDisplayName(resources.getString("H2_onmouseup_DisplayName"));
            prop_onmouseup.setShortDescription(resources.getString("H2_onmouseup_Description"));
            ...
            prop_style.setDisplayName(resources.getString("H2_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("H2_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("H2_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("H2_styleClass_Description"));
            ...
            prop_title.setDisplayName(resources.getString("H2_title_DisplayName"));
            prop_title.setShortDescription(resources.getString("H2_title_Description"));
            ...
            prop_xmlLang.setDisplayName(resources.getString("H2_xmlLang_DisplayName"));
            prop_xmlLang.setShortDescription(resources.getString("H2_xmlLang_Description"));
