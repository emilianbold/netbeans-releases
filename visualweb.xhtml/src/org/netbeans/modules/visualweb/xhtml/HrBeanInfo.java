...
public class HrBeanInfo extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.xhtml.Bundle-JSF", Locale.getDefault(), HrBeanInfo.class.getClassLoader());

    /**
     * <p>Construct a new <code>HrBeanInfo</code>.</p>
     */
    public HrBeanInfo() {

        beanClass = org.netbeans.modules.visualweb.xhtml.Hr.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/xhtml/Hr_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/xhtml/Hr_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/xhtml/Hr_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/xhtml/Hr_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("Hr_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("Hr_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_html_elements_hr");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"hr");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.FALSE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_propsheets_html_hr_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"hr");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_align.setDisplayName(resources.getString("Hr_align_DisplayName"));
            prop_align.setShortDescription(resources.getString("Hr_align_Description"));
            ...
            prop_dir.setDisplayName(resources.getString("Hr_dir_DisplayName"));
            prop_dir.setShortDescription(resources.getString("Hr_dir_Description"));
            ...
            prop_id.setDisplayName(resources.getString("Hr_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("Hr_id_Description"));
            ...
            prop_lang.setDisplayName(resources.getString("Hr_lang_DisplayName"));
            prop_lang.setShortDescription(resources.getString("Hr_lang_Description"));
            ...
            PropertyDescriptor prop_noshade = new PropertyDescriptor("noshade",beanClass,"getNoshade","setNoshade");
            prop_noshade.setDisplayName(resources.getString("Hr_noshade_DisplayName"));
            prop_noshade.setShortDescription(resources.getString("Hr_noshade_Description"));
            prop_noshade.setExpert(false);
            prop_noshade.setHidden(false);
            prop_noshade.setPreferred(false);
            attrib = new AttributeDescriptor("noshade",false,null,true);
            prop_noshade.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_noshade.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.APPEARANCE);

            PropertyDescriptor prop_noshade_boolean = new PropertyDescriptor("noshade_boolean",beanClass,"getNoshade_boolean","setNoshade_boolean");
            prop_noshade_boolean.setDisplayName(resources.getString("Hr_noshade_boolean_DisplayName"));
            prop_noshade_boolean.setShortDescription(resources.getString("Hr_noshade_boolean_Description"));
            prop_noshade_boolean.setExpert(false);
            prop_noshade_boolean.setHidden(false);
            prop_noshade_boolean.setPreferred(false);
            attrib = new AttributeDescriptor("noshade_boolean",false,null,true);
            prop_noshade_boolean.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_noshade_boolean.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.APPEARANCE);

            PropertyDescriptor prop_onclick = new PropertyDescriptor("onclick",beanClass,"getOnclick","setOnclick");
            prop_onclick.setDisplayName(resources.getString("Hr_onclick_DisplayName"));
            prop_onclick.setShortDescription(resources.getString("Hr_onclick_Description"));
            ...
            prop_ondblclick.setDisplayName(resources.getString("Hr_ondblclick_DisplayName"));
            prop_ondblclick.setShortDescription(resources.getString("Hr_ondblclick_Description"));
            ...
            prop_onkeydown.setDisplayName(resources.getString("Hr_onkeydown_DisplayName"));
            prop_onkeydown.setShortDescription(resources.getString("Hr_onkeydown_Description"));
            ...
            prop_onkeypress.setDisplayName(resources.getString("Hr_onkeypress_DisplayName"));
            prop_onkeypress.setShortDescription(resources.getString("Hr_onkeypress_Description"));
            ...
            prop_onkeyup.setDisplayName(resources.getString("Hr_onkeyup_DisplayName"));
            prop_onkeyup.setShortDescription(resources.getString("Hr_onkeyup_Description"));
            ...
            prop_onmousedown.setDisplayName(resources.getString("Hr_onmousedown_DisplayName"));
            prop_onmousedown.setShortDescription(resources.getString("Hr_onmousedown_Description"));
            ...
            prop_onmousemove.setDisplayName(resources.getString("Hr_onmousemove_DisplayName"));
            prop_onmousemove.setShortDescription(resources.getString("Hr_onmousemove_Description"));
            ...
            prop_onmouseout.setDisplayName(resources.getString("Hr_onmouseout_DisplayName"));
            prop_onmouseout.setShortDescription(resources.getString("Hr_onmouseout_Description"));
            ...
            prop_onmouseover.setDisplayName(resources.getString("Hr_onmouseover_DisplayName"));
            prop_onmouseover.setShortDescription(resources.getString("Hr_onmouseover_Description"));
            ...
            prop_onmouseup.setDisplayName(resources.getString("Hr_onmouseup_DisplayName"));
            prop_onmouseup.setShortDescription(resources.getString("Hr_onmouseup_Description"));
            ...
            prop_size.setDisplayName(resources.getString("Hr_size_DisplayName"));
            prop_size.setShortDescription(resources.getString("Hr_size_Description"));
            ...
            prop_size.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.ADVANCED);
            prop_size.setValue("minValue", new Integer(0));
            prop_size.setValue("unsetValue", new Integer(Integer.MIN_VALUE));

            PropertyDescriptor prop_style = new PropertyDescriptor("style",beanClass,"getStyle","setStyle");
            prop_style.setDisplayName(resources.getString("Hr_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("Hr_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("Hr_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("Hr_styleClass_Description"));
            ...
            prop_title.setDisplayName(resources.getString("Hr_title_DisplayName"));
            prop_title.setShortDescription(resources.getString("Hr_title_Description"));
            ...
            prop_width.setDisplayName(resources.getString("Hr_width_DisplayName"));
            prop_width.setShortDescription(resources.getString("Hr_width_Description"));
            ...
            prop_xmlLang.setDisplayName(resources.getString("Hr_xmlLang_DisplayName"));
            prop_xmlLang.setShortDescription(resources.getString("Hr_xmlLang_Description"));
