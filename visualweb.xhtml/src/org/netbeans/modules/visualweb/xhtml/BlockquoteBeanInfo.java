...
public class BlockquoteBeanInfo extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.xhtml.Bundle-JSF", Locale.getDefault(), BlockquoteBeanInfo.class.getClassLoader());

    /**
     * <p>Construct a new <code>BlockquoteBeanInfo</code>.</p>
     */
    public BlockquoteBeanInfo() {

        beanClass = org.netbeans.modules.visualweb.xhtml.Blockquote.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/xhtml/Blockquote_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/xhtml/Blockquote_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/xhtml/Blockquote_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/xhtml/Blockquote_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("Blockquote_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("Blockquote_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_html_elements_blockquote");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"blockquote");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_propsheets_html_blockquote_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"blockquote");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            PropertyDescriptor prop_cite = new PropertyDescriptor("cite",beanClass,"getCite","setCite");
            prop_cite.setDisplayName(resources.getString("Blockquote_cite_DisplayName"));
            prop_cite.setShortDescription(resources.getString("Blockquote_cite_Description"));
            prop_cite.setExpert(false);
            prop_cite.setHidden(false);
            prop_cite.setPreferred(false);
            attrib = new AttributeDescriptor("cite",false,null,true);
            prop_cite.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_cite.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.GENERAL);

            PropertyDescriptor prop_dir = new PropertyDescriptor("dir",beanClass,"getDir","setDir");
            prop_dir.setDisplayName(resources.getString("Blockquote_dir_DisplayName"));
            prop_dir.setShortDescription(resources.getString("Blockquote_dir_Description"));
            ...
            prop_id.setDisplayName(resources.getString("Blockquote_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("Blockquote_id_Description"));
            ...
            prop_lang.setDisplayName(resources.getString("Blockquote_lang_DisplayName"));
            prop_lang.setShortDescription(resources.getString("Blockquote_lang_Description"));
            ...
            prop_onclick.setDisplayName(resources.getString("Blockquote_onclick_DisplayName"));
            prop_onclick.setShortDescription(resources.getString("Blockquote_onclick_Description"));
            ...
            prop_ondblclick.setDisplayName(resources.getString("Blockquote_ondblclick_DisplayName"));
            prop_ondblclick.setShortDescription(resources.getString("Blockquote_ondblclick_Description"));
            ...
            prop_onkeydown.setDisplayName(resources.getString("Blockquote_onkeydown_DisplayName"));
            prop_onkeydown.setShortDescription(resources.getString("Blockquote_onkeydown_Description"));
            ...
            prop_onkeypress.setDisplayName(resources.getString("Blockquote_onkeypress_DisplayName"));
            prop_onkeypress.setShortDescription(resources.getString("Blockquote_onkeypress_Description"));
            ...
            prop_onkeyup.setDisplayName(resources.getString("Blockquote_onkeyup_DisplayName"));
            prop_onkeyup.setShortDescription(resources.getString("Blockquote_onkeyup_Description"));
            ...
            prop_onmousedown.setDisplayName(resources.getString("Blockquote_onmousedown_DisplayName"));
            prop_onmousedown.setShortDescription(resources.getString("Blockquote_onmousedown_Description"));
            ...
            prop_onmousemove.setDisplayName(resources.getString("Blockquote_onmousemove_DisplayName"));
            prop_onmousemove.setShortDescription(resources.getString("Blockquote_onmousemove_Description"));
            ...
            prop_onmouseout.setDisplayName(resources.getString("Blockquote_onmouseout_DisplayName"));
            prop_onmouseout.setShortDescription(resources.getString("Blockquote_onmouseout_Description"));
            ...
            prop_onmouseover.setDisplayName(resources.getString("Blockquote_onmouseover_DisplayName"));
            prop_onmouseover.setShortDescription(resources.getString("Blockquote_onmouseover_Description"));
            ...
            prop_onmouseup.setDisplayName(resources.getString("Blockquote_onmouseup_DisplayName"));
            prop_onmouseup.setShortDescription(resources.getString("Blockquote_onmouseup_Description"));
            ...
            prop_style.setDisplayName(resources.getString("Blockquote_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("Blockquote_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("Blockquote_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("Blockquote_styleClass_Description"));
            ...
            prop_title.setDisplayName(resources.getString("Blockquote_title_DisplayName"));
            prop_title.setShortDescription(resources.getString("Blockquote_title_Description"));
            ...
            prop_xmlLang.setDisplayName(resources.getString("Blockquote_xmlLang_DisplayName"));
            prop_xmlLang.setShortDescription(resources.getString("Blockquote_xmlLang_Description"));
