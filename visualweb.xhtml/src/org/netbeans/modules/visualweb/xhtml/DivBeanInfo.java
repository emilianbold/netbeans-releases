...
public class DivBeanInfo extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.xhtml.Bundle-JSF", Locale.getDefault(), DivBeanInfo.class.getClassLoader());

    /**
     * <p>Construct a new <code>DivBeanInfo</code>.</p>
     */
    public DivBeanInfo() {

        beanClass = org.netbeans.modules.visualweb.xhtml.Div.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/xhtml/Div_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/xhtml/Div_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/xhtml/Div_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/xhtml/Div_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("Div_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("Div_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_html_elements_div");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"div");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_propsheets_html_div_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"div");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_align.setDisplayName(resources.getString("Div_align_DisplayName"));
            prop_align.setShortDescription(resources.getString("Div_align_Description"));
            prop_align.setExpert(false);
            prop_align.setHidden(false);
            prop_align.setPreferred(false);
            attrib = new AttributeDescriptor("align",false,null,false);
            ...
            prop_dir.setDisplayName(resources.getString("Div_dir_DisplayName"));
            prop_dir.setShortDescription(resources.getString("Div_dir_Description"));
            ...
            attrib = new AttributeDescriptor("dir",false,null,false);
            ...
            prop_id.setDisplayName(resources.getString("Div_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("Div_id_Description"));
            ...
            prop_lang.setDisplayName(resources.getString("Div_lang_DisplayName"));
            prop_lang.setShortDescription(resources.getString("Div_lang_Description"));
            ...
            attrib = new AttributeDescriptor("lang",false,null,false);
            ...
            prop_onclick.setDisplayName(resources.getString("Div_onclick_DisplayName"));
            prop_onclick.setShortDescription(resources.getString("Div_onclick_Description"));
            ...
            attrib = new AttributeDescriptor("onclick",false,null,false);
            ...
            prop_ondblclick.setDisplayName(resources.getString("Div_ondblclick_DisplayName"));
            prop_ondblclick.setShortDescription(resources.getString("Div_ondblclick_Description"));
            ...
            attrib = new AttributeDescriptor("ondblclick",false,null,false);
            ...
            prop_onkeydown.setDisplayName(resources.getString("Div_onkeydown_DisplayName"));
            prop_onkeydown.setShortDescription(resources.getString("Div_onkeydown_Description"));
            ...
            attrib = new AttributeDescriptor("onkeydown",false,null,false);
            ...
            prop_onkeypress.setDisplayName(resources.getString("Div_onkeypress_DisplayName"));
            prop_onkeypress.setShortDescription(resources.getString("Div_onkeypress_Description"));
            ...
            attrib = new AttributeDescriptor("onkeypress",false,null,false);
            ...
            prop_onkeyup.setDisplayName(resources.getString("Div_onkeyup_DisplayName"));
            prop_onkeyup.setShortDescription(resources.getString("Div_onkeyup_Description"));
            ...
            attrib = new AttributeDescriptor("onkeyup",false,null,false);
            ...
            prop_onmousedown.setDisplayName(resources.getString("Div_onmousedown_DisplayName"));
            prop_onmousedown.setShortDescription(resources.getString("Div_onmousedown_Description"));
            ...
            attrib = new AttributeDescriptor("onmousedown",false,null,false);
            ...
            prop_onmousemove.setDisplayName(resources.getString("Div_onmousemove_DisplayName"));
            prop_onmousemove.setShortDescription(resources.getString("Div_onmousemove_Description"));
            ...
            attrib = new AttributeDescriptor("onmousemove",false,null,false);
            ...
            prop_onmouseout.setDisplayName(resources.getString("Div_onmouseout_DisplayName"));
            prop_onmouseout.setShortDescription(resources.getString("Div_onmouseout_Description"));
            ...
            attrib = new AttributeDescriptor("onmouseout",false,null,false);
            ...
            prop_onmouseover.setDisplayName(resources.getString("Div_onmouseover_DisplayName"));
            prop_onmouseover.setShortDescription(resources.getString("Div_onmouseover_Description"));
            ...
            attrib = new AttributeDescriptor("onmouseover",false,null,false);
            ...
            prop_onmouseup.setDisplayName(resources.getString("Div_onmouseup_DisplayName"));
            prop_onmouseup.setShortDescription(resources.getString("Div_onmouseup_Description"));
            ...
            attrib = new AttributeDescriptor("onmouseup",false,null,false);
            ...
            prop_style.setDisplayName(resources.getString("Div_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("Div_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("Div_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("Div_styleClass_Description"));
            prop_styleClass.setPropertyEditorClass(loadClass("com.sun.rave.propertyeditors.StyleClassPropertyEditor"));
            prop_styleClass.setExpert(false);
            prop_styleClass.setHidden(false);
            prop_styleClass.setPreferred(false);
            attrib = new AttributeDescriptor("class",false,null,false);
            ...
            prop_title.setDisplayName(resources.getString("Div_title_DisplayName"));
            prop_title.setShortDescription(resources.getString("Div_title_Description"));
            prop_title.setExpert(false);
            prop_title.setHidden(false);
            prop_title.setPreferred(false);
            attrib = new AttributeDescriptor("title",false,null,false);
            ...
            prop_xmlLang.setDisplayName(resources.getString("Div_xmlLang_DisplayName"));
            prop_xmlLang.setShortDescription(resources.getString("Div_xmlLang_Description"));
            ...
            attrib = new AttributeDescriptor("xmlLang",false,null,false);
