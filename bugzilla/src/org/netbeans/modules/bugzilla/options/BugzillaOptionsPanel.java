 ...
 * @author Tomas Stupka
 */
@OptionsPanelController.Keywords(keywords={"bugzilla", "#KW_IssueTracking"}, location=OptionsDisplayer.ADVANCED, tabTitle="#LBL_IssueTracking")
public class BugzillaOptionsPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(BugzillaOptionsPanel.class, "BugzillaOptionsPanel.jLabel1.text")); // NOI18N

        issuesTextField.setText(org.openide.util.NbBundle.getMessage(BugzillaOptionsPanel.class, "BugzillaOptionsPanel.issuesTextField.text")); // NOI18N
