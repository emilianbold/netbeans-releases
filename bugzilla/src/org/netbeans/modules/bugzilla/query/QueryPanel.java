...
public class QueryPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        savePanelLayout.setHorizontalGroup(
            ...
            .add(savePanelLayout.createSequentialGroup()
                .add(jLabel3)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(queryNameTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 343, Short.MAX_VALUE))
        );
        ...
        tableHeaderPanelLayout.setHorizontalGroup(
            ...
            .add(tableHeaderPanelLayout.createSequentialGroup()
                ...
                .add(filterLabel)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(filterComboBox, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 137, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
        );
        ...
        tableFieldsPanelLayout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, tableFieldsPanelLayout.createSequentialGroup()
                ...
                .add(tableFieldsPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, tablePanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 748, Short.MAX_VALUE)
        ...
        tableFieldsPanelLayout.setVerticalGroup(
            ...
            .add(tableFieldsPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(tablePanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 49, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        byTextLabel.setFont(new java.awt.Font("Lucida Grande", 1, 13)); // NOI18N
        ...
        byDetailsLabel.setFont(new java.awt.Font("Lucida Grande", 1, 13)); // NOI18N
        ...
        byLastChangeLabel.setFont(new java.awt.Font("Lucida Grande", 1, 13)); // NOI18N
        ...
        urlPanelLayout.setHorizontalGroup(
            ...
            .add(urlPanelLayout.createSequentialGroup()
                ...
                .add(jLabel2)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(urlTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 633, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        criteriaPanelLayout.setHorizontalGroup(
            ...
            .add(criteriaPanelLayout.createSequentialGroup()
                ...
                .add(578, 578, 578))
            .add(byTextContainer, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 746, Short.MAX_VALUE)
            .add(byLastChangeContainer, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 746, Short.MAX_VALUE)
            .add(criteriaPanelLayout.createSequentialGroup()
                .add(byDetailsLabel)
                .addContainerGap())
            .add(byDetailsContainer, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 746, Short.MAX_VALUE)
            .add(criteriaPanelLayout.createSequentialGroup()
                .add(byPeopleLabel)
                .addContainerGap())
            .add(byPeopleContainer, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 746, Short.MAX_VALUE)
    ...
    void switchQueryFields(boolean showAdvanced) {
        ...
        if(showAdvanced) {
            urlToggleButton.setText(org.openide.util.NbBundle.getMessage(QueryPanel.class, "QueryPanel.urlToggleLabel.textUrl"));
        } else {
            urlToggleButton.setText(org.openide.util.NbBundle.getMessage(QueryPanel.class, "QueryPanel.urlToggleLabel.textForm"));
        }
    }


    void showNoContentPanel(boolean on, JComponent progressBar, String text) {
    ...
    void showNoContentPanel(boolean on) {
        showNoContentPanel(on, null, null);
    }
