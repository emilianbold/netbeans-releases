        ...
        private void initComponents() {
                        ...
                        .add(byLastChangePanelLayout.createSequentialGroup()
                                ...
                                .add(byLastChangePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                        ...
                                        .add(byLastChangePanelLayout.createSequentialGroup()
                                                ...
                                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                                .add(newValueTextField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                ...
                criteriaPanelLayout.setHorizontalGroup(
                        ...
                        .add(criteriaPanelLayout.createSequentialGroup()
                                .addContainerGap()
                                .add(byDetailsLabel))
                        .add(byDetailsContainer)
                        .add(criteriaPanelLayout.createSequentialGroup()
                                .addContainerGap()
                                .add(byPeopleLabel))
                        .add(byPeopleContainer)
                        .add(criteriaPanelLayout.createSequentialGroup()
                                .addContainerGap()
