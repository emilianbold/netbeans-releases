...
import org.netbeans.modules.bugzilla.util.TasksUtil;

/**
 *
 * @author tomas
 */
public class BugzillaTest extends NbTestCase {

    public static final String TEST_PROJECT = "TESTPROJECT";
    public static final String REPO_PASSWD  = "dilino";
    public static final String REPO_URL     = "http://129.157.21.119/bugzilla"; //"http://129.157.20.205/bugzilla"; //
...
////            assertEquals("ta", val);
    ...
    public static TaskData createIssue(BugzillaRepositoryConnector brc, TaskRepository repository, String summary, String desc, String typeName) throws CoreException, MalformedURLException {
        ...
        BugzillaClient client = brc.getClientManager().getClient(repository, nullProgressMonitor);
