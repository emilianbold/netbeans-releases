 ...
 * @author mt154047
 */
public class VisualizerSessionsStateHandler implements SessionStateListener, DLightSessionListener {

    private SessionState currentSessionState = null;
    private final RefreshStateVisualizer vis;

    VisualizerSessionsStateHandler(RefreshStateVisualizer vis) {
        this.vis = vis;
