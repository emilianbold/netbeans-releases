...
public final class SetVariableValue {
    ...
    public static final class Arguments extends V8Arguments {
        ...
        private final PropertyLong scopeNumber;
        private final PropertyLong scopeFrameNumber;
        
        public Arguments(String name, V8Value newValue, Long scopeNumber, Long scopeFrameNumber) {
            this.name = name;
            this.newValue = newValue;
            this.scopeNumber = new PropertyLong(scopeNumber);
        ...
        public PropertyLong getScopeNumber() {
            return scopeNumber;
        }
