...
public class V8Object extends V8Value {
    ...
    private final long constructorFunctionHandle;
    private final long protoObjectHandle;
    private final long prototypeObjectHandle;
    private final Map<String, Long> properties;
    
    public V8Object(long handle, String className,
                    long constructorFunctionHandle,
    ...
    public long getConstructorFunctionHandle() {
        return constructorFunctionHandle;
    }

    public long getProtoObjectHandle() {
        return protoObjectHandle;
    }

    public long getPrototypeObjectHandle() {
