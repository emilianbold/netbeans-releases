...
public class CndTokenListTest extends NbTestCase {
    ...
    public void testSimpleWordBroker() throws Exception {
        tokenListTest(
            ...
            "tes", "test", "testttt", "testtttt","testttttt"
        );
    }
    ...
    public void testIsIdentifierLike() throws Exception {
        ...
        assertTrue(CndTokenList.isIdentifierLike("setTestingData"));

        assertFalse(CndTokenList.isIdentifierLike("test"));
        assertFalse(CndTokenList.isIdentifierLike("code"));
        assertFalse(CndTokenList.isIdentifierLike("data"));
    }

    public void testPositions() throws Exception {
        Document doc = new PlainDocument();
        
        doc.putProperty(Language.class, CppTokenId.languageCpp());
        
        doc.insertString(0, "/**tes test <pre>testt</pre> <a href='testtt'>testttt</a> testttttt*/", null);
        
        TokenList l = new CndTokenList(doc);
