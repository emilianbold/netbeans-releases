...
/**
 * Concrete form for the Queue Manager Settings dialog.
 *
 * @author Noel.Ang@sun.com
 */
final class QueueManagerSettingsForm
        extends Form {

    QueueManagerSettingsForm(WSDLWizardContext context, FormModel model) {
        super(context, model);
    }
    ...
    protected FormView getView() {
        if (swingComponent == null) {
            swingComponent = new QueueManagerSettingsPanel();
        }
    ...
    JComponent getDefaultFocusComponent() {
        getView();
        return ((QueueManagerSettingsPanel) swingComponent).getDefaultFocusComponent();
    }
    ...
    public boolean isValid() {
        ...
        return !"".equals(aModel.getQueueManager());
    }
    ...
    private final String taskDescription = NbBundle.getMessage(
            QueueManagerSettingsForm.class,
            "QueueManagerSettingsForm.TaskDescription"
    );
}
