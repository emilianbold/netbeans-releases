...
import org.netbeans.modules.wsdlextensions.mq.editor.MqWsdlEditorExtensionIterator;
...
public class MQTemplateProvider
        extends ExtensibilityElementTemplateProvider {

    private static final String BASELOC =
            "/org/netbeans/modules/wsdlextensions/mq/template/";

    private static final String mqTemplateUrl = BASELOC + "template.xml";
    ...
    public InputStream getTemplateFileInputStream(String filePath) {
        return MQTemplateProvider.class.getResourceAsStream(BASELOC + filePath);
    }
    ...
    public WSDLWizardExtensionIterator getWSDLWizardExtensionIterator(
        ...
        return new MqWsdlEditorExtensionIterator(context);
    }
}
