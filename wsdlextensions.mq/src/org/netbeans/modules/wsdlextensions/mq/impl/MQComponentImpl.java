 ...
 * @author rchen
 */
public abstract class MQComponentImpl extends GenericExtensibilityElement implements MQComponent {
    
    /** Creates a new instance of MQComponentImpl */
    public MQComponentImpl(WSDLModel model, Element e) {
         super(model, e);
    }
