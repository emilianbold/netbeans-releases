 ...
 * @author rchen
 */
public class MQBindingImpl extends MQComponentImpl implements MQBinding {
    
    /** Creates a new instance of MQBindingImpl */
    public MQBindingImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
      public MQBindingImpl(WSDLModel model){
        this(model, createPrefixedElement(MQQName.BINDING.getQName(), model));
    }
