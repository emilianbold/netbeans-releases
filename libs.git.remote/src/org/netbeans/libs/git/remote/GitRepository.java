 ...
 * {@link GitClient#init(org.netbeans.libs.git.remote.progress.ProgressMonitor) } was called.</p>
...
public final class GitRepository {
     ...
     * {@link GitClient#merge(java.lang.String, org.netbeans.libs.git.remote.GitRepository.FastForwardOption, org.netbeans.libs.git.remote.progress.ProgressMonitor)}.
    ...
    public static synchronized GitRepository getInstance (VCSFileProxy repositoryLocation) {
        synchronized (repositoryPool) {
            ...
            if (repository == null) {
                ...
                repositoryPool.put(repositoryLocation, repository = new GitRepository(repositoryLocation));
            }
            return repository;
        }
    }
