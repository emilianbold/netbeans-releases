...
class AllMemoryAction extends FlyweightAction {

    private final static class SharedAllMemoryAction extends Shared {
	// like SystemAction
	protected String iconResource() {
	    return "org/netbeans/modules/cnd/debugger/dbx/resources/icons/rtc/show_all_activity_16.png";  // NOI18N
	}
	...
	protected void initialize() {
	    super.initialize();
	    putValue(NAME, Catalog.get("Memory_ShowAll"));
	    putValue(SHORT_DESCRIPTION, Catalog.get("TIP_Memory_ShowAll"));
	}
    }
