...
//@BreakpointType.Registration(displayName="#LBL_Debugger")
public class DebuggerBreakpointType extends NativeBreakpointType {

    // interface BreakpointType
    public NativeBreakpoint newInstance(int flags) {
	return new DebuggerBreakpoint(flags);
    } 

    // interface BreakpointType
    @Override
    public String getTypeDisplayName() {
        return Catalog.get("LBL_Debugger");
    }

    // interface NativeBreakpointType
    public BreakpointPanel getCustomizer(NativeBreakpoint editable) {
	if (editable == null)
	    return new DebuggerBreakpointPanel();
	else
	    return new DebuggerBreakpointPanel(editable);
    }
}
