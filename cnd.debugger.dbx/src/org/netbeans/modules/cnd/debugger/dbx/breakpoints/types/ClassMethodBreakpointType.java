...
//@BreakpointType.Registration(displayName="#LBL_ClassMethod")
public class ClassMethodBreakpointType extends NativeBreakpointType {

    // interface BreakpointType
    public NativeBreakpoint newInstance(int flags) {
	return new ClassMethodBreakpoint(flags);
    } 

    // interface BreakpointType
    @Override
    public String getTypeDisplayName() {
	return Catalog.get("LBL_ClassMethod");
    }

    // interface NativeBreakpointType
    public BreakpointPanel getCustomizer(NativeBreakpoint editable) {
	if (editable == null)
	    return new ClassMethodBreakpointPanel();
	else
