...
//@BreakpointType.Registration(displayName="#LBL_LoadObject")
public class LoadObjBreakpointType extends NativeBreakpointType {

    // interface BreakpointType
    public NativeBreakpoint newInstance(int flags) {
	return new LoadObjBreakpoint(flags);
    } 

    // interface BreakpointType
    @Override
    public String getTypeDisplayName() {
        return Catalog.get("LBL_LoadObject");
    }

    // interface NativeBreakpointType
    public BreakpointPanel getCustomizer(NativeBreakpoint editable) {
	if (editable == null)
	    return new LoadObjBreakpointPanel();
	else
