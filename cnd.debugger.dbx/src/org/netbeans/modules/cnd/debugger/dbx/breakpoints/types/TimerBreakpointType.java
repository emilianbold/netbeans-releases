...
//@BreakpointType.Registration(displayName="#LBL_Timer")
public class TimerBreakpointType extends NativeBreakpointType {

    // interface BreakpointType
    public NativeBreakpoint newInstance(int flags) {
	return new TimerBreakpoint(flags);
    } 

    // interface BreakpointType
    @Override
    public String getTypeDisplayName() {
	return Catalog.get("LBL_Timer");
    }

    // interface NativeBreakpointType
    public BreakpointPanel getCustomizer(NativeBreakpoint editable) {
	if (editable == null)
	    return new TimerBreakpointPanel();
	else
