...
//@BreakpointType.Registration(displayName="#LBL_Process")
public class ProcessBreakpointType extends NativeBreakpointType {

    // interface BreakpointType
    public NativeBreakpoint newInstance(int flags) {
	return new ProcessBreakpoint(flags);
    } 

    // interface BreakpointType
    @Override
    public String getTypeDisplayName() {
        return Catalog.get("LBL_Process");
    }

    // interface NativeBreakpointType
    public BreakpointPanel getCustomizer(NativeBreakpoint editable) {
	if (editable == null)
	    return new ProcessBreakpointPanel();
	else
