 ...
 */
public class POJOConsumerDrop extends DestinationPaletteDrop implements ActiveEditorDrop {
    /**
     * Constructor
     */
    public POJOConsumerDrop() {
    ...
    */
    public boolean handleTransfer(JTextComponent target) {
        POJOConsumerPalleteWizardIterator powiz = new POJOConsumerPalleteWizardIterator();
         WizardDescriptor wd = new WizardDescriptor(powiz);
        this.mWizDesc = wd;
