/**
 *	This generated bean class POJOProvider
 *	matches the schema element 'POJOProvider'.
...
public class POJOProvider {
	 ...
	 */
	public POJOProvider(java.lang.String className, java.lang.String a_package, boolean updateWsdlDuringBuild) {
	 ...
	 * Deep copy
	 */
	public POJOProvider(org.netbeans.modules.soa.pojo.schema.POJOProvider source) {
		this(source, false);
	}
	 ...
	 */
	public POJOProvider(org.netbeans.modules.soa.pojo.schema.POJOProvider source, boolean justData) {
	...
	public void changePropertyByName(String name, Object value) {
		...
		if (name == "className")
			...
			throw new IllegalArgumentException(name+" is not a valid property name for POJOProvider");
	}
	...
	public boolean equals(Object o) {
		return o instanceof org.netbeans.modules.soa.pojo.schema.POJOProvider && equals((org.netbeans.modules.soa.pojo.schema.POJOProvider) o);
	}

	public boolean equals(org.netbeans.modules.soa.pojo.schema.POJOProvider inst) {
		if (inst == this) {
			return true;
		}
		if (inst == null) {
