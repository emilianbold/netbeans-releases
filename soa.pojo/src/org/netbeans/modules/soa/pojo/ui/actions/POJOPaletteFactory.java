 ...
 */
public final class POJOPaletteFactory {

    private POJOPaletteFactory() {}
    ...
    */
        ...
        if (ourPalette == null) {
            try {
                ourPalette = PaletteFactory.createPalette(
                    POJO_PALETTE_FOLDER,
                    new POJOPaletteActions(),
                    new POJOPaletteFilter(),
                    new POJOPaletteDragAndDropHandler());
    ...
    //Till issue http://www.netbeans.org/issues/show_bug.cgi?id=125442 is fixed.
    // Use CAPSEEPalette.
    //private static final String POJO_PALETTE_FOLDER = "OpenESBPalette"; // NOI18N
    private static final String POJO_PALETTE_FOLDER = "CAPSEEPalette"; // NOI18N
