...
import org.netbeans.modules.cnd.diagnostics.clank.ClankDiagnosticsAnalyzerImpl;
...
public class ClankErrorPathDetailsProviderImpl implements ClankErrorPathDetailsProvider {
    ...
    public void implement(final ClankCsmErrorInfo errorInfo) {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                //provider2Hints
                ClankDiagnosticsDetailsTopComponent details = ClankDiagnosticsDetailsTopComponent.findInstance();
                details.setData(errorInfo);
//                ClankDiagnosticsAnalyzerImpl analyzer = new ClankDiagnosticsAnalyzerImpl
//                details.setData(Lookups.fixed(Utilities.actionsGlobalContext().lookupAll(Object.class).toArray(new Object[0])), 
//                         new AnalysisResult(provider2Hints, errorsToProjects, analyzerId2Description, Collections.EMPTY_LIST));
                details.open();
