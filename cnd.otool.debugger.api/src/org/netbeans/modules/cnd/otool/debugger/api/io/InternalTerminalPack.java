...
import org.netbeans.modules.cnd.otool.io.OtoolNativeIOProvider;
...
class InternalTerminalPack extends IOPack {
    ...
    public InternalTerminalPack(InputOutput io, ExecutionEnvironment exEnv) {
        super( exEnv);
        this.io = io;
    }
    ...
    public boolean start() {
        try {
            ...
            //TODO: CALL TO SPI THAT WILL DEAL WITH pseudo terminal
            //PtySupport.connect(io, pty);
            OtoolNativeIOProvider.connect(pty);
