...
package org.netbeans.modules.cnd.otool.debugger.api.remote;
...
//    }
     ...
     */
    public static void fillConfigurationFromHost(Configuration conf, EngineType engine, ExecutionEnvironment execEnv) {
	MakeConfiguration makeConfiguration = (MakeConfiguration) conf;
