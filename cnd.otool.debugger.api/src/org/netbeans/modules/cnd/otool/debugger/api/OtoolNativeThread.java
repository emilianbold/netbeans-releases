...
public abstract class OtoolNativeThread {
    ...
    protected void notifyThreadSuspended(boolean suspended) {
        pch.firePropertyChange(PROP_SUSPENDED, this, suspended ? Boolean.TRUE : Boolean.FALSE);
    }
    
    public void suspend() {
         suspended = true;
         notifyThreadSuspended(suspended);
    }
