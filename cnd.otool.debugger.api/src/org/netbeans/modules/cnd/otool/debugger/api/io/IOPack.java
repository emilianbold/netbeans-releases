...
package org.netbeans.modules.cnd.otool.debugger.api.io;
...
public class IOPack {
  ...
  //  private final boolean external;
    ...
    protected IOPack(ExecutionEnvironment exEnv) {
...
//            res = new IOPack(exEnv);
//        } else if (OtoolNativeDebuggerManager.isStandalone()) {
//            TermComponent pio;
//            if (remote || Utilities.isWindows()) {
...
//            }
//        }
        res = new InternalTerminalPack(io,exEnv);
	res.bringUp();
