 ...
 */
public class PerfEnterpriseSamples extends JellyTestCase {

    protected static int logIdx = 0;
    protected static final String PROJECT_LOCATION = System.getProperty("nbjunit.workdir");
    private static final String BUILD_SUCCESSFUL = "BUILD SUCCESSFUL";
    private ServerInstance server;

    /** Need to be defined because of JUnit */
    public PerfEnterpriseSamples(String name) {
        super(name);
    }

    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite();
        suite.addTest(new PerfEnterpriseSamples("testNewPetCatalogSample"));
     ...
     */
    public void testNewPetCatalogSample() throws IOException {
    ...
    public void testBuildPetCatalogSample() throws IOException {
        testBuildProject("PetCatalog");
    }

    public void testCleanPetCatalogSample() throws IOException {
        testCleanProject("PetCatalog");
    }

    public void testRedeployPetCatalogSample() throws IOException {
        testRedeployProject("PetCatalog");
    }
