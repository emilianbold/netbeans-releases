...
//TODO        suite.addTest(new OpenFiles("testOpening20kBJavaFile", "Open Java file (20kB)"));
//TODO        suite.addTest(new OpenFiles("testOpening20kBTxtFile", "Open Txt file (20kB)"));
//TODO        suite.addTest(new OpenFiles("testOpening20kBXmlFile", "Open Xml file (20kB)"));
//TODO        suite.addTest(new OpenFilesNoCloneableEditor("testOpening20kBPropertiesFile", "Open Properties file (20kB)"));
//TODO        suite.addTest(new OpenFilesNoCloneableEditor("testOpening20kBPictureFile", "Open Picture file (20kB)"));
        
//TODO        suite.addTest(new OpenFiles("testOpening20kBWebXMLFile", "Open web.xml file"));
//TODO        suite.addTest(new OpenFiles("testOpening20kBJSPFile", "Open JSP file"));
        
//TODO        suite.addTest(new OpenFilesWithOpenedEditor("testOpening20kBJavaFile", "Open Java file (20kB) if Editor opened"));
//TODO        suite.addTest(new OpenFilesWithOpenedEditor("testOpening20kBTxtFile", "Open Txt file (20kB) if Editor opened"));
//TODO        suite.addTest(new OpenFilesWithOpenedEditor("testOpening20kBXmlFile", "Open Xml file (20kB) if Editor opened"));
        
//TODO        suite.addTest(new OpenFormFile("testOpening20kBFormFile", "Open Form file (20kB)"));
//TODO        suite.addTest(new OpenFormFileWithOpenedEditor("testOpening20kBFormFile", "Open Form file (20kB) if Editor opened"));        
        
//TODO        suite.addTest(new OpenFilesNoCloneableEditorWithOpenedEditor("testOpening20kBPropertiesFile", "Open Properties file (20kB) if Editor opened"));
//TODO        suite.addTest(new OpenFilesNoCloneableEditorWithOpenedEditor("testOpening20kBPictureFile", "Open Picture file (20kB) if Editor opened"));

//TODO        suite.addTest(new OpenFilesWithOpenedEditor("testOpening20kBWebXMLFile", "Open web.xml file if Editor opened"));
//TODO        suite.addTest(new OpenFilesWithOpenedEditor("testOpening20kBJSPFile", "Open JSP file if Editor opened"));
...
//TODO        suite.addTest(new PasteInEditor("measureTime", "Paste in the editor"));
//TODO        suite.addTest(new PageUpPageDownInEditor("measureTime", "Press Page Up in the editor", true));
//TODO        suite.addTest(new PageUpPageDownInEditor("measureTime", "Press Page Down in the editor", false));
        
//TODO        suite.addTest(new JavaCompletionInEditor("measureTime", "Invoke Code Completion dialog in Editor"));
//TODO        suite.addTest(new TypingInEditor("measureTime", "Type a character in Editor"));
