...
public class ScanProjectPerfTest extends NbTestCase {
    ...
    public void XtestScanJEdit() throws IOException, ExecutionException, InterruptedException {
        scanProject("http://spbweb.russia.sun.com/~ok153203/jEdit41.zip", 
                    "jEdit41.zip",
                    "jEdit41");
    }

    public void XtestScanNigelsFreeForm() throws IOException, ExecutionException, InterruptedException {
        scanProject("http://kim-sun.czech.sun.com/~pf124312/nigel.zip",
                    "Clean.zip",
                    "clean/projects/ST");
    }

    public void XtestPhpProject() throws IOException, ExecutionException, InterruptedException {
    ...
    public void XtestOpenJdk7() throws IOException, ExecutionException, InterruptedException {
            ...
            throws IOException, ExecutionException, InterruptedException
    {
        ...
        repositoryUpdater.setLevel(Level.FINER);
    ...
    private class ScanningHandler extends Handler {
        ...
        public void publish(LogRecord record) {
            ...
            if (message != null && message.startsWith("Complete binary")) {
                if (message.contains("source scan time")) {
                ...
                if (message.contains("binary scan time")) {
                    PerformanceData res = new PerformanceData();
                    StringTokenizer tokenizer = new StringTokenizer(message, " ");
                    int count = tokenizer.countTokens();
