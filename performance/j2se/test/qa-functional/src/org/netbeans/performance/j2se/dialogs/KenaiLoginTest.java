 ...
 */
public class KenaiLoginTest extends PerformanceTestCase {

    protected String menu, loginDialog;

    /** Creates a new instance of About */
    public KenaiLoginTest(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of About */
    public KenaiLoginTest(String testName, String performanceDataName) {
