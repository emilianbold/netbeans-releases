 ...
 */
public class NewKenaiProjectTest extends PerformanceTestCase {

    protected String menu, loginDialog;

    /** Creates a new instance of About */
    public NewKenaiProjectTest(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of About */
    public NewKenaiProjectTest(String testName, String performanceDataName) {
