 ...
 */
public class AddNewXMLSchema_2 extends PerformanceTestCase {
     ...
     */
    public AddNewXMLSchema_2(String testName) {
        super(testName);
        expectedTime = 10000;
     ...
     */
    public AddNewXMLSchema_2(String testName, String performanceDataName) {
