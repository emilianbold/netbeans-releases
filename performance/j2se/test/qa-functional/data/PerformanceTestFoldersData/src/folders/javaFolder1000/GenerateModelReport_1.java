 ...
 *
 */
public class GenerateModelReport_1 extends PerformanceTestCase {

    private static String testProjectName = "jEdit-Model";

    /** Creates a new instance of GenerateModelReport */
    public GenerateModelReport_1(String testName) {
        super(testName);
        expectedTime = 300000;
        WAIT_AFTER_OPEN = 4000;
    }

    public GenerateModelReport_1(String testName, String performanceDataName) {
