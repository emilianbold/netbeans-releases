 ...
 */
public class OpenProjectDialogTest_3_1 extends PerformanceTestCase {

    private String MENU, TITLE;
   

    /** Creates a new instance of OpenProjectDialog */
    public OpenProjectDialogTest_3_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of OpenProjectDialog */
    public OpenProjectDialogTest_3_1(String testName, String performanceDataName) {
