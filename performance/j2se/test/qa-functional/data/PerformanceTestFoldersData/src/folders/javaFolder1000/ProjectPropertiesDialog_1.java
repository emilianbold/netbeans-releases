 ...
 */
public class ProjectPropertiesDialog_1  extends PerformanceTestCase {

    private Node testNode;
    private String targetProject, TITLE;
    
    public ProjectPropertiesDialog_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
        targetProject = "MobileApplicationVisualMIDlet";
        TITLE = "MobileApplicationVisualMIDlet";
    }
    public ProjectPropertiesDialog_1(String testName, String performanceDataName) {
