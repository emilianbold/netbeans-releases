 ...
 *
 */
public class OpenUMLDiagram_2 extends PerformanceTestCase {
    ...
    public OpenUMLDiagram_2(String testName) {
        super(testName);
        expectedTime = 2000;
        WAIT_AFTER_OPEN = 4000;
    }

    public OpenUMLDiagram_2(String testName, String performanceDataName) {
