 ...
 */
public class NewWatchDialogTest_5 extends PerformanceTestCase {

    private String MENU, TITLE;
 

    /** Creates a new instance of NewWatchDialog */
    public NewWatchDialogTest_5(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of NewWatchDialog */
    public NewWatchDialogTest_5(String testName, String performanceDataName) {
