 ...
 *
 */
public class CreateSequenceDiagramFromMultipleNodes_1 extends PerformanceTestCase {
    ...
    public CreateSequenceDiagramFromMultipleNodes_1(String testName) {
        super(testName);
        expectedTime = 5000;
        WAIT_AFTER_OPEN = 4000;
    }

    public CreateSequenceDiagramFromMultipleNodes_1(String testName, String performanceDataName) {
