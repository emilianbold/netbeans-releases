 ...
 */
public class VersioningWindowTest_2 extends PerformanceTestCase {

    private String MENU, NAME;
    

    /** Creates a new instance of VersioningWindow */
    public VersioningWindowTest_2(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of VersioningWindow */
    public VersioningWindowTest_2(String testName, String performanceDataName) {
