 ...
 */
public class RailsGeneratorDialog_1 extends org.netbeans.modules.performance.utilities.PerformanceTestCase {
    public static final String suiteName="Scripting UI Responsiveness Dialogs suite";
    private Node testNode;
    private String CMD, TITLE, projectName;
    
    public RailsGeneratorDialog_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;          
    }
    public RailsGeneratorDialog_1(String testName, String performanceDataName)
    {
