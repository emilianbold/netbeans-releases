 ...
 */
public class DeployTest_2 extends PerformanceTestCase {
     ...
     */
    public DeployTest_2(String testName) {
        super(testName);
        expectedTime = 60000;
     ...
     */
    public DeployTest_2(String testName, String performanceDataName) {
