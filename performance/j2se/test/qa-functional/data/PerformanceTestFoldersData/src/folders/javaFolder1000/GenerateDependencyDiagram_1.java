 ...
 *
 */
public class GenerateDependencyDiagram_1 extends PerformanceTestCase {
    ...
    public GenerateDependencyDiagram_1(String testName) {
        super(testName);
        expectedTime = EXPECTED_TIME;
        WAIT_AFTER_OPEN = 4000;
    }

    public GenerateDependencyDiagram_1(String testName, String performanceDataName) {
