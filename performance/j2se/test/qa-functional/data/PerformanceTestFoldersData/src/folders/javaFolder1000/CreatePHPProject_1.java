 ...
 */
public class CreatePHPProject_1  extends org.netbeans.modules.performance.utilities.PerformanceTestCase {
    ...
    public CreatePHPProject_1(String testName)
    {
        super(testName);        
        expectedTime = 10000;
    ...
    public CreatePHPProject_1(String testName, String performanceDataName)
    {
