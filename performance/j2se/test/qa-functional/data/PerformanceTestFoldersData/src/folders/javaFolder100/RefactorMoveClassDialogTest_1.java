 ...
 */
public class RefactorMoveClassDialogTest_1 extends PerformanceTestCase {

    private static Node testNode;
    private String TITLE, ACTION;
    
    /** Creates a new instance of RefactorRenameDialog */
    public RefactorMoveClassDialogTest_1(String testName) {
        super(testName);
    ...
    /** Creates a new instance of RefactorRenameDialog */
    public RefactorMoveClassDialogTest_1(String testName, String performanceDataName) {
