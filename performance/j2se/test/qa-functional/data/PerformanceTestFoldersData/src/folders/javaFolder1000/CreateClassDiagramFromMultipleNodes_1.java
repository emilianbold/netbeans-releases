 ...
 *
 */
public class CreateClassDiagramFromMultipleNodes_1 extends PerformanceTestCase {
    ...
    public CreateClassDiagramFromMultipleNodes_1(String testName) {
        super(testName);
        expectedTime = 5000;
        WAIT_AFTER_OPEN = 4000;
    }

    public CreateClassDiagramFromMultipleNodes_1(String testName, String performanceDataName) {
