 ...
 */
public class DeleteFileDialogTest_2_1 extends PerformanceTestCase {

    private static Node testNode;
    private String TITLE;

    /** Creates a new instance of RefactorRenameDialog */
    public DeleteFileDialogTest_2_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of RefactorRenameDialog */
    public DeleteFileDialogTest_2_1(String testName, String performanceDataName) {
