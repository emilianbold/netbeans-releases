 ...
 */
public class FormatFileTest_2 extends org.netbeans.modules.performance.utilities.PerformanceTestCase {
    ...
    public FormatFileTest_2(String testName) {
        super(testName);
    }

    public FormatFileTest_2(String testName, String performanceDataName) {
    ...
    public static Test suite() {
        return NbModuleSuite.create(
            NbModuleSuite.createConfiguration(FormatFileTest.class)
            .enableModules(".*")
            .clusters(".*")
            .reuseUserDir(true)
        );    
