 ...
 */
public class RefactorFindUsagesDialogTest_4 extends PerformanceTestCase {
    ...
    public RefactorFindUsagesDialogTest_4(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of RefactorFindUsagesDialog */
    public RefactorFindUsagesDialogTest_4(String testName, String performanceDataName) {
