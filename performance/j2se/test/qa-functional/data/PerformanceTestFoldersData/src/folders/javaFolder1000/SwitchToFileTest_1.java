 ...
 * 
 */
public class SwitchToFileTest_1  extends PerformanceTestCase {
    ...
    public SwitchToFileTest_1(String testName) {
        super(testName);
    ...
    /** Creates a new instance of SwitchToFile */
    public SwitchToFileTest_1(String testName, String performanceDataName) {
