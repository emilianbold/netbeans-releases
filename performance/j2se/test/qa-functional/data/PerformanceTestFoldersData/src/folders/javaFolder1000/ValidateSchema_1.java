 ...
 *
 */
public class ValidateSchema_1 extends PerformanceTestCase {
    
    private Node schemaNode;
    
    /** Creates a new instance of ValidateSchema */
    public ValidateSchema_1(String testName) {
        super(testName);
    ...
    public ValidateSchema_1(String testName, String  performanceDataName) {
    ...
    public static Test suite() {
        return NbModuleSuite.create(
            NbModuleSuite.createConfiguration(ValidateSchema.class)
            .addTest("measureTime")
            .enableModules(".*")
            .clusters(".*")
        );    
