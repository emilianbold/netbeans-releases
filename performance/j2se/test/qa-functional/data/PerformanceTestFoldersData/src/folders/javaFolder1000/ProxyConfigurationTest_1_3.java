 ...
 */
public class ProxyConfigurationTest_1_3 extends PerformanceTestCase {
    ...
    public ProxyConfigurationTest_1_3(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of ProxyConfiguration */
    public ProxyConfigurationTest_1_3(String testName, String performanceDataName) {
