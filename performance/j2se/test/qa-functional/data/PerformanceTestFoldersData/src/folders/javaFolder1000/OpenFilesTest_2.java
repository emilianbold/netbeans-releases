 ...
 */
public class OpenFilesTest_2 extends PerformanceTestCase {
     ...
     */
    public OpenFilesTest_2(String testName) {
        super(testName);
     ...
     */
    public OpenFilesTest_2(String testName, String performanceDataName) {
