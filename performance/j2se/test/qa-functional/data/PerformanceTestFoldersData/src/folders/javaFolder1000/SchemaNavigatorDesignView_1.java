 ...
 */
public class SchemaNavigatorDesignView_1  extends PerformanceTestCase {
    
    private Node processNode, schemaNode, tempNode;
    
    /** Creates a new instance of SchemaNavigatorDesignView */
    public SchemaNavigatorDesignView_1(String testName) {
        super(testName);
    ...
    /** Creates a new instance of SchemaNavigatorDesignView */
    public SchemaNavigatorDesignView_1(String testName, String performanceDataName) {
    ...
    public static Test suite() {
        return NbModuleSuite.create(
            NbModuleSuite.createConfiguration(SchemaNavigatorDesignView.class)
            .addTest("measureTime")
            .enableModules(".*")
            .clusters(".*")
        );    
