 ...
 */
public class FindInProjectsTest_1_2 extends PerformanceTestCase {

    private String MENU, TITLE;
    
    /** Creates a new instance of FindInProjects */
    public FindInProjectsTest_1_2(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of FindInProjects */
    public FindInProjectsTest_1_2(String testName, String performanceDataName) {
