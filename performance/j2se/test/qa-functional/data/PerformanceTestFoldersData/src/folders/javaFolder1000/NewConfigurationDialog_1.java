 ...
 */
public class NewConfigurationDialog_1  extends PerformanceTestCase {

    private Node testNode;    
    private String targetProject, TITLE;
    
    public NewConfigurationDialog_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
        targetProject = "MobileApplicationVisualMIDlet";              
        
    }
    public NewConfigurationDialog_1(String testName, String performanceDataName) {
