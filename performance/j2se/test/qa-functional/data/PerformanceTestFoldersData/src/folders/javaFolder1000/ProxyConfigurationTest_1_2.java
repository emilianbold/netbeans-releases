 ...
 */
public class ProxyConfigurationTest_1_2 extends PerformanceTestCase {
    ...
    public ProxyConfigurationTest_1_2(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of ProxyConfiguration */
    public ProxyConfigurationTest_1_2(String testName, String performanceDataName) {
