 ...
 */
public class SchemaViewSwitchTest_1 extends PerformanceTestCase  {
    ...
    public SchemaViewSwitchTest_1(String testName) {
        super(testName);
    ...
    public SchemaViewSwitchTest_1(String testName, String  performanceDataName) {
