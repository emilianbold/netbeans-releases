 ...
 */
public class OpenBPELproject_2 extends PerformanceTestCase {
     ...
     */
    public OpenBPELproject_2(String testName) {
        super(testName);
        expectedTime = 10000;
     ...
     */
    public OpenBPELproject_2(String testName, String performanceDataName) {
