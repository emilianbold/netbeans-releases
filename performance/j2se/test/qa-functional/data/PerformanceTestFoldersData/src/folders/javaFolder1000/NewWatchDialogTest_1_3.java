 ...
 */
public class NewWatchDialogTest_1_3 extends PerformanceTestCase {

    private String MENU, TITLE;
 

    /** Creates a new instance of NewWatchDialog */
    public NewWatchDialogTest_1_3(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of NewWatchDialog */
    public NewWatchDialogTest_1_3(String testName, String performanceDataName) {
