 ...
 */
public class RefactorRenameDialogTest_1_3 extends PerformanceTestCase {

    private static Node testNode;
    private String TITLE, ACTION;
    
    /** Creates a new instance of RefactorRenameDialog */
    public RefactorRenameDialogTest_1_3(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of RefactorRenameDialog */
    public RefactorRenameDialogTest_1_3(String testName, String performanceDataName) {
