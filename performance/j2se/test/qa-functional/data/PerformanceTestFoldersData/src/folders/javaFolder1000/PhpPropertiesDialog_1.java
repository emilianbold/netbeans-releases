 ...
 */
public class PhpPropertiesDialog_1  extends org.netbeans.modules.performance.utilities.PerformanceTestCase {
    public static final String suiteName="Scripting UI Responsiveness Dialogs suite";
    private Node testNode;
    private String TITLE, projectName;
    
    public PhpPropertiesDialog_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;          
    }
    
    public PhpPropertiesDialog_1(String testName, String performanceDataName) {
