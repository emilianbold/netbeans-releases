 ...
 */
public class RefactorFindUsagesDialogTest_2_1 extends PerformanceTestCase {
    ...
    public RefactorFindUsagesDialogTest_2_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of RefactorFindUsagesDialog */
    public RefactorFindUsagesDialogTest_2_1(String testName, String performanceDataName) {
