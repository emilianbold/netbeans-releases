 ...
 */
public class QuickRunDialog_1 extends PerformanceTestCase {
    
    private Node testNode;    
    private String targetProject, TITLE;
    
    public QuickRunDialog_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
        targetProject = "MobileApplicationVisualMIDlet";
    }
    public QuickRunDialog_1(String testName, String performanceDataName) {
