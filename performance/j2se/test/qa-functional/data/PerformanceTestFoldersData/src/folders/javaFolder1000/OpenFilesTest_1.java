 ...
 */
public class OpenFilesTest_1 extends PerformanceTestCase {
     ...
     */
    public OpenFilesTest_1(String testName) {
        super(testName);
     ...
     */
    public OpenFilesTest_1(String testName, String performanceDataName) {
