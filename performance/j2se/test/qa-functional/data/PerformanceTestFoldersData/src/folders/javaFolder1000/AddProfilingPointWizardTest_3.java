 ...
 */
public class AddProfilingPointWizardTest_3  extends PerformanceTestCase {
     ...
     * @param testName 
     */
    public AddProfilingPointWizardTest_3(String testName) {
        super(testName);
     ...
     */
    public AddProfilingPointWizardTest_3(String testName, String performanceDataName) {
