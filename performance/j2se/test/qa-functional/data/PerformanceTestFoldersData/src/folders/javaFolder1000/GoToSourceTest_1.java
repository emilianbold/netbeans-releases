 ...
 */
public class GoToSourceTest_1 extends org.netbeans.modules.performance.utilities.PerformanceTestCase {
    ...
    public GoToSourceTest_1(String testName) {
        super(testName);
        expectedTime = UI_RESPONSE;
        HEURISTIC_FACTOR = -1; // use default WaitAfterOpen for all iterations             
    }

    public GoToSourceTest_1(String testName, String performanceDataName) {
