 ...
 */
public class ProxyConfigurationTest_5 extends PerformanceTestCase {
    ...
    public ProxyConfigurationTest_5(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of ProxyConfiguration */
    public ProxyConfigurationTest_5(String testName, String performanceDataName) {
