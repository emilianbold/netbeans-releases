 ...
 */
public class CreatePHPSampleProject_1  extends org.netbeans.modules.performance.utilities.PerformanceTestCase {
    ...
    public CreatePHPSampleProject_1(String testName)
    {
        super(testName);        
        expectedTime = 10000;
    ...
    public CreatePHPSampleProject_1(String testName, String performanceDataName)
    {
