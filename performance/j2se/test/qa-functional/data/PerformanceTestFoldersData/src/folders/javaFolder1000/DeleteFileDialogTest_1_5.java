 ...
 */
public class DeleteFileDialogTest_1_5 extends PerformanceTestCase {

    private static Node testNode;
    private String TITLE;

    /** Creates a new instance of RefactorRenameDialog */
    public DeleteFileDialogTest_1_5(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of RefactorRenameDialog */
    public DeleteFileDialogTest_1_5(String testName, String performanceDataName) {
