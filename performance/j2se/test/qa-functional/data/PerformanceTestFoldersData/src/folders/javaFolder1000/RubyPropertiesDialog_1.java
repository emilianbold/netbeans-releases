 ...
 */
public class RubyPropertiesDialog_1  extends org.netbeans.modules.performance.utilities.PerformanceTestCase {
    public static final String suiteName="Scripting UI Responsiveness Dialogs suite";
    private Node testNode;
    private String TITLE, projectName;
    
    public RubyPropertiesDialog_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;          
    }
    
    public RubyPropertiesDialog_1(String testName, String performanceDataName) {
