 ...
 */
public class HelpContentsWindowTest_1_4 extends PerformanceTestCase {

   
    /** Creates a new instance of HelpContentsWindow */
    public HelpContentsWindowTest_1_4(String testName) {
        super(testName);
        expectedTime = 1000; 
    }
    
    /** Creates a new instance of HelpContentsWindow */
    public HelpContentsWindowTest_1_4(String testName, String performanceDataName) {
