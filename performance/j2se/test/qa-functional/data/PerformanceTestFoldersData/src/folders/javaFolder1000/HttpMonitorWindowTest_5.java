 ...
 */
public class HttpMonitorWindowTest_5 extends PerformanceTestCase {

    private String MENU, TITLE;

    /** Creates a new instance of HttpMonitorWindow */
    public HttpMonitorWindowTest_5(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of HttpMonitorWindow */
    public HttpMonitorWindowTest_5(String testName, String performanceDataName) {
