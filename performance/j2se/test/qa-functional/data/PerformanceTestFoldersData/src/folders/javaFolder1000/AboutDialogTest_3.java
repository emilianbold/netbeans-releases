 ...
 */
public class AboutDialogTest_3 extends PerformanceTestCase {

    protected String MENU, ABOUT, DETAIL;

    /** Creates a new instance of About */
    public AboutDialogTest_3(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of About */
    public AboutDialogTest_3(String testName, String performanceDataName) {
