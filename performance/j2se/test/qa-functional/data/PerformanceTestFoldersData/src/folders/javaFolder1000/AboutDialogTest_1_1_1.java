 ...
 */
public class AboutDialogTest_1_1_1 extends PerformanceTestCase {

    protected String MENU, ABOUT, DETAIL;

    /** Creates a new instance of About */
    public AboutDialogTest_1_1_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of About */
    public AboutDialogTest_1_1_1(String testName, String performanceDataName) {
