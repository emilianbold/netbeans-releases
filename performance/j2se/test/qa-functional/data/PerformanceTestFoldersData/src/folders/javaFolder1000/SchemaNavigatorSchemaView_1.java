 ...
 */
public class SchemaNavigatorSchemaView_1  extends PerformanceTestCase {
    ...
    public SchemaNavigatorSchemaView_1(String testName) {
        super(testName);
        expectedTime = EXPECTED_TIME;
    }
    
    /** Creates a new instance of SchemaNavigatorDesignView */
    public SchemaNavigatorSchemaView_1(String testName, String performanceDataName) {
    ...
    public static Test suite() {
        return NbModuleSuite.create(
            NbModuleSuite.createConfiguration(SchemaNavigatorSchemaView.class)
            .addTest("measureTime")
            .enableModules(".*")
            .clusters(".*")
        );    
