 ...
 */
public class JavadocIndexSearchTest_1 extends PerformanceTestCase {

    private String BUNDLE, MENU, TITLE;

    /** Creates a new instance of JavadocIndexSearch */
    public JavadocIndexSearchTest_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of JavadocIndexSearch */
    public JavadocIndexSearchTest_1(String testName, String performanceDataName) {
