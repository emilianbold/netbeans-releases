 ...
 *
 */
public class OpenSchemaView_1 extends PerformanceTestCase {
    ...
    public OpenSchemaView_1(String testName) {
        super(testName);
    ...
    public OpenSchemaView_1(String testName, String  performanceDataName) {
