 ...
 */
public class VersioningWindowTest_4 extends PerformanceTestCase {

    private String MENU, NAME;
    

    /** Creates a new instance of VersioningWindow */
    public VersioningWindowTest_4(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of VersioningWindow */
    public VersioningWindowTest_4(String testName, String performanceDataName) {
