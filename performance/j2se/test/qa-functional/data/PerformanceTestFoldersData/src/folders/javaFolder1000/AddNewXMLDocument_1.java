 ...
 */
public class AddNewXMLDocument_1 extends PerformanceTestCase {
     ...
     */
    public AddNewXMLDocument_1(String testName) {
        super(testName);
        expectedTime = 10000;
     ...
     */
    public AddNewXMLDocument_1(String testName, String performanceDataName) {
