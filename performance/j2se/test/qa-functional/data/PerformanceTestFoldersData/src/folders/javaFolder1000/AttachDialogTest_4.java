 ...
 */
public class AttachDialogTest_4 extends PerformanceTestCase {

    private String MENU, TITLE;

    /** Creates a new instance of AttachDialog */
    public AttachDialogTest_4(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of AttachDialog */
    public AttachDialogTest_4(String testName, String performanceDataName) {
