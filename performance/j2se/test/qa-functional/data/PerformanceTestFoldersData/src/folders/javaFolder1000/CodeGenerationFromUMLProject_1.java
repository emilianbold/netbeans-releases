 ...
 *
 */
public class CodeGenerationFromUMLProject_1 extends PerformanceTestCase {
    ...
    public CodeGenerationFromUMLProject_1(String testName) {
        super(testName);
        expectedTime = 10000;
        WAIT_AFTER_OPEN = 4000;
    }

    public CodeGenerationFromUMLProject_1(String testName, String performanceDataName) {
