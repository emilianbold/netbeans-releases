 ...
 */
public class RefactorFindUsagesDialogTest_1_4 extends PerformanceTestCase {
    ...
    public RefactorFindUsagesDialogTest_1_4(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of RefactorFindUsagesDialog */
    public RefactorFindUsagesDialogTest_1_4(String testName, String performanceDataName) {
