 ...
 */
public class OpenJ2EEFilesWithOpenedEditorTest_1 extends OpenJ2EEFilesTest {
    
    /**
     * Creates a new instance of OpenFiles
     * @param testName the name of the test
     */
    public OpenJ2EEFilesWithOpenedEditorTest_1(String testName) {
        super(testName);
    }
     ...
     */
    public OpenJ2EEFilesWithOpenedEditorTest_1(String testName, String performanceDataName) {
