 ...
 */
public class CommentingCodeInEditorTest_1 extends PerformanceTestCase {
    ...
    public CommentingCodeInEditorTest_1(String testName) {
        super(testName);
        WAIT_AFTER_OPEN = 200;
    }
    
    /** Creates a new instance of TypingInEditor */
    public CommentingCodeInEditorTest_1(String testName, String performanceDataName) {
