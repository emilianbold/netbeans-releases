 ...
 */
public class ProjectsViewSubMenusTest_1 extends PerformanceTestCase {
    ...
    public ProjectsViewSubMenusTest_1(String testName) {
        super(testName);
        expectedTime = 250;
        WAIT_AFTER_OPEN = 500;
    }
    ...
    /** Creates a new instance of ProjectsViewPopupMenu */
    public ProjectsViewSubMenusTest_1(String testName, String performanceDataName) {
