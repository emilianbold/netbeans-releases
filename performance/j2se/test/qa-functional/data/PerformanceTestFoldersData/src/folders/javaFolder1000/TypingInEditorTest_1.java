 ...
 */
public class TypingInEditorTest_1 extends PerformanceTestCase {
    ...
    public TypingInEditorTest_1(String testName) {
        super(testName);
        WAIT_AFTER_OPEN = 200;
    }
    
    /** Creates a new instance of TypingInEditor */
    public TypingInEditorTest_1(String testName, String performanceDataName) {
