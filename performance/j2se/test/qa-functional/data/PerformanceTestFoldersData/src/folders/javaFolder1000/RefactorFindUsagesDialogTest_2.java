 ...
 */
public class RefactorFindUsagesDialogTest_2 extends PerformanceTestCase {
    ...
    public RefactorFindUsagesDialogTest_2(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of RefactorFindUsagesDialog */
    public RefactorFindUsagesDialogTest_2(String testName, String performanceDataName) {
