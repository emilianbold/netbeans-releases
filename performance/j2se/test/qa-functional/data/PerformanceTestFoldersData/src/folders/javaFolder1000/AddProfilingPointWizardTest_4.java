 ...
 */
public class AddProfilingPointWizardTest_4  extends PerformanceTestCase {
     ...
     * @param testName 
     */
    public AddProfilingPointWizardTest_4(String testName) {
        super(testName);
     ...
     */
    public AddProfilingPointWizardTest_4(String testName, String performanceDataName) {
