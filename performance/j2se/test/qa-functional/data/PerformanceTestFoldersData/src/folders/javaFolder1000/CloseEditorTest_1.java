 ...
 */
public class CloseEditorTest_1 extends PerformanceTestCase {
     ...
     */
    public CloseEditorTest_1(String testName) {
        super(testName);
     ...
     */
    public CloseEditorTest_1(String testName, String performanceDataName) {
