 ...
 */
public class ApplyDesignPattern_1  extends PerformanceTestCase {
    
    private Node processNode, schemaNode;
    private String schemaName;
    
    /** Creates a new instance of SchemaNavigatorDesignView */
    public ApplyDesignPattern_1(String testName) {
        super(testName);
    ...
    /** Creates a new instance of SchemaNavigatorDesignView */
    public ApplyDesignPattern_1(String testName, String performanceDataName) {
