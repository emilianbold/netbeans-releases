 ...
 */
public class AttachDialogTest_2 extends PerformanceTestCase {

    private String MENU, TITLE;

    /** Creates a new instance of AttachDialog */
    public AttachDialogTest_2(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of AttachDialog */
    public AttachDialogTest_2(String testName, String performanceDataName) {
