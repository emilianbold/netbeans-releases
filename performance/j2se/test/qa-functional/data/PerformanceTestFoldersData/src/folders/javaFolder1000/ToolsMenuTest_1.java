 ...
 */
public class ToolsMenuTest_1 extends MainMenuTest {
    
    protected static Node dataObjectNode;
    
    /** Creates a new instance of ToolsMenu */
    public ToolsMenuTest_1(String testName) {
        super(testName);
        expectedTime = UI_RESPONSE;
    }
    
    /** Creates a new instance of ToolsMenu */
    public ToolsMenuTest_1(String testName, String performanceDataName) {
