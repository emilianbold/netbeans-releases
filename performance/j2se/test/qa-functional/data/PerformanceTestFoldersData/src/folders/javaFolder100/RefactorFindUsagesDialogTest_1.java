 ...
 */
public class RefactorFindUsagesDialogTest_1 extends PerformanceTestCase {
    ...
    public RefactorFindUsagesDialogTest_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of RefactorFindUsagesDialog */
    public RefactorFindUsagesDialogTest_1(String testName, String performanceDataName) {
