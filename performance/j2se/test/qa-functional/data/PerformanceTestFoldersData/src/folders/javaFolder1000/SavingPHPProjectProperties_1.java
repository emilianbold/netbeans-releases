 ...
 */
public class SavingPHPProjectProperties_1  extends org.netbeans.modules.performance.utilities.PerformanceTestCase {
    ...
    public SavingPHPProjectProperties_1(String testName) {
        super(testName);        
        expectedTime = 1000;
    }
    
    public SavingPHPProjectProperties_1(String testName, String performanceDataName) {
