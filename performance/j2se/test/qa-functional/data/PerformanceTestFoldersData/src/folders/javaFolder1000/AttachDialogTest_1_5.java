 ...
 */
public class AttachDialogTest_1_5 extends PerformanceTestCase {

    private String MENU, TITLE;

    /** Creates a new instance of AttachDialog */
    public AttachDialogTest_1_5(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of AttachDialog */
    public AttachDialogTest_1_5(String testName, String performanceDataName) {
