 ...
 */
public class AddNewWSDLDocument_2 extends PerformanceTestCase {
     ...
     */
    public AddNewWSDLDocument_2(String testName) {
        super(testName);
        expectedTime = 10000;
     ...
     */
    public AddNewWSDLDocument_2(String testName, String performanceDataName) {
