 ...
 */
public class ToDoWindowTest_1_4 extends PerformanceTestCase {

    private String MENU, TITLE;
    

    /** Creates a new instance of ToDoWindow */
    public ToDoWindowTest_1_4(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of ToDoWindow */
    public ToDoWindowTest_1_4(String testName, String performanceDataName) {
