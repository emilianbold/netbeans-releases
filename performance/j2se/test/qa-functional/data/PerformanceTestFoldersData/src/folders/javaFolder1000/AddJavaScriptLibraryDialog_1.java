 ...
 */
public class AddJavaScriptLibraryDialog_1  extends org.netbeans.modules.performance.utilities.PerformanceTestCase {
    
    public static final String suiteName="Scripting UI Responsiveness Actions suite";
    protected String MENU, TITLE;
    
    public AddJavaScriptLibraryDialog_1(String testName) {
        super(testName);
        expectedTime = 18000;
        WAIT_AFTER_OPEN=20000;         
    }
    
    public AddJavaScriptLibraryDialog_1(String testName, String performanceDataName) {
