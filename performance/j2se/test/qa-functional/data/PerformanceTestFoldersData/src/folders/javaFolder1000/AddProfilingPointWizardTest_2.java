 ...
 */
public class AddProfilingPointWizardTest_2  extends PerformanceTestCase {
     ...
     * @param testName 
     */
    public AddProfilingPointWizardTest_2(String testName) {
        super(testName);
     ...
     */
    public AddProfilingPointWizardTest_2(String testName, String performanceDataName) {
