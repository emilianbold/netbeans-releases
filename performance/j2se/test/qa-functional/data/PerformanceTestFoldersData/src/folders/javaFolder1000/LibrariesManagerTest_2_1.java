 ...
 */
public class LibrariesManagerTest_2_1 extends PerformanceTestCase {

    private String MENU, TITLE;

    /** Creates a new instance of LibrariesManager */
    public LibrariesManagerTest_2_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of LibrariesManager */
    public LibrariesManagerTest_2_1(String testName, String performanceDataName) {
