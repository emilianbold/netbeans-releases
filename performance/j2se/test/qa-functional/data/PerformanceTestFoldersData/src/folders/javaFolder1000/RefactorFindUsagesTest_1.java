 ...
 */
public class RefactorFindUsagesTest_1 extends PerformanceTestCase {
    ...
    public RefactorFindUsagesTest_1(String testName) {
        super(testName);
        expectedTime = 120000; // the action has progress indication and it is expected it will last
    }
    
    /** Creates a new instance of RefactorFindUsagesDialog */
    public RefactorFindUsagesTest_1(String testName, String performanceDataName) {
