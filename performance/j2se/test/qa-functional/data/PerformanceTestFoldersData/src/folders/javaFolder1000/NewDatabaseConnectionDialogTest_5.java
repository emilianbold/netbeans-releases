 ...
 */
public class NewDatabaseConnectionDialogTest_5 extends PerformanceTestCase {
    ...
    public NewDatabaseConnectionDialogTest_5(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of NewDatabaseConnectionDialog */
    public NewDatabaseConnectionDialogTest_5(String testName, String performanceDataName) {
