 ...
 */
public class RubyGemsDialog_1 extends org.netbeans.modules.performance.utilities.PerformanceTestCase {
    public static final String suiteName="Scripting UI Responsiveness Dialogs suite";
    protected String MENU, TITLE;
    
    public RubyGemsDialog_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
       
    }
    
    public RubyGemsDialog_1(String testName, String performanceDataName) {
