 ...
 */
public class PluginManagerTest_2 extends PerformanceTestCase {

    protected String BUNDLE, MENU, TITLE;
    
    /** Creates a new instance of PluginManager */
    public PluginManagerTest_2(String testName) {
        super(testName);
    ...
    /** Creates a new instance of PluginManager */
    public PluginManagerTest_2(String testName, String performanceDataName) {
