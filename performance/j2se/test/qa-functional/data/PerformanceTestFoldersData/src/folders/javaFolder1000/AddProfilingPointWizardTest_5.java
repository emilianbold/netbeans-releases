 ...
 */
public class AddProfilingPointWizardTest_5  extends PerformanceTestCase {
     ...
     * @param testName 
     */
    public AddProfilingPointWizardTest_5(String testName) {
        super(testName);
     ...
     */
    public AddProfilingPointWizardTest_5(String testName, String performanceDataName) {
