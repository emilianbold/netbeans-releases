 ...
 *
 */
public class SelectingMultipleNodes_1 extends PerformanceTestCase {
    ...
    public SelectingMultipleNodes_1(String testName) {
        super(testName);
        expectedTime = 2000;
    ...
    public SelectingMultipleNodes_1(String testName, String performanceDataName) {
