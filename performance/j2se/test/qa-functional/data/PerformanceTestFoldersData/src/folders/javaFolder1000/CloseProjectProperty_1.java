 ...
 */
public class CloseProjectProperty_1 extends PerformanceTestCase {
     ...
     */
    public CloseProjectProperty_1(String testName) {
        super(testName);
        expectedTime = 10000;
     ...
     */
    public CloseProjectProperty_1(String testName, String performanceDataName) {
