 ...
 */
public class AddNewXMLDocument_2 extends PerformanceTestCase {
     ...
     */
    public AddNewXMLDocument_2(String testName) {
        super(testName);
        expectedTime = 10000;
     ...
     */
    public AddNewXMLDocument_2(String testName, String performanceDataName) {
