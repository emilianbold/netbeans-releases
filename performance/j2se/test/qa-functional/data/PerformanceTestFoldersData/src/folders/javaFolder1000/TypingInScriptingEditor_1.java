 ...
 */
public class TypingInScriptingEditor_1 extends org.netbeans.modules.performance.utilities.PerformanceTestCase {
    ...
    public TypingInScriptingEditor_1(String testName) {
        super(testName);
        expectedTime = UI_RESPONSE;       
        HEURISTIC_FACTOR = -1; // use default WaitAfterOpen for all iterations             
    }
    public TypingInScriptingEditor_1(String testName, String performanceDataName) {
