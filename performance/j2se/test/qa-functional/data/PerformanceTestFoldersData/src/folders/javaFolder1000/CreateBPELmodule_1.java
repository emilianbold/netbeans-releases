 ...
 */
public class CreateBPELmodule_1 extends PerformanceTestCase {
     ...
     */
    public CreateBPELmodule_1(String testName) {
        super(testName);
        expectedTime = 10000;
     ...
     */
    public CreateBPELmodule_1(String testName, String performanceDataName) {
