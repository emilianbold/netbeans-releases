 ...
 *
 */
public class DeployProject_1_1 extends PerformanceTestCase {
    ...
    public DeployProject_1_1(String testName) {
        super(testName);
    ...
    public DeployProject_1_1(String testName, String  performanceDataName) {
...
//        new CloseAllDocumentsAction().performAPI();
    ...
    public static Test suite() {
        return NbModuleSuite.create(
            NbModuleSuite.createConfiguration(DeployProject.class)
            .addTest("measureTime")
            .enableModules(".*")
            .clusters(".*")
        );    
