 ...
 */
public class ProxyConfigurationTest_1 extends PerformanceTestCase {
    ...
    public ProxyConfigurationTest_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of ProxyConfiguration */
    public ProxyConfigurationTest_1(String testName, String performanceDataName) {
