 ...
 */
public class AddServerInstanceDialogTest_1 extends PerformanceTestCase {

    private String MENU, TITLE;
    private Node thenode;

    /** Creates a new instance of AddServerInstanceDialog */
    public AddServerInstanceDialogTest_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of AddServerInstanceDialog */
    public AddServerInstanceDialogTest_1(String testName, String performanceDataName) {
