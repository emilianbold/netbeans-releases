 ...
 */
public class SwitchToSchemaView_1  extends PerformanceTestCase {
    ...
    public SwitchToSchemaView_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of SwitchSchemaView */
    public SwitchToSchemaView_1(String testName, String performanceDataName) {
    ...
    public static Test suite() {
        return NbModuleSuite.create(
            NbModuleSuite.createConfiguration(SwitchToSchemaView.class)
            .addTest("measureTime")
            .enableModules(".*")
            .clusters(".*")
        );    
