 ...
 */
public class DocumentsDialogTest_1 extends PerformanceTestCase {

    private static EditorOperator editor;

    /** Creates a new instance of DocumentsDialog */
    public DocumentsDialogTest_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of DocumentsDialog */
    public DocumentsDialogTest_1(String testName, String performanceDataName) {
