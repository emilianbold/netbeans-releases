 ...
 */
public class AddJDBCDriverDialogTest_1_1_2 extends PerformanceTestCase {

    private String BUNDLE, MENU, TITLE;
    private Node thenode;

    /** Creates a new instance of AddJDBCDriverDialog */
    public AddJDBCDriverDialogTest_1_1_2(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of AddJDBCDriverDialog */
    public AddJDBCDriverDialogTest_1_1_2(String testName, String performanceDataName) {
