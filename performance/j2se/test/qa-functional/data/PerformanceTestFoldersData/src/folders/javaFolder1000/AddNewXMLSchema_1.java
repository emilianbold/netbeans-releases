 ...
 */
public class AddNewXMLSchema_1 extends PerformanceTestCase {
     ...
     */
    public AddNewXMLSchema_1(String testName) {
        super(testName);
        expectedTime = 10000;
     ...
     */
    public AddNewXMLSchema_1(String testName, String performanceDataName) {
...
//        new CloseAllDocumentsAction().performAPI();
    ...
    public static Test suite() {
        return NbModuleSuite.create(
            NbModuleSuite.createConfiguration(AddNewXMLSchema.class)
            .addTest("measureTime")
            .enableModules(".*")
            .clusters(".*")
            .reuseUserDir(true)
