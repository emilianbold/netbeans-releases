 ...
 */
public class NewDatabaseConnectionDialogTest_4 extends PerformanceTestCase {
    ...
    public NewDatabaseConnectionDialogTest_4(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of NewDatabaseConnectionDialog */
    public NewDatabaseConnectionDialogTest_4(String testName, String performanceDataName) {
