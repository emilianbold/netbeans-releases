 ...
 *
 */
public class OpenUMLDiagram_1_1 extends PerformanceTestCase {
    ...
    public OpenUMLDiagram_1_1(String testName) {
        super(testName);
        expectedTime = 2000;
        WAIT_AFTER_OPEN = 4000;
    }

    public OpenUMLDiagram_1_1(String testName, String performanceDataName) {
