 ...
 */
public class VersioningWindowTest_3 extends PerformanceTestCase {

    private String MENU, NAME;
    

    /** Creates a new instance of VersioningWindow */
    public VersioningWindowTest_3(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of VersioningWindow */
    public VersioningWindowTest_3(String testName, String performanceDataName) {
