 ...
 * 
 */
public class SwitchViewTest_1  extends PerformanceTestCase {
    
        private String operator;
        private int ke;

    /** Creates a new instance of SwitchToFile */
    public SwitchViewTest_1(String testName) {
        super(testName);
    ...
    public SwitchViewTest_1(String testName, String performanceDataName) {
