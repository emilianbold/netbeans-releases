 ...
 */
public class OpenUMLProject_1 extends PerformanceTestCase {
     ...
     */
    public OpenUMLProject_1(String testName) {
        super(testName);
        expectedTime = 10000;
     ...
     */
    public OpenUMLProject_1(String testName, String performanceDataName) {
