 ...
 */
public class VersioningWindowTest_1_1 extends PerformanceTestCase {

    private String MENU, NAME;
    

    /** Creates a new instance of VersioningWindow */
    public VersioningWindowTest_1_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of VersioningWindow */
    public VersioningWindowTest_1_1(String testName, String performanceDataName) {
