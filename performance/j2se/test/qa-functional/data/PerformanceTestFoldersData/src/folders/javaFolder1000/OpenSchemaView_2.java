 ...
 *
 */
public class OpenSchemaView_2 extends PerformanceTestCase {
    ...
    public OpenSchemaView_2(String testName) {
        super(testName);
    ...
    public OpenSchemaView_2(String testName, String  performanceDataName) {
