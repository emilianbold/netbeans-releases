 ...
 */
public class SwitchToDesignView_1  extends PerformanceTestCase {
    ...
    public SwitchToDesignView_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of SwitchSchemaView */
    public SwitchToDesignView_1(String testName, String performanceDataName) {
