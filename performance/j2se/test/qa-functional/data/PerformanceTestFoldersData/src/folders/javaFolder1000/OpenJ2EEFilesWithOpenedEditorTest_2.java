 ...
 */
public class OpenJ2EEFilesWithOpenedEditorTest_2 extends OpenJ2EEFilesTest {
    
    /**
     * Creates a new instance of OpenFiles
     * @param testName the name of the test
     */
    public OpenJ2EEFilesWithOpenedEditorTest_2(String testName) {
        super(testName);
    }
     ...
     */
    public OpenJ2EEFilesWithOpenedEditorTest_2(String testName, String performanceDataName) {
