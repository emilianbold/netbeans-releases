 ...
 *
 */
public class CreateEmptyDiagram_1 extends PerformanceTestCase {
    ...
    public CreateEmptyDiagram_1(String testName) {
        super(testName);
        expectedTime = 5000;
        WAIT_AFTER_OPEN = 4000;
    }

    public CreateEmptyDiagram_1(String testName, String performanceDataName) {
