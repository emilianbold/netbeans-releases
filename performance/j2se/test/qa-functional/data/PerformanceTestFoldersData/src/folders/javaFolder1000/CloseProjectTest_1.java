 ...
 */
public class CloseProjectTest_1 extends org.netbeans.modules.performance.utilities.PerformanceTestCase {
    public static final String suiteName="Scripting UI Responsiveness Actions suite";
    private static String projectName; 
    protected static ProjectsTabOperator projectsTab = null;
    
    public CloseProjectTest_1(String testName) {
        super(testName);
    }

    public CloseProjectTest_1(String testName, String performanceDataName) {
