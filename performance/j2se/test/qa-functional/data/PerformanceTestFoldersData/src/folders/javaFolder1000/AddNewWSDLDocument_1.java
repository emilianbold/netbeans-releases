 ...
 */
public class AddNewWSDLDocument_1 extends PerformanceTestCase {
     ...
     */
    public AddNewWSDLDocument_1(String testName) {
        super(testName);
        expectedTime = 10000;
     ...
     */
    public AddNewWSDLDocument_1(String testName, String performanceDataName) {
