 ...
 */
public class HttpMonitorWindowTest_1_4 extends PerformanceTestCase {

    private String MENU, TITLE;

    /** Creates a new instance of HttpMonitorWindow */
    public HttpMonitorWindowTest_1_4(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of HttpMonitorWindow */
    public HttpMonitorWindowTest_1_4(String testName, String performanceDataName) {
