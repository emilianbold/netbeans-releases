 ...
 */
public class ProxyConfigurationTest_2_1 extends PerformanceTestCase {
    ...
    public ProxyConfigurationTest_2_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of ProxyConfiguration */
    public ProxyConfigurationTest_2_1(String testName, String performanceDataName) {
