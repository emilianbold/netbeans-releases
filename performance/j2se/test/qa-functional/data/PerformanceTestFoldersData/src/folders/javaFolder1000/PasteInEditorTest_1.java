 ...
 */
public class PasteInEditorTest_1 extends PerformanceTestCase {
    
    private EditorOperator editorOperator1, editorOperator2;
    
    /** Creates a new instance of PasteInEditor */
    public PasteInEditorTest_1(String testName) {
        super(testName);
    ...
    /** Creates a new instance of PasteInEditor */
    public PasteInEditorTest_1(String testName, String performanceDataName) {
