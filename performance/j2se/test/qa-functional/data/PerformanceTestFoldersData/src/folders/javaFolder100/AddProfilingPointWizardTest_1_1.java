 ...
 */
public class AddProfilingPointWizardTest_1_1  extends PerformanceTestCase {
     ...
     * @param testName 
     */
    public AddProfilingPointWizardTest_1_1(String testName) {
        super(testName);
     ...
     */
    public AddProfilingPointWizardTest_1_1(String testName, String performanceDataName) {
