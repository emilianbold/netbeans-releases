 ...
 */
public class ProxyConfigurationTest_4 extends PerformanceTestCase {
    ...
    public ProxyConfigurationTest_4(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of ProxyConfiguration */
    public ProxyConfigurationTest_4(String testName, String performanceDataName) {
