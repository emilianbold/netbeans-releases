 ...
 */
public class MIDletViewsSwitch_1 extends PerformanceTestCase {
    ...
    public MIDletViewsSwitch_1(String testName) {
        super(testName);
    ...
    public MIDletViewsSwitch_1(String testName, String performanceDataName) {
