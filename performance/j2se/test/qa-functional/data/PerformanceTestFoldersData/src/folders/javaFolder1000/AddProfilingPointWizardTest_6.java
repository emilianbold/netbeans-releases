 ...
 */
public class AddProfilingPointWizardTest_6  extends PerformanceTestCase {
     ...
     * @param testName 
     */
    public AddProfilingPointWizardTest_6(String testName) {
        super(testName);
     ...
     */
    public AddProfilingPointWizardTest_6(String testName, String performanceDataName) {
