 ...
 */
public class AddNewBpelProcess_1 extends PerformanceTestCase {
     ...
     */
    public AddNewBpelProcess_1(String testName) {
        super(testName);
        expectedTime = 10000;
     ...
     */
    public AddNewBpelProcess_1(String testName, String performanceDataName) {
