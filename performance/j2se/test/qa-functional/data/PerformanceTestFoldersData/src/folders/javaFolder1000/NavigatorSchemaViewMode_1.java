 ...
 */
public class NavigatorSchemaViewMode_1  extends PerformanceTestCase {
    ...
    public NavigatorSchemaViewMode_1(String testName) {
        super(testName);
        expectedTime = EXPECTED_TIME; 
    }
    
    public NavigatorSchemaViewMode_1(String testName, String performanceDataName) {
