 ...
 */
public class NewDatabaseConnectionDialogTest_1_1 extends PerformanceTestCase {
    ...
    public NewDatabaseConnectionDialogTest_1_1(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of NewDatabaseConnectionDialog */
    public NewDatabaseConnectionDialogTest_1_1(String testName, String performanceDataName) {
