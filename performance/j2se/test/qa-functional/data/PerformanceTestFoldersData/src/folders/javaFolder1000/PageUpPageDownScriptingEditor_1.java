 ...
 */
public class PageUpPageDownScriptingEditor_1 extends org.netbeans.modules.performance.utilities.PerformanceTestCase {
    ...
    public PageUpPageDownScriptingEditor_1(String testName) {
        super(testName);
        expectedTime = UI_RESPONSE;
        WAIT_AFTER_OPEN = 200;        
    }
    public PageUpPageDownScriptingEditor_1(String testName, String performanceDataName) {
