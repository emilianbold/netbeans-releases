 ...
 */
public class RefactorFindUsagesDialogTest_5 extends PerformanceTestCase {
    ...
    public RefactorFindUsagesDialogTest_5(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of RefactorFindUsagesDialog */
    public RefactorFindUsagesDialogTest_5(String testName, String performanceDataName) {
