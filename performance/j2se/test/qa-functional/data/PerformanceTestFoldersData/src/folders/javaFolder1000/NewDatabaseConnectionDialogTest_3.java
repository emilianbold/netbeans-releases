 ...
 */
public class NewDatabaseConnectionDialogTest_3 extends PerformanceTestCase {
    ...
    public NewDatabaseConnectionDialogTest_3(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of NewDatabaseConnectionDialog */
    public NewDatabaseConnectionDialogTest_3(String testName, String performanceDataName) {
