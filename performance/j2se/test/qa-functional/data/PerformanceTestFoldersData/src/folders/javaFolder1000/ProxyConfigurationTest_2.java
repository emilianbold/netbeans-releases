 ...
 */
public class ProxyConfigurationTest_2 extends PerformanceTestCase {
    ...
    public ProxyConfigurationTest_2(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of ProxyConfiguration */
    public ProxyConfigurationTest_2(String testName, String performanceDataName) {
