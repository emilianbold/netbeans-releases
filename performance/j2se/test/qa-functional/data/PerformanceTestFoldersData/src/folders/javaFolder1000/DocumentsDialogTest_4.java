 ...
 */
public class DocumentsDialogTest_4 extends PerformanceTestCase {

    private static EditorOperator editor;

    /** Creates a new instance of DocumentsDialog */
    public DocumentsDialogTest_4(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of DocumentsDialog */
    public DocumentsDialogTest_4(String testName, String performanceDataName) {
