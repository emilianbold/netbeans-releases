 ...
 */
public class RefactorFindUsagesDialogTest_3 extends PerformanceTestCase {
    ...
    public RefactorFindUsagesDialogTest_3(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of RefactorFindUsagesDialog */
    public RefactorFindUsagesDialogTest_3(String testName, String performanceDataName) {
