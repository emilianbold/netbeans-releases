 ...
 */
public class CreateMIDlet_1 extends PerformanceTestCase {
     ...
     */
    public CreateMIDlet_1(String testName) {
        super(testName);
        expectedTime = 10000;
     ...
     */
    public CreateMIDlet_1(String testName, String performanceDataName) {
