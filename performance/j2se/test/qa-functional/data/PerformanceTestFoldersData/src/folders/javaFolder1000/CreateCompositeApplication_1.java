 ...
 */
public class CreateCompositeApplication_1 extends PerformanceTestCase {
     ...
     */
    public CreateCompositeApplication_1(String testName) {
        super(testName);
        expectedTime = 10000;
     ...
     */
    public CreateCompositeApplication_1(String testName, String performanceDataName) {
