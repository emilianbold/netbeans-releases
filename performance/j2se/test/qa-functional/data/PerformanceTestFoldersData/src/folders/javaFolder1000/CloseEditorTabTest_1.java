 ...
 */
public class CloseEditorTabTest_1 extends PerformanceTestCase {
     ...
     */
    public CloseEditorTabTest_1(String testName) {
        super(testName);
     ...
     */
    public CloseEditorTabTest_1(String testName, String performanceDataName) {
    ...
    public ComponentOperator open(){
        new CloseViewAction().performMenu(new EditorOperator("ViewRegisters.java"));
        return null;
    }
