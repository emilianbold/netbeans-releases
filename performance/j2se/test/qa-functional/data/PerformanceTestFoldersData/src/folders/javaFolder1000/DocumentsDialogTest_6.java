 ...
 */
public class DocumentsDialogTest_6 extends PerformanceTestCase {

    private static EditorOperator editor;

    /** Creates a new instance of DocumentsDialog */
    public DocumentsDialogTest_6(String testName) {
        super(testName);
        expectedTime = WINDOW_OPEN;
    }
    
    /** Creates a new instance of DocumentsDialog */
    public DocumentsDialogTest_6(String testName, String performanceDataName) {
