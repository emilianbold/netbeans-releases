...
public class SimpleNode implements Node {
  ...
  public SimpleNode(BDEParser p, int i) {
    this(i);
    parser = p;
  }
  ...
  /** Accept the visitor. **/
  public Object childrenAccept(BDEParserVisitor visitor, Object data) throws Exception {
    if (children != null) {
  ...
  public String toString() { return BDEParserTreeConstants.jjtNodeName[id]; }
