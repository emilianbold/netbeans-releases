 ...
 *
 */
public class StartAppserverTest extends PerformanceTestCase {
     ...
     *  @param testName
     **/
    public StartAppserverTest(String testName) {
        super(testName);
     ...
     **/
    public StartAppserverTest(String testName, String  performanceDataName) {
    ...
    public static NbTestSuite suite() {
        ...
        suite.addTest(NbModuleSuite.create(NbModuleSuite.createConfiguration(EnterpriseSetup.class)
             .addTest(StartAppserverTest.class)
