...
public class MeasureJ2EESetupTest {
	...
	suite.addTest(NbModuleSuite.create(NbModuleSuite.createConfiguration(J2EESetup.class).enableModules(".*").clusters("ergonomics[0-9]|websvccommon[0-9]|apisupport[0-9]|profiler[0-9]|gsf[0-9]|webcommon[0-9]|xml[0-9]|enterprise[0-9]").reuseUserDir(false)));
        return suite;
    }
