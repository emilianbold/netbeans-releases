 ...
 */
public class ComplexMobilityProjectStartup extends MeasureStartupTimeTestCase {
    
    /** Define testcase
     * @param testName name of the testcase
     */
    public ComplexMobilityProjectStartup(String testName) {
        super(testName);
    }
    ...
    public void testStartIDE() throws java.io.IOException {
        measureComplexStartupTime("Startup Time with opened Mobility project");
    }
