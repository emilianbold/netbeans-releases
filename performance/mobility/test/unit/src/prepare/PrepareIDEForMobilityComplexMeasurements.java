...
//        err = System.out;
    ...
    public void openProjects() {
        try {
            ...
            ProjectSupport.openProject(projectsLocation + "MobileApplicationSwitchConfiguration");
            ProjectSupport.waitScanFinished();
            ProjectSupport.openProject(projectsLocation + "MobileApplicationVisualMIDlet");
            ProjectSupport.waitScanFinished();
        }catch(Exception exc){
            test_failed = true;
            fail(exc);
