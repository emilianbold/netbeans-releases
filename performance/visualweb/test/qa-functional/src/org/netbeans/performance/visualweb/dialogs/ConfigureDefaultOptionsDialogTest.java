 ...
 */
public class ConfigureDefaultOptionsDialogTest extends JSFComponentOptionsDialog {

    /** Creates a new instance of ConfigureDefaultOptionsDialogTest */
    public ConfigureDefaultOptionsDialogTest(String testName) {
        super(testName);
    ...
    public ConfigureDefaultOptionsDialogTest(String testName, String performanceDataName) {
