 ...
 */
public class ComponentStyleDialogTest extends JSFComponentOptionsDialog {
     ...
     * @param testName
     */
    public ComponentStyleDialogTest(String testName) {
        super(testName);
     ...
     */
    public ComponentStyleDialogTest(String testName, String performanceDataName) {
