 ...
 */
public class PropertyBindingDialogTest extends JSFComponentOptionsDialog {

    /** Creates a new instance of PropertyBindingDialog */
    public PropertyBindingDialogTest(String testName) {
        super(testName);
    ...
    public PropertyBindingDialogTest(String testName, String performanceDataName) {
