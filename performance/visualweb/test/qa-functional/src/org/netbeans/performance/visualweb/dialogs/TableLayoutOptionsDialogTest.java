 ...
 */
public class TableLayoutOptionsDialogTest extends JSFComponentOptionsDialog {

    /** Creates a new instance of TableLayoutOptionsDialog */
    public TableLayoutOptionsDialogTest(String testName) {
        super(testName);
     ...
     */
    public TableLayoutOptionsDialogTest(String testName, String performanceDataName) {
