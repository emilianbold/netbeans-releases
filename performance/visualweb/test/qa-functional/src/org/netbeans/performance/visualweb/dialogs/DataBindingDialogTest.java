 ...
 */
public class DataBindingDialogTest extends JSFComponentOptionsDialog {

    /** Creates a new instance of DataBindingDialogTest */
    public DataBindingDialogTest(String testName) {
        super(testName);
    ...
    public DataBindingDialogTest(String testName, String performanceDataName) {
