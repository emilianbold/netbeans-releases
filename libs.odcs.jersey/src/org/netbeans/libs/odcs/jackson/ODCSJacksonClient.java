...
public class ODCSJacksonClient implements ODCSClient {
    ...
    public ODCSJacksonClient(String url, PasswordAuthentication pa) {
    ...
    private <T> T runGet(Class<T> t, String service) throws ODCSException {
    ...
    private <T> T runPost(Class<T> t, String service, Object content) throws ODCSException {
