 ...
 * @author tomas
 */
public abstract class AbstractODCSClientTest extends NbTestCase {
    ...
    public static Test suite() {
        return NbModuleSuite
                    .emptyConfiguration()
                    .gui(false)
                    .addTest(AbstractODCSClientTest.class)
                    .suite();
    }
    
    public AbstractODCSClientTest(String testName) {
        super(testName);
    }
...
//    }
    ...
    abstract protected ODCSClient getClient();
