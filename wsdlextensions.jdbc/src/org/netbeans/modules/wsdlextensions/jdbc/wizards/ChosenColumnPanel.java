 ...
 */
public class ChosenColumnPanel extends JPanel implements JDBCTableColumnDisplayable {
    ...
    class RowDataWrapper {
        ...
        public void setSelected(final Boolean isSelected) {
            this.tcolumn.setChooseSelected(isSelected.booleanValue());
        }
    }
    ...
    public List getSelectedColumnTables() {
        final List selColumns = new ArrayList();
        for (int cnt = 0; cnt < ((MyTColumnModel) this.metaDataTColumn.getModel()).getRowCount(); cnt++) {
            if (((MyTColumnModel) this.metaDataTColumn.getModel()).getRowDataWrapper(cnt).isSelected().booleanValue()) {
                selColumns.add((((MyTColumnModel) this.metaDataTColumn.getModel()).getRowDataWrapper(cnt)).getTColumn());
            }
        }
        return selColumns;
    }
    ...
    private void initWhereClause() {
        ...
        whereLabel.setText(org.openide.util.NbBundle.getMessage(ChosenColumnPanel.class, "whereLabel.text")); // NOI18N
        jPanel1.add(whereLabel);

        whereTextField.setText(org.openide.util.NbBundle.getMessage(ChosenColumnPanel.class, "whereTextField.text")); // NOI18N
        whereTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                whereTextFieldActionPerformed(evt);
            }
        });
        jPanel1.add(whereTextField);
    }// </editor-fold>

	private void whereTextFieldActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    javax.swing.JTextField whereTextField;
