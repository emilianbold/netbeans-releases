...
public class JDBCWizardTransferPanel extends JPanel implements ActionListener, WizardDescriptor.Panel {
     ...
     *
     */
    private JDBCWizardTransferDescriptorPanel mWizardPanel = null;
...
//        JDBCWizardTransferPanel.this.tablePanel.resetTable(this.selTableList);
    ...
    public JDBCWizardTransferPanel(JDBCWizardTransferDescriptorPanel wizardPanel,
            final String title) {
        super();
    ...
    public void storeSettings(final Object settings) {
        ...
        this.tablePanel.storeSettings(settings);
