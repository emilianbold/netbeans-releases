 ...
 * @author jalmero
 */
public class StoredProcedureDescriptorPanel extends WSDLWizardDescriptorPanel {
     ...
     */
    private StoredProceduresPanel mPanel;    
    
    String mTitle = "";
    
    public StoredProcedureDescriptorPanel(WSDLWizardContext context,
            String title) {
        super(context);
        mTitle = title;
    ...
    public StoredProcedureDescriptorPanel(String title) {
        this(null, title);
    }
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new StoredProceduresPanel(this, mTitle);
        }         
