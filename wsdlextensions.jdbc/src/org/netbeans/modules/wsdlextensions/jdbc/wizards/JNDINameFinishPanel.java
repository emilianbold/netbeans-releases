...
public class JNDINameFinishPanel extends JNDINamePanel implements WizardDescriptor.FinishablePanel {
     ...
     * 
     */
    private JNDINameFinishDescriptorPanel mWizardPanel = null;  
    ...
    public JNDINameFinishPanel(JNDINameFinishDescriptorPanel wizardPanel,
            final String title) {
        this(title);
    ...
    public void setWSDLComponent(WSDLComponent wsdlComponent) {
        super.setWSDLComponent(wsdlComponent);
    }
}
