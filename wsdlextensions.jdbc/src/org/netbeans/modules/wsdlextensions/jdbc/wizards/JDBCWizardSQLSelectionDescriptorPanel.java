 ...
 * @author jalmero
 */
public class JDBCWizardSQLSelectionDescriptorPanel extends WSDLWizardDescriptorPanel {
    
    public JDBCWizardSQLSelectionDescriptorPanel(WSDLWizardContext context,
            String title) {
        super(context);
        mTitle = title;
    }
     ...
     */
    private JDBCWizardSQLSelectionPanel mPanel;    
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new JDBCWizardSQLSelectionPanel(this, mTitle);
        }         
