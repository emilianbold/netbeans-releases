...
public class UpdateColumnPanel extends JPanel implements JDBCTableColumnDisplayable {
    ...
    private void initWhereClause() {
        ...
        whereLabel.setText(org.openide.util.NbBundle.getMessage(UpdateColumnPanel.class, "whereLabel.text")); // NOI18N
        jPanel1.add(whereLabel);

        whereTextField.setText(org.openide.util.NbBundle.getMessage(UpdateColumnPanel.class, "whereTextField.text")); // NOI18N
