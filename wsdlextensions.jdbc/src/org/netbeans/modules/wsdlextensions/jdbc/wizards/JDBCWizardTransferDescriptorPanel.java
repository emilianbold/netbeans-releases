 ...
 * @author jalmero
 */
public class JDBCWizardTransferDescriptorPanel extends WSDLWizardDescriptorPanel {
    
    public JDBCWizardTransferDescriptorPanel(WSDLWizardContext context,
            String title) {
        super(context);
        mTitle = title;
    }
     ...
     */
    private JDBCWizardTransferPanel mPanel;
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new JDBCWizardTransferPanel(this, mTitle);
        }         
