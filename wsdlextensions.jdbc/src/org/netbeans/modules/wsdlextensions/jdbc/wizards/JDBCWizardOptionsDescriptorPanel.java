 ...
 * @author jalmero
 */
public class JDBCWizardOptionsDescriptorPanel extends WSDLWizardDescriptorPanel {
    
    public JDBCWizardOptionsDescriptorPanel(WSDLWizardContext context,
            String title) {
        super(context);
        mTitle = title;
    }
     ...
     */
    private JDBCWizardOptionsPanel mPanel;
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new JDBCWizardOptionsPanel(this, mTitle);
        }         
    ...
    public boolean isTableSelected() {
        return mPanel.isTableSelected();
    }
    
    public boolean isPreparedStatementsSelected() {
        return mPanel.isPreparedStatementsSelected();
    }
    
    public boolean isProceduresSelected() {
        return mPanel.isProceduresSelected();
    }  
    
    public boolean isSQLFileSelected() {
        return mPanel.isSQLFileSelected();
    }      
    
    public DatabaseConnection getConnection() {
        return mPanel.getConnection();
    }    
    
    public void setSelection(String val) {
        mPanel.setSelection(val);
    }
}
