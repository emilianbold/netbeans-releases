 ...
 * @author jalmero
 */
public class JDBCWizardTableSelectionDescriptorPanel extends WSDLWizardDescriptorPanel {
     ...
     */
    private JDBCWizardTableSelectionPanel mPanel;    
    
    String mTitle = "";
    
    public JDBCWizardTableSelectionDescriptorPanel(WSDLWizardContext context,
            String title) {
        super(context);
        mTitle = title;
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new JDBCWizardTableSelectionPanel(this, mTitle);
            mPanel.initialize();
        }         
