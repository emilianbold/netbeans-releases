 ...
 * @author
 */
//TODOfinal class SimpleTargetChooserPanel implements WizardDescriptor.FinishablePanel, ChangeListener {
final class SimpleTargetChooserPanel extends WSDLWizardDescriptorPanel implements ChangeListener {
...
//    private final WizardDescriptor.Panel bottomPanel;
    private WizardDescriptor.Panel bottomPanel = null;
...
//    private final boolean isFolder;
    ...
    public SimpleTargetChooserPanel(WSDLWizardContext context) {
        super(context);
    }
     ...
     */
    SimpleTargetChooserPanel(WSDLWizardContext context, Project project, SourceGroup[] folders, WizardDescriptor.Panel bottomPanel,
            boolean isFolder) {
        super(context);
...
//    }
    ...
    public String getName() {
        return "SimpleTargetChooserPanel";
    }
...
//               commented below because this class is no longer shown as
//               the New Wizard from WSDL Wizard is used instead        
//        if (this.isValid()) {
//            if (this.bottomPanel != null) {
