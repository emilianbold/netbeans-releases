 ...
 * @author skini
 */
public class JDBCRenameRefactorVisitor extends ChildVisitor implements WSDLVisitor, JDBCComponent.Visitor {
    private Referenceable referenced;
    private String oldName;
    
    public JDBCRenameRefactorVisitor(Referenceable referenced, String oldName) {
    ...
    public void visit(JDBCOperationOutput target) {
        if (referenced instanceof Part) {
            target.setReturnPartName(((Part) referenced).getName());
        }
    }
