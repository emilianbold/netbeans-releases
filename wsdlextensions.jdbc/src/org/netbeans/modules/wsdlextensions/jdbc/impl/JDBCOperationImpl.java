 ...
 *
 */
public class JDBCOperationImpl extends JDBCComponentImpl implements JDBCOperation {
    
    public JDBCOperationImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
    public JDBCOperationImpl(WSDLModel model){
        this(model, createPrefixedElement(JDBCQName.OPERATION.getQName(), model));
    }
