 ...
 *
 */
public class JDBCBindingImpl extends JDBCComponentImpl implements JDBCBinding {
    public JDBCBindingImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
    public JDBCBindingImpl(WSDLModel model){
        this(model, createPrefixedElement(JDBCQName.BINDING.getQName(), model));
    }
