...
public class DBColumnImpl implements DBColumn, Cloneable, Comparable {
    ...
    protected boolean deleteSelected = true;
    ...
    public boolean isSelected() {
        return this.insertSelected && this.updateSelected && this.chooseSelected && this.pollSelected && this.deleteSelected;
    }
    ...
    public void setDeleteSelected(final boolean cselect) {
        this.deleteSelected = cselect;
    }
    ...
    public void setSelected(final boolean cselect) {
        ...
        this.setDeleteSelected(cselect);
    }
