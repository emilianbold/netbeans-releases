 ...
 * @author narayanaa
 */
public class MySQLQueryGenerator implements DBQueryModel {
    ...
    private static final Logger mLog = Logger.getLogger(MySQLQueryGenerator.class.getName());
    ...
    private static final MySQLQueryGenerator instance = new MySQLQueryGenerator();
    
    public static final MySQLQueryGenerator getInstance(){
    	if(instance != null)
    		return instance;
    	else
    ...
    public String createInsertQuery() throws Exception {
        ...
        MySQLQueryGenerator.mLog.log(Level.INFO, "Generated Insert Query " + sb.toString());
        return sb.toString();
    }
    ...
    public String createUpdateQuery(String where) throws Exception {
        ...
        MySQLQueryGenerator.mLog.log(Level.INFO, "Generated Update Query " + sb.toString());
        return sb.toString();
    }
    ...
    public String createDeleteQuery(String where) throws Exception {
        ...
        MySQLQueryGenerator.mLog.log(Level.INFO, "Generated Delete Query " + sb.toString());
        return sb.toString();
    }
    ...
    public String createFindQuery(String where) throws Exception {
        ...
        MySQLQueryGenerator.mLog.log(Level.INFO, "Generated Find Query " + sb.toString());
        return sb.toString();
    }
    ...
    public String createPoolQuery(String where) throws Exception {
        ...
        MySQLQueryGenerator.mLog.log(Level.INFO, "Generated Pool Query " + sb.toString());
        return sb.toString();
    }
    ...
    public String getParamOrder(final String queryType) throws Exception {
        final StringBuffer sb = new StringBuffer();
        List tempList = null;
        if (MySQLQueryGenerator.INSERT_QUERY.equals(queryType)) {
            tempList = this.mInsertColumns;
        }
        if (MySQLQueryGenerator.UPDATE_QUERY.equals(queryType)) {
