...
public class DBTableImpl implements DBTable, Cloneable, Comparable {
    ...
    public boolean addColumn(final DBColumn theColumn) {
        if (theColumn != null) {
            ...
            this.columnsInTableOrder.add(theColumn);
            return true;
        }
    ...
    public boolean deleteAllColumns() {
        this.columns.clear();
        this.columnsInTableOrder.clear();
        return false;
    }
    ...
    public boolean deleteColumn(final String columnName) {
        if (columnName != null && columnName.trim().length() != 0) {
        	Object col = this.columns.get(columnName);
        	this.columnsInTableOrder.remove(col);
    ...
    public boolean setAllColumns(final Map theColumns) {
        ...
        if (theColumns != null) {
            ...
            this.columnsInTableOrder.addAll(columns.values());
        }
        return true;
    }
