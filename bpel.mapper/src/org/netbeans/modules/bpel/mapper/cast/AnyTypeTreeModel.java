 ...
 * @author nk160297
 */
public class AnyTypeTreeModel implements ExtTreeModel {

    private String ROOT_ITEM = "root"; // NOI18N
    
    private ExternalModelResolver mModelResolver;
    private Map<GlobalType, GlobalType> mDerivationMap;
    
    public AnyTypeTreeModel(final BpelModel bpelModel) {
        mModelResolver = new BpelExternalModelResolver(bpelModel);
        mDerivationMap = TypeInheritanceUtil.populateDerivationMap(mModelResolver);
    }
    ...
    public List getChildren(Object parent) {
        if (parent == ROOT_ITEM) {
            mModelResolver.getVisibleModels();
