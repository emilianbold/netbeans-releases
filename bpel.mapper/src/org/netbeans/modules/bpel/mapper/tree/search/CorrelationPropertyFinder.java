 ...
 * @author anjeleevich
 */
public class CorrelationPropertyFinder extends SimpleFinder {
    private AbstractVariableDeclaration variable;
    private CorrelationProperty property;
    
    public CorrelationPropertyFinder(AbstractVariableDeclaration variable,
