 ...
 * @author anjeleevich
 */
public class VariableAndNMPropertyFinder extends SimpleFinder {
    private String variableName;
    private String propertyQName;
    private BpelDesignContext designContext;
    
    public VariableAndNMPropertyFinder(BpelDesignContext designContext, 
    ...
    protected boolean isFit(Object treeItem) {
        ...
        if (treeItem instanceof NMProperty) {
            ...
            if (nmPropertyName.length() > 0) {
                return isEqual(nmPropertyName, propertyQName); // NOI18N
            }
        }
