 ...
 */
public class BpelCopyAction extends NodeAction implements MapperSelectionListener {
    private Mapper mapper;

    public BpelCopyAction() {
        super();
    }
    ...
    protected void performAction(Node[] activatedNodes) {
        ...
        mapper.getActionMap().get(DefaultEditorKit.copyAction).
                actionPerformed(new ActionEvent(mapper, 0, "Bepl-Copy-Action"));
    }
