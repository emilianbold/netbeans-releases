 ...
 * @version 1.0
 */
public class LoggingMultiviewElementDesc 
        implements MultiViewDescription, Serializable 
{
    ...
    public static final String PREFERED_ID = "loggingMapperMVTC";  //NOI18N
    public static final String GROUP_ID = "bpel_mapper_tcgroup";  //NOI18N

    private BPELDataObject myDataObject;


    public LoggingMultiviewElementDesc(BPELDataObject dObj) {
        myDataObject = dObj;
    }
    ...
    public String getDisplayName() {
        return NbBundle.getMessage(LoggingMultiviewElementDesc.class,
                "LBL_LoggingMultiview_DisplayName"); // NOI18N
    }
    ...
    public MultiViewElement createElement() {
        return new LoggingMultiviewElement(myDataObject);
    }
