...
//System.out.println("ADD INPORT");
      Import imp = addImport(createImport(imp_model));
...
//System.out.println("create import: " + fo);
        if (fo != null) {
            ...
            return createImport(getNewModelNamespace(fo, importType),
                    getNewModelLocation(model, fo),
