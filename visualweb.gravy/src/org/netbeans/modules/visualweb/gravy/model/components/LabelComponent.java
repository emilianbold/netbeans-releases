...
public class LabelComponent extends WebComponent {
    ...
    public final static String LABEL_ID = Bundle.getStringTrimmed(ravePaletteBundle,
                                          Bundle.getStringTrimmed(bundle, "LabelComponent"));
    
    public LabelComponent(ComponentSet set) {
        super(set, LABEL_ID);
        isVisual = true;
