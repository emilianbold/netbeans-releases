...
/**
 * Class representing JBoss Application Servers.
 */

public class JBoss4 extends ApplicationServer {
    
    public final static String SERVER_START_PROFILE = "Start in Profile Mode";
    public final static String SERVER_VIEW_JMX = "View JMX Console";
    ...
    
    {
        ...
        this.server_popup = new String[][] {{SERVER_START, "false", "true"}, {SERVER_START_DEBUG, "false", "true"},
                                            ...
                                            {SERVER_VIEW_JMX, "true", "true"}, {SERVER_VIEW_LOG, "true", "true"},
                                            {PROPERTIES, "true", "true"}};
        this.application_popup = new String[] {APPLICATION_OPEN, APPLICATION_UNDEPLOY};
        this.app_pref = "";
    }
   
    /**
     * Creates JBoss4 with specified descriptor.
     * @param DTDescriptor Descriptor of JBoss Application Server.
     */
    public JBoss4(DeploymentTargetDescriptor DTDescriptor) {
