...
public class TextFieldComponent extends WebComponent {
    ...
    public final static String TEXTFIELD_ID = Bundle.getStringTrimmed(ravePaletteBundle,
                                              Bundle.getStringTrimmed(bundle, "TextFieldComponent"));
    
    public TextFieldComponent(ComponentSet set) {
        super(set, TEXTFIELD_ID);
        isVisual = true;
        isEventHadling = true;
    }
}
