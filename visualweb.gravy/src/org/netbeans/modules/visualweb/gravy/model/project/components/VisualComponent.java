...
public class VisualComponent extends Component {
     ...
     */
    public VisualComponent(WebComponent webcomponent, String name) {
        super(webcomponent, name);
    }

    /**
     * Get coordinates of component.
     * @return Point of component.
     */
    ...
    /**
     * Set coordiantes of component.
     * @param point of component.
     */
