...
public class DropDownListComponent extends WebComponent {
    ...
    public final static String DROP_DOWN_LIST_ID = Bundle.getStringTrimmed(ravePaletteBundle,
                                           Bundle.getStringTrimmed(bundle, "DropDownListComponent"));
    
    public DropDownListComponent(ComponentSet set) {
        super(set, DROP_DOWN_LIST_ID);
        isVisual = true;
        isEventHadling = true;
    }
}
