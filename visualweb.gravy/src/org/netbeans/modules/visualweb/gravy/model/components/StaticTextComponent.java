...
public class StaticTextComponent extends WebComponent {
    ...
    public final static String STATIC_TEXT_ID = Bundle.getStringTrimmed(ravePaletteBundle,
                                          Bundle.getStringTrimmed(bundle, "StaticTextComponent"));
    
    public StaticTextComponent(ComponentSet set) {
        super(set, STATIC_TEXT_ID);
        isVisual = true;
