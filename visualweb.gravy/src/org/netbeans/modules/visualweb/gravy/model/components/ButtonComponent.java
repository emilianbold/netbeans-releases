...
public class ButtonComponent extends WebComponent {
    ...
    public final static String BUTTON_ID = Bundle.getStringTrimmed(ravePaletteBundle,
                                           Bundle.getStringTrimmed(bundle, "ButtonComponent"));
    
    public ButtonComponent(ComponentSet set) {
        super(set, BUTTON_ID);
        isVisual = true;
        isEventHadling = true;
    }
