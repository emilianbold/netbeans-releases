 ...
 */
public class KeyBindingsEditorOperator extends NbDialogOperator {

    /** Creates new KeyBindings that can handle it.
     */
    public KeyBindingsEditorOperator() {
        super("Key Bindings");
//                java.util.ResourceBundle.getBundle("org.netbeans.modules.editor.options.Bundle").getString("PROP_keyBindings"));
    }

    /** Creates new StringArrayCustomEditorOperator
     * @param wrapper JDialogOperator wrapper for custom editor */
    public KeyBindingsEditorOperator(JDialogOperator wrapper) {
    ...
    /**
     * @param editorName
     * @return KeyBindingEditorOperator
     */
    public static KeyBindingsEditorOperator invoke(String editorName) {
	...
	options.advanced();
        ...
        tfp.openEditor();
        KeyBindingsEditorOperator ret=new KeyBindingsEditorOperator();
        //options.close();
        return ret;
    }

    /**
     * Get list of KeyBindingsEditor's actions.
     * @param editorName Name of KeyBindingsEditor.
     * @return List of KeyBindingsEditor's actions.
     */
    public static List listActions(String editorName) {
        KeyBindingsEditorOperator instance = invoke(editorName);
    ...
    /**
     * Get list of KeyBindingsEditor's bindings.
     * @param editorName Name of KeyBindingsEditor.
     * @return List of KeyBindingsEditor's bindings.
     */
    ...
    public static void main(String args[]) {
        ...
        for (int j=0;j < 20;j++) {
            ...
            for (int i=0;i < names.length;i++) {
                list = KeyBindingsEditorOperator.listActions(names[i]);
