...
/**
 * Compares 2 text files and finds lines, which are different.
 */
public class LineDiff implements Diff {
    ...
    /**
     * Returns true or false depending on mode of file comparison.
     * @return true, if file comparison is not case-sensitive, otherwise - false.
     */
