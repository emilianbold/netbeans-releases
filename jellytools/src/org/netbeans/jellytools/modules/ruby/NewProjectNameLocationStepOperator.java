 ...
 */
public class NewProjectNameLocationStepOperator extends org.netbeans.jellytools.NewProjectNameLocationStepOperator {

    private JLabelOperator _lblProjectName;

    private JLabelOperator _lblProjectLocation;

    final String bundle = "org.netbeans.modules.ruby.rubyproject.ui.wizards.Bundle";   //Ruby wizard bundle
    ...
    public JLabelOperator lblProjectLocation() {
        if (_lblProjectLocation == null) {
            ...
            _lblProjectLocation = new JLabelOperator(this,
                    Bundle.getStringTrimmed(bundle, "LBL_NWP1_ProjectLocation_Label"));
        }
    ...
    public JLabelOperator lblProjectName() {
        if (_lblProjectName == null) {
            _lblProjectName = new JLabelOperator(this,
                    Bundle.getStringTrimmed(bundle,  "LBL_NWP1_ProjectName_Label"));
        }
