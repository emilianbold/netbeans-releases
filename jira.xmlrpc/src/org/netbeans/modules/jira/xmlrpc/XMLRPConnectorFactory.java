...
public class XMLRPConnectorFactory implements JiraConnectorProvider.JiraConnectorFactory {

    @Override
    public JiraConnectorProvider create() {
        return new XmlRpcJiraConnectorProvider();
    }

    @Override
    public JiraConnectorProvider.Type forType() {
