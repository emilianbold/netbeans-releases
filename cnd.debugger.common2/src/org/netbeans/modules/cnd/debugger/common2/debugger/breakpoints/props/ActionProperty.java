...
public final class ActionProperty extends EnumProperty {
    
    private Action value = Action.STOP;

    public ActionProperty(PropertyOwnerSupport po,
    ...
    public final void set(Action a) {
	value = a;
    }
