...
public final class ProcessEventProperty extends EnumProperty {
    ...
    private ProcessEvent value = ProcessEvent.EXIT;

    public ProcessEventProperty(PropertyOwnerSupport po,
				String name, String key, boolean ro, 
			  ProcessEvent initialValue) {
    ...
    public final void set(ProcessEvent a) {
	value = a;
	setDirty();
    }
