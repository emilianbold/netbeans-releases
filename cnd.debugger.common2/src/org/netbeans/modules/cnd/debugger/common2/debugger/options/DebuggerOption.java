...
public class DebuggerOption extends Option {
    ...
    private static final int radio_or_check = CHECK_BOX;
	...
	*/
    ...
    public DebuggerOption(String inName, String[] inValues,
			   ...
			   int inType, boolean hasTooltip, boolean hasMnemonic) {
