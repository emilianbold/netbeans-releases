...
/**
 * Action which "stepi over" the user's program
 */
public class StepOverInstAction extends CallableSystemAction implements StateListener {

    static final long serialVersionUID = -8705899978543961455L;
    private NativeDebugger debugger;

    public StepOverInstAction() {
