...
class WatchXMLWriter extends XMLDocWriter implements UserdirFile.Writer {

    private UserdirFile userdirFile;
    private WatchesXMLCodec encoder;

    WatchXMLWriter(UserdirFile userdirFile, WatchBag wb) {
	this.userdirFile = userdirFile;
	// TMP setIndentChars(8);
	encoder = new WatchesXMLCodec(wb);
    } 
