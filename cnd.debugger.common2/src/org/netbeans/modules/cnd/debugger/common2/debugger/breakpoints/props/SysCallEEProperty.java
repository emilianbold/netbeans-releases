...
public final class SysCallEEProperty extends EnumProperty {
    
    private SysCallEE value = SysCallEE.ENTRY;

    public SysCallEEProperty(PropertyOwnerSupport po,
			     String name, String key, boolean ro, 
			  SysCallEE initialValue) {
    ...
    public final void set(SysCallEE a) {
	value = a;
	setDirty();
    }

    public final SysCallEE get() {
	return value;
    }
}
