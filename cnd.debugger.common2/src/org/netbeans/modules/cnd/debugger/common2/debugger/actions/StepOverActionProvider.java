...
public class StepOverActionProvider extends NativeActionsProvider {

    public StepOverActionProvider(ContextProvider ctx) {
	super(ctx);
    }
	...
	setEnabled(ActionsManager.ACTION_STEP_OVER, enable);
    }
}
