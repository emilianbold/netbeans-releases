...
class BreakpointXMLWriter extends XMLDocWriter implements UserdirFile.Writer {

    private UserdirFile userdirFile;
    private BreakpointsXMLCodec encoder;

    BreakpointXMLWriter(UserdirFile userdirFile, BreakpointBag bb) {
	this.userdirFile = userdirFile;
	// TMP setIndentChars(8);
	encoder = new BreakpointsXMLCodec(bb);
    } 
