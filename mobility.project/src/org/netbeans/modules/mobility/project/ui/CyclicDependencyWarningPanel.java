...
public class CyclicDependencyWarningPanel extends JPanel implements Runnable {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel2.setText(NbBundle.getMessage(CyclicDependencyWarningPanel.class, "LBL_CyclicDependencies"));
        ...
        jLabel1.setDisplayedMnemonic(org.openide.util.NbBundle.getBundle(CyclicDependencyWarningPanel.class).getString("MNM_CycDeps_Projects").charAt(0));
        jLabel1.setLabelFor(jList1);
        jLabel1.setText(NbBundle.getMessage(CyclicDependencyWarningPanel.class, "LBL_CycDeps_Projects"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jCheckBox1.setMnemonic(org.openide.util.NbBundle.getBundle(CyclicDependencyWarningPanel.class).getString("MNM_CycDeps_DoNotAgain").charAt(0));
        jCheckBox1.setText(NbBundle.getMessage(CyclicDependencyWarningPanel.class, "LBL_CycDeps_DoNotAgain"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
