...
public class ProjectPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setName(org.openide.util.NbBundle.getMessage(ProjectPanel.class, "TITLE_Project"));
        jLabel1.setDisplayedMnemonic(org.openide.util.NbBundle.getBundle(ProjectPanel.class).getString("MNM_Project_Name").charAt(0));
        jLabel1.setLabelFor(tName);
        jLabel1.setText(org.openide.util.NbBundle.getMessage(ProjectPanel.class, "LBL_Project_Name"));
        ...
        jLabel2.setDisplayedMnemonic(org.openide.util.NbBundle.getBundle(ProjectPanel.class).getString("MNM_Projects_Home").charAt(0));
        jLabel2.setLabelFor(tHome);
        jLabel2.setText(org.openide.util.NbBundle.getMessage(ProjectPanel.class, "LBL_Projects_Home"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        bBrowse.setMnemonic(org.openide.util.NbBundle.getBundle(ProjectPanel.class).getString("MNM_Project_Browse").charAt(0));
        bBrowse.setText(org.openide.util.NbBundle.getMessage(ProjectPanel.class, "LBL_Project_Browse"));
        ...
        jLabel3.setDisplayedMnemonic(org.openide.util.NbBundle.getBundle(ProjectPanel.class).getString("MNM_Project_Created").charAt(0));
        jLabel3.setLabelFor(tCreated);
        jLabel3.setText(org.openide.util.NbBundle.getMessage(ProjectPanel.class, "LBL_Project_Created"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        cMainProject.setMnemonic(org.openide.util.NbBundle.getBundle(ProjectPanel.class).getString("MNM_Project_SetAsMainProject").charAt(0));
        cMainProject.setSelected(true);
        cMainProject.setText(org.openide.util.NbBundle.getMessage(ProjectPanel.class, "LBL_Project_SetAsMainProject"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        cCreateMIDlet.setMnemonic(org.openide.util.NbBundle.getBundle(ProjectPanel.class).getString("MNM_Project_CreateMIDlet").charAt(0));
        cCreateMIDlet.setSelected(true);
        cCreateMIDlet.setText(org.openide.util.NbBundle.getMessage(ProjectPanel.class, "LBL_Project_CreateMIDlet"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jLabel4.setText(NbBundle.getMessage(ProjectPanel.class, "LBL_ProjectSources"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jRadioEmptySrc.setMnemonic(NbBundle.getMessage(ProjectPanel.class, "MNM_EmptySources").charAt(0));
        jRadioEmptySrc.setSelected(true);
        jRadioEmptySrc.setText(NbBundle.getMessage(ProjectPanel.class, "LBL_EmptySources"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        ...
        jRadioCopySrc.setMnemonic(NbBundle.getMessage(ProjectPanel.class, "MNM_CopySources").charAt(0));
        jRadioCopySrc.setText(NbBundle.getMessage(ProjectPanel.class, "LBL_CopySources"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
