...
public class MIDPTargetChooserPanelGUI extends javax.swing.JPanel implements ActionListener, DocumentListener {
    ...
    private void initComponents() {
        ...
        lName.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSN_MidletName")); // NOI18N
        lName.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSD_MidletName")); // NOI18N
        ...
        tName.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSN_MidletName")); // NOI18N
        tName.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSD_MidletName")); // NOI18N
        ...
        lClassName.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSN_MidpClassName")); // NOI18N
        lClassName.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSD_MidpClassName")); // NOI18N
        ...
        tClassName.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSN_MidpClassName")); // NOI18N
        tClassName.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSD_MidpClassName")); // NOI18N
        ...
        lIcon.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSN_MidletIcon")); // NOI18N
        lIcon.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSD_MidletIcon")); // NOI18N
        ...
        jLabel5.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSN_MidpTargetProject")); // NOI18N
        jLabel5.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSD_MidpTargetProject")); // NOI18N
        ...
        projectTextField.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSN_MidpTargetProject")); // NOI18N
        projectTextField.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSD_MidpTargetProject")); // NOI18N
        ...
        jLabel2.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSN_MidpTargetPackage")); // NOI18N
        jLabel2.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSD_MidpTargetPackage")); // NOI18N
        ...
        packageComboBox.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSN_MidpTargetPackage")); // NOI18N
        packageComboBox.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSD_MidpTargetPackage")); // NOI18N
        ...
        jLabel4.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSN_CreatedFile")); // NOI18N
        jLabel4.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSD_CreatedFile")); // NOI18N
        ...
        fileTextField.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSN_CreatedFile")); // NOI18N
        fileTextField.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(MIDPTargetChooserPanelGUI.class, "ACSD_CreatedFile")); // NOI18N
