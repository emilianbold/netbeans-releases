...
public class EnterPasswordPanel extends javax.swing.JPanel implements ActionListener {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabelUsername.setDisplayedMnemonic(NbBundle.getMessage(EnterPasswordPanel.class, "MNM_PasswordPanel_Username").charAt(0));
        jLabelUsername.setLabelFor(jTextFieldUsername);
        jLabelUsername.setText(NbBundle.getMessage(EnterPasswordPanel.class, "LBL_PasswordPanel_Username"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jLabelPassword.setDisplayedMnemonic(org.openide.util.NbBundle.getBundle(EnterPasswordPanel.class).getString("MNM_Password_Password").charAt(0));
        jLabelPassword.setLabelFor(jPasswordField);
        jLabelPassword.setText(org.openide.util.NbBundle.getMessage(EnterPasswordPanel.class, "LBL_Password_Password"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jCheckBoxRemember.setMnemonic(NbBundle.getMessage(EnterPasswordPanel.class, "MNM_PasswordPanel_Remember").charAt(0));
        jCheckBoxRemember.setText(NbBundle.getMessage(EnterPasswordPanel.class, "LBL_PasswordPanel_Remember"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
