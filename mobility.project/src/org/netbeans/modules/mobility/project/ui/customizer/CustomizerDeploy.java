...
public class CustomizerDeploy extends JPanel implements CustomizerPanel, VisualPropertyGroup, ActionListener {
    ...
    private void initComponents()
    {
        ...
        jLabelInstance.setText(NbBundle.getMessage(CustomizerDeploy.class, "LBL_CustDeploy_DeploymentInstance"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(11, 0, 0, 0);
        ...
        jButtonManager.setText(NbBundle.getMessage(CustomizerDeploy.class, "LBL_CustDeploy_Manage"));
