...
public class LocalizationSupportPanelGUI extends JPanel implements ActionListener, ItemListener, DocumentListener {
    ...
    private void initComponents()
    {
        ...
        setName(org.openide.util.NbBundle.getMessage(LocalizationSupportPanelGUI.class, "TITLE_File"));
        setPreferredSize(new java.awt.Dimension(245, 232));
        jPanel1.setLayout(new java.awt.GridBagLayout());

        clsLabel.setDisplayedMnemonic(org.openide.util.NbBundle.getBundle(LocalizationSupportPanelGUI.class).getString("MNM_File_MIDPClassName").charAt(0));
        clsLabel.setLabelFor(clsTextField);
        clsLabel.setText(org.openide.util.NbBundle.getMessage(LocalizationSupportPanelGUI.class, "LBL_File_MIDPClassName"));
        ...
        rnLabel.setDisplayedMnemonic(org.openide.util.NbBundle.getBundle(LocalizationSupportPanelGUI.class).getString("MNM_Resource_FileName").charAt(0));
        rnLabel.setLabelFor(rnTextField);
        rnLabel.setText(org.openide.util.NbBundle.getMessage(LocalizationSupportPanelGUI.class, "LBL_Resource_FileName"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        rnTextField.setText(org.openide.util.NbBundle.getMessage(LocalizationSupportPanelGUI.class, "TXT_DefValue_MessagesFile"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        ...
        prjLabel.setDisplayedMnemonic(org.openide.util.NbBundle.getBundle(LocalizationSupportPanelGUI.class).getString("MNM_File_Project").charAt(0));
        prjLabel.setLabelFor(prjTextField);
        prjLabel.setText(org.openide.util.NbBundle.getMessage(LocalizationSupportPanelGUI.class, "LBL_File_Project"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        pkgLabel.setDisplayedMnemonic(org.openide.util.NbBundle.getBundle(LocalizationSupportPanelGUI.class).getString("MNM_File_Package").charAt(0));
        pkgLabel.setLabelFor(pkgComboBox);
        pkgLabel.setText(org.openide.util.NbBundle.getMessage(LocalizationSupportPanelGUI.class, "LBL_File_Package"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        cClassLabel.setDisplayedMnemonic(org.openide.util.NbBundle.getBundle(LocalizationSupportPanelGUI.class).getString("MNM_File_Created_Class").charAt(0));
        cClassLabel.setLabelFor(cClassTextField);
        cClassLabel.setText(org.openide.util.NbBundle.getMessage(LocalizationSupportPanelGUI.class, "LBL_File_Created_Class"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 6, 0);
        ...
        cResourceLabel.setDisplayedMnemonic(org.openide.util.NbBundle.getBundle(LocalizationSupportPanelGUI.class).getString("MNM_File_Created_Resource").charAt(0));
        cResourceLabel.setLabelFor(cResourceTextField);
        cResourceLabel.setText(org.openide.util.NbBundle.getMessage(LocalizationSupportPanelGUI.class, "LBL_File_Created_Resource"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 12, 0);
        ...
        dsLabel.setDisplayedMnemonic(org.openide.util.NbBundle.getBundle(LocalizationSupportPanelGUI.class).getString("MNM_DefValue_DefaultString").charAt(0));
        dsLabel.setLabelFor(dsTextField);
        dsLabel.setText(org.openide.util.NbBundle.getMessage(LocalizationSupportPanelGUI.class, "LBL_Resource_DefaultString"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 6, 6);
        ...
        dsTextField.setText(org.openide.util.NbBundle.getMessage(LocalizationSupportPanelGUI.class, "TXT_DefValue_DefaultString"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        ...
        emLabel.setDisplayedMnemonic(org.openide.util.NbBundle.getBundle(LocalizationSupportPanelGUI.class).getString("MNM_DefValue_ErrorMessage").charAt(0));
        emLabel.setLabelFor(emTextField);
        emLabel.setText(org.openide.util.NbBundle.getMessage(LocalizationSupportPanelGUI.class, "LBL_Resource_ErrorMessage"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 6, 6);
        ...
        emTextField.setText(org.openide.util.NbBundle.getMessage(LocalizationSupportPanelGUI.class, "TXT_DefValue_ErrorMessage"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
