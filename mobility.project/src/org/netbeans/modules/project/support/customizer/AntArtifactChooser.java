...
public class AntArtifactChooser extends javax.swing.JPanel implements PropertyChangeListener {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabelName.setDisplayedMnemonic(org.openide.util.NbBundle.getBundle(AntArtifactChooser.class).getString("MNM_AAChooser_ProjectName").charAt(0));
        jLabelName.setLabelFor(jTextFieldName);
        jLabelName.setText(NbBundle.getMessage(AntArtifactChooser.class, "LBL_AAChooser_ProjectName"));
        ...
        jLabelJarFiles.setDisplayedMnemonic(org.openide.util.NbBundle.getBundle(AntArtifactChooser.class).getString("MNM_AAChooser_JARFiles").charAt(0));
        jLabelJarFiles.setLabelFor(jListArtifacts);
        jLabelJarFiles.setText(NbBundle.getMessage(AntArtifactChooser.class, "LBL_AAChooser_JARFiles"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 12, 2, 0);
