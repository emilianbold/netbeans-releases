...
import org.netbeans.modules.web.client.javascript.debugger.js.dbgp.CommandFactory;
import org.netbeans.modules.web.client.javascript.debugger.js.dbgp.DebuggerProxy;
import org.netbeans.modules.web.client.javascript.debugger.js.dbgp.Extension.Source;
import org.netbeans.modules.web.client.javascript.debugger.js.dbgp.Extension.Window;
import org.netbeans.modules.web.client.javascript.debugger.js.dbgp.InitMessage;
import org.netbeans.modules.web.client.javascript.debugger.js.dbgp.Message;
import org.netbeans.modules.web.client.javascript.debugger.js.dbgp.OnloadMessage;
...
import org.netbeans.modules.web.client.javascript.debugger.js.dbgp.Status;
import org.netbeans.modules.web.client.javascript.debugger.js.dbgp.Status.DebugMessage;
...
import org.netbeans.modules.web.client.javascript.debugger.js.impl.JSCallStackFrameImpl;
...
public class DbgpUtils {
    static JSBreakpoint getBreakpoint(StatusResponse response) {
    ...
    static JSSource[] getJSSources(List<Source> sources) {
    ...
    static JSWindow[] getJSWindows(List<Window> windows) {
    ...
    static boolean isStepSuccessfull(StatusResponse response){
       return (response.getState() == Status.State.BREAKPOINT && 
                response.getReason() == Status.Reason.OK);     
    }

    static Breakpoint.BreakpointSetCommand getDbgpBreakpointCommand(DebuggerProxy proxy, 
    ...
    static JSDebuggerState getDebuggerState(Message message) {
    ...
    static List<JSBreakpoint> getJSBreakpoints(List<Breakpoint> breakpoints) {
    ...
    static JSBreakpoint getJSBreakpoint(Breakpoint breakpoint) {
        return JSFactory.createJSBreakpoint(breakpoint.getFileURI(), breakpoint.getLineNumber(),
                breakpoint.getId());
    }

    static JSCallStackFrame getJSCallStackFrame(JSDebugger debugger, Stack callStack) {
    ...
    static List<JSCallStackFrame> getJSCallStackFrames(JSDebugger debugger, List<Stack> callStacks) {
    ...
    static JSProperty getJSProperty(JSCallStackFrame frame, Property property) {
        if(property == null) {
            return null;
        }
        try {
    ...
    static JSProperty[] getJSProperties(JSCallStackFrame callStackFrame, Property property) {
