...
public class RoundTripEnumAndEnumLiteralEventsTestCase extends AbstractUMLTestCase implements IRoundTripAttributeEventsSink, IRoundTripClassEventsSink, IRoundTripEnumEventsSink, IRoundTripEnumLiteralEventsSink, IRoundTripOperationEventsSink, IRoundTripPackageEventsSink, IRoundTripRelationEventsSink
{
	...
	public void testEnumCreate()
	{
		...
		enums.setName("TestEnum1");
		readFromFile(propFile,"Enumeration","create");
	...
	{
		IEnumeration enums = createType("Enumeration");
		enums.setName("TestEnum2");
		resetVals();
		enums.setIsFinal(true);
		readFromFile(propFile,"Enumeration","modify");
		assertEquals(elemKind,elemKindFromInputFile);
		assertEquals(eventState,eventStateFromInputFile);
		assertEquals(0, count);
	}
	...
	{
		IEnumeration enums = createType("Enumeration");
		enums.setName("TestEnum3");
		resetVals();
		enums.delete();
		readFromFile(propFile,"Enumeration","delete");
		assertEquals(elemKind,elemKindFromInputFile);
		assertEquals(eventState,eventStateFromInputFile);
		assertEquals(0, count);
	}
	...
	public void testEnumLiteralCreate()
	{
		IEnumeration enums = createType("Enumeration");
		resetVals();
		IEnumerationLiteral enLit = enums.createLiteral("BoolLit1");
		enums.addLiteral(enLit);
		readFromFile(propFile,"EnumLiteral","create");
		assertEquals(elemKind,elemKindFromInputFile);
		assertEquals(eventState,eventStateFromInputFile);
		assertEquals(0, count);
	}
	...
	{
		IEnumeration enums = createType("Enumeration");
		IEnumerationLiteral enLit = enums.createLiteral("BoolLit2");
		enums.addLiteral(enLit);
		resetVals();
		enLit.setName("TestLit");
		readFromFile(propFile,"EnumLiteral","modify");
		assertEquals(elemKind,elemKindFromInputFile);
		assertEquals(eventState,eventStateFromInputFile);
		assertEquals(0, count);
	}
	...
	{
		IEnumeration enums = createType("Enumeration");
		IEnumerationLiteral enLit = enums.createLiteral("BoolLit3");
		enums.addLiteral(enLit);
		resetVals();
		enLit.delete();
		readFromFile(propFile,"EnumLiteral","delete");
		assertEquals(elemKind,elemKindFromInputFile);
		assertEquals(eventState,eventStateFromInputFile);
		assertEquals(0, count);
	}
