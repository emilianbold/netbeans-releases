...
public class FireEventContextPushedTestCase extends TestCase implements IEventFrameworkEventsSink
{
	...
	public  void testFireEventContextPushed()
	{
		...
		eventDisptcher.fireEventContextPushed(context,payload);
		assertTrue(testData);
	}
