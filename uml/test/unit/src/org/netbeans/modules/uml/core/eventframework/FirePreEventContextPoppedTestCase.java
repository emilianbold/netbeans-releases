...
public class FirePreEventContextPoppedTestCase extends TestCase implements IEventFrameworkEventsSink
{
	...
	public  void testFirePreEventContextPopped()
	{
		...
		eventDisptcher.firePreEventContextPopped(context,payload);
		assertTrue(testData);
	}
