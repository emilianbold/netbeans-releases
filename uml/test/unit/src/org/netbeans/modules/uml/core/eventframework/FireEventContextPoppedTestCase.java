...
public class FireEventContextPoppedTestCase extends TestCase implements IEventFrameworkEventsSink
{
	...
	public  void testFireEventContextPopped()
	{
		...
		eventDisptcher.fireEventContextPopped(context,payload);
		assertTrue(testData);
	}
