...
import org.netbeans.modules.uml.core.metamodel.infrastructure.coreinfrastructure.Signal;
...
public class ChangeSignal extends Signal implements IChangeSignal
{
    ...
    {
        return new ElementCollector<IExpression>().retrieveSingleElement( 
    ...
    {
        addChild("UML:ChangeSignal.changeExpression",
    ...
    {
        buildNodePresence("UML:ChangeSignal", doc, node);
    }
}
