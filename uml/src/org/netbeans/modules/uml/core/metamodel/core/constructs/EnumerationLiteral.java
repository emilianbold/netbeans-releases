    ...
    implements IEnumerationLiteral
{
    ...
    {
        ElementCollector< IEnumeration > col = new ElementCollector< IEnumeration >();
    ...
    {
        new ElementConnector< IEnumerationLiteral >()
            .setSingleElementAndConnect( 
                            ...
                            new IBackPointer<IEnumeration>() 
                            {
                                ...
                                {
                                    enumeration.addLiteral(EnumerationLiteral.this);
                                }
                            }, 
                            new IBackPointer<IEnumeration>() 
                            {
                                public void execute(IEnumeration enumeration) 
                                {
                                    enumeration.removeLiteral(EnumerationLiteral.this);
                                }
                            } 
        );
    }
    ...
    {
        buildNodePresence("UML:EnumerationLiteral", doc, node);
    }        
