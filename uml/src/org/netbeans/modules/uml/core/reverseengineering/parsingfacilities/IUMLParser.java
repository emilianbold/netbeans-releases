...
import org.netbeans.modules.uml.core.reverseengineering.reframework.parsingframework.IParseFacility;

/**
 */
public interface IUMLParser extends IParseFacility
{
    public IEventDispatchController getEventDispatchController();

    public IUMLParserEventDispatcher getUMLParserDispatcher();

    public void processOperationFromFile(String filename, IREOperation op, 
                                         IOpParserOptions opts);
}
