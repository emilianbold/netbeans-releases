...
public JavaLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("byte", this), new Integer(55));
	literals.put(new ANTLRHashString("public", this), new Integer(66));
	literals.put(new ANTLRHashString("case", this), new Integer(97));
	literals.put(new ANTLRHashString("short", this), new Integer(57));
	literals.put(new ANTLRHashString("break", this), new Integer(92));
	literals.put(new ANTLRHashString("while", this), new Integer(90));
	literals.put(new ANTLRHashString("new", this), new Integer(140));
	literals.put(new ANTLRHashString("instanceof", this), new Integer(125));
	literals.put(new ANTLRHashString("implements", this), new Integer(79));
	literals.put(new ANTLRHashString("synchronized", this), new Integer(71));
	literals.put(new ANTLRHashString("float", this), new Integer(59));
	literals.put(new ANTLRHashString("package", this), new Integer(48));
	literals.put(new ANTLRHashString("return", this), new Integer(94));
	literals.put(new ANTLRHashString("throw", this), new Integer(96));
	literals.put(new ANTLRHashString("null", this), new Integer(139));
	literals.put(new ANTLRHashString("protected", this), new Integer(67));
	literals.put(new ANTLRHashString("class", this), new Integer(73));
	literals.put(new ANTLRHashString("throws", this), new Integer(85));
	literals.put(new ANTLRHashString("do", this), new Integer(91));
	literals.put(new ANTLRHashString("strictfp", this), new Integer(43));
	literals.put(new ANTLRHashString("super", this), new Integer(83));
	literals.put(new ANTLRHashString("transient", this), new Integer(69));
	literals.put(new ANTLRHashString("native", this), new Integer(70));
	literals.put(new ANTLRHashString("interface", this), new Integer(75));
	literals.put(new ANTLRHashString("final", this), new Integer(41));
	literals.put(new ANTLRHashString("if", this), new Integer(87));
	literals.put(new ANTLRHashString("double", this), new Integer(61));
	literals.put(new ANTLRHashString("volatile", this), new Integer(72));
	literals.put(new ANTLRHashString("catch", this), new Integer(100));
	literals.put(new ANTLRHashString("try", this), new Integer(99));
	literals.put(new ANTLRHashString("int", this), new Integer(58));
	literals.put(new ANTLRHashString("for", this), new Integer(89));
	literals.put(new ANTLRHashString("extends", this), new Integer(74));
	literals.put(new ANTLRHashString("boolean", this), new Integer(54));
	literals.put(new ANTLRHashString("char", this), new Integer(56));
	literals.put(new ANTLRHashString("private", this), new Integer(65));
	literals.put(new ANTLRHashString("default", this), new Integer(98));
	literals.put(new ANTLRHashString("false", this), new Integer(138));
	literals.put(new ANTLRHashString("this", this), new Integer(82));
	literals.put(new ANTLRHashString("static", this), new Integer(68));
	literals.put(new ANTLRHashString("abstract", this), new Integer(42));
	literals.put(new ANTLRHashString("continue", this), new Integer(93));
	literals.put(new ANTLRHashString("finally", this), new Integer(101));
	literals.put(new ANTLRHashString("else", this), new Integer(88));
	literals.put(new ANTLRHashString("import", this), new Integer(50));
	literals.put(new ANTLRHashString("void", this), new Integer(53));
	literals.put(new ANTLRHashString("switch", this), new Integer(95));
	literals.put(new ANTLRHashString("true", this), new Integer(137));
					...
					case '4':  case '5':  case '6':  case '7':
					{
						...
						do {
							if (((LA(1) >= '0' && LA(1) <= '7'))) {
								...
								if ( _cnt292>=1 ) { break _loop292; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
							}
