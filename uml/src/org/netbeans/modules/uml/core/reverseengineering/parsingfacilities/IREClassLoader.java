...
public interface IREClassLoader
{
    ...
    public IREClass loadClass(String className, IREClass thisPtr);
    ...
    public void addLibrary(ILanguageLibrary newVal);
    public List < IDependencyEvent >  getDependencies(IREClass c);
