...
/**
 */
public interface IClassLoaderListener
    extends IUMLParserEventsSink, IUMLParserAtomicEventsSink
{
    public IFileInformation getFileInformation();
    
    public ETList<IREAttribute> getTopLevelAttributes();
    
    public ETList<IREOperation> getTopLevelOperations();
}
