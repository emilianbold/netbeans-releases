...
public interface IREOperationWizard extends IPreferenceControlledDialog
{
   public boolean display(Frame parent);

   public IStrings getBaseDirectories();

   public void addLookupDirectory(String newVal);

   public void addLookupDirectories(IStrings newVal);
