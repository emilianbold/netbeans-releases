 ...
 */
//public class ADDrawingAreaActions extends Object implements ActionListener, TSEGraphChangeListener
...
//public class ADDrawingAreaActions extends TSEAnyChangeAdapter implements ActionListener
{
...
//      TSEWindowState state = this.getCurrentState();
      ...
      //if ((state instanceof TSESelectState) && !this.m_drawingArea.isAutoFitInWindow())
	  if ((state instanceof TSESelectTool) && !this.m_drawingArea.isAutoFitInWindow())
      {
         this.onSwitchToPan();
      }
//      else if ((state instanceof TSEPanState) && !this.m_drawingArea.isAutoFitInWindow())
      else if ((state instanceof TSEPanTool) && !this.m_drawingArea.isAutoFitInWindow())
      {
         this.onSwitchToZoom();
      }
//      else if ((state instanceof TSEZoomState) && !this.m_drawingArea.isAutoFitInWindow())
      else if ((state instanceof TSEZoomTool) && !this.m_drawingArea.isAutoFitInWindow())
      {
         this.onSwitchToInteractiveZoom();
      }
//      else if ((state instanceof TSEInteractiveZoomState) &&
    ...
    */
//   protected void switchState(TSEWindowState state)
   protected void switchState(TSEWindowTool state)
   {
//      getGraphWindow().switchState(state);
...
//         if ((state instanceof TSEPanState) || (state instanceof TSEZoomState) || (state instanceof TSEInteractiveZoomState) || (state instanceof TSELinkNavigationState))
   ...
   public void actionPerformed(ActionEvent event)
   {
      ...
      //System.out.println("ADDrawingAreaAction.actionPerform: action cmd="+ command);
