...
/**
 * Creates a cursor that is used to represent to display a cross hair.
 *
 * @author Trey Spiva
 */
public class ETCrossHairCursor extends ETCustomCursor
{
   ...
   public static Cursor getCursor() {
      ...
      {
         ETCustomCursor instance = new ETCrossHairCursor();
