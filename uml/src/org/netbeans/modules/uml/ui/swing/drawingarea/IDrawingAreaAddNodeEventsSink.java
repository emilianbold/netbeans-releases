...
public interface IDrawingAreaAddNodeEventsSink
{
	/**
	 * Fired to verify that this node is allowed at this point.
	*/
	public void onDrawingAreaCreateNode( IDiagram pParentDiagram, ICreateNodeContext pContext, IResultCell cell );

	/**
	 * Fired when the node is being dragged during creation after an left button down.
	*/
