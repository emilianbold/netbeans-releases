...
public interface IDrawingAreaSelectionEventsSink
{
	/**
	 * Fired after the select list has been modified.  If it was a compartment select that caused this event then the compartment is also provided, otherwise it is NULL
	*/
