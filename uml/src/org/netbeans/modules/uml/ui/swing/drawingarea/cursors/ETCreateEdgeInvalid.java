...
/**
 * Creates a cursor that is used to represent notify the user that edge can not
 * placed at the specified location.
 *
 * @author Trey Spiva
 */
public class ETCreateEdgeInvalid extends ETCustomCursor
{
   /**
   ...
   protected String getCursorName() {
      return "CreateInvalidEdgeCursor";
   }
