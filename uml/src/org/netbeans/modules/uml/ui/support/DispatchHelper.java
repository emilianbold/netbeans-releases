...
//		public void revokeWSProjectSinkDP(IEventsSink pSink){}
   ...
   public void revokePreferenceManagerSink(IPreferenceManagerEventsSink sink)
			throws InvalidArguments
	{
		if(sink != null)
		{	
   ...
   public void revokeInitSink(ICoreProductInitEventsSink sink)
			throws InvalidArguments
	{
		if(sink != null)
		{	
...
//				TODO: We do not have a JCWrapper from the ProjectEventsSink.
   ...
   public void revokeProjectSink(IProjectEventsSink sink)
			throws InvalidArguments
	{
		if(sink != null)
		{	
...
//				}
   ...
   public void registerForWorkspaceEventsDP(IWorkspaceEventsSink sink)
  {
   ...
   public void revokeWorkspaceSinkDP(IWorkspaceEventsSink sink)
	   throws InvalidArguments
   {
	   if(sink != null)
	   {	
   ...
   public void revokeWSProjectSinkDP(IWSProjectEventsSink sink)
		   throws InvalidArguments
   {
	   if(sink != null)
	   {	
