...
//import org.netbeans.modules.uml.core.coreapplication.AddinController;
...
//import org.netbeans.modules.uml.ui.support.applicationmanager.AddInControllerEx;
...
//import org.netbeans.modules.uml.ui.support.scmintegration.SCMEventDispatcher;
//import org.netbeans.modules.uml.ui.support.scmintegration.SCMIntegrator;
...
//	}
			...
			if (pDiagram instanceof IUIDiagram)
			{
				...
				if (control != null)
				{
					...
					if (fileName != null && fileName.length() > 0)
					{
						...
						IDiagram existingDia = getDiagram(fileName);
						if (existingDia == null)
						{
							m_Diagrams.put(fileName, pDiagram);
						}
					}
				}
			}
		...
		if (pDiagram != null)
		{
			if (pDiagram instanceof IUIDiagram)
			{
				...
				if (control != null)
				{
					...
					if (fileName != null && fileName.length() > 0)
					{
						Object obj = m_Diagrams.get(fileName);
						if (obj != null)
						{
							m_Diagrams.remove(fileName);
						}
					}
				}
			}
	...
	public IDiagram getDiagram(String sFilename)
	{
		...
		{
			Object obj = m_Diagrams.get(sFilename);
