...
public class ETNavigableAssociationEdgeDrawEngine extends ETAssociationEdgeDrawEngine {
	public ETNavigableAssociationEdgeDrawEngine() {
		super();
	}
