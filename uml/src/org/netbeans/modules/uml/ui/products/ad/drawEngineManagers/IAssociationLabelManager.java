 ...
 * @author KevinM
 */
public interface IAssociationLabelManager extends IADLabelManager {
	// Shows/Hides the name label for this association end.
	public void showNameLabel(IAssociationEnd pEnd);

	// Shows/Hides the multiplicity label for this association end.
	public void showMultiplicityLabel(IAssociationEnd pEnd);

	//  Creates the association name label.
	public void createAssociationNameLabel(boolean bAssignDefaultName);

	// Create the assocation name for the specific end.
	public void createAssociationEndNameLabel(IAssociationEnd pEnd, boolean bAssignDefaultName);

	//  Create the multiplicity label for the specific end.
