 ...
 * @author Trey Spiva
 */
public class ADDiagramUseCaseEngine extends ADCoreEngine
{
	public void registerAccelerators()
	{
		...
		accelsToRegister.add(IDrawingAreaAcceleratorKind.DAVK_CREATE_ACTOR);
			
		// Add the ability to manipulate classifiers 
