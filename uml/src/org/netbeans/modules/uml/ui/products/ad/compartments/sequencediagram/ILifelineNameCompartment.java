 ...
 * @author Trey Spiva
 */
public interface ILifelineNameCompartment extends IADNameCompartment
{
   /**
    * Set the meta type represented by the draw engine.
    *
    * @param value The meta type name.
    */
   public void setRepresentsMetaType(String value);

   /**
    * Retrieves the meta type represented by the draw engine.
    *
    * @return The meta type name.
    */
