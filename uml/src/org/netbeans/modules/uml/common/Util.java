...
public class Util
{
   ...
   public static String stripSpacesInString(String s) {
   	...
   	public static boolean hasNameCollision(INamespace space, String name, String newType, INamedElement self)
	{
	...
	public static ETList<INamedElement> getCollidingElements(INamedElement curElement, String newName)
	{
