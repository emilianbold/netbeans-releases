...
public class VersioningInfo {
     ...
     * @param properties
     */
    public static void show (HashMap<VCSFileProxy, Map<String, String>> properties) {
    ...
    private static class VersioningInfoNode extends AbstractNode {
        private final HashMap<VCSFileProxy, Map<String, String>> properties;
        private final String name;
        private final String desc;

        public VersioningInfoNode (HashMap<VCSFileProxy, Map<String, String>> properties) {
            super(Children.LEAF);
        ...
        protected Sheet createSheet() {
            ...
            for (Map.Entry<VCSFileProxy, Map<String, String>> e : properties.entrySet()) {
                Map<String, String> fileProps = e.getValue();
                Sheet.Set ps = new Sheet.Set();
                ps.setName(e.getKey().getPath());
                ps.setDisplayName(e.getKey().getName());
                ps.setShortDescription(e.getKey().getPath());
