...
public class OracleDeploymentFactory implements DeploymentFactory {
    ...
    public DeploymentManager getDeploymentManager(String uri, String username,
        ...
        return new OracleDeploymentManager(
                PlatformManagerConnectionFactory.getDefault(props.getProperty(IP_URL_ENDPOINT)), 
    ...
    public DeploymentManager getDisconnectedDeploymentManager(String uri) throws DeploymentManagerCreationException {
        // XXX
        return new OracleDeploymentManager(PlatformManagerConnectionFactory.getDefault("Disconnected-Deployment-Manager"), ""); // NOI18N
    }
