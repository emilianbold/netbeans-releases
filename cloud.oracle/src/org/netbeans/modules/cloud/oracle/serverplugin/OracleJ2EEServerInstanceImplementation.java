 ...
 *
 */
public class OracleJ2EEServerInstanceImplementation implements ServerInstanceImplementation {

    private OracleJ2EEInstance aij;

    public OracleJ2EEServerInstanceImplementation(OracleJ2EEInstance aij) {
        this.aij = aij;
    }
