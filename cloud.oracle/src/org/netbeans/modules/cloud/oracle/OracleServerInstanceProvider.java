...
/**
 * Provider of registered Cloud9 accounts in the IDE.
 */
public class OracleServerInstanceProvider implements ServerInstanceProvider, ChangeListener {

    private ChangeSupport listeners;
    private List<ServerInstance> instances;
    private static OracleServerInstanceProvider instance;
    
    private OracleServerInstanceProvider() {
    ...
    public static synchronized OracleServerInstanceProvider getProvider() {
        if (instance == null) {
            instance = new OracleServerInstanceProvider();
        }
        return instance;
    }
