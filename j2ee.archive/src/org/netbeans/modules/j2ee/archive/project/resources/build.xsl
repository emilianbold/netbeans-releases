...
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xalan project archiveproject">
    ...
    <xsl:template match="/">
        ...
        <xsl:variable name="name" select="/project:project/project:configuration/archiveproject:data/archiveproject:name"/>
