 ...
 * @author tomslot
 */
public class CreateManyToManyRelationshipHint extends AbstractCreateRelationshipHint {

    public CreateManyToManyRelationshipHint(FileObject fileObject,
        ...
        super(fileObject, classHandle, accessType, localAttrName, targetEntityClassName,
                JPAAnnotations.MANY_TO_MANY, JPAAnnotations.MANY_TO_MANY);
    }
}
