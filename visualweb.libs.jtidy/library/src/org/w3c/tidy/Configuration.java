...
public class Configuration implements java.io.Serializable {
    ...
    /** When set, treat the output as jsp source; e.g. entities should
     * be escaped, there should be xhtml doctype, etc. */
    public boolean outputJspMode = false;
    /** When set, treat the input as jsp source, e.g. entities should be
     * considered escaped, etc. */
    public boolean inputJspMode = false;
