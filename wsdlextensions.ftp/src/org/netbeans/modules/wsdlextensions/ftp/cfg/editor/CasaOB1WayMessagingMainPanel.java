/*
 * CasaOB1WayMessagingMainPanel.java
 *
 */
 ...
 */
public class CasaOB1WayMessagingMainPanel extends javax.swing.JPanel implements BindingConfigurationDelegate {
    ...
    /** Creates new form CasaOB1WayMessagingMainPanel */
    public CasaOB1WayMessagingMainPanel(WSDLComponent component, PropertyChangeSupport proxy) {
    ...
    private void initCustomComponents() {
        ...
        mOBMsgPanel = new OutboundMessagePanel(mQName, mComponent, true, true, mProxy);
        
        jTabbedPane1.addTab("1." + mFTP1WayPanel.getName(), mFTP1WayPanel);
        jTabbedPane1.addTab("2." + mOBMsgPanel.getName(), mOBMsgPanel);
    ...
    private void initComponents() {
        ...
        jTabbedPane1.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(CasaOB1WayMessagingMainPanel.class, "CasaOB1WayMessagingMainPanel.jTabbedPane1.AccessibleContext.accessibleName")); // NOI18N
        jTabbedPane1.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(CasaOB1WayMessagingMainPanel.class, "CasaOB1WayMessagingMainPanel.jTabbedPane1.AccessibleContext.accessibleDescription")); // NOI18N

        add(jPanel1, java.awt.BorderLayout.CENTER);
        jPanel1.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(CasaOB1WayMessagingMainPanel.class, "CasaOB1WayMessagingMainPanel.jPanel1.AccessibleContext.accessibleName")); // NOI18N
        jPanel1.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(CasaOB1WayMessagingMainPanel.class, "CasaOB1WayMessagingMainPanel.jPanel1.AccessibleContext.accessibleDescription")); // NOI18N
