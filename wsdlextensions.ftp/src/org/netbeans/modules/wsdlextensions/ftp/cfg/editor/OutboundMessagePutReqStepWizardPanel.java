...
public class OutboundMessagePutReqStepWizardPanel extends WSDLWizardDescriptorPanel {
    ...
    public OutboundMessagePutReqStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }
    public OutboundMessagePutReqStepWizardPanel(WSDLWizardContext context, boolean oneway, boolean isLast) {
        this(context);
        mOneWay = oneway;
        mIsLast = isLast;
    }
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new OutboundMessagePanel(mQName, mWSDLComponent, mOneWay, true);
        }
    ...
    public String getName() {
        return NbBundle.getMessage(OutboundMessagePutReqStepWizardPanel.class,
                "OutboundMessagePutReqStepWizardPanel.StepLabel");        
    }
