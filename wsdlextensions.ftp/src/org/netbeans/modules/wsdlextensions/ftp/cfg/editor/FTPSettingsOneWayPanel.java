/*
 * FTPSettingsOneWayPanel.java
 *
 * Created on September 22, 2008, 10:29 AM
 */
 ...
 * @author  jfu
 */
public class FTPSettingsOneWayPanel extends javax.swing.JPanel implements AncestorListener, PropertyAccessible, BindingConfigurationDelegate {
    ...
    private static final Logger mLogger = Logger.getLogger(FTPSettingsOneWayPanel.class.getName());
    ...
    private AncestorListener mAncestorListner;
    private PropertyChangeSupport mProxy;

    /** Creates new form FTPSettingsOneWayPanel */
    public FTPSettingsOneWayPanel(QName qName, WSDLComponent component) {
        this(qName, component, null);
    }

    public FTPSettingsOneWayPanel(QName qName, WSDLComponent component, PropertyChangeSupport proxy) {
        mProxy = proxy;
        initComponents();
    ...
    private boolean commitAddress(FTPAddress fTPAddress) {
        ...
        try {
            ...
            String url = "ftp://" + userText.getText() + ":" + passwd + "@" + hostText.getText() + ":" + portText.getText();
...
//                        }
    ...
    public String getName() {
        return NbBundle.getMessage(FTPSettingsOneWayPanel.class,
                "FTPSettingsOneWayPanel.StepLabel");
    }
    ...
    private void initComponents() {
        ...
        ftpOneWayCfgPanel = new javax.swing.JPanel();
        ...
        lstStyleImgLab = new javax.swing.JLabel();
        ...
        userListStyleLocLab1 = new javax.swing.JLabel();
        ...
        ftpOneWayCfgPanel.setMinimumSize(new java.awt.Dimension(610, 430));
        ftpOneWayCfgPanel.setName("ftpOneWayCfgPanel"); // NOI18N
        ftpOneWayCfgPanel.setPreferredSize(new java.awt.Dimension(610, 430));
        ftpOneWayCfgPanel.setLayout(new java.awt.GridBagLayout());

        ftpConfigTabbedPane.setMinimumSize(new java.awt.Dimension(610, 430));
        ftpConfigTabbedPane.setName("ftpConfigTabbedPane"); // NOI18N
        ftpConfigTabbedPane.setPreferredSize(new java.awt.Dimension(610, 430));
        ...
        org.openide.awt.Mnemonics.setLocalizedText(hostLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.hostLab.text")); // NOI18N
        ...
        hostLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.hostLab.AccessibleContext.accessibleDescription")); // NOI18N
        ...
        hostText.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.hostText.AccessibleContext.accessibleName")); // NOI18N
        hostText.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.hostText.AccessibleContext.accessibleDescription")); // NOI18N

        portLab.setLabelFor(portText);
        org.openide.awt.Mnemonics.setLocalizedText(portLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.portLab.text")); // NOI18N
        ...
        portLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.portLab.AccessibleContext.accessibleDescription")); // NOI18N

        portText.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.portText.text")); // NOI18N
        ...
        portText.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.portText.AccessibleContext.accessibleName")); // NOI18N
        portText.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.portText.AccessibleContext.accessibleDescription")); // NOI18N

        userLab.setLabelFor(userText);
        org.openide.awt.Mnemonics.setLocalizedText(userLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.userLab.text")); // NOI18N
        ...
        userLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.userLab.AccessibleContext.accessibleDescription")); // NOI18N
        ...
        userText.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.userText.AccessibleContext.accessibleName")); // NOI18N
        userText.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.userText.AccessibleContext.accessibleDescription")); // NOI18N

        passwordLab.setLabelFor(passwdFld);
        org.openide.awt.Mnemonics.setLocalizedText(passwordLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.passwordLab.text")); // NOI18N
        ...
        passwordLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.passwordLab.AccessibleContext.accessibleDescription")); // NOI18N

        passwdFld.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.passwdFld.text")); // NOI18N
        ...
        passwdFld.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.passwdFld.AccessibleContext.accessibleName")); // NOI18N
        passwdFld.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.passwdFld.AccessibleContext.accessibleDescription")); // NOI18N

        listStyleLab.setLabelFor(listStylesCombo);
        org.openide.awt.Mnemonics.setLocalizedText(listStyleLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.listStyleLab.text")); // NOI18N
        ...
        listStyleLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.listStyleLab.AccessibleContext.accessibleDescription")); // NOI18N
        ...
        listStylesCombo.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.listStylesCombo.AccessibleContext.accessibleName")); // NOI18N
        listStylesCombo.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.listStylesCombo.AccessibleContext.accessibleDescription")); // NOI18N

        transferModeLab.setLabelFor(transferModeCombo);
        org.openide.awt.Mnemonics.setLocalizedText(transferModeLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.transferModeLab.text")); // NOI18N
        ...
        transferModeLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.transferModeLab.AccessibleContext.accessibleDescription")); // NOI18N
        ...
        transferModeCombo.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.transferModeCombo.AccessibleContext.accessibleName")); // NOI18N
        transferModeCombo.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.transferModeCombo.AccessibleContext.accessibleDescription")); // NOI18N
        ...
        hostImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.hostImgLab.text")); // NOI18N
        hostImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        portImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.portImgLab.text")); // NOI18N
        portImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        portImgLab.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.portImgLab.AccessibleContext.accessibleName")); // NOI18N
        ...
        userImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.userImgLab.text")); // NOI18N
        userImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        passwdImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.passwdImgLab.text")); // NOI18N
        passwdImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        lstStyleImgLab.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/netbeans/modules/wsdlextensions/ftp/resources/service_composition_16.png"))); // NOI18N
        lstStyleImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.lstStyleImgLab.text")); // NOI18N
        lstStyleImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        lstStyleImgLab.setName("lstStyleImgLab"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 0);
        connectionPanel.add(lstStyleImgLab, gridBagConstraints);
        ...
        transModeImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.transModeImgLab.text")); // NOI18N
        transModeImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        ftpConfigTabbedPane.addTab(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.connectionPanel.TabConstraints.tabTitle"), connectionPanel); // NOI18N
        connectionPanel.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.connectionPanel.AccessibleContext.accessibleName")); // NOI18N
        connectionPanel.getAccessibleContext().setAccessibleDescription("FTP Connection Setting");
        ...
        org.openide.awt.Mnemonics.setLocalizedText(securedFTPTypeLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.securedFTPTypeLab.text")); // NOI18N
        ...
        securedFTPTypeLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.securedFTPTypeLab.AccessibleContext.accessibleDescription")); // NOI18N
        ...
        securedFTPTypeCombo.setNextFocusableComponent(enableCCCCheckLab);
        ...
        securedFTPTypeCombo.getAccessibleContext().setAccessibleName("secure ftp type selection");
        securedFTPTypeCombo.getAccessibleContext().setAccessibleDescription("secure ftp type selection");

        org.openide.awt.Mnemonics.setLocalizedText(enableCCCCheckLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.enableCCCCheckLab.text")); // NOI18N
        enableCCCCheckLab.setName("enableCCCCheckLab"); // NOI18N
        enableCCCCheckLab.setNextFocusableComponent(keyStoreText);
        ...
        enableCCCCheckLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.enableCCCCheckLab.AccessibleContext.accessibleDescription")); // NOI18N

        keyStoreLab.setLabelFor(keyStoreText);
        org.openide.awt.Mnemonics.setLocalizedText(keyStoreLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.keyStoreLab.text")); // NOI18N
        ...
        keyStoreLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.keyStoreLab.AccessibleContext.accessibleDescription")); // NOI18N

        keyStoreText.setName("keyStoreText"); // NOI18N
        keyStoreText.setNextFocusableComponent(keyStorePasswdText);
        ...
        keyStoreText.getAccessibleContext().setAccessibleName("key store location field");
        keyStoreText.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.keyStoreText.AccessibleContext.accessibleDescription")); // NOI18N

        keyStorePasswdLab.setLabelFor(keyStorePasswdText);
        org.openide.awt.Mnemonics.setLocalizedText(keyStorePasswdLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.keyStorePasswdLab.text")); // NOI18N
        ...
        keyStorePasswdLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.keyStorePasswdLab.AccessibleContext.accessibleDescription")); // NOI18N

        keyStorePasswdText.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.keyStorePasswdText.text")); // NOI18N
        keyStorePasswdText.setName("keyStorePasswdText"); // NOI18N
        keyStorePasswdText.setNextFocusableComponent(keyAliasText);
        ...
        keyStorePasswdText.getAccessibleContext().setAccessibleName("key store password field");
        keyStorePasswdText.getAccessibleContext().setAccessibleDescription("key store password field");

        keyAliasLab.setLabelFor(keyAliasText);
        org.openide.awt.Mnemonics.setLocalizedText(keyAliasLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.keyAliasLab.text")); // NOI18N
        ...
        keyAliasLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.keyAliasLab.AccessibleContext.accessibleDescription")); // NOI18N

        keyAliasText.setName("keyAliasText"); // NOI18N
        keyAliasText.setNextFocusableComponent(keyAliasPasswdFld);
        ...
        keyAliasText.getAccessibleContext().setAccessibleName("key alias field");
        keyAliasText.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.keyAliasText.AccessibleContext.accessibleDescription")); // NOI18N

        keyAliasPasswdLab.setLabelFor(keyAliasPasswdFld);
        org.openide.awt.Mnemonics.setLocalizedText(keyAliasPasswdLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.keyAliasPasswdLab.text")); // NOI18N
        ...
        keyAliasPasswdLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.keyAliasPasswdLab.AccessibleContext.accessibleDescription")); // NOI18N

        keyAliasPasswdFld.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.keyAliasPasswdFld.text")); // NOI18N
        keyAliasPasswdFld.setName("keyAliasPasswdFld"); // NOI18N
        keyAliasPasswdFld.setNextFocusableComponent(trustStoreText);
        ...
        keyAliasPasswdFld.getAccessibleContext().setAccessibleName("key password field");
        keyAliasPasswdFld.getAccessibleContext().setAccessibleDescription("key password field");

        trustStoreLab.setLabelFor(trustStoreText);
        org.openide.awt.Mnemonics.setLocalizedText(trustStoreLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.trustStoreLab.text")); // NOI18N
        ...
        trustStoreLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.trustStoreLab.AccessibleContext.accessibleDescription")); // NOI18N

        trustStoreText.setName("trustStoreText"); // NOI18N
        trustStoreText.setNextFocusableComponent(trustStorePasswdFld);
        ...
        trustStoreText.getAccessibleContext().setAccessibleName("trust store location field");
        trustStoreText.getAccessibleContext().setAccessibleDescription("trust store location field");

        trustStorePasswdLab.setLabelFor(trustStorePasswdFld);
        org.openide.awt.Mnemonics.setLocalizedText(trustStorePasswdLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.trustStorePasswdLab.text")); // NOI18N
        ...
        trustStorePasswdLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.trustStorePasswdLab.AccessibleContext.accessibleDescription")); // NOI18N

        trustStorePasswdFld.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.trustStorePasswdFld.text")); // NOI18N
        ...
        trustStorePasswdFld.getAccessibleContext().setAccessibleName("trust store password field");
        trustStorePasswdFld.getAccessibleContext().setAccessibleDescription("trust store password field");
        ...
        secTypeImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.secTypeImgLab.text")); // NOI18N
        secTypeImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        cccImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.cccImgLab.text")); // NOI18N
        cccImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        ksLocImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.ksLocImgLab.text")); // NOI18N
        ksLocImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        ksPasswdImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.ksPasswdImgLab.text")); // NOI18N
        ksPasswdImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        kaliasImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.kaliasImgLab.text")); // NOI18N
        kaliasImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        kaliasPasswdImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.kaliasPasswdImgLab.text")); // NOI18N
        kaliasPasswdImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        tsLocImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.tsLocImgLab.text")); // NOI18N
        tsLocImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        tsPasswdImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.tsPasswdImgLab.text")); // NOI18N
        tsPasswdImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        ftpConfigTabbedPane.addTab(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.sslConfigPanel.TabConstraints.tabTitle"), sslConfigPanel); // NOI18N
        sslConfigPanel.getAccessibleContext().setAccessibleName("FTP SSL Setting");
        sslConfigPanel.getAccessibleContext().setAccessibleDescription("FTP SSL Setting");
        ...
        org.openide.awt.Mnemonics.setLocalizedText(controlEncodingLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.controlEncodingLab.text")); // NOI18N
        ...
        controlEncodingLab.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.controlEncodingLab.AccessibleContext.accessibleName")); // NOI18N
        controlEncodingLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.controlEncodingLab.AccessibleContext.accessibleDescription")); // NOI18N
        ...
        controlEncodingText.getAccessibleContext().setAccessibleName("control encoding field");
        controlEncodingText.getAccessibleContext().setAccessibleDescription("control encoding field");

        cmdChannelTimeoutLab.setLabelFor(cmdChannelTimeoutText);
        org.openide.awt.Mnemonics.setLocalizedText(cmdChannelTimeoutLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.cmdChannelTimeoutLab.text")); // NOI18N
        ...
        cmdChannelTimeoutLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.cmdChannelTimeoutLab.AccessibleContext.accessibleDescription")); // NOI18N
        ...
        cmdChannelTimeoutText.getAccessibleContext().setAccessibleName("command channel timeout field");
        cmdChannelTimeoutText.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.cmdChannelTimeoutText.AccessibleContext.accessibleDescription")); // NOI18N

        dataChannelTimeoutLab.setLabelFor(dataChannelTimeoutText);
        org.openide.awt.Mnemonics.setLocalizedText(dataChannelTimeoutLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.dataChannelTimeoutLab.text")); // NOI18N
        ...
        dataChannelTimeoutLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.dataChannelTimeoutLab.AccessibleContext.accessibleDescription")); // NOI18N
        ...
        dataChannelTimeoutText.getAccessibleContext().setAccessibleName("data channel timeout field");
        dataChannelTimeoutText.getAccessibleContext().setAccessibleDescription("data channel timeout field");

        org.openide.awt.Mnemonics.setLocalizedText(useUDStyleCheck, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.useUDStyleCheck.text")); // NOI18N
        ...
        useUDStyleCheck.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.useUDStyleCheck.AccessibleContext.accessibleDescription")); // NOI18N

        userListStyleNameLab.setLabelFor(userListStyleNameText);
        org.openide.awt.Mnemonics.setLocalizedText(userListStyleNameLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.userListStyleNameLab.text")); // NOI18N
        ...
        userListStyleNameLab.getAccessibleContext().setAccessibleDescription("User Defined Directory List St&yle");
        ...
        userListStyleNameText.getAccessibleContext().setAccessibleName("user defined directory listing style");
        userListStyleNameText.getAccessibleContext().setAccessibleDescription("user defined directory listing style");

        userListStyleLocLab.setLabelFor(userListStyleLocText);
        org.openide.awt.Mnemonics.setLocalizedText(userListStyleLocLab, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.userListStyleLocLab.text")); // NOI18N
        ...
        userListStyleLocLab.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.userListStyleLocLab.AccessibleContext.accessibleDescription")); // NOI18N
        ...
        userListStyleLocText.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.userListStyleLocText.AccessibleContext.accessibleName")); // NOI18N
        userListStyleLocText.getAccessibleContext().setAccessibleDescription("user defined directory listing style");
        ...
        ctlEncodingImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.ctlEncodingImgLab.text")); // NOI18N
        ctlEncodingImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        cmdTimeoutImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.cmdTimeoutImgLab.text")); // NOI18N
        cmdTimeoutImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        dataTimeoutImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.dataTimeoutImgLab.text")); // NOI18N
        dataTimeoutImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        useUDImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.useUDImgLab.text")); // NOI18N
        useUDImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        udStyleImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.udStyleImgLab.text")); // NOI18N
        udStyleImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        udStyleCfgImgLab.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.udStyleCfgImgLab.text")); // NOI18N
        udStyleCfgImgLab.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        userListStyleLocLab1.setLabelFor(userListStyleLocText);
        org.openide.awt.Mnemonics.setLocalizedText(userListStyleLocLab1, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.userListStyleLocLab1.text")); // NOI18N
        userListStyleLocLab1.setName("userListStyleLocLab1"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(10, 30, 10, 10);
        advancedPanel.add(userListStyleLocLab1, gridBagConstraints);

        persistLocLab1.setLabelFor(persistLocText);
        org.openide.awt.Mnemonics.setLocalizedText(persistLocLab1, org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.persistLocLab1.text")); // NOI18N
        ...
        persistLocLab1.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.persistLocLab1.AccessibleContext.accessibleDescription")); // NOI18N
        ...
        persistLocImgLab1.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.persistLocImgLab1.text")); // NOI18N
        persistLocImgLab1.setToolTipText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPBCConfigurationEditorProvider.ImgIconSrvCompEditable.tooltip")); // NOI18N
        ...
        persistLocText.setText(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.persistLocText.text")); // NOI18N
        ...
        persistLocText.getAccessibleContext().setAccessibleName("persistence base location");
        persistLocText.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.persistLocText.AccessibleContext.accessibleDescription")); // NOI18N

        ftpConfigTabbedPane.addTab(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.advancedPanel.TabConstraints.tabTitle"), advancedPanel); // NOI18N
        advancedPanel.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.advancedPanel.AccessibleContext.accessibleName")); // NOI18N
        advancedPanel.getAccessibleContext().setAccessibleDescription("FTP Advanced Setting");
        ...
        ftpOneWayCfgPanel.add(ftpConfigTabbedPane, gridBagConstraints);
        ftpConfigTabbedPane.getAccessibleContext().setAccessibleName("FTP Configuration Tabbed Pane");
        ftpConfigTabbedPane.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.ftpConfigTabbedPane.AccessibleContext.accessibleDescription")); // NOI18N

        jSplitPane1.setLeftComponent(ftpOneWayCfgPanel);
        ftpOneWayCfgPanel.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.ftpOneWayCfgPanel.AccessibleContext.accessibleName")); // NOI18N
        ftpOneWayCfgPanel.getAccessibleContext().setAccessibleDescription("ftp one way configuration panel");

        descPanel.setMinimumSize(new java.awt.Dimension(610, 70));
        descPanel.setName("descPanel"); // NOI18N
        descPanel.setPreferredSize(new java.awt.Dimension(610, 70));
        ...
        descPanel.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.descPanel.AccessibleContext.accessibleName")); // NOI18N
        descPanel.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.descPanel.AccessibleContext.accessibleDescription")); // NOI18N

        add(jSplitPane1, java.awt.BorderLayout.CENTER);
        jSplitPane1.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.jSplitPane1.AccessibleContext.accessibleName")); // NOI18N
        jSplitPane1.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.jSplitPane1.AccessibleContext.accessibleDescription")); // NOI18N

        getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.AccessibleContext.accessibleName")); // NOI18N
        getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FTPSettingsOneWayPanel.class, "FTPSettingsOneWayPanel.AccessibleContext.accessibleDescription")); // NOI18N
...
// TODO add your handling code here:
    ...
    private void initCustomComponents() {
        ...
        gridBagConstraints.weightx = 0.5;
        gridBagConstraints.weighty = 0.5;
        ftpOneWayCfgPanel.add(tmpPanel, gridBagConstraints);
        /**
    ...
    private javax.swing.JPanel ftpOneWayCfgPanel;
    ...
    private javax.swing.JLabel lstStyleImgLab;
    ...
    private javax.swing.JLabel userListStyleLocLab1;
