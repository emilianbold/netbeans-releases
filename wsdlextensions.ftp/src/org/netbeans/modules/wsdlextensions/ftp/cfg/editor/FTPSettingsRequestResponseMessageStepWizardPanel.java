...
public class FTPSettingsRequestResponseMessageStepWizardPanel extends WSDLWizardDescriptorPanel {
    ...
    public FTPSettingsRequestResponseMessageStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }
     ...
     */
    private FTPSettingsRequestResponseMessagePanel mPanel;
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new FTPSettingsRequestResponseMessagePanel(mQName, mComponent);
        }
    ...
    public boolean isValid() {
        ...
        // if me is valid, but others are not
        // then disable "finish", but allow "next"
        // if every one is valid, then both "next" and "finish"
    ...
    public String getName() {
        return NbBundle.getMessage(FTPSettingsRequestResponseMessageStepWizardPanel.class,
                "FTPSettingsRequestResponseMessageStepWizardPanel.StepLabel");
    }
