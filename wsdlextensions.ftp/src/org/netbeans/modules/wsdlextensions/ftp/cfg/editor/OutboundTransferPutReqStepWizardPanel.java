...
public class OutboundTransferPutReqStepWizardPanel extends WSDLWizardDescriptorPanel {
    ...
    public OutboundTransferPutReqStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }

    public OutboundTransferPutReqStepWizardPanel(WSDLWizardContext context, boolean oneway, boolean isLast) {
        this(context);
        mIsLast = isLast;
        bOneWay = oneway;
    }
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new OutboundTransferPanel(mQName, mWSDLComponent, bOneWay, true);
        }
    ...
    public String getName() {
        return NbBundle.getMessage(OutboundTransferPutReqStepWizardPanel.class,
                "OutboundTransferPutReqStepWizardPanel.StepLabel");        
    }
