...
public class InboundTransferPollReqStepWizardPanel extends WSDLWizardDescriptorPanel {
    ...
    public InboundTransferPollReqStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }
    
    public InboundTransferPollReqStepWizardPanel(WSDLWizardContext context, boolean oneway, boolean isLast) {
        this(context);
        mIsLast = isLast;
        bOneWay = oneway;
    }
     ...
     */
    private InboundTransferPanel mPanel;
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new InboundTransferPanel(mQName, mComponent, bOneWay, true, false);
        }
    ...
    public String getName() {
        return NbBundle.getMessage(InboundTransferPollReqStepWizardPanel.class,
                "InboundTransferPollReqStepWizardPanel.StepLabel");
    }
