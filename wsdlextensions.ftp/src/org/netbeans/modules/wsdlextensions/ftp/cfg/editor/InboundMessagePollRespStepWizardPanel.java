...
public class InboundMessagePollRespStepWizardPanel extends WSDLWizardDescriptorPanel {
    ...
    public InboundMessagePollRespStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }
    
    public InboundMessagePollRespStepWizardPanel(WSDLWizardContext context, boolean oneway, boolean isLast) {
        this(context);
        mIsLast = isLast;
        mOneWay = oneway;
    }
    
    public InboundMessagePollRespStepWizardPanel(WSDLWizardContext context, boolean oneway, boolean isLast, boolean solicit) {
        this(context);
        mOneWay = oneway;
        mIsLast = isLast;
        mSolicit = solicit;
     ...
     */
    private InboundMessagePanel mPanel;
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new InboundMessagePanel(mQName, mComponent, mOneWay, false, mSolicit);
        }
    ...
    public String getName() {
        return NbBundle.getMessage(InboundMessagePollRespStepWizardPanel.class,
                mSolicit ? "InboundMessagePollRespStepWizardPanel.Solicit.StepLabel" : "InboundMessagePollRespStepWizardPanel.StepLabel");
    }
