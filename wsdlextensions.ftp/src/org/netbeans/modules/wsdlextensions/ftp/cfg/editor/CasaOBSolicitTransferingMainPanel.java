 ...
 */
public class CasaOBSolicitTransferingMainPanel extends javax.swing.JPanel implements BindingConfigurationDelegate {
    ...
    /** Creates new form CasaOBSolicitTransferingMainPanel */
    public CasaOBSolicitTransferingMainPanel(WSDLComponent component, PropertyChangeSupport proxy) {
    ...
    public InboundTransferPanel getOBTransferPanel() {
    ...
    private void initCustomComponents() {
        ...
        mIBTransferPanel = new InboundTransferPanel(mQName, mComponent, true, true, true, mProxy);
    ...
    private void initComponents() {
        ...
        jTabbedPane1.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(CasaOBSolicitTransferingMainPanel.class, "CasaOBSolicitTransferingMainPanel.jTabbedPane1.AccessibleContext.accessibleName")); // NOI18N
        jTabbedPane1.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(CasaOBSolicitTransferingMainPanel.class, "CasaOBSolicitTransferingMainPanel.jTabbedPane1.AccessibleContext.accessibleDescription")); // NOI18N

        add(jPanel1, java.awt.BorderLayout.CENTER);
        jPanel1.getAccessibleContext().setAccessibleName("CASA Outbound Solicit Transferring Main Panel");
        jPanel1.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(CasaOBSolicitTransferingMainPanel.class, "CasaOBSolicitTransferingMainPanel.jPanel1.AccessibleContext.accessibleDescription")); // NOI18N
