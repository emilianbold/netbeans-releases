...
public class FTPSettingsRequestResponseTransferStepWizardPanel extends WSDLWizardDescriptorPanel {
    ...
    public FTPSettingsRequestResponseTransferStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }
     ...
     */
    private FTPSettingsRequestResponseTransferPanel mPanel;
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new FTPSettingsRequestResponseTransferPanel(mQName, mComponent);
        }
    ...
    public String getName() {
        return NbBundle.getMessage(FTPSettingsRequestResponseTransferStepWizardPanel.class,
                "FTPSettingsRequestResponseTransferStepWizardPanel.StepLabel");
    }
