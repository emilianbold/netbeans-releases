...
public class InboundTransferPollRespStepWizardPanel extends WSDLWizardDescriptorPanel {
    ...
    public InboundTransferPollRespStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }

    public InboundTransferPollRespStepWizardPanel(WSDLWizardContext context, boolean oneway, boolean isLast) {
        this(context);
        mIsLast = isLast;
        bOneWay = oneway;
    }

    public InboundTransferPollRespStepWizardPanel(WSDLWizardContext context, boolean oneway, boolean isLast, boolean solicit) {
        this(context);
        mIsLast = isLast;
        mSolicit = solicit;
        bOneWay = oneway;
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new InboundTransferPanel(mQName, mComponent, bOneWay, false, mSolicit);
        }
    ...
    public String getName() {
        return NbBundle.getMessage(InboundTransferPollRespStepWizardPanel.class,
                mSolicit ? "InboundTransferPollRespStepWizardPanel.Solicit.StepLabel" : "InboundTransferPollRespStepWizardPanel.StepLabel");
    }
