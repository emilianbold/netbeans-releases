/*
 * CasaIB1WayTransferingMainPanel.java
 *
 */
 ...
 */
public class CasaIB1WayTransferingMainPanel extends javax.swing.JPanel implements BindingConfigurationDelegate {

    private FTPSettingsOneWayPanel mFTP1WayPanel = null;
    private InboundTransferPanel mIBTransPanel = null;
    ...
    public CasaIB1WayTransferingMainPanel(WSDLComponent component, PropertyChangeSupport proxy) {
    ...
    public void populateView(WSDLComponent component) {
        ...
        if (mIBTransPanel != null) {
            mIBTransPanel.populateView(null, component);                    
        }     
    }
    ...
    public boolean commit() {
        ...
        if (mIBTransPanel != null) {
            result = result && mIBTransPanel.commit();
        }     
        return result;
    }
    ...
    public void enablePayloadProcessing(boolean enable) {
        if (mIBTransPanel != null) {
            mIBTransPanel.enablePayloadProcessing(enable);                    
        }     
    }
    ...
    public void setProject(Project project) {
        ...
        if (mIBTransPanel != null) {
            mIBTransPanel.setProject(project);                    
        }     
    }    
    ...
    public void setOperationName(String opName) {
        ...
        if (mIBTransPanel != null) {
            mIBTransPanel.setOperationName(opName);
        }  
    }
    ...
    private void initCustomComponents() {
        ...
        mIBTransPanel = new InboundTransferPanel(mQName, mComponent, true, true, false, mProxy);
        
        jTabbedPane1.addTab("1."+mFTP1WayPanel.getName(), mFTP1WayPanel);
        jTabbedPane1.addTab("2."+mIBTransPanel.getName(), mIBTransPanel);
    ...
    private void initComponents() {
        ...
        jTabbedPane1.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(CasaIB1WayTransferingMainPanel.class, "CasaIB1WayTransferingMainPanel.jTabbedPane1.AccessibleContext.accessibleName")); // NOI18N
        jTabbedPane1.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(CasaIB1WayTransferingMainPanel.class, "CasaIB1WayTransferingMainPanel.jTabbedPane1.AccessibleContext.accessibleDescription")); // NOI18N

        add(jPanel1, java.awt.BorderLayout.CENTER);

        getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(CasaIB1WayTransferingMainPanel.class, "CasaIB1WayTransferingMainPanel.AccessibleContext.accessibleName")); // NOI18N
        getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(CasaIB1WayTransferingMainPanel.class, "CasaIB1WayTransferingMainPanel.AccessibleContext.accessibleDescription")); // NOI18N
