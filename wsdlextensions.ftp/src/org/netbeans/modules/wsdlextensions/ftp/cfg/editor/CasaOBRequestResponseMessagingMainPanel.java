 ...
 */
public class CasaOBRequestResponseMessagingMainPanel extends javax.swing.JPanel implements BindingConfigurationDelegate {
    ...
    public CasaOBRequestResponseMessagingMainPanel(WSDLComponent component, PropertyChangeSupport proxy) {
    ...
    private void initCustomComponents() {
        ...
        mIBMsgPanel = new InboundMessagePanel(mQName, mComponent, false, false, false, mProxy);
        mOBMsgPanel = new OutboundMessagePanel(mQName, mComponent, false, true, mProxy);
        
        jTabbedPane1.addTab("1." + mFTPReqRespMessagePanel.getName(), mFTPReqRespMessagePanel);
        jTabbedPane1.addTab("2." + mOBMsgPanel.getName(), mOBMsgPanel); // put req
        jTabbedPane1.addTab("3." + mIBMsgPanel.getName(), mIBMsgPanel); // poll resp
    ...
    private void initComponents() {
        ...
        jTabbedPane1.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(CasaOBRequestResponseMessagingMainPanel.class, "CasaOBRequestResponseMessagingMainPanel.jTabbedPane1.AccessibleContext.accessibleName")); // NOI18N
        jTabbedPane1.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(CasaOBRequestResponseMessagingMainPanel.class, "CasaOBRequestResponseMessagingMainPanel.jTabbedPane1.AccessibleContext.accessibleDescription")); // NOI18N

        add(jPanel1, java.awt.BorderLayout.CENTER);
        jPanel1.getAccessibleContext().setAccessibleName("CASA Outbound Request Response Messaging Main Panel");
        jPanel1.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(CasaOBRequestResponseMessagingMainPanel.class, "CasaOBRequestResponseMessagingMainPanel.jPanel1.AccessibleContext.accessibleDescription")); // NOI18N
