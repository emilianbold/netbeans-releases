...
public class OutboundMessagePutRespStepWizardPanel extends WSDLWizardDescriptorPanel {
     ...
     */
    WSDLComponent mWSDLComponent = null;
    boolean mValid = true;
    ...
    public OutboundMessagePutRespStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }

    public OutboundMessagePutRespStepWizardPanel(WSDLWizardContext context, boolean oneway, boolean isLast) {
        this(context);
        mIsLast = isLast;
        mOneWay = oneway;
    }
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new OutboundMessagePanel(mQName, mWSDLComponent, mOneWay, false);
        }
    ...
    public void readSettings(Object settings) {       
       ...
       if ((myContext != null) && (myContext.getWSDLModel() != null)) {
           ...
           mWSDLComponent = Utilities.getAddress(defs);
           mPortType = Utilities.getPortType((FTPAddress) mWSDLComponent);
       }        
    }
    ...
    public String getName() {
        return NbBundle.getMessage(OutboundMessagePutRespStepWizardPanel.class,
                "OutboundMessagePutRespStepWizardPanel.StepLabel");        
    }
        ...
        if (mPanel != null) {
            ...
            if ((ok) && (mTemplateWizard.
                ...
                boolean genPortLinkType = ((Boolean) mTemplateWizard.
                        getProperty("GENERATE_PARTNER_LINKTYPE")).booleanValue();//NOI18N
                if (genPortLinkType) {
                    BindingComponentUtils.createPartnerLinkType(mPortType, 
                            mWSDLComponent.getModel(), false);
                }                                
            }            
        } 
        return true;
