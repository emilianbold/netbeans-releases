 ...
 */
public class CasaIBRequestResponseTransferingMainPanel extends javax.swing.JPanel implements BindingConfigurationDelegate {
    ...
    public CasaIBRequestResponseTransferingMainPanel(WSDLComponent component, PropertyChangeSupport proxy) {
    ...
    private void initCustomComponents() {
        ...
        mIBTransferPanel = new InboundTransferPanel(mQName, mComponent, false, true, false, mProxy);
        mOBTransferPanel = new OutboundTransferPanel(mQName, mComponent, false, false, mProxy);
        
        jTabbedPane1.addTab("1." + mFTPReqRespTransferPanel.getName(), mFTPReqRespTransferPanel);
        jTabbedPane1.addTab("2." + mIBTransferPanel.getName(), mIBTransferPanel);
        jTabbedPane1.addTab("3." + mOBTransferPanel.getName(), mOBTransferPanel);
    ...
    private void initComponents() {
        ...
        jTabbedPane1.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(CasaIBRequestResponseTransferingMainPanel.class, "CasaIBRequestResponseTransferingMainPanel.jTabbedPane1.AccessibleContext.accessibleName")); // NOI18N
        jTabbedPane1.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(CasaIBRequestResponseTransferingMainPanel.class, "CasaIBRequestResponseTransferingMainPanel.jTabbedPane1.AccessibleContext.accessibleDescription")); // NOI18N

        add(jPanel1, java.awt.BorderLayout.CENTER);
        jPanel1.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(CasaIBRequestResponseTransferingMainPanel.class, "CasaIBRequestResponseTransferingMainPanel.jPanel1.AccessibleContext.accessibleName")); // NOI18N
        jPanel1.getAccessibleContext().setAccessibleDescription("CASA Inbound Request Response Transferring Main Panel");
