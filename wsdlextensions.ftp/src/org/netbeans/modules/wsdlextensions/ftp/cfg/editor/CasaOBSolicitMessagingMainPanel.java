 ...
 */
public class CasaOBSolicitMessagingMainPanel extends javax.swing.JPanel implements BindingConfigurationDelegate {
    ...
    /** Creates new form CasaOBSolicitMessagingMainPanel */
    public CasaOBSolicitMessagingMainPanel(WSDLComponent component, PropertyChangeSupport proxy) {
    ...
    public InboundMessagePanel getOBMessagePanel() {
        return mIBMsgPanel;
    }
    ...
    private void initCustomComponents() {
        ...
        mIBMsgPanel = new InboundMessagePanel(mQName, mComponent, true, true, true, mProxy);
    ...
    private void initComponents() {
        ...
        jTabbedPane1.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(CasaOBSolicitMessagingMainPanel.class, "CasaOBSolicitMessagingMainPanel.jTabbedPane1.AccessibleContext.accessibleName")); // NOI18N
        jTabbedPane1.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(CasaOBSolicitMessagingMainPanel.class, "CasaOBSolicitMessagingMainPanel.jTabbedPane1.AccessibleContext.accessibleDescription")); // NOI18N

        add(jPanel1, java.awt.BorderLayout.CENTER);
        jPanel1.getAccessibleContext().setAccessibleName("CASA Outbound Solicit Messaging Main Panel");
        jPanel1.getAccessibleContext().setAccessibleDescription("CASA Outbound Solicit Messaging Main Panel");
