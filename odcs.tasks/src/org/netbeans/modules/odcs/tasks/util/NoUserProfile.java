...
public class NoUserProfile extends TaskUserProfile {
    ...
    public NoUserProfile() {
        setLoginName(display);
        setRealname(display);
        // hopefully we never run into situations when getID & co. will be necessary
    }
    ...
    public int hashCode() {
        int hash = 3;
        hash = 11 * hash + Objects.hashCode(this.display);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final NoUserProfile other = (NoUserProfile) obj;
