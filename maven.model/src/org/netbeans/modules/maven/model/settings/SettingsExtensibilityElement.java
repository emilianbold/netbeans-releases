 ...
 * @author mkleint
 */
public interface SettingsExtensibilityElement extends SettingsComponent {
     ...
     */
    interface UpdaterProvider extends SettingsExtensibilityElement {
        /**
         * @return component updater to be used in merge operations when source sync happens.
         */
        <T extends SettingsExtensibilityElement> ComponentUpdater<T> getComponentUpdater();
    }
    
    /**
     * Interface for an extensibility element that is a root of an embedded model.
     */
    interface EmbeddedModel extends SettingsExtensibilityElement {
