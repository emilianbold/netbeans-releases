...
public class ActivationPropertyImpl extends ProfilesComponentImpl implements ActivationProperty {
    ...
    public ActivationPropertyImpl(ProfilesModel model, Element element) {
        super(model, element);
    }
    
    public ActivationPropertyImpl(ProfilesModel model) {
        this(model, createElementNS(model, model.getProfilesQNames().ACTIVATIONPROPERTY));
    }
    ...
    public String getValue() {
        return getChildElementText(getModel().getProfilesQNames().VALUE.getQName());
    }

    public void setValue(String value) {
        setChildElementText(getModel().getProfilesQNames().VALUE.getName(), value,
                getModel().getProfilesQNames().VALUE.getQName());
    }
