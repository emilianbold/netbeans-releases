...
public class ActivationImpl extends ProfilesComponentImpl implements Activation {
    ...
    public ActivationImpl(ProfilesModel model, Element element) {
        super(model, element);
    }
    
    public ActivationImpl(ProfilesModel model) {
        this(model, createElementNS(model, model.getProfilesQNames().ACTIVATION));
    }
    ...
    public void setActivationOS(ActivationOS activationOS) {
        List<Class<? extends ProfilesComponent>> empty = Collections.emptyList();
        setChild(ActivationOS.class, getModel().getProfilesQNames().ACTIVATIONOS.getName(), activationOS, empty);
    }
    ...
    public void setActivationProperty(ActivationProperty activationProperty) {
        List<Class<? extends ProfilesComponent>> empty = Collections.emptyList();
        setChild(ActivationProperty.class, getModel().getProfilesQNames().ACTIVATIONPROPERTY.getName(), activationProperty, empty);
    }
    ...
    public void setActivationFile(ActivationFile activationFile) {
        List<Class<? extends ProfilesComponent>> empty = Collections.emptyList();
        setChild(ActivationFile.class, getModel().getProfilesQNames().ACTIVATIONFILE.getName(), activationFile, empty);
    }
    ...
    public void setActivationCustom(ActivationCustom activationCustom) {
        List<Class<? extends ProfilesComponent>> empty = Collections.emptyList();
        setChild(ActivationCustom.class, getModel().getProfilesQNames().ACTIVATIONCUSTOM.getName(), activationCustom, empty);
    }
