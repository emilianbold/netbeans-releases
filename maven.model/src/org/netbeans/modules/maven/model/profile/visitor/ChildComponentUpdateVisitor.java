 ...
 * @author mkleint
 */
public class ChildComponentUpdateVisitor<T extends ProfilesComponent>
    ...
    public boolean canAdd(ProfilesComponent target, Component child) {
        if (!(child instanceof ProfilesComponent)) return false;
        update(target, (ProfilesComponent) child, null);
        return canAdd;
    }
    
    public void update(ProfilesComponent target, ProfilesComponent child, Operation operation) {
        update(target, child, -1, operation);
    }
    
    public void update(ProfilesComponent target, ProfilesComponent child, int index, Operation operation) {
        assert target != null;
        assert child != null;
