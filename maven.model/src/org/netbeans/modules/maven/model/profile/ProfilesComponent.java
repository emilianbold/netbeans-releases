...
public interface ProfilesComponent extends DocumentComponent<ProfilesComponent> {
    ...
    void accept(ProfilesComponentVisitor visitor);
     ...
     */
    void addExtensibilityElement(ProfilesExtensibilityElement ee);
     ...
     */
    void removeExtensibilityElement(ProfilesExtensibilityElement ee);
     ...
     */
    <T extends ProfilesExtensibilityElement> List<T> getExtensibilityElements(Class<T> type);
