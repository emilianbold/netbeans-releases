 ...
 * @author mkleint
 */
public class ProfilesModelFactory extends AbstractModelFactory<ProfilesModel> {
    
    private static final ProfilesModelFactory modelFactory = new ProfilesModelFactory();
    
    public static ProfilesModelFactory getDefault(){
        return modelFactory;
    }
    
    /** Creates a new instance of ProfilesModelFactory */
    private ProfilesModelFactory() {
    }
     ...
     */
    @Override
    public ProfilesModel getModel(ModelSource source) {
    ...
    protected ProfilesModel createModel(ModelSource source) {
        return new ProfilesModelImpl(source);
    }
}
