 ...
 * @author mkleint
 */
public interface ProfilesExtensibilityElement extends ProfilesComponent {
     ...
     */
    public void addAnyElement(ProfilesExtensibilityElement anyElement, int index);
    
    /**
     * Removes child extensibility element of unknown type.
     */
    public void removeAnyElement(ProfilesExtensibilityElement any);
    
    /**
     * @returns list of children extensibility elements of unknown type.
     */
    public List<ProfilesExtensibilityElement> getAnyElements();
     ...
     */
    interface UpdaterProvider extends ProfilesExtensibilityElement {
        /**
         * @return component updater to be used in merge operations when source sync happens.
         */
        <T extends ProfilesExtensibilityElement> ComponentUpdater<T> getComponentUpdater();
    }
    
    /**
     * Interface for an extensibility element that is a root of an embedded model.
     */
    interface EmbeddedModel extends ProfilesExtensibilityElement {
