...
public class MakefilePrintOptions extends BasePrintOptions {
    ...
    public MakefilePrintOptions() {
        this(MakefileKit.class, MAKEFILE);
    }

    public MakefilePrintOptions(Class kitClass, String typeName) {
    ...
    protected String getString(String s) {
        try {
            String res = NbBundle.getBundle(MakefilePrintOptions.class).getString(s);
    ...
    public HelpCtx getHelpCtx () {
        return new HelpCtx ("Welcome_opt_print_makefile"); // NOI18N
    }
}
