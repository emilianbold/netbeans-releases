...
public class FuncMethodNode extends ViewNode {
    public FuncMethodNode(DataObject dao, String name, int lineno, char kind, String scope, int scopeCluster, int cluster) {
