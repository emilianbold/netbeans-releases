...
/**
* Extended settings for Shell.
*
*/

public class ShellSettingsInitializer extends Settings.AbstractInitializer {

  /** Name assigned to initializer */
  public static final String NAME = "shell-settings-initializer"; //NOI18N
  ...
  */
  public ShellSettingsInitializer(Class fKitClass) {
    super(NAME);
  ...
  public void updateSettingsMap(Class kitClass, Map settingsMap) {
    ...
    if (kitClass == fKitClass) {
      ...
      settingsMap.put(ExtSettingsNames.HIGHLIGHT_MATCH_BRACE,
                      ShellSettingsDefaults.defaultHighlightMatchBrace);

      settingsMap.put(SettingsNames.IDENTIFIER_ACCEPTOR,
                      ShellSettingsDefaults.defaultIdentifierAcceptor);
