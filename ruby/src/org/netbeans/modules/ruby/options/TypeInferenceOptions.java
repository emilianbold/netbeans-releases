 ...
 * @author Erno Mononen
 */
public final class TypeInferenceOptions extends AdvancedOption {

    @Override
    public String getDisplayName() {
        return NbBundle.getMessage(TypeInferenceOptions.class, "TypeInferenceOptionsPanel.tiOptionsLabel.text");
    }
    ...
    private static final class Controller extends OptionsPanelController {
        ...
        private final TypeInferenceOptionsPanel component = new TypeInferenceOptionsPanel();
        ...
        public HelpCtx getHelpCtx() {
            return new HelpCtx(TypeInferenceOptions.class);
        }
