...
public abstract class ProjectNode extends ContainerNode {
    ...
    public ProjectNode(final Project project, ContainerNode root, final boolean includeSubprojects) {
        super(ProjectUtilities.getProjectName(project), ProjectUtilities.getProjectIcon(project), root);
        this.project = project;
        this.subprojects = includeSubprojects;
        setValid(ProjectUtilities.getClasspathInfo(project, includeSubprojects) != null);
    }

    public ProjectNode(Project project, boolean includeSubprojects) {
        this(project, null, includeSubprojects);
    }
    ...
    public boolean supportsSubprojects() {
        return subprojects;
    }
}
