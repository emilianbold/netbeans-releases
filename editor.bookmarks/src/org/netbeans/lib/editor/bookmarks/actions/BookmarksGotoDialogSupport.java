...
public class BookmarksGotoDialogSupport extends GotoDialogSupport {
    ...
    protected boolean performGoto() {
        ...
        if (c != null) {
            String gotoValue = getGotoValueText();
            try {
                Integer.parseInt(gotoValue); // Check if the value is numeric
    ...
    public static final class BookmarksGotoAction extends ExtKit.GotoAction {
        ...
        public void actionPerformed(ActionEvent evt, JTextComponent target) {
            if (target != null) {
                new BookmarksGotoDialogSupport().showGotoDialog(new KeyEventBlocker(target, false));
            }
        }
