...
public class ErrorNode extends LeafNode {
    ...
    public ErrorNode( String text, Action refreshAction ) {
        ...
        btnRefresh = new LinkButton(LBL_Retry(), refreshAction); //NOI18N
        lblMessage = new TreeLabel(text);
        lblMessage.setIcon(new ImageIcon(ImageUtilities.loadImage("org/netbeans/modules/team/server/resources/error.png"))); //NOI18N
    }
