...
abstract class BasicTransactionalTableDataProviderBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.dataprovider.designtime.impl.Bundle-JSF", Locale.getDefault(), BasicTransactionalTableDataProviderBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>BasicTransactionalTableDataProviderBeanInfoBase</code>.</p>
     */
    public BasicTransactionalTableDataProviderBeanInfoBase() {

        beanClass = com.sun.data.provider.impl.BasicTransactionalTableDataProvider.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/dataprovider/designtime/impl/BasicTransactionalTableDataProvider_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/dataprovider/designtime/impl/BasicTransactionalTableDataProvider_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/dataprovider/designtime/impl/BasicTransactionalTableDataProvider_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/dataprovider/designtime/impl/BasicTransactionalTableDataProvider_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("BasicTransactionalTableDataProvider_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("BasicTransactionalTableDataProvider_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"basicTransactionalTableDataProvider");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_class.setDisplayName(resources.getString("BasicTransactionalTableDataProvider_class_DisplayName"));
            prop_class.setShortDescription(resources.getString("BasicTransactionalTableDataProvider_class_Description"));
            ...
            prop_cursorRow.setDisplayName(resources.getString("BasicTransactionalTableDataProvider_cursorRow_DisplayName"));
            prop_cursorRow.setShortDescription(resources.getString("BasicTransactionalTableDataProvider_cursorRow_Description"));
            ...
            prop_dataListeners.setDisplayName(resources.getString("BasicTransactionalTableDataProvider_dataListeners_DisplayName"));
            prop_dataListeners.setShortDescription(resources.getString("BasicTransactionalTableDataProvider_dataListeners_Description"));
            ...
            prop_fieldKeys.setDisplayName(resources.getString("BasicTransactionalTableDataProvider_fieldKeys_DisplayName"));
            prop_fieldKeys.setShortDescription(resources.getString("BasicTransactionalTableDataProvider_fieldKeys_Description"));
            ...
            prop_rowCount.setDisplayName(resources.getString("BasicTransactionalTableDataProvider_rowCount_DisplayName"));
            prop_rowCount.setShortDescription(resources.getString("BasicTransactionalTableDataProvider_rowCount_Description"));
            ...
            prop_tableCursorListeners.setDisplayName(resources.getString("BasicTransactionalTableDataProvider_tableCursorListeners_DisplayName"));
            prop_tableCursorListeners.setShortDescription(resources.getString("BasicTransactionalTableDataProvider_tableCursorListeners_Description"));
            ...
            prop_tableDataListeners.setDisplayName(resources.getString("BasicTransactionalTableDataProvider_tableDataListeners_DisplayName"));
            prop_tableDataListeners.setShortDescription(resources.getString("BasicTransactionalTableDataProvider_tableDataListeners_Description"));
            ...
            prop_tableDataProvider.setDisplayName(resources.getString("BasicTransactionalTableDataProvider_tableDataProvider_DisplayName"));
            prop_tableDataProvider.setShortDescription(resources.getString("BasicTransactionalTableDataProvider_tableDataProvider_Description"));
            ...
            prop_transactionalDataListeners.setDisplayName(resources.getString("BasicTransactionalTableDataProvider_transactionalDataListeners_DisplayName"));
            prop_transactionalDataListeners.setShortDescription(resources.getString("BasicTransactionalTableDataProvider_transactionalDataListeners_Description"));
