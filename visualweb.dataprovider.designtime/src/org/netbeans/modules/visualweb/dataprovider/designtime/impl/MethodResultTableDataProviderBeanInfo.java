...
import com.sun.data.provider.impl.MethodResultTableDataProvider;
import java.util.List;
import java.beans.EventSetDescriptor;

public class MethodResultTableDataProviderBeanInfo extends MethodResultTableDataProviderBeanInfoBase {
        ...
        if (esDescriptors == null) {
            List results =
              BeanInfoSupport.getDataProviderEventSetDescriptors
                (MethodResultTableDataProvider.class);
