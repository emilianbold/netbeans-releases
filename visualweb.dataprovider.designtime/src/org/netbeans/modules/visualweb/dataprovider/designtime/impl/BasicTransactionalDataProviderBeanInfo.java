...
import com.sun.data.provider.impl.BasicTransactionalDataProvider;
import java.beans.EventSetDescriptor;
import java.util.List;

public class BasicTransactionalDataProviderBeanInfo extends BasicTransactionalDataProviderBeanInfoBase {
        ...
        if (esDescriptors == null) {
            List results =
              BeanInfoSupport.getDataProviderEventSetDescriptors
                (BasicTransactionalDataProvider.class);
