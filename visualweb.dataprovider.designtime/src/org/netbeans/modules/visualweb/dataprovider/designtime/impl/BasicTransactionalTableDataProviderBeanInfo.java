...
public class BasicTransactionalTableDataProviderBeanInfo extends BasicTransactionalTableDataProviderBeanInfoBase {
    ...
    public EventSetDescriptor[] getEventSetDescriptors() {
        ...
        if (esDescriptors == null) {
            List results =
                    ...
                    (BasicTransactionalTableDataProvider.class);
