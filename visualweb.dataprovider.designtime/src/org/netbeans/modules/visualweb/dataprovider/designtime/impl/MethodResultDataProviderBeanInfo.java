...
import com.sun.data.provider.impl.MethodResultDataProvider;
import java.beans.EventSetDescriptor;
import java.util.List;

public class MethodResultDataProviderBeanInfo extends MethodResultDataProviderBeanInfoBase {
        ...
        if (esDescriptors == null) {
            List results =
              BeanInfoSupport.getDataProviderEventSetDescriptors
                (MethodResultDataProvider.class);
