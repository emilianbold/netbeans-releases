...
public class ObjectListDataProviderBeanInfo extends ObjectListDataProviderBeanInfoBase {
    
    private EventSetDescriptor esDescriptors[] = null;
    
     public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor beanDescriptor = super.getBeanDescriptor();
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY, "projrave_ui_elements_palette_dataproviders_object_list_dp");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY, "projrave_ui_elements_palette_dataproviders_propsheets_object_list_dp_props");
