 ...
 * @version 2008.02.01
 */
final class ValidationAnnotation extends Annotation implements PropertyChangeListener {
    
  public ValidationAnnotation(Annotatable annotatable, String message) {
    myMessage = message;
...
//    }
  ...
  public String getAnnotationType() {
    return "soa-validation-annotation"; // NOI18N
  }
