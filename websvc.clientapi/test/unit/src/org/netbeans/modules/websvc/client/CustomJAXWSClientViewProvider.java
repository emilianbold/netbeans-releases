...
public class CustomJAXWSClientViewProvider implements JAXWSClientViewProvider {
    ...
    public CustomJAXWSClientViewProvider() {
    }
    
    public JAXWSClientView findJAXWSClientView() {
        return JAXWSClientViewFactory.createJAXWSClientView(new CustomJAXWSClientViewImpl());
    }
    
    private static final class CustomJAXWSClientViewImpl implements JAXWSClientViewImpl {
