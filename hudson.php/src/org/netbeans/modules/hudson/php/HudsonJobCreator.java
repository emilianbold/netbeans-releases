...
public final class HudsonJobCreator extends JPanel implements ProjectHudsonJobCreator, ChangeListener {
    ...
    private void setupProject() throws IOException {
        try {
            if (PpwScript.getDefault().createProjectFiles(phpModule)) {
                ...
                errorOccured("The project files were not generated by PPW script", Bundle.HudsonJobCreator_error_ppw());
            }
        } catch (InvalidPhpProgramException ex) {
    ...
    private void warningOccured(String warning) {
        informUser(warning, false);
    }

    private void errorOccured(String error, String logMessage) throws IOException {
        informUser(error, true);
