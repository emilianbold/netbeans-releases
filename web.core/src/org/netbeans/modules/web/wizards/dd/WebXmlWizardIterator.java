 ...
 * @author Petr Slechta
 */
public final class WebXmlWizardIterator implements WizardDescriptor.InstantiatingIterator {
    private int index;
    ...
    public Set instantiate() throws IOException {
        WebXmlWizardPanel1 panel = (WebXmlWizardPanel1)panels[0];
