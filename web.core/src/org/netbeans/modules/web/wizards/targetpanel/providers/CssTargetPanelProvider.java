...
public class CssTargetPanelProvider extends WebTargetPanelProvider<FileType> {
    
    public CssTargetPanelProvider(){
        super("css", "LBL_CssName");        // NOI18N
    }
    ...
    public String getNewFileName() {
        return super.getNewFileName()+"css";//NOI18N
    }
    ...
    public String getWizardTitle() {
        return NbBundle.getMessage(CssTargetPanelProvider.class, "TITLE_CSS");// NOI18N
    }
