...
public class JSTargetPanelProvider extends WebTargetPanelProvider<FileType> {
    
    public JSTargetPanelProvider(){
        super("javascript","LBL_JSName");        //NOI18N
    }
    ...
    public String getNewFileName() {
        return super.getNewFileName()+"javascript";//NOI18N
    }
    ...
    public String getWizardTitle() {
        return NbBundle.getMessage(JSFTargetPanelProvider.class, "TITLE_JS");
    }
