...
public class XhtmlTargetPanelProvider extends WebTargetPanelProvider<FileType> {
    ...
    public XhtmlTargetPanelProvider(){
        super("xhtml","LBL_XHtmlName"); // NOI18N
    }
    ...
    public String getWizardTitle() {
        return NbBundle.getMessage(XhtmlTargetPanelProvider.class, "TITLE_XHTML");// NOI18N
    }
    ...
    public String getNewFileName() {
        return super.getNewFileName()+"xhtml";//NOI18N
    }
