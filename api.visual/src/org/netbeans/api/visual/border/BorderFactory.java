...
public final class BorderFactory {
    ...
    * @param horizontal the horizontal thickness
    ...
    public static Border createLineBorder (int thickness, Color color) {
        return new LineBorder (thickness, thickness, thickness, thickness, color != null ? color : LookFeel.createDefaultLookFeel().getForeground()/*Color.BLACK*/);
    }
    ...
    public static Border createLineBorder (int top, int left, int bottom, int right, Color color) {
        return new LineBorder (top, left, bottom, right, color != null ? color : LookFeel.createDefaultLookFeel().getForeground()/*Color.BLACK*/);
    }
    ...
    public static Border createResizeBorder (int thickness, Color color, boolean outer) {
        return new ResizeBorder (thickness, color != null ? color : LookFeel.createDefaultLookFeel().getForeground()/*Color.BLACK*/, outer);
    }
    ...
    public static Border createDashedBorder (Color color, int width, int height, boolean squares) {
        if (! squares)
            return new FancyDashedBorder (color != null ? color : LookFeel.createDefaultLookFeel().getForeground()/*Color.BLACK*/, width, height);
        else
            return new DashedBorder (color != null ? color : LookFeel.createDefaultLookFeel().getForeground()/*Color.BLACK*/, width, height);
    }
/**
     * Creates a resize border rendered with dashed stroke.
     * The instance can be shared by multiple widgets.
