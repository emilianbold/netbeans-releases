...
public class VMDOriginalColorScheme extends VMDColorScheme {
    ...
    private static final Color COLOR_HOVERED = LookFeel.createDefaultLookFeel().getForeground()/*Color.BLACK*/;
...
//    private static final Color COLOR0 = new Color (169, 197, 235);
    ...
    private static final Border BORDER_PIN_HOVERED = BorderFactory.createLineBorder (2, 8, 2, 8, LookFeel.createDefaultLookFeel().getForeground()/*Color.BLACK*/);
