...
public class ServerLocationPanel extends JPanel implements WizardDescriptor.Panel {
    ...
    public ServerLocationPanel(String[] steps, int index, ChangeListener listener, WSInstantiatingIterator instantiatingIterator) {
    ...
    private void init() {
        ...
        if (System.getProperty("websphere.home") != null) { // NOI18N
            locationField.setText(System.getProperty("websphere.home")); // NOI18N
        }
        gridBagConstraints = new GridBagConstraints();
