...
MANUFACTURE_ID, "NAME", ADDRESSLINE1, ADDRESSLINE2, CITY, "STATE", ZIP, PHONE, FAX, EMAIL, 
REP )
VALUES
...
INSERT INTO PRODUCT (
PRODUCT_ID, MANUFACTURE_ID, PRODUCT_CODE, PURCHASE_COST, QUANTITY_ON_HAND, MARKUP, 
...
ALTER TABLE PRODUCT ADD CONSTRAINT FOREIGNKEY_MANUFACTURE_ID FOREIGN KEY ( 
MANUFACTURE_ID )
        REFERENCES MANUFACTURE ( MANUFACTURE_ID ) ON UPDATE no action ON DELETE 
no action;
...
ALTER TABLE CUSTOMER ADD CONSTRAINT FOREIGNKEY_ZIP FOREIGN KEY ( ZIP )
        REFERENCES MICRO_MARKETS ( ZIP_CODE ) ON UPDATE no action ON 
DELETE no action;

ALTER TABLE ORDERS ADD CONSTRAINT FOREIGNKEY_CUSTOMER_ID FOREIGN KEY ( 
CUSTOMER_ID )
        REFERENCES CUSTOMER ( CUSTOMER_ID ) ON UPDATE no action ON 
DELETE no action;

ALTER TABLE ORDERS ADD CONSTRAINT FOREIGNKEY_PRODUCT_ID FOREIGN KEY ( 
PRODUCT_ID )
