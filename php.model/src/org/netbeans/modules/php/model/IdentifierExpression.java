 ...
 * to variable. Variable value will be known
 * at runtime so method can be called.
 * 
 * But such identifier expression can be only identifier
 * itself and varaible ( see subinterfaces ).
 *  
 * @author ads
 *
 */
