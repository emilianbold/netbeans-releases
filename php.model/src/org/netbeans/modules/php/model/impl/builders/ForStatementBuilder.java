...
import org.netbeans.modules.php.model.impl.ForStatementImpl;
 ...
 *
 */
public class ForStatementBuilder implements SourceElementBuilder {
    ...
    {
        return new ForStatementImpl( model , node , realNode, sequence );
    }
    ...
    public SourceElement build( SourceElement parent, ASTNode node, 
            ASTNode realNode ,TokenSequence<?> sequence ) 
    {
        return new ForStatementImpl( parent , node , realNode, sequence );
    }
