 ...
 *
 */
public class ClassConstImpl extends SourceElementImpl implements ClassConst {
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.ClassConst#getName()
     */
    public String getName() {
        ...
        for (ASTItem child : children) {
            if ( child instanceof ASTToken ) {
                ...
                if ( token.getTypeName().equals( IDENTIFIER) ) {
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.ClassConst#getValue()
     */
