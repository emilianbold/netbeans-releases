...
import org.netbeans.modules.php.model.impl.ClassFunctionDefinitionImpl;
 ...
 *
 */
public class ClassFuncDefBuilder implements SourceElementBuilder {
    
    private ClassFuncDefBuilder(){
    }
    ...
    {
        ASTNode defNode = realNode.getNode( StatementsListFactory.FUNC_DEF );
        return new ClassFunctionDefinitionImpl( parent , node, realNode , 
                defNode , sequence );
    }
    
    public static ClassFuncDefBuilder getInstance(){
        return INSTANCE;
    }

    private static final ClassFuncDefBuilder INSTANCE = new ClassFuncDefBuilder();
}
