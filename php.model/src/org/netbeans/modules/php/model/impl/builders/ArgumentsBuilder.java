...
public class ArgumentsBuilder {
    ...
    private static final String INCLUDE_ARG     = 
					"LanguageConstructArgument";// NOI18N
    
    private static final String ARGS            = "Arguments";      // NOI18N
    
    private static final String LIST_ARGS       = "ListArguments";  // NOI18N
            ...
            TokenSequence<?> sequence ) 
    {
        ...
        assert nt.equals( ECHO_ARGS ) || nt.equals( DEFINE_ARG ) || 
            nt.equals( INCLUDE_ARG ) || nt.equals( ARGS ) || 
            nt.equals( LIST_ARGS) || subNode != null; 
