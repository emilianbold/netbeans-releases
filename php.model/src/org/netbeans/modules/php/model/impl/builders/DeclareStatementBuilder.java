...
import org.netbeans.modules.php.model.impl.DeclareStatementImpl;
 ...
 *
 */
public class DeclareStatementBuilder implements SourceElementBuilder {
    
    private DeclareStatementBuilder() {
    }
    ...
    {
        return new DeclareStatementImpl( model,  node , realNode, sequence);
    }
    ...
    public SourceElement build( SourceElement parent, ASTNode node, 
            ASTNode realNode ,TokenSequence sequence ) {
        return new DeclareStatementImpl( parent , node , realNode, sequence );
    }
    ...
    private static final SourceElementBuilder INSTANCE = new DeclareStatementBuilder();
