...
public class ForImpl extends SourceElementImpl implements For {
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.For#getConditionalExpression()
     */
    public ForExpression getConditionalExpression() {
        List<ForExpression> expressions = getChildren( ForExpression.class );
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.For#getInitialExpression()
     */
    public ForExpression getInitialExpression() {
        return getChild( ForExpression.class );
    }

    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.For#getTerminalExpression()
     */
    public ForExpression getTerminalExpression() {
        List<ForExpression> expressions = getChildren( ForExpression.class );
