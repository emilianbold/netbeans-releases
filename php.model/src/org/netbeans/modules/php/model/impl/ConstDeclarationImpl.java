 ...
 *
 */
public class ConstDeclarationImpl extends SourceElementImpl 
    implements ConstDeclaration 
{

    public ConstDeclarationImpl( SourceElement parent, ASTNode node, 
    ...
    public Class<? extends SourceElement> getElementType() {
        return ConstDeclaration.class;
    }

    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.ConstDeclaration#getDeclaredConstants()
     */
    public List<ClassConst> getDeclaredConstants() {
        return getChildren( ClassConst.class ) ;
    }
