...
import org.netbeans.modules.php.model.impl.SwitchStatementImpl;
 ...
 *
 */
public class SwitchStatementBuilder implements SourceElementBuilder {
    ...
    {
        return new SwitchStatementImpl( model, node , realNode, sequence );
    }
    ...
    public SourceElement build( SourceElement parent, ASTNode node, 
            ASTNode realNode ,TokenSequence<?> sequence ) 
    {
        return new SwitchStatementImpl( parent , node , realNode, sequence );
    }
