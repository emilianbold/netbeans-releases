 ...
 *
 */
public class InterfaceBodyImpl extends SourceElementImpl implements
        InterfaceBody
{

    public InterfaceBodyImpl( SourceElement parent, ASTNode node, 
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.InterfaceBody#getStatements()
     */
    public List<InterfaceStatement> getStatements() {
        return getChildren( InterfaceStatement.class );
    }
