 ...
 *
 */
public class NewExpressionImpl extends SourceElementImpl implements
        NewExpression
{
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.ArgumentsHolder#getArguments()
     */
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.NewExpression#isByReference()
     */
    public boolean isByReference() {
        ...
        for (ASTItem item : list) {
            if ( item instanceof ASTToken ){
                String image = ((ASTToken) item).getIdentifier().trim();
                if ( image.equals( Utils.REFERENCE )){
                    return true;
                }
            }
        }
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.NewExpression#getClassName()
     */
    public Reference<ClassDefinition> getClassName() {
        ASTToken token = getNarrowNode().getTokenType( Utils.IDENTIFIER );
        String name = token.getIdentifier().trim();
        return new ReferenceImpl<ClassDefinition>( this , name , 
