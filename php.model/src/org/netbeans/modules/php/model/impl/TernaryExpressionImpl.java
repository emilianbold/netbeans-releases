 ...
 *
 */
public class TernaryExpressionImpl extends SourceElementImpl implements
        TernaryExpression
{
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.TernaryExpression#getCondition()
     */
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.TernaryExpression#getFalseExpression()
     */
    public Expression getFalseExpression() {
        List<Expression> list = getChildren( Expression.class );
        if ( list.size() <3 ){
            return null;            
        }
        return list.get( 2 );
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.TernaryExpression#getTrueExpression()
     */
