...
public class ForEachImpl extends SourceElementImpl implements ForEach {
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.ForEach#getIndexVariable()
     */
    public VariableDeclaration getIndexVariable() {
        List<VariableDeclaration> children = 
            getChildren( VariableDeclaration.class );
        if ( children.size() > 1 ){
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.ForEach#getValueVariable()
     */
    public VariableDeclaration getValueVariable() {
        List<VariableDeclaration> children = 
            getChildren( VariableDeclaration.class );
        if ( children.size() > 1 ){
            ...
            return getChild( VariableDeclaration.class );
        }
    }
