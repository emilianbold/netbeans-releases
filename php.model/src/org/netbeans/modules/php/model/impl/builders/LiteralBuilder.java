...
import org.netbeans.modules.php.model.impl.LiteralImpl;

public class LiteralBuilder implements SourceElementBuilder {
    ...
    public SourceElement build( SourceElement parent, ASTNode node, 
            ASTNode realNode ,TokenSequence sequence ) 
    {
        return new LiteralImpl( parent, node , realNode, sequence );
    }
    
    public static LiteralBuilder getInstance(){
        return INSTANCE;
    }
    
    private static final LiteralBuilder INSTANCE = new LiteralBuilder(); 
