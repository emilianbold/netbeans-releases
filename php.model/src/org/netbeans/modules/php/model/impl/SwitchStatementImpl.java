 ...
 *
 */
public class SwitchStatementImpl extends SourceElementImpl
    implements SwitchStatement 
{

    public SwitchStatementImpl( PhpModel model , ASTNode node, 
            ASTNode realNode ,TokenSequence<?> sequence) 
    {
        super( model, node , realNode, sequence );
    }

    public SwitchStatementImpl( SourceElement parent, ASTNode node, 
            ASTNode realNode ,TokenSequence<?> sequence ) 
    {
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.SwitchStatement#getCases()
     */
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.SwitchStatement#getDefault()
     */
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.SwitchStatement#getSwitch()
     */
    public Switch getSwitch() {
        return getChild( Switch.class );
    }

    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.SwitchStatement#isAlternative()
     */
    public boolean isAlternative() {
        return getNarrowNode().getNode( SwitchStatementFactory.COLON ) != null;
    }
}
