...
import org.netbeans.modules.php.model.impl.FunctionDefinitionImpl;
 ...
 *
 */
public class FunctionDefBuilder implements SourceElementBuilder {
    
    private FunctionDefBuilder(){
    }
    ...
    {
        return new FunctionDefinitionImpl( model, node , realNode, sequence) ;
    }
    ...
    public SourceElement build( SourceElement parent, ASTNode node, 
            ASTNode realNode ,TokenSequence sequence ) 
    {
        return new FunctionDefinitionImpl( parent , node , realNode, sequence );
    }
    ...
    private static final SourceElementBuilder INSTANCE = new FunctionDefBuilder();
