...
import org.netbeans.modules.php.model.impl.IfStatementImpl;
 ...
 *
 */
public class IfStatementBuilder implements SourceElementBuilder {
    ...
    {
        return new IfStatementImpl( model, node , realNode, sequence );
    }
    ...
    public SourceElement build( SourceElement parent, ASTNode node, 
            ASTNode realNode ,TokenSequence sequence ) 
    {
        return new IfStatementImpl( parent , node , realNode, sequence );
    }
    ...
    private static final SourceElementBuilder INSTANCE = new IfStatementBuilder();
