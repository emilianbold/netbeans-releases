 ...
 *
 */
public class AttributesImpl extends SourceElementImpl implements AttributesDeclaration {
    ...
    public Class<? extends SourceElement> getElementType() {
        return AttributesDeclaration.class;
    }
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.AttributesDeclaration#getModifiers()
     */
    public List<Modifier> getModifiers() {
        ...
        ret.addAll( Utils.getModifiers(Utils.getClassMemberNode( getNode())));
        
        return ret;
    }

    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.AttributesDeclaration#getDeclaredAttributes()
     */
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.impl.SourceElementImpl#getText()
     */
    @Override
