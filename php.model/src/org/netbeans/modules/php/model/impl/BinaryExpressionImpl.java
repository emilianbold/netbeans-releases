 ...
 *
 */
public class BinaryExpressionImpl extends ExpressionImpl implements
        BinaryExpression
{

    public BinaryExpressionImpl( SourceElement parent, ASTNode node, 
            ASTNode realNode , TokenSequence sequence ) {
        super(parent, node, realNode , sequence);
    }

    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.BinaryExpression#getLeftOperand()
     */
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.BinaryExpression#getRightOperand()
     */
