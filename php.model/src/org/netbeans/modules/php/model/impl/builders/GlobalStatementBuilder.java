...
import org.netbeans.modules.php.model.impl.GlobalStatementImpl;
 ...
 *
 */
public class GlobalStatementBuilder implements SourceElementBuilder {
    
    private GlobalStatementBuilder(){
    }
    ...
    {
        return new GlobalStatementImpl( model, node , realNode, sequence );
    }
    ...
    public SourceElement build( SourceElement parent, ASTNode node, 
            ASTNode realNode ,TokenSequence<?> sequence ) 
    {
        return new GlobalStatementImpl( parent , node , realNode, sequence );
    } 
    
    public static SourceElementBuilder getInstance(){
        return INSTANCE;
    }
    
    private static final SourceElementBuilder INSTANCE = 
        new GlobalStatementBuilder();
