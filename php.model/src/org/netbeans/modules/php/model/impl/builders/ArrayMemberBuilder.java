 ...
 *
 */
class ArrayMemberBuilder  implements SourceElementBuilder {
    
    private ArrayMemberBuilder() {
    }
            ...
            ASTNode realNode, TokenSequence sequence )
    {
        ...
        ASTNode expression = realNode.getNode( ExpressionFactory.EXPRESSION );
        assert expression!=null;
        return ExpressionBuilder.getInstance().build(parent, expression, 
                expression, sequence);
    }
    
    public static ArrayMemberBuilder getInstance() {
        return INSTANCE;
    }
    
    public static final ArrayMemberBuilder INSTANCE = new ArrayMemberBuilder(); 
