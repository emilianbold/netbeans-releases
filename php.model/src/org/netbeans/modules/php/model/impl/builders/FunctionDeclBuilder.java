...
import org.netbeans.modules.php.model.impl.FunctionDeclarationImpl;
 ...
 *
 */
public class FunctionDeclBuilder implements SourceElementBuilder {
    
    private FunctionDeclBuilder(){
    }
     ...
     */
    public FunctionDeclaration build( SourceElement parent, ASTNode node,
            ASTNode realNode ,TokenSequence<?> sequence )
    {
        return new FunctionDeclarationImpl( parent , node , realNode, sequence );
    }
    
    public static FunctionDeclBuilder getInstance(){
        return INSTANCE;
    }
    
    private static final FunctionDeclBuilder INSTANCE   = new FunctionDeclBuilder();
