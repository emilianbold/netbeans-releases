 ...
 *
 */
public class FormalParameterListImpl extends SourceElementImpl implements
        FormalParameterList
{

    public FormalParameterListImpl( SourceElement parent, 
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.FormalParameterList#getParameters()
     */
    public List<FormalParameter> getParameters() {
        return getChildren( FormalParameter.class );
    }
    ...
    public Class<? extends SourceElement> getElementType() {
        return FormalParameterList.class;
    }
