...
import org.netbeans.modules.php.model.impl.StaticStatementImpl;
 ...
 *
 */
public class StaticStatementBuilder implements SourceElementBuilder {
    
    private StaticStatementBuilder(){
    }
    ...
    {
        return new StaticStatementImpl( model, node , realNode, sequence );
    }
    ...
    public SourceElement build( SourceElement parent, ASTNode node, 
            ASTNode realNode ,TokenSequence sequence ) 
    {
        return new StaticStatementImpl( parent ,node , realNode, sequence  );
    }
