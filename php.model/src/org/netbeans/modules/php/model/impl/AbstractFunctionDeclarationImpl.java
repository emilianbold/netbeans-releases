 ...
 *
 */
public class AbstractFunctionDeclarationImpl extends FunctionDeclarationImpl 
    implements ClassFunctionDeclaration 
{
    ...
    public List<Modifier> getModifiers() {
        ...
        if ( Utils.getClassMemberNode( getNode()) != null ) {
            /* 
             * Pointed node could be null in case of main node is
             * interface. In this case previous cycle is enough for modifiers.
             */ 
    ...
    public Class<? extends SourceElement> getElementType() {
        return ClassFunctionDeclaration.class;
    }
    ...
    private ASTNode getModifiersNode(){
        return myNodeWithModifiers;
    }
    
    private ASTNode myNodeWithModifiers;
