...
import org.netbeans.modules.php.model.impl.BreakStatementImpl;
 ...
 *
 */
public class BreakBuilder implements SourceElementBuilder {
    
    private BreakBuilder(){
    }
    ...
    {
        return new BreakStatementImpl( model , node , realNode, sequence );
    }
    ...
    public SourceElement build( SourceElement parent, ASTNode node,
            ASTNode realNode ,TokenSequence<?> sequence ) 
    {
        return new BreakStatementImpl( parent , node , realNode, sequence );
    }
    ...
    private final static SourceElementBuilder INSTANCE = new BreakBuilder();
