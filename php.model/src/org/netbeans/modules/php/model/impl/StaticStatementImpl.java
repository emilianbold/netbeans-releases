 ...
 *
 */
public class StaticStatementImpl extends SourceElementImpl implements
        StaticStatement
{
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.StaticStatement#getVariableDeclaration()
     */
    public List<InitializedDeclaration> getVariables() {
        return getChildren( InitializedDeclaration.class );
    }
