...
public class ForStatementImpl extends StatementImpl implements ForStatement {
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.ForStatement#getFor()
     */
    public For getFor() {
        return getChild( For.class );
    }

    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.ForStatement#isAlternative()
     */
    public boolean isAlternative() {
        return getNode().getNode( ForStatementFactory.ALTERNATIVE ) != null;
    }
