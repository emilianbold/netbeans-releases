 ...
 *
 */
public class ClassBodyImpl extends SourceElementImpl implements ClassBody {
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.ClassBody#getStatements()
     */
    public List<ClassStatement> getStatements() {
        return getChildren( ClassStatement.class );
    }
