...
public class AttributeImpl extends SourceElementImpl implements Attribute {
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.Attribute#getName()
     */
    public String getName() {
        ASTToken token = getNode().getTokenType( Utils.VARIABLE );
        if ( token == null ) {
            return null;
        }
        else {
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.Attribute#getValue()
     */
