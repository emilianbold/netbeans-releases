...
import org.netbeans.modules.php.model.impl.ExpressionStatementImpl;
 ...
 *
 */
public class ExpressionStatementBuilder implements SourceElementBuilder {
    ...
    {
        return new ExpressionStatementImpl( model, node , realNode, sequence);
    }
    ...
    public SourceElement build( SourceElement parent, ASTNode node, 
            ASTNode realNode ,TokenSequence sequence ) 
    {
        return new ExpressionStatementImpl( parent , node , realNode, sequence  );
    }
    ...
    private static final SourceElementBuilder INSTANCE = new ExpressionStatementBuilder();
