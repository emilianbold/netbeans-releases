...
import org.netbeans.modules.php.model.impl.ConstDeclarationImpl;
 ...
 *
 */
public class ConstDeclarationBuilder implements SourceElementBuilder {
    
    private ConstDeclarationBuilder(){
    }
    ...
    public static ConstDeclarationBuilder getInstance(){
        return INSTANCE;
    }
    
    private static final ConstDeclarationBuilder INSTANCE  = new ConstDeclarationBuilder();
