 ...
 *
 */
public class ForEachStatementImpl extends StatementImpl
    implements ForEachStatement 
{
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.ForEachStatement#getForEach()
     */
    public ForEach getForEach() {
        return getChild( ForEach.class );
    }

    /* (non-Javadoc)
     * @see org.netbeans.modules.php.model.ForEachStatement#isAlternative()
     */
    public boolean isAlternative() {
        return getNarrowNode().getNode( ForEachFactory.ALTERNATIVE )!=null;
    }
