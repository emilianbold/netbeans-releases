...
import org.netbeans.modules.php.model.impl.AttributesImpl;
 ...
 *
 */
public class AttributeDeclBuilder implements SourceElementBuilder {
    
    private AttributeDeclBuilder(){
    }
    ...
    {
        return new AttributesImpl( parent , node, realNode , sequence );
    }
    
    public static AttributeDeclBuilder getInstance(){
        return INSTANCE;
    }
    
    private static final AttributeDeclBuilder INSTANCE = new AttributeDeclBuilder();
