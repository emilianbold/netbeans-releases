...
import org.netbeans.modules.php.model.impl.WhileImpl;
 ...
 *
 */
public class WhileBuilder implements SourceElementBuilder {
    
    private static final String WHILE_COMMON        = "WhileCommon";   // NOI18N

    private WhileBuilder(){
    }
    
    public static WhileBuilder getInstance() {
        return INSTANCE;
    }
    
    public boolean isWhile( ASTNode node ){
        return node.getNT().equals( WHILE_COMMON );
    }
    ...
    private final static WhileBuilder INSTANCE = new WhileBuilder();
