...
import org.netbeans.modules.php.model.impl.ForEachStatementImpl;
 ...
 *
 */
public class ForEachStatementBuilder implements SourceElementBuilder {
    ...
    {
        return new ForEachStatementImpl( model , node , realNode , sequence );
    }
    ...
    public SourceElement build( SourceElement parent, ASTNode node, 
            ASTNode realNode ,TokenSequence<?> sequence ) 
    {
        return new ForEachStatementImpl( parent , node , realNode, sequence );
    }
