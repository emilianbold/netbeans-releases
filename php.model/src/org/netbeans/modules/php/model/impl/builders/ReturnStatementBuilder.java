...
import org.netbeans.modules.php.model.impl.ReturnStatementImpl;
 ...
 *
 */
public class ReturnStatementBuilder implements SourceElementBuilder {
    ...
    {
        return new ReturnStatementImpl( model, node , realNode, sequence );
    }
    ...
    public SourceElement build( SourceElement parent, ASTNode node, 
            ASTNode realNode, TokenSequence<?> sequence ) 
    {
        return new ReturnStatementImpl( parent , node , realNode, sequence );
    }
    
    public static final SourceElementBuilder getInstance(){
        return INSTANCE;
    }
