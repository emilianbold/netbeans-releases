...
import org.netbeans.modules.php.model.impl.ForExpressionImpl;
...
public class ForFactory {
    ...
    private final static String EXPRESSION  = "ForExpression";  // NOI18N 
    
    private ForFactory() {
    }

    public static final ForFactory getInstance() {
        return INSTANCE;
    }
    ...
    private static final ForFactory INSTANCE = new ForFactory();
