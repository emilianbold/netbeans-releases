 ...
 *
 */
public class ClassFunctionDeclarationBuilder implements SourceElementBuilder {
    
    private ClassFunctionDeclarationBuilder(){
    }
    ...
    {
        ASTNode declNode = realNode.getNode( FunctionDefFactory.FUNCTION_DECL );
        return new AbstractFunctionDeclarationImpl( parent , node, realNode , 
                declNode , sequence );
    }
    
    public static ClassFunctionDeclarationBuilder getInstance(){
        return INSTANCE;
    }
    
    private static final ClassFunctionDeclarationBuilder INSTANCE = 
        new ClassFunctionDeclarationBuilder();
