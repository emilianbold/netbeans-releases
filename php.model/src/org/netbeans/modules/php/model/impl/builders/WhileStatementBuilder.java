...
import org.netbeans.modules.php.model.impl.WhileStatementImpl;
 ...
 *
 */
public class WhileStatementBuilder implements SourceElementBuilder {
    ...
    {
        return new WhileStatementImpl( model,  node , realNode, sequence);
    }
    ...
    public SourceElement build( SourceElement parent, ASTNode node, 
            ASTNode realNode ,TokenSequence<?> sequence ) {
        return new WhileStatementImpl( parent , node , realNode, sequence );
    }
    ...
    private static final SourceElementBuilder INSTANCE = new WhileStatementBuilder();
