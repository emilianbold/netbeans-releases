 ...
 */
public class RemoteDevelopmentFirstTest extends CndBaseTestSuite {

    public static final String PLATFORMS_SECTION = "remote.platforms";
    public static final String DEFAULT_SECTION = "remote";

    public RemoteDevelopmentFirstTest(Class testClass) {
    ...
    public RemoteDevelopmentFirstTest(String name, Test... tests) {
        setName(name);
        for (Test test : tests) {
            addTest(test);
        }
    ...
    // Why are tests just Test, not NativeExecutionBaseTestCase?
    // to allow add warnings (TestSuite.warning() returns test stub with warning)
    public RemoteDevelopmentFirstTest(String name, Collection<Test> tests) {
        setName(name);
        for (Test test : tests) {
            addTest(test);
        }
    ...
    public RemoteDevelopmentFirstTest() {
    ...
    private RemoteDevelopmentFirstTest(String name, Class... testClasses) {
        super(name, PLATFORMS_SECTION, testClasses);
    }

    public static Test suite() {
        TestSuite suite = new RemoteDevelopmentFirstTest();
        return suite;
    }
}
