 ...
 */
public class SftpGnuRemoteBuildTestCase extends RemoteBuildTestBase {

    public SftpGnuRemoteBuildTestCase(String testName) {
        super(testName);
    }

    public SftpGnuRemoteBuildTestCase(String testName, ExecutionEnvironment execEnv) {
    ...
    public static Test suite() {
        return new RemoteDevelopmentTest(SftpGnuRemoteBuildTestCase.class);
    }
}
