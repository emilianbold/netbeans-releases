...
public class XmlOutputWrapperGenerator {
    ...
    public XmlOutputWrapperGenerator(FileObject destDir, String className, String packageName, String[] jaxbOutputClassNames) {
        ...
        if (wrapElementName.endsWith(JaxRsCodeGenerator.CONVERTER_SUFFIX)) {
            wrapElementName = wrapElementName.substring(0,wrapElementName.lastIndexOf(JaxRsCodeGenerator.CONVERTER_SUFFIX));
        }
    }
