 ...
 * 
 */
public class JaxRsCodeSetupPanel extends javax.swing.JPanel {
    ...
    public JaxRsCodeSetupPanel(String uriTemplate, String resourceName, List<ParameterInfo> inputParams, boolean resourceExists) {
        initComponents();
    ...
    private class ParamCellRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, 
            ...
            if (value == null) {
                return new JLabel(NbBundle.getMessage(JaxRsCodeSetupPanel.class, "LBL_NotSet"));
    ...
    private void initComponents() {
        ...
        paramLabel.setText(org.openide.util.NbBundle.getMessage(JaxRsCodeSetupPanel.class, "LBL_Parameters")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(uriTemplateLabel, org.openide.util.NbBundle.getMessage(JaxRsCodeSetupPanel.class, "LBL_UriTemplate")); // NOI18N

        uriTemplateTF.setText(org.openide.util.NbBundle.getMessage(JaxRsCodeSetupPanel.class, "JaxRsCodeSetupPanel.uriTemplateTF.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(methodNameLabel, org.openide.util.NbBundle.getMessage(JaxRsCodeSetupPanel.class, "LBL_MethodName")); // NOI18N

        methodNameTF.setText(org.openide.util.NbBundle.getMessage(JaxRsCodeSetupPanel.class, "JaxRsCodeSetupPanel.methodNameTF.text")); // NOI18N
        ...
        subresourceLocatorLabel.setText(org.openide.util.NbBundle.getMessage(JaxRsCodeSetupPanel.class, "LBL_SubresourceLocator")); // NOI18N

        subresourceLabel.setText(org.openide.util.NbBundle.getMessage(JaxRsCodeSetupPanel.class, "LBL_Subresource")); // NOI18N

        resourceNameLabel.setLabelFor(resourceNameTF);
        org.openide.awt.Mnemonics.setLocalizedText(resourceNameLabel, org.openide.util.NbBundle.getMessage(JaxRsCodeSetupPanel.class, "LBL_ResourceName")); // NOI18N

        resourceNameTF.setText(org.openide.util.NbBundle.getMessage(JaxRsCodeSetupPanel.class, "JaxRsCodeSetupPanel.resourceNameTF.text")); // NOI18N
        resourceNameTF.setEnabled(false);

        messageLabel.setText(org.openide.util.NbBundle.getMessage(JaxRsCodeSetupPanel.class, "MSG_AlreadyGenerated")); // NOI18N
        ...
        paramLabel.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(JaxRsCodeSetupPanel.class, "MSG_SetConstantValues")); // NOI18N
