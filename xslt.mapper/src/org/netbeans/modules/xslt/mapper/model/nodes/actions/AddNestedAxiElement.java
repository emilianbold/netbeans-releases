 ...
 * @author nk160297
 */
public class AddNestedAxiElement extends AbstractAction {
    ...
    public AddNestedAxiElement(XsltMapper xsltMapper, TreeNode node, 
        ...
        myElement = element;
        //
        putValue(Action.NAME, myElement.getName());
        Icon icon = new ImageIcon(NodeType.ELEMENT.getImage());
        putValue(Action.SMALL_ICON, icon);
    }
    
    public void actionPerformed(ActionEvent e) {
        // TODO delete
        System.out.println("AddNestedAxiElement"); 
    }
