 ...
 * @author jsandusky
 */
public class StringLiteralUpdater extends AbstractLiteralUpdater {
    
    public ILiteralEditor getEditor(IBasicMapper basicMapper, IFieldNode field) {
        // Check if the field represents a duration.
        String literalName = field.getLiteralName();
        String name = field.getName();
        List<String> names = new ArrayList<String>();
        if (literalName != null) {
            if (!names.contains(literalName)) {
