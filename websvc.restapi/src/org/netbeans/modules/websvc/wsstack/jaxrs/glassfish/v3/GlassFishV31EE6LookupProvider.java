 ...
 * @author ayubkhan
 */
public class GlassFishV31EE6LookupProvider implements LookupProvider {

    @Override
    public Lookup createAdditionalLookup(Lookup baseContext) {
        String gfRootStr = baseContext.lookup(String.class);
        return Lookups.fixed(WSStackFactory.createWSStack(JaxRs.class ,new GlassFishV31EE6JaxRsStack(gfRootStr), WSStack.Source.SERVER));
    }
