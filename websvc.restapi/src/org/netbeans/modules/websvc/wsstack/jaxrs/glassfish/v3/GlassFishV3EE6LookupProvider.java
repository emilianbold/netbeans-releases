 ...
 * @author ayubkhan
 */
public class GlassFishV3EE6LookupProvider implements LookupProvider {

    public Lookup createAdditionalLookup(Lookup baseContext) {
        String gfRootStr = baseContext.lookup(String.class);
        return Lookups.fixed(WSStackFactory.createWSStack(JaxRs.class ,new GlassFishV3EE6JaxRsStack(gfRootStr), WSStack.Source.SERVER));
    }
