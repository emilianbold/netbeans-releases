...
public enum GroovyTokenId implements TokenId {
    ...
    BAND_ASSIGN("&=", "assign-operator"),
    BOR_ASSIGN("|=", "assign-operator"),
    BSR_ASSIGN(">>>=", "assign-operator"),
    BXOR_ASSIGN("^=", "assign-operator"),
    DIV_ASSIGN("/=", "assign-operator"),
    MINUS_ASSIGN("-=", "assign-operator"),
    MOD_ASSIGN("%=", "assign-operator"),
    PLUS_ASSIGN("+=", "assign-operator"),
    SL_ASSIGN("<<=", "assign-operator"),
    SR_ASSIGN(">>=", "assign-operator"),
    STAR_ASSIGN("*=", "assign-operator"),
    STAR_STAR_ASSIGN("**=", "assign-operator"),
