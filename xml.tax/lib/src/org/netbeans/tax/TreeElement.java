...
//  	attributes.setContentManager (this);
     ...
     * @throws ReadOnlyException
     */
    public final TreeAttribute setAttribute (String name, String value) throws ReadOnlyException, InvalidArgumentException {
	checkReadOnly();
     ...
     * @throws ReadOnlyException
     */
    public final TreeAttribute setAttribute (TreeAttribute newAttr) throws ReadOnlyException {
	checkReadOnly();
	TreeAttribute oldAttr = removeAttribute (newAttr.getQName());
	attributes.add (newAttr);
	return oldAttr;
    }
