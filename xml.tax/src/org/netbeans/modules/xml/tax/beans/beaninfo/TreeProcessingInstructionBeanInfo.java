...
public class TreeProcessingInstructionBeanInfo extends SimpleBeanInfo {
    ...
    static {
        try {
            ...
            properties[PROPERTY_target].setDisplayName ( Util.getString ( "PROP_TreeProcessingInstructionBeanInfo_target" ) );
            properties[PROPERTY_target].setShortDescription ( Util.getString ( "HINT_TreeProcessingInstructionBeanInfo_target" ) );
            properties[PROPERTY_readOnly] = new PropertyDescriptor ( "readOnly", TreeProcessingInstruction.class, "isReadOnly", null ); // NOI18N
            properties[PROPERTY_readOnly].setDisplayName ( Util.getString ( "PROP_TreeProcessingInstructionBeanInfo_readOnly" ) );
            properties[PROPERTY_readOnly].setShortDescription ( Util.getString ( "HINT_TreeProcessingInstructionBeanInfo_readOnly" ) );
            ...
            properties[PROPERTY_data].setDisplayName ( Util.getString ( "PROP_TreeProcessingInstructionBeanInfo_data" ) );
            properties[PROPERTY_data].setShortDescription ( Util.getString ( "HINT_TreeProcessingInstructionBeanInfo_data" ) );
            properties[PROPERTY_length] = new PropertyDescriptor ( "length", TreeProcessingInstruction.class, "getLength", null ); // NOI18N
            properties[PROPERTY_length].setDisplayName ( Util.getString ( "PROP_TreeProcessingInstructionBeanInfo_length" ) );
            properties[PROPERTY_length].setShortDescription ( Util.getString ( "HINT_TreeProcessingInstructionBeanInfo_length" ) );
