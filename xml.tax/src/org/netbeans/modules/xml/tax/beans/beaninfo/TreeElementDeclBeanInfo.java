...
import org.netbeans.modules.xml.tax.beans.customizer.TreeElementDeclCustomizer;
 ...
 * @version 0.1
 */
public class TreeElementDeclBeanInfo extends SimpleBeanInfo {

    // Bean descriptor //GEN-FIRST:BeanDescriptor
    private static BeanDescriptor beanDescriptor = new BeanDescriptor  ( TreeElementDecl.class , TreeElementDeclCustomizer.class );
...
//              properties[PROPERTY_contentType].setShortDescription ( Util.getString ( "HINT_TreeElementDeclBeanInfo_contentType" ) );
    ...
    static {
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( org.netbeans.tax.TreeElementDecl.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
