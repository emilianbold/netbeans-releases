...
import org.netbeans.modules.xml.tax.beans.customizer.TreeGeneralEntityReferenceCustomizer;
...
public class TreeGeneralEntityReferenceBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor beanDescriptor = new BeanDescriptor  ( TreeGeneralEntityReference.class , TreeGeneralEntityReferenceCustomizer.class );
    ...
    static {
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( org.netbeans.tax.TreeGeneralEntityReference.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
