...
import org.netbeans.modules.xml.tax.beans.customizer.TreeAttlistDeclCustomizer;
import org.netbeans.modules.xml.tax.beans.editor.TreeAttlistDeclAttributeListEditor;
 ...
 * @version 0.1
 */
public class TreeAttlistDeclBeanInfo extends SimpleBeanInfo {
	...
	return new BeanDescriptor  ( TreeAttlistDecl.class , TreeAttlistDeclCustomizer.class );
    }
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        int PROPERTY_elementName = 0;
        int PROPERTY_attributeDefs = 1;
    ...
    public EventSetDescriptor[] getEventSetDescriptors() {
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( org.netbeans.tax.TreeAttlistDecl.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch( IntrospectionException e) {
            Exceptions.printStackTrace(e);
        }
