...
public class TreeNotationDeclBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor beanDescriptor = new BeanDescriptor  ( TreeNotationDecl.class , TreeNotationDeclCustomizer.class );
    ...
    static {
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( org.netbeans.tax.TreeNotationDecl.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
