...
public class TreeCommentBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor beanDescriptor = new BeanDescriptor  ( TreeComment.class , TreeCommentCustomizer.class );
    ...
    static {
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( org.netbeans.tax.TreeComment.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
