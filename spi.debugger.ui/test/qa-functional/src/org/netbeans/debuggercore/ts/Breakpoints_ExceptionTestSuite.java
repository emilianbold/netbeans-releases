...
import org.netbeans.debuggercore.ExceptionBreakpointsTest;
 ...
 */
public class Breakpoints_ExceptionTestSuite extends JellyTestCase {
    
    public Breakpoints_ExceptionTestSuite(String name) {
        super(name);
    }
