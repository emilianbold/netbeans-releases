...
import org.netbeans.debuggercore.MethodBreakpointsTest;
 ...
 */
public class Breakpoints_MethodTestSuite extends JellyTestCase {
    
    public Breakpoints_MethodTestSuite(String name) {
        super(name);
    }
