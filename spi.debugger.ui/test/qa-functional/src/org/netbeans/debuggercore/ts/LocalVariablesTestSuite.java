...
import org.netbeans.debuggercore.LocalVariablesTest;
 ...
 * @author peter
 */
public class LocalVariablesTestSuite extends JellyTestCase {
    
    public LocalVariablesTestSuite(String name) {
        super(name);
    }
