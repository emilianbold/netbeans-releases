 ...
 */
public class AttachTypeContextAware extends AttachType implements ContextAwareService<AttachType> {
    ...
    private AttachTypeContextAware(String serviceName, String displayName) {
        this.serviceName = serviceName;
        this.displayName = displayName;
    }

    private AttachTypeContextAware(String serviceName, String displayName, ContextProvider context) {
        this.serviceName = serviceName;
        this.displayName = displayName;
    ...
    public AttachType forContext(ContextProvider context) {
        if (context == this.context) {
            ...
            return new AttachTypeContextAware(serviceName, displayName, context);
        }
    }
    ...
    static ContextAwareService createService(Map attrs) throws ClassNotFoundException {
        ...
        return new AttachTypeContextAware(serviceName, displayName);
    }
