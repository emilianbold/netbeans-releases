...
package org.netbeans.modules.visualweb.test.components.advanced.loadbundle;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.advanced.loadbundle.Acceptance";
    ...
    //Outline variables
    public String _outlineHtml1 = Bundle.getStringTrimmed(_sharedBundle,"outlineHtml1");
    ...
    public String _advancedLoadBundle = Bundle.getStringTrimmed(_sharedBundle,"advancedLoadBundle");
    

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _loadbundle1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"loadbundle1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _loadBundle = Bundle.getStringTrimmed(_privateBundle,"loadBundle");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddAdvancedLoadBundle"));
        suite.addTest(new AcceptanceTest("testVerifyLoadBundle"));
...
//        suite.addTest(new AcceptanceTest("testAddButton"));
    ...
    /*
     *    Add a loadBundle to designer
     */
    public void testAddAdvancedLoadBundle() {
        startTest();
        log("**Initialize");
        ...
        log("**Add loadBundle to designer");
        clickPoint = palette.getClickPoint(_advancedLoadBundle);
        dropPoint = new Point(_x, _loadbundle1y);
        palette.addComponent(_advancedLoadBundle, designer, dropPoint);
    ...
    /*
     * Verify loadbundle in outline window
     */
    public void testVerifyLoadBundle() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select " + _loadBundle + " from Outline window");
        String path = _outlineHtml1 + _loadBundle;
        doo.verify();
