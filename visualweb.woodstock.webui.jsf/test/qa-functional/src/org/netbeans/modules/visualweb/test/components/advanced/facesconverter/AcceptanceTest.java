...
package org.netbeans.modules.visualweb.test.components.advanced.facesconverter;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.advanced.facesconverter.Acceptance";
    ...
    public String _advancedFacesConverter = Bundle.getStringTrimmed(_sharedBundle,"advancedFacesConverter");
    

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _facesconverter1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"facesconverter1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _facesconverter = Bundle.getStringTrimmed(_privateBundle,"facesconverter");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddAdvancedFacesConverter"));
        suite.addTest(new AcceptanceTest("testVerifyFacesConverter"));
...
//        suite.addTest(new AcceptanceTest("testAddButton"));
    ...
    /*
     *    Add a faces converter to designer
     */
    public void testAddAdvancedFacesConverter() {
        startTest();
        log("**Initialize");
        ...
        log("**Add faces converter to designer");
        clickPoint = palette.getClickPoint(_advancedFacesConverter);
        dropPoint = new Point(_x, _facesconverter1y);
        palette.addComponent(_advancedFacesConverter, designer, dropPoint);
    ...
    /*
     * Verify faces converter in outline window
     */
    public void testVerifyFacesConverter() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select " + _facesconverter + " from Outline window");
        String path = _outlineForm1 + _facesconverter;
        doo.verify();
