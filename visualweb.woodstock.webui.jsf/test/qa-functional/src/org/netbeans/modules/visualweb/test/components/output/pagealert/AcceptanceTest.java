...
package org.netbeans.modules.visualweb.test.components.output.pagealert;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _projectName = "PageAlertTests";
    ...
    public String _typeQuestion = Bundle.getStringTrimmed(_sharedBundle, "typeQuestion");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("addPageAlert"));
    ...
    public void addPageAlert() {
        
        startTest();
        designer = new DesignerPaneOperator(RaveWindowOperator.getDefaultRave());
        Util.wait(1000);
        PaletteContainerOperator palette = new PaletteContainerOperator("Layout");
        palette.addComponent("Page Alert", designer, new Point(50, 50));
        try { Thread.sleep(4000); } catch(Exception e) {}

        sheet = new SheetTableOperator();
        sheet.setTextValue("id", "pgAlert1");
        sheet.selectCombo("type", "information");
        sheet.setTextValue("summary", "Summary goes here");
        sheet.setTextValue("detail", "Detail info  goes here ");
        sheet.setTextValue("style", "height: 118px; left: 120px; top: 96px; position: absolute; width: 310px");
        sheet.setTextValue("title", "Sun Microsystems");
        sheet.setComboBoxValue(_propertyType, _typeQuestion);
        Util.wait(500);
        endTest();
