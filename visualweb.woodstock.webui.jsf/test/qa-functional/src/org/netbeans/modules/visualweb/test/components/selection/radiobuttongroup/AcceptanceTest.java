...
package org.netbeans.modules.visualweb.test.components.selection.radiobuttongroup;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _projectName = "RadioButtonGroupAcceptanceTest";
    ...
    public static int xRadioButtonGroup=50;
    public static int yRadioButtonGroup=50;
    public static int xStaticText=80;
    public static int yStaticText=200;
    ...
    String image1= imageDir + "solarisLogo.jpg";
    String image2= imageDir + "windowXPLogo.jpg";
...
//    
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddRadioButtonGroup"));
     //   suite.addTest(new AcceptanceTest("testAddPageBeanProperty"));
//        suite.addTest(new AcceptanceTest("testLoadImageFiles"));
//        suite.addTest(new AcceptanceTest("testAddButtonActionEvent"));
    ...
    /*
     *   Add a RadioButton Group component . Set id, label, and imageURL properties
     */
    
    public void testAddRadioButtonGroup() {
        startTest();
        ...
        // Add a  RadioButtonGroup component, set its label and columns property
        Point dropPoint = new Point(xRadioButtonGroup, yRadioButtonGroup);
        palette.addComponent(Bundle.getStringTrimmed(_bundle, "basicRadioButtonGroup"), designer, dropPoint);
        sheet = new SheetTableOperator();
        Util.wait(2000);
        ComponentUtils.setProperty(sheet, Bundle.getStringTrimmed(_bundle, "propertyLabel"), "Select an OS");
        ComponentUtils.setProperty(sheet, Bundle.getStringTrimmed(_bundle, "propertyColumns"), "2");
        Util.wait(2000);
        ...
        log(" Add a static text");
        palette = new PaletteContainerOperator(basicPalette);
        palette.addComponent(Bundle.getStringTrimmed(_bundle, "basicStaticText"), designer, new Point(xStaticText, yStaticText));
        Util.wait(2000);
    ...
    public void testAddPageBeanProperty() {
        startTest();
        log("Add SessionBean property - platforms, type is Option[]");
        String path = _projectName+"|"+ "Source Packages|"+_projectName+"|Page1.java|Page1|Bean Patterns";
         String type= Bundle.getStringTrimmed(_bundle, "optionType")+"[]" ;
        ComponentUtils.addObjectProperty(path, "platforms",
                 type, 
                 Bundle.getStringTrimmed(_bundle, "BeanPattern_Mode_ReadWrite"));
        
        log("Open Java editor, initiaize platforms property");
        designer = new DesignerPaneOperator(RaveWindowOperator.getDefaultRave());
...
//        
        ...
        log("Bind platforms to radiobuttongroup's item property");
        // ComponentUtils.bindToObject(xRadioButtonGroup, yRadioButtonGroup, "Page1|page1|platforms");
        designer = new DesignerPaneOperator(RaveWindowOperator.getDefaultRave());
        designer.clickMouse(radioButtonGroupID, 1);
        TestUtils.wait(1000);
        
        ComponentUtils.setPropertyBinding(designer, xRadioButtonGroup, yRadioButtonGroup, "item", "#{Page1.platforms}");
        
//        sheet = new SheetTableOperator();
//        TestUtils.wait(2000);
//        ComponentUtils.setProperty(sheet, Bundle.getStringTrimmed(_bundle, "propertyItems"), "#{Page1.platforms}");
//        TestUtils.wait(2000);
        Util.wait(500);
        endTest();
    }
    
    public void testLoadImageFiles() {
        startTest();
        log("load first image" + image1);
        ComponentUtils.loadImageFile(image1);
        TestUtils.wait(1000);
        
        log("load second image" + image2);
        ComponentUtils.loadImageFile(image2);
        TestUtils.wait(1000);
        
        log("load third image"+ image3);
        ComponentUtils.loadImageFile(image3);
        TestUtils.wait(1000);
        
        log("load fourth image"+ image4);
        ComponentUtils.loadImageFile(image4);
        TestUtils.wait(1000);
