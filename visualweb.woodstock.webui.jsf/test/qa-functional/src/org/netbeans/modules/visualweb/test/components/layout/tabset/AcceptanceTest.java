...
package org.netbeans.modules.visualweb.test.components.layout.tabset;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.layout.tabset.Acceptance";
    ...
    public String _layoutTabSet = Bundle.getStringTrimmed(_sharedBundle,"layoutTabSet");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _tabset1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"tabset1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));
    public String _buttonPath = Bundle.getStringTrimmed(_privateBundle,"buttonPath");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddTabSet"));
        suite.addTest(new AcceptanceTest("testAddButton"));
        suite.addTest(new AcceptanceTest("testVerifyButtonLocation"));
    ...
    public void testAddTabSet() {
        ...
        clickPoint = palette.getClickPoint(_layoutTabSet);
        dropPoint = new Point(_x, _tabset1y);
        palette.dndPaletteComponent(_layoutTabSet, designer, dropPoint);
    ...
    /*
     * Verify button location in outline window
     */
    public void testVerifyButtonLocation() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select button1 location from Outline window");
        String path = _outlineForm1 + _buttonPath;
        doo.verify();
