...
package org.netbeans.modules.visualweb.test.components.validators.length;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.validators.length.Acceptance";
    ...
    public int _length1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"length1y"));
    ...
    public String _maxValue = Bundle.getStringTrimmed(_privateBundle,"maxValue");
    public String _minValue = Bundle.getStringTrimmed(_privateBundle,"minValue");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddLengthValidator"));
        suite.addTest(new AcceptanceTest("testConfigureLengthValidator"));
...
//        palette.addComponent(_basicTextField, designer, dropPoint);
     ...
     */
    public void testAddLengthValidator() {
        startTest();
        log("**Initialize");
        designer = new DesignerPaneOperator(RaveWindowOperator.getDefaultRave());
        palette = new PaletteContainerOperator(_validatorPalette);
        try { Thread.sleep(5000); } catch(Exception e) {}

        log("**Add length validator to designer");
        clickPoint = palette.getClickPoint(_validatorLength);
        dropPoint = new Point(_x+15, _length1y+15);
        palette.addComponent(_validatorLength, designer, dropPoint);
        try { Thread.sleep(2000); } catch(Exception e) {}
    ...
    /*
     * Configure length Validator in outline window
     */
    public void testConfigureLengthValidator() {
        startTest();
        log("**Initialize");
...
//        doo.clickOnPath(path);
        ...
        log("**Set Max property value"); //1000
        sheet = new SheetTableOperator();
        int row = sheet.findCellRow(_propertyMaximum);
        sheet.clickForEdit(row, 1);
        sheet.clickForEdit(row, 1);
        new JTextComponentOperator(sheet).enterText(_maxValue);

        log("**Set Min property value"); //-273.15
        row = sheet.findCellRow(_propertyMinimum);
        sheet.clickForEdit(row, 1);
        sheet.clickForEdit(row, 1);
        new JTextComponentOperator(sheet).enterText(_minValue);
