...
package org.netbeans.modules.visualweb.test.components.converters.sqldate;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.converters.sqldate.Acceptance";
    ...
    public String _converterSqlDate = Bundle.getStringTrimmed(_sharedBundle,"converterSQLDate");
    
    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _sqldate1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"sqldate1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _sqlDateConverter1 = Bundle.getStringTrimmed(_privateBundle,"sqlDateConverter1");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddSqlDateConverter"));
        suite.addTest(new AcceptanceTest("testVerifySqlDateConverter"));
     ...
     */
    public void testAddSqlDateConverter() {
        startTest();
        log("**Initialize");
        ...
        log("**Add sql date converter to designer");
        clickPoint = palette.getClickPoint(_converterSqlDate);
        dropPoint = new Point(_x, _sqldate1y);
        palette.addComponent(_converterSqlDate, designer, dropPoint);
    ...
    /*
     * Verify sql date converter in outline window
     */
    public void testVerifySqlDateConverter() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select sqlDateConverter1 from Outline window");
        String path = _outlinePage1 + _sqlDateConverter1;
        doo.verify();
