...
package org.netbeans.modules.visualweb.test.components.converters.byteconverter;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.converters.byteconverter.Acceptance";
    ...
    public String _converterByte = Bundle.getStringTrimmed(_sharedBundle,"converterByte");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _byte1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"byte1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _byteConverter1 = Bundle.getStringTrimmed(_privateBundle,"byteConverter1");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddByteConverter"));
        suite.addTest(new AcceptanceTest("testVerifyByteConverter"));
     ...
     */
    public void testAddByteConverter() {
        startTest();
        log("**Initialize");
        ...
        log("**Add byte converter to designer");
        clickPoint = palette.getClickPoint(_converterByte);
        dropPoint = new Point(_x, _byte1y);
        palette.addComponent(_converterByte, designer, dropPoint);
    ...
    /*
     * Verify byte converter in outline window
     */
    public void testVerifyByteConverter() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select byteConverter1 from Outline window");
        String path = _outlinePage1 + _byteConverter1;
        doo.verify();
