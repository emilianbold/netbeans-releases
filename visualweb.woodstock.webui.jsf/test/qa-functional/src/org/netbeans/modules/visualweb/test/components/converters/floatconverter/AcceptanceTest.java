...
package org.netbeans.modules.visualweb.test.components.converters.floatconverter;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.converters.floatconverter.Acceptance";
    ...
    public String _converterFloat = Bundle.getStringTrimmed(_sharedBundle,"converterFloat");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _float1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"float1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _floatConverter1 = Bundle.getStringTrimmed(_privateBundle,"floatConverter1");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddFloatConverter"));
        suite.addTest(new AcceptanceTest("testVerifyFloatConverter"));
     ...
     */
    public void testAddFloatConverter() {
        startTest();
        log("**Initialize");
        ...
        log("**Add float converter to designer");
        clickPoint = palette.getClickPoint(_converterFloat);
        dropPoint = new Point(_x, _float1y);
        palette.addComponent(_converterFloat, designer, dropPoint);
    ...
    /*
     * Verify float converter in outline window
     */
    public void testVerifyFloatConverter() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select floatConverter from Outline window");
        String path = _outlinePage1 + _floatConverter1;
        doo.verify();
