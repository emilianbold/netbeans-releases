...
package org.netbeans.modules.visualweb.test.components.converters.sqltime;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.converters.sqltime.Acceptance";
    ...
    public String _converterSqlTime = Bundle.getStringTrimmed(_sharedBundle,"converterSQLTime");
    
    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _sqltime1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"sqltime1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _sqlTimeConverter1 = Bundle.getStringTrimmed(_privateBundle,"sqlTimeConverter1");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddSqlTimeConverter"));
        suite.addTest(new AcceptanceTest("testVerifySqlTimeConverter"));
     ...
     */
    public void testAddSqlTimeConverter() {
        startTest();
        log("**Initialize");
        ...
        log("**Add sql time converter to designer");
        clickPoint = palette.getClickPoint(_converterSqlTime);
        dropPoint = new Point(_x, _sqltime1y);
        palette.addComponent(_converterSqlTime, designer, dropPoint);
    ...
    /*
     * Verify sql time converter in outline window
     */
    public void testVerifySqlTimeConverter() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select sqlTimeConverter1 from Outline window");
        String path = _outlinePage1 + _sqlTimeConverter1;
        doo.verify();
