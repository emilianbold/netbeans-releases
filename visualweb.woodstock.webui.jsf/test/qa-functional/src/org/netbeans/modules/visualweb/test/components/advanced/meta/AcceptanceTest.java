...
package org.netbeans.modules.visualweb.test.components.advanced.meta;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.advanced.meta.Acceptance";
    ...
    public String _advancedMeta = Bundle.getStringTrimmed(_sharedBundle,"advancedMeta");
    

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _meta1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"meta1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _meta = Bundle.getStringTrimmed(_privateBundle,"meta");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddAdvancedMeta"));
        suite.addTest(new AcceptanceTest("testVerifyMeta"));
...
//        suite.addTest(new AcceptanceTest("testAddButton"));
     ...
     */
    public void testAddAdvancedMeta() {
        startTest();
        log("**Initialize");
        ...
        log("**Add meta to designer");
        clickPoint = palette.getClickPoint(_advancedMeta);
        dropPoint = new Point(_x, _meta1y);
        palette.addComponent(_advancedMeta, designer, dropPoint);
    ...
    /*
     * Verify Meta in outline window
     */
    public void testVerifyMeta() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select " + _meta + " from Outline window");
        String path = _outlineHead1 + _meta;
        doo.verify();
