...
package org.netbeans.modules.visualweb.test.components.input.stdmultiline;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.input.stdmultiline.Acceptance";
    ...
    public String _standardMultiLine = Bundle.getStringTrimmed(_sharedBundle,"standardMultiLine");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _multiline1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"multiline1y"));
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddMultiLine"));
    ...
    public void testAddMultiLine() {
        ...
        clickPoint = palette.getClickPoint(_standardMultiLine);
        dropPoint = new Point(_x, _multiline1y);
...
//        palette.dndPaletteComponent(_standardSecretField, designer, dropPoint);
        palette.addComponent(_standardMultiLine, designer, dropPoint);
