...
package org.netbeans.modules.visualweb.test.components.advanced.parameter;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.advanced.parameter.Acceptance";
    ...
    public String _advancedParameter = Bundle.getStringTrimmed(_sharedBundle,"advancedParameter");
    

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _param1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"param1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _param = Bundle.getStringTrimmed(_privateBundle,"param");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddAdvancedParam"));
        suite.addTest(new AcceptanceTest("testVerifyParam"));
...
//        suite.addTest(new AcceptanceTest("testAddButton"));
    ...
    /*
     *    Add a parameter to designer
     */
    public void testAddAdvancedParam() {
        startTest();
        log("**Initialize");
        ...
        log("**Add parameter to designer");
        clickPoint = palette.getClickPoint(_advancedParameter);
        dropPoint = new Point(_x, _param1y);
        palette.addComponent(_advancedParameter, designer, dropPoint);
    ...
    /*
     * Verify param in outline window
     */
    public void testVerifyParam() {
        ...
        log("**Select " + _param + " from Outline window");
        String path = _outlineForm1 + _param;
        doo.verify();
