...
package org.netbeans.modules.visualweb.test.components.output.stdinlinemessage;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    //Project variables
    public String _sharedBundle = ComponentUtils.getBundle();
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.output.stdinlinemessage.AcceptanceTest";
    ...
    public String _standardInlineMessage = Bundle.getStringTrimmed(_sharedBundle,"standardInlineMessage");
    public String _standardTextField = Bundle.getStringTrimmed(_sharedBundle,"standardTextField");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _inlinemessage1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"inlinemessage1y"));
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddComponentLabel"));
    ...
    /*
     *    Add a Component Label to designer
     */
    public void testAddComponentLabel() {
        startTest();
        log("**Initialize");
        ...
        log("**Add Standard Inline Message to designer");
        clickPoint = palette.getClickPoint(_standardInlineMessage);
        dropPoint = new Point(_x, _inlinemessage1y);
        palette.addComponent(_standardInlineMessage, designer, dropPoint);
        try { Thread.sleep(2000); } catch(Exception e) {}
        
/*
        log("**Set label text inline");
        //JTextFieldOperator field = new JTextFieldOperator(designer);
        JTextAreaOperator field = new JTextAreaOperator(designer);
        SwingTextKeyboardDriver keyboard = new SwingTextKeyboardDriver();
        keyboard.enterText(field, _componentLabel);
*/        
        log("**Done.");
        endTest();
