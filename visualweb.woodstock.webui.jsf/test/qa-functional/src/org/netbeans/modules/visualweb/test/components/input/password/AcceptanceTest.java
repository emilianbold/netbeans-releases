...
package org.netbeans.modules.visualweb.test.components.input.password;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.input.password.Acceptance";
    ...
    public String _basicPassword = Bundle.getStringTrimmed(_sharedBundle,"basicPassword");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _password1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"password1y"));
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddPassword"));
    ...
    public void testAddPassword() {
        ...
        clickPoint = palette.getClickPoint(_basicPassword);
        dropPoint = new Point(_x, _password1y);
        palette.dndPaletteComponent(_basicPassword, designer, dropPoint);
