...
package org.netbeans.modules.visualweb.test.components.output.stdformattedoutput;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.output.stdformattedoutput.AcceptanceTest";
    ...
    public String _standardFormattedOutput = Bundle.getStringTrimmed(_sharedBundle,"standardFormattedOutput");
    ...
    public int _formattedoutput1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"formattedoutput1y"));
    ...
    public void testAddComponentLabel() {
        ...
        log("**Add Standard Formatted Output to designer");
        clickPoint = palette.getClickPoint(_standardFormattedOutput);
        dropPoint = new Point(_x, _formattedoutput1y);
        palette.addComponent(_standardFormattedOutput, designer, dropPoint);
