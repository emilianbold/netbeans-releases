...
package org.netbeans.modules.visualweb.test.components.advanced.facesvaluechangelistener;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.advanced.facesvaluechangelistener.Acceptance";
    ...
    public String _advancedFacesValueChangeListener = Bundle.getStringTrimmed(_sharedBundle,"advancedFacesValueChangeListener");
    

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _facesvaluechangelistener1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"facesvaluechangelistener1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _facesvaluechangelistener = Bundle.getStringTrimmed(_privateBundle,"facesvaluechangelistener");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddAdvancedFacesValueChangeListener"));
        suite.addTest(new AcceptanceTest("testVerifyFacesValueChangeListener"));
...
//        suite.addTest(new AcceptanceTest("testAddButton"));
    ...
    /*
     *    Add a faces value change listener to designer
     */
    public void testAddAdvancedFacesValueChangeListener() {
        startTest();
        log("**Initialize");
        ...
        log("**Add faces value change listner to designer");
        clickPoint = palette.getClickPoint(_advancedFacesValueChangeListener);
        dropPoint = new Point(_x, _facesvaluechangelistener1y);
        palette.addComponent(_advancedFacesValueChangeListener, designer, dropPoint);
    ...
    /*
     * Verify faces value change listener in outline window
     */
    public void testVerifyFacesValueChangeListener() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select " + _facesvaluechangelistener + " from Outline window");
        String path = _outlineForm1 + _facesvaluechangelistener;
        doo.verify();
