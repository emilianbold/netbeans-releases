...
package org.netbeans.modules.visualweb.test.components.converters.shortconverter;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.converters.shortconverter.Acceptance";
    ...
    public String _converterShort = Bundle.getStringTrimmed(_sharedBundle,"converterShort");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _short1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"short1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _shortConverter1 = Bundle.getStringTrimmed(_privateBundle,"shortConverter1");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddShortConverter"));
        suite.addTest(new AcceptanceTest("testVerifyShortConverter"));
     ...
     */
    public void testAddShortConverter() {
        startTest();
        log("**Initialize");
        ...
        log("**Add short converter to designer");
        clickPoint = palette.getClickPoint(_converterShort);
        dropPoint = new Point(_x, _short1y);
        palette.addComponent(_converterShort, designer, dropPoint);
    ...
    /*
     * Verify short converter in outline window
     */
    public void testVerifyShortConverter() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select shortConverter1 from Outline window");
        String path = _outlinePage1 + _shortConverter1;
        doo.verify();
