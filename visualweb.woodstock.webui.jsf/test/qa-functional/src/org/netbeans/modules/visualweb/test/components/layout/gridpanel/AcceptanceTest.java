...
package org.netbeans.modules.visualweb.test.components.layout.gridpanel;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.layout.gridpanel.Acceptance";
    ...
    public String _layoutGridPanel = Bundle.getStringTrimmed(_sharedBundle,"layoutGridPanel");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _gridpanel1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"gridpanel1y"));
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddGridPanel"));
    ...
    public void testAddGridPanel() {
        ...
        clickPoint = palette.getClickPoint(_layoutGridPanel);
        dropPoint = new Point(_x, _gridpanel1y);
        palette.dndPaletteComponent(_layoutGridPanel, designer, dropPoint);
