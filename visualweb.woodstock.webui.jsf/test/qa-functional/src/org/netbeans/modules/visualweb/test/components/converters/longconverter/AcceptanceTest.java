...
package org.netbeans.modules.visualweb.test.components.converters.longconverter;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.converters.longconverter.Acceptance";
    ...
    public String _converterLong = Bundle.getStringTrimmed(_sharedBundle,"converterLong");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _long1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"long1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _longConverter1 = Bundle.getStringTrimmed(_privateBundle,"longConverter1");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddLongConverter"));
        suite.addTest(new AcceptanceTest("testVerifyLongConverter"));
     ...
     */
    public void testAddLongConverter() {
        startTest();
        log("**Initialize");
        ...
        log("**Add Long converter to designer");
        clickPoint = palette.getClickPoint(_converterLong);
        dropPoint = new Point(_x, _long1y);
        palette.addComponent(_converterLong, designer, dropPoint);
    ...
    /*
     * Verify long converter in outline window
     */
    public void testVerifyLongConverter() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select Long converter from Outline window");
        String path = _outlinePage1 + _longConverter1;
        doo.verify();
