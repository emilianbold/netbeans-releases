...
package org.netbeans.modules.visualweb.test.components.output.stdcomponentlabel;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.output.stdcomponentlabel.AcceptanceTest";
    ...
    public String _standardComponentLabel = Bundle.getStringTrimmed(_sharedBundle,"standardComponentLabel");
    ...
    public int _componentlabel1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"componentlabel1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    //Values
    public String _componentLabel = Bundle.getStringTrimmed(_privateBundle,"componentlabel");
    ...
    public void testAddComponentLabel() {
        ...
        log("**Add Standard Component Lable to designer");
        clickPoint = palette.getClickPoint(_standardComponentLabel);
        dropPoint = new Point(_x, _componentlabel1y);
        palette.addComponent(_standardComponentLabel, designer, dropPoint);
