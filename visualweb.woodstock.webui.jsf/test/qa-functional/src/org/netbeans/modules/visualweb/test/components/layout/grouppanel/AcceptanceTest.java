...
package org.netbeans.modules.visualweb.test.components.layout.grouppanel;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.layout.grouppanel.Acceptance";
    ...
    public String _layoutGroupPanel = Bundle.getStringTrimmed(_sharedBundle,"layoutGroupPanel");
    ...
    public void testAddGroupPanel() {
        ...
        log("**Add group panel to designer");
        clickPoint = palette.getClickPoint(_layoutGroupPanel);
        dropPoint = new Point(_x, _grouppanel1y);
        palette.dndPaletteComponent(_layoutGroupPanel, designer, dropPoint);
