...
package org.netbeans.modules.visualweb.test.components.advanced.script;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.advanced.script.Acceptance";
    ...
    //Outline variables
    public String _outlineHead1 = Bundle.getStringTrimmed(_sharedBundle,"outlineHead1");
    ...
    public String _advancedScript = Bundle.getStringTrimmed(_sharedBundle,"advancedScript");
    

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _script1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"script1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _script = Bundle.getStringTrimmed(_privateBundle,"script");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddAdvancedScript"));
        suite.addTest(new AcceptanceTest("testVerifyScript"));
...
//        suite.addTest(new AcceptanceTest("testAddButton"));
    ...
    /*
     *    Add a script to designer
     */
    public void testAddAdvancedScript() {
        startTest();
        log("**Initialize");
        ...
        log("**Add script to designer");
        clickPoint = palette.getClickPoint(_advancedScript);
        dropPoint = new Point(_x, _script1y);
        palette.addComponent(_advancedScript, designer, dropPoint);
    ...
    /*
     * Verify Script in outline window
     */
    public void testVerifyScript() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select " + _script + " from Outline window");
        String path = _outlineHead1 + _script;
        doo.verify();
