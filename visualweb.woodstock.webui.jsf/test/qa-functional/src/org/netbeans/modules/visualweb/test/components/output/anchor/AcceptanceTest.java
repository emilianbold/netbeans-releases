...
package org.netbeans.modules.visualweb.test.components.output.anchor;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _projectName = "AnchorTests";
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddAnchor"));
    ...
    public void testAddAnchor() {
        ...
        log("**Add label & set text");
        palette.addComponent("Label", designer, new Point(50, 20));
        try { Thread.sleep(2000); } catch(Exception e) {}
        new SheetTableOperator().setTextValue("text", "Sun Microsystems");
        
        log("**Add anchor & set id");
        palette.addComponent("Anchor", designer, new Point(50, 1000));
        try { Thread.sleep(2000); } catch(Exception e) {}
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);
        String path = _outlineForm1 + "anchor1";
        doo.verify();
        doo.selectPath(path);
        Util.wait(5000);  
        new SheetTableOperator().setTextValue("id", "bottomanchor");
