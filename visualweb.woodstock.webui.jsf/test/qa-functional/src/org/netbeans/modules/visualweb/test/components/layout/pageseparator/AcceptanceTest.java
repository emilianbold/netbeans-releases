...
package org.netbeans.modules.visualweb.test.components.layout.pageseparator;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.layout.pageseparator.Acceptance";
    ...
    public String _layoutPageSeparator = Bundle.getStringTrimmed(_sharedBundle,"layoutPageSeparator");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _pageseparator1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"pageseparator1y"));
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddPageSeparator"));
     ...
     */
    public void testAddPageSeparator() {
        startTest();
        log("**Initialize");
        ...
        clickPoint = palette.getClickPoint(_layoutPageSeparator);
        dropPoint = new Point(_x, _pageseparator1y);
        palette.dndPaletteComponent(_layoutPageSeparator, designer, dropPoint);
