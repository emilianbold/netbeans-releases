...
package org.netbeans.modules.visualweb.test.components.layout.stdgridpanel;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.layout.stdgridpanel.Acceptance";
    ...
    public String _standardGridPanel = Bundle.getStringTrimmed(_sharedBundle,"standardGridPanel");
    ...
    public void testAddGridPanel() {
        ...
        clickPoint = palette.getClickPoint(_standardGridPanel);
        dropPoint = new Point(_x, _gridpanel1y);
//        palette.dndPaletteComponent(_standardGridPanel, designer, dropPoint);
        palette.addComponent(_standardGridPanel, designer, dropPoint);
