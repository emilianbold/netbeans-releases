...
package org.netbeans.modules.visualweb.test.components.output.messagegroup;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _projectName = "MessageGroupTests";
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("addMessageGroup"));
    ...
    public void addMessageGroup() {
        ...
        palette.addComponent("Text Field", designer, new Point(50, 20));
        sheet = new SheetTableOperator();
        sheet.setTextValue("id", "name");
        try { Thread.sleep(2000); } catch(Exception e) {}
        palette.addComponent("Message Group", designer, new Point(50, 100));
        sheet = new SheetTableOperator();
        sheet.setTextValue("id", "msgrp1");
        sheet.switchCheckBox("showDetail");
