...
package org.netbeans.modules.visualweb.test.components.converters.sqltimestamp;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.converters.sqltimestamp.Acceptance";
    ...
    public String _converterSqlTimestamp = Bundle.getStringTrimmed(_sharedBundle,"converterSQLTimestamp");
    
    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _sqltimestamp1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"sqltimestamp1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _sqlTimestampConverter1 = Bundle.getStringTrimmed(_privateBundle,"sqlTimestampConverter1");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddSqlTimestampConverter"));
        suite.addTest(new AcceptanceTest("testVerifySqlTimestampConverter"));
     ...
     */
    public void testAddSqlTimestampConverter() {
        startTest();
        log("**Initialize");
        ...
        log("**Add sql timestamp converter to designer");
        clickPoint = palette.getClickPoint(_converterSqlTimestamp);
        dropPoint = new Point(_x, _sqltimestamp1y);
        palette.addComponent(_converterSqlTimestamp, designer, dropPoint);
    ...
    /*
     * Verify sql timestamp converter in outline window
     */
    public void testVerifySqlTimestampConverter() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select sqlTimestampConverter1 from Outline window");
        String path = _outlinePage1 + _sqlTimestampConverter1;
        doo.verify();
