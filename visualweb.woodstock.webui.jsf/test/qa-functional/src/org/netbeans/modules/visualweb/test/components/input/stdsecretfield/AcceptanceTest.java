...
package org.netbeans.modules.visualweb.test.components.input.stdsecretfield;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.input.stdsecretfield.Acceptance";
    ...
    public String _standardSecretField = Bundle.getStringTrimmed(_sharedBundle,"standardSecretField");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _secret1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"secret1y"));
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddSecretField"));
     ...
     */
    public void testAddSecretField() {
        startTest();
        log("**Initialize");
        Util.saveAllAPICall();
        ...
        clickPoint = palette.getClickPoint(_standardSecretField);
        dropPoint = new Point(_x, _secret1y);
...
//        palette.dndPaletteComponent(_standardSecretField, designer, dropPoint);
        palette.addComponent(_standardSecretField, designer, dropPoint);
