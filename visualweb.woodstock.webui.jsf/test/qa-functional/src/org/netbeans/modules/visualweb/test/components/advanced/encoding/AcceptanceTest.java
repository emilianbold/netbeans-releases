...
package org.netbeans.modules.visualweb.test.components.advanced.encoding;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle = "org.netbeans.modules.visualweb.test.components.advanced.encoding.Acceptance";
    ...
    public String _advancedEncoding = Bundle.getStringTrimmed(_sharedBundle, "advancedEncoding");


    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle, "x"));
    public int _encoding1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle, "encoding1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle, "button1y"));

    public String _encoding = Bundle.getStringTrimmed(_privateBundle, "encoding");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddAdvancedEncoding"));
        suite.addTest(new AcceptanceTest("testVerifyEncoding"));
...
//        suite.addTest(new AcceptanceTest("testAddButton"));
    ...
    /*
     *    Add a encoding to designer
     */
    public void testAddAdvancedEncoding() {
        startTest();
        log("**Initialize");
        ...
        clickPoint = palette.getClickPoint(_advancedEncoding);
        dropPoint = new Point(_x, _encoding1y);
//        palette.dndPaletteComponent(_advancedEncoding, designer, dropPoint);
        palette.addComponent(_advancedEncoding, designer, dropPoint);
        try {
            Thread.sleep(2000);
        } catch (Exception e) {
        }
    ...
    /*
     * Verify Encoding in outline window
     */
    public void testVerifyEncoding() {
        ...
        log("**Select " + _encoding + " from Outline window");
        String path = _outlineHead1 + _encoding;
        doo.verify();
