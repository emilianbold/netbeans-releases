...
package org.netbeans.modules.visualweb.test.components.layout.stdgrouppanel;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.layout.stdgrouppanel.Acceptance";
    ...
    public String _standardGroupPanel = Bundle.getStringTrimmed(_sharedBundle,"standardGroupPanel");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _grouppanel1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"grouppanel1y"));
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddGroupPanel"));
    ...
    public void testAddGroupPanel() {
        ...
        clickPoint = palette.getClickPoint(_standardGroupPanel);
        dropPoint = new Point(_x, _grouppanel1y);
...
//        palette.dndPaletteComponent(_standardSecretField, designer, dropPoint);
        palette.addComponent(_standardGroupPanel, designer, dropPoint);
    ...
    public void testAddButton() {
        ...
        dropPoint = new Point(_x+5, _button1y+5);
