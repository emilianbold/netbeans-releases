...
package org.netbeans.modules.visualweb.test.components.output.inlinehelp;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _projectName = "InlineHelpTests";
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("addInlineHelp"));
    ...
    public void addInlineHelp() {
        ...
        palette.addComponent("Text Field", designer, new Point(25, 25));
        try { Thread.sleep(2000); } catch(Exception e) {}
//        sheet = new SheetTableOperator();
//        sheet.setTextValue("id", "name");
        
        palette = new PaletteContainerOperator("Basic"); //workaround bug
        palette.addComponent("Message Group", designer, new Point(25, 100));
        try { Thread.sleep(2000); } catch(Exception e) {}
//        sheet = new SheetTableOperator();
//        sheet.setTextValue("id", "msgrp1");
//        sheet.switchCheckBox("showGlobalOnly");
        
        palette = new PaletteContainerOperator("Composite");
        palette.addComponent("Inline Help", designer, new Point(25, 50));
        try { Thread.sleep(2000); } catch(Exception e) {}
//        sheet = new SheetTableOperator();
//        sheet.setTextValue("id", "inlnhelp1");
//        sheet.setTextValue("text", "Help content for this page goes here");
