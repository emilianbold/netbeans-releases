...
package org.netbeans.modules.visualweb.test.components.layout.form;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.layout.form.Acceptance";
    ...
    public String _layoutForm = Bundle.getStringTrimmed(_sharedBundle,"layoutForm");
    ...
    public void testAddForm() {
        ...
        clickPoint = palette.getClickPoint(_layoutForm);
        dropPoint = new Point(_x, _form1y);
//        palette.dndPaletteComponent(_layoutForm, designer, dropPoint);
        palette.addComponent(_layoutForm, designer, dropPoint);
