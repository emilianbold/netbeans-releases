...
package org.netbeans.modules.visualweb.test.components.converters.biginteger;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.converters.biginteger.Acceptance";
    ...
    public String _converterBigInteger = Bundle.getStringTrimmed(_sharedBundle,"converterBigInteger");
    ...
    public int _biginteger1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"biginteger1y"));
    ...
    public String _bigIntegerConverter1 = Bundle.getStringTrimmed(_privateBundle,"bigIntegerConverter1");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddBigIntegerConverter"));
        suite.addTest(new AcceptanceTest("testVerifyBigIntegerConverter"));
     ...
     */
    public void testAddBigIntegerConverter() {
        startTest();
        log("**Initialize");
        ...
        log("**Add big integer converter to designer");
        clickPoint = palette.getClickPoint(_converterBigInteger);
        dropPoint = new Point(_x, _biginteger1y);
        palette.addComponent(_converterBigInteger, designer, dropPoint);
        try { Thread.sleep(5000); } catch(Exception e) {}
    ...
    /*
     * Verify big integer converter in outline window
     */
    public void testVerifyBigIntegerConverter() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(5000);

        log("**Select bigIntegerConverter1 from Outline window");
        String path = _outlinePage1 + _bigIntegerConverter1;
        doo.verify();
//        doo.clickOnPath(path);
    ...
    public void testAddTextField() {
        ...
        log("**Set Converter property to " + _bigIntegerConverter1);
        sheet = new SheetTableOperator();
        row = sheet.findCellRow(_propertyConverter);
        sheet.clickForEdit(row, 1);
        sheet.setComboBoxValue(_propertyConverter, _bigIntegerConverter1);
