...
package org.netbeans.modules.visualweb.test.components.advanced.facesverbatim;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.advanced.facesverbatim.Acceptance";
    ...
    public String _advancedFacesVerbatim = Bundle.getStringTrimmed(_sharedBundle,"advancedFacesVerbatim");
    

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _facesverbatim1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"facesverbatim1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _facesverbatim = Bundle.getStringTrimmed(_privateBundle,"facesverbatim");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddAdvancedFacesVerbatim"));
        suite.addTest(new AcceptanceTest("testVerifyFacesVerbatim"));
...
//        suite.addTest(new AcceptanceTest("testAddButton"));
    ...
    /*
     *    Add a faces verbatim to designer
     */
    public void testAddAdvancedFacesVerbatim() {
        startTest();
        log("**Initialize");
        ...
        log("**Add faces verbatim to designer");
        clickPoint = palette.getClickPoint(_advancedFacesVerbatim);
        dropPoint = new Point(_x, _facesverbatim1y);
        palette.addComponent(_advancedFacesVerbatim, designer, dropPoint);
    ...
    /*
     * Verify faces verbatim in outline window
     */
    public void testVerifyFacesVerbatim() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select " + _facesverbatim + " from Outline window");
        String path = _outlineForm1 + _facesverbatim;
        doo.verify();
