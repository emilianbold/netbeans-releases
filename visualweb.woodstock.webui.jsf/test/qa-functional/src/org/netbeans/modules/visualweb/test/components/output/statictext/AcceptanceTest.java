...
package org.netbeans.modules.visualweb.test.components.output.statictext;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _projectName = "StaticTextComponentTests";
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("addStaticText"));
    ...
    public void addStaticText() {
        ...
        palette.addComponent("Static Text", designer, new Point(50, 50));
