...
package org.netbeans.modules.visualweb.test.components.action.progressbar;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.action.progressbar.Acceptance";
    ...
    public String _compositeProgressBar = Bundle.getStringTrimmed(_sharedBundle,"compositeProgressBar");
    ...
    public int _progressbar1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"progressbar1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));
    public String _progressBar1 = Bundle.getStringTrimmed(_privateBundle,"progressBar1");

    //Property variables
    public String _propertyTask = Bundle.getStringTrimmed(_sharedBundle,"propertyTask");
    public String _taskRunning = Bundle.getStringTrimmed(_sharedBundle,"taskRunning");
    public String _propertyType = Bundle.getStringTrimmed(_sharedBundle,"propertyType");
    public String _typeBusy = Bundle.getStringTrimmed(_sharedBundle,"typeBusy");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddProgressBar"));
        suite.addTest(new AcceptanceTest("testVerifyProgressBar"));
        suite.addTest(new AcceptanceTest("testConfigureProgressBar"));
    ...
    /*
     *    Add a progress bar to designer
     */
    public void testAddProgressBar() {
        ...
        log("**Add progressbar to designer");
        clickPoint = palette.getClickPoint(_compositeProgressBar);
        dropPoint = new Point(_x, _progressbar1y);
        palette.addComponent(_compositeProgressBar, designer, dropPoint);
    ...
    /*
     * Verify length validator in outline window
     */
    public void testVerifyProgressBar() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select progressbar1 from Outline window");
        String path = _outlineForm1 + _progressBar1;
        doo.verify();
//        doo.clickOnPath(path);
     ...
     * Verify length validator in outline window
     */
    public void testConfigureProgressBar() {
        startTest();
        log("**Set Task = RUNNING via property sheet");
        sheet = new SheetTableOperator();
        row = sheet.findCellRow(_propertyTask);
        sheet.clickForEdit(row, 1);
        sheet.setComboBoxValue(_propertyTask, _taskRunning);
        
        log("**Set Type = BUSY via property sheet");
        sheet = new SheetTableOperator();
        row = sheet.findCellRow(_propertyType);
        sheet.clickForEdit(row, 1);
        sheet.setComboBoxValue(_propertyType, _typeBusy);
