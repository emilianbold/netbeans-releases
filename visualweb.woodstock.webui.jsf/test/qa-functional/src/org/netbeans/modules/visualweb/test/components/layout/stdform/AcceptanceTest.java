...
package org.netbeans.modules.visualweb.test.components.layout.stdform;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.layout.stdform.Acceptance";
    ...
    public String _standardForm = Bundle.getStringTrimmed(_sharedBundle,"standardForm");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _form1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"form1y"));
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddForm"));
    ...
    public void testAddForm() {
        ...
        log("**Add component to designer");
        clickPoint = palette.getClickPoint(_standardForm);
        dropPoint = new Point(_x, _form1y);
        palette.dndPaletteComponent(_standardForm, designer, dropPoint);
//        palette.addComponent(_standardForm, designer, dropPoint);
//        palette.addComponentOfClass("javax.faces.component.html.HtmlForm", designer, dropPoint);
        try { Thread.sleep(2000); } catch(Exception e) {}
        
        log("**Done.");
//        fail();//all three options are dragging the wrong component.
        endTest();
