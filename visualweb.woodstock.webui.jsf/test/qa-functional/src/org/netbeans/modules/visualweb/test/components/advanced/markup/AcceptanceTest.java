...
package org.netbeans.modules.visualweb.test.components.advanced.markup;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.advanced.markup.Acceptance";
    ...
    public String _advancedMarkup = Bundle.getStringTrimmed(_sharedBundle,"advancedMarkup");
    

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _markup1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"markup1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _markup = Bundle.getStringTrimmed(_privateBundle,"markup");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddAdvancedMarkup"));
        suite.addTest(new AcceptanceTest("testVerifyMarkup"));
...
//        suite.addTest(new AcceptanceTest("testAddButton"));
    ...
    /*
     *    Add a markup to designer
     */
    public void testAddAdvancedMarkup() {
        startTest();
        log("**Initialize");
        ...
        log("**Add markup to designer");
        clickPoint = palette.getClickPoint(_advancedMarkup);
        dropPoint = new Point(_x, _markup1y);
        palette.addComponent(_advancedMarkup, designer, dropPoint);
    ...
    /*
     * Verify markup in outline window
     */
    public void testVerifyMarkup() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select " + _markup + " from Outline window");
        String path = _outlineForm1 + _markup;
        doo.verify();
