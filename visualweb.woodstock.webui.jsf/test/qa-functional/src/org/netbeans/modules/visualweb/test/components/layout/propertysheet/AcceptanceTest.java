...
package org.netbeans.modules.visualweb.test.components.layout.propertysheet;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.layout.propertysheet.Acceptance";
    ...
    public String _layoutPropertySheet = Bundle.getStringTrimmed(_sharedBundle,"layoutPropertySheet");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _propertysheet1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"propertysheet1y"));
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddPropertySheet"));
    ...
    public void testAddPropertySheet() {
        ...
        clickPoint = palette.getClickPoint(_layoutPropertySheet);
        dropPoint = new Point(_x, _propertysheet1y);
//        palette.dndPaletteComponent(_layoutPropertySheet, designer, dropPoint);
        palette.addComponent(_layoutPropertySheet, designer, dropPoint);
