...
package org.netbeans.modules.visualweb.test.components.converters.calendar;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.converters.calendar.Acceptance";
    ...
    public String _converterCalendar = Bundle.getStringTrimmed(_sharedBundle,"converterCalendar");
    ...
    public String _calendarConverter1 = Bundle.getStringTrimmed(_privateBundle,"calendarConverter1");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddCalendarConverter"));
        suite.addTest(new AcceptanceTest("testVerifyCalendarConverter"));
     ...
     */
    public void testAddCalendarConverter() {
        startTest();
        log("**Initialize");
        ...
        log("**Add calendar converter to designer");
        clickPoint = palette.getClickPoint(_converterCalendar);
        dropPoint = new Point(_x, _calendar1y);
        palette.addComponent(_converterCalendar, designer, dropPoint);
     ...
     */
    public void testVerifyCalendarConverter() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select calendarConverter1 from Outline window");
        String path = _outlinePage1 + _calendarConverter1;
        doo.verify();
