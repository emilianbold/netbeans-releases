...
package org.netbeans.modules.visualweb.test.components.converters.datetime;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.converters.datetime.Acceptance";
    ...
    public String _converterDateTime = Bundle.getStringTrimmed(_sharedBundle,"converterDateTime");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _datetime1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"datetime1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _dateTimeConverter1 = Bundle.getStringTrimmed(_privateBundle,"dateTimeConverter1");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddDateTimeConverter"));
        suite.addTest(new AcceptanceTest("testVerifyDateTimeConverter"));
     ...
     */
    public void testAddDateTimeConverter() {
        startTest();
        log("**Initialize");
        ...
        log("**Add datetime converter to designer");
        clickPoint = palette.getClickPoint(_converterDateTime);
        dropPoint = new Point(_x, _datetime1y);
        palette.addComponent(_converterDateTime, designer, dropPoint);
    ...
    /*
     * Verify date time converter in outline window
     */
    public void testVerifyDateTimeConverter() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select dateTimeConverter1 from Outline window");
        String path = _outlinePage1 + _dateTimeConverter1;
        doo.verify();
