...
package org.netbeans.modules.visualweb.test.components.converters.integerconverter;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.converters.integerconverter.Acceptance";
    ...
    public int _integer1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"integer1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _integerConverter1 = Bundle.getStringTrimmed(_privateBundle,"integerConverter1");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddIntegerConverter"));
        suite.addTest(new AcceptanceTest("testVerifyIntegerConverter"));
     ...
     */
    public void testAddIntegerConverter() {
        startTest();
        log("**Initialize");
        ...
        clickPoint = palette.getClickPoint(_converterInteger);
        dropPoint = new Point(_x, _integer1y);
    ...
    /*
     * Verify integer converter in outline window
     */
    public void testVerifyIntegerConverter() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select integerConverter1 from Outline window");
        String path = _outlinePage1 + _integerConverter1;
        doo.verify();
