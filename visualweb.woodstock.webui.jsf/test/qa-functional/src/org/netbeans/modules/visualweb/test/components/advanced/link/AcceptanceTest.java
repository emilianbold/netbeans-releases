...
package org.netbeans.modules.visualweb.test.components.advanced.link;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.advanced.link.Acceptance";
    ...
    public String _advancedLink = Bundle.getStringTrimmed(_sharedBundle,"advancedLink");
    

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _link1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"link1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _link = Bundle.getStringTrimmed(_privateBundle,"link");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddAdvancedLink"));
        suite.addTest(new AcceptanceTest("testVerifyLink"));
...
//        suite.addTest(new AcceptanceTest("testAddButton"));
    ...
    /*
     *    Add a link to designer
     */
    public void testAddAdvancedLink() {
        startTest();
        log("**Initialize");
        ...
        log("**Add link to designer");
        clickPoint = palette.getClickPoint(_advancedLink);
        dropPoint = new Point(_x, _link1y);
        palette.addComponent(_advancedLink, designer, dropPoint);
    ...
    public void testVerifyLink() {
        ...
        log("**Select " + _link + " from Outline window");
        String path = _outlineHead1 + _link;
        doo.verify();
