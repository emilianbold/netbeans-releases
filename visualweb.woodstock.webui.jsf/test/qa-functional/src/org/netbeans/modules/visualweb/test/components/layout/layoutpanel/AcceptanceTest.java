...
package org.netbeans.modules.visualweb.test.components.layout.layoutpanel;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.layout.layoutpanel.Acceptance";
    ...
    public String _layoutLayoutPanel = Bundle.getStringTrimmed(_sharedBundle,"layoutLayoutPanel");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _layoutpanel1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"layoutpanel1y"));
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddLayoutPanel"));
     ...
     */
    public void testAddLayoutPanel() {
        startTest();
        log("**Initialize");
        ...
        clickPoint = palette.getClickPoint(_layoutLayoutPanel);
        dropPoint = new Point(_x, _layoutpanel1y);
        palette.dndPaletteComponent(_layoutLayoutPanel, designer, dropPoint);
