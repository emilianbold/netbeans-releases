...
package org.netbeans.modules.visualweb.test.components.input.stdtextfield;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.input.stdtextfield.Acceptance";
    ...
    public void testAddTextField() {
        ...
        clickPoint = palette.getClickPoint(_standardTextField);
...
//        palette.dndPaletteComponent(_standardSecretField, designer, dropPoint);
        palette.addComponent(_standardTextField, designer, dropPoint);
