...
package org.netbeans.modules.visualweb.test.components.validators.longrange;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.validators.longrange.Acceptance";
    ...
    public String _validatorLongRange = Bundle.getStringTrimmed(_sharedBundle,"validatorLongRange");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _longrange1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"longrange1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));
    public String _longRangeValidator1 = Bundle.getStringTrimmed(_privateBundle,"longRangeValidator1");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddLongRangeValidator"));
        suite.addTest(new AcceptanceTest("testConfigureLongRangeValidator"));
...
//        palette.addComponent(_basicTextField, designer, dropPoint);
    ...
    /*
     *    Add a long Range Validator to designer
     */
    public void testAddLongRangeValidator() {
        startTest();
        log("**Initialize");
        designer = new DesignerPaneOperator(RaveWindowOperator.getDefaultRave());
        ...
        log("**Add long range validator to designer");
        clickPoint = palette.getClickPoint(_validatorLongRange);
        dropPoint = new Point(_x+15, _longrange1y+15);
        palette.addComponent(_validatorLongRange, designer, dropPoint);
        try { Thread.sleep(2000); } catch(Exception e) {}
    ...
    /*
     * Configure long Range in outline window
     */
    public void testConfigureLongRangeValidator() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select doubleRangeValidator1 from Outline window");
        String path = _outlinePage1 + _longRangeValidator1;
        doo.verify();
//        doo.clickOnPath(path);
     ...
     */
    public void testVerifyLongRangeValidator() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select longRangeValidator1 from Outline window");
        String path = _outlinePage1 + _longRangeValidator1;
        doo.verify();
//        doo.clickOnPath(path);
        doo.selectPath(path);
