...
package org.netbeans.modules.visualweb.test.components.advanced.facesactionlistener;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.advanced.facesactionlistener.Acceptance";
    ...
    public String _advancedFacesActionListener = Bundle.getStringTrimmed(_sharedBundle,"advancedFacesActionListener");
    

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _facesactionlistener1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"facesactionlistener1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _facesactionlistener = Bundle.getStringTrimmed(_privateBundle,"facesactionlistener");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddAdvancedFacesActionListener"));
        suite.addTest(new AcceptanceTest("testVerifyFacesActionListener"));
...
//        suite.addTest(new AcceptanceTest("testAddButton"));
    ...
    /*
     *    Add a faces action listener to designer
     */
    public void testAddAdvancedFacesActionListener() {
        startTest();
        log("**Initialize");
        ...
        log("**Add faces action listner to designer");
        clickPoint = palette.getClickPoint(_advancedFacesActionListener);
        dropPoint = new Point(_x, _facesactionlistener1y);
        palette.addComponent(_advancedFacesActionListener, designer, dropPoint);
    ...
    /*
     * Verify faces action listner in outline window
     */
    public void testVerifyFacesActionListener() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select " + _facesactionlistener + " from Outline window");
        String path = _outlineForm1 + _facesactionlistener;
        doo.verify();
