...
package org.netbeans.modules.visualweb.test.components.converters.character;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.converters.character.Acceptance";
    ...
    public String _converterCharacter = Bundle.getStringTrimmed(_sharedBundle,"converterCharacter");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _character1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"character1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _characterConverter1 = Bundle.getStringTrimmed(_privateBundle,"characterConverter1");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddCharacterConverter"));
        suite.addTest(new AcceptanceTest("testVerifyCharacterConverter"));
     ...
     */
    public void testAddCharacterConverter() {
        startTest();
        log("**Initialize");
        ...
        log("**Add character converter to designer");
        clickPoint = palette.getClickPoint(_converterCharacter);
        dropPoint = new Point(_x, _character1y);
        palette.addComponent(_converterCharacter, designer, dropPoint);
    ...
    /*
     * Verify Calendar converter in outline window
     */
    public void testVerifyCharacterConverter() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select characterConverter1 from Outline window");
        String path = _outlinePage1 + _characterConverter1;
        doo.verify();
