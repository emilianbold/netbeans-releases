...
package org.netbeans.modules.visualweb.test.components.validators.doublerange;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.validators.doublerange.Acceptance";
    ...
    public String _validatorDoubleRange = Bundle.getStringTrimmed(_sharedBundle,"validatorDoubleRange");
    ...
    public String _doubleRangeValidator1 = Bundle.getStringTrimmed(_privateBundle,"doubleRangeValidator1");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddDoubleRangeValidator"));
        suite.addTest(new AcceptanceTest("testConfigureDoubleRangeValidator"));
...
//        palette.addComponent(_basicTextField, designer, dropPoint);
    ...
    /*
     *    Add a double range validator to textfield
     */
    public void testAddDoubleRangeValidator() {
        startTest();
        log("**Initialize");
        designer = new DesignerPaneOperator(RaveWindowOperator.getDefaultRave());
        ...
        log("**Add double range validator to designer");
        clickPoint = palette.getClickPoint(_validatorDoubleRange);
        dropPoint = new Point(_x+15, _textfield1y+15);
        palette.addComponent(_validatorDoubleRange, designer, dropPoint);
        //palette.dndPaletteComponent(_validatorDoubleRange, designer, dropPoint);
        try { Thread.sleep(2000); } catch(Exception e) {}
    ...
    /*
     * Configure double Range in outline window
     */
    public void testConfigureDoubleRangeValidator() {
        startTest();
        log("**Initialize");
        ...
        String path = _outlinePage1 + _doubleRangeValidator1;
        doo.verify();
