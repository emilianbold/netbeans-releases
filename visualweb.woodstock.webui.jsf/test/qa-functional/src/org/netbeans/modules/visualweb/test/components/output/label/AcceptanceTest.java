...
package org.netbeans.modules.visualweb.test.components.output.label;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _projectName = "LabelComponentTests";
    ...
    public void testAddLabel() {
        ...
        Util.wait(1000);
        PaletteContainerOperator palette = new PaletteContainerOperator(Bundle.getStringTrimmed(BUNDLE,"PaletteGroup"));
        palette.addComponent("Label", designer, new Point(50, 50));
        sheet = new SheetTableOperator();
        sheet.setTextValue("id", "company");
        sheet.setTextValue("text", "Sun Microsystems");
        sheet.setTextValue("toolTip", "My Work Place");
        Util.wait(2000);
        endTest();
