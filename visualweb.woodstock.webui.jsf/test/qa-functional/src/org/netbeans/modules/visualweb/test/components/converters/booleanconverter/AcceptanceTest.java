...
package org.netbeans.modules.visualweb.test.components.converters.booleanconverter;
...
public class AcceptanceTest extends RaveTestCase {
    ...
    public String _privateBundle ="org.netbeans.modules.visualweb.test.components.converters.booleanconverter.Acceptance";
    ...
    public String _converterBoolean = Bundle.getStringTrimmed(_sharedBundle,"converterBoolean");

    //drop points
    public int _x = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"x"));
    public int _boolean1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"boolean1y"));
    public int _button1y = Integer.parseInt(Bundle.getStringTrimmed(_privateBundle,"button1y"));

    public String _booleanConverter1 = Bundle.getStringTrimmed(_privateBundle,"booleanConverter1");
    ...
    public static Test suite() {
        ...
        suite.addTest(new AcceptanceTest("testAddBooleanConverter"));
        suite.addTest(new AcceptanceTest("testVerifyBooleanConverter"));
     ...
     */
    public void testAddBooleanConverter() {
        startTest();
        log("**Initialize");
        ...
        log("**Add boolean converter to designer");
        clickPoint = palette.getClickPoint(_converterBoolean);
        dropPoint = new Point(_x, _boolean1y);
        palette.addComponent(_converterBoolean, designer, dropPoint);
    ...
    /*
     * Verify boolean converter in outline window
     */
    public void testVerifyBooleanConverter() {
        startTest();
        log("**Initialize");
        DocumentOutlineOperator doo = new DocumentOutlineOperator(Util.getMainWindow());
        Util.wait(2000);

        log("**Select booleanConverter1 from Outline window");
        String path = _outlinePage1 + _booleanConverter1;
        doo.verify();
