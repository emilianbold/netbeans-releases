...
public abstract class EditDependencyPresenter extends Presenter {
    ...
    /**
     * Returns whether the related component is editable using EditAction class
     * @return true, if the related component is editable
     */
    ...
    public static final Presenter createNotEditablePresenter() {    
        return new EditDependencyPresenter() {
            public boolean isComponentEditable() {
                return false;
            }
