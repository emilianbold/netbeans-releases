...
public class SchemaTest extends TestCase {
    ...
    public void testSchemaPartnerLinkType() throws Exception {
        MyErrorHandler errorHandler = new MyErrorHandler();
        SchemaFactory sf = SchemaFactory.newInstance(XMLConstants.W3C_XML_SCHEMA_NS_URI);
        sf.setErrorHandler(errorHandler);
        PartnerLinkTypeValidatorSchemaFactory fac = new PartnerLinkTypeValidatorSchemaFactory();
    ...
    public void testSchemaPropertyAndPropertyAlias() throws Exception {
        MyErrorHandler errorHandler = new MyErrorHandler();
        SchemaFactory sf = SchemaFactory.newInstance(XMLConstants.W3C_XML_SCHEMA_NS_URI);
        sf.setErrorHandler(errorHandler);
        BPELPropertiesValidatorSchemaFactory fac = new BPELPropertiesValidatorSchemaFactory();
        Source s = fac.getSchemaSource();
        Schema schema = sf.newSchema(s);
