...
import org.netbeans.modules.iep.editor.refactoring.WSDLRefactoringElement;
 ...
 */
public class IEPTreeFactoryImpl implements TreeElementFactoryImplementation {
    
  public Map<Object, TreeElement> map = new WeakHashMap();

   public static IEPTreeFactoryImpl instance;
    {
        instance = this;
    }
    ...
    public TreeElement getTreeElement(Object o) {
        ...
        if (o instanceof RefactoringElement) {
            ...
            if (u!=null && u instanceof IEPComponent) {
                result = new IEPTreeElement((RefactoringElement) o);
            } 
        } else if(o instanceof WSDLRefactoringElement) {
            if(result == null) {
                result = new WSDLTreeElement((RefactoringElement) o);
            }  
        } else if( o instanceof IEPComponent){
            result = new IEPTreeElement((IEPComponent)o);
        }
