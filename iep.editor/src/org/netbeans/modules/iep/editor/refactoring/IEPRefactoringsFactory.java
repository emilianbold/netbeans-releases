 ...
 * @author 
 */
public class IEPRefactoringsFactory implements RefactoringPluginFactory {
    ...
    public RefactoringPlugin createInstance(AbstractRefactoring refactoring) {
        ...
        if (refactoring instanceof WhereUsedQuery) {
            return new IEPWhereUsedRefactoringPlugin( (WhereUsedQuery)refactoring);
        } else if (refactoring instanceof RenameRefactoring) {
            return new IEPRenameRefactoringPlugin( (RenameRefactoring)refactoring);
