 ...
 * 
 */
public class IEPTreeElement implements TreeElement { 
    ...
    IEPTreeElement(RefactoringElement element) {
        this.element = element;
        this.comp = element.getLookup().lookup(IEPComponent.class);
                
        assert comp instanceof IEPComponent:"This TreeElement handles IEPComponents only";
...
//                            node = NodesFactory.getInstance().create(comp);
                            //TODO we need to get Node of any other plan component.
    ...
    IEPTreeElement(Object element) {
        this.comp = (IEPComponent)element;
