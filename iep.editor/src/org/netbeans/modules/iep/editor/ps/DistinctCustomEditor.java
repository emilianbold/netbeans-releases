...
public class DistinctCustomEditor extends DefaultCustomEditor {

    private static final Logger mLog = Logger.getLogger(DistinctCustomEditor.class.getName());

    /** Creates a new instance of DistinctCustomEditor */
    public DistinctCustomEditor() {
        super();
    }
