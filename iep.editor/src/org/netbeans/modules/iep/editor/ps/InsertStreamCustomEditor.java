...
public class InsertStreamCustomEditor extends DefaultCustomEditor {
    private static final Logger mLog = Logger.getLogger(InsertStreamCustomEditor.class.getName());
    
    /** Creates a new instance of InsertStreamCustomEditor */
    public InsertStreamCustomEditor() {
        super();
    }
