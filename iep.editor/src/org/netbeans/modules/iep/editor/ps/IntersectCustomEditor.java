...
public class IntersectCustomEditor extends DefaultCustomEditor {
    private static final Logger mLog = Logger.getLogger(IntersectCustomEditor.class.getName());
    
    /** Creates a new instance of IntersectCustomEditor */
    public IntersectCustomEditor() {
        super();
    }
