...
public class ColumnGroup {
     ...
     */
    public Vector getColumnGroups(TableColumn col, Vector g) {
        g.addElement(this);
        if (colVector.contains(col)) return g;
        Iterator iter = colVector.iterator();
        while (iter.hasNext()) {
            Object obj = iter.next();
            if (obj instanceof ColumnGroup) {
                Vector groups =
                (Vector)((ColumnGroup)obj).getColumnGroups(col,(Vector)g.clone());
