...
public class BatchedStreamOutputCustomEditor extends DefaultCustomEditor {
    ...
    private static class MyCustomizer extends DefaultCustomizer {
        ...
        protected JPanel createPropertyPanel() throws Exception {
            ...
            // include timestamp
            TcgProperty includeTimestampProp = mComponent.getProperty(INCLUDE_TIMESTAMP_KEY);
            ...
            // batch size
            TcgProperty batchSizeProp = mComponent.getProperty(BATCH_SIZE_KEY);
            ...
            TcgProperty maximumDelayProp = mComponent.getProperty(MAXIMUM_DELAY_SIZE_KEY);
            TcgProperty maximumDelayUnitProp = mComponent.getProperty(MAXIMUM_DELAY_UNIT_KEY);
