...
/**
 * AttributeBasedWindowCustomEditor.java
 *
 * Created on November 10, 2006, 10:23 AM
 *
 * @author Bing Lu
 */
public class AttributeBasedWindowCustomEditor extends DefaultCustomEditor {
    private static final Logger mLog = Logger.getLogger(AttributeBasedWindowCustomEditor.class.getName());
    
    /** Creates a new instance of StaticIOCustomEditor */
    public AttributeBasedWindowCustomEditor() {
        super();
    }
    ...
    private static class MyCustomizer extends DefaultCustomizer {
        ...
        protected JPanel createPropertyPanel() throws Exception {
            ...
            String attributeStr = NbBundle.getMessage(TupleBasedAggregatorCustomEditor.class, "CustomEditor.ATTRIBUTE");
