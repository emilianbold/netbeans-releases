 ...
 */
public class MultiRowTableHeaderUI extends BasicTableHeaderUI {
    /**
    ...
    public void paint(Graphics g, JComponent c) {
        ...
        MultiRowTableColumnModel cm = (MultiRowTableColumnModel)header.getColumnModel();
        if (cm == null) return;
        ((MultiRowTableHeader)header).setColumnMargin();
        int column = 0;
        Dimension size = header.getSize();
        Rectangle cellRect  = new Rectangle(0, 0, size.width, size.height);
        Hashtable<ColumnGroup, Rectangle> hashMap = new Hashtable<ColumnGroup, Rectangle>();
        ...
        while (columns.hasMoreElements()) {
            ...
            if (colGrpIter != null) {
                ...
                while (colGrpIter.hasNext()) {
                    ...
                    Rectangle groupRect = (Rectangle)hashMap.get(cGroup);
                    if (groupRect == null) {
                        groupRect = new Rectangle(cellRect);
                        Dimension d = cGroup.getSize(header.getTable());
                        groupRect.width  = d.width;
                        groupRect.height = d.height;
                        hashMap.put(cGroup, groupRect);
                    }
    ...
    private int getHeaderHeight() {
        int height = 0;
        MultiRowTableColumnModel columnModel = (MultiRowTableColumnModel)header.getColumnModel();
