...
/**
 * TimeBasedAggregatorCustomEditor.java
 *
 * Created on November 10, 2006, 10:23 AM
 *
 * @author Bing Lu
 */
public class TimeBasedAggregatorCustomEditor extends DefaultCustomEditor {
    private static final Logger mLog = Logger.getLogger(TimeBasedAggregatorCustomEditor.class.getName());
    
    /** Creates a new instance of StaticIOCustomEditor */
    public TimeBasedAggregatorCustomEditor() {
        super();
    }
    ...
    private static class MyCustomizer extends DefaultCustomizer {
        ...
        protected JPanel createPropertyPanel() throws Exception {
            ...
            gbc.weighty = 0.0D;
            gbc.fill = GridBagConstraints.NONE;
            pane.add(mStartPanel.component[2], gbc);
            ...
            TcgProperty incrementUnitProp = mComponent.getProperty(INCREMENT_UNIT_KEY);
