...
/**
 * TupleBasedAggregatorCustomEditor.java
 *
 * Created on November 10, 2006, 10:23 AM
 *
 * @author Bing Lu
 */
public class TupleBasedAggregatorCustomEditor extends DefaultCustomEditor {
    private static final Logger mLog = Logger.getLogger(TupleBasedAggregatorCustomEditor.class.getName());
    
    /** Creates a new instance of StaticIOCustomEditor */
    public TupleBasedAggregatorCustomEditor() {
        super();
    }
    ...
    private static class MyCustomizer extends DefaultCustomizer {
        ...
        protected PropertyPanel mIncrementPanel;
