...
public class RelationStreamCustomEditor extends DefaultCustomEditor {
    private static final Logger mLog = Logger.getLogger(RelationStreamCustomEditor.class.getName());
    
    /** Creates a new instance of RelationStreamCustomEditor */
    public RelationStreamCustomEditor() {
        super();
    }
