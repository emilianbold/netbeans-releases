...
public class UnionAllCustomEditor extends DefaultCustomEditor {
    private static final Logger mLog = Logger.getLogger(UnionAllCustomEditor.class.getName());
    
    /** Creates a new instance of UnionAllCustomEditor */
    public UnionAllCustomEditor() {
        super();
    }
