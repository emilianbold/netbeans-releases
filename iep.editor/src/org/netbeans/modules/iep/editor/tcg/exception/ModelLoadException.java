...
public class ModelLoadException
    ...
    /**
     * Constructor for the ModelLoadException object
     *
     ...
     */
    public ModelLoadException(String keyName, String bundleName,
                                 Object[] params) {
     ...
     *        rethrown.
     */
    public ModelLoadException(I18nException original) {
        super(original);
    }
}
