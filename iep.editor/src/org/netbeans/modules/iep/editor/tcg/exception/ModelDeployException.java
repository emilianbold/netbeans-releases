 ...
 * @author Bing Lu
 */
public class ModelDeployException
    extends I18nException {

    /**
     * Constructor for the ModelDeployException object
     *
     ...
     */
    public ModelDeployException(String keyName, String bundleName,
                                   Object[] params) {
     ...
     *        rethrown.
     */
    public ModelDeployException(I18nException original) {
        super(original);
    }
}
