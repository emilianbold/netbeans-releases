 ...
 * @author Bing Lu
 */
public class OkValidator implements org.netbeans.modules.iep.model.lib.TcgComponentValidator {
    ...
    public org.netbeans.modules.iep.model.lib.TcgComponentValidationReport validate(TcgComponent component) {
        return new org.netbeans.modules.iep.model.lib.TcgComponentValidationReport(component, VALIDATION_OK_KEY, new ArrayList(), new ArrayList());
    }
}
