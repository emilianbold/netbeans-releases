 ...
 * @author Bing Lu
 */
public class OkValidator implements TcgComponentValidator {
    ...
    public TcgComponentValidationReport validate(TcgComponent component) {
        return new TcgComponentValidationReport(component, VALIDATION_OK_KEY, new ArrayList(), new ArrayList());
    }
}
