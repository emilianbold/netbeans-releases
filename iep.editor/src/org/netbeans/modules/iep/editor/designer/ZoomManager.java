...
public class ZoomManager {
    ...
    public static URL imgFitDiagramURL = ZoomManager.class.getResource("/images/fit_diagram.png");
    public static URL imgFitWidthURL = ZoomManager.class.getResource("/images/fit_width.png");
    public static URL imgNormalSizeURL = ZoomManager.class.getResource("/images/normal_size.png");
    public static URL imgZoomInURL = ZoomManager.class.getResource("/images/zoom_in.png");
    public static URL imgZoomOutURL = ZoomManager.class.getResource("/images/zoom_out.png");;
     ...
     */
    public ZoomManager(PlanCanvas scene) {
        this.scene = scene;
...
//                JScrollPane.class, scene.getCanvas());
...
//        Point sceneCenter = scene.convertViewToScene(center);
        Point sceneCenter = center; 
        scene.convertDocToView(sceneCenter);
...
//        Point newViewCenter = scene.convertSceneToView(sceneCenter);
        Point newViewCenter = sceneCenter;
//        scene.convertViewToDoc(newViewCenter);
        
        JComponent view = scene;
    ...
    private static class FitDiagramAction extends AbstractAction {
        ...
        public FitDiagramAction(ZoomManager manager) {
            this.manager = manager;
            ImageIcon img = new ImageIcon(imgFitDiagramURL);
            if (img != null) {
        ...
        public void actionPerformed(ActionEvent e) {
            PlanCanvas scene = manager.getScene();
//            JScrollPane pane = (JScrollPane) SwingUtilities.getAncestorOfClass(
//                    JScrollPane.class, scene.getCanvas());
//            if (pane == null) {
...
//            Rectangle compRect = scene.getPreferredBounds();
            Rectangle compRect = scene.getBounds();
    ...
    private static class FitWidthAction extends AbstractAction {
        ...
        public FitWidthAction(ZoomManager manager) {
            ...
            ImageIcon img = new ImageIcon(imgFitWidthURL);
            if (img != null) {
                putValue(Action.SMALL_ICON, img);
            }
...
//            Rectangle compRect = scene.getPreferredBounds();
    ...
    private static class ZoomDefaultAction extends AbstractAction {
        ...
        public ZoomDefaultAction(ZoomManager manager) {
            ...
            ImageIcon img = new ImageIcon(imgNormalSizeURL);
            if (img != null) {
                putValue(Action.SMALL_ICON, img);
            }
    ...
    private static class ZoomInAction extends AbstractAction implements ZoomListener {
        ...
        public ZoomInAction(ZoomManager manager) {
            ...
            ImageIcon img = new ImageIcon(imgZoomInURL);
            if (img != null) {
                putValue(Action.SMALL_ICON, img);
            }
    ...
    private static class ZoomOutAction extends AbstractAction implements ZoomListener {
        ...
        public ZoomOutAction(ZoomManager manager) {
            ...
            ImageIcon img = new ImageIcon(imgZoomOutURL);
            if (img != null) {
                putValue(Action.SMALL_ICON, img);
            }
