 ...
 * </pre>
 *
 * @author borrowed from the xml.wsdlui module.
 */
public class PlanSourceCookieProxyLookup extends ProxyLookup
     ...
     */
    public PlanSourceCookieProxyLookup(Lookup[] lookups, Node delegate) {
        super();
