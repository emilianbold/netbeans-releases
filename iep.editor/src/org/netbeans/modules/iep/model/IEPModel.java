 ...
 * 
 */
public abstract class IEPModel extends AbstractDocumentModel<IEPComponent> implements Referenceable, SharedConstants {
...
//   <T extends ReferenceableIEPComponent> T  findComponetnByName(QName name, Class<T> type);
     ...
     public abstract void saveWsdl(boolean abstractOnly) throws Exception;
     
     public abstract List<WsOperatorComponent> getWebServiceList(WSType wsType);
     
     public abstract List<OperatorComponent> getEntryList();
     
     public abstract List<OperatorComponent> getExitList();
