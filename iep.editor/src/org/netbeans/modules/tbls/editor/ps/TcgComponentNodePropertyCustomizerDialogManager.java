 ...
 * @author Bing Lu
 */
public class TcgComponentNodePropertyCustomizerDialogManager implements SharedConstants {
    /**
    ...
    private Window getDialog(TcgComponentNodeProperty prop) {
        ...
        mOkButton.getAccessibleContext().setAccessibleDescription(mOkButton.getText());
        ...
        String helpID = prop.getModelComponent().getString(PROP_HELP_ID);
//        if(helpID == null) {
...
//        }
        ...
        //accessibilty
        mDialog.getAccessibleContext().setAccessibleDescription(mTitle);
