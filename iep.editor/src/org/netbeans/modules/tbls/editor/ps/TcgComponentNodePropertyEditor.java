...
public abstract class TcgComponentNodePropertyEditor implements PropertyEditor, ComponentPropertyEditorConfig, ExPropertyEditor, HelpCtx.Provider {
	...
	return NbBundle.getMessage(TcgComponentNodePropertyEditor.class, 
		"TcgComponentNodePropertyEditor.Property_Launch_Custom_Editor_Label");
...
//        return prop.getValue();
    ...
    public synchronized void addPropertyChangeListener(
        ...
        if (mListeners == null) {
            mListeners = new java.util.Vector<PropertyChangeListener>();
        }
    ...
    public void firePropertyChange() {
        ...
        synchronized (this) {
            ...
            targets = (java.util.Vector<PropertyChangeListener>) mListeners.clone();
        }
