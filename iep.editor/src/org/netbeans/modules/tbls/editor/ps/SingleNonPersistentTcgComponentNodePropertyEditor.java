 ...
 * @author Bing Lu
 */
public abstract class SingleNonPersistentTcgComponentNodePropertyEditor implements PropertyEditor, ComponentPropertyEditorConfig, ExPropertyEditor,HelpCtx.Provider {
    private static final Logger mLogger = Logger.getLogger(SingleNonPersistentTcgComponentNodePropertyEditor.class.getName());
     ...
     * @since 1.5
     */
    public SingleNonPersistentTcgComponentNodePropertyEditor() {
...
//    firePropertyChange();
    ...
    public String getAsText() {
        ...
        if (type == TcgType.STRING_LIST) {
            List list =  ( List) getPropertyType().getDefaultValue();
        ...
        if (type == TcgType.STRING) {
            String s = (String) getPropertyType().getDefaultValue();
            if (s.startsWith("i18n.")) {
        ...
        return getPropertyType().getDefaultValue().toString();
    }
