...
public class TcgComponentValidationReport implements TcgModelConstants {
    ...
    private List<TcgComponentValidationReport> mChildReportList;
    private List<TcgComponentValidationMsg> mMessageList;
    
    /** Creates a new instance of TcgComponentValidationReport */
    public TcgComponentValidationReport(TcgComponent component, String type, List<TcgComponentValidationMsg> messageList, List<TcgComponentValidationReport> childReportList) {
    ...
    public List<TcgComponentValidationMsg> getMessageList() {
        return mMessageList;
    }
    
    public List<TcgComponentValidationReport> getChildReportList() {
