...
import org.netbeans.modules.ruby.merbproject.MerbActionProvider;
 ...
 */
public final class MerbLogicalViewProvider extends RubyBaseLogicalViewProvider {
    ...
    public MerbLogicalViewProvider(
    ...
    private final class RubyLogicalViewRootNode extends AbstractNode {
        ...
        public RubyLogicalViewRootNode() {
            super(NodeFactorySupport.createCompositeChildren(getProject(), "Projects/org-netbeans-modules-ruby-merbproject/Nodes"), 
                  Lookups.singleton(getProject()));
            setIconBaseWithExtension("org/netbeans/modules/ruby/merbproject/ui/resources/jruby.png");
        ...
        public @Override String getShortDescription() {
            ...
            if (platformDesc == null) {
                platformDesc = NbBundle.getMessage(MerbLogicalViewProvider.class, "RubyLogicalViewProvider.PlatformNotFound");
            }
            String dirName = FileUtil.getFileDisplayName(getProject().getProjectDirectory());
            return NbBundle.getMessage(MerbLogicalViewProvider.class, "RubyLogicalViewProvider.ProjectTooltipDescription", dirName, platformDesc);
        }
        ...
        private Action[] getAdditionalActions() {
            ...
            ResourceBundle bundle = NbBundle.getBundle(MerbLogicalViewProvider.class);
            ...
            actions.add(ProjectSensitiveActions.projectCommandAction(MerbActionProvider.COMMAND_RDOC, bundle.getString("LBL_RDocAction_Name"), null)); // NOI18N
            actions.add(null);
            if (INCLUDE_IRB_CONSOLE) {
                actions.add(ProjectSensitiveActions.projectCommandAction(MerbActionProvider.COMMAND_IRB_CONSOLE, "IRB" /*bundle.getString("LBL_ConsoleAction_Name")*/, null)); // NOI18N
                actions.add(null);
            }
            ...
            if (AutoTestSupport.isInstalled(getProject())) {
                actions.add(ProjectSensitiveActions.projectCommandAction(MerbActionProvider.COMMAND_AUTOTEST, bundle.getString("LBL_AutoTest"), null)); // NOI18N
            }
            if (rspecSupport.isRSpecInstalled()) {
                actions.add(ProjectSensitiveActions.projectCommandAction(MerbActionProvider.COMMAND_RSPEC, bundle.getString("LBL_RSpec"), null)); // NOI18N
            }
