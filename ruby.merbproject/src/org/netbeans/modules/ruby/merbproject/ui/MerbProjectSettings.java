...
/**
 * Settings for Merb projects.
 */
public class MerbProjectSettings {

    private static final MerbProjectSettings INSTANCE = new MerbProjectSettings();
    ...
    public static MerbProjectSettings getDefault() {
        return INSTANCE;
    }

    private static Preferences getPreferences() {
        return NbPreferences.forModule(MerbProjectSettings.class);
    }
    ...
    public boolean getLogicalView() {
        return getPreferences().getBoolean(LOGICAL_VIEW, false);
    }
