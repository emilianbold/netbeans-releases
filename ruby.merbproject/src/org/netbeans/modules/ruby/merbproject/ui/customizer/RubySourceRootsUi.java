...
public final class RubySourceRootsUi {
    ...
    public static DefaultTableModel createModel( MerbSourceRoots roots ) {
    ...
    public static EditMediator registerEditMediator( MerbProject master,
                                             MerbSourceRoots sourceRoots,
                                             JTable rootsList,
    ...
    public static class EditMediator implements ActionListener, ListSelectionListener, CellEditorListener {
        ...
        public EditMediator( MerbProject master,
                             MerbSourceRoots sourceRoots,
                             JTable rootsList,
                             JButton addFolderButton,
                             JButton removeButton,
...
out:        for( int i = 0; i < files.length; i++ ) {
                ...
                if ((p=FileOwnerQuery.getOwner(normalizedFile.toURI()))!=null && !p.getProjectDirectory().equals(project.getProjectDirectory())) {
                    ...
                    final SourceGroup[] javaGroups = sources.getSourceGroups(MerbProject.SOURCES_TYPE_RUBY);
