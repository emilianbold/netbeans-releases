...
public class CustomizerRun extends JPanel implements HelpCtx.Provider {
    ...
    public CustomizerRun(MerbProjectProperties uiProperties) {
        ...
        configPropsKeys = new String[] {
            MerbProjectProperties.RUN_SCRIPT,
            MerbProjectProperties.APPLICATION_ARGS,
            MerbProjectProperties.RUBY_OPTIONS,
            MerbProjectProperties.RUN_WORK_DIR,
            MerbProjectProperties.RAKE_ARGS,
            MerbProjectProperties.JVM_ARGS
        };
        ...
        jButtonMainClass.addActionListener(new MainClassListener(project.getSourceRoots(), runScriptTextField));
        ...
        platformListener = new PlatformComponentFactory.PlatformChangeListener() {
            public void platformChanged() {
                ...
                if (platform != null) {
                    ...
                    configs.get(getSelectedConfig()).put(MerbProjectProperties.PLATFORM_ACTIVE, platform.getID());
                    updateEnabled();
                }
            }
        };
    ...
    private void initComponents() {
        ...
        runScriptLabel = new javax.swing.JLabel();
        runScriptTextField = new javax.swing.JTextField();
        jButtonMainClass = new javax.swing.JButton();
        runScriptArgs = new javax.swing.JLabel();
        ...
        runScriptLabel.setLabelFor(runScriptTextField);
        org.openide.awt.Mnemonics.setLocalizedText(runScriptLabel, org.openide.util.NbBundle.getMessage(CustomizerRun.class, "LBL_CustomizeRun_Run_MainClass_JLabel")); // NOI18N
        ...
        runScriptArgs.setLabelFor(jTextFieldArgs);
        org.openide.awt.Mnemonics.setLocalizedText(runScriptArgs, org.openide.util.NbBundle.getMessage(CustomizerRun.class, "LBL_CustomizeRun_Run_Args_JLabel")); // NOI18N
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .add(mainPanelLayout.createSequentialGroup()
                .add(mainPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    ...
                    .add(runScriptArgs, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .add(runScriptLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(mainPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jLabelVMOptionsExample)
                    .add(rakeExampleLabel)
                    .add(jrubyPropsExample)
                    .add(rakeTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 507, Short.MAX_VALUE)
                    .add(jrubyPropsText, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 507, Short.MAX_VALUE)
                    .add(jTextFieldArgs, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 507, Short.MAX_VALUE)
                    .add(rubyOptions, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 507, Short.MAX_VALUE)
                    .add(runScriptTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 507, Short.MAX_VALUE)
                    .add(jTextWorkingDirectory, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 507, Short.MAX_VALUE))
                .add(6, 6, 6)
        ...
        mainPanelLayout.setVerticalGroup(
            ...
            .add(mainPanelLayout.createSequentialGroup()
                .add(mainPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(runScriptLabel)
                    .add(jButtonMainClass)
                    .add(runScriptTextField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(mainPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(runScriptArgs)
        ...
        runScriptTextField.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(CustomizerRun.class, "CustomizerRun.jTextFieldMainClass.AccessibleContext.accessibleName")); // NOI18N
        runScriptTextField.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getBundle(CustomizerRun.class).getString("AD_jTextFieldMainClass")); // NOI18N
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.LEADING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(org.jdesktop.layout.GroupLayout.TRAILING, platforms, 0, 489, Short.MAX_VALUE)
                            .add(org.jdesktop.layout.GroupLayout.TRAILING, configCombo, 0, 489, Short.MAX_VALUE))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
    ...
    private void configChanged(String activeConfig) {
        ...
        if (active != null) {
            ...
            String activePlatformID = active.get(MerbProjectProperties.PLATFORM_ACTIVE);
            if (activePlatformID == null) {
                activePlatformID = def.get(MerbProjectProperties.PLATFORM_ACTIVE);
            }
    ...
    private javax.swing.JLabel runScriptArgs;
    private javax.swing.JLabel runScriptLabel;
    private javax.swing.JTextField runScriptTextField;
    ...
    private class MainClassListener implements ActionListener /*, DocumentListener */ {
        ...
        MainClassListener( MerbSourceRoots sourceRoots, JTextField mainClassTextField ) {
