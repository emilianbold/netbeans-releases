 ...
 */
public class MerbSharabilityQuery implements SharabilityQueryImplementation, PropertyChangeListener {

    private final RakeProjectHelper helper;
    private final PropertyEvaluator evaluator;
    private final MerbSourceRoots srcRoots;
     ...
     */
    MerbSharabilityQuery (RakeProjectHelper helper, PropertyEvaluator evaluator, MerbSourceRoots srcRoots, MerbSourceRoots testRoots) {
        this.helper = helper;
    ...
    public int getSharability(final File file) {
        return ProjectManager.mutex().readAccess(new Mutex.Action<Integer>() {
            public Integer run() {
                synchronized (MerbSharabilityQuery.this) {
                    if (delegate == null) {
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        if (MerbSourceRoots.PROP_ROOT_PROPERTIES.equals(evt.getPropertyName())) {
            synchronized (this) {
                this.delegate = null;
            }
        }
