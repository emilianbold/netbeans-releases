...
final class SourcePathImplementation implements ClassPathImplementation, PropertyChangeListener {
     ...
     */
    public SourcePathImplementation(MerbSourceRoots sourceRoots) {
     ...
     */
    public SourcePathImplementation(MerbSourceRoots sourceRoots, RakeProjectHelper projectHelper, PropertyEvaluator evaluator) {
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        if (MerbSourceRoots.PROP_ROOTS.equals (evt.getPropertyName())) {
            synchronized (this) {
                this.resources = null;
            }
