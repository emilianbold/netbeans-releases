...
public class DataObjectTest_validity extends NbTestCase {

    /** Creates new DataObjectTest_manipulation */
    public DataObjectTest_validity(java.lang.String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        NbTestSuite suite = new NbTestSuite(DataObjectTest_validity.class);
        return suite;
    }
...
//     boolean successful = true;
  ...
  //          successful = true;
     ...
     *Own test
     */
    public void testDOValidity() throws Exception {
            prepare();
            org.openide.loaders.DataObject testedDO = DataObjectTest.findResource(NAME);
            DOT.checkValidity(testedDO);
            clean();
            //do not forget to merge the results!
//            successful = successful && DOT.successful;
            System.out.println("\n" + DOT.successful );
            assertTrue("Validity test failed!",DOT.successful);        
    }
