...
public class DataObjectTest_others extends NbTestCase {

    /** Creates new DataObjectTest_manipulation */
    public DataObjectTest_others(java.lang.String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        NbTestSuite suite = new NbTestSuite(DataObjectTest_others.class);
        return suite;
    }    
...
//            successful = true;
     ...
     *Own test
     */
    public void testDOOthers() throws Exception {
...
//            try{
                DOT.shadowMe(testedDO).delete();
//            }catch(Exception ex){
//                DOT.writeRef("\nDeleting of shadowed object failed!");
//                DOT.printException(ex);
//                DOT.writeRef(FAILED);
//            }
            DOT.checkTemplate(testedDO);
            DOT.testHelpCtx(testedDO);
            clean();
...
//            ee.printStackTrace();
//            DOT.writeRef("Others test failed!",FAILED);
//        }
        assertTrue("Others test failed!",DOT.successful);        
    }
    ...
    protected String NAME = null;//"/DataObjects/JavaSourceObject.java";
}
