...
public class DataObjectTest_modify extends NbTestCase {

    /** Creates new DataObjectTest_manipulation */
    public DataObjectTest_modify(java.lang.String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        NbTestSuite suite = new NbTestSuite(DataObjectTest_modify.class);
        return suite;
    }    
...
//            org.openide.filesystems.FileObject fo = DOT.rep.findResource(new DataObjectTest("x").getClass().getPackage().getName().replace('.','/')
  //                                                                                + NAME);
    //        org.openide.loaders.DataObject testedDO = org.openide.loaders.DataObject.find(fo);
            ...
            DOT.checkModifyAbility(testedDO);
            clean();
