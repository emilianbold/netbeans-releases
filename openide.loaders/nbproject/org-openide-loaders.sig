...
hfds BOTTOM,HEIGHT_TOLERANCE,LEFT,RESIDUAL_WIDTH,RIGHT,TOP,actionDataFlavor,backingFolder,buttonDataFlavor,customFontHeightCorrection,displayName,dnd,dragSourceButtonIndex,dropTargetButtonIndex,emptyInsets,floatable,hintsMap,insertBefore,isDragSourceToolbar,isJdk15,isJdk16,isMetalLaF,isXP,listener,mouseListener,processor,serialVersionUID,synthIconClass,testExecuted
hcls DefaultIconButton,DnDSupport,Folder,ToolbarAqua,ToolbarBump,ToolbarGrip,ToolbarGtk,ToolbarMouseListener,ToolbarXP
...
supr javax.swing.JComponent
hfds center,defaultPool,folder,instance,isXP,listener,lowerBorder,mid,name,preferredIconSize,serialVersionUID,taskListener,toolbarAccessibleContext,toolbarConfigs,toolbars,upperBorder
...
supr java.lang.Object
hfds DEFAULT,allLoaders,cntchanges,defaultLoaders,emptyDataLoaderRecognized,listeners,loaderArray,preferredLoader,serialVersionUID,systemLoaders
hcls DefaultLoader,DefaultPool,FolderLoader,InstanceLoader,InstanceLoaderSystem,ShadowLoader
...
hfds defaultLookup,obj,propL,refreshIconNodes,refreshNameIconLock,refreshNameNodes,refreshNamesIconsRunning,refreshNamesIconsTask,serialVersionUID,showFileExtensions
hcls AllFilesProperty,LastModifiedProperty,LazyFilesSet,NamesUpdater,ObjectHandle,PropL,SizeProperty
...
supr java.lang.Object
hfds EA_ASSIGNED_LOADER,EA_ASSIGNED_LOADER_MODULE,LOG,REGISTRY_INSTANCE,changeSupport,item,listenersMethodLock,loader,modif,modified,nodeCreationLock,nodeDelegate,serialVersionUID,syncModified,synchObject,vetoableChangeSupport,warnedClasses
...
supr org.openide.loaders.MultiDataObject
hfds MUTEX,RP,SHADOW_EXTENSION,allDataShadows,lastTask,nodes,origL,original,serialVersionUID
hcls DSWeakReference,OrigL
...
hfds CURRENT,LAST_CURRENT,PROCESSOR,container,creationTask,err,listener,map,object,recognizingTask,waitFor
...
hcls FolderLookupData,ICItem,ProxyLkp
...
supr org.openide.loaders.MultiDataObject
hfds CLOSE,EA_INSTANCE_CLASS,EA_INSTANCE_CREATE,EA_INSTANCE_OF,EA_NAME,EA_PROVIDER_PATH,EA_SUBCLASSES,ICON_NAME,IDO_LOCK,MAX_FILENAME_LENGTH,OPEN,PROCESSOR,SAVE_DELAY,SER_EXT,XML_EXT,cookieResult,cookiesLkp,cookiesLsnr,createdIDOs,err,fileLock,nameCache,nodeLsnr,nodeResult,savingCanceled,ser,serialVersionUID,un,warnedAboutBrackets
...
hfds ERR,RECOGNIZER,chLis,checked,cookieSet,cookieSetLock,delayProcessor,delayedPropFilesLock,delayedPropFilesTask,firingProcessor,primary,secondary,secondaryCreationLock,serialVersionUID
...
hfds CUSTOM_DESCRIPTION,CUSTOM_ITERATOR,EA_DESCRIPTION,EA_DESC_RESOURCE,EA_ITERATOR,PREF_DIM,PROP_CONTENT_DATA,PROP_CONTENT_SELECTED_INDEX,iterator,lastComp,newObjects,pcl,progressHandle,showTargetChooser,targetChooser,targetDataFolder,targetIterator,targetName,template,templateChooser,templatesFolder,titleFormatSet
...
meth public static void write(org.w3c.dom.Document,java.io.Writer) throws java.io.IOException
 anno 0 java.lang.Deprecated()
supr org.openide.loaders.MultiDataObject
hfds ERR,chainingEntityResolver,doc,editor,emgrLock,errorHandler,infoParser,infos,serialVersionUID,status
...
meth public void setValue(java.lang.String,java.lang.Object)
supr org.openide.nodes.Node
hfds DELEGATE_ALL,childrenProvided,delegateMask,hashCodeDepth,nodeL,original,overridesGetDisplayNameCache,pchlAttached,propL,replaceProvidedLookupCache
...
meth public final void removePropertyChangeListener(java.beans.PropertyChangeListener)
supr java.lang.Object
hfds annotationCount,attachedAnnotations,deleted,propertyChangeSupport
...
hfds HELP_ID,cursorPosition,customComponent,customToolbar,initialized,serialVersionUID,support
...
supr org.openide.windows.CloneableOpenSupport
hfds DOCUMENT_LOADING,DOCUMENT_NO,DOCUMENT_READY,DOCUMENT_RELOADING,ERR,LOCAL_LOAD_TASK,LOCK_PRINTING,PROP_PANE,alreadyModified,annotationsLoaded,doc,documentStatus,externallyModified,inUserQuestionExceptionHandler,justRevertedToNotModified,kit,lastReusable,lastSaveTime,lastSelected,lineSet,lineSetWHM,listener,listeners,lookup,mimeType,positionManager,prepareDocumentRuntimeException,prepareTask,printing,propertyChangeSupport,reloadDialogOpened,revertingUndoOrReloading,undoRedo
hcls BeforeModificationEdit,BeforeSaveEdit,CESUndoRedoManager,DelegateIOExc,FilterUndoableEdit,Listener,PlainEditorKit,SearchBeforeModificationEdit
...
hfds ERR,nodeL,obj
hcls DOEnvLookup,DataNodeListener,EnvListener
...
hfds fileLock,fileObject,serialVersionUID,warned
hcls SaveAsCapableImpl
...
hfds dataObject,nullPart,serialVersionUID
hcls NullPart
...
meth public final static org.openide.text.PrintPreferences$Alignment[] values()
