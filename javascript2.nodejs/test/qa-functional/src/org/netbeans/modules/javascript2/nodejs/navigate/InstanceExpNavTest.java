 ...
 * @author vriha
 */
public class InstanceExpNavTest extends GeneralNodeJs {

    public InstanceExpNavTest(String args) {
        super(args);
    }

    public static Test suite() {
        return NbModuleSuite.create(
                NbModuleSuite.createConfiguration(InstanceExpNavTest.class).addTest(
                        "openProject",
                        "testDirectProperty",
                        "testDirectProperty2",
                        "testRefProperty"
    ...
    public void testDirectProperty() throws Exception {
        startTest();
        testGoToDeclaration(new EditorOperator("maingt.js"), 60);
        endTest();
    }

    public void testDirectProperty2() throws Exception {
        startTest();
        testGoToDeclaration(new EditorOperator("maingt.js"), 61);
        endTest();
    }

    public void testRefProperty() throws Exception {
        startTest();
        testGoToDeclaration(new EditorOperator("maingt.js"), 64);
        endTest();
    }
