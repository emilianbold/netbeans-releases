...
public class ExportedClassNavTest extends GeneralNodeJs {
    ...
    public void testExportedClass() throws Exception {
        startTest();
        testGoToDeclaration(new EditorOperator("maingt.js"), 103);
        endTest();
    }

    public void testPrototypeProperty() throws Exception {
        startTest();
        testGoToDeclaration(new EditorOperator("maingt.js"), 105);
        endTest();
    ...
    public void testProperty() throws Exception {
        startTest();
        testGoToDeclaration(new EditorOperator("maingt.js"), 106);
        endTest();
    }
}
