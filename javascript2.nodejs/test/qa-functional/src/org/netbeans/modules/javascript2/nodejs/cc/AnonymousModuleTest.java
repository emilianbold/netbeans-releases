...
public class AnonymousModuleTest extends GeneralNodeJs {
    ...
    public void testAnonymous1() throws Exception {
        startTest();
        testCompletion(new EditorOperator("cc3.js"), 77);
        endTest();
    }

    public void testAnonymous2() throws Exception {
        startTest();
        testCompletion(new EditorOperator("cc3.js"), 79);
        endTest();
    }

    public void testAnonymous3() throws Exception {
        startTest();
        testCompletion(new EditorOperator("cc3.js"), 81);
        endTest();
    }

    public void testAnonymous4() throws Exception {
        startTest();
        testCompletion(new EditorOperator("cc3.js"), 83);
        endTest();
    }

    public void testAnonymous5() throws Exception {
        startTest();
        testCompletion(new EditorOperator("cc3.js"), 85);
        endTest();
    }

    public void testAnonymous6() throws Exception {
        startTest();
        testCompletion(new EditorOperator("cc3.js"), 87);
        endTest();
    }

    public void testAnonymous7() throws Exception {
        startTest();
        testCompletion(new EditorOperator("cc3.js"), 89);
        endTest();
    }

    public void testAnonymous8() throws Exception {
        startTest();
        testCompletion(new EditorOperator("cc3.js"), 91);
        endTest();
    }

    public void testAnonymous9() throws Exception {
        startTest();
        testCompletion(new EditorOperator("cc3.js"), 93);
        endTest();
    }
