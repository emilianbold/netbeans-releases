...
public class MozillaBrowserFactoryImpl extends EmbeddedBrowserFactory {

    private final PropertyChangeSupport propSupport = new PropertyChangeSupport(this);
    public MozillaBrowserFactoryImpl() {
    }

    @Override
    public boolean isEnabled() {
        return !BrowserFactory.isMozillaHidden();
    }
    ...
    public WebBrowser createEmbeddedBrowser() {
        ...
        return new WebBrowserImpl(BrowserType.Mozilla);
    }
