...
public class WebkitBrowserFactoryImpl extends EmbeddedBrowserFactory {

    private final PropertyChangeSupport propSupport = new PropertyChangeSupport(this);
    public WebkitBrowserFactoryImpl() {
    }

    @Override
    public boolean isEnabled() {
        return !BrowserFactory.isWebkitHidden();
    }
    ...
    public WebBrowser createEmbeddedBrowser() {
        ...
        return new WebBrowserImpl(BrowserType.Webkit);
    }
