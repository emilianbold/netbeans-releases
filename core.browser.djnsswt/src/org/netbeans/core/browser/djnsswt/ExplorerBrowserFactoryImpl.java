...
public class ExplorerBrowserFactoryImpl extends EmbeddedBrowserFactory {

    private final PropertyChangeSupport propSupport = new PropertyChangeSupport(this);
    public ExplorerBrowserFactoryImpl() {
    }

    @Override
    public boolean isEnabled() {
        return !BrowserFactory.isExplorerHidden();
    }
    ...
    public WebBrowser createEmbeddedBrowser() {
        ...
        return new WebBrowserImpl(BrowserType.Explorer);
    }
