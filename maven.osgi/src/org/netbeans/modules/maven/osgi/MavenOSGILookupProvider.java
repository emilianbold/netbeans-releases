...
public class MavenOSGILookupProvider implements LookupProvider {
    
    /** Creates a new instance of MavenApisupportLookupProvider */
    public MavenOSGILookupProvider() {
    }
...
//        // if there's more items later, just do a proxy..
        ...
        ic.add(new OSGIRecoPrivTemplates(project));
        ...
        private void checkOSGI() {
            ...
            if (NbMavenProject.TYPE_OSGI.equals(packaging) && !lastType.equals(packaging)) {
                ...
                content.add(lastAccess);
                    ...
                    NbMavenProject.TYPE_OSGI.equals(packaging)))
            {
