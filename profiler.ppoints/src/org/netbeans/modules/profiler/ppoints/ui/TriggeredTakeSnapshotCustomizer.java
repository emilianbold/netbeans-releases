...
public class TriggeredTakeSnapshotCustomizer extends ValidityAwarePanel implements DocumentListener, ValidityListener,
    ...
    public void setTriggerCondition(TriggeredGlobalProfilingPoint.TriggerCondition condition) {
        triggerCustomizer.setTriggerCondition(condition);
    }

    public TriggeredGlobalProfilingPoint.TriggerCondition getTriggerCondition() {
        return triggerCustomizer.getTriggerCondition();
    }
    ...
    public void initComponents(String caption, Icon icon) {
        ...
        constraints.fill = GridBagConstraints.NONE;
        constraints.insets = new Insets(0, 0, 0, 5);
        triggerHeaderContainer.add(triggerHeaderLabel, constraints);
        ...
        constraints.fill = GridBagConstraints.HORIZONTAL;
        constraints.insets = new Insets(0, 0, 0, 0);
        triggerHeaderContainer.add(triggerHeaderSeparator, constraints);
        ...
        // timeCustomizer
        triggerCustomizer = new TriggerCustomizer();
        triggerCustomizer.addValidityListener(this);
        constraints = new GridBagConstraints();
        constraints.gridx = 0;
        constraints.gridy = 5;
        constraints.gridwidth = GridBagConstraints.REMAINDER;
        ...
        add(triggerCustomizer, constraints);
    ...
    private void updateValidity() {
        boolean isValid = !isNameEmpty() && snapshotCustomizer.areSettingsValid() && areTriggerSettingsValid();
