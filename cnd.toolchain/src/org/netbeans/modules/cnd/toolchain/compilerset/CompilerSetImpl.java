...
public final class CompilerSetImpl extends CompilerSet {
    ...
    public CompilerSetImpl createCopy() {
        return createCopy(this.flavor, getDirectory(), name, isAutoGenerated(), charset);
    }
     ...
     * @return
     */
    public CompilerSetImpl createCopy(CompilerFlavor flavor, String directory, String name, Boolean autoGenerated, Charset charset) {
