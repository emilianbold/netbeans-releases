...
public interface CompilerSet {
    ...
    String getDynamicLibrarySearchOption();

    String getLibraryOption();

    String getLibrarySearchOption();

    String getName();

    String getQmakeSpec(int platform);
