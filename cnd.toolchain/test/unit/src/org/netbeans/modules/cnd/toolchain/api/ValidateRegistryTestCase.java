...
public class ValidateRegistryTestCase extends NbTestCase {
    ...
    private void parse(final FileObject file) throws Exception {
        ...
        Schema schema = schemaFactory.newSchema(new StreamSource(ValidateRegistryTestCase.class.getResourceAsStream("/org/netbeans/modules/cnd/toolchain/api/toolchaindefinition.xsd")));
