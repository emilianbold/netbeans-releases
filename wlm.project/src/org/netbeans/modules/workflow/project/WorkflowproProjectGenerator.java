 ...
 * @author Pavel Buzek
 */
public class WorkflowproProjectGenerator {
    ...
    private WorkflowproProjectGenerator() {
    }
    ...
    private static void createCatalogXml(FileObject project) {
        try {
            FileObject resource = Repository.getDefault().getDefaultFileSystem().findResource("wlm-project-resources/catalog.xml");
    ...
    private static AntProjectHelper setupProject(FileObject dirFO, String name, String j2eeLevel) throws IOException {
        AntProjectHelper h = ProjectGenerator.createProject(dirFO, WorkflowproProjectType.TYPE);
        Element data = h.getPrimaryConfigurationData(true);
        Document doc = data.getOwnerDocument();
        Element nameEl = doc.createElementNS(WorkflowproProjectType.PROJECT_CONFIGURATION_NAMESPACE, "name"); // NOI18N
        nameEl.appendChild(doc.createTextNode(name));
        data.appendChild(nameEl);
        Element minant = doc.createElementNS(WorkflowproProjectType.PROJECT_CONFIGURATION_NAMESPACE, "minimum-ant-version"); // NOI18N
...
//        
        ...
        ep.setProperty(PROJECT_NAME, name);
        ...
        //============= Start of IcanPro========================================//
        ep.setProperty(IcanproProjectProperties.JBI_SETYPE_PREFIX, "sun-wlm-engine"); // NOI18N
