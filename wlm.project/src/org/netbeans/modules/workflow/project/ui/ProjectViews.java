...
import org.netbeans.modules.workflow.project.ProjectConstants;
...
class ProjectViews {
    ...
    private static final class DocBaseNode extends FilterNode { 
        private static Image CONFIGURATION_FILES_BADGE = ImageUtilities
                .loadImage( "org/netbeans/modules/bpel/project/ui/resources/docjar.gif", true ); // NOI18N
