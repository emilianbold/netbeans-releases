...
public class InstanceCreater {
    ...
    private InstanceCreater(boolean soapEnc) {
        _soapEnc = soapEnc;
    }
    ...
    public static String createSampleForType(SchemaType sType) {
        ...
        new InstanceCreater(false).createSampleForType(sType, cursor);
    ...
    public static String createSampleForElement( SchemaGlobalElement element )
    {
        ...
        new InstanceCreater (false).createSampleForType(element.getType(), c );
