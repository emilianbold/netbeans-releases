 ...
 * @author  gpatil
 */
public class JAXBMarshalerPnl extends JPanel implements DocumentListener {
    ...
    public JAXBMarshalerPnl(Project project, JTextComponent doc) {
        this.prj = project;
        this.doc = doc;
        initComponents();
        custInit();
    ...
    private void initComponents() {
        ...
        jcMarshalTo = new javax.swing.JComboBox();
        lblValidation = new javax.swing.JLabel();

        setLayout(new java.awt.GridBagLayout());

        jlGenerateOTDCode.setText(org.openide.util.NbBundle.getMessage(JAXBMarshalerPnl.class, "LBL_GenJAXBMarshalCode")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jlOtdClass, org.openide.util.NbBundle.getMessage(JAXBMarshalerPnl.class, "LBL_JAXBClass")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jlMethodName, org.openide.util.NbBundle.getMessage(JAXBMarshalerPnl.class, "LBL_MethodName")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        txtMethodName.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(JAXBMarshalerPnl.class, "ASCD_MethodName")); // NOI18N
        ...
        txtClassName.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(JAXBMarshalerPnl.class, "ACSD_JAXBClass")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(btnFind, org.openide.util.NbBundle.getMessage(JAXBMarshalerPnl.class, "LBL_BTN_FindClass")); // NOI18N
        ...
        btnFind.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(JAXBMarshalerPnl.class, "ACSD_FindJAXBClass")); // NOI18N

        lblMarshalTo.setLabelFor(jcMarshalTo);
        org.openide.awt.Mnemonics.setLocalizedText(lblMarshalTo, org.openide.util.NbBundle.getMessage(JAXBMarshalerPnl.class, "LBL_MarshalTo")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jcMarshalTo.setModel(getMarshalToOptions());
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        gridBagConstraints.weightx = 0.5;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        add(jcMarshalTo, gridBagConstraints);
        jcMarshalTo.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(JAXBMarshalerPnl.class, "ACSD_MarshalTo")); // NOI18N
    ...
    private javax.swing.JComboBox jcMarshalTo;
    ...
    private void custInit(){
        ...
        this.jcMarshalTo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                String methName = JavaSourceUtil.recommendMethodName(methodNames,
                jcMarshalTo.getSelectedItem().toString(), true, true);
    ...
    private ComboBoxModel getMarshalToOptions(){
        ...
        otdClasses.add("OutputStream");//NOI18N
        otdClasses.add("Writer");//NOI18N
    ...
    public Map<String, Object> getData(){
        ...
        data.put(OTDImportConstants.MAP_KEY_MARSHAL_UNMARSHAL_TYPE, this.jcMarshalTo.getSelectedItem().toString());
        return data;
    }
