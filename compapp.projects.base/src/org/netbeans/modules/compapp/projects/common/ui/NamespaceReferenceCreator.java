...
/**
 * Base class for external reference creators. 
 * 
...
public abstract class NamespaceReferenceCreator<T extends Component>
     ...
     */
    public NamespaceReferenceCreator(T component, Model model) {
        super(component);
    ...
    public void applyChanges() throws IOException {
        // NOOP. This will not update the catalog as 
        // ImplicitCatalogSupport will update both catalog.xml and catalog.wsdl.
    }
    ...
    public ExternalReferenceDataNode createExternalReferenceNode(Node original) {
        ...
        //CHIK
        ExternalReferenceDataNode erdn = new ImplicitReferenceDataNode(
    ...
    private void validateInput(ExternalReferenceNode node) {
        ...
        if (mustNamespaceDiffer() && node instanceof ExternalReferenceDataNode) {
            ...
            if (ep.length() == 0 || prefixMap.containsKey(ep) ||
                ...
                msg = NbBundle.getMessage(NamespaceReferenceCreator.class,
    ...
    protected Node createRootNode() {
        ...
        byFilesNode.setDisplayName(NbBundle.getMessage(
                NamespaceReferenceCreator.class,
                "LBL_ExternalReferenceCreator_Category_By_File"));

        // Construct the By Namespace node.
        Children nsChildren = new ImplicitNamespaceChildren(roots, decorator); ////CHIK
...
//        categories.add(new Node[]{ byFilesNode, byNsNode, retrievedNode });
        ...
        rootNode.setDisplayName(NbBundle.getMessage(NamespaceReferenceCreator.class,
                "CTL_ExternalReferenceCreator_Column_Name_name"));
        rootNode.setShortDescription(NbBundle.getMessage(NamespaceReferenceCreator.class,
...
//    }
    ...
    protected String getLocation(Node node) {
        //NOTE: since cross-project location for the catalog entry is calculated
        // during addtion of this namespace to catalog.wsdl, we need not worry 
        // about gettting the relative location. 
        
        // just return the default file location uri.
        String location="";
        
        return location;
        
    }
////    //TODO: if the location needed, it should be calculated using Implicit
////    // catalog support implementation.        
////    /**
////     * Get the URI location for the given node.
////     *
////     * @param  node  Node from which to retrieve location value.
...
////    }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(locationLabel, org.openide.util.NbBundle.getBundle(NamespaceReferenceCreator.class).getString("LBL_ExternalReferenceCreator_Location")); // NOI18N
        locationLabel.setToolTipText(org.openide.util.NbBundle.getBundle(NamespaceReferenceCreator.class).getString("TIP_ExternalReferenceCreator_Location")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(namespaceLabel, org.openide.util.NbBundle.getBundle(NamespaceReferenceCreator.class).getString("LBL_ExternalReferenceCreator_Namespace")); // NOI18N
        namespaceLabel.setToolTipText(org.openide.util.NbBundle.getBundle(NamespaceReferenceCreator.class).getString("TIP_ExternalReferenceCreator_Namespace")); // NOI18N
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                        ...
                        .add(namespaceTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 319, Short.MAX_VALUE))
                    .add(locationLabel)
