...
/**
 * This class represents the nodes in the treeview of the wsdl or xsd files in 
 ...
 * @author chikkala
 */
public class ImplicitReferenceDataNode extends ExternalReferenceDataNode {

    public ImplicitReferenceDataNode(Node original, ExternalReferenceDecorator decorator) {
        super(original, decorator); 
        this.setChildren(new Children(original, decorator));
    }
    ...
    private static class Children extends FilterNode.Children {
        ...
        protected Node[] createNodes(Node n) {
            ...
            if (dobj != null) {
                ...
                if ( docType == null ) {
                    // return xsd or wsdl node
                    String wsdlExt = DocumentTypesEnum.wsdl.toString();
                    String xsdExt = DocumentTypesEnum.schema.toString();
                    if (fobj.isFolder() || cookie != null && 
                            (fname.endsWith(xsdExt) || fname.endsWith(wsdlExt)) ) {
                        return super.createNodes(n);
                    }                    
                } else {
                    String ext = docType.toString();
