 ...
 *
 */
public class ScopedProxyabilityAnalyzer extends AbstractScopedAnalyzer 
        ...
        if ( modifiers.contains( Modifier.FINAL) ){
            ErrorDescription description = CdiEditorAnalysisFactory.
                createError( element, compInfo, 
                    NbBundle.getMessage(ScopedProxyabilityAnalyzer.class, 
            ...
            if (modifiers.contains(Modifier.FINAL)) {
                ErrorDescription description = CdiEditorAnalysisFactory
                        .createNotification( Severity.WARNING, method, compInfo, 
                                NbBundle.getMessage(
                                ScopedProxyabilityAnalyzer.class,
