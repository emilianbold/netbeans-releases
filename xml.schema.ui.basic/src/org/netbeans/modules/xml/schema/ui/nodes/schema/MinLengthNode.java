 ...
 */
public class MinLengthNode extends SchemaComponentNode<MinLength>
{
    /**
     *
     *
     */
    public MinLengthNode(SchemaUIContext context, 
	...
	{
		return NbBundle.getMessage(MinLengthNode.class,
			"LBL_MinLengthNode_TypeDisplayName"); // NOI18N
	}
    ...
    protected Sheet createSheet() 
    {
        ...
        try {
            ...
            Property fixedProp = new BooleanProperty(
                    ...
                    MinLength.FIXED_PROPERTY, // property name
                    NbBundle.getMessage(MinLengthNode.class,"PROP_Facet_Fixed_DisplayName"), // display name
                    NbBundle.getMessage(MinLengthNode.class,"PROP_Facet_Fixed_ShortDescription"),	// descr
            ...
            Property valueProp = new NonNegativeIntegerProperty.Primitive(
                    getReference().get(), // schema component
                    MinLength.VALUE_PROPERTY,
                    NbBundle.getMessage(MinLengthNode.class,"PROP_Facet_Value_DisplayName"), // display name
                    NbBundle.getMessage(MinLengthNode.class,"PROP_Facet_Value_ShortDescription")	// descr
                    );
