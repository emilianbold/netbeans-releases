...
public class ComplexExtensionNode extends SchemaComponentNode<ComplexExtension>
{
     ...
     *
     */
    public ComplexExtensionNode(SchemaUIContext context, 
	...
	{
		return NbBundle.getMessage(ComplexExtensionNode.class,
			"LBL_ComplexExtensionNode_TypeDisplayName"); // NOI18N
	}
    ...
    protected Sheet createSheet() {
        ...
        try {
            ...
            Node.Property baseTypeProp = new GlobalReferenceProperty<GlobalType>(
                    getReference().get(),
                    ComplexExtension.BASE_PROPERTY,
                    NbBundle.getMessage(ComplexExtensionNode.class,
