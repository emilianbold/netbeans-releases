 ...
 */
final class PowerupCommand implements Command {

    public String execute(ShellPanel shellPanel, String[] args) throws ShellException {
        try {
            APDUSender.getSender(shellPanel).powerup();
        } catch (IOException ex) {
            Logger.getLogger(PowerupCommand.class.getPackage().getName()).log(Level.FINER, null, ex);
    ...
    public String usage() {
        return APDUSender.getString("USAGE_POWERUP"); //NOI18N
    }
}
