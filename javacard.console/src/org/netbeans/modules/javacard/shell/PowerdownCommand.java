...
final class PowerdownCommand implements Command {
    ...
    public String execute(ShellPanel shellPanel, String[] args) throws ShellException {
        try {
            APDUSender.getSender(shellPanel).powerdown();
        } catch (IOException ex) {
            Logger.getLogger(PowerdownCommand.class.getPackage().getName()).log(Level.FINER, null, ex);
    ...
    public String usage() {
        return APDUSender.getString("USAGE_POWERDOWN"); //NOI18N
    }
}
