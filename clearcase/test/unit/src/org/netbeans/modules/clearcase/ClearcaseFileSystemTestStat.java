 ...
 */
public class ClearcaseFileSystemTestStat extends ClearcaseFileSystemTest {

    public ClearcaseFileSystemTestStat(Test test) {
        super(test);
    }
    ...
    public static Test suite() {
        ...
        return new ClearcaseFileSystemTestStat(suite);
    }
}
