 ...
 * @author rmatous
 */
public class CleacaseFileSystemTest extends FileSystemFactoryHid {
    ...
    public CleacaseFileSystemTest(Test test) {
        super(test);
    }
    ...
    public static Test suite() {
        ...
        return new CleacaseFileSystemTest(suite);
    }
    ...
    protected FileSystem[] createFileSystem(String testName, String[] resources) throws IOException {
        System.out.println(" ++++ createFileSystem start " + System.currentTimeMillis());
        ...
        System.out.println(" ++++ createFileSystem   end" + System.currentTimeMillis());
