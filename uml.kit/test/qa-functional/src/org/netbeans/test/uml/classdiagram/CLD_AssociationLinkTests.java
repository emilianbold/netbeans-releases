...
/*
 * CLD_AssociationLinkTests.java
 *
 * Created on May 13, 2005, 3:53 PM
 *
 ...
 */
public class CLD_AssociationLinkTests extends ClassDiagramTestCase {
    
    private static String prName = "UMLProjectForAssociationLink";
    private static String dpdName = "ClassDiagramForAssociationLink";
    ...
    public CLD_AssociationLinkTests(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.classdiagram.CLD_AssociationLinkTests.class);
        return suite;
    }
    ...
    public static void main(java.lang.String[] args) {
        ...
        junit.textui.TestRunner.run(new org.netbeans.test.uml.classdiagram.CLD_AssociationLinkTests("testCopyAndPasteClassElement"));
    }
...
//------------------------------------------------------------------------------    
    ...
    public void testSelectAllByPopup() throws NotFoundException {
        boolean result = verifier.checkSelectAllByPopup(ElementTypes.CLASS, ElementTypes.NODE, LinkTypes.ASSOCIATION);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
    ...
    public void testInvertSelection() throws NotFoundException {
        boolean result = verifier.checkInvertSelection(ElementTypes.CLASS, ElementTypes.ARTIFACT, LinkTypes.ASSOCIATION);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
    ...
    public void testRedirectSourceElement2() throws NotFoundException {
        boolean result = verifier.checkRedirectSourceElement(ElementTypes.NODE, ElementTypes.INTERFACE, ElementTypes.ARTIFACT);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
    ...
    public void testRedirectSourceElement4() throws NotFoundException {
        boolean result = verifier.checkRedirectSourceElement(ElementTypes.INTERFACE, ElementTypes.ARTIFACT, ElementTypes.NODE);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
    ...
    public void testRedirectTargetElement2() throws NotFoundException {
        boolean result = verifier.checkRedirectTargetElement(ElementTypes.NODE, ElementTypes.CLASS, ElementTypes.NODE);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
    ...
    public void testRedirectTargetElement3() throws NotFoundException {
        boolean result = verifier.checkRedirectTargetElement(ElementTypes.ARTIFACT, ElementTypes.CLASS, ElementTypes.ARTIFACT);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
    ...
    public void testRedirectTargetElement4() throws NotFoundException {
        boolean result = verifier.checkRedirectTargetElement(ElementTypes.INTERFACE, ElementTypes.INTERFACE, ElementTypes.NODE);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new LinkVerifier(diagram, LinkTypes.ASSOCIATION, "CLD_", getLog());
    }
