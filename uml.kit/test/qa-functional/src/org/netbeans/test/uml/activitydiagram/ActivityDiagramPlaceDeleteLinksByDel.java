 ...
 */
public class ActivityDiagramPlaceDeleteLinksByDel extends UMLTestCase {
    ...
    private static String prName= "ActivityDiagramProjectPDLD";
    ...
    public ActivityDiagramPlaceDeleteLinksByDel(String name) {
        super(name);
    }
     public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.activitydiagram.ActivityDiagramPlaceDeleteLinksByDel.class);
        return suite;
    }
  ...
  public void testDeleteLinkByKey2() {
        lastTestCase=getCurrentTestMethodName();
