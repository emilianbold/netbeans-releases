...
public class SQDASyncMessagePropertiesTests extends UMLTestCase {
    
    
    public SQDASyncMessagePropertiesTests(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(SQDASyncMessagePropertiesTests.class);
        return suite;
    }
    
    
    /******************const section*************************/
    private String PROJECT_NAME = "SQD_umlASMPT";
    ...
    protected void setUp() {
        ...
        if (!initialized){
                ...
                message = dia.createLinkOnDiagram(LinkTypes.ASYNC_MESSAGE,  line1, line2);
    ...
    public void testCheckNameAndAlias(){
        ...
        boolean editable = true;
            ...
            //
            propertyName = "Alias";
            oldValue = "NewVal"; //???value for alias isn't changed until focus move from properties
    ...
    public void testCheckMessageKind(){
        ...
        String oldValue = "asynchronous";
        final String newValue = "asynchronous";
        String renderer = PropertyVerifier.STRING_RENDERER;
        boolean editable = false;
