 ...
 */
public class ActivityDiagramNameElements extends UMLTestCase {
    ...
    private static String prName= "ActivityDiagramProjectNE";
    ...
    public ActivityDiagramNameElements(String name) {
        super(name);
    }
     public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.activitydiagram.ActivityDiagramNameElements.class);
        return suite;
    }
   ...
   private void testElementPlace(String workPkg,String diagramName,String element,String elementName,ElementTypes elementType)
   {
       ...
       //
        ...
        org.netbeans.test.uml.activitydiagram.utils.Utils.setTextProperty("Name","ELName");
        //
        new EventTool().waitNoEvent(500);
        //
        try
        {
            DiagramElementOperator dEl=new DiagramElementOperator(d,"ELName",elementType,0);
        }
        catch(Exception ex)
        {
             fail("Can't find "+element+" with name \"ELName\" on diagram");
        }
        //
        assertTrue("No name propagated to node within diagram",lastDiagramNode.isChildPresent("ELName"));
   }
