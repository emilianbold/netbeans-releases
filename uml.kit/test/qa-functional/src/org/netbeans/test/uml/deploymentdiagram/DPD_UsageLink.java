...
public class DPD_UsageLink extends UMLTestCase {
    ...
    private static String prName = "UMLProjectDPD12";
    ...
    public DPD_UsageLink(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.deploymentdiagram.DPD_UsageLink.class);
        return suite;
    }
...
/**
 * @caseblock Usage link
 * @usecase Invert selection of a Usage link
 */
...
/**
 * @caseblock Usage link
 * @usecase Find target element of a Usage link
 */
 ...
 */
    public void testRedirectSourceElement1() throws NotFoundException {
        boolean result = verifier.checkRedirectSourceElement(ElementTypes.COMPONENT, ElementTypes.COMPONENT, ElementTypes.INTERFACE);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testRedirectSourceElement5() throws NotFoundException {
        boolean result = verifier.checkRedirectSourceElement(ElementTypes.PACKAGE, ElementTypes.PACKAGE, ElementTypes.DEPLOYMENT_SPECIFICATION);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testRedirectSourceElement6() throws NotFoundException {
        boolean result = verifier.checkRedirectSourceElement(ElementTypes.DEPLOYMENT_SPECIFICATION, ElementTypes.DEPLOYMENT_SPECIFICATION, ElementTypes.COMPONENT);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testRedirectSourceElement7() throws NotFoundException {
        boolean result = verifier.checkRedirectSourceElement(ElementTypes.COMPONENT, ElementTypes.ARTIFACT, ElementTypes.INTERFACE);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testRedirectSourceElement9() throws NotFoundException {
        boolean result = verifier.checkRedirectSourceElement(ElementTypes.ARTIFACT, ElementTypes.PACKAGE, ElementTypes.COMPONENT);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testRedirectTargetElement1() throws NotFoundException {
        boolean result = verifier.checkRedirectTargetElement(ElementTypes.COMPONENT, ElementTypes.INTERFACE, ElementTypes.NODE);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testRedirectTargetElement2() throws NotFoundException {
        boolean result = verifier.checkRedirectTargetElement(ElementTypes.NODE, ElementTypes.PACKAGE, ElementTypes.DEPLOYMENT_SPECIFICATION);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testRedirectTargetElement3() throws NotFoundException {
        boolean result = verifier.checkRedirectTargetElement(ElementTypes.INTERFACE, ElementTypes.PACKAGE, ElementTypes.DEPLOYMENT_SPECIFICATION);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testRedirectTargetElement4() throws NotFoundException {
        boolean result = verifier.checkRedirectTargetElement(ElementTypes.ARTIFACT, ElementTypes.COMPONENT, ElementTypes.DEPLOYMENT_SPECIFICATION);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testRedirectTargetElement5() throws NotFoundException {
        boolean result = verifier.checkRedirectTargetElement(ElementTypes.NODE, ElementTypes.COMPONENT, ElementTypes.INTERFACE);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testRedirectTargetElement6() throws NotFoundException {
        boolean result = verifier.checkRedirectTargetElement(ElementTypes.PACKAGE, ElementTypes.COMPONENT, ElementTypes.INTERFACE);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testRedirectTargetElement7() throws NotFoundException {
        boolean result = verifier.checkRedirectTargetElement(ElementTypes.PACKAGE, ElementTypes.ARTIFACT, ElementTypes.DEPLOYMENT_SPECIFICATION);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testRedirectTargetElement8() throws NotFoundException {
        boolean result = verifier.checkRedirectTargetElement(ElementTypes.DEPLOYMENT_SPECIFICATION, ElementTypes.COMPONENT, ElementTypes.INTERFACE);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testRedirectTargetElement9() throws NotFoundException {
        boolean result = verifier.checkRedirectTargetElement(ElementTypes.DEPLOYMENT_SPECIFICATION, ElementTypes.ARTIFACT, ElementTypes.NODE);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new LinkVerifier(diagram, LinkTypes.USAGE, "", getLog());
    }
