...
public class SQDSyncMessagePropertiesTests extends UMLTestCase {
    
    
    public SQDSyncMessagePropertiesTests(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(SQDSyncMessagePropertiesTests.class);
        return suite;
    }
    
    
    /******************const section*************************/
    private String PROJECT_NAME = "SQD_umlSMPT";
    ...
    protected void setUp() {
        ...
        if (!initialized){
                ...
                message = dia.createLinkOnDiagram(LinkTypes.SYNC_MESSAGE,  line1, line2);
    ...
    public void testCheckNameAndAlias(){
        ...
        boolean editable = true;
            ...
            SequenceDiagramOperator sd=new SequenceDiagramOperator(DIAGRAM);
            sd.makeComponentVisible();
            sd.clickMouse(10,40,1);
    ...
    public void testCheckMessageKind(){
        ...
        String oldValue = "synchronous";
        final String newValue = "synchronous";
        String renderer = PropertyVerifier.STRING_RENDERER;
        boolean editable = false;
