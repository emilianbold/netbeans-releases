...
public class CreateStateDiagramTests extends UMLTestCase {
    
    private EventTool eventTool = new EventTool();
    
    public CreateStateDiagramTests(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(CreateStateDiagramTests.class);
        return suite;
    }
    
    
    /******************const section*************************/
    private String PROJECT_NAME = "CDFS_uml_State";
    ...
    public void testCreateStateDiagramFromClass(){
        ...
        if (!util.diagramHasExactElements(new DiagramElementOperator[]{comp}, dia)){
            fail("testCreateStateDiagramFromClass verification failed");
        }
    ...
    public void testCreateStateDiagramFromManyClasses(){
        ...
        util.createDiagram(nodes, NewDiagramWizardOperator.STATE_DIAGRAM, DIA_NAME);
        ...
        if (!util.diagramHasExactElements(classNames, dia)){
            fail("testCreateStateDiagramFromManyClasses verification failed");
        }
    ...
    public void testCreateStateDiagramFromOperation(){
        ...
        if (wizard.isDiagramAllowed(NewDiagramWizardOperator.STATE_DIAGRAM)){
            fail("testCreateStateDiagramFromOperation verification failed ");
        }
