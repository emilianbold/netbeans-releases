...
public class CreateDeploymentDiagramTests extends UMLTestCase {
    
    private EventTool eventTool = new EventTool();
    
    public CreateDeploymentDiagramTests(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(CreateDeploymentDiagramTests.class);
        return suite;
    }
    
    
    /******************const section*************************/
    private String PROJECT_NAME = "CDFS_uml_Depl";
    ...
    public void testCreateDeploymentDiagramFromClass(){
        ...
        if (!util.diagramHasExactElements(new DiagramElementOperator[]{comp}, dia)){
            fail("testCreateDeploymentDiagramFromClass verification failed");
        }
    ...
    public void testCreateDeploymentDiagramFromManyClasses(){
        ...
        util.createDiagram(nodes, NewDiagramWizardOperator.DEPLOYMENT_DIAGRAM, DIA_NAME);
        ...
        if (!util.diagramHasExactElements(classNames, dia)){
            fail("testCreateDeploymentDiagramFromManyClasses verification failed");
        }
    ...
    public void testCreateDeploymentDiagramFromOperation(){
        final String PATH_TO_OPERATION = "Model|cdfs|Customer|Operations|process";
        final String DIA_NAME = "DGOPDD";
        util = new CDFSUtil(PROJECT_NAME, this);
        ...
        if (wizard.isDiagramAllowed(NewDiagramWizardOperator.DEPLOYMENT_DIAGRAM)){
            fail("testCreateDeploymentDiagramFromOperation verification failed ");
        }
