 ...
 */
public class TestToolTipsPI extends UMLTestCase {
    
    private static String prName= "EditControlToolTipsPlInd";
    ...
    private static String defaultAttributeVisibility=org.netbeans.test.uml.editcontrol.utils.Utils.defaultAttributeVisibilityPI;
    ...
    private static String tooltip1="<html>visibility &lt;&lt; stereotype, ... &gt;&gt; derived<b> name</b> : type[multiplicity] = initialValue {properties, ...}</html>"; 
    //--
    ...
    private static String atStr2=attributeVisibility2+" "+attributeName2+" : "+attributeType2+" = "+attributeDefValue2;
    private static String tooltip2="<html><b>visibility</b> &lt;&lt; stereotype, ... &gt;&gt; derived name : type[multiplicity] = initialValue {properties, ...}</html>"; 
    //--
    ...
    private static String atStr3=attributeVisibility3+" "+attributeName3+" : "+attributeType3+" = "+attributeDefValue3;
    private static String tooltip3="<html><b>visibility</b> &lt;&lt; stereotype, ... &gt;&gt; derived name : type[multiplicity] = initialValue {properties, ...}</html>"; 
    //--
    ...
    private static String atStr4=attributeVisibility4+" "+attributeName4+" : "+attributeType4+"["+attributeMultiplicities4+"]";
    private static String tooltip4="<html>visibility &lt;&lt; stereotype, ... &gt;&gt; derived name<b> : type</b>[multiplicity] = initialValue {properties, ...}</html>"; 
//--
    ...
    private static String atStr5=attributeVisibility5+" "+attributeName5+" : "+attributeType5+" = "+attributeDefValue5;
    private static String tooltip5="<html>visibility &lt;&lt; stereotype, ... &gt;&gt; derived name : type[multiplicity]<b> = initialValue</b> {properties, ...}</html>"; 
    //--
    ...
    private static String atStr6=attributeVisibility6+" "+attributeName6+" : "+attributeType6+" = "+attributeDefValue6;
    private static String tooltip6="<html>visibility &lt;&lt; stereotype, ... &gt;&gt; derived name : type[multiplicity] = initialValue {<b>name</b>=value}</html>"; 
    //--
    ...
    private static String atStr7=attributeVisibility7+" "+attributeName7+" : "+attributeType7+" = "+attributeDefValue7;
    private static String tooltip7="<html>visibility &lt;&lt; stereotype, ... &gt;&gt; derived name : type[multiplicity] = initialValue {name<b>=value</b>}</html>"; 
    //--
    ...
    private static String atStr8=attributeVisibility8+" "+attributeName8+" : "+attributeType8+" = "+attributeDefValue8;
    private static String tooltip8="<html>visibility &lt;&lt; stereotype, ... &gt;&gt; derived name : type[multiplicity]<b> = initialValue</b> {properties, ...}</html>"; 
    //--
    ...
    private static String opStr9=operationVisibility9+" "+operationName9+"( "+parameterName9+" : "+parameterType9+" )"+" : "+operationRetType9;
    private static String tooltip9="<html>visibility &lt;&lt; stereotype, ... &gt;&gt;<b> name</b>( parameter ) : returnType {properties, ...}</html>"; 
    //--
    ...
    private static String opStr10=operationVisibility10+" "+operationName10+"( "+parameterName10+" : "+parameterType10+" )"+" : "+operationRetType10;
    private static String tooltip10="<html><b>visibility</b> &lt;&lt; stereotype, ... &gt;&gt; name( parameter, ... ) : returnType {properties, ...}</html>"; 
    //--
    ...
    private static String opStr11=operationVisibility11+" "+operationName11+"( "+parameterName11+" : "+parameterType11+" )"+" : "+operationRetType11;
    private static String tooltip11="<html>visibility &lt;&lt; stereotype, ... &gt;&gt;<b> name</b>( parameter, ... ) : returnType {properties, ...}</html>"; 
    //--
    ...
    private static String opStr12=operationVisibility12+" "+operationName12+"( "+parameterName12+" : "+parameterType12+" )"+" : "+operationRetType12;
    private static String tooltip12="<html>visibility &lt;&lt; stereotype, ... &gt;&gt;<b> name</b>( parameter ) : returnType {properties, ...}</html>"; 
    //--
    ...
    private static String opStr13=operationVisibility13+" "+operationName13+"( "+parameterName13+" "+parameterType13+" )"+" : "+operationRetType13;
    private static String tooltip13="<html>visibility &lt;&lt; stereotype, ... &gt;&gt; name( <b>name</b> : type[ multiplicity] = defaultValue ) : returnType {properties, ...}</html>"; 
    //--
    ...
    private static String opStr14=operationVisibility14+" "+operationName14+"( "+parameterName14+" : "+parameterType14+" )"+" : "+operationRetType14;
    private static String tooltip14="<html><b>visibility</b> &lt;&lt; stereotype, ... &gt;&gt; name( parameter, ... ) : returnType {properties, ...}</html>"; 
    //--
    ...
    private static String opStr15=operationVisibility15+" "+operationName15+"( "+parameterName15+" : "+parameterType15+" )"+" : "+operationRetType15;
    private static String tooltip15="<html>visibility &lt;&lt; stereotype, ... &gt;&gt;<b> name</b>( parameter ) : returnType {properties, ...}</html>"; 

    
    
    /** Need to be defined because of JUnit */
    public TestToolTipsPI(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.editcontrol.TestToolTipsPI.class);
        return suite;
    }
    ...
    public void testAttributeTooltip() {
        ...
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(attributeVisibility1,attributeType1,attributeName1,attributeDefValue1);
        //
        ...
        //
        assertFalse(78657,"Tooltip "+new JMenuItemOperator(tt).getText()+" isn't correct, should be "+tooltip1,new JMenuItemOperator(tt).getText().indexOf("PSK_TT")>-1);
        assertTrue("Tooltip isn't correct: "+new JMenuItemOperator(tt).getText(),tooltip1.equals(new JMenuItemOperator(tt).getText()));
    ...
    public void testAttributeVisibilityTooltip() {
        ...
        atComp.getPopup().pushMenu(PopupConstants.INSERT_ATTRIBUTE);
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(attributeVisibility2,attributeType2,attributeName2,attributeDefValue2);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        JPopupMenuOperator tt=new JPopupMenuOperator();
        //
        assertFalse(78657,"Tooltip "+new JMenuItemOperator(tt).getText()+" isn't correct, should be "+tooltip2,new JMenuItemOperator(tt).getText().indexOf("PSK_TT")>-1);
        assertTrue("Tooltip isn't correct: "+new JMenuItemOperator(tt).getText(),tooltip2.equals(new JMenuItemOperator(tt).getText()));
        int dx=Math.abs(attrCmp.getCenterPoint().x-tt.getCenterX());
        int dy=Math.abs(attrCmp.getCenterPoint().y-tt.getCenterY());
        assertTrue("Tooltip is located far from attribute compartment in compare to compartment width and height, (center_dx:"+dx+",center_dy:"+dy+ ")",dx>attrCmp.getRectangle().width || dy>attrCmp.getRectangle().height);
    }
    ...
    public void testAttributeTypeTooltip() {
        ...
        atComp.getPopup().pushMenu(PopupConstants.INSERT_ATTRIBUTE);
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(attributeVisibility3,attributeType3,attributeName3,attributeDefValue3);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        JPopupMenuOperator tt=new JPopupMenuOperator();
        //
        assertFalse(78657,"Tooltip "+new JMenuItemOperator(tt).getText()+" isn't correct, should be "+tooltip3,new JMenuItemOperator(tt).getText().indexOf("PSK_TT")>-1);
        assertTrue("Tooltip isn't correct: "+new JMenuItemOperator(tt).getText(),tooltip3.equals(new JMenuItemOperator(tt).getText()));
        int dx=Math.abs(attrCmp.getCenterPoint().x-tt.getCenterX());
        int dy=Math.abs(attrCmp.getCenterPoint().y-tt.getCenterY());
        assertTrue("Tooltip is located far from attribute compartment in compare to compartment width and height, (center_dx:"+dx+",center_dy:"+dy+ ")",dx>attrCmp.getRectangle().width || dy>attrCmp.getRectangle().height);
    }
    ...
    public void testAttributeMultiplicityTooltip() {
        ...
        atComp.getPopup().pushMenu(PopupConstants.INSERT_ATTRIBUTE);
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(attributeVisibility4,attributeType4,attributeName4+"["+attributeMultiplicities4+"]",attributeDefValue4);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        JPopupMenuOperator tt=new JPopupMenuOperator();
        //
        assertFalse(78657,"Tooltip "+new JMenuItemOperator(tt).getText()+" isn't correct, should be "+tooltip4,new JMenuItemOperator(tt).getText().indexOf("PSK_TT")>-1);
        assertTrue("Tooltip isn't correct: "+new JMenuItemOperator(tt).getText(),tooltip4.equals(new JMenuItemOperator(tt).getText()));
        int dx=Math.abs(attrCmp.getCenterPoint().x-tt.getCenterX());
        int dy=Math.abs(attrCmp.getCenterPoint().y-tt.getCenterY());
        assertTrue("Tooltip is located far from attribute compartment in compare to compartment width and height, (center_dx:"+dx+",center_dy:"+dy+ ")",dx>attrCmp.getRectangle().width || dy>attrCmp.getRectangle().height);
    }
    ...
    public void testAttributeInitialValueTooltip() {
        ...
        atComp.getPopup().pushMenu(PopupConstants.INSERT_ATTRIBUTE);
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(attributeVisibility5,attributeType5,attributeName5,attributeDefValue5);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        JPopupMenuOperator tt=new JPopupMenuOperator();
        //
        assertFalse(78657,"Tooltip "+new JMenuItemOperator(tt).getText()+" isn't correct, should be "+tooltip5,new JMenuItemOperator(tt).getText().indexOf("PSK_TT")>-1);
        assertTrue("Tooltip isn't correct: "+new JMenuItemOperator(tt).getText(),tooltip5.equals(new JMenuItemOperator(tt).getText()));
        int dx=Math.abs(attrCmp.getCenterPoint().x-tt.getCenterX());
        int dy=Math.abs(attrCmp.getCenterPoint().y-tt.getCenterY());
        assertTrue("Tooltip is located far from attribute compartment in compare to compartment width and height, (center_dx:"+dx+",center_dy:"+dy+ ")",dx>attrCmp.getRectangle().width || dy>attrCmp.getRectangle().height);
    }
    ...
    public void testAttributePropertyNameTooltip() {
        ...
        atComp.getPopup().pushMenu(PopupConstants.INSERT_ATTRIBUTE);
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(attributeVisibility6,attributeType6,attributeName6,attributeDefValue6);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        JPopupMenuOperator tt=new JPopupMenuOperator();
        //
        assertFalse(78657,"Tooltip "+new JMenuItemOperator(tt).getText()+" isn't correct, should be "+tooltip6,new JMenuItemOperator(tt).getText().indexOf("PSK_TT")>-1);
        assertTrue("Tooltip isn't correct: "+new JMenuItemOperator(tt).getText(),tooltip6.equals(new JMenuItemOperator(tt).getText()));
        int dx=Math.abs(attrCmp.getCenterPoint().x-tt.getCenterX());
        int dy=Math.abs(attrCmp.getCenterPoint().y-tt.getCenterY());
        assertTrue("Tooltip is located far from attribute compartment in compare to compartment width and height, (center_dx:"+dx+",center_dy:"+dy+ ")",dx>attrCmp.getRectangle().width || dy>attrCmp.getRectangle().height);
    }
    ...
    public void testAttributePropertyValueTooltip() {
        ...
        atComp.getPopup().pushMenu(PopupConstants.INSERT_ATTRIBUTE);
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(attributeVisibility7,attributeType7,attributeName7,attributeDefValue7);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        JPopupMenuOperator tt=new JPopupMenuOperator();
        //
        assertFalse(78657,"Tooltip "+new JMenuItemOperator(tt).getText()+" isn't correct, should be "+tooltip7,new JMenuItemOperator(tt).getText().indexOf("PSK_TT")>-1);
        assertTrue("Tooltip isn't correct: "+new JMenuItemOperator(tt).getText(),tooltip7.equals(new JMenuItemOperator(tt).getText()));
        int dx=Math.abs(attrCmp.getCenterPoint().x-tt.getCenterX());
        int dy=Math.abs(attrCmp.getCenterPoint().y-tt.getCenterY());
        assertTrue("Tooltip is located far from attribute compartment in compare to compartment width and height, (center_dx:"+dx+",center_dy:"+dy+ ")",dx>attrCmp.getRectangle().width || dy>attrCmp.getRectangle().height);
    }
    ...
    public void testAttributeInitialValueBeforePropertyTooltip() {
        ...
        atComp.getPopup().pushMenu(PopupConstants.INSERT_ATTRIBUTE);
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(attributeVisibility8,attributeType8,attributeName8,attributeDefValue8);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        JPopupMenuOperator tt=new JPopupMenuOperator();
        //
        assertFalse(78657,"Tooltip "+new JMenuItemOperator(tt).getText()+" isn't correct, should be "+tooltip8,new JMenuItemOperator(tt).getText().indexOf("PSK_TT")>-1);
        assertTrue("Tooltip isn't correct: "+new JMenuItemOperator(tt).getText(),tooltip8.equals(new JMenuItemOperator(tt).getText()));
        int dx=Math.abs(attrCmp.getCenterPoint().x-tt.getCenterX());
        int dy=Math.abs(attrCmp.getCenterPoint().y-tt.getCenterY());
        assertTrue("Tooltip is located far from attribute compartment in compare to compartment width and height, (center_dx:"+dx+",center_dy:"+dy+ ")",dx>attrCmp.getRectangle().width || dy>attrCmp.getRectangle().height);
    }
    ...
    public void testOperationTooltip() {
        ...
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(operationVisibility9,operationRetType9,operationName9,parameterType9,parameterName9, true);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        JPopupMenuOperator tt=new JPopupMenuOperator();
        //
        assertFalse(78657,"Tooltip "+new JMenuItemOperator(tt).getText()+" isn't correct, should be "+tooltip9,new JMenuItemOperator(tt).getText().indexOf("PSK_TT")>-1);
        assertTrue("Tooltip isn't correct: "+new JMenuItemOperator(tt).getText(),tooltip9.equals(new JMenuItemOperator(tt).getText()));
    ...
    public void testOperationVisibilityTooltip() {
        ...
        opComp.getPopup().pushMenu(PopupConstants.INSERT_OPERATION);
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(operationVisibility10,operationRetType10,operationName10,parameterType10,parameterName10, true);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        assertFalse(78657,"Tooltip "+tooltip+" isn't correct, should be "+tooltip10+":::"+tooltip.length()+" vs "+tooltip10.length()+" vs "+tooltip.trim().length()+"|||"+tooltip.indexOf(tooltip10),new JMenuItemOperator(tt).getText().indexOf("PSK_TT")>-1);
        assertTrue("Tooltip isn't correct: "+new JMenuItemOperator(tt).getText(),tooltip10.equals(new JMenuItemOperator(tt).getText()));
         int dx=Math.abs(operCmp.getCenterPoint().x-tt.getCenterX());
        int dy=Math.abs(operCmp.getCenterPoint().y-tt.getCenterY());
        assertTrue("Tooltip is located far from attribute compartment in compare to compartment width and height, (center_dx:"+dx+",center_dy:"+dy+ ")",dx>operCmp.getRectangle().width || dy>operCmp.getRectangle().height);
   }
    ...
    public void testOperationNameTooltip() {
        ...
        opComp.getPopup().pushMenu(PopupConstants.INSERT_OPERATION);
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(operationVisibility11,operationRetType11,operationName11,parameterType11,parameterName11, true);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        String tooltip=new JMenuItemOperator(tt).getText();
        System.out.println(tooltip);
        assertFalse(78657,"Tooltip "+tooltip+" isn't correct, should be "+tooltip11+":::"+tooltip.length()+" vs "+tooltip11.length()+" vs "+tooltip.trim().length()+"|||"+tooltip.indexOf(tooltip11),new JMenuItemOperator(tt).getText().indexOf("PSK_TT")>-1);
        assertTrue("Tooltip isn't correct: "+new JMenuItemOperator(tt).getText(),tooltip11.equals(new JMenuItemOperator(tt).getText()));
        int dx=Math.abs(operCmp.getCenterPoint().x-tt.getCenterX());
        int dy=Math.abs(operCmp.getCenterPoint().y-tt.getCenterY());
        assertTrue("Tooltip is located far from attribute compartment in compare to compartment width and height, (center_dx:"+dx+",center_dy:"+dy+ ")",dx>operCmp.getRectangle().width || dy>operCmp.getRectangle().height);
   }
    ...
    public void testOperationParameterTypeTooltip() {
        ...
        opComp.getPopup().pushMenu(PopupConstants.INSERT_OPERATION);
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(operationVisibility12,operationRetType12,operationName12,parameterType12,parameterName12, true);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        String tooltip=new JMenuItemOperator(tt).getText();
        System.out.println(tooltip);
        assertFalse(78657,"Tooltip "+tooltip+" isn't correct, should be "+tooltip12+":::"+tooltip.length()+" vs "+tooltip12.length()+" vs "+tooltip.trim().length()+"|||"+tooltip.indexOf(tooltip12),new JMenuItemOperator(tt).getText().indexOf("PSK_TT")>-1);
        assertTrue("Tooltip isn't correct: "+new JMenuItemOperator(tt).getText(),tooltip12.equals(new JMenuItemOperator(tt).getText()));
        int dx=Math.abs(operCmp.getCenterPoint().x-tt.getCenterX());
        int dy=Math.abs(operCmp.getCenterPoint().y-tt.getCenterY());
        assertTrue("Tooltip is located far from attribute compartment in compare to compartment width and height, (center_dx:"+dx+",center_dy:"+dy+ ")",dx>operCmp.getRectangle().width || dy>operCmp.getRectangle().height);
   }
    ...
    public void testOperationParameterNameTooltip() {
        ...
        opComp.getPopup().pushMenu(PopupConstants.INSERT_OPERATION);
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(operationVisibility13,operationRetType13,operationName13,parameterType13,parameterName13, true);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        String tooltip=new JMenuItemOperator(tt).getText();
        System.out.println(tooltip);
        assertFalse(78657,"Tooltip "+tooltip+" isn't correct, should be "+tooltip13+":::"+tooltip.length()+" vs "+tooltip13.length()+" vs "+tooltip.trim().length()+"|||"+tooltip.indexOf(tooltip13),new JMenuItemOperator(tt).getText().indexOf("PSK_TT")>-1);
        assertTrue("Tooltip isn't correct: "+new JMenuItemOperator(tt).getText(),tooltip13.equals(new JMenuItemOperator(tt).getText()));
        int dx=Math.abs(operCmp.getCenterPoint().x-tt.getCenterX());
        int dy=Math.abs(operCmp.getCenterPoint().y-tt.getCenterY());
        assertTrue("Tooltip is located far from attribute compartment in compare to compartment width and height, (center_dx:"+dx+",center_dy:"+dy+ ")",dx>operCmp.getRectangle().width || dy>operCmp.getRectangle().height);
   }
    ...
    public void testOperationReturnTypeTooltip() {
        ...
        opComp.getPopup().pushMenu(PopupConstants.INSERT_OPERATION);
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(operationVisibility14,operationRetType14,operationName14,parameterType14,parameterName14, true);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        assertFalse(78657,"Tooltip "+tooltip+" isn't correct, should be "+tooltip14+":::"+tooltip.length()+" vs "+tooltip14.length()+" vs "+tooltip.trim().length()+"|||"+tooltip.indexOf(tooltip14),new JMenuItemOperator(tt).getText().indexOf("PSK_TT")>-1);
        assertTrue("Tooltip isn't correct: "+new JMenuItemOperator(tt).getText(),tooltip14.equals(new JMenuItemOperator(tt).getText()));
        int dx=Math.abs(operCmp.getCenterPoint().x-tt.getCenterX());
        int dy=Math.abs(operCmp.getCenterPoint().y-tt.getCenterY());
        assertTrue("Tooltip is located far from attribute compartment in compare to compartment width and height, (center_dx:"+dx+",center_dy:"+dy+ ")",dx>operCmp.getRectangle().width || dy>operCmp.getRectangle().height);
   }
    ...
    public void testSequenceDiagramTooltip() {
        ...
        JPopupMenuOperator tt=new JPopupMenuOperator();
        //
        assertFalse(78657,"Tooltip "+new JMenuItemOperator(tt).getText()+" isn't correct, should be "+tooltip15,new JMenuItemOperator(tt).getText().indexOf("PSK_TT")>-1);
        assertTrue("Tooltip isn't correct: "+new JMenuItemOperator(tt).getText(),tooltip15.equals(new JMenuItemOperator(tt).getText()));
    }
    ...
    public void setUp() {
        ...
        if(!codeSync)
        {
            org.netbeans.test.uml.editcontrol.utils.Utils.commonSetup(workdir, prName, org.netbeans.test.umllib.util.LabelsAndTitles.ANALYSIS_UML_PROJECT_LABEL);
            //
            codeSync=true;
        }
   }
