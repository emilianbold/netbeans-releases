...
public class DPD_Component extends UMLTestCase {
    ...
    public DPD_Component(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.deploymentdiagram.DPD_Component.class);
        return suite;
    }
...
/**
 * @caseblock Component Symbol
 * @usecase Lock edit of a Component
 */
 ...
 */
    public void testSelectAllSimilar() throws NotFoundException {
        boolean result = verifier.checkSelectAllSimilar(new ElementTypes[]{ElementTypes.INTERFACE, ElementTypes.COMPONENT});
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testHideChildrenOneLevel() throws NotFoundException {
        boolean result = verifier.checkHideChildrenOneLevel(2, 2, LinkTypes.DEPENDENCY, ElementTypes.COMPONENT);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testHideChildrenAllLevels() throws NotFoundException {
        boolean result = verifier.checkHideChildrenAllLevels(2, 2, LinkTypes.DEPENDENCY, ElementTypes.COMPONENT);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testHideParentsOneLevel() throws NotFoundException {
        boolean result = verifier.checkHideParentsOneLevel(2, 2, LinkTypes.DEPENDENCY, ElementTypes.COMPONENT);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testHideParentsAllLevels() throws NotFoundException {
        boolean result = verifier.checkHideParentsAllLevels(2, 2, LinkTypes.DEPENDENCY, ElementTypes.COMPONENT);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }   
 ...
 */
    public void testShowChildrenOneLevel() throws NotFoundException {
        boolean result = verifier.checkShowChildrenOneLevel(2, 2, LinkTypes.DEPENDENCY, ElementTypes.COMPONENT);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }   
 ...
 */
    public void testShowChildrenAllLevels() throws NotFoundException {
        boolean result = verifier.checkShowChildrenAllLevels(2, 2, LinkTypes.DEPENDENCY, ElementTypes.COMPONENT);
        if (!result){
 ...
 */
    public void testShowParentsOneLevel() throws NotFoundException {
        boolean result = verifier.checkShowParentsOneLevel(2, 2, LinkTypes.DEPENDENCY, ElementTypes.COMPONENT);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }   
 ...
 */
    public void testShowParentsAllLevels() throws NotFoundException {
        boolean result = verifier.checkShowParentsAllLevels(2, 2, LinkTypes.DEPENDENCY, ElementTypes.COMPONENT);
        if (!result){
            fail(78350, "Test failed. Details in log file.");
        }
    }   
...
/**
 * @caseblock Component Symbol
 * @usecase Background color of a Component
 */
...
/**
 * @caseblock Component Symbol
 * @usecase Text color of a Component
 */
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new DiagramElementVerifier(diagram, ElementTypes.COMPONENT, "", getLog());
    }
