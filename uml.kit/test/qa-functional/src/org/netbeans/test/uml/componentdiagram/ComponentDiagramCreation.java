...
public class ComponentDiagramCreation extends DiagramCreation {
    ...
    public ComponentDiagramCreation(String name) {
        super(name,NewDiagramWizardOperator.COMPONENT_DIAGRAM,"ComponentDiagramProjectADC","org.netbeans.test.uml.componentdiagram.ComponentDiagramCreation");
    }
     public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(ComponentDiagramCreation.class);
        return suite;
    }
