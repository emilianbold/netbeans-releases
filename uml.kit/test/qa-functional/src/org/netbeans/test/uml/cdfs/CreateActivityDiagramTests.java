...
public class CreateActivityDiagramTests extends UMLTestCase {
    
    private EventTool eventTool = new EventTool();
    
    public CreateActivityDiagramTests(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(CreateActivityDiagramTests.class);
        return suite;
    }
    
    
    /******************const section*************************/
    private String PROJECT_NAME = "CDFS_uml_Act";
    ...
    public void testCreateActivityDiagramFromManyClasses(){
        ...
        util.createDiagram(nodes, NewDiagramWizardOperator.ACTIVITY_DIAGRAM, DIA_NAME);
        ...
        if (!util.diagramHasExactElements(classNames, dia)){
            fail("testCreateActivityDiagramFromManyClasses verification failed");
        }
    ...
    public void testCreateActivityDiagramFromOperation(){
        final String PATH_TO_OPERATION = "Model|cdfs|Customer|Operations|process";
        final String DIA_NAME = "DGOPAD";
        util = new CDFSUtil(PROJECT_NAME, this);
        ...
        if (wizard.isDiagramAllowed(NewDiagramWizardOperator.ACTIVITY_DIAGRAM)){
            fail("testCreateActivityDiagramFromOperation verification failed ");
        }
