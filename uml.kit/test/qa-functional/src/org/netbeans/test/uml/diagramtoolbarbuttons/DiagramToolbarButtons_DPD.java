...
public class DiagramToolbarButtons_DPD extends UMLTestCase {
    ...
    public DiagramToolbarButtons_DPD(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.diagramtoolbarbuttons.DiagramToolbarButtons_DPD.class);
        return suite;
    }
 ...
 */
    public void testBtn_SequenceLayout(){
        ...
        try
        {
            ...
            fail("unexpected "+btnTooltipName+" on deployment diagram.");
        }
        catch(Exception ex)
        {
            //good
...
//------------------------------------------------------------------------------
    ...
    public void setUp() throws FileNotFoundException{
        ...
        diagram = DTBUtils.openDiagram(prName, dpdName, NewDiagramWizardOperator.DEPLOYMENT_DIAGRAM, workDir);
        if (diagram == null){
