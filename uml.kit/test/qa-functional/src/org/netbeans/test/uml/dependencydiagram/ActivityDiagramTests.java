...
public class ActivityDiagramTests extends UMLTestCase {
    private final String projectName = "Depend_uml_act";
    ...
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(ActivityDiagramTests.class);
        return suite;
    }
    
    
    public void testInvocation(){
        verifier.testDependencyGenerationAbsence(ElementTypes.INVOCATION);
    }
    
    public void testActivityGroup(){
        verifier.testDependencyGenerationAbsence(ElementTypes.ACTIVITY_GROUP);
    }
    
    public void testInitialNode(){
        verifier.testDependencyGenerationAbsence(ElementTypes.INITIAL_NODE);
    }
    
    public void testActivityFinalNode(){
        verifier.testDependencyGenerationAbsence(ElementTypes.ACTIVITY_FINAL_NODE);
    }
    
    public void testFlowFinal(){
        verifier.testDependencyGenerationAbsence(ElementTypes.FLOW_FINAL);
    }
    
    public void testDecision(){
        
        verifier.testDependencyGenerationAbsence(ElementTypes.DECISION);
    ...
    public void testParameterUsage(){
        ...
        verifier.testDependencyGenerationAbsence(ElementTypes.PARAMETER_USAGE);
    ...
    public void testDataStore(){
        ...
        verifier.testDependencyGenerationAbsence(ElementTypes.DATA_STORE);
    ...
    public void testSignal(){
        ...
        verifier.testDependencyGenerationAbsence(ElementTypes.SIGNAL);
    ...
    public void testPartition(){
        ...
        verifier.testDependencyGenerationAbsence(ElementTypes.PARTITION);
    ...
    public void testFork(){
        ...
        verifier.testDependencyGenerationAbsence(ElementTypes.HORIZONTAL_FORK);
    ...
    protected void setUp(){
        ...
        diagram = DependencyUtils.openDiagram(projectName, diagramName, NewDiagramWizardOperator.ACTIVITY_DIAGRAM, workDir);
        if (diagram == null)
