...
public class CollaborationDiagramTests extends UMLTestCase {
    private final String projectName = "Depend_uml_cod";
    ...
    public CollaborationDiagramTests(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(CollaborationDiagramTests.class);
        return suite;
    }
    ...
    protected void setUp(){
        ...
        diagram = DependencyUtils.openDiagram(projectName, diagramName, NewDiagramWizardOperator.COLLABORATION_DIAGRAM, workDir);
        if (diagram == null)
