...
public class DPD_AssociationLink extends UMLTestCase {
    ...
    public DPD_AssociationLink(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.deploymentdiagram.DPD_AssociationLink.class);
        return suite;
    }
...
/**
 * @caseblock Association link
 * @usecase Select all on a diagram by popup menu of a Association link
 */
...
/**
 * @caseblock Association link
 * @usecase Find source element of a Association link
 */
 ...
 */
    public void testRedirectTargetElement1() throws NotFoundException {
        boolean result = verifier.checkRedirectTargetElement(ElementTypes.COMPONENT, ElementTypes.INTERFACE, ElementTypes.ARTIFACT);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testRedirectTargetElement2() throws NotFoundException {
        boolean result = verifier.checkRedirectTargetElement(ElementTypes.NODE, ElementTypes.COMPONENT, ElementTypes.NODE);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
 ...
 */
    public void testRedirectTargetElement3() throws NotFoundException {
        boolean result = verifier.checkRedirectTargetElement(ElementTypes.ARTIFACT, ElementTypes.COMPONENT, ElementTypes.ARTIFACT);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new LinkVerifier(diagram, LinkTypes.ASSOCIATION, "", getLog());
    }
