...
public class DrawingAreaPasteAction extends DiagramElementAction{
    
    private static final String actionPopup = PopupConstants.EDIT+"|"+PopupConstants.PASTE;
    
    public DrawingAreaPasteAction(){
