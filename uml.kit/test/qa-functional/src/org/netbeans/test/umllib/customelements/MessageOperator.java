...
public class MessageOperator extends LinkOperator{
    ...
    public MessageOperator(DiagramOperator diagramOperator, String operationSignature ) throws NotFoundException {
        this(diagramOperator, operationSignature, 0);
    }
    ...
    public static class MesssageByLabelChooser implements DiagramElementChooser {
        
        String name;
        
        public MesssageByLabelChooser(String name){
            this.name = name;
        }
