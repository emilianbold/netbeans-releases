 ...
 *
 * Created on May 12, 2005, 5:36 PM
 *
...
public class InsertOperationAction extends DiagramElementAction{
    ...
    private static final Shortcut insertOperationShortcut = new Shortcut(KeyEvent.VK_O, InputEvent.ALT_MASK | InputEvent.SHIFT_MASK);
    
    
    /** Creates a new instance of InsertOperationAction */
    public InsertOperationAction() {
        super(null, actionPopup, insertOperationShortcut);
    }
