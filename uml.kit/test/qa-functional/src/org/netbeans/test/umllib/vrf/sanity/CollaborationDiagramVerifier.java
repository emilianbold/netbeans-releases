...
public class CollaborationDiagramVerifier extends AbstractDiagramVerifier{
     ...
     */
    public CollaborationDiagramVerifier(String diagramName) {
        super(diagramName);
    }
     ...
     * @param log 
     */
    public CollaborationDiagramVerifier(String diagramName, PrintStream log) {
     ...
     * @param prefix 
     */
    public CollaborationDiagramVerifier(String diagramName, PrintStream log, String prefix) {
