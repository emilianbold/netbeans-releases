...
public class MTestConfig implements XMLSerializable {
    ...
    public static void main(String[] args) throws Exception {
        MTestConfigTask task = new MTestConfigTask();
        task.setTestconfig("D:\\cvs_work\\nb_all\\xtest\\src\\org\\netbeans\\xtest\\harness\\cfg.xml");
        task.setTesttype("unit");
        task.setTestattributes("empty");
        task.setPatternsetattribs("aaa,!ccc,!bbb");
        task.execute();
        
        MTestConfig mconfig = task.getMTestConfig();
        
        //MTestConfig mconfig = loadConfig(new File("D:\\cvs_work\\nb_all\\xtest\\src\\org\\netbeans\\xtest\\harness\\cfg.xml"));
        mconfig.dump();
    }
