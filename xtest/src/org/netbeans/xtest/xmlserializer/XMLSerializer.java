...
public class XMLSerializer {
    ...
    public static XMLSerializable getXMLSerializable(Element element, int depth) throws XMLSerializeException {    	        // if depth is zero, we don't want dig deeper
    	// 
        if (depth==0) {
 ...
 **/
	...
	private static void processPCDATA(XMLSerializable xmlSerializable, Node pcdata) throws XMLSerializeException {		
		...
		if (value != null) {
			...
			if (trimmedValue.length() > 0) {
				...
				// need to do
				System.err.println("processPCDATA - not yet implemented:'"+pcdata.getNodeValue()+"'");			
			}
		}
	}	
	...
	private static void processCDATA(XMLSerializable xmlSerializable, Node cdata) throws XMLSerializeException {
		System.err.println("processCDATA - not yet implemented");		
	}	
		...
		switch (containerMapping.getContainerMappingType()) {
			case ClassMappingRegistry.DIRECT: 
				if (fieldClass.isArray()) {
					...
					System.err.println("direct mapping collection - not yet implemented");
				} else {
			...
			case ClassMappingRegistry.SUBELEMENT:
				if (fieldClass.isArray()) {
					...
					System.err.println("subelement mapping collection - not yet implemented");				
				} else {
					//this should neve happend ....
					throw new XMLSerializeException("Field contains unrecognized type");
				}
