...
public abstract class XMLBean {
    ...
    public static void setField(Field field,Object obj, String value) throws Exception {
        ...
        throw new Exception("field type '"+fieldTypeName+"' not supported");
        
    }
    
    
    protected void fillAttributes(NamedNodeMap atts) throws Exception {
    ...
    protected void fillElements(NodeList elements) throws Exception {
            ...
            switch (elementNode.getNodeType()) {
                ...
                case Node.ELEMENT_NODE :
                    ...
                    if (elemField != null) {
                        ...
                        XMLBean childBean = getXMLBean(element);
    ...
    public static XMLBean getXMLBean(Document doc) throws Exception {
        Element element = doc.getDocumentElement();
        return getXMLBean(element);
    }
    
    public static XMLBean getXMLBean(Element element) throws Exception {
        ...
        try {
            ...
            Object aBean = xmlBeanClass.newInstance();
            // is the bean instance of xmlBean ?
            if (!XMLBean.class.isInstance(aBean)) {
                throw new Exception("class "+xmlBeanClass+" is not instance of XMLBean");
            }
            ...
            if (childElements != null) {
                if (childElements.getLength()!=0) {
                    ...
                    xmlBean.fillElements(childElements);
                }
            }           
        } catch (ClassNotFoundException cnfe) {
            // we didn't find the class - throw exception
            // todo
    ...
    public Document toDocument() throws Exception {
        ...
        Element element = this.toElement(doc);
                        ...
                        for (int j = 0; j < length; j++) {
                            ...
                            if (xmlBeanObject!=null) {
                                if (xmlBeanObject instanceof XMLBean) {
                                    Element childElement = ((XMLBean)xmlBeanObject).toElement(doc);
