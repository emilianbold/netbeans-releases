...
//    static final String ICON_PATH = "SET/PATH/TO/ICON/HERE";
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(javax.swing.UIManager.getDefaults().getColor("Label.disabledForeground"));
            ...
            .add(repoPanelLayout.createSequentialGroup()
                .add(repoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(repoPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(queriesPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 196, Short.MAX_VALUE))
                    .add(findIssuesLabel))
                .addContainerGap())
        );
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        if(evt.getPropertyName().equals(BugtrackingController.EVENT_COMPONENT_DATA_SAVED)) {
            setSaved();
        } else if(evt.getPropertyName().equals(BugtrackingController.EVENT_COMPONENT_DATA_REMOVED)) { // XXX listen on query!
            if(query != null && evt.getSource() == query.getController()) {
                close();
            } else {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                if(query != null) {
                    ...
                    c.removePropertyChangeListener(QueryTopComponent.this);
                }
                ...
                BugtrackingController c = query.getController();
                panel.add(c.getComponent());
                c.addPropertyChangeListener(QueryTopComponent.this);
                revalidate();
                repaint();
            }
        });
    ...
    private void updateSavedQueries(Repository repo) {        
        Query[] queries = repo.getSavedQueries();
