...
private void jList1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList1MouseClicked
    ...
    private boolean updateStatusPanel () {
        ...
        shouldBeVisible = shouldBeVisible && (issue == null || !issue.getLongName().trim().equals(comboBar.getCommand().getText().trim()));
        ...
        void invoke() {
            runTask(new Runnable() {
                public void run() {
                    ...
                    Query q = repository.createQuery();
                    q.simpleSearch(criteria);
                    System.out.println("simple search finnished");
