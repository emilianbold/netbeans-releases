...
public abstract class Issue {
    ...
    public String getLongName() {
        return getID() + " - " + getSummary(); // NOI18N
    }
    ...
    public void setSeen(boolean seen) {
        boolean oldValue = this.seen;
        this.seen = seen;
        getNode().fireSeenValueChanged(oldValue, seen);
    }

    protected abstract class IssueProperty extends org.openide.nodes.PropertySupport.ReadOnly {
