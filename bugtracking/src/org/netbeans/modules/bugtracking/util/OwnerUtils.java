...
public class OwnerUtils {
    ...
    public static void setLooseAssociation(Repository repository, boolean mainProjectOnly) {
        BugtrackingOwnerSupport.getInstance().setLooseAssociation(
                mainProjectOnly ? 
                    BugtrackingOwnerSupport.ContextType.MAIN_PROJECT_ONLY : 
                    BugtrackingOwnerSupport.ContextType.SELECTED_FILE_AND_ALL_PROJECTS, 
                APIAccessor.IMPL.getImpl(repository));
    }
