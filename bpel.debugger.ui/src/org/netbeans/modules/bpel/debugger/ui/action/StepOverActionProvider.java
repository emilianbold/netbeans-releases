 ...
 */
public class StepOverActionProvider extends BpelActionsProviderSupport {

    /**{@inheritDoc}*/
    public StepOverActionProvider(ContextProvider provider) {
        super(provider, ActionsManager.ACTION_STEP_OVER);
