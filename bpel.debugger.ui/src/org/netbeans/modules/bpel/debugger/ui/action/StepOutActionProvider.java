 ...
 */
public class StepOutActionProvider extends BpelActionsProviderSupport {

    /**{@inheritDoc}*/
    public StepOutActionProvider(ContextProvider provider) {
        super(provider, ActionsManager.ACTION_STEP_OUT);
