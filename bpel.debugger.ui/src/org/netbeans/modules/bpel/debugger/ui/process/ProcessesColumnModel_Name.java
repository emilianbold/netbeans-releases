 ...
 */
public final class ProcessesColumnModel_Name extends AbstractColumn {
    public ProcessesColumnModel_Name() {
        super();
        
        myId = PROCESS_NAME_COLUMN_ID;
        myName = "CTL_Process_Column_Name"; // NOI18N
        myTooltip = "CTL_Process_Column_Name_Tooltip"; // NOI18N
        myType = null;
    }
    ...
    public static final String PROCESS_NAME_COLUMN_ID
        = "ProcessNameColumn"; // NOI18N
}
