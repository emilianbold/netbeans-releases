 ...
 * @version 2005.12.01
 */
public class ContinueActionProvider extends BpelActionsProviderSupport {

    /**{@inheritDoc}*/
    public ContinueActionProvider(ContextProvider provider) {
        super(provider, ActionsManager.ACTION_CONTINUE);
