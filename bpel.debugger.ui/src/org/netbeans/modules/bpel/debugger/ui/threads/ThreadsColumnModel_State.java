 ...
 */
public final class ThreadsColumnModel_State extends AbstractColumn {
    public ThreadsColumnModel_State() {
        super();
        
        myId = COLUMN_ID;
        myName = "CTL_Column_State"; // NOI18N
        myTooltip = "CTL_Column_State_Tooltip"; // NOI18N
        myType = String.class;
    }
