 ...
 */
public final class PLinksColumnModel_Type extends AbstractColumn {
    public PLinksColumnModel_Type() {
        super();
        
        myId = PLinksTableModel.TYPE_COLUMN_ID;
        myName = "CTL_Column_Type"; // NOI18N
        myTooltip = "CTL_Column_Type_Tooltip"; // NOI18N
        myType = String.class;
    }
