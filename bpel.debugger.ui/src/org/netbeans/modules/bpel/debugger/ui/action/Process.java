...
import org.netbeans.modules.bpel.debugger.ui.process.BpelProcessTopComponent;
...
public class Process extends AbstractAction {
    ...
    public Process() {
      ...
      putValue(
        ...
        "org/netbeans/modules/bpel/debugger/" + // NOI18N
        "ui/resources/image/process.gif"))); // NOI18N
    }
    
    /**{@inheritDoc}*/
    public void actionPerformed(ActionEvent e) {
        TopComponent view = WindowManager.getDefault().findTopComponent(
            BpelProcessTopComponent.NAME);
        if (view == null) {
            throw new IllegalArgumentException(BpelProcessTopComponent.NAME);
        }
        view.open();
        view.requestActive();
    }
