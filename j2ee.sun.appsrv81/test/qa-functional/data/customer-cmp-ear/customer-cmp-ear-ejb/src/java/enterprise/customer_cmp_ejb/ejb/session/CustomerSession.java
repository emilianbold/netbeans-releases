...
public class CustomerSession implements CustomerSessionLocal, CustomerSessionRemote{
    ...
    public Customer_new searchForCustomer(String id){
        
        Customer_new cust = (Customer_new)em.find(Customer_new.class, id);
        return cust;
    }
    ...
    public Customer_new addCustomerAddress(Customer_new cust, Address address){
        
        Customer_new mergedCust = em.merge(cust);
        mergedCust.getAddresses().add(address);
        return mergedCust;
        
    }
    
    public Customer_new removeCustomerSubscription(String cust, String subs) throws SubscriptionNotFoundException{
        
        //System.out.println("called remove Customer_new Subscription.....");
        
        Customer_new customer = (Customer_new)em.find(Customer_new.class, cust);
    ...
    public Customer_new addCustomerSubscription(String cust, String subs) throws DuplicateSubscriptionException{
        
        //System.out.println("called add Customer_new Subscription.....");
        Customer_new customer = (Customer_new)em.find(Customer_new.class, cust);
        Subscription subscription = (Subscription)em.find(Subscription.class, subs);
