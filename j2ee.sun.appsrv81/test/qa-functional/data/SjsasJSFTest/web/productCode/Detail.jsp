    ...
    <body>
        <f:view>
            ...
            <h:form>
                ...
                <h:outputText rendered="#{empty productCode.productCode.product}">
                    No Product<br>
                </h:outputText>
                <h:dataTable value="#{productCode.productCode.product}" var="item" 
                    border="1" cellpadding="2" cellspacing="0" 
                    rendered="#{not empty productCode.productCode.product}">
                    <h:column>
                        <f:facet name="header">
                ...
                <h:commandLink action="#{productCode.editSetup}" value="Edit">
                    <f:param name="prodCode" value="#{productCode.productCode.prodCode}"/>
                </h:commandLink>
                <br>
