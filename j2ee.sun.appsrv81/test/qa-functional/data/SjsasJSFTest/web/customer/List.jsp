    ...
    <body>
        <f:view>
            ...
            <h:form>
                ...
                rendered="#{customer.lastItem < customer.itemCount && customer.lastItem + customer.batchSize > customer.itemCount}"/><h:dataTable value='#{customer.customers}' var='item' border="1" cellpadding="2" cellspacing="0">
                    <h:column>
                        <f:facet name="header">
