    ...
    <body>
        <f:view>
            ...
            <h:form>
                ...
                <h:outputText rendered="#{empty customer.customer.orders}">
                    No Orders<br>
                </h:outputText>
                <h:dataTable value="#{customer.customer.orders}" var="item" 
                    border="1" cellpadding="2" cellspacing="0" 
                    rendered="#{not empty customer.customer.orders}">
                    <h:column>
                        <f:facet name="header">
                    ...
                    <h:column>
                        <h:commandLink value="Destroy" action="#{orders.destroyFromCustomer}">
                            <f:param name="orderNum" value="#{item.orderNum}"/>
                        </h:commandLink>
                        <h:outputText value=" "/>
                ...
                <h:commandLink value="New Orders" action="#{orders.createFromCustomerSetup}">
                    <f:param name="relatedId" value="#{customer.customer.customerId}"/>
                </h:commandLink>
                <br>
                <br>
                <h:commandLink action="#{customer.editSetup}" value="Edit">
                    <f:param name="customerId" value="#{customer.customer.customerId}"/>
                </h:commandLink>
                <br>
