...
/**
 */
public class ConnectorResourceNode extends ResourceLeafNode {
    
    private static final String NODE_TYPE = NodeTypes.CONNECTOR_RESOURCE;
    
    
    public ConnectorResourceNode(final AppserverMgmtController controller, 
            final String connResourceName) {
        super(controller, NODE_TYPE, connResourceName);
    }

    /**
     * Return the SheetProperties to be displayed for this Connector Resource.
     *
     * @return A java.util.Map containing all of the Connector Resource properties.
     */
    protected java.util.Map getSheetProperties() {
        return getAppserverMgmtController().
            getConnectorResourceProperties(getResourceName(), 
    ...
    public javax.management.Attribute setSheetProperty(String attrName, Object value) {
        return getAppserverMgmtController().
            setConnectorResourceProperty(getResourceName(), attrName, value);
    }
    ...
    public void remove() {
        getAppserverMgmtController().
            deleteConnectorResource(getResourceName());
    }
}
