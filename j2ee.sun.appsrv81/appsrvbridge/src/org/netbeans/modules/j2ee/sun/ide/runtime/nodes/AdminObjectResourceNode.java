...
/**
 */
public class AdminObjectResourceNode extends ResourceLeafNode {
    
    private static final String NODE_TYPE = NodeTypes.ADMIN_OBJECT_RESOURCE;
    
    
    /**
     *
     */
    public AdminObjectResourceNode(final AppserverMgmtController controller, 
            final String adminObjName) {
        super(controller, NODE_TYPE, adminObjName);
    }

    
    /**
     * Return the SheetProperties to be displayed for this Admin Object Resource.
     *
     * @return A java.util.Map containing all Admin Object Resource properties.
     */
    protected java.util.Map getSheetProperties() {
        return getAppserverMgmtController().
            getAdminObjectResourceProperties(getResourceName(), 
    ...
    public javax.management.Attribute setSheetProperty(String attrName, Object value) {
        return getAppserverMgmtController().
                setAdminObjectResourceProperty(getResourceName(), attrName, 
                    value);
    }
    ...
    public void remove() {
        getAppserverMgmtController().
            deleteAdminObjectResource(getResourceName());
    }
