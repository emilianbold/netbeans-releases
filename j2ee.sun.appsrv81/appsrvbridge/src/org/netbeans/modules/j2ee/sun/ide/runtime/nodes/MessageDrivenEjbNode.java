...
public class MessageDrivenEjbNode extends AppserverMgmtLeafNode {
    ...
    private static final String NODE_TYPE = NodeTypes.MESSAGE_DRIVEN_BEAN;
     ...
     */
//////    public MessageDrivenEjbNode(String ejbModuleName, String ejbName) {
//////        super(NODE_TYPE);
...
//////    }
    ...
    /**
     * Constructor for instantiating a new MessageDrivenEjbNode. 
     *
     * @param controller The name of the EjbModuleController to which this 
     *        ejb belongs.
     * @param ejbName The name of the ejb to which this node refers.
     */
    public MessageDrivenEjbNode(EJBModuleController controller, String ejbName) {
        super(NODE_TYPE);
        this.ejbName = ejbName;
    ...
    public MessageDrivenEjbNode(String name) {
        super(NODE_TYPE);
        this.ejbName = name;
        setDisplayName(name);
    }
     ...
     *
     * @return A java.util.Map containing all message driven ejb properties.
     */
    protected java.util.Map getSheetProperties() {
        return controller.getMessageDrivenEJBProperties(ejbName, 
    ...
    public javax.management.Attribute setSheetProperty(String attrName, Object value) {
        return controller.setMessageDrivenEJBProperties(getName(), attrName, value);
    }
