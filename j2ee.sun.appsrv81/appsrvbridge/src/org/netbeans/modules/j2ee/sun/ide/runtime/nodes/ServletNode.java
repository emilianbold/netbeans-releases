...
public class ServletNode extends AppserverMgmtLeafNode {
    ...
    private static final String NODE_TYPE = NodeTypes.SERVLET;
     ...
     *
     * @param controller The WebModuleController to which this servlet refers.
     * @param servletName The name of the servlet to which this node refers.
     */
    public ServletNode(WebModuleController controller, String servletName) {
        super(NODE_TYPE);
    ...
    protected java.util.Map getSheetProperties() {
        return controller.getServletProperties(servletName, 
    ...
    public javax.management.Attribute setSheetProperty(String attrName, Object value) {
        return controller.setServletProperties(getName(), attrName, value);
    }
