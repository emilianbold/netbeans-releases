...
/**
 */
public class PersistenceManagerResourceNode extends ResourceLeafNode {

    private static final String NODE_TYPE = NodeTypes.PM_RESOURCE;

    
    public PersistenceManagerResourceNode(
            final AppserverMgmtController controller, 
            final String pmResourceName) {
        super(controller, NODE_TYPE, pmResourceName);
    }

    /**
     * Return the SheetProperties to be displayed for this PM Resource.
     *
    ...
    protected java.util.Map getSheetProperties() {
        return getAppserverMgmtController().
            getPersistenceManagerFactoryProperties(getResourceName(), 
    ...
    public javax.management.Attribute setSheetProperty(String attrName, Object value) {
        return getAppserverMgmtController().
            setPersistenceManagerResourceFactoryProperty(getResourceName(), 
                attrName, value);
    }
    ...
    public void remove() {
        getAppserverMgmtController().
            deletePersistenceManagerResourceFactory(getResourceName());
    }
