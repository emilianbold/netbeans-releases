...
/**
 */
public class CustomResourceNode extends ResourceLeafNode {
    
    private static final String NODE_TYPE = NodeTypes.CUSTOM_RESOURCE;

    
    public CustomResourceNode(final AppserverMgmtController controller, 
            final String customResourceName) {
        super(controller, NODE_TYPE, customResourceName);
    }
    
    
    /**
     * Return the SheetProperties to be displayed for this Custom Resource.
     *
     * @return A java.util.Map containing all Custom Resource properties.
     */
    protected java.util.Map getSheetProperties() {
        return getAppserverMgmtController().
            getCustomResourceProperties(getResourceName(), 
    ...
    public javax.management.Attribute setSheetProperty(String attrName, Object value) {
        return getAppserverMgmtController().
            setCustomResourceProperty(getResourceName(), attrName, value);
    }
    ...
    public void remove() {
        getAppserverMgmtController().
            deleteCustomResource(getResourceName());
    }
}
