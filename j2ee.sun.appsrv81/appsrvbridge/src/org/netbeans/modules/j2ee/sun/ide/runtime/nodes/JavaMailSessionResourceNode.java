...
/**
 */
public class JavaMailSessionResourceNode extends ResourceLeafNode {
    
    private static final String NODE_TYPE = NodeTypes.MAIL_RESOURCE;

    
    public JavaMailSessionResourceNode(final AppserverMgmtController controller, 
            final String mailResourceName) {
        super(controller, NODE_TYPE, mailResourceName);
    }

    /**
     * Return the SheetProperties to be displayed for this JavaMail Session resource.
     *
     * @return A java.util.Map containing all JavaMail properties.
     */
    protected java.util.Map getSheetProperties() {
        return getAppserverMgmtController().getJavaMailSessionResourceProperties(getResourceName(), 
    ...
    public javax.management.Attribute setSheetProperty(String attrName, Object value) {
        return getAppserverMgmtController().setJavaMailSessionResourceProperty(getResourceName(), attrName, value);
    }
     ...
     */
    public void remove() {
        getAppserverMgmtController().deleteJavaMailSessionResource(getResourceName());
    }
}
