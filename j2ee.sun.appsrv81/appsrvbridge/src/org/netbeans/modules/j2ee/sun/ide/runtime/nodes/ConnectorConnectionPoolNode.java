...
/**
 */
public class ConnectorConnectionPoolNode extends ResourceLeafNode {
    
    private static final String NODE_TYPE = NodeTypes.CONNECTOR_CONNECTION_POOL;
    
    
    public ConnectorConnectionPoolNode(final AppserverMgmtController controller, 
            final String connPoolName) {
        super(controller, NODE_TYPE, connPoolName);
    }
    ...
    protected java.util.Map getSheetProperties() {
        return getAppserverMgmtController().
            getConnectorConnectionPoolProperties(getResourceName(), 
    ...
    public javax.management.Attribute setSheetProperty(String attrName, Object value) {
        return getAppserverMgmtController().
            setConnectorConnectionPoolProperty(getResourceName(), attrName,
                value);
    }
    ...
    public void remove() {
        getAppserverMgmtController().
            deleteConnectorConnectionPool(getResourceName());
    }
}
