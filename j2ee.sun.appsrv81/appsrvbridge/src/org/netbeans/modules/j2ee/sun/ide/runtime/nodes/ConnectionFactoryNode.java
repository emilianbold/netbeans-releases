...
public class ConnectionFactoryNode extends ResourceLeafNode {
    ...
    private static final String NODE_TYPE = NodeTypes.CONNECTION_FACTORY;
    
    
    /**
     *
     */
    public ConnectionFactoryNode(final AppserverMgmtController controller, 
            final String factoryName) {
        super(controller, NODE_TYPE, factoryName);
    }
    
    
    /**
     * Return the SheetProperties to be displayed for this Connection Factory.
     *
     * @return A java.util.Map containing all Connection Factory properties.
     */
    ...
    public javax.management.Attribute setSheetProperty(String attrName, Object value) {
        return getAppserverMgmtController().
            setJMSConnectionFactoryProperty(getResourceName(), attrName, value);
    }
    ...
    public void remove() {
        getAppserverMgmtController().
            deleteJMSConnectionFactory(getResourceName());
    }
}
