...
/**
 */
public class StatelessEjbNode extends AppserverMgmtLeafNode {
     ...
     */
    public StatelessEjbNode(EJBModuleController controller, String ejbName) {
    ...
    public StatelessEjbNode(String name) {
        super(NODE_TYPE);
        this.ejbName = name;
        setDisplayName(name);
    }
    ...
    protected java.util.Map getSheetProperties() {
        return controller.getStatelessEJBProperties(ejbName, 
    ...
    public javax.management.Attribute setSheetProperty(String attrName, Object value) {
        return controller.setStatelessEJBProperties(getName(), attrName, value);
    }
