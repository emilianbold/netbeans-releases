...
public class ResourceAdapterNode extends AppserverMgmtLeafNode {
    ...
    private static final String NODE_TYPE = NodeTypes.RESOURCE_ADAPTER;
     ...
     */
    public ResourceAdapterNode(ConnectorModuleController controller, 
            String resAdapterName) {
        super(NODE_TYPE);
        this.resAdapterName = resAdapterName;
        this.controller = controller;
        setDisplayName(resAdapterName);
    }
    
    public ResourceAdapterNode(String name) {
        super(NODE_TYPE);
        this.resAdapterName = name;
        setDisplayName(name);
    }
    ...
    protected java.util.Map getSheetProperties() {
        return controller.getResourceAdapterProperties(resAdapterName, 
    ...
    public javax.management.Attribute setSheetProperty(String attrName, Object value) {
        return controller.setResourceAdapterProperty(resAdapterName, attrName, value);
    }
