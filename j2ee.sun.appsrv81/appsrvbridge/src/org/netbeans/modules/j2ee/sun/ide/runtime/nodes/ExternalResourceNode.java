...
/**
 */
public class ExternalResourceNode extends ResourceLeafNode {
    
    private static final String NODE_TYPE = NodeTypes.EXTERNAL_RESOURCE;
    
    
    public ExternalResourceNode(final AppserverMgmtController controller, 
            final String extResName) {
        super(controller, NODE_TYPE, extResName);
    }
    
    
    /**
     * Return the SheetProperties to be displayed for this external resource.
     *
     * @return An array containing all External Resource properties.
     */
    protected java.util.Map getSheetProperties() {
        return getAppserverMgmtController().
            getExternalResourceProperties(getResourceName(), 
    ...
    public javax.management.Attribute setSheetProperty(String attrName, Object value) {
        return getAppserverMgmtController().
            setExternalResourceProperty(getResourceName(), attrName, value);
    }
    ...
    public void remove() {
        getAppserverMgmtController().
            deleteExternalResource(getResourceName());
    }
}
