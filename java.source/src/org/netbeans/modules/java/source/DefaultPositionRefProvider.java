...
public final class DefaultPositionRefProvider extends PositionRefProvider {
    ...
    private DefaultPositionRefProvider(CloneableEditorSupport ces) {
        this.ces = ces;
        this.es = null;
    }
    
    private DefaultPositionRefProvider(EditorSupport es) {
        this.es = es;
        this.ces = null;
    }
    
    @Override
    public PositionRef createPositionRef(int position, Position.Bias bias) {
    ...
    public static final class FactoryImpl implements PositionRefProvider.Factory {
        ...
        public PositionRefProvider create(FileObject fo) throws IOException {
            ...
            if (obj instanceof CloneableEditorSupport) {
                return new DefaultPositionRefProvider((CloneableEditorSupport) obj);
            }
            ...
            return es != null ? new DefaultPositionRefProvider(es) : null;
        }
    }
}
