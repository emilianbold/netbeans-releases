...
public abstract class ClasspathInfoAccessor {
    ...
    public abstract ClasspathInfo create (FileObject fo, boolean backgroundCompilation);
    
    public abstract ClasspathInfo create (ClassPath bootPath, ClassPath compilePath, ClassPath sourcePath, boolean backgroundCompilation);
