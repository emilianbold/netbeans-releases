...
public class FormatingOptionsPanel extends JPanel implements ActionListener, PropertyChangeListener {
    ...
    FormatingOptionsPanel( FormatingOptionsPanelController fopControler, Lookup masterLookup ) {
    ...
    private void createCategories() {
        ...
        // categories.add(FmtImports.getController(fopControler.preferences)); // XXX
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        categoryPanel.add(category.getComponent(masterLookup), BorderLayout.CENTER);
    ...
    public static abstract class Category extends OptionsPanelController {
        ...
        public abstract void loadFrom(Preferences preferences);
        
        public abstract void storeTo(Preferences preferences);
        
        public abstract void refreshPreview(JEditorPane pane, Preferences preferences);
