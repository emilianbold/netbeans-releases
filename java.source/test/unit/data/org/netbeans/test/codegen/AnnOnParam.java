...
public class AnnOnParam {
    ...
    public AnnOnParam(@AnnotationType(id=5,synopsis="Unknown",engineer="snoopy",date="2005") int a) {
    }

    public int method0(final @AnnotationType(id=5,synopsis="Unknown",engineer="snoopy",date="2005") String s) {
        return 5;
    }
