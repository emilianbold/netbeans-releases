...
public class ClasspathInfoTest extends NbTestCase {
    ...
    public void testGetTypeDeclaration() throws Exception {
        ClasspathInfo ci = ClasspathInfo.create( bootPath, classPath, null);
	JavacElements elements = (JavacElements) JavacParser.createJavacTask(ci,  (DiagnosticListener) null, (String) null, null, null, null, null).getElements();
    ...
    public void testGetPackageDeclaration() throws Exception {
        ...
        for( Enumeration entries = jf.entries(); entries.hasMoreElements(); ) {
            ...
            if ( je.isDirectory() ) {
                ...
                PackageElement pd = JavacParser.createJavacTask(ci,  (DiagnosticListener) null, (String) null, null, null, null, null).getElements().getPackageElement( packageName );
