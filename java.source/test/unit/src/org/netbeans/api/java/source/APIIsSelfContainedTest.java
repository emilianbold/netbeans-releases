...
public class APIIsSelfContainedTest extends NbTestCase {
    ...
    private FileObject[] prepareClasspath() {
        ...
        return new FileObject[] {
            FileUtil.getArchiveRoot(root.getFileObject("java3/modules/org-netbeans-modules-java-source.jar")),
            FileUtil.getArchiveRoot(root.getFileObject("java3/modules/ext/javac-api-nb-7.0-b07.jar")),
            FileUtil.getArchiveRoot(root.getFileObject("java3/modules/ext/javac-impl-nb-7.0-b07.jar")),
        };
    }
