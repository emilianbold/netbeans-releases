...
public abstract class SelectionAwareSourceTaskFactory extends SourceTaskFactory {
    ...
    /**Construct the SelectionAwareSourceTaskFactory with given {@link Phase} and {@link Priority}.
     *
     ...
     */
    public SelectionAwareSourceTaskFactory(Phase phase, Priority priority) {
     ...
     * @since 0.22
     */
    public SelectionAwareSourceTaskFactory(Phase phase, Priority priority, String... supportedMimeTypes) {
    ...
    private Map<JTextComponent, ComponentListener> component2Listener = new HashMap<JTextComponent, SelectionAwareSourceTaskFactory.ComponentListener>();
