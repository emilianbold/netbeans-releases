...
public abstract class EditorAwareSourceTaskFactory extends SourceTaskFactory {
    ...
    /**Construct the EditorAwareSourceTaskFactory with given {@link Phase} and {@link Priority}.
     *
     ...
     */
    protected EditorAwareSourceTaskFactory(Phase phase, Priority priority) {
