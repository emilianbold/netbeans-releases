...
public class StringSourceFileReader implements SourceFileReader {

    private String buffer;
    private FileObject bufferFo;

    public StringSourceFileReader(String buffer, FileObject bufferFo) {
        super();
        this.buffer = buffer;
        this.bufferFo = bufferFo;
    }
