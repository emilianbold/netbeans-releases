...
public interface Formatter {
     ...
     */
    void reformat(Document doc, int startOffset, int endOffset, CompilationInfo compilationInfo);
     ...
     */
    void reindent(Document doc, int startOffset, int endOffset);
