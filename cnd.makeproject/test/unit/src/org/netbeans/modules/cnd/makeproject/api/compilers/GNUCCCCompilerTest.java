...
"# 1 \"tmp.cpp\"\n";
        ...
        GNUCCCompiler instance = new GNUCCCompiler("localhost", flavor, Tool.CCCompiler, "MinGW", "MinGW", "C:\\MinGW\\bin") {
            @Override
...
"COLLECT_GCC_OPTIONS='-E' '-v' '-mtune=i386'\n";
        ...
        GNUCCCompiler instance = new GNUCCCompiler("localhost", flavor, Tool.CCCompiler, "MinGW_TDM", "MinGW_TDM", "D:\\tec\\mingw\\bin") {
            @Override
            protected String normalizePath(String path) {
                return path;
            }
...
"# 1 \"tmp.cpp\"\n";
        ...
        GNUCCCompiler instance = new GNUCCCompiler("localhost", flavor, Tool.CCCompiler, "Cygwin", "Cygwin", "C:\\cygwin\\bin") {
            @Override
            protected String normalizePath(String path) {
                return path;
            }
...
"# 1 \"tmp.cpp\"\n";
        ...
        GNUCCCompiler instance = new GNUCCCompiler("localhost", flavor, Tool.CCCompiler, "GNU", "GNU", "/usr/sfw/bin") {
            @Override
            protected String normalizePath(String path) {
                return path;
            }
