...
public abstract class DefaultProjectOperationsImplementationUI {
    ...
    public abstract void copyProject(MakeProject project, DefaultProjectOperationsImplementationExecutor executor);
    public abstract void moveProject(MakeProject project, DefaultProjectOperationsImplementationExecutor executor);
    public abstract void renameProject(MakeProject project, DefaultProjectOperationsImplementationExecutor executor);
    private static final Default DEFAULT = new Default();

    protected DefaultProjectOperationsImplementationUI() {
    }
    
    public static DefaultProjectOperationsImplementationUI getDefaultProjectOperationsImplementationUI() {
        DefaultProjectOperationsImplementationUI ui = Lookup.getDefault().lookup(DefaultProjectOperationsImplementationUI.class);
        return ui == null ? DEFAULT : ui;
    }

    private static final class Default extends DefaultProjectOperationsImplementationUI {
