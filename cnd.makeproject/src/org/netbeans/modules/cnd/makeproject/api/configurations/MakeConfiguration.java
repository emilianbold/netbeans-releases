...
//        return ret;
    ...
    public String expandMacros(String val) {
        // Substitute macros
        val = CndPathUtilitities.expandMacro(val, "${TESTDIR}", MakeConfiguration.BUILD_FOLDER + '/' +MakeConfiguration.CND_CONF_MACRO+ '/' + MakeConfiguration.CND_PLATFORM_MACRO + "/" + "tests"); // NOI18N
