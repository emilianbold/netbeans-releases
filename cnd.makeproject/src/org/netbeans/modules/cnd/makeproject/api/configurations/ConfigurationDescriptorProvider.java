...
public class ConfigurationDescriptorProvider {
    public static final boolean VCS_WRITE = Boolean.getBoolean("cnd.make.vcs.write");//org.netbeans.modules.cnd.makeproject.configurations.CommonConfigurationXMLCodec.VCS_WRITE;
