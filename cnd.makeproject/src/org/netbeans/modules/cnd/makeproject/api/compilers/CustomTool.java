...
public final class CustomTool extends Tool {
    ...
    private CustomTool(ExecutionEnvironment env) {
        super(env, CompilerFlavor.getUnknown(PlatformTypes.getDefaultPlatform()), ToolKind.CustomTool, "", NbBundle.getMessage(CustomTool.class, "LBL_CustomTool"), null); // NOI18N
    }
