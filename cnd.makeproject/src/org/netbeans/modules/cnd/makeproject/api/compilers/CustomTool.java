...
public final class CustomTool extends Tool {
    ...
    private CustomTool(ExecutionEnvironment env) {
        super(env, CompilerFlavorAccessor.getUnknown(PlatformTypes.getDefaultPlatform()), CustomTool, "", NbBundle.getMessage(CustomTool.class, "LBL_CustomTool"), null); // NOI18N
    }
