 ...
 */
@ServiceProvider(service=MakeProjectOptions.MakeOptionNamedEntity.class, position=900)
public class RebuildPropsChanged extends MakeProjectOptions.MakeOptionNamedEntity {
