...
//            String systemOs = getCurrentSystemOs();
    ...
    //            changeXmlFileByTagName(doc, "defaultConf", systemOs, "X-DEFAULTCONF-X"); // NOI18N
                ...
                if (platform == PlatformTypes.PLATFORM_WINDOWS) { // Utilities.isWindows()) {
                    ...
                    changeXmlFileByTagAttrName(doc, CommonConfigurationXMLCodec.MAKE_ARTIFACT_ELEMENT, "OP", "dll", "X-LIBSUFFIX-X"); // NOI18N
                    if (variant != null) {
                ...
                if (platform == PlatformTypes.PLATFORM_MACOSX) { //Utilities.getOperatingSystem() == Utilities.OS_MAC) {
                    ...
                    changeXmlFileByTagAttrName(doc, CommonConfigurationXMLCodec.MAKE_ARTIFACT_ELEMENT, "OP", "lib", "X-LIBPREFIX-X"); // NOI18N
                    changeXmlFileByTagAttrName(doc, CommonConfigurationXMLCodec.MAKE_ARTIFACT_ELEMENT, "OP", "dylib", "X-LIBSUFFIX-X"); // NOI18N
                    if (variant != null) {
                        changeXmlFileByTagAttrName(doc, CommonConfigurationXMLCodec.MAKE_ARTIFACT_ELEMENT, "OP", variant, "X-PLATFORM-X"); // NOI18N
                    }
                } else {
                    ...
                    changeXmlFileByTagAttrName(doc, CommonConfigurationXMLCodec.MAKE_ARTIFACT_ELEMENT, "OP", "lib", "X-LIBPREFIX-X"); // NOI18N
                    changeXmlFileByTagAttrName(doc, CommonConfigurationXMLCodec.MAKE_ARTIFACT_ELEMENT, "OP", "so", "X-LIBSUFFIX-X"); // NOI18N
                    if (variant != null) {
                        changeXmlFileByTagAttrName(doc, CommonConfigurationXMLCodec.MAKE_ARTIFACT_ELEMENT, "OP", variant, "X-PLATFORM-X"); // NOI18N
                    }
                }
