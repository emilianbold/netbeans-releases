 ...
 */
public class ResolveRfsLibraryImpl implements ConfirmSupport.ResolveRfsLibrary {
    ...
    public static final class ResolveRfsLibraryFactoryImpl implements ResolveRfsLibraryFactory {
        ...
        @Override
        public ConfirmSupport.ResolveRfsLibrary create(final ExecutionEnvironment execEnv) {
