...
class RemoteProjectImportWizardPanel implements WizardDescriptor.FinishablePanel<WizardDescriptor> {
    ...
    @Override
    public SettingsPanel getComponent() {
        if (component == null) {
            component = new RemoteProjectImportVisual(this);
        }
        return component;
    }
