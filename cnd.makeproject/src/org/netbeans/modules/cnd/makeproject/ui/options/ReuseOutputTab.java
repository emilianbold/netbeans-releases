 ...
 */
@ServiceProvider(service=MakeProjectOptions.MakeOptionNamedEntity.class, position=300)
public class ReuseOutputTab extends MakeProjectOptions.MakeOptionNamedEntity {
    // Reuse
