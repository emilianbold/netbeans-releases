 ...
 */
@ServiceProvider(service=MakeProjectOptions.MakeOptionNamedEntity.class, position=500)
public class ViewBinaryFiles extends MakeProjectOptions.MakeOptionNamedEntity {
