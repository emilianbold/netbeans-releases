...
public abstract class SPIAccessor {
    ...
    public static synchronized SPIAccessor get() {
        if (INSTANCE == null) {
            Class<?> c = MakeConfigurationDescriptor.class;
            try {
    ...
    /**
     * Register the accessor. The method can only be called once - othewise it
    ...
    public abstract void setDefaultConfigurationsRestored(MakeConfigurationDescriptor cd, boolean restored);
    public abstract boolean isDefaultConfigurationsRestored(MakeConfigurationDescriptor cd);
}
