...
public class BuildPlatformNodeProp extends IntNodeProp implements PropertyChangeListener {
    ...
    public BuildPlatformNodeProp(IntConfiguration intConfiguration, DevelopmentHostConfiguration developmentHost, MakeCustomizer makeCustomizer, boolean canWrite, String unused, String name, String description) {
