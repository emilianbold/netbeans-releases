...
public abstract class JSValueImpl implements JSValue {
    private JSCallStackFrameImpl callStackFrame;
    private String fullName;
    private TypeOf typeOf;

    protected String displayValue;

    JSValueImpl(JSCallStackFrameImpl callStackFrame, String fullName, TypeOf typeOf) {
        this.callStackFrame = callStackFrame;
    ...
    JSDebugger getJSDebugger() {
        return callStackFrame.getJSDebugger();
    }
