 ...
 *
 */
public abstract class BaseMessageChildElement {
    ...
    protected Node getChild( String nodeName ) {
        return Message.getChild( getNode() , nodeName );
    }
    
    protected List<Node> getChildren( String nodeName ) {
        return Message.getChildren( getNode(), nodeName);
    }
    
    protected String getAttribute( String attrName ){
        return Message.getAttribute( getNode(), attrName);
    }
