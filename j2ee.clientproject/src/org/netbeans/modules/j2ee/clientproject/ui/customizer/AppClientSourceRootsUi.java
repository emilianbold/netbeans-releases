...
public final class AppClientSourceRootsUi {
    ...
    public static EditMediator registerEditMediator( AppClientProject master,
        ...
        columnNames[0]  = NbBundle.getMessage( AppClientSourceRootsUi.class,"CTL_PackageFolders");
        columnNames[1]  = NbBundle.getMessage( AppClientSourceRootsUi.class,"CTL_PackageLabels");
    ...
    public static void showIllegalRootsDialog(Set<File> roots) {
        JButton closeOption = new JButton(NbBundle.getMessage(AppClientSourceRootsUi.class,"CTL_J2SESourceRootsUi_Close"));
        closeOption.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(AppClientSourceRootsUi.class,"AD_J2SESourceRootsUi_Close"));
        JPanel warning = new WarningDlg(roots);
        String message = NbBundle.getMessage(AppClientSourceRootsUi.class,"MSG_InvalidRoot");
        JOptionPane optionPane = new JOptionPane(new Object[] {message, warning},
                ...
                new Object[0],
                null);
        optionPane.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(AppClientSourceRootsUi.class,"AD_InvalidRootDlg"));
        DialogDescriptor dd = new DialogDescriptor(optionPane,
                NbBundle.getMessage(AppClientSourceRootsUi.class,"TITLE_InvalidRoot"),
                true,
                new Object[] {
            closeOption,
        },
    ...
    public static class EditMediator implements ActionListener, ListSelectionListener, CellEditorListener {
        ...
        public EditMediator( AppClientProject master,
                SourceRoots sourceRoots,
                JTable rootsList,
                JButton addFolderButton,
                JButton removeButton,
        ...
        public void actionPerformed( ActionEvent e ) {
            ...
            if ( source == addFolderButton ) {
                ...
                if (this.sourceRoots.isTest()) {
                    chooser.setDialogTitle( NbBundle.getMessage( AppClientSourceRootsUi.class, "LBL_TestFolder_DialogTitle" )); // NOI18N
                } else {
                    chooser.setDialogTitle( NbBundle.getMessage( AppClientSourceRootsUi.class, "LBL_SourceFolder_DialogTitle" )); // NOI18N
                }
    ...
    private static class WarningDlg extends JPanel {
        ...
        private void initGui(Set<File> invalidRoots) {
            setLayout( new GridBagLayout());
            JLabel label = new JLabel();
            label.setText(NbBundle.getMessage(AppClientSourceRootsUi.class,"LBL_InvalidRoot"));
            label.setDisplayedMnemonic(NbBundle.getMessage(AppClientSourceRootsUi.class,"MNE_InvalidRoot").charAt(0));
            ...
            roots.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(AppClientSourceRootsUi.class,"AD_InvalidRoot"));
            JLabel label2 = new JLabel();
            label2.setText(NbBundle.getMessage(AppClientSourceRootsUi.class,"MSG_InvalidRoot2"));
            c = new GridBagConstraints();
            c.gridx = GridBagConstraints.RELATIVE;
            c.gridy = GridBagConstraints.RELATIVE;
            c.gridwidth = GridBagConstraints.REMAINDER;
            ...
            public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                if (projectConflict) {
                    ...
                    if (p!=null) {
                        ...
                        message = MessageFormat.format(NbBundle.getMessage(AppClientSourceRootsUi.class,"TXT_RootOwnedByProject"), new Object[] {
                            message,
                            projectName});
                    }
                }
