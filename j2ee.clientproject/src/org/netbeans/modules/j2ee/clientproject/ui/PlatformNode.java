...
class PlatformNode extends AbstractNode implements ChangeListener {
    ...
    private static final String PLATFORM_ICON = "org/netbeans/modules/j2ee/clientproject/ui/resources/platform.gif";    //NOI18N
    ...
    private static class PlatformProvider implements PropertyChangeListener {
        ...
        public JavaPlatform getPlatform () {
            if (platformCache == null) {
                ...
                platformCache = AppClientProjectUtil.getActivePlatform (platformSystemName);
        ...
        private void fireChange () {
            ...
            synchronized (this) {
                ...
                _listeners = this.listeners.toArray(new ChangeListener[listeners.size()]);
            }
