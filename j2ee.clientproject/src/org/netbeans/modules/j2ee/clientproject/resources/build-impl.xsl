...
<!--                <xsl:if test="count(//carproject:included-library) &gt; 0">
            ...
            <target name="-debug-start-debuggee-test">
                ...
                <carproject:test-debug includes="${{javac.includes}}" excludes="" testincludes="${{javac.includes}}"/>
            </target>
            ...
            <target name="-debug-start-debuggee-test-method">
                ...
                <fail unless="test.class">Must select one file in the IDE or set test.class</fail>
                <fail unless="test.method">Must select some method in the IDE or set test.method</fail>
                <carproject:test-debug includes="${{javac.includes}}" excludes="" testincludes="${{test.class}}" testmethods="${{test.method}}"/>
            </target>
