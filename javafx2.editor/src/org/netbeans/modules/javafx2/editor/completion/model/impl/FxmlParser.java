...
import org.netbeans.modules.javafx2.editor.completion.model.ErrorReporter;
...
import org.netbeans.modules.javafx2.editor.completion.model.ModelBuilderAccessor;
import org.netbeans.modules.javafx2.editor.completion.model.processors.NamedInstancesCollector;
import org.netbeans.modules.javafx2.editor.completion.model.impl.BuildEnvironment;
import org.netbeans.modules.javafx2.editor.completion.model.impl.FxModelBuilder;
import org.netbeans.modules.javafx2.editor.completion.model.impl.ModelBuilderStep;
import org.netbeans.modules.javafx2.editor.completion.model.processors.PropertyResolver;
import org.netbeans.modules.javafx2.editor.completion.model.processors.ReferenceResolver;
import org.netbeans.modules.javafx2.editor.completion.model.processors.TypeResolver;
...
public class FxmlParser extends Parser implements ErrorReporter {
    ...
    public void parse(Snapshot snapshot, Task task, SourceModificationEvent event) throws ParseException {
        ...
        result = new ResultImpl(env.getNodes(), snapshot, model, problems, h);
    ...
    private static final class ResultImpl extends FxmlParserResult {
        private FxNodes nodes;

        public ResultImpl(FxNodes nodes, Snapshot _snapshot, FxModel sourceModel, Collection<ErrorMark> problems, TokenHierarchy<XMLTokenId>  h) {
            super(_snapshot, sourceModel, problems, h);
            this.nodes = nodes;
        }

        @Override
        public FxNodes getNodes() {
            return nodes;
        }
    }
    ...
    private BuildEnvironment createBuildEnvironment() {
        ...
        env.setNodes(new FxNodes(ModelAccessor.INSTANCE));
        env.setAccessor(ModelAccessor.INSTANCE);
        env.setBeanProvider(new FxBean.Provider() {
