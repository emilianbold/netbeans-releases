...
import org.netbeans.modules.javafx2.editor.completion.beans.FxBeanInfo.Provider;
 ...
 * @author sdedic
 */
public final class BuildEnvironment implements FxBeanInfo.Provider, ErrorReporter {
    private CompilationInfo info;
    private ErrorReporter   reporter;
    private FxBeanInfo.Provider beanProvider;
    private ModelBuilderAccessor accessor;
    ...
    public ModelBuilderAccessor getAccessor() {
        return accessor;
    }
    
    void setAccessor(ModelBuilderAccessor accessor) {
    ...
    void setBeanProvider(Provider beanProvider) {
