...
public class FXMLCompletion2 implements CompletionProvider {
    ...
    public CompletionTask createTask(int queryType, JTextComponent component) {
        ...
        if (queryType == COMPLETION_QUERY_TYPE) {
            return new AsyncCompletionTask(new Q(component), component);
        }
        return null;
    }
    ...
    private static class Q extends AsyncCompletionQuery {
        ...
        public Q(JTextComponent component) {
        ...
        protected void query(CompletionResultSet resultSet, Document doc, int caretOffset) {
            try {
                ...
                ParserManager.parse(JavaFXEditorUtils.JAVA_MIME_TYPE,
                        new Task(cpInfo, component, resultSet, doc, caretOffset));
                resultSet.finish();
    ...
    private static class Task extends UserTask implements ClasspathInfoProvider {
        ...
        public Task(ClasspathInfo cpInfo, JTextComponent component, CompletionResultSet resultSet, Document doc, int caretOffset) {
        ...
        public void run(ResultIterator resultIterator) throws Exception {
            ...
            final CompilationInfo ci = (CompilationInfo)CompilationInfo.get(result);

            final CompletionContext ctx = new CompletionContext(resultSet, doc, caretOffset);
            ...
            doc.render(new Runnable() { public void run() { 
                ctx.init(TokenHierarchy.get(doc), ci); 
            }});
