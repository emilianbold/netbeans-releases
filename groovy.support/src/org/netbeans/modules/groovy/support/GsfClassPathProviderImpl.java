...
/**
 * Another workaround for Java CP vs GSF CP clash
 *
...
public class GsfClassPathProviderImpl implements ClassPathProvider {
    ...
    public ClassPath findClassPath(FileObject file, String type) {
        if ("groovy".equals(file.getExt())) { // NOI18N
            org.netbeans.api.java.classpath.ClassPath javaCP = org.netbeans.api.java.classpath.ClassPath.getClassPath(file, type);
            if (javaCP != null) {
                return ClassPathSupport.createClassPath(javaCP.getRoots());
            }
        }
        return null;
    }
