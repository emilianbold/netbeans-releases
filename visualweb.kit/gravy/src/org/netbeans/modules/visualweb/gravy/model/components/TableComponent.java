...
public class TableComponent extends WebComponent {
    ...
    public final static String TABLE_ID = Bundle.getStringTrimmed(ravePaletteBundle,
                                          Bundle.getStringTrimmed(bundle, "TableComponent"));
    
    public TableComponent(ComponentSet set) {
        super(set, TABLE_ID);
        isVisual = true;
        isEventHadling = false;
    }
}
