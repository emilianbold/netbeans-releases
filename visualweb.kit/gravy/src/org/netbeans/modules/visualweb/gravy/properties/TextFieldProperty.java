...
/**
 * Can be used to set all properties which use JTextField to change value.
 * <p>
 * Usage:<br>
 * <pre>
 ...
 *      TextFieldProperty pr = new TextFieldProperty(psto, "Name");
...
public class TextFieldProperty extends Property {
     ...
     * @deprecated Use {@link Property} instead
     */
    public TextFieldProperty(ContainerOperator contOper, String name) {
        super(contOper, name);
    }

    /** Starts editing the property and waits for JTextField
     * @return JTextFieldOperator of property text field 
     * @deprecated Use {@link Property} instead
     */
