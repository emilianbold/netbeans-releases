...
/** Used to call "Edit|Find" main menu item or Ctrl+F shortcut.
 * @see Action
...
public class FindAction extends Action{
    ...
    private static final String findMenu = Bundle.getStringTrimmed("org.netbeans.core.Bundle", "Menu/Edit") + "|" + findPopup; 
    private static final Action.Shortcut findShortcut = Util.isMacOS() ? 
               new Action.Shortcut(KeyEvent.VK_F, KeyEvent.META_MASK) : new Action.Shortcut(KeyEvent.VK_F, KeyEvent.CTRL_MASK);    
    ...
    public void performShortcut() {
        ...
        for(int i=0; i<shortcuts.length; i++) {
            new KeyRobotDriver(null).pushKey(null, findShortcut.getKeyCode(), findShortcut.getKeyModifiers(), JemmyProperties.getCurrentTimeouts().create("Timeouts.DeltaTimeout"));
