...
/**
 * Common class for all non visual components on web page.
 */

public class NonVisualComponent extends Component {

    /**
     * Create non visual component on web page using web component from palette.
     * @param webcomponent
     * @param name
     */
    public NonVisualComponent(WebComponent webcomponent, String name) {
