...
/**
 * Class representing Tomcat 5.5 Application Servers.
 */

public class Tomcat55 extends ApplicationServer {
    ...
    public final static String SERVER_VIEW_CONTEXT_LOG = "View Server Log";
    ...
    
    {
        ...
        this.application_popup = new String[] {APPLICATION_ENABLE, APPLICATION_DISABLE, APPLICATION_OPEN, APPLICATION_UNDEPLOY};
        this.app_pref = "/";
    }
    
    /**
     * Creates Tomcat55 with specified descriptor.
     * @param DTDescriptor Descriptor of Tomcat 5.5 Application Server.
     */
    public Tomcat55(DeploymentTargetDescriptor DTDescriptor) {
