...
public class JBossAcceptanceTestSuite extends NbTestSuite {
    
    private JBossAcceptanceTestSuite(String name) {
        super(name);
    }
    ...
    public static NbTestSuite suite() {
        JBossAcceptanceTestSuite suite = new JBossAcceptanceTestSuite("JBoss Deployment Acceptance Tests");
        DeploymentAcceptanceTest.serverType = "JBoss Application Server";
