...
public class WebLogicTestSuite extends NbTestSuite {
    ...
    public static NbTestSuite suite() {
        WebLogicTestSuite suite = new WebLogicTestSuite("WebLogic Deployment Tests");
        DeploymentTest.serverType = "BEA WebLogic Server";
