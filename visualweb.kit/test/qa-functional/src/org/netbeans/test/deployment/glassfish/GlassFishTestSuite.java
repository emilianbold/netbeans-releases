...
package org.netbeans.test.deployment.glassfish;
...
public class GlassFishTestSuite extends NbTestSuite {
    
    private GlassFishTestSuite(String name) {
        super(name);
    }
    
    /**
     * Returns GlassFish specific instance of the TestSuite
     *
     * @return instance of the TestSuite
     */
    public static NbTestSuite suite() {
        GlassFishTestSuite suite = new GlassFishTestSuite("GlassFish Deployment Tests");
//        DeploymentTest.serverType = "Sun Java System Application Server";
//        DeploymentAcceptanceTest.serverType = "Sun Java System Application Server";
//        DeploymentTest.serverType = "GlassFish V1";
//        DeploymentAcceptanceTest.serverType = "GlassFish V1";
        DeploymentTest.serverType = "GlassFish V2";
        DeploymentAcceptanceTest.serverType = "GlassFish V2";
