...
public class GlassFishAcceptanceTestSuite extends NbTestSuite {
    
    private GlassFishAcceptanceTestSuite(String name) {
        super(name);
    }
    ...
    public static NbTestSuite suite() {
        GlassFishAcceptanceTestSuite suite = new GlassFishAcceptanceTestSuite("GlassFish Deployment Acceptance Tests");
