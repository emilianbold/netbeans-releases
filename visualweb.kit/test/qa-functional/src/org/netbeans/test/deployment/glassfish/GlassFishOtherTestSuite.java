...
public class GlassFishOtherTestSuite extends NbTestSuite {
    
    private GlassFishOtherTestSuite(String name) {
        super(name);
    }
    ...
    public static NbTestSuite suite() {
        GlassFishOtherTestSuite suite = new GlassFishOtherTestSuite("GlassFish Other Deployment Tests");
//        OtherDeploymentTest.serverType = "Sun Java System Application Server";
//        OtherDeploymentTest.serverType = "GlassFish V1";
        OtherDeploymentTest.serverType = "GlassFish V2";
