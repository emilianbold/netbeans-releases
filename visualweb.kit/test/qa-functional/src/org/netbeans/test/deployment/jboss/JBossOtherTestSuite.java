...
public class JBossOtherTestSuite extends NbTestSuite {
    
    private JBossOtherTestSuite(String name) {
        super(name);
    }
    ...
    public static NbTestSuite suite() {
        JBossOtherTestSuite suite = new JBossOtherTestSuite("JBoss Other Deployment Tests");
        OtherDeploymentTest.serverType = "JBoss Application Server";
