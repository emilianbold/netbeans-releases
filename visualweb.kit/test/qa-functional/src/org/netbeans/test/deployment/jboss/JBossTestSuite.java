...
public class JBossTestSuite extends NbTestSuite {
    ...
    public static NbTestSuite suite() {
        JBossTestSuite suite = new JBossTestSuite("JBoss Deployment Tests");
        DeploymentTest.serverType = "JBoss Application Server";
