...
public class TextstyleDescriptor implements Descriptor {
    ...
    private Color notEditableTextColor;


    public TextstyleDescriptor(Color editableTextColor) {
        this(editableTextColor, null);
    }


    public TextstyleDescriptor(Color editableTextColor,
            Color notEditableTextColor)
    {
    ...
    public Color getNotEditableTextColor(){
        return notEditableTextColor;
    }
}
