...
public class DecorationManager {
    ...
    private final Object listKey = new Object();
...
//
//
//    public void detachProvider( DecorationProvider provider){
//        providersList.add(provider);
//        /*
//         * trigger re-calculation of all decorations to get rid
//         * of decorations reported by removed provider
//         */
//        decorationChanged(null);
//    }
    
    
    public void addDecoration(BpelEntity entity, Decoration decoration){
        modifyList(entity, decoration, true);
        updateResult(entity);
        updateView();
    }
    
    
    public void removeDecoration(BpelEntity entity, Decoration decoration){
        modifyList(entity, decoration, false);
        updateResult(entity);
        updateView();
    }
    ...
    private void updateResult(BpelEntity entity){
        ...
        //stage 1. calculate summ of decorations PUSHED to manager
        Collection<Decoration> list = (Collection) entity.getCookie(listKey);
        if (list != null){
        ...
        //stage 2. PULL decorations from provider
    ...
    private void modifyList(BpelEntity entity, Decoration decoration, boolean addFlag){
        Collection<Decoration> list = (Collection) entity.getCookie(listKey);
    ...
    private void repositionComponents(BpelEntity entity){
        ...
        float zoom = designView.getCorrectedZoom();
