...
//        scrollPane = createScrollPane(list);
    ...
    private static JScrollPane createScrollPane(JComponent content) {
        ...
        res.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
        ...
        JScrollBar verticalScrollBar = res.getVerticalScrollBar();
        verticalScrollBar.setOpaque(false);
        
        for (int i = verticalScrollBar.getComponentCount() - 1; i >= 0; i--) {
            Component c = verticalScrollBar.getComponent(i);
...
//    }
    ...
    private static final Paint FILL = new Color(0xCCFFFFFF, true);
