...
import org.netbeans.modules.bpel.design.model.elements.EventGateway;
...
public class PickPattern extends CompositePattern {
    ...
    private EventGateway forkGateway;
    private EventGateway mergeGateway;
    ...
    protected void createElementsImpl() {
        ...
        forkGateway = new EventGateway();
        forkGateway.setLabelText(""); // NOI18N
        mergeGateway = new EventGateway();
    ...
    public void reconnectElements() {
        ...
        float x11 = forkGateway.getX();
        float x12 = x11 + forkGateway.getWidth();
        
        float x21 = mergeGateway.getX();
        float x22 = x21 + mergeGateway.getY();
    ...
    public Area createSelection() {
        ...
        res.subtract(GUtils.createArea(forkGateway.getShape()));
        res.subtract(GUtils.createArea(mergeGateway.getShape()));
        return res;
    }
