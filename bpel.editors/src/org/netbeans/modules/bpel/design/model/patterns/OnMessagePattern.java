...
import org.netbeans.modules.bpel.design.model.elements.MessageEvent;
...
public class OnMessagePattern
    ...
    public FRectangle layoutPattern(LayoutManager manager) {
        float height = messageEvent.getHeight() + LayoutManager.HSPACING;
        float width = messageEvent.getWidth();
...
//          System.out.println("Width=" + pSize.width);
    ...
    public Area createSelection() {
        ...
        res.subtract(GUtils.createArea(messageEvent.getShape()));
        return res;
    }
