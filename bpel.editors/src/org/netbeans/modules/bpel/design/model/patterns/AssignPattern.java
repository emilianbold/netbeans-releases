...
import org.netbeans.modules.bpel.design.model.elements.AssignElement;
import org.netbeans.modules.bpel.design.model.elements.VisualElement;
import org.netbeans.modules.bpel.design.nodes.DiagramExtInfo;
import org.netbeans.modules.bpel.design.nodes.DiagramExtInfoImpl;
...
public class AssignPattern extends BasicActivityPattern{
    ...
    private DiagramExtInfo diagramExtInfo;
    ...
    protected void createElementsImpl() {
        VisualElement element = new AssignElement();
    ...
    public DiagramExtInfo getExtInfo() {
        if (diagramExtInfo == null) {
            diagramExtInfo = new DiagramExtInfoImpl();
        }
        return diagramExtInfo;
    }
