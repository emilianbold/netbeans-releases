...
import org.netbeans.modules.bpel.design.model.elements.RepeatUntilGateway;
...
public class RepeatUntilPattern extends CompositePattern {
    ...
    private RepeatUntilGateway gateway;
    ...
    protected void createElementsImpl() {
        ...
        gateway = new RepeatUntilGateway();
    ...
    public FRectangle layoutPattern(LayoutManager manager) {
        ...
        float x0 = -gateway.getWidth() - LayoutManager.HSPACING;
        float y0 = 0;
    ...
    public Area createSelection() {
        ...
        res.subtract(GUtils.createArea(gateway.getShape()));
        return res;
    }
