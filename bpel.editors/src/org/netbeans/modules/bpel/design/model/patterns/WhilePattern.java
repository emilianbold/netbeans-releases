...
import org.netbeans.modules.bpel.design.model.elements.WhileGateway;
...
public class WhilePattern extends CompositePattern {
    ...
    public FRectangle layoutPattern(LayoutManager manager) {
        float gx = -gateway.getWidth() - LayoutManager.HSPACING;
        float gy = -gateway.getHeight() - LayoutManager.VSPACING;
