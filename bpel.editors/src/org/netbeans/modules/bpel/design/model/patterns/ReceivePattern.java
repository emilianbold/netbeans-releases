...
import org.netbeans.modules.bpel.design.model.elements.ReceiveElement;
...
public class ReceivePattern extends BasicActivityPattern{
    ...
    protected void createElementsImpl() {
        VisualElement element = new ReceiveElement();
...
//        JPopupMenu menu = new JPopupMenu("Receive");
//        menu.add(new PropertyEditorAction(this));
//        menu.add(new RemoveAction(this, "Remove Receive Activity"));
//        return menu;
//    }
