...
public class OnAlarmEventPattern extends CompositePattern {
    ...
    public OnAlarmEventPattern(DiagramModel model) {
        super(model);
    }
    ...
    protected void createElementsImpl() {
        ...
        BpelEntity activity = ((OnAlarmEvent) getOMReference()).getScope();
        ...
        public void drop() {
            if (getDraggedPattern().getOMReference() instanceof Scope) {
                ...
                scope.setActivity((ExtendableActivity) getDraggedPattern()
                        .getOMReference());
                ((OnAlarmEvent) getOMReference()).setScope(scope);
            }            
        }
    }
}
