...
public class GlobalComplexTypeNode extends SchemaComponentNode<GlobalComplexType> {
    ...
    public GlobalComplexTypeNode(GlobalComplexType type, Children children, Lookup lookup) {
        super(type, children, lookup);
    }
    
    public GlobalComplexTypeNode(GlobalComplexType type, Lookup lookup) {
        super(type, lookup);
    }
    
    public NodeType getNodeType() {
        return NodeType.GLOBAL_COMPLEX_TYPE;
    }
    
    public VariableStereotype getStereotype() {
        return VariableStereotype.GLOBAL_COMPLEX_TYPE;
    }
