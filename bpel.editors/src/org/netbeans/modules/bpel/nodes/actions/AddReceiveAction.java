 ...
 *
 */
public class AddReceiveAction extends AddPaletteActivityAction {
    ...
    protected String getBundleName() {
        return NodeType.RECEIVE.getDisplayName(); // NOI18N
    }
    
    public ActionType getType() {
        return ActionType.ADD_RECEIVE;
    }
    ...
    protected ExtendableActivity getPaletteActivity(BpelModel model) {
        return model.getBuilder().createReceive();
    }
