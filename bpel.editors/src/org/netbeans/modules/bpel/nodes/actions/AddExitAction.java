 ...
 *
 */
public class AddExitAction extends AddPaletteActivityAction {
    ...
    protected String getBundleName() {
        return NodeType.EXIT.getDisplayName(); // NOI18N
    }
    
    public ActionType getType() {
        return ActionType.ADD_EXIT;
    }
    ...
    protected ExtendableActivity getPaletteActivity(BpelModel model) {
        return model.getBuilder().createExit();
    }
