 ...
 *
 */
public class AddRethrowAction extends AddPaletteActivityAction {
    private static final long serialVersionUID = 1L;

    public AddRethrowAction() {
        super("basic/rethrow"); // NOI18N
    }    
    
    protected String getBundleName() {
        return NodeType.RETHROW.getDisplayName(); // NOI18N
    }
    
    public ActionType getType() {
        return ActionType.ADD_RETHROW;
    }
    ...
    private boolean isSupportedParent(BpelEntity bpelEntity) {
        ...
        if (bpelEntity instanceof FaultHandler) {
            return true;
        }
    ...
    protected ExtendableActivity getPaletteActivity(BpelModel model) {
        return model.getBuilder().createRethrow();
    }
