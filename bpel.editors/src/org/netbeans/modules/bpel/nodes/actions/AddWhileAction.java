 ...
 *
 */
public class AddWhileAction extends AddPaletteActivityAction {
    ...
    protected String getBundleName() {
        return NodeType.WHILE.getDisplayName(); // NOI18N
    }
    
    public ActionType getType() {
        return ActionType.ADD_WHILE;
    }
    ...
    protected ExtendableActivity getPaletteActivity(BpelModel model) {
        return model.getBuilder().createWhile();
    }
