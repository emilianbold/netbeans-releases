 ...
 *
 */
public class AddCompensateScopeAction extends AddPaletteActivityAction {
    ...
    protected String getBundleName() {
        return NodeType.COMPENSATE_SCOPE.getDisplayName(); // NOI18N
    }
    
    public ActionType getType() {
        return ActionType.ADD_COMPENSATE_SCOPE;
    }
    ...
    protected ExtendableActivity getPaletteActivity(BpelModel model) {
        return model.getBuilder().createCompensateScope();
    }
