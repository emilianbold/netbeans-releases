 ...
 *
 */
public class AddSequenceAction extends AddPaletteActivityAction {
    private static final long serialVersionUID = 1L;

    public AddSequenceAction() {
        super("structured/sequence"); // NOI18N
    }    
    
    protected String getBundleName() {
        return NodeType.SEQUENCE.getDisplayName(); // NOI18N
    }
    
    public ActionType getType() {
        return ActionType.ADD_SEQUENCE;
    }
    ...
    protected ExtendableActivity getPaletteActivity(BpelModel model) {
        return model.getBuilder().createSequence();
    }
