 ...
 *
 */
public class AddScopeAction extends AddPaletteActivityAction {
    ...
    public boolean isContainerSupportChildType(BpelContainer container) {
        if (container instanceof ScopeHolder 
                && ((ScopeHolder)container).getScope() != null) {
            return false;
        }
        return true;
    }
    ...
    protected String getBundleName() {
        return NodeType.SCOPE.getDisplayName(); // NOI18N
    }
    
    public ActionType getType() {
        return ActionType.ADD_SCOPE;
    }
    ...
    protected ExtendableActivity getPaletteActivity(BpelModel model) {
        return model.getBuilder().createScope();
    }
