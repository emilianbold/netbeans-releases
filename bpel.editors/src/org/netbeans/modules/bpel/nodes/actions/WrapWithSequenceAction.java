 ...
 * @version 1.0
 */
public class WrapWithSequenceAction extends AbstractWrapWithAction<Sequence> {

    public WrapWithSequenceAction() {
    }
    ...
    public Activity getWrapEntity(BpelContainer parent) {
        return parent.getBpelModel().getBuilder().createSequence();
    }
}
