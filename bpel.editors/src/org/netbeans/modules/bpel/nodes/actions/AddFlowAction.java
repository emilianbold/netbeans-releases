 ...
 *
 */
public class AddFlowAction extends AddPaletteActivityAction {
    ...
    protected String getBundleName() {
        return NodeType.FLOW.getDisplayName(); // NOI18N
    }
    
    public ActionType getType() {
        return ActionType.ADD_FLOW;
    }
    ...
    protected ExtendableActivity getPaletteActivity(BpelModel model) {
        return model.getBuilder().createFlow();
    }
