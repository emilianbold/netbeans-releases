...
public class MoveElseIfLeftAction extends BpelNodeAction {

    private static final long serialVersionUID = 1L;

    protected String getBundleName() {
        return NbBundle.getMessage(getClass(), "CTL_MoveElseIfLeftAction"); // NOI18N
    }

    public ActionType getType() {
        return ActionType.MOVE_ELSE_IF_LEFT;
    }
    ...
    protected void performAction(BpelEntity[] bpelEntities) {
        ...
        for (int i = 1; i < elseIfs.length; i++) {
