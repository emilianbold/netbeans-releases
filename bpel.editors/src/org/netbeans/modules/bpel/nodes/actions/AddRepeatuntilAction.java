 ...
 *
 */
public class AddRepeatuntilAction extends AddPaletteActivityAction {
    ...
    protected String getBundleName() {
        return NodeType.REPEAT_UNTIL.getDisplayName(); // NOI18N
    }
    
    public ActionType getType() {
        return ActionType.ADD_REPEAT_UNTIL;
    }
    ...
    protected ExtendableActivity getPaletteActivity(BpelModel model) {
        return model.getBuilder().createRepeatUntil();
    }
