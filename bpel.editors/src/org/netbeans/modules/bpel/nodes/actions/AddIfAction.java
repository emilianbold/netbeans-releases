 ...
 *
 */
public class AddIfAction extends AddPaletteActivityAction {
    private static final long serialVersionUID = 1L;

    public AddIfAction() {
        super("structured/if"); // NOI18N
    }    
    
    protected String getBundleName() {
        return NodeType.IF.getDisplayName(); // NOI18N
    }
    
    public ActionType getType() {
        return ActionType.ADD_IF;
    }
    ...
    protected ExtendableActivity getPaletteActivity(BpelModel model) {
        return model.getBuilder().createIf();
    }
