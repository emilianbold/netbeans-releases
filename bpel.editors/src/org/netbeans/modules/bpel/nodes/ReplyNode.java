 ...
 * @author nk160297
 */
public class ReplyNode extends DiagramBpelNode<Reply, DiagramExtInfo> {
...
// Issue 85553 end.        
        ...
        property = PropertyUtils.registerAttributeProperty(myInstanceRef, 
                messagePropertySet,
                VariableReference.VARIABLE, OUTPUT, 
        ...
        property = PropertyUtils.registerAttributeProperty(myInstanceRef, 
                faultPropertySet,
                VariableReference.VARIABLE, FAULT_VARIABLE_REF, 
    ...
    public Component getCustomizer() {
        return new ReplyCustomEditor(this, EditingMode.EDIT_INSTANCE);
    }
