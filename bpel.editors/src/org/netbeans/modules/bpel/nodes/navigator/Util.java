...
//////        return getClosestBaseScopes(childOneLevelEntities);
    ...
    public static FileObject getFileObjectByModel(BpelModel model) {
        if (model != null){
    ...
    public static int getLineNum(BpelEntity entity) {
    ...
    public static int getColumnNum(BpelEntity entity) {
        int position = entity.findPosition();
        ModelSource modelSource = entity.getBpelModel().getModelSource();
        assert modelSource != null;
        Lookup lookup = modelSource.getLookup();
