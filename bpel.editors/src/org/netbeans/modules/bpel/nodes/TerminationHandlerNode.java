...
public class TerminationHandlerNode
        extends DiagramBpelNode<TerminationHandler, DiagramExtInfo>
{

    public TerminationHandlerNode(TerminationHandler reference, Lookup lookup) {
        super(reference, lookup);
    }

    public TerminationHandlerNode(TerminationHandler reference, 
