...
// Issue 85553 end        
        ...
        property = PropertyUtils.registerAttributeProperty(selfReference, 
                messagePropertySet,
                VariableReference.VARIABLE, EVENT_VARIABLE_NAME,
    ...
    public Component getCustomizer() {
        return new OnEventCustomEditor(this, EditingMode.EDIT_INSTANCE);
    }
        ...
        if (event != null) {
            ...
            event.getBpelModel().invoke(new Callable() {
                public Object call() throws Exception {
                    ...
                    FromPart[] fromPartArr = event.getFromParts();
                    if (fromPartArr != null) {
                        for (int index = 0; index < fromPartArr.length; index++) {
                            event.removeFromPart(index);
                        }
                    }
                    //
                    updateVarTypeAttribute(event);
