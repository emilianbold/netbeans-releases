 ...
 * @author nk160297
 */
public class MessageExchangeChildren extends BaseScopeChildren {
    
    public MessageExchangeChildren(BaseScope bScope, Lookup lookup) {
        super(bScope, lookup);
    }
        ...
        if (meContainer != null) {
            ...
            for (MessageExchange mExch : mExchangeArr) {
                Node newNode = nodeFactory.createNode(
                        NodeType.MESSAGE_EXCHANGE, mExch, null, myLookup);
