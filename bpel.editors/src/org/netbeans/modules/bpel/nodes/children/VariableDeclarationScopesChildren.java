...
public class VariableDeclarationScopesChildren extends Children.Keys
    ...
    protected Node[] createNodes(Object key) {
        ...
        for (VariableDeclaration varDecl : varDeclArr) {
            Node newNode = nodeFactory.createNode(
                    NodeType.VARIABLE, varDecl, null, myLookup);
            nodesList.add(newNode);
        }
        //
    ...
    private Node createVdScopeNode(
        ...
        //
        NodeType bpelNodeType = NavigatorNodeFactory.getBasicNodeType(vdScope);
        Node newNode = nodeFactory.createNode(
                bpelNodeType, vdScope, null, myLookup);
        //
        return newNode;
    }
    ...
    private class MyVariableTypeInfoProvider implements VariableTypeInfoProvider {
        ...
        public Constants.VariableStereotype getVariableStereotype() {
            return VariableNode.getVariableStereotype(varDecl);
        }
        
        public Object getVariableType() {
            return VariableNode.getVariableType(varDecl);
        }
