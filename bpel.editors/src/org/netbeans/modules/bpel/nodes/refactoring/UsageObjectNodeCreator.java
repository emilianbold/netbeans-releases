 ...
 *
 */
public class UsageObjectNodeCreator extends RefactoringNodeCreatorAbstract {

    public UsageObjectNodeCreator() {
    }

    public boolean isSupported(UsageNodeType nodeType) {
        return nodeType == UsageNodeType.USAGE_OBJECT;
    }
    ...
    public Node create(UsageNodeType nodeType, Object reference) {
        ...
        if (node != null) {
            node =  new UsageObjectNode((BpelNode) node);
        }
