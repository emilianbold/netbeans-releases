 ...
 *
 */
public class UsageContextNodeCreator extends RefactoringNodeCreatorAbstract {

    public UsageContextNodeCreator() {
    }

    public boolean isSupported(UsageNodeType nodeType) {
        return nodeType == UsageNodeType.USAGE_CONTEXT;
    }
    ...
    public Node create(UsageNodeType nodeType, Object reference) {
        ...
        if (node != null) {
            node =  new UsageContextNode(node);
        }
