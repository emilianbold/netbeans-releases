 ...
 *
 */
public class FromPartNode extends DiagramBpelNode<FromPart, DiagramExtInfo>{
...
//        BpelReference<VariableDeclaration> toVar = fromPart.getToVariable();
//        result.append(toVar == null ? EMPTY_STRING 
//                : TO_VARIABLE_EQ+toVar.getRefString()); 
//
//        return NbBundle.getMessage(FromPartNode.class,
//            "LBL_FROM_PART_NODE_TOOLTIP", // NOI18N
//            result.toString()
//            );
//    }
