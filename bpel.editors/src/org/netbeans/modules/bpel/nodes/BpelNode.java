...
//            sourceEntity = ((EntityUpdateEvent)event).getOldValue();
    ...
    private Image getDebuggerBadgedImage(Image nodeImage ) {
        return org.netbeans.modules.bpel.properties.Util.getBadgedIcon(
...
//        System.out.println("getted Debug annotationType: "+annotationDebugType);
        ...
        if (isErrorBadged) {
            return getErrorBadge() != null
                    ? org.netbeans.modules.bpel.properties.Util.getBadgedIcon(
...
//        return "[" + getNodeType().getDisplayName() + "]"; // NOI18N
...
//    }
    ...
    public Action[] getActions(boolean b) {
        Action[] actions = createActionsArray();
    ...
    private Action[] createActionsArray() {
