...
public class BpelMultiviewProviderImpl implements BpelMultiviewProvider {
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.bpel.core.multiview.spi.BpelMultiviewProvider#createMultiview(org.netbeans.modules.bpel.core.BPELDataObject)
     */
    public MultiViewDescription createMultiview( BPELDataObject dataObject ) {
        return new DesignerMultiViewElementDesc( dataObject );
    }
