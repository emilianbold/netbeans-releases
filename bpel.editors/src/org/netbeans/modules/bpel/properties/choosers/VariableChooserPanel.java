/*
 * VariableChooserPanel1.java
 *
 * Created on 9 Сентябрь 2006 г., 10:54
 */
 ...
 * @author  supernikita
 */
public class VariableChooserPanel extends AbstractTreeChooserPanel
        implements Reusable  {
     ...
     */
    public void setSelectedVariable(VariableDeclaration newValue) {
        if (newValue != null) {
            //
    ...
    public VariableDeclaration getSelectedVariable() {
    ...
    private class MyValidator extends DefaultChooserValidator {
        ...
        public boolean doDetailedValidation() {
            ...
            if (varVisScope != null) {
                ...
                //
                VariableDeclaration selectedVar = getSelectedVariable();
                if (selectedVar != null) {
                    ...
                    while(itr.hasNext()) {
                        ...
                        if (!varInScope.equals(selectedVar)) {
                            ...
                            SwingUtilities.invokeLater(new Runnable() {
                                public void run() {
                                    setSelectedVariable(varInScope);
                                }
                            });
                        }
                        break;
