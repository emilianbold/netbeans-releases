 ...
 * @author  nk160297
 */
public class CorrelationPropertyTypeChooserPanel extends AbstractTreeChooserPanel
        implements Reusable {
    ...
    public CorrelationPropertyTypeChooserPanel(StereotypeFilter stereotypeFilter, Lookup lookup) {
        super(lookup);
...
/*
    ...
    public void setSelectedType(final TypeContainer typeContainer) {
        ...
        if (stereotype == null) {
            setSelectedValue(null);
            String messageText = NbBundle.getMessage(FormBundle.class,
                    "ERR_PROPERTY_TYPE_RESOLVE_PROBLEM", // NOI18N
...
//                        }
    ...
    private class MyValidator extends DefaultChooserValidator {
        ...
        protected String getIncorrectNodeSelectionReasonKey() {
            return "ERR_PROPERTY_TYPE_NOT_SPECIFIED"; // NOI18N
        }
