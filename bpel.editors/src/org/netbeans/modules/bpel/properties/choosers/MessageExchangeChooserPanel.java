 ...
 * @author nk160297
 */
public class MessageExchangeChooserPanel extends AbstractTreeChooserPanel
        implements Reusable {
     ...
     */
    public void setSelectedMessageExchange(MessageExchange newValue) {
        if (newValue != null) {
    ...
    public MessageExchange getSelectedMessageExchange() {
