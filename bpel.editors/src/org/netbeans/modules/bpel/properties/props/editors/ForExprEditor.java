 ...
 * @author nk160297
 */
public class ForExprEditor extends ExpressionPropEditor<For> implements Reusable {

    public ForExprEditor() {
    }

    protected For createNewExpression(BpelModel model) {
        return model.getBuilder().createFor();
    }
