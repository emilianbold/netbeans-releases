...
import org.netbeans.modules.bpel.nodes.InstanceRef;
import org.netbeans.modules.bpel.properties.Constants;
import org.netbeans.modules.bpel.properties.PropertyType;
import org.netbeans.modules.bpel.properties.UserNotification;
import org.netbeans.modules.bpel.properties.editors.FormBundle;
import org.netbeans.modules.bpel.properties.editors.controls.ClassBasedPool;
        ...
        try {
            ...
            if (objRef == null && instanceRef != null) {
                ...
                if (prop != null) {
                    ...
                    prop.setValue(Constants.PROPERTY_TYPE_ATTRIBUTE, propertyType);
                    ...
                    if (boundAttributeName != null && boundAttributeName.length() > 0) {
                        prop.setValue(Constants.BOUNDED_ATTRIBUTE_NAME,
                                boundAttributeName);
                    }
                    if (boundElementClass != null) {
                        prop.setValue(Constants.BOUNDED_ELEMENT_CLASS,
                                boundElementClass);
                    }
                    //
...
//    }
        ...
        for (Node.PropertySet propSet : node.getPropertySets()) {
            for (Node.Property prop : propSet.getProperties()) {
                ...
                Object boundedAttributeName = prop.getValue(
                        Constants.BOUNDED_ATTRIBUTE_NAME);
        ...
        for (Node.PropertySet propSet : node.getPropertySets()) {
            for (Node.Property prop : propSet.getProperties()) {
                ...
                Object boundedElementClass = prop.getValue(
                        Constants.BOUNDED_ELEMENT_CLASS);
    ...
    public static class Reflection extends Node.Property {
        ...
        private static Class findAccessibleClass(Object instance) {
            if (instance instanceof BpelEntity) {
                return ((BpelEntity)instance).getElementType();
            } else {
        ...
        public DocumentComponent getDocumentComponent() {
            ...
            if (ref != null) {
                ...
                if (ref instanceof BpelNode) {
                    BpelNode node = (BpelNode) ref;
                        ...
                        if (oldValue == null ||
                            ...
                            if (oldText == null || oldText.length() == 0) {
                                ...
                                String msg = NbBundle.getMessage(
                                        FormBundle.class, "ERR_REQURED_PROPERTY"); // NOI18N
