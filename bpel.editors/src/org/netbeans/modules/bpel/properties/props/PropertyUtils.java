 ...
 * @author nk160297
 */
public final class PropertyUtils  extends org.netbeans.modules.soa.ui.properties.PropertyUtils {
    ...
    public Reflection getReflection(InstanceRef instanceRef, Class valueType, Method getter, Method setter, Method remover) {
        return new PropertyUtils.Reflection(instanceRef, valueType, getter, setter, remover);
    }

    public Reflection getReflection(InstanceRef instanceRef, Class valueType, String getterName, String setterName, String removerName) throws NoSuchMethodException {
