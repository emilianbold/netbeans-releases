...
import org.netbeans.modules.bpel.properties.editors.controls.CustomNodeChooser;
...
public class FaultNamePropertyCustomizer extends ValidablePropertyCustomizer
        implements CustomNodeChooser, PropertyChangeListener {
    ...
    public void init(PropertyEnv propertyEnv, PropertyEditor propertyEditor) {
        ...
        myPropertyEnv.setState(getValidStateManager().isValid() ?
    ...
    public void createContent() {
        ...
        getChooserPanel().getExplorerManager().
            ...
            public void propertyChange(PropertyChangeEvent evt) {
                if (ExplorerManager.PROP_SELECTED_NODES.
                    ...
                    QName newFaultName = getChooserPanel().getSelectedFaultName();
        ...
        //
        getValidStateManager().ignoreValidator(
...
//System.out.println("calculateFaultNameFromText:");
    ...
    private void setFaultName(QName newValue, Object source) {
        ...
        if (newValue == null) {
            ...
            if (source != getChooserPanel()) {
                getChooserPanel().setSelectedFaultName(newValue);
            }
        }
        //
    }
    ...
    public Validator createValidator() {
        return new DefaultValidator((ValidStateManager.Provider)this) {
 ...
 */
    ...
    public void setDescriptor(NodeChooserDescriptor descriptor) {
    }
    ...
    public boolean initControls() {
        ...
        //
        getValidStateManager().addValidStateListener(new ValidStateListener() {
    ...
    public void setSelectedValue(Object newValue) {
        if (newValue != null && newValue instanceof QName) {
            setFaultName((QName)newValue, null);
        } else {
            setFaultName((QName)null, null);
        }
        //
        getValidator().revalidate(true);
    }
