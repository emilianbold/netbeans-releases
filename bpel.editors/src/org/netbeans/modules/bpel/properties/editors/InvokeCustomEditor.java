...
public class InvokeCustomEditor extends AbstractCustomNodeEditor<Invoke> {

    static final long serialVersionUID = 1L;

    private InvokeMainPanel mainPanel;
    private CorrelationPTablePanel correlationPanel;
    private JTabbedPane tabbedPane;
    
    public InvokeCustomEditor(InvokeNode replyNode, EditingMode mode) {
        super(replyNode);
        if (mode != null) {
            setEditingMode(mode);
        }
    ...
    public HelpCtx getHelpCtx() {
        ...
        if (comp != null && comp instanceof HelpCtx.Provider) {
            ...
            return new HelpCtx("org.netbeans.modules.bpel.design.nodes.NodeType.INVOKE"); // NOI18N
