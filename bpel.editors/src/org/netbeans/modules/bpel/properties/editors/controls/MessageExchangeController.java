...
//    private ConfigurationListener myListener;
    ...
    private void chooseMessageExchange() {
        ...
        VisibilityScope visScope = new VisibilityScope(
                (BpelEntity)myEditor.getModelNode().getReference(), lookup);
        ...
        if (myMsgEx != null) {
            mExchChooserPanel.setSelectedMessageExchange(myMsgEx);
        }
        ...
        if (descriptor.isOkHasPressed()) {
            MessageExchange newMExch =
                    mExchChooserPanel.getSelectedMessageExchange();
            if (newMExch != null) {
    ...
    private void recalculateMsgEx() {
        ...
        //
        Object obj = myEditor.getModelNode().getReference();
    ...
    public boolean initControls() {
        try {
            ...
            //
            Property prop = PropertyUtils.lookForPropertyByType(node,
