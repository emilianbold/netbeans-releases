...
public class CorrelationPropertyMainPanel extends EditorLifeCycleAdapter
    ...
    public boolean initControls() {
        try {
            ...
            //
            CorrelationProperty corrProp = myEditor.getModelNode().getReference();
            if (corrProp == null) {
    ...
    public boolean applyNewValues() {
        try {
            ...
            Model model = null;
            //
            TypeContainer tc = ((TypeChooserPanel)pnlTypeChooser).getSelectedType();
...
//                new ImportRegistrationHelper(var.getBpelModel()).addImport(model);
    ...
    private void initComponents() {
        ...
        lblPropertyName.setText(org.openide.util.NbBundle.getMessage(FormBundle.class, "LBL_VariableName"));
        lblPropertyName.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FormBundle.class,"ACSN_LBL_VariableName"));
        lblPropertyName.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FormBundle.class,"ACSD_LBL_VariableName"));
