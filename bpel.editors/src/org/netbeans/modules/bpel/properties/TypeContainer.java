...
public class TypeContainer {
    ...
    public TypeContainer(Part part) {
        myType = part;
    }
    ...
    public String getTypeName() {
        ...
        } else if (myType instanceof Part) {
            return ((Part)myType).getName();
    ...
    public QName getTypeQName() {
        if (myType instanceof Message) {
            ...
            String targetNamespace = ((Part)myType).getModel().
                    getDefinitions().getTargetNamespace();
            String localPart = ((Part)myType).getName();
            return new QName(targetNamespace, localPart);
        } else if (myType instanceof GlobalElement) {
