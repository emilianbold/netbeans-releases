...
/**
 * This interface is used to provide an abstraction over the DiscoveryConfig
...
public interface DiscoveryConfig extends TrustAuthorityConfig {
    ...
    public void registerProvider(ProviderConfig providerConfg);
    
    public void unregisterProvider(ProviderConfig providerConfg);
}
