...
/**
 * Notification of a completed process instance in the target BPEL Engine.
 * When a process instance is completed normally or with a fault or has been
 * terminated and there is a corresponding enabled
 ...
 */
public interface ProcessInstanceCompletedEvent extends Event {
    
    /**
     * Returns the process instance which is completed.
     *
     * @return the process instance which is completed
     */
