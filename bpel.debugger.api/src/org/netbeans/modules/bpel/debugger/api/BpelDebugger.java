...
public abstract class BpelDebugger {
    ...
    /**
     * Returns the debugger engine provider.
     *
     * @return the debugger engine provider
     */
    public final BpelDebuggerEngineProvider getEngineProvider() {
        return myDebuggerEngineProvider;
    }
}
