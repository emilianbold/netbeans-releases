...
public class MakefileOrConfigurePanel extends javax.swing.JPanel implements HelpCtx.Provider{
    ...
    void read(WizardDescriptor wizardDescriptor) {
        ...
        try {
            ...
            if (path != null) {
                ...
                ExecutionEnvironment env = (ExecutionEnvironment) wizardDescriptor.getProperty(ProjectTemplatePanel.REMOTE_FILE_ENV);
                FileSystem fileSystem = FileSystemProvider.getFileSystem(env);
                String configureScript = ConfigureUtils.findConfigureScript(fileSystem.findResource(path));
        ...
        try {
            ...
            if (makefileRadioButton.isSelected()) {
                ...
                if (i > 0) {// && !configureNameTextField.getText().isEmpty()) {
                    ExecutionEnvironment env = (ExecutionEnvironment) settings.getProperty(ProjectTemplatePanel.REMOTE_FILE_ENV);
                    FileSystem fileSystem = FileSystemProvider.getFileSystem(env);
                    String cn = ConfigureUtils.findConfigureScript(fileSystem.findResource(mn.substring(0,i)));
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("org/netbeans/modules/cnd/remote/projectui/wizard/cnd/Bundle"); // NOI18N
