...
public class EvaluatorLifecycle extends DebuggerManagerAdapter {
    ...
    private static final String EVALUATOR_LIFECYCLE_PROPERTIES = "EvaluatorLifecycle"; // NOI18N
    private static final String EVALUATOR_OPENED = "EvaluatorOpened"; // NOI18N
    ...
    public void engineAdded(DebuggerEngine engine) {
        ...
        if (d != null) {
            boolean opened = preferences.getBoolean(EVALUATOR_OPENED, false);
            if (opened) {
                openOrClose(true);
            }
        }
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                if (open) {
                    ...
                    preferences.putBoolean(EVALUATOR_OPENED, opened);
                    if (opened) {
