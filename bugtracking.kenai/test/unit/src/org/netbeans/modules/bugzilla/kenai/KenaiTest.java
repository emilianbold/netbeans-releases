...
public class KenaiTest extends NbTestCase implements TestConstants {
    ...
    public static final String KENAI_REPO_URL = "http://testjava.net/bugzilla";
    ...
    protected void setUp() throws Exception {
        ...
        if(proxy != null) {
            ...
            repository.setProperty(TaskRepository.PROXY_HOSTNAME, proxy);
            repository.setProperty(TaskRepository.PROXY_PORT, port);
        }
...
//        }
    ...
    public void testQuery() throws Throwable {
        try {
            ...
            String url = "/buglist.cgi?query_format=advanced&product=nb-jnet-test";
            ...
            IStatus status = brc.performQuery(repository, query, collector, null, NULL_PROGRESS_MONITOR);
