...
meth public void setValue(org.netbeans.api.lexer.Language<? extends org.netbeans.api.lexer.TokenId>,java.lang.Object,java.lang.Object,boolean)
...
meth public java.lang.String toString()
meth public org.netbeans.api.lexer.Language<? extends org.netbeans.api.lexer.TokenId> innerLanguage()
meth public org.netbeans.api.lexer.Language<? extends org.netbeans.api.lexer.TokenId> language(int)
meth public org.netbeans.api.lexer.Language<? extends org.netbeans.api.lexer.TokenId> topLanguage()
meth public org.netbeans.api.lexer.LanguagePath embedded(org.netbeans.api.lexer.Language<? extends org.netbeans.api.lexer.TokenId>)
...
meth public static org.netbeans.api.lexer.LanguagePath get(org.netbeans.api.lexer.Language<? extends org.netbeans.api.lexer.TokenId>)
meth public static org.netbeans.api.lexer.LanguagePath get(org.netbeans.api.lexer.LanguagePath,org.netbeans.api.lexer.Language<? extends org.netbeans.api.lexer.TokenId>)
supr java.lang.Object
...
meth public final static org.netbeans.api.lexer.PartType[] values()
...
meth public org.netbeans.api.lexer.TokenChange<? extends org.netbeans.api.lexer.TokenId> embeddedChange(int)
...
meth public boolean isSnapshotReleased()
meth public int tokenShiftEndOffset()
meth public int tokenShiftStartOffset()
meth public java.lang.String toString()
meth public java.util.List<org.netbeans.api.lexer.TokenSequence<? extends org.netbeans.api.lexer.TokenId>> embeddedTokenSequences(int,boolean)
meth public java.util.List<org.netbeans.api.lexer.TokenSequence<? extends org.netbeans.api.lexer.TokenId>> tokenSequenceList(org.netbeans.api.lexer.LanguagePath,int,int)
meth public java.util.Set<org.netbeans.api.lexer.LanguagePath> languagePaths()
meth public org.netbeans.api.lexer.TokenHierarchy<{org.netbeans.api.lexer.TokenHierarchy%0}> createSnapshot()
meth public org.netbeans.api.lexer.TokenHierarchy<{org.netbeans.api.lexer.TokenHierarchy%0}> snapshotOf()
meth public org.netbeans.api.lexer.TokenSequence<? extends org.netbeans.api.lexer.TokenId> tokenSequence()
meth public static <%0 extends javax.swing.text.Document> org.netbeans.api.lexer.TokenHierarchy<{%%0}> get({%%0})
meth public static <%0 extends org.netbeans.api.lexer.TokenId> org.netbeans.api.lexer.TokenHierarchy<java.lang.Void> create(java.io.Reader,org.netbeans.api.lexer.Language<{%%0}>,java.util.Set<{%%0}>,org.netbeans.api.lexer.InputAttributes)
meth public static <%0 extends org.netbeans.api.lexer.TokenId> org.netbeans.api.lexer.TokenHierarchy<java.lang.Void> create(java.lang.CharSequence,boolean,org.netbeans.api.lexer.Language<{%%0}>,java.util.Set<{%%0}>,org.netbeans.api.lexer.InputAttributes)
meth public static org.netbeans.api.lexer.TokenHierarchy<java.lang.Void> create(java.lang.CharSequence,org.netbeans.api.lexer.Language<? extends org.netbeans.api.lexer.TokenId>)
...
meth public void snapshotRelease()
meth public {org.netbeans.api.lexer.TokenHierarchy%0} mutableInputSource()
supr java.lang.Object
hfds operation
...
meth public org.netbeans.api.lexer.TokenChange<? extends org.netbeans.api.lexer.TokenId> tokenChange()
...
fld public final static org.netbeans.api.lexer.TokenHierarchyEventType EMBEDDING
...
meth public final static org.netbeans.api.lexer.TokenHierarchyEventType[] values()
...
meth public boolean createEmbedding(org.netbeans.api.lexer.Language<? extends org.netbeans.api.lexer.TokenId>,int,int)
meth public boolean createEmbedding(org.netbeans.api.lexer.Language<? extends org.netbeans.api.lexer.TokenId>,int,int,boolean)
...
meth public org.netbeans.api.lexer.TokenSequence<? extends org.netbeans.api.lexer.TokenId> embedded()
...
supr java.lang.Object
hfds modCount,parentTokenIndexes,token,tokenIndex,tokenList,tokenOffset
...
CLSS public abstract org.netbeans.spi.lexer.CharPreprocessor
cons public CharPreprocessor()
meth protected abstract boolean isSensitiveChar(char)
meth protected abstract int maxLookahead()
meth protected abstract void preprocessChar()
meth protected final int inputRead()
meth protected final void inputBackup(int)
meth protected final void notifyError(java.lang.String)
meth protected final void outputOriginal(int)
meth protected final void outputPreprocessed(char,int)
meth public static org.netbeans.spi.lexer.CharPreprocessor createUnicodeEscapesPreprocessor()
supr java.lang.Object
hfds operation
...
meth public final static org.netbeans.spi.lexer.EmbeddingPresence[] values()
...
meth protected org.netbeans.spi.lexer.CharPreprocessor createCharPreprocessor()
meth protected org.netbeans.spi.lexer.EmbeddingPresence embeddingPresence({org.netbeans.spi.lexer.LanguageHierarchy%0})
meth protected org.netbeans.spi.lexer.LanguageEmbedding<? extends org.netbeans.api.lexer.TokenId> embedding(org.netbeans.api.lexer.Token<{org.netbeans.spi.lexer.LanguageHierarchy%0}>,org.netbeans.api.lexer.LanguagePath,org.netbeans.api.lexer.InputAttributes)
...
meth public abstract org.netbeans.api.lexer.Language<? extends org.netbeans.api.lexer.TokenId> findLanguage(java.lang.String)
meth public abstract org.netbeans.spi.lexer.LanguageEmbedding<? extends org.netbeans.api.lexer.TokenId> findLanguageEmbedding(org.netbeans.api.lexer.Token<? extends org.netbeans.api.lexer.TokenId>,org.netbeans.api.lexer.LanguagePath,org.netbeans.api.lexer.InputAttributes)
...
meth public static java.lang.Integer integerState(int)
meth public void backup(int)
supr java.lang.Object
hfds charProvider,eof,readText
hcls ReadText
...
meth protected abstract org.netbeans.api.lexer.Language<? extends org.netbeans.api.lexer.TokenId> language()
...
meth public org.netbeans.api.lexer.Token<{org.netbeans.spi.lexer.TokenFactory%0}> createPropertyToken({org.netbeans.spi.lexer.TokenFactory%0},int,org.netbeans.spi.lexer.TokenPropertyProvider,org.netbeans.api.lexer.PartType)
