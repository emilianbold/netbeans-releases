...
public interface TriggerEditor {
    ...
    void setFields(boolean typeEditable, TriggerDetail td);
    void captureFields(TriggerDetail td);
    void validateFields(TriggerDetail td);
    void showError(SchedulerArgumentException sae);
