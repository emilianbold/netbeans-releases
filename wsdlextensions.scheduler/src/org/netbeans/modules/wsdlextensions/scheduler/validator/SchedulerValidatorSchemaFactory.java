 ...
 */
public class SchedulerValidatorSchemaFactory extends ValidatorSchemaFactory
        implements SchedulerConstants {
    
    public static final String schedulerXSDUrl =
        "/org/netbeans/modules/wsdlextensions/scheduler/resources/scheduler-ext.xsd";   //NOI18N
    ...
    public InputStream getSchemaInputStream() {
        return SchedulerValidatorSchemaFactory.class.getResourceAsStream(
                schedulerXSDUrl);
    }
    ...
    public Source getSchemaSource() {
        InputStream in = getSchemaInputStream();
        Source s = new StreamSource(in);
        s.setSystemId(SchedulerValidatorSchemaFactory.class
                .getResource(schedulerXSDUrl).toString());
        return s;
    }
}
