 ...
 */
public abstract class SchedulerComponentImpl extends GenericExtensibilityElement
        implements SchedulerComponent {

    public SchedulerComponentImpl(WSDLModel wsdModel, Element element) {
        super(wsdModel, element);
    }
