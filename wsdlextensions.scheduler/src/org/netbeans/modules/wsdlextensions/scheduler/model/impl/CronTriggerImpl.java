 ...
 */
public class CronTriggerImpl extends SchedulerTriggerImpl
        implements CronTrigger {

    public CronTriggerImpl(WSDLModel wsdlModel) {
        super(wsdlModel);
    }
    
    public CronTriggerImpl(WSDLModel wsdlModel, Element element) {
        super(wsdlModel, element);
    }

    @Override
    public String getType() {
        return TriggerType.CRON.getProgName();
    }

    @Override
    public void setType(String type) {
        super.setType(TriggerType.CRON.getProgName());
    }
