...
import org.netbeans.modules.wsdlextensions.scheduler.configeditor.StaticScheduleStepWizardPanel;
 ...
 */
public class SchedulerWSDLWizardExtensionIterator
    ...
    public SchedulerWSDLWizardExtensionIterator(WSDLWizardContext context) {
        super(context);
    }
    ...
    public void setTemplateName(String templateName) {
        ...
        panels = new WSDLWizardDescriptorPanel[0];
        if (templateName.equals(OperationMode.STATIC.getTemplateName())) {
            panels = new WSDLWizardDescriptorPanel[]{
                        new StaticScheduleStepWizardPanel(context),
                    };
        }
    ...
    public String[] getSteps() {
        assert templateName != null : "template is not set";            //NOI18N
        return steps;
    }
    ...
    public boolean commit() {
        ...
        for (WSDLWizardDescriptorPanel panel : panels) {
            if (panel instanceof StaticScheduleStepWizardPanel) {                                
                status = ((StaticScheduleStepWizardPanel) panel).commit();                 
            }
