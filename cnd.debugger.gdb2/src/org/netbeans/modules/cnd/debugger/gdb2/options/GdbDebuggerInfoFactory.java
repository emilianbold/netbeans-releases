...
import org.netbeans.modules.cnd.debugger.gdb2.GdbDebuggerInfoAccessor;
...
public final class GdbDebuggerInfoFactory {
	...
	return GdbDebuggerInfoAccessor.getDefault().create(dt, hostName, conf, action, targetCommand);
    }
