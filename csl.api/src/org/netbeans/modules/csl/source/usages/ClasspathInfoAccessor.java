...
public abstract class ClasspathInfoAccessor {
    ...
    public static void setInstance(ClasspathInfoAccessor newInstance) {
...
//    
    ...
    public abstract ClasspathInfo create (FileObject fo, Object/*JavaFileFilterImplementation*/ filter, boolean backgroundCompilation, boolean ignoreExcludes);
    
    public abstract ClasspathInfo create (ClassPath bootPath, ClassPath compilePath, ClassPath sourcePath, Object/*JavaFileFilterImplementation*/ filter,
