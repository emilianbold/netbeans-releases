...
public class DefaultComponentFactory extends ComponentFactory {
    ...
    @Override
    public FileNameComboBox createFileNameComboBox() {
        return new DefaultFileNameComboBox();
    }

    @Override
    public ScopeComboBox createScopeComboBox() {
        return new org.netbeans.modules.search.ScopeComboBox(
                FindDialogMemory.getDefault().getScopeTypeId());
    }

    @Override
    public ScopeSettingsPanel createScopeSettingsPanel(boolean searchAndReplace,
