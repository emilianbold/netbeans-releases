 ...
 * @author jhavlin
 */
public abstract class TerminationFlag {

    /**
     * Method providing access to a flag indicating that the search has been
     * terminated.
     *
     * @return True if the search has been terminated by user, false if
