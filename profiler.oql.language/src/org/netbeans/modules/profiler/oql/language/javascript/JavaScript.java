...
public class JavaScript {
    ...
    private static final String DOC = "org/netbeans/modules/profiler/oql/language/javascript/Documentation.xml";
    private static final String MIME_TYPE = "text/x-oql";
