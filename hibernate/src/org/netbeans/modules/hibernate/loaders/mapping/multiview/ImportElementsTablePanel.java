 ...
 * @author Dongmei Cao
 */
public class ImportElementsTablePanel extends DefaultTablePanel {
    
    private ImportElementsTableModel model;
    private HibernateMappingDataObject mappingDataObject;

    /** Creates new form EventTablePanel */
    public ImportElementsTablePanel(final HibernateMappingDataObject dObj, final ImportElementsTableModel model) {
    	super(model);
    	this.model=model;
