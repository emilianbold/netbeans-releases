 ...
 * @author  Dongmei Cao
 */
public class MetaDataPanel extends SectionInnerPanel {

    public MetaDataPanel(SectionView view, final HibernateMappingDataObject dObj) {
        super(view);
        initComponents();
        MetaDataTableModel model = new MetaDataTableModel(dObj.getHibernateMapping());
        MetaDataTablePanel panel = new MetaDataTablePanel(dObj, model);
