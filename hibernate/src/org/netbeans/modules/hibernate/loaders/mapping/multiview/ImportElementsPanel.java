 ...
 * @author  Dongmei Cao
 */
public class ImportElementsPanel extends SectionInnerPanel {

    public ImportElementsPanel(SectionView view, final HibernateMappingDataObject dObj) {
        super(view);
        initComponents();
        ImportElementsTableModel model = new ImportElementsTableModel(dObj.getHibernateMapping());
        ImportElementsTablePanel panel = new ImportElementsTablePanel(dObj, model);
