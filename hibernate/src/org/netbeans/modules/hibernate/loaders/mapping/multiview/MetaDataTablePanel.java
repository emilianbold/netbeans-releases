 ...
 * @author Dongmei Cao
 */
public class MetaDataTablePanel extends DefaultTablePanel {
    
    private MetaDataTableModel model;
    private HibernateMappingDataObject mappingDataObject;

    /** Creates new form EventTablePanel */
    public MetaDataTablePanel(final HibernateMappingDataObject dObj, final MetaDataTableModel model) {
    	super(model);
    	this.model=model;
    ...
    private class TableActionListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            ...
            EditDialog dialog = new EditDialog(dialogPanel, NbBundle.getMessage(MetaDataTablePanel.class, "LBL_Meta"), add) {
                ...
                protected String validate() {
                    ...
                    if (attribute.length() == 0) {
                        return NbBundle.getMessage(MetaDataTablePanel.class, "TXT_Meta_Attribute_Empty");
                    } 
                    
                    if( value.length() == 0 ) {
                        return NbBundle.getMessage(MetaDataTablePanel.class, "TXT_Meta_Value_Empty");
                    }
