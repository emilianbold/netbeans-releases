 ...
 * @author  Dongmei Cao
 */
public class EventPanel extends SectionInnerPanel {

    public EventPanel(SectionView view, final HibernateCfgDataObject dObj, Event event) {
        super(view);
        initComponents();
        // Error Pages
        EventTableModel model = new EventTableModel(event);
        EventTablePanel panel = new EventTablePanel(dObj, model);
