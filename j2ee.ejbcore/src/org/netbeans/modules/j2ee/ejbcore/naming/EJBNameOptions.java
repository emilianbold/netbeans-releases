...
public final class EJBNameOptions extends AdvancedOption {
    ...
    private static final String DEFAULT_LOCAL_PREFIX = "Local";
    private static final String DEFAULT_HOME_SUFFIX= "Home";
    ...
    public String getSessionLocalPrefix() { return prefs().get(SESSION_LOCAL_PREFIX, DEFAULT_LOCAL_PREFIX); } // NOI18N
    public void setSessionLocalPrefix(String prefix) { prefs().put(SESSION_LOCAL_PREFIX, prefix); }
    public String getSessionLocalSuffix() { return prefs().get(SESSION_LOCAL_SUFFIX, ""); } // NOI18N
    ...
    public String getSessionRemoteSuffix() { return prefs().get(SESSION_REMOTE_SUFFIX, ""); } // NOI18N
    public void setSessionRemoteSuffix(String suffix) { prefs().put(SESSION_REMOTE_SUFFIX, suffix); }
    public String getSessionLocalHomePrefix() { return prefs().get(SESSION_LOCALHOME_PREFIX, DEFAULT_LOCAL_PREFIX); } // NOI18N
    public void setSessionLocalHomePrefix(String prefix) { prefs().put(SESSION_LOCALHOME_PREFIX, prefix); }
    public String getSessionLocalHomeSuffix() { return prefs().get(SESSION_LOCALHOME_SUFFIX, DEFAULT_HOME_SUFFIX); } // NOI18N
    ...
    public String getSessionRemoteHomeSuffix() { return prefs().get(SESSION_REMOTEHOME_SUFFIX, DEFAULT_HOME_SUFFIX); } // NOI18N
    ...
    public String getSessionEjbNameSuffix() { return prefs().get(SESSION_EJBNAME_SUFFIX, "EJB"); } // NOI18N
    ...
    public String getEntityLocalPrefix() { return prefs().get(ENTITY_LOCAL_PREFIX, DEFAULT_LOCAL_PREFIX); } // NOI18N
    public void setEntityLocalPrefix(String prefix) { prefs().put(ENTITY_LOCAL_PREFIX, prefix); }
    public String getEntityLocalSuffix() { return prefs().get(ENTITY_LOCAL_SUFFIX, ""); } // NOI18N
    ...
    public String getEntityRemoteSuffix() { return prefs().get(ENTITY_REMOTE_SUFFIX, ""); } // NOI18N
    public void setEntityRemoteSuffix(String suffix) { prefs().put(ENTITY_REMOTE_SUFFIX, suffix); }
    public String getEntityLocalHomePrefix() { return prefs().get(ENTITY_LOCALHOME_PREFIX, DEFAULT_LOCAL_PREFIX); } // NOI18N
    ...
    public String getMessageDrivenEjbNameSuffix() { return prefs().get(MESSAGEDRIVEN_EJBNAME_SUFFIX, "EJB"); } // NOI18N
