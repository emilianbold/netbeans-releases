...
public class SessionGeneratorTest extends TestBase {
    ...
    public void testGenerateJavaEE14() throws IOException {
        ...
        SessionGenerator sessionGenerator = new SessionGenerator("TestStatelessLR", packageFileObject, true, true, Session.SESSION_TYPE_STATELESS, false, false, true, null, false, true);
        ...
        sessionGenerator = new SessionGenerator("TestStatefulLR", packageFileObject, false, true, Session.SESSION_TYPE_STATEFUL, false, false, true, null, false, true);
        sessionGenerator.generate();
    ...
    public void testGenerateJavaEE50() throws IOException {
        ...
        SessionGenerator sessionGenerator = new SessionGenerator("TestStateless", packageFileObject, true, true, Session.SESSION_TYPE_STATELESS, true, false, false, null, false, true);
        sessionGenerator.generate();
        ...
        sessionGenerator = new SessionGenerator("TestStateful", packageFileObject, true, false, Session.SESSION_TYPE_STATEFUL, true, false, false, null, false, true);
        sessionGenerator.generate();
    ...
    public void testGenerateJavaEE60() throws IOException {
        ...
        sessionGenerator = new SessionGenerator("TestSingleton", packageFileObject, false, false, Session.SESSION_TYPE_SINGLETON, true, false, false, null, false, true);
        sessionGenerator.generate();
