 ...
 * @author Radek Matous
 */
public class CoreSettingsTest extends BasicTestForImport {
    ...
    public void testPreferedShortEmptyElement() throws Exception {
        assertPropertyType("preferedShortEmptyElement","java.lang.Boolean");
        assertProperty("preferedShortEmptyElement","true");
    }
    public void testAutoParsingDelay() throws Exception {
        assertPropertyType("autoParsingDelay","java.lang.Integer");
        assertProperty("autoParsingDelay","3000");
    }
