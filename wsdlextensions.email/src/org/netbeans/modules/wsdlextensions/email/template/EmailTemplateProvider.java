...
public class EmailTemplateProvider extends ExtensibilityElementTemplateProvider {
    ...
    public InputStream getTemplateFileInputStream(String filePath) {
        return EmailTemplateProvider.class.getResourceAsStream("/org/netbeans/modules/wsdlextensions/email/template/" + filePath);
    }
    
    @Override
    public WSDLWizardExtensionIterator getWSDLWizardExtensionIterator(WSDLWizardContext context) {
        return new EmailWSDLWizardExtensionIterator(context);
    }    
