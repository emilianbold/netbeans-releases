...
public class POP3InputImpl extends POP3ComponentImpl implements POP3Input {
    ...
    public String getMessage() {
     ...
     public void setCharset(String val) {
		 setAttribute(POP3Input.EMAIL_CHAR_SET, EMAILAttribute.EMAIL_CHARSET_NAME, val);
     }
     ...
     public void setUse(String val){
        setAttribute(POP3Input.EMAIL_USE, EMAILAttribute.EMAIL_USE, val);
     }
     ...
     public void setEncodingStyle(String val){
        setAttribute(POP3Input.EMAIL_ENCODINGSTYLE, EMAILAttribute.EMAIL_ENCODING_STYLE, val);
     }
     ...
     public void setNewsgroups(String newsGroup){
        setAttribute(POP3Input.EMAIL_NEWSGROUP, EMAILAttribute.EMAIL_NEWSGROUP, newsGroup);
     }
     ...
     public void setHandleNMAttachments(boolean val){
        setAttribute(POP3Input.EMAIL_HANDLENMATT, EMAILAttribute.EMAIL_HANDLE_NM_ATT, val);
     }
     ...
     public void setSaveAttachmentsToDir(String val){
        setAttribute(POP3Input.EMAIL_SAVEATTDIR, EMAILAttribute.EMAIL_SAVE_ATT_DIR, val);
     }
