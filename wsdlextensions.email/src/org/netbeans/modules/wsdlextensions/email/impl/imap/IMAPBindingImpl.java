 ...
 *
 */
public class IMAPBindingImpl extends IMAPComponentImpl implements IMAPBinding {
    public IMAPBindingImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
    public IMAPBindingImpl(WSDLModel model){
        this(model, createPrefixedElement(IMAPQName.BINDING.getQName(), model));
    }
