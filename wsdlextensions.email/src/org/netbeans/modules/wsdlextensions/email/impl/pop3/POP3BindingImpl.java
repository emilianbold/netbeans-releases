 ...
 *
 */
public class POP3BindingImpl extends POP3ComponentImpl implements POP3Binding {
    public POP3BindingImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
    public POP3BindingImpl(WSDLModel model){
        this(model, createPrefixedElement(POP3QName.BINDING.getQName(), model));
    }
