...
*/
public abstract class IMAPComponentImpl extends GenericExtensibilityElement implements IMAPComponent {
    public IMAPComponentImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
    protected String getNamespaceURI() {
        return IMAPQName.EMAIL_NS_URI;
    }
}
