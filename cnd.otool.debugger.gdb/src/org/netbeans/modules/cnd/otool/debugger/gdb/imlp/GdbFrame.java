...
public final class GdbFrame extends OtoolNativeFrame {
  
    private MITList MIframe;
    private final List<GdbLocal> argsArray = new ArrayList<>();


    public GdbFrame(OtoolGdbDebugger debugger, MIValue frame, MIResult frameargs, OtoolNativeThread thread) {
	...
	return new ArrayList(argsArray);
    }
