...
import org.netbeans.modules.cnd.debugger.gdb.mi.MIConst;
...
public class GdbVersionPeculiarity {
    ...
    private GdbVersionPeculiarity(Version version) {
        this.version = version;
    }

    public static GdbVersionPeculiarity create(Version version) {
        return new GdbVersionPeculiarity(version);
    }
    ...
    public boolean isSupported() {
        return (version.compareTo(6, 8) >= 0);
    }
