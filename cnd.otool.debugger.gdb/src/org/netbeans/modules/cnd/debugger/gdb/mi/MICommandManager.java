...
class MICommandManager {
    ...
    void finish(MICommand cmd) {
        ...
        System.out.println("MICommandManager.finish() remove from pending commands" + String.format("## finished %d\n\r", cmd.getToken())); // NOI18N
        System.out.println("MICommandManager.finish()" + String.format("## outstanding: ")); // NOI18N
        synchronized (pendingCommands) {
            if (pendingCommands.isEmpty()) {
                System.out.println("MICommandManager.finish()" + String.format("none")); // NOI18N
            } else {
                for (MICommand oc : pendingCommands) {
                    System.out.println("MICommandManager.finish()" + String.format(" %s", oc.toString())); // NOI18N
                }
            }
        }
        System.out.println("MICommandManager.finish()" + String.format("\n\r")); // NOI18N
