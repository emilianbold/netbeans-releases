...
public class ApplicationBean1 extends AbstractApplicationBean {
    ...
    public void init() {
        ...
        this.genres = new String[]{ "Action/Adventure", "Comedy", "Drama", "Foreign" };
        this.genreOptions = new Option[this.genres.length];
        for ( int i = 0; i < getGenres().length; i++ ) {
            genreOptions[i] = new Option(getGenres()[i]);
        }
        this.ratings = new String[]{"G", "PG", "PG-13", "R", "NC-17"};
        this.ratingOptions = new Option[this.ratings.length];
        for ( int j = 0; j < this.getRatings().length; j++ ) {
            ratingOptions[j] = new Option(getRatings()[j]);
        }
    }
    ...
    public Option[] getRatingOptions() {
