...
public class SessionBean1 extends AbstractSessionBean {
    ...
    private RowKey currentPersonRowKey;

    public RowKey getCurrentPersonRowKey() {
        return currentPersonRowKey;
    }

    public void setCurrentPersonRowKey(RowKey currentPersonRowKey) {
        this.currentPersonRowKey = currentPersonRowKey;
    }
}
