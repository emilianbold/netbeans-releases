 ...
 */
public class ChooseVehicle extends AbstractPageBean {
    ...
    public void setReport(Button b) {
        this.report = b;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("ChooseVehicle Initialization Failure", e);
    ...
    public String report_action() {
        ...
        try {
            CachedRowSet searchVehicleRowSet = getSessionBean1().getVehicleRowSet();
            String stateId = (String) getValue("#{currentRow.value['vehicle.stateid']}");
            String licensePlate = (String) getValue("#{currentRow.value['vehicle.licenseplate']}");
            String make = (String) getValue("#{currentRow.value['vehicle.make']}");
            String model = (String) getValue("#{currentRow.value['vehicle.model']}");
            String color = (String) getValue("#{currentRow.value['vehicle.color']}");
