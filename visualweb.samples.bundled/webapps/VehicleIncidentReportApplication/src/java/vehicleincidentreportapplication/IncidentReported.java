 ...
 */
public class IncidentReported extends AbstractPageBean {
    ...
    private StaticText incident = new StaticText();

    public StaticText getIncident() {
        return incident;
    }

    public void setIncident(StaticText st) {
        this.incident = st;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("IncidentReported Initialization Failure", e);
