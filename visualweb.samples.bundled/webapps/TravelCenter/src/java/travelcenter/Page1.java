...
public class Page1 extends AbstractPageBean {
    ...
    public void prerender() {
        ...
        try {
            Integer id = (Integer) getPersonId().getSelected();
            if (id == null) {
                id = (Integer) getPersonDataProvider().getValue("PERSON.PERSONID");
            }
            getSessionBean1().getTripRowSet().setObject(1, id);
            getTripDataProvider().refresh();
        } catch (Exception e) {
    ...
    public String button1_action() {
        ...
        this.getRequestBean1().setPersonId((Integer) this.personId.getSelected());
        this.getRequestBean1().setTripId((Integer) this.button1.getText());
        return "details";
    }
}
