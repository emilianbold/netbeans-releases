 ...
 * @author nam
 */
public class WagTransferable<T> implements Transferable {

    public static final Set<DataFlavor> WAG_SERVICE_FLAVORS = new HashSet<DataFlavor>(
            Arrays.asList(new DataFlavor[] {
        ConsumerFlavorProvider.WAG_SERVICE_FLAVOR
    }));
    
    private final T transferData;
    private final Set<DataFlavor> flavors;

    public WagTransferable(T transferData, Set<DataFlavor> flavors) {
