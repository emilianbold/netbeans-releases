 ...
 * @author  peterliu
 */
public class PreviousResultsAction extends NodeAction {
    ...
    public org.openide.util.HelpCtx getHelpCtx() {
        return new HelpCtx(PreviousResultsAction.class);
    }

    public String getName() {
        return NbBundle.getMessage(PreviousResultsAction.class, "PreviousResultsAction");
    }
    ...
    protected void performAction(final Node[] nodes) {
        ...
        for (int i = 0; i < nodes.length; i++) {
            nodes[i].getLookup().lookup(WagSearchResult.class).previous();
        }
    }
