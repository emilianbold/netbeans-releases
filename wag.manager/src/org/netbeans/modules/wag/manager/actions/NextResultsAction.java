 ...
 * @author  peterliu
 */
public class NextResultsAction extends NodeAction {
    ...
    public org.openide.util.HelpCtx getHelpCtx() {
        return new HelpCtx(NextResultsAction.class);
    }

    public String getName() {
        return NbBundle.getMessage(NextResultsAction.class, "NextResultsAction");
    }
    ...
    protected void performAction(final Node[] nodes) {
        ...
        for (int i = 0; i < nodes.length; i++) {
            nodes[i].getLookup().lookup(WagSearchResult.class).next();
        }
    }
