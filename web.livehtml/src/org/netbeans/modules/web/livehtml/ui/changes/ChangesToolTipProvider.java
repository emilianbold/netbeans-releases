 ...
 */
@NbBundle.Messages({
    "CTL_ChangesToolTipProvider_DisplayName=Revision changes"
})
public class ChangesToolTipProvider extends RevisionToolTipService implements ExplorerManager.Provider {
    
    private static final String NAME = Bundle.CTL_ChangesToolTipProvider_DisplayName();
    
    private ExplorerManager explorerManager = new ExplorerManager();

    /**
     * Creates new form ChangesToolTipPanel
     */
    public ChangesToolTipProvider() {
        initComponents();
        changesListView.setShowParentNode(false);
    }
    ...
    protected void setRevision(Revision revision, boolean reformatContent) {
        final List<Change> changes = reformatContent ? revision.getReformattedChanges() : revision.getChanges();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(changesScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 400, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(changesScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE)
        );
    }// </editor-fold>//GEN-END:initComponents
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private org.openide.explorer.view.ListView changesListView;
