 ...
 * @version 1.0
 */
public class GenerateEqualsAndHashCodeOperator extends JDialogOperator {

    /** Creates new GenerateEqualsAndHashCode that can handle it.
     */
    public GenerateEqualsAndHashCodeOperator() {
        super("Generate equals() and hashCode()");
    }
    ...
    */
    public static void main(String args[]) {
        new GenerateEqualsAndHashCodeOperator().verify();
