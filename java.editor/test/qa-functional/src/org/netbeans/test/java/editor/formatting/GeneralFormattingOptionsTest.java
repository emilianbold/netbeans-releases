...
import org.netbeans.test.java.editor.formatting.operators.AllLanguageTabsAndIndentsOperator;
import org.netbeans.test.java.editor.formatting.operators.FormattingOptionsOperator;


public class GeneralFormattingOptionsTest extends FormattingOptionsTest {

    public GeneralFormattingOptionsTest(String testMethodName) {
        super(testMethodName);
    }

    public void testExpandTabsToSpacesAllLanguage() {
        FormattingOptionsOperator formattingOperator = FormattingOptionsOperator.invoke(true);
        AllLanguageTabsAndIndentsOperator operator = formattingOperator.getAllLanguageTabsAndIndentsOperator();
        try {
    ...
    public void testTabSizeAllLanguage() {
        FormattingOptionsOperator formattingOperator = FormattingOptionsOperator.invoke(true);
        AllLanguageTabsAndIndentsOperator operator = formattingOperator.getAllLanguageTabsAndIndentsOperator();
        try {
            operator.getExpandTabsToSpaces().changeSelection(false);
    ...
    public void testIndentationLevelAllLanguage() {
        FormattingOptionsOperator formattingOperator = FormattingOptionsOperator.invoke(true);
        AllLanguageTabsAndIndentsOperator operator = formattingOperator.getAllLanguageTabsAndIndentsOperator();
        try {
