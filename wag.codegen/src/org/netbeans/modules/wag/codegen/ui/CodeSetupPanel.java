...
public class CodeSetupPanel extends javax.swing.JPanel {
    ...
    private List<WagServiceParameter> inputParams;
    private boolean methodNameModified = false;
    private boolean showParamTypes;
    private Dialog dialog;

    /** Creates new form CodeSetupPanel */
    public CodeSetupPanel(List<WagServiceParameter> inputParams) {
        this(inputParams, true);
    }
    
    /** Creates new form CodeSetupPanel */
    public CodeSetupPanel(List<WagServiceParameter> inputParams, boolean showParamTypes) {
        initComponents();
    ...
    private class ParamTableModel extends AbstractTableModel {
        ...
        public Object getValueAt(int row, int column) {
            WagServiceParameter info = inputParams.get(row);
