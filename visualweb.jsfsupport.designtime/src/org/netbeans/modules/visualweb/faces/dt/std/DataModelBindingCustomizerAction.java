...
public class DataModelBindingCustomizerAction extends BasicDisplayAction {

    private static final ComponentBundle bundle = ComponentBundle.getBundle(
        DataModelBindingCustomizerAction.class);

    public DataModelBindingCustomizerAction(DesignBean bean) {
    ...
    public Result invoke() {
        return new CustomizerResult(bean, new DataModelBindingCustomizer());
    }
}
