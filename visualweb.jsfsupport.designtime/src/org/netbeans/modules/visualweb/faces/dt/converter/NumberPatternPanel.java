...
public class NumberPatternPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblExample, org.openide.util.NbBundle.getMessage(NumberPatternPanel.class, "example")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        lblResults.setText(bundle.getString("results_label")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        ...
        btnTest.setText(bundle.getString("testButton_label")); // NOI18N
