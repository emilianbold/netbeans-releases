 ...
 * @author gjmurphy
 */
public class DateTimeStylesDomain extends Domain {
    ...
    private static Element[] elements = new Element[] {
        new Element("default", bundle.getString("default")),
        new Element("short", bundle.getString("short")),
        new Element("medium", bundle.getString("medium")),
        new Element("long", bundle.getString("long")),
        new Element("full", bundle.getString("full"))
    };

    public Element[] getElements() {
        return DateTimeStylesDomain.elements;
    }
