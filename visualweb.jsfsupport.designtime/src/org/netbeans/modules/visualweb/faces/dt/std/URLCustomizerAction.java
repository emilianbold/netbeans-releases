...
public class URLCustomizerAction extends BasicDisplayAction {
    ...
    private static final ComponentBundle bundle = ComponentBundle.getBundle(URLCustomizerAction.class);

    public URLCustomizerAction(DesignBean bean) {
        super(bundle.getMessage("urlValEllipse")); //NOI18N
        this.bean = bean;
    }
