 ...
 */
package org.netbeans.modules.visualweb.faces.dt.util;
...
public class ComponentBundle {
    ...
    private static final String DESIGN_TIME_IMPL_CLASS = "org.netbeans.modules.visualweb.faces.dt.util.DesignTimeComponentBundle"; 	//NOI18N
    ...
    public static ComponentBundle getBundle(Class c, String suffix) {
        ...
        if (cb == null) {
        	if (Beans.isDesignTime()) {
        		try {
                            // XXX This looks silly, why the class is not directly used? It is in the same package!
