...
/**
 *	This generated bean class ExtensionAttrType
 *	matches the schema element 'extensionAttrType'.
 *  The root bean class is TemplateGroup
 *
 *	Generated on Thu Sep 14 11:59:07 PDT 2006
 * @Generated
 */

package org.netbeans.modules.xml.wsdl.bindingsupport.template;

public class ExtensionAttrType {
	public static final String NAME = "Name";	// NOI18N
	public static final String DEFAULTVALUE = "DefaultValue";	// NOI18N
	 ...
	 */
	public ExtensionAttrType() {
	}

	/**
	 * Deep copy
	 */
	public ExtensionAttrType(org.netbeans.modules.xml.wsdl.bindingsupport.template.ExtensionAttrType source) {
		this(source, false);
	}
	 ...
	 */
	public ExtensionAttrType(org.netbeans.modules.xml.wsdl.bindingsupport.template.ExtensionAttrType source, boolean justData) {
		_Name = source._Name;
	...
	protected void writeNodeAttributes(java.io.Writer out, String nodeName, String namespace, String indent, java.util.Map namespaceMap) throws java.io.IOException {
		...
		// defaultValue is an attribute with namespace http://xml.netbeans.org/schema/templates
		if (_DefaultValue != null) {
			out.write(" defaultValue='");
			org.netbeans.modules.xml.wsdl.bindingsupport.template.TemplateGroup.writeXML(out, _DefaultValue, true);
			out.write("'");	// NOI18N
		}
	}
	...
	protected void readNodeAttributes(org.w3c.dom.Node node, java.util.Map namespacePrefixes, org.w3c.dom.NamedNodeMap attrs) {
		...
		attr = (org.w3c.dom.Attr) attrs.getNamedItem("defaultValue");
		if (attr != null) {
			attrValue = attr.getValue();
	...
	public void changePropertyByName(String name, Object value) {
		...
		if (name == "name")
			...
			throw new IllegalArgumentException(name+" is not a valid property name for ExtensionAttrType");
	}
	...
	public boolean equals(Object o) {
		return o instanceof org.netbeans.modules.xml.wsdl.bindingsupport.template.ExtensionAttrType && equals((org.netbeans.modules.xml.wsdl.bindingsupport.template.ExtensionAttrType) o);
	}

	public boolean equals(org.netbeans.modules.xml.wsdl.bindingsupport.template.ExtensionAttrType inst) {
		if (inst == this) {
			return true;
		}
		if (inst == null) {
