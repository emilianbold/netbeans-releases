...
public class GlobFileBuiltQueryTest extends NbTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        fbqi = new GlobFileBuiltQuery(h, new String[] {
            "${src.dir}/*.java",
            "${test.src.dir}/*.java",
        }, new String[] {
    ...
    public void testChangeFiring() throws Exception {
        ...
        OutputStream os = new FileOutputStream(new File(pkg, "Foo.class"));
        os.close();
        scratch.getFileSystem().refresh(false);
        assertTrue("Foo.class created on disk", fooL.expect(WAIT));
