...
/** 
 * Action provider of the iep module project. 
 *
 * @author Bing Lu
 */
class IepProjectActionProvider implements ActionProvider {
    ...
    public IepProjectActionProvider(IepProject project, AntProjectHelper antProjectHelper, ReferenceHelper refHelper) {
