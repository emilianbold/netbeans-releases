...
public class HudsonJobBuildPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        loadingLabel.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        loadingLabel.setIcon(ImageUtilities.loadImageIcon("org/netbeans/modules/hudson/ui/resources/loading.gif", true));
            ...
            if (!SwingUtilities.isEventDispatchThread()) {
                ...
                if (!state) {
                    ...
                    if (data.isBuilding()) {
                        ...
                        buildStatusLabel.setIcon(ImageUtilities.loadImageIcon("org/netbeans/modules/hudson/ui/resources/building.gif", true));
