...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/">
        ...
        *** GENERATED - DO NOT EDIT  ***
        ...
        <project>
            <xsl:attribute name="default">-wsit-deploy</xsl:attribute>
            <xsl:attribute name="basedir">..</xsl:attribute>
            
            <target name="-pre-init-wsit">
                <subant>
                    <xsl:attribute name="target">-wsit-classpath-setup</xsl:attribute>
                    <xsl:attribute name="antfile">nbproject/wsit-deploy.xml</xsl:attribute>
                    <xsl:attribute name="buildpath">${basedir}</xsl:attribute>
                </subant>
                <property file="nbproject/private/private.properties_wsit"/>
                <delete file="nbproject/private/private.properties_wsit"/>
            </target>
            
            <target name="-run-deploy-wsit">
                <xsl:attribute name="depends">-wsit-deploy</xsl:attribute>
            </target>
