...
public class ServiceView extends SectionView {
    ...
    ServiceView(InnerPanelFactory factory, WSDLModel model, Project p, Node node, Service s) {
        ...
        if (bindingNodes.length > 1) {
            ...
            for (Binding binding : bindings) {
                ...
                bindingCont.addSection(servicePanel, true);
...
//                    Collection<BindingFault> faults = op.getBindingFaults();
//                    for (BindingFault f : faults) {
//                        Node bfNode = new BindingFaultNode(this, f);
//                        subNodes.add(bfNode);
//                        SectionPanel bfPanel = new SectionPanel(this, bfNode, f, false);
