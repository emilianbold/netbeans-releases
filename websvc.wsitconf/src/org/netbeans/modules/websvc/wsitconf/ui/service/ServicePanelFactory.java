...
public class ServicePanelFactory implements org.netbeans.modules.xml.multiview.ui.InnerPanelFactory {
     ...
     */
    ServicePanelFactory(ToolBarDesignEditor editor, Node node, UndoManager undoManager, Project p) {
        this.editor=editor;
        this.node = node;
        this.project = p;
    ...
    public SectionInnerPanel createInnerPanel(Object key) {
        if (key instanceof Binding) {
            ...
            return new ServicePanel((SectionView) editor.getContentView(), node, project, b, undoManager);
        }
        if (key instanceof BindingOperation) {
            BindingOperation o = (BindingOperation)key;
            return new OperationPanel((SectionView) editor.getContentView(), node, project, o, undoManager);
        }
        if (key instanceof BindingInput) {
            BindingInput o = (BindingInput)key;
            return new InputPanel((SectionView) editor.getContentView(), node, o, undoManager);
        }
        ...
        if (key instanceof BindingFault) {
            BindingFault o = (BindingFault)key;
            return new FaultPanel((SectionView) editor.getContentView(), node, o, undoManager);
        }
        return null;
    }
}
