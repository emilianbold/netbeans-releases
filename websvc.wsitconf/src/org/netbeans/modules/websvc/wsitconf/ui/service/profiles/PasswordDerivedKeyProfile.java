...
public class PasswordDerivedKeyProfile extends ProfileBase
    ...
    public String getDisplayName() {
        return ComboConstants.PROF_PASSWD_DERIVED;
    }
    ...
    public boolean isProfileSupported(Project p, WSDLComponent component, boolean sts) {
        ...
        return !ConfigVersion.CONFIG_1_0.equals(configVersion) && !(ConfigVersion.CONFIG_1_3.equals(configVersion));
    }

    public String getDescription() {
        return ComboConstants.PROF_PASSWD_DERIVED_INFO;
    }
    ...
    public void displayConfig(WSDLComponent component, UndoManager undoManager) {
        ...
        JPanel profConfigPanel = new PasswordDerivedKey(component, this);
