...
public class InputPanel extends SectionInnerPanel {
    ...
    private void initComponents() {
        ...
        tokenComboLabel.setText(org.openide.util.NbBundle.getMessage(InputPanel.class, "LBL_tokenComboLabel")); // NOI18N

        tokenCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "X509", "Username" }));

        targetsButton.setText(org.openide.util.NbBundle.getMessage(InputPanel.class, "LBL_SignEncrypt")); // NOI18N
        ...
        configButton.setText(org.openide.util.NbBundle.getMessage(InputPanel.class, "LBL_keyConfigButton")); // NOI18N

        signedChBox.setText(org.openide.util.NbBundle.getMessage(InputPanel.class, "LBL_Token_Signed")); // NOI18N
        ...
        endorsingChBox.setText(org.openide.util.NbBundle.getMessage(InputPanel.class, "LBL_Token_Endorsing")); // NOI18N
