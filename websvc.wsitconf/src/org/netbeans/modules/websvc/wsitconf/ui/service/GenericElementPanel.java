 ...
 */
public class GenericElementPanel<T extends WSDLComponent> extends SectionInnerPanel {
...
//    private boolean inSync = false;
    ...
    public GenericElementPanel(SectionView view, T fault, UndoManager undoManager) {
        super(view);
...
//        inSync = false;
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(targetsButton, org.openide.util.NbBundle.getMessage(GenericElementPanel.class, "LBL_SignEncrypt")); // NOI18N
    ...
    private void targetsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_targetsButtonActionPerformed
        ...
        TargetsPanel targetsPanel = new TargetsPanel(element); //NOI18N
        DialogDescriptor dlgDesc = new DialogDescriptor(targetsPanel, 
                NbBundle.getMessage(GenericElementPanel.class, "LBL_Targets_Panel_Title")); //NOI18N
