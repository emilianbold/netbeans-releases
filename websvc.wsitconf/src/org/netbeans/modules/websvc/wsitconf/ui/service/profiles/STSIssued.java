            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(layout.createSequentialGroup()
                        ...
                        .add(issuerAddressField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 199, Short.MAX_VALUE))
                    .add(reqDerivedKeys)
                    .add(reqSigConfChBox)
                    .add(secConvChBox)
                    ...
                    .add(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(issuerMetadataField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
                            .add(layout.createSequentialGroup()
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                    .add(keySizeCombo, 0, 152, Short.MAX_VALUE)
                                    .add(keyTypeCombo, 0, 152, Short.MAX_VALUE)
                                    .add(tokenTypeCombo, 0, 152, Short.MAX_VALUE)
                                    .add(algoSuiteCombo, 0, 152, Short.MAX_VALUE)
                                    .add(layoutCombo, 0, 152, Short.MAX_VALUE))))))
                .addContainerGap())
        );
