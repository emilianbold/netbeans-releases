...
public class STSIssued extends javax.swing.JPanel {
     ...
     */
    public STSIssued(WSDLComponent comp) {
        super();
        initComponents();
...
//        algoSuiteCombo.addItem(ComboConstants.TRIPLEDESSHA256RSA15);
    ...
    private void initComponents() {
        ...
        secConvChBox.setText(org.openide.util.NbBundle.getMessage(STSIssued.class, "LBL_SecConvLabel")); // NOI18N
        ...
        reqSigConfChBox.setText(org.openide.util.NbBundle.getMessage(STSIssued.class, "LBL_RequireSigConfirmation")); // NOI18N
        ...
        derivedKeysChBox.setText(org.openide.util.NbBundle.getMessage(STSIssued.class, "LBL_RequireDerivedKeysForSecConv")); // NOI18N
        ...
        algoSuiteLabel.setText(org.openide.util.NbBundle.getMessage(STSIssued.class, "LBL_AlgoSuiteLabel")); // NOI18N
        ...
        layoutLabel.setText(org.openide.util.NbBundle.getMessage(STSIssued.class, "LBL_LayoutLabel")); // NOI18N
        ...
        encryptSignatureChBox.setText(org.openide.util.NbBundle.getMessage(STSIssued.class, "LBL_EncryptSignatureLabel")); // NOI18N
        ...
        reqDerivedKeys.setText(org.openide.util.NbBundle.getMessage(STSIssued.class, "LBL_RequireDerivedKeysIssued")); // NOI18N
        ...
        encryptOrderChBox.setText(org.openide.util.NbBundle.getMessage(STSIssued.class, "LBL_EncryptOrderLabel")); // NOI18N
        ...
        issuerAddressLabel.setText(org.openide.util.NbBundle.getMessage(STSIssued.class, "LBL_IssuerAddress")); // NOI18N
        ...
        issuerMetadataLabel.setText(org.openide.util.NbBundle.getMessage(STSIssued.class, "LBL_IssuerMetadataAddress")); // NOI18N
        ...
        tokenTypeLabel.setText(org.openide.util.NbBundle.getMessage(STSIssued.class, "LBL_RSTTokenType")); // NOI18N

        keyTypeLabel.setText(org.openide.util.NbBundle.getMessage(STSIssued.class, "LBL_RSTKeyType")); // NOI18N

        keySizeLabel.setText(org.openide.util.NbBundle.getMessage(STSIssued.class, "LBL_RSTKeySize")); // NOI18N
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(layout.createSequentialGroup()
                        ...
                        .add(issuerAddressField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE))
                    .add(layout.createSequentialGroup()
                        .add(issuerMetadataLabel)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(issuerMetadataField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 116, Short.MAX_VALUE))
                    .add(layout.createSequentialGroup()
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(tokenTypeLabel)
                            .add(keyTypeLabel)
