...
public class KeystorePanel extends JPanel {
    ...
    private void initComponents() {
        ...
        keystoreLocationTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                keystoreLocationTextFieldActionPerformed(evt);
            }
        });
        ...
        keystorePasswordField.addKeyListener(new java.awt.event.KeyAdapter() {

            @Override
            public void keyReleased(java.awt.event.KeyEvent evt) {
                keystorePasswordFieldKeyReleased(evt);
            }
        });
    ...
    private void keystorePasswordFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_keystorePasswordFieldKeyReleased
        if (!inSync) {
    ...
    }//GEN-LAST:event_keystorePasswordFieldKeyReleased

    private void keystoreLocationTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_keystoreLocationTextFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_keystoreLocationTextFieldActionPerformed
    ...
    private void keyAliasComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_keyAliasComboActionPerformed
        if (!inSync) {
            ...
            if ((alias != null) && (alias.length() == 0)) {
                ...
                ProprietarySecurityPolicyModelHelper.setKeyStoreAlias(comp, alias, false);
            }
            return;
        }
    ...
    private void keystoreLocationButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_keystoreLocationButtonActionPerformed
        ...
        if (chooser.showOpenDialog(this)== JFileChooser.APPROVE_OPTION) {
            ...
            if (file != null) {
                ...
                ProprietarySecurityPolicyModelHelper.setStoreLocation(comp, file.getPath(), false, false);
    ...
    private void reloadAliases() {
        Enumeration<String> aliases = getAliases(getKeystorePath(), getCharKeystorePassword(), keystoreType);
