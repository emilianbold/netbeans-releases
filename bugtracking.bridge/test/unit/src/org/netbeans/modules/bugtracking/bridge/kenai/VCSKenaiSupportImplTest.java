...
public class VCSKenaiSupportImplTest extends NbTestCase {
    ...
    public void testHandleKenaiProjectEvent() throws URISyntaxException, NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, KenaiException {
        ...
        Method method = VCSKenaiSupportImpl.class.getDeclaredMethod("handleKenaiProjectEvent", new Class[]{PropertyChangeEvent.class, String.class});
        method.setAccessible(true);
        method.invoke(support, new Object[] {e, kp.getName()});

        assertEquals(1, events.size());
        evt = events.get(0);
        assertEquals(VCSKenaiSupport.PROP_KENAI_VCS_NOTIFICATION, evt.getPropertyName());
        assertTrue(evt.getNewValue() instanceof VCSKenaiSupport.VCSKenaiNotification);
