...
/**
 * Manages <em>ReplaceAction</em> - enables and disables it by current set of
 * selected nodes.
 *
 * @author Petr Kuzel
 ...
 */
final class ReplaceActionManager extends ActionManager<ReplaceInFilesAction, ReplaceAction, ReplaceInFilesAction.LookupSensitive> {

    private static final String MAPPED_FIND_ACTION =
            ReplaceActionManager.class.getName() + " - ReplActionImpl"; //NOI18N
    ...
    protected void initLookupSensitiveActionClass() {
        lookUpSensitiveClass = ReplaceInFilesAction.LookupSensitive.class;
    }
