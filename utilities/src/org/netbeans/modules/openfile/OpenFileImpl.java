...
public class OpenFileImpl {
    ...
    protected boolean checkFileExists(File file) {
        em.log("    file: " + file);                                    //NOI18N
        em.log("    file.exists: " + file.exists());                    //NOI18N
        em.log("    file.isFile: " + file.isFile());                    //NOI18N
     ...
     * At first, it finds a corresponding <code>FileObject</code>
     * using method {@link #findFileObject} and then opens is
     * by
     * {@link #open(FileObject, String, boolean, InetAddress, int, int) open(FileObject, ...)}.
     *
    ...
    void open(File file,
        ...
        try {
            ...
            /* ignore it -- use the original File instance: */
        ...
        /* Find a FileObject for the File: */
        FileObject fileObject;
        if ((fileObject = findFileObject(file)) == null) {
            return;
        }
        
        open(fileObject, file.getPath(), wait, address, port, line);
    }
...
//             }
     ...
     */
    private synchronized FileObject findFileObject(File f) {
