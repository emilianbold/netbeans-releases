 ...
 * @author jm202557
 */
public class BasicSearchAndReplace extends JellyTestCase {
    ...
    public BasicSearchAndReplace(String testName) {
        super(testName);
    }
    
    /** add tests to test suits */
    public static NbTestSuite suite(){
        NbTestSuite suite = new NbTestSuite(BasicSearchAndReplace.class);
        return suite;
    }
