...
class Grammar {
    ...
    public Grammar(org.netbeans.modules.cnd.antlr.Tool tool, String name, String superGrammar, IndexedVector rules) {
        this.name = name;
    ...
    public void expandInPlace() {
        ...
        if ((options != null && options.getElement("importVocab") == null) || options == null) {
            ...
            String superExportVocabFileName = path + superG.exportVocab +
                org.netbeans.modules.cnd.antlr.CodeGenerator.TokenTypesFileSuffix +
                org.netbeans.modules.cnd.antlr.CodeGenerator.TokenTypesFileExt;
