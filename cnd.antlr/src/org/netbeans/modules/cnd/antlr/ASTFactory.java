...
public class ASTFactory {
	 ...
	 *  via the ASTFactory(Hashtable) ctor in org.netbeans.modules.cnd.antlr.Parser.
	 */
	 ...
	 *  say @[PLUS,"+",PLUSNode] in an org.netbeans.modules.cnd.antlr action.
	 *  @since 2.7.2
	 */
	...
	protected AST createUsingCtor(Token token, String className) {
		...
		try {
			c = Utils.loadClass(className);
			Class[] tokenArgType = new Class[] { org.netbeans.modules.cnd.antlr.Token.class };
			try {
     ...
     *  a prior dependency on class org.netbeans.modules.cnd.antlr.Tool.
     */
