...
public class JAXBWizSourceForBinaryQueryImpl implements SourceForBinaryQueryImplementation {
    ...
    public JAXBWizSourceForBinaryQueryImpl(){
    }
    ...
    public class Result implements SourceForBinaryQuery.Result {
        ...
        public FileObject[] getRoots() {
            FileObject fo =
                    prj.getProjectDirectory().getFileObject("build/generated/addons/jaxb"); // NOI18N
