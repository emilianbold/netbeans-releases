...
public class AcceptanceTestCaseWSDL extends JellyTestCase {
    ...
    public void CreateJAXBBindingInternal()
    {
        ...
        opFileChooser.chooseFile( System.getProperty( "xtest.data" ) + File.separator + "CreditReportSimple.wsdl" );
