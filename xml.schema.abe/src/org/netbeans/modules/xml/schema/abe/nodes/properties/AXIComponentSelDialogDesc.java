...
public class AXIComponentSelDialogDesc extends DialogDescriptor
        implements PropertyChangeListener {
    public AXIComponentSelDialogDesc(AXIComponentSelectionPanel panel,
    ...
    public void propertyChange(PropertyChangeEvent event) {
        if (event.getPropertyName().equals(
                AXIComponentSelectionPanel.PROPERTY_SELECTION)) {
