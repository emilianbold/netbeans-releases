...
public class TextComponentValidator {
    ...
    public TextComponentValidator(NotifyDescriptor nd) {
        this.validator = new Validator();
        this.nd = nd;
    }

    public void addTextComponentRule(JTextComponent textComponent, Predicate<String> rule) {
        textComponent.getDocument().addDocumentListener(new DocListener(nd));

        validator.addValidationRule(() -> textComponent.getText(), rule);
    }
    ...
    private class DocListener implements DocumentListener {
        ...
        public DocListener(NotifyDescriptor nd) {
            this.nd = nd;
        }
