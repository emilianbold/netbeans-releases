...
abstract class IFrameBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), IFrameBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>IFrameBeanInfoBase</code>.</p>
     */
    public IFrameBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.IFrame.class;
        defaultPropertyName = "name";
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/IFrame_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/IFrame_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/IFrame_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/IFrame_M32";
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_align.setDisplayName(resources.getString("IFrame_align_DisplayName"));
            prop_align.setShortDescription(resources.getString("IFrame_align_Description"));
            ...
            prop_noResize.setDisplayName(resources.getString("IFrame_noResize_DisplayName"));
            prop_noResize.setShortDescription(resources.getString("IFrame_noResize_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("IFrame_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("IFrame_toolTip_Description"));
            ...
            prop_url.setDisplayName(resources.getString("IFrame_url_DisplayName"));
            prop_url.setShortDescription(resources.getString("IFrame_url_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("IFrame_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("IFrame_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("IFrame_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("IFrame_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("IFrame_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("IFrame_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("IFrame_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("IFrame_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("IFrame_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("IFrame_family_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("IFrame_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("IFrame_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("IFrame_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("IFrame_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("IFrame_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("IFrame_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("IFrame_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("IFrame_rendersChildren_Description"));
