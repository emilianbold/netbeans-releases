...
abstract class DropDownBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), DropDownBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>DropDownBeanInfoBase</code>.</p>
     */
    public DropDownBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.DropDown.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/DropDown_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/DropDown_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/DropDown_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/DropDown_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("DropDown_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("DropDown_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_bh_dropdown_list");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"dropDown");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_palette_bh_propsheets_bh_dropdown_list_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"dropDown");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_action.setDisplayName(resources.getString("DropDown_action_DisplayName"));
            prop_action.setShortDescription(resources.getString("DropDown_action_Description"));
            ...
            prop_actionListener.setDisplayName(resources.getString("DropDown_actionListener_DisplayName"));
            prop_actionListener.setShortDescription(resources.getString("DropDown_actionListener_Description"));
            ...
            prop_actionListener.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.GENERAL);

            PropertyDescriptor prop_forgetValue = new PropertyDescriptor("forgetValue",beanClass,"isForgetValue","setForgetValue");
            prop_forgetValue.setDisplayName(resources.getString("DropDown_forgetValue_DisplayName"));
            prop_forgetValue.setShortDescription(resources.getString("DropDown_forgetValue_Description"));
            prop_forgetValue.setExpert(false);
            prop_forgetValue.setHidden(true);
            prop_forgetValue.setPreferred(false);
            attrib = new AttributeDescriptor("forgetValue",false,null,true);
            prop_forgetValue.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_forgetValue.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.GENERAL);

            PropertyDescriptor prop_navigateToValue = new PropertyDescriptor("navigateToValue",beanClass,"isNavigateToValue","setNavigateToValue");
            prop_navigateToValue.setDisplayName(resources.getString("DropDown_navigateToValue_DisplayName"));
            prop_navigateToValue.setShortDescription(resources.getString("DropDown_navigateToValue_Description"));
            prop_navigateToValue.setExpert(false);
            prop_navigateToValue.setHidden(true);
            prop_navigateToValue.setPreferred(false);
            attrib = new AttributeDescriptor("navigateToValue",false,null,true);
            prop_navigateToValue.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_navigateToValue.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.GENERAL);

            PropertyDescriptor prop_submitForm = new PropertyDescriptor("submitForm",beanClass,"isSubmitForm","setSubmitForm");
            prop_submitForm.setDisplayName(resources.getString("DropDown_submitForm_DisplayName"));
            prop_submitForm.setShortDescription(resources.getString("DropDown_submitForm_Description"));
            prop_submitForm.setExpert(false);
            prop_submitForm.setHidden(true);
            prop_submitForm.setPreferred(false);
            attrib = new AttributeDescriptor("submitForm",false,null,true);
            prop_submitForm.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_submitForm.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.GENERAL);

            PropertyDescriptor prop_labelOnTop = new PropertyDescriptor("labelOnTop",beanClass,"isLabelOnTop","setLabelOnTop");
            prop_labelOnTop.setDisplayName(resources.getString("DropDown_labelOnTop_DisplayName"));
            prop_labelOnTop.setShortDescription(resources.getString("DropDown_labelOnTop_Description"));
            ...
            prop_rows.setDisplayName(resources.getString("DropDown_rows_DisplayName"));
            prop_rows.setShortDescription(resources.getString("DropDown_rows_Description"));
            prop_rows.setPropertyEditorClass(loadClass("com.sun.rave.propertyeditors.IntegerPropertyEditor"));
            prop_rows.setExpert(false);
            prop_rows.setHidden(true);
            ...
            prop_separators.setDisplayName(resources.getString("DropDown_separators_DisplayName"));
            prop_separators.setShortDescription(resources.getString("DropDown_separators_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("DropDown_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("DropDown_visible_Description"));
            ...
            prop_disabled.setDisplayName(resources.getString("DropDown_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("DropDown_disabled_Description"));
            ...
            prop_items.setDisplayName(resources.getString("DropDown_items_DisplayName"));
            prop_items.setShortDescription(resources.getString("DropDown_items_Description"));
            ...
            prop_label.setDisplayName(resources.getString("DropDown_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("DropDown_label_Description"));
            ...
            prop_labelLevel.setDisplayName(resources.getString("DropDown_labelLevel_DisplayName"));
            prop_labelLevel.setShortDescription(resources.getString("DropDown_labelLevel_Description"));
            ...
            prop_onBlur.setDisplayName(resources.getString("DropDown_onBlur_DisplayName"));
            prop_onBlur.setShortDescription(resources.getString("DropDown_onBlur_Description"));
            ...
            prop_onChange.setDisplayName(resources.getString("DropDown_onChange_DisplayName"));
            prop_onChange.setShortDescription(resources.getString("DropDown_onChange_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("DropDown_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("DropDown_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("DropDown_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("DropDown_onDblClick_Description"));
            ...
            prop_onFocus.setDisplayName(resources.getString("DropDown_onFocus_DisplayName"));
            prop_onFocus.setShortDescription(resources.getString("DropDown_onFocus_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("DropDown_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("DropDown_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("DropDown_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("DropDown_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("DropDown_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("DropDown_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("DropDown_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("DropDown_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("DropDown_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("DropDown_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("DropDown_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("DropDown_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("DropDown_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("DropDown_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("DropDown_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("DropDown_onMouseUp_Description"));
            ...
            prop_onSelect.setDisplayName(resources.getString("DropDown_onSelect_DisplayName"));
            prop_onSelect.setShortDescription(resources.getString("DropDown_onSelect_Description"));
            ...
            prop_readOnly.setDisplayName(resources.getString("DropDown_readOnly_DisplayName"));
            prop_readOnly.setShortDescription(resources.getString("DropDown_readOnly_Description"));
            ...
            prop_selected.setDisplayName(resources.getString("DropDown_selected_DisplayName"));
            prop_selected.setShortDescription(resources.getString("DropDown_selected_Description"));
            ...
            prop_style.setDisplayName(resources.getString("DropDown_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("DropDown_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("DropDown_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("DropDown_styleClass_Description"));
            ...
            prop_tabIndex.setDisplayName(resources.getString("DropDown_tabIndex_DisplayName"));
            prop_tabIndex.setShortDescription(resources.getString("DropDown_tabIndex_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("DropDown_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("DropDown_toolTip_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("DropDown_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("DropDown_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("DropDown_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("DropDown_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("DropDown_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("DropDown_children_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("DropDown_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("DropDown_converter_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("DropDown_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("DropDown_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("DropDown_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("DropDown_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("DropDown_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("DropDown_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("DropDown_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("DropDown_immediate_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("DropDown_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("DropDown_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("DropDown_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("DropDown_localValueSet_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("DropDown_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("DropDown_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("DropDown_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("DropDown_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("DropDown_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("DropDown_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("DropDown_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("DropDown_rendersChildren_Description"));
            ...
            prop_required.setDisplayName(resources.getString("DropDown_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("DropDown_required_Description"));
            ...
            prop_submittedValue.setDisplayName(resources.getString("DropDown_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("DropDown_submittedValue_Description"));
            ...
            prop_validator.setDisplayName(resources.getString("DropDown_validator_DisplayName"));
            prop_validator.setShortDescription(resources.getString("DropDown_validator_Description"));
            ...
            prop_value.setDisplayName(resources.getString("DropDown_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("DropDown_value_Description"));
            ...
            prop_valueChangeListener.setDisplayName(resources.getString("DropDown_valueChangeListener_DisplayName"));
            prop_valueChangeListener.setShortDescription(resources.getString("DropDown_valueChangeListener_Description"));
