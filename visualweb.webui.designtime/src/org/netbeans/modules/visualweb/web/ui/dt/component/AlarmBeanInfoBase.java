...
abstract class AlarmBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), AlarmBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>AlarmBeanInfoBase</code>.</p>
     */
    public AlarmBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.Alarm.class;
        defaultPropertyName = "severity";
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Alarm_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Alarm_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Alarm_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Alarm_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("Alarm_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("Alarm_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"alarm");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.FALSE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"alarm");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_alt.setDisplayName(resources.getString("Alarm_alt_DisplayName"));
            prop_alt.setShortDescription(resources.getString("Alarm_alt_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("Alarm_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("Alarm_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("Alarm_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("Alarm_onDblClick_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("Alarm_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("Alarm_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("Alarm_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("Alarm_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("Alarm_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("Alarm_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("Alarm_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("Alarm_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("Alarm_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("Alarm_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("Alarm_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("Alarm_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("Alarm_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("Alarm_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("Alarm_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("Alarm_onMouseUp_Description"));
            ...
            prop_severity.setDisplayName(resources.getString("Alarm_severity_DisplayName"));
            prop_severity.setShortDescription(resources.getString("Alarm_severity_Description"));
            ...
            prop_style.setDisplayName(resources.getString("Alarm_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("Alarm_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("Alarm_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("Alarm_styleClass_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("Alarm_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("Alarm_toolTip_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("Alarm_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("Alarm_visible_Description"));
            ...
            prop_align.setDisplayName(resources.getString("Alarm_align_DisplayName"));
            prop_align.setShortDescription(resources.getString("Alarm_align_Description"));
            ...
            prop_border.setDisplayName(resources.getString("Alarm_border_DisplayName"));
            prop_border.setShortDescription(resources.getString("Alarm_border_Description"));
            ...
            prop_height.setDisplayName(resources.getString("Alarm_height_DisplayName"));
            prop_height.setShortDescription(resources.getString("Alarm_height_Description"));
            ...
            prop_hspace.setDisplayName(resources.getString("Alarm_hspace_DisplayName"));
            prop_hspace.setShortDescription(resources.getString("Alarm_hspace_Description"));
            ...
            prop_icon.setDisplayName(resources.getString("Alarm_icon_DisplayName"));
            prop_icon.setShortDescription(resources.getString("Alarm_icon_Description"));
            ...
            prop_longDesc.setDisplayName(resources.getString("Alarm_longDesc_DisplayName"));
            prop_longDesc.setShortDescription(resources.getString("Alarm_longDesc_Description"));
            ...
            prop_url.setDisplayName(resources.getString("Alarm_url_DisplayName"));
            prop_url.setShortDescription(resources.getString("Alarm_url_Description"));
            ...
            prop_vspace.setDisplayName(resources.getString("Alarm_vspace_DisplayName"));
            prop_vspace.setShortDescription(resources.getString("Alarm_vspace_Description"));
            ...
            prop_width.setDisplayName(resources.getString("Alarm_width_DisplayName"));
            prop_width.setShortDescription(resources.getString("Alarm_width_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("Alarm_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("Alarm_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("Alarm_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("Alarm_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("Alarm_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("Alarm_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("Alarm_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("Alarm_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("Alarm_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("Alarm_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("Alarm_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("Alarm_id_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("Alarm_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("Alarm_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("Alarm_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("Alarm_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("Alarm_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("Alarm_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("Alarm_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("Alarm_rendersChildren_Description"));
            ...
            prop_value.setDisplayName(resources.getString("Alarm_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("Alarm_value_Description"));
