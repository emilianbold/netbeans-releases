...
abstract class IconHyperlinkBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), IconHyperlinkBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>IconHyperlinkBeanInfoBase</code>.</p>
     */
    public IconHyperlinkBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.IconHyperlink.class;
        defaultPropertyName = "url";
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/IconHyperlink_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/IconHyperlink_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/IconHyperlink_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/IconHyperlink_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("IconHyperlink_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("IconHyperlink_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"iconHyperlink");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"iconHyperlink");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_align.setDisplayName(resources.getString("IconHyperlink_align_DisplayName"));
            prop_align.setShortDescription(resources.getString("IconHyperlink_align_Description"));
            ...
            prop_alt.setDisplayName(resources.getString("IconHyperlink_alt_DisplayName"));
            prop_alt.setShortDescription(resources.getString("IconHyperlink_alt_Description"));
            ...
            prop_border.setDisplayName(resources.getString("IconHyperlink_border_DisplayName"));
            prop_border.setShortDescription(resources.getString("IconHyperlink_border_Description"));
            ...
            prop_height.setDisplayName(resources.getString("IconHyperlink_height_DisplayName"));
            prop_height.setShortDescription(resources.getString("IconHyperlink_height_Description"));
            ...
            prop_hspace.setDisplayName(resources.getString("IconHyperlink_hspace_DisplayName"));
            prop_hspace.setShortDescription(resources.getString("IconHyperlink_hspace_Description"));
            ...
            prop_icon.setDisplayName(resources.getString("IconHyperlink_icon_DisplayName"));
            prop_icon.setShortDescription(resources.getString("IconHyperlink_icon_Description"));
            ...
            prop_imageURL.setDisplayName(resources.getString("IconHyperlink_imageURL_DisplayName"));
            prop_imageURL.setShortDescription(resources.getString("IconHyperlink_imageURL_Description"));
            ...
            prop_textPosition.setDisplayName(resources.getString("IconHyperlink_textPosition_DisplayName"));
            prop_textPosition.setShortDescription(resources.getString("IconHyperlink_textPosition_Description"));
            ...
            prop_value.setDisplayName(resources.getString("IconHyperlink_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("IconHyperlink_value_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("IconHyperlink_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("IconHyperlink_visible_Description"));
            ...
            prop_vspace.setDisplayName(resources.getString("IconHyperlink_vspace_DisplayName"));
            prop_vspace.setShortDescription(resources.getString("IconHyperlink_vspace_Description"));
            ...
            prop_width.setDisplayName(resources.getString("IconHyperlink_width_DisplayName"));
            prop_width.setShortDescription(resources.getString("IconHyperlink_width_Description"));
            ...
            prop_action.setDisplayName(resources.getString("IconHyperlink_action_DisplayName"));
            prop_action.setShortDescription(resources.getString("IconHyperlink_action_Description"));
            ...
            prop_actionListener.setDisplayName(resources.getString("IconHyperlink_actionListener_DisplayName"));
            prop_actionListener.setShortDescription(resources.getString("IconHyperlink_actionListener_Description"));
            ...
            prop_disabled.setDisplayName(resources.getString("IconHyperlink_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("IconHyperlink_disabled_Description"));
            ...
            prop_onBlur.setDisplayName(resources.getString("IconHyperlink_onBlur_DisplayName"));
            prop_onBlur.setShortDescription(resources.getString("IconHyperlink_onBlur_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("IconHyperlink_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("IconHyperlink_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("IconHyperlink_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("IconHyperlink_onDblClick_Description"));
            ...
            prop_onFocus.setDisplayName(resources.getString("IconHyperlink_onFocus_DisplayName"));
            prop_onFocus.setShortDescription(resources.getString("IconHyperlink_onFocus_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("IconHyperlink_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("IconHyperlink_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("IconHyperlink_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("IconHyperlink_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("IconHyperlink_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("IconHyperlink_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("IconHyperlink_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("IconHyperlink_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("IconHyperlink_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("IconHyperlink_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("IconHyperlink_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("IconHyperlink_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("IconHyperlink_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("IconHyperlink_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("IconHyperlink_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("IconHyperlink_onMouseUp_Description"));
            ...
            prop_shape.setDisplayName(resources.getString("IconHyperlink_shape_DisplayName"));
            prop_shape.setShortDescription(resources.getString("IconHyperlink_shape_Description"));
            ...
            prop_style.setDisplayName(resources.getString("IconHyperlink_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("IconHyperlink_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("IconHyperlink_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("IconHyperlink_styleClass_Description"));
            ...
            prop_tabIndex.setDisplayName(resources.getString("IconHyperlink_tabIndex_DisplayName"));
            prop_tabIndex.setShortDescription(resources.getString("IconHyperlink_tabIndex_Description"));
            ...
            prop_target.setDisplayName(resources.getString("IconHyperlink_target_DisplayName"));
            prop_target.setShortDescription(resources.getString("IconHyperlink_target_Description"));
            ...
            prop_text.setDisplayName(resources.getString("IconHyperlink_text_DisplayName"));
            prop_text.setShortDescription(resources.getString("IconHyperlink_text_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("IconHyperlink_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("IconHyperlink_toolTip_Description"));
            ...
            prop_type.setDisplayName(resources.getString("IconHyperlink_type_DisplayName"));
            prop_type.setShortDescription(resources.getString("IconHyperlink_type_Description"));
            ...
            prop_url.setDisplayName(resources.getString("IconHyperlink_url_DisplayName"));
            prop_url.setShortDescription(resources.getString("IconHyperlink_url_Description"));
            ...
            prop_urlLang.setDisplayName(resources.getString("IconHyperlink_urlLang_DisplayName"));
            prop_urlLang.setShortDescription(resources.getString("IconHyperlink_urlLang_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("IconHyperlink_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("IconHyperlink_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("IconHyperlink_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("IconHyperlink_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("IconHyperlink_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("IconHyperlink_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("IconHyperlink_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("IconHyperlink_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("IconHyperlink_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("IconHyperlink_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("IconHyperlink_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("IconHyperlink_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("IconHyperlink_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("IconHyperlink_immediate_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("IconHyperlink_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("IconHyperlink_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("IconHyperlink_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("IconHyperlink_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("IconHyperlink_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("IconHyperlink_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("IconHyperlink_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("IconHyperlink_rendersChildren_Description"));
