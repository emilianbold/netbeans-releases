...
/**
 * A delegating renderer for components that implement
 * {@link org.netbeans.modules.visualweb.web.ui.component.ValueHolder}, which does two things. If
 ...
 * @author gjmurphy
 */
public abstract class ValueHolderDesignTimeRenderer extends AbstractDesignTimeRenderer {
    ...
    public void encodeBegin(FacesContext context, UIComponent component) throws IOException {
        if (ValueHolder.class.isAssignableFrom(component.getClass())) {
            ...
            if (valueBinding != null && (value == null || value.getClass().equals(Object.class) || value.toString().length() == 0)) {
                ...
                isTextSet = true;
            } else if (needsShadowText(valueHolder)) {
                valueHolder.setValue(getShadowText());
