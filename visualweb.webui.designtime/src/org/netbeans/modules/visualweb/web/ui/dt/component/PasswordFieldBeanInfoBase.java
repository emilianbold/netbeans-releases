...
abstract class PasswordFieldBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), PasswordFieldBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>PasswordFieldBeanInfoBase</code>.</p>
     */
    public PasswordFieldBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.PasswordField.class;
        defaultPropertyName = "text";
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/PasswordField_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/PasswordField_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/PasswordField_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/PasswordField_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("PasswordField_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("PasswordField_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_bh_password_field");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"passwordField");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_palette_bh_propsheets_bh_password_field_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"passwordField");
    ...
    public FacetDescriptor[] getFacetDescriptors() {
        ...
        try {
            ...
            facet_label.setDisplayName(resources.getString("PasswordField_label_DisplayName"));
            facet_label.setShortDescription(resources.getString("PasswordField_label_Description"));

            FacetDescriptor facet_readOnly = new FacetDescriptor("readOnly");
            facet_readOnly.setDisplayName(resources.getString("PasswordField_readOnly_DisplayName"));
            facet_readOnly.setShortDescription(resources.getString("PasswordField_readOnly_Description"));
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            PropertyDescriptor prop_password = new PropertyDescriptor("password",beanClass,"getPassword","setPassword");
            prop_password.setDisplayName(resources.getString("PasswordField_password_DisplayName"));
            prop_password.setShortDescription(resources.getString("PasswordField_password_Description"));
            prop_password.setPropertyEditorClass(loadClass("com.sun.rave.propertyeditors.StringPropertyEditor"));
            prop_password.setExpert(false);
            prop_password.setHidden(false);
            prop_password.setPreferred(false);
            attrib = new AttributeDescriptor("password",false,null,true);
            prop_password.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_password.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.APPEARANCE);

            PropertyDescriptor prop_columns = new PropertyDescriptor("columns",beanClass,"getColumns","setColumns");
            prop_columns.setDisplayName(resources.getString("PasswordField_columns_DisplayName"));
            prop_columns.setShortDescription(resources.getString("PasswordField_columns_Description"));
            ...
            prop_disabled.setDisplayName(resources.getString("PasswordField_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("PasswordField_disabled_Description"));
            ...
            prop_label.setDisplayName(resources.getString("PasswordField_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("PasswordField_label_Description"));
            ...
            prop_labelLevel.setDisplayName(resources.getString("PasswordField_labelLevel_DisplayName"));
            prop_labelLevel.setShortDescription(resources.getString("PasswordField_labelLevel_Description"));
            ...
            prop_maxLength.setDisplayName(resources.getString("PasswordField_maxLength_DisplayName"));
            prop_maxLength.setShortDescription(resources.getString("PasswordField_maxLength_Description"));
            ...
            prop_maxLength.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.BEHAVIOR);
            ...
            prop_onBlur.setDisplayName(resources.getString("PasswordField_onBlur_DisplayName"));
            prop_onBlur.setShortDescription(resources.getString("PasswordField_onBlur_Description"));
            ...
            prop_onChange.setDisplayName(resources.getString("PasswordField_onChange_DisplayName"));
            prop_onChange.setShortDescription(resources.getString("PasswordField_onChange_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("PasswordField_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("PasswordField_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("PasswordField_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("PasswordField_onDblClick_Description"));
            ...
            prop_onFocus.setDisplayName(resources.getString("PasswordField_onFocus_DisplayName"));
            prop_onFocus.setShortDescription(resources.getString("PasswordField_onFocus_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("PasswordField_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("PasswordField_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("PasswordField_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("PasswordField_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("PasswordField_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("PasswordField_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("PasswordField_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("PasswordField_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("PasswordField_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("PasswordField_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("PasswordField_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("PasswordField_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("PasswordField_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("PasswordField_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("PasswordField_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("PasswordField_onMouseUp_Description"));
            ...
            prop_onSelect.setDisplayName(resources.getString("PasswordField_onSelect_DisplayName"));
            prop_onSelect.setShortDescription(resources.getString("PasswordField_onSelect_Description"));
            ...
            prop_readOnly.setDisplayName(resources.getString("PasswordField_readOnly_DisplayName"));
            prop_readOnly.setShortDescription(resources.getString("PasswordField_readOnly_Description"));
            ...
            prop_style.setDisplayName(resources.getString("PasswordField_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("PasswordField_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("PasswordField_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("PasswordField_styleClass_Description"));
            ...
            prop_tabIndex.setDisplayName(resources.getString("PasswordField_tabIndex_DisplayName"));
            prop_tabIndex.setShortDescription(resources.getString("PasswordField_tabIndex_Description"));
            ...
            prop_text.setDisplayName(resources.getString("PasswordField_text_DisplayName"));
            prop_text.setShortDescription(resources.getString("PasswordField_text_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("PasswordField_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("PasswordField_toolTip_Description"));
            ...
            prop_trim.setDisplayName(resources.getString("PasswordField_trim_DisplayName"));
            prop_trim.setShortDescription(resources.getString("PasswordField_trim_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("PasswordField_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("PasswordField_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("PasswordField_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("PasswordField_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("PasswordField_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("PasswordField_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("PasswordField_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("PasswordField_children_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("PasswordField_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("PasswordField_converter_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("PasswordField_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("PasswordField_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("PasswordField_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("PasswordField_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("PasswordField_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("PasswordField_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("PasswordField_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("PasswordField_immediate_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("PasswordField_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("PasswordField_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("PasswordField_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("PasswordField_localValueSet_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("PasswordField_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("PasswordField_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("PasswordField_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("PasswordField_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("PasswordField_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("PasswordField_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("PasswordField_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("PasswordField_rendersChildren_Description"));
            ...
            prop_required.setDisplayName(resources.getString("PasswordField_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("PasswordField_required_Description"));
            ...
            prop_submittedValue.setDisplayName(resources.getString("PasswordField_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("PasswordField_submittedValue_Description"));
            ...
            prop_validator.setDisplayName(resources.getString("PasswordField_validator_DisplayName"));
            prop_validator.setShortDescription(resources.getString("PasswordField_validator_Description"));
            ...
            prop_value.setDisplayName(resources.getString("PasswordField_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("PasswordField_value_Description"));
            ...
            prop_valueChangeListener.setDisplayName(resources.getString("PasswordField_valueChangeListener_DisplayName"));
            prop_valueChangeListener.setShortDescription(resources.getString("PasswordField_valueChangeListener_Description"));
