...
/**
 * BeanInfo for the {@link org.netbeans.modules.visualweb.web.ui.dt.component.Button} component.
 *
 * @author gjmurphy
 */
    ...
    public EventSetDescriptor[] getEventSetDescriptors() {
        if (eventSetDescriptors == null) {
            ...
            for (int i = 0; i < eventSetDescriptors.length; i++) {
                if (eventSetDescriptors[i].getName().equals("action")) {
                    eventSetDescriptors[i].setValue(
                            Constants.EventDescriptor.DEFAULT_EVENT_BODY,
                            DesignMessageUtil.getMessage(ButtonBeanInfo.class, "buttonHandler"));
                }
            }
        }
