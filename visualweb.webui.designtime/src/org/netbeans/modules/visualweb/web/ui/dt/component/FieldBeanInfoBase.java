...
abstract class FieldBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), FieldBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>FieldBeanInfoBase</code>.</p>
     */
    public FieldBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.Field.class;
        defaultPropertyName = "";
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Field_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Field_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Field_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Field_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("Field_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("Field_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(true);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"field");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.FALSE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"field");
    ...
    public FacetDescriptor[] getFacetDescriptors() {
        ...
        try {
            ...
            facet_label.setDisplayName(resources.getString("Field_label_DisplayName"));
            facet_label.setShortDescription(resources.getString("Field_label_Description"));

            FacetDescriptor facet_readOnly = new FacetDescriptor("readOnly");
            facet_readOnly.setDisplayName(resources.getString("Field_readOnly_DisplayName"));
            facet_readOnly.setShortDescription(resources.getString("Field_readOnly_Description"));
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_columns.setDisplayName(resources.getString("Field_columns_DisplayName"));
            prop_columns.setShortDescription(resources.getString("Field_columns_Description"));
            ...
            prop_disabled.setDisplayName(resources.getString("Field_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("Field_disabled_Description"));
            ...
            prop_label.setDisplayName(resources.getString("Field_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("Field_label_Description"));
            ...
            prop_labelLevel.setDisplayName(resources.getString("Field_labelLevel_DisplayName"));
            prop_labelLevel.setShortDescription(resources.getString("Field_labelLevel_Description"));
            ...
            prop_maxLength.setDisplayName(resources.getString("Field_maxLength_DisplayName"));
            prop_maxLength.setShortDescription(resources.getString("Field_maxLength_Description"));
            ...
            prop_onBlur.setDisplayName(resources.getString("Field_onBlur_DisplayName"));
            prop_onBlur.setShortDescription(resources.getString("Field_onBlur_Description"));
            ...
            prop_onChange.setDisplayName(resources.getString("Field_onChange_DisplayName"));
            prop_onChange.setShortDescription(resources.getString("Field_onChange_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("Field_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("Field_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("Field_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("Field_onDblClick_Description"));
            ...
            prop_onFocus.setDisplayName(resources.getString("Field_onFocus_DisplayName"));
            prop_onFocus.setShortDescription(resources.getString("Field_onFocus_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("Field_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("Field_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("Field_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("Field_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("Field_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("Field_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("Field_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("Field_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("Field_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("Field_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("Field_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("Field_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("Field_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("Field_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("Field_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("Field_onMouseUp_Description"));
            ...
            prop_onSelect.setDisplayName(resources.getString("Field_onSelect_DisplayName"));
            prop_onSelect.setShortDescription(resources.getString("Field_onSelect_Description"));
            ...
            prop_readOnly.setDisplayName(resources.getString("Field_readOnly_DisplayName"));
            prop_readOnly.setShortDescription(resources.getString("Field_readOnly_Description"));
            ...
            prop_style.setDisplayName(resources.getString("Field_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("Field_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("Field_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("Field_styleClass_Description"));
            ...
            prop_tabIndex.setDisplayName(resources.getString("Field_tabIndex_DisplayName"));
            prop_tabIndex.setShortDescription(resources.getString("Field_tabIndex_Description"));
            ...
            prop_text.setDisplayName(resources.getString("Field_text_DisplayName"));
            prop_text.setShortDescription(resources.getString("Field_text_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("Field_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("Field_toolTip_Description"));
            ...
            prop_trim.setDisplayName(resources.getString("Field_trim_DisplayName"));
            prop_trim.setShortDescription(resources.getString("Field_trim_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("Field_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("Field_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("Field_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("Field_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("Field_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("Field_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("Field_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("Field_children_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("Field_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("Field_converter_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("Field_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("Field_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("Field_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("Field_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("Field_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("Field_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("Field_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("Field_immediate_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("Field_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("Field_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("Field_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("Field_localValueSet_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("Field_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("Field_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("Field_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("Field_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("Field_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("Field_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("Field_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("Field_rendersChildren_Description"));
            ...
            prop_required.setDisplayName(resources.getString("Field_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("Field_required_Description"));
            ...
            prop_submittedValue.setDisplayName(resources.getString("Field_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("Field_submittedValue_Description"));
            ...
            prop_validator.setDisplayName(resources.getString("Field_validator_DisplayName"));
            prop_validator.setShortDescription(resources.getString("Field_validator_Description"));
            ...
            prop_value.setDisplayName(resources.getString("Field_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("Field_value_Description"));
            ...
            prop_valueChangeListener.setDisplayName(resources.getString("Field_valueChangeListener_DisplayName"));
            prop_valueChangeListener.setShortDescription(resources.getString("Field_valueChangeListener_Description"));
