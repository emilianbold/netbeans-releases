...
abstract class TableActionsBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), TableActionsBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>TableActionsBeanInfoBase</code>.</p>
     */
    public TableActionsBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.TableActions.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/TableActions_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/TableActions_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/TableActions_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/TableActions_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("TableActions_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("TableActions_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"tableActions");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"tableActions");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_abbr.setDisplayName(resources.getString("TableActions_abbr_DisplayName"));
            prop_abbr.setShortDescription(resources.getString("TableActions_abbr_Description"));
            ...
            PropertyDescriptor prop_actionsBottom = new PropertyDescriptor("actionsBottom",beanClass,"isActionsBottom","setActionsBottom");
            prop_actionsBottom.setDisplayName(resources.getString("TableActions_actionsBottom_DisplayName"));
            prop_actionsBottom.setShortDescription(resources.getString("TableActions_actionsBottom_Description"));
            prop_actionsBottom.setExpert(false);
            prop_actionsBottom.setHidden(false);
            prop_actionsBottom.setPreferred(false);
            prop_actionsBottom.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.GENERAL);

            PropertyDescriptor prop_align = new PropertyDescriptor("align",beanClass,"getAlign","setAlign");
            prop_align.setDisplayName(resources.getString("TableActions_align_DisplayName"));
            prop_align.setShortDescription(resources.getString("TableActions_align_Description"));
            ...
            prop_axis.setDisplayName(resources.getString("TableActions_axis_DisplayName"));
            prop_axis.setShortDescription(resources.getString("TableActions_axis_Description"));
            ...
            prop_bgColor.setDisplayName(resources.getString("TableActions_bgColor_DisplayName"));
            prop_bgColor.setShortDescription(resources.getString("TableActions_bgColor_Description"));
            ...
            prop_char.setDisplayName(resources.getString("TableActions_char_DisplayName"));
            prop_char.setShortDescription(resources.getString("TableActions_char_Description"));
            ...
            prop_charOff.setDisplayName(resources.getString("TableActions_charOff_DisplayName"));
            prop_charOff.setShortDescription(resources.getString("TableActions_charOff_Description"));
            ...
            prop_colSpan.setDisplayName(resources.getString("TableActions_colSpan_DisplayName"));
            prop_colSpan.setShortDescription(resources.getString("TableActions_colSpan_Description"));
            ...
            prop_extraHtml.setDisplayName(resources.getString("TableActions_extraHtml_DisplayName"));
            prop_extraHtml.setShortDescription(resources.getString("TableActions_extraHtml_Description"));
            ...
            prop_headers.setDisplayName(resources.getString("TableActions_headers_DisplayName"));
            prop_headers.setShortDescription(resources.getString("TableActions_headers_Description"));
            ...
            prop_height.setDisplayName(resources.getString("TableActions_height_DisplayName"));
            prop_height.setShortDescription(resources.getString("TableActions_height_Description"));
            ...
            prop_noWrap.setDisplayName(resources.getString("TableActions_noWrap_DisplayName"));
            prop_noWrap.setShortDescription(resources.getString("TableActions_noWrap_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("TableActions_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("TableActions_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("TableActions_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("TableActions_onDblClick_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("TableActions_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("TableActions_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("TableActions_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("TableActions_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("TableActions_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("TableActions_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("TableActions_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("TableActions_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("TableActions_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("TableActions_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("TableActions_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("TableActions_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("TableActions_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("TableActions_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("TableActions_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("TableActions_onMouseUp_Description"));
            ...
            prop_rowSpan.setDisplayName(resources.getString("TableActions_rowSpan_DisplayName"));
            prop_rowSpan.setShortDescription(resources.getString("TableActions_rowSpan_Description"));
            ...
            prop_scope.setDisplayName(resources.getString("TableActions_scope_DisplayName"));
            prop_scope.setShortDescription(resources.getString("TableActions_scope_Description"));
            ...
            prop_style.setDisplayName(resources.getString("TableActions_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("TableActions_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("TableActions_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("TableActions_styleClass_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("TableActions_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("TableActions_toolTip_Description"));
            ...
            prop_valign.setDisplayName(resources.getString("TableActions_valign_DisplayName"));
            prop_valign.setShortDescription(resources.getString("TableActions_valign_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("TableActions_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("TableActions_visible_Description"));
            ...
            prop_width.setDisplayName(resources.getString("TableActions_width_DisplayName"));
            prop_width.setShortDescription(resources.getString("TableActions_width_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("TableActions_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("TableActions_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("TableActions_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("TableActions_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("TableActions_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("TableActions_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("TableActions_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("TableActions_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("TableActions_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("TableActions_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("TableActions_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("TableActions_id_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("TableActions_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("TableActions_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("TableActions_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("TableActions_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("TableActions_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("TableActions_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("TableActions_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("TableActions_rendersChildren_Description"));
