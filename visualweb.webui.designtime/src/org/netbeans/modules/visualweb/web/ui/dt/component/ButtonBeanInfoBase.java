...
abstract class ButtonBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), ButtonBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>ButtonBeanInfoBase</code>.</p>
     */
    public ButtonBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.Button.class;
        defaultPropertyName = "text";
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Button_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Button_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Button_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Button_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("Button_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("Button_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_bh_button");
        ...
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_palette_bh_propsheets_bh_button_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"button");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_action.setDisplayName(resources.getString("Button_action_DisplayName"));
            prop_action.setShortDescription(resources.getString("Button_action_Description"));
            ...
            prop_actionListener.setDisplayName(resources.getString("Button_actionListener_DisplayName"));
            prop_actionListener.setShortDescription(resources.getString("Button_actionListener_Description"));
            ...
            prop_alt.setDisplayName(resources.getString("Button_alt_DisplayName"));
            prop_alt.setShortDescription(resources.getString("Button_alt_Description"));
            ...
            prop_disabled.setDisplayName(resources.getString("Button_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("Button_disabled_Description"));
            ...
            prop_escape.setDisplayName(resources.getString("Button_escape_DisplayName"));
            prop_escape.setShortDescription(resources.getString("Button_escape_Description"));
            ...
            prop_imageURL.setDisplayName(resources.getString("Button_imageURL_DisplayName"));
            prop_imageURL.setShortDescription(resources.getString("Button_imageURL_Description"));
            ...
            prop_mini.setDisplayName(resources.getString("Button_mini_DisplayName"));
            prop_mini.setShortDescription(resources.getString("Button_mini_Description"));
            ...
            PropertyDescriptor prop_noTextPadding = new PropertyDescriptor("noTextPadding",beanClass,"isNoTextPadding","setNoTextPadding");
            prop_noTextPadding.setDisplayName(resources.getString("Button_noTextPadding_DisplayName"));
            prop_noTextPadding.setShortDescription(resources.getString("Button_noTextPadding_Description"));
            prop_noTextPadding.setExpert(false);
            prop_noTextPadding.setHidden(false);
            prop_noTextPadding.setPreferred(false);
            attrib = new AttributeDescriptor("noTextPadding",false,null,true);
            prop_noTextPadding.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_noTextPadding.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.APPEARANCE);

            PropertyDescriptor prop_onBlur = new PropertyDescriptor("onBlur",beanClass,"getOnBlur","setOnBlur");
            prop_onBlur.setDisplayName(resources.getString("Button_onBlur_DisplayName"));
            prop_onBlur.setShortDescription(resources.getString("Button_onBlur_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("Button_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("Button_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("Button_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("Button_onDblClick_Description"));
            ...
            prop_onFocus.setDisplayName(resources.getString("Button_onFocus_DisplayName"));
            prop_onFocus.setShortDescription(resources.getString("Button_onFocus_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("Button_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("Button_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("Button_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("Button_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("Button_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("Button_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("Button_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("Button_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("Button_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("Button_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("Button_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("Button_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("Button_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("Button_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("Button_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("Button_onMouseUp_Description"));
            ...
            PropertyDescriptor prop_primary = new PropertyDescriptor("primary",beanClass,"isPrimary","setPrimary");
            prop_primary.setDisplayName(resources.getString("Button_primary_DisplayName"));
            prop_primary.setShortDescription(resources.getString("Button_primary_Description"));
            prop_primary.setExpert(false);
            prop_primary.setHidden(false);
            prop_primary.setPreferred(false);
            attrib = new AttributeDescriptor("primary",false,null,true);
            prop_primary.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_primary.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.APPEARANCE);

            PropertyDescriptor prop_reset = new PropertyDescriptor("reset",beanClass,"isReset","setReset");
            prop_reset.setDisplayName(resources.getString("Button_reset_DisplayName"));
            prop_reset.setShortDescription(resources.getString("Button_reset_Description"));
            prop_reset.setExpert(false);
            prop_reset.setHidden(false);
            prop_reset.setPreferred(false);
            attrib = new AttributeDescriptor("reset",false,null,true);
            prop_reset.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_reset.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.BEHAVIOR);

            PropertyDescriptor prop_style = new PropertyDescriptor("style",beanClass,"getStyle","setStyle");
            prop_style.setDisplayName(resources.getString("Button_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("Button_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("Button_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("Button_styleClass_Description"));
            ...
            prop_tabIndex.setDisplayName(resources.getString("Button_tabIndex_DisplayName"));
            prop_tabIndex.setShortDescription(resources.getString("Button_tabIndex_Description"));
            ...
            prop_text.setDisplayName(resources.getString("Button_text_DisplayName"));
            prop_text.setShortDescription(resources.getString("Button_text_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("Button_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("Button_toolTip_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("Button_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("Button_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("Button_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("Button_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("Button_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("Button_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("Button_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("Button_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("Button_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("Button_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("Button_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("Button_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("Button_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("Button_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("Button_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("Button_immediate_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("Button_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("Button_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("Button_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("Button_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("Button_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("Button_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("Button_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("Button_rendersChildren_Description"));
            ...
            prop_value.setDisplayName(resources.getString("Button_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("Button_value_Description"));
