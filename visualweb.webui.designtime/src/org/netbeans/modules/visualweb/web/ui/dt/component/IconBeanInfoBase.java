...
abstract class IconBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), IconBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>IconBeanInfoBase</code>.</p>
     */
    public IconBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.Icon.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Icon_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Icon_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Icon_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Icon_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("Icon_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("Icon_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"icon");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.FALSE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"icon");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_align.setDisplayName(resources.getString("Icon_align_DisplayName"));
            prop_align.setShortDescription(resources.getString("Icon_align_Description"));
            ...
            prop_alt.setDisplayName(resources.getString("Icon_alt_DisplayName"));
            prop_alt.setShortDescription(resources.getString("Icon_alt_Description"));
            ...
            prop_border.setDisplayName(resources.getString("Icon_border_DisplayName"));
            prop_border.setShortDescription(resources.getString("Icon_border_Description"));
            ...
            prop_height.setDisplayName(resources.getString("Icon_height_DisplayName"));
            prop_height.setShortDescription(resources.getString("Icon_height_Description"));
            ...
            prop_hspace.setDisplayName(resources.getString("Icon_hspace_DisplayName"));
            prop_hspace.setShortDescription(resources.getString("Icon_hspace_Description"));
            ...
            prop_icon.setDisplayName(resources.getString("Icon_icon_DisplayName"));
            prop_icon.setShortDescription(resources.getString("Icon_icon_Description"));
            ...
            prop_longDesc.setDisplayName(resources.getString("Icon_longDesc_DisplayName"));
            prop_longDesc.setShortDescription(resources.getString("Icon_longDesc_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("Icon_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("Icon_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("Icon_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("Icon_onDblClick_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("Icon_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("Icon_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("Icon_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("Icon_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("Icon_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("Icon_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("Icon_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("Icon_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("Icon_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("Icon_onMouseUp_Description"));
            ...
            prop_style.setDisplayName(resources.getString("Icon_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("Icon_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("Icon_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("Icon_styleClass_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("Icon_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("Icon_toolTip_Description"));
            ...
            prop_url.setDisplayName(resources.getString("Icon_url_DisplayName"));
            prop_url.setShortDescription(resources.getString("Icon_url_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("Icon_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("Icon_visible_Description"));
            ...
            prop_vspace.setDisplayName(resources.getString("Icon_vspace_DisplayName"));
            prop_vspace.setShortDescription(resources.getString("Icon_vspace_Description"));
            ...
            prop_width.setDisplayName(resources.getString("Icon_width_DisplayName"));
            prop_width.setShortDescription(resources.getString("Icon_width_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("Icon_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("Icon_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("Icon_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("Icon_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("Icon_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("Icon_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("Icon_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("Icon_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("Icon_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("Icon_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("Icon_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("Icon_id_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("Icon_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("Icon_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("Icon_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("Icon_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("Icon_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("Icon_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("Icon_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("Icon_rendersChildren_Description"));
            ...
            prop_value.setDisplayName(resources.getString("Icon_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("Icon_value_Description"));
