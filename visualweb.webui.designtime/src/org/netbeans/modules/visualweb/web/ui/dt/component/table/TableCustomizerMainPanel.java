...
public class TableCustomizerMainPanel extends javax.swing.JPanel implements DesignContextListener{
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("org/netbeans/modules/visualweb/web/ui/dt/component/table/Bundle"); // NOI18N
        lblTableDataProvider.setText(bundle.getString("TABLE_DATA_PROVIDER_TITLE")); // NOI18N
        lblTableDataProvider.setVerifyInputWhenFocusTarget(false);
        getDataPanel.add(lblTableDataProvider, java.awt.BorderLayout.WEST);
        lblTableDataProvider.getAccessibleContext().setAccessibleDescription(bundle.getString("GET_DATA_FROM_ACCESS_DESC")); // NOI18N
        ...
        cbxTableDataprovider.getAccessibleContext().setAccessibleDescription(bundle.getString("GET_DATA_FROM_ACCESS_DESC")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(addDataProviderButton, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "ADD_DP_BUTTON_LBL")); // NOI18N
        ...
        addDataProviderButton.getAccessibleContext().setAccessibleDescription(bundle.getString("ADD_DATA_PROVIDER_ACCESS_DESC")); // NOI18N
        ...
        addButton.setText(bundle.getString("ADD_TO_BUTTON_LBL")); // NOI18N
        ...
        removeButton.setText(bundle.getString("REMOVE_FROM_BUTTON_LBL")); // NOI18N
        ...
        removeAllButton.setText(bundle.getString("REMOVE_ALL_BUTTON_LBL")); // NOI18N
        ...
        addAllButton.setText(bundle.getString("ADD_ALL_BUTTON")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(upButton, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "UP_BUTTON_LBL")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(downButton, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "DOWN_BUTTON_LBL")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(newColumnButton, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "NEW_BUTTON_LABEL")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblAvailableColumns, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "AVAILABLE_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.gridwidth = 2;
        ...
        lblAvailableColumns.getAccessibleContext().setAccessibleName(bundle.getString("AVAILABLE_LBL")); // NOI18N

        lblSelectedColumns.setLabelFor(selectedColumns);
        org.openide.awt.Mnemonics.setLocalizedText(lblSelectedColumns, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "SELECTED_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        lblColumnDetails.setText(bundle.getString("COLUMN_DETAILS_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.gridwidth = 2;
        ...
        cbxHorzAlign.getAccessibleContext().setAccessibleDescription(bundle.getString("HORIZ_ALIGN_ACCESS_DESC")); // NOI18N

        lblHorzAlign.setLabelFor(cbxHorzAlign);
        org.openide.awt.Mnemonics.setLocalizedText(lblHorzAlign, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "HORIZONTAL_ALIGN_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblHeaderText, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "HEADER_TEXT_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblFooterText, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "FOOTER_TEXT_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        txtHeader.getAccessibleContext().setAccessibleDescription(bundle.getString("HEADER_TEXT_ACCESS_DESC")); // NOI18N
        ...
        txtFooter.getAccessibleContext().setAccessibleDescription(bundle.getString("FOOTER_COLUMN_ACCESS_DESC")); // NOI18N

        lblComponentType.setLabelFor(cbxComponentType);
        org.openide.awt.Mnemonics.setLocalizedText(lblComponentType, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "COMPONENT_TYPE_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        lblComponentType.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "SELECT_COLUMN_TYPE_ACCESS_DESC")); // NOI18N
        ...
        cbxComponentType.getAccessibleContext().setAccessibleDescription(bundle.getString("SELECT_COLUMN_TYPE_ACCESS_DESC")); // NOI18N

        lblValueExpression.setLabelFor(txtValueExpression);
        org.openide.awt.Mnemonics.setLocalizedText(lblValueExpression, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "VALUE_EXPRESSION_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        txtValueExpression.getAccessibleContext().setAccessibleDescription(bundle.getString("COLUMN_EXPRESSION_ACCESS_DESC")); // NOI18N

        lblVertAlign.setLabelFor(cbxVertAlign);
        org.openide.awt.Mnemonics.setLocalizedText(lblVertAlign, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "VERTICAL_ALIGN_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 6;
        ...
        cbxVertAlign.getAccessibleContext().setAccessibleDescription(bundle.getString("VERT_ALIGN_ACCESS_DESC")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(cbSortable, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "SORTABLE_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        cbSortable.getAccessibleContext().setAccessibleDescription(bundle.getString("MAKE_COLUMN_SORTABLE_ACCESS_DESC")); // NOI18N

        jLabel1.setLabelFor(widthField);
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "WIDTH_LABEL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jLabel1.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "WIDTH_ACCESS_DESC")); // NOI18N
        ...
        widthField.getAccessibleContext().setAccessibleDescription(bundle.getString("WIDTH_ACCESS_DESC")); // NOI18N

        columnsPanel.add(columnDetailPanel, java.awt.BorderLayout.SOUTH);

        tableLayoutPanel.addTab(bundle.getString("COLUMNS_TAB_TITLE"), columnsPanel); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblTableTitle, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "TITLE_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblTableSummary, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "SUMMARY_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        lblTableSummary.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "EMPTY_MESSAGE_ACCESS_DESC")); // NOI18N
        ...
        txtTableTitle.getAccessibleContext().setAccessibleDescription(bundle.getString("TITLE_ACCESS_DESC")); // NOI18N
        ...
        txtTableSummary.getAccessibleContext().setAccessibleDescription(bundle.getString("SUMMARY_ACCESS_DESC")); // NOI18N
        ...
        txtTableFooter.getAccessibleContext().setAccessibleDescription(bundle.getString("FOOTER_ACCESS_DESC")); // NOI18N

        lblTableFooter.setLabelFor(txtTableSummary);
        org.openide.awt.Mnemonics.setLocalizedText(lblTableFooter, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "FOOTER_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblEmptyDataMsg, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "EMPTY_DATA_MSG_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        txtEmptyDataMsg.getAccessibleContext().setAccessibleDescription(bundle.getString("EMPTY_MESSAGE_ACCESS_DESC")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(cbSelectAllRowsButton, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "SELECT_ALL_ROWS_BUTTON_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        cbSelectAllRowsButton.getAccessibleContext().setAccessibleDescription(bundle.getString("SHOW_SELECT_ALL_ACCESS_DESC")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(cbDeselectAllRowsButton, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "DESELECT_ALL_ROWS_BUTTON_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        cbDeselectAllRowsButton.getAccessibleContext().setAccessibleDescription(bundle.getString("SHOW_DESELECT_ALL_ACCESS_DESC")); // NOI18N

        pageSizePanel.setLayout(new java.awt.BorderLayout(5, 5));

        lblPageSize.setLabelFor(txtPageRows);
        org.openide.awt.Mnemonics.setLocalizedText(lblPageSize, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "PAGE_SIZE_LBL")); // NOI18N
        lblPageSize.setEnabled(false);
        pageSizePanel.add(lblPageSize, java.awt.BorderLayout.WEST);
        lblPageSize.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "PAGE_ROWS_ACCESS_DESC")); // NOI18N
        ...
        txtPageRows.getAccessibleContext().setAccessibleDescription(bundle.getString("PAGE_ROWS_ACCESS_DESC")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(cbEnablePagination, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "ENABLE_PAGINATION_LBL")); // NOI18N
        ...
        cbEnablePagination.getAccessibleContext().setAccessibleDescription(bundle.getString("ENABLE_PAGINATION_ACCESS_DESC")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(cbClearSortButton, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "SHOW_CLEAR_SORT_BUTTON_LBL")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        cbClearSortButton.getAccessibleContext().setAccessibleDescription(bundle.getString("SHOW_CLEAR_SORT_ACCESS_DESC")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(cbSortPanelButton, org.openide.util.NbBundle.getMessage(TableCustomizerMainPanel.class, "SHOW_SORT_PANEL_TOGGLE_BUTTON")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        cbSortPanelButton.getAccessibleContext().setAccessibleDescription(bundle.getString("SHOW_TOGGLE_SORT_ACCESS_DESC")); // NOI18N
        ...
        tableLayoutPanel.addTab(bundle.getString("OPTIONS_TAB_TITLE"), optionsPanel); // NOI18N
