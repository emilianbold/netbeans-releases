...
abstract class StaticTextBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), StaticTextBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>StaticTextBeanInfoBase</code>.</p>
     */
    public StaticTextBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.StaticText.class;
        defaultPropertyName = "text";
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/StaticText_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/StaticText_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/StaticText_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/StaticText_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("StaticText_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("StaticText_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_bh_static_text");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"staticText");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_palette_bh_propsheets_bh_static_text_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"staticText");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_escape.setDisplayName(resources.getString("StaticText_escape_DisplayName"));
            prop_escape.setShortDescription(resources.getString("StaticText_escape_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("StaticText_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("StaticText_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("StaticText_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("StaticText_onDblClick_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("StaticText_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("StaticText_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("StaticText_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("StaticText_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("StaticText_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("StaticText_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("StaticText_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("StaticText_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("StaticText_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("StaticText_onMouseUp_Description"));
            ...
            prop_style.setDisplayName(resources.getString("StaticText_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("StaticText_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("StaticText_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("StaticText_styleClass_Description"));
            ...
            prop_text.setDisplayName(resources.getString("StaticText_text_DisplayName"));
            prop_text.setShortDescription(resources.getString("StaticText_text_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("StaticText_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("StaticText_toolTip_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("StaticText_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("StaticText_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("StaticText_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("StaticText_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("StaticText_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("StaticText_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("StaticText_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("StaticText_children_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("StaticText_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("StaticText_converter_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("StaticText_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("StaticText_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("StaticText_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("StaticText_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("StaticText_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("StaticText_id_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("StaticText_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("StaticText_localValue_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("StaticText_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("StaticText_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("StaticText_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("StaticText_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("StaticText_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("StaticText_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("StaticText_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("StaticText_rendersChildren_Description"));
            ...
            prop_value.setDisplayName(resources.getString("StaticText_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("StaticText_value_Description"));
