...
abstract class TextFieldBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), TextFieldBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>TextFieldBeanInfoBase</code>.</p>
     */
    public TextFieldBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.TextField.class;
        defaultPropertyName = "text";
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/TextField_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/TextField_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/TextField_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/TextField_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("TextField_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("TextField_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_bh_text_field");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"textField");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_palette_bh_propsheets_bh_text_field_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"textField");
    ...
    public FacetDescriptor[] getFacetDescriptors() {
        ...
        try {
            ...
            facet_label.setDisplayName(resources.getString("TextField_label_DisplayName"));
            facet_label.setShortDescription(resources.getString("TextField_label_Description"));

            FacetDescriptor facet_readOnly = new FacetDescriptor("readOnly");
            facet_readOnly.setDisplayName(resources.getString("TextField_readOnly_DisplayName"));
            facet_readOnly.setShortDescription(resources.getString("TextField_readOnly_Description"));
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_columns.setDisplayName(resources.getString("TextField_columns_DisplayName"));
            prop_columns.setShortDescription(resources.getString("TextField_columns_Description"));
            ...
            prop_disabled.setDisplayName(resources.getString("TextField_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("TextField_disabled_Description"));
            ...
            prop_label.setDisplayName(resources.getString("TextField_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("TextField_label_Description"));
            ...
            prop_labelLevel.setDisplayName(resources.getString("TextField_labelLevel_DisplayName"));
            prop_labelLevel.setShortDescription(resources.getString("TextField_labelLevel_Description"));
            ...
            prop_maxLength.setDisplayName(resources.getString("TextField_maxLength_DisplayName"));
            prop_maxLength.setShortDescription(resources.getString("TextField_maxLength_Description"));
            ...
            prop_onBlur.setDisplayName(resources.getString("TextField_onBlur_DisplayName"));
            prop_onBlur.setShortDescription(resources.getString("TextField_onBlur_Description"));
            ...
            prop_onChange.setDisplayName(resources.getString("TextField_onChange_DisplayName"));
            prop_onChange.setShortDescription(resources.getString("TextField_onChange_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("TextField_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("TextField_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("TextField_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("TextField_onDblClick_Description"));
            ...
            prop_onFocus.setDisplayName(resources.getString("TextField_onFocus_DisplayName"));
            prop_onFocus.setShortDescription(resources.getString("TextField_onFocus_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("TextField_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("TextField_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("TextField_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("TextField_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("TextField_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("TextField_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("TextField_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("TextField_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("TextField_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("TextField_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("TextField_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("TextField_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("TextField_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("TextField_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("TextField_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("TextField_onMouseUp_Description"));
            ...
            prop_onSelect.setDisplayName(resources.getString("TextField_onSelect_DisplayName"));
            prop_onSelect.setShortDescription(resources.getString("TextField_onSelect_Description"));
            ...
            prop_readOnly.setDisplayName(resources.getString("TextField_readOnly_DisplayName"));
            prop_readOnly.setShortDescription(resources.getString("TextField_readOnly_Description"));
            ...
            prop_style.setDisplayName(resources.getString("TextField_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("TextField_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("TextField_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("TextField_styleClass_Description"));
            ...
            prop_tabIndex.setDisplayName(resources.getString("TextField_tabIndex_DisplayName"));
            prop_tabIndex.setShortDescription(resources.getString("TextField_tabIndex_Description"));
            ...
            prop_text.setDisplayName(resources.getString("TextField_text_DisplayName"));
            prop_text.setShortDescription(resources.getString("TextField_text_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("TextField_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("TextField_toolTip_Description"));
            ...
            prop_trim.setDisplayName(resources.getString("TextField_trim_DisplayName"));
            prop_trim.setShortDescription(resources.getString("TextField_trim_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("TextField_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("TextField_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("TextField_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("TextField_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("TextField_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("TextField_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("TextField_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("TextField_children_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("TextField_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("TextField_converter_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("TextField_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("TextField_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("TextField_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("TextField_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("TextField_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("TextField_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("TextField_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("TextField_immediate_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("TextField_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("TextField_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("TextField_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("TextField_localValueSet_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("TextField_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("TextField_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("TextField_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("TextField_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("TextField_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("TextField_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("TextField_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("TextField_rendersChildren_Description"));
            ...
            prop_required.setDisplayName(resources.getString("TextField_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("TextField_required_Description"));
            ...
            prop_submittedValue.setDisplayName(resources.getString("TextField_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("TextField_submittedValue_Description"));
            ...
            prop_validator.setDisplayName(resources.getString("TextField_validator_DisplayName"));
            prop_validator.setShortDescription(resources.getString("TextField_validator_Description"));
            ...
            prop_value.setDisplayName(resources.getString("TextField_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("TextField_value_Description"));
            ...
            prop_valueChangeListener.setDisplayName(resources.getString("TextField_valueChangeListener_DisplayName"));
            prop_valueChangeListener.setShortDescription(resources.getString("TextField_valueChangeListener_Description"));
