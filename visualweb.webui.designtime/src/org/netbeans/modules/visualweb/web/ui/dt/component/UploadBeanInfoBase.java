...
abstract class UploadBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), UploadBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>UploadBeanInfoBase</code>.</p>
     */
    public UploadBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.Upload.class;
        defaultPropertyName = "target";
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Upload_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Upload_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Upload_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Upload_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("Upload_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("Upload_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_bh_file_upload");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"fileUpload");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.FALSE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_palette_bh_propsheets_bh_file_upload_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"upload");
    ...
    public FacetDescriptor[] getFacetDescriptors() {
        ...
        try {
            ...
            facet_label.setDisplayName(resources.getString("Upload_label_DisplayName"));
            facet_label.setShortDescription(resources.getString("Upload_label_Description"));

            FacetDescriptor facet_readOnly = new FacetDescriptor("readOnly");
            facet_readOnly.setDisplayName(resources.getString("Upload_readOnly_DisplayName"));
            facet_readOnly.setShortDescription(resources.getString("Upload_readOnly_Description"));
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_columns.setDisplayName(resources.getString("Upload_columns_DisplayName"));
            prop_columns.setShortDescription(resources.getString("Upload_columns_Description"));
            ...
            attrib = new AttributeDescriptor("columns",false,"40",true);
            ...
            prop_converter.setDisplayName(resources.getString("Upload_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("Upload_converter_Description"));
            ...
            prop_maxLength.setDisplayName(resources.getString("Upload_maxLength_DisplayName"));
            prop_maxLength.setShortDescription(resources.getString("Upload_maxLength_Description"));
            ...
            PropertyDescriptor prop_uploadedFile = new PropertyDescriptor("uploadedFile",beanClass,"getUploadedFile","setUploadedFile");
            prop_uploadedFile.setDisplayName(resources.getString("Upload_uploadedFile_DisplayName"));
            prop_uploadedFile.setShortDescription(resources.getString("Upload_uploadedFile_Description"));
            prop_uploadedFile.setPropertyEditorClass(loadClass("com.sun.rave.propertyeditors.binding.ValueBindingPropertyEditor"));
            prop_uploadedFile.setExpert(false);
            prop_uploadedFile.setHidden(false);
            prop_uploadedFile.setPreferred(false);
            attrib = new AttributeDescriptor("uploadedFile",false,null,true);
            prop_uploadedFile.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_uploadedFile.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.DATA);

            PropertyDescriptor prop_disabled = new PropertyDescriptor("disabled",beanClass,"isDisabled","setDisabled");
            prop_disabled.setDisplayName(resources.getString("Upload_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("Upload_disabled_Description"));
            ...
            prop_label.setDisplayName(resources.getString("Upload_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("Upload_label_Description"));
            ...
            prop_labelLevel.setDisplayName(resources.getString("Upload_labelLevel_DisplayName"));
            prop_labelLevel.setShortDescription(resources.getString("Upload_labelLevel_Description"));
            ...
            prop_onBlur.setDisplayName(resources.getString("Upload_onBlur_DisplayName"));
            prop_onBlur.setShortDescription(resources.getString("Upload_onBlur_Description"));
            ...
            prop_onChange.setDisplayName(resources.getString("Upload_onChange_DisplayName"));
            prop_onChange.setShortDescription(resources.getString("Upload_onChange_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("Upload_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("Upload_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("Upload_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("Upload_onDblClick_Description"));
            ...
            prop_onFocus.setDisplayName(resources.getString("Upload_onFocus_DisplayName"));
            prop_onFocus.setShortDescription(resources.getString("Upload_onFocus_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("Upload_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("Upload_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("Upload_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("Upload_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("Upload_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("Upload_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("Upload_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("Upload_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("Upload_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("Upload_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("Upload_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("Upload_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("Upload_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("Upload_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("Upload_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("Upload_onMouseUp_Description"));
            ...
            prop_onSelect.setDisplayName(resources.getString("Upload_onSelect_DisplayName"));
            prop_onSelect.setShortDescription(resources.getString("Upload_onSelect_Description"));
            ...
            prop_readOnly.setDisplayName(resources.getString("Upload_readOnly_DisplayName"));
            prop_readOnly.setShortDescription(resources.getString("Upload_readOnly_Description"));
            ...
            prop_style.setDisplayName(resources.getString("Upload_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("Upload_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("Upload_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("Upload_styleClass_Description"));
            ...
            prop_tabIndex.setDisplayName(resources.getString("Upload_tabIndex_DisplayName"));
            prop_tabIndex.setShortDescription(resources.getString("Upload_tabIndex_Description"));
            ...
            prop_text.setDisplayName(resources.getString("Upload_text_DisplayName"));
            prop_text.setShortDescription(resources.getString("Upload_text_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("Upload_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("Upload_toolTip_Description"));
            ...
            prop_trim.setDisplayName(resources.getString("Upload_trim_DisplayName"));
            prop_trim.setShortDescription(resources.getString("Upload_trim_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("Upload_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("Upload_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("Upload_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("Upload_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("Upload_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("Upload_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("Upload_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("Upload_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("Upload_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("Upload_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("Upload_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("Upload_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("Upload_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("Upload_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("Upload_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("Upload_immediate_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("Upload_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("Upload_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("Upload_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("Upload_localValueSet_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("Upload_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("Upload_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("Upload_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("Upload_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("Upload_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("Upload_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("Upload_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("Upload_rendersChildren_Description"));
            ...
            prop_required.setDisplayName(resources.getString("Upload_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("Upload_required_Description"));
            ...
            prop_submittedValue.setDisplayName(resources.getString("Upload_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("Upload_submittedValue_Description"));
            ...
            prop_validator.setDisplayName(resources.getString("Upload_validator_DisplayName"));
            prop_validator.setShortDescription(resources.getString("Upload_validator_Description"));
            ...
            prop_value.setDisplayName(resources.getString("Upload_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("Upload_value_Description"));
            ...
            prop_valueChangeListener.setDisplayName(resources.getString("Upload_valueChangeListener_DisplayName"));
            prop_valueChangeListener.setShortDescription(resources.getString("Upload_valueChangeListener_Description"));
