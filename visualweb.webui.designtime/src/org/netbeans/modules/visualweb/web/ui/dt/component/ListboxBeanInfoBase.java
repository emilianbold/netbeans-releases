...
abstract class ListboxBeanInfoBase extends SimpleBeanInfo {
    ...
    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), ListboxBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>ListboxBeanInfoBase</code>.</p>
     */
    public ListboxBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.Listbox.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Listbox_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Listbox_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Listbox_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Listbox_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("Listbox_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("Listbox_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_bh_listbox");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"listbox");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_palette_bh_propsheets_bh_listbox_props");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            PropertyDescriptor prop_monospace = new PropertyDescriptor("monospace",beanClass,"isMonospace","setMonospace");
            prop_monospace.setDisplayName(resources.getString("Listbox_monospace_DisplayName"));
            prop_monospace.setShortDescription(resources.getString("Listbox_monospace_Description"));
            prop_monospace.setExpert(false);
            prop_monospace.setHidden(false);
            prop_monospace.setPreferred(false);
            attrib = new AttributeDescriptor("monospace",false,null,true);
            prop_monospace.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_monospace.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.APPEARANCE);

            PropertyDescriptor prop_multiple = new PropertyDescriptor("multiple",beanClass,"isMultiple","setMultiple");
            prop_multiple.setDisplayName(resources.getString("Listbox_multiple_DisplayName"));
            prop_multiple.setShortDescription(resources.getString("Listbox_multiple_Description"));
            ...
            prop_labelOnTop.setDisplayName(resources.getString("Listbox_labelOnTop_DisplayName"));
            prop_labelOnTop.setShortDescription(resources.getString("Listbox_labelOnTop_Description"));
            ...
            prop_rows.setDisplayName(resources.getString("Listbox_rows_DisplayName"));
            prop_rows.setShortDescription(resources.getString("Listbox_rows_Description"));
            ...
            prop_separators.setDisplayName(resources.getString("Listbox_separators_DisplayName"));
            prop_separators.setShortDescription(resources.getString("Listbox_separators_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("Listbox_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("Listbox_visible_Description"));
            ...
            prop_disabled.setDisplayName(resources.getString("Listbox_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("Listbox_disabled_Description"));
            ...
            prop_items.setDisplayName(resources.getString("Listbox_items_DisplayName"));
            prop_items.setShortDescription(resources.getString("Listbox_items_Description"));
            ...
            prop_label.setDisplayName(resources.getString("Listbox_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("Listbox_label_Description"));
            ...
            prop_labelLevel.setDisplayName(resources.getString("Listbox_labelLevel_DisplayName"));
            prop_labelLevel.setShortDescription(resources.getString("Listbox_labelLevel_Description"));
            ...
            prop_onBlur.setDisplayName(resources.getString("Listbox_onBlur_DisplayName"));
            prop_onBlur.setShortDescription(resources.getString("Listbox_onBlur_Description"));
            ...
            prop_onChange.setDisplayName(resources.getString("Listbox_onChange_DisplayName"));
            prop_onChange.setShortDescription(resources.getString("Listbox_onChange_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("Listbox_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("Listbox_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("Listbox_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("Listbox_onDblClick_Description"));
            ...
            prop_onFocus.setDisplayName(resources.getString("Listbox_onFocus_DisplayName"));
            prop_onFocus.setShortDescription(resources.getString("Listbox_onFocus_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("Listbox_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("Listbox_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("Listbox_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("Listbox_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("Listbox_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("Listbox_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("Listbox_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("Listbox_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("Listbox_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("Listbox_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("Listbox_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("Listbox_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("Listbox_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("Listbox_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("Listbox_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("Listbox_onMouseUp_Description"));
            ...
            prop_onSelect.setDisplayName(resources.getString("Listbox_onSelect_DisplayName"));
            prop_onSelect.setShortDescription(resources.getString("Listbox_onSelect_Description"));
            ...
            prop_readOnly.setDisplayName(resources.getString("Listbox_readOnly_DisplayName"));
            prop_readOnly.setShortDescription(resources.getString("Listbox_readOnly_Description"));
            ...
            prop_selected.setDisplayName(resources.getString("Listbox_selected_DisplayName"));
            prop_selected.setShortDescription(resources.getString("Listbox_selected_Description"));
            ...
            prop_style.setDisplayName(resources.getString("Listbox_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("Listbox_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("Listbox_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("Listbox_styleClass_Description"));
            ...
            prop_tabIndex.setDisplayName(resources.getString("Listbox_tabIndex_DisplayName"));
            prop_tabIndex.setShortDescription(resources.getString("Listbox_tabIndex_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("Listbox_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("Listbox_toolTip_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("Listbox_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("Listbox_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("Listbox_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("Listbox_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("Listbox_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("Listbox_children_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("Listbox_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("Listbox_converter_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("Listbox_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("Listbox_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("Listbox_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("Listbox_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("Listbox_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("Listbox_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("Listbox_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("Listbox_immediate_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("Listbox_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("Listbox_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("Listbox_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("Listbox_localValueSet_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("Listbox_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("Listbox_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("Listbox_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("Listbox_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("Listbox_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("Listbox_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("Listbox_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("Listbox_rendersChildren_Description"));
            ...
            prop_required.setDisplayName(resources.getString("Listbox_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("Listbox_required_Description"));
            ...
            prop_submittedValue.setDisplayName(resources.getString("Listbox_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("Listbox_submittedValue_Description"));
            ...
            prop_validator.setDisplayName(resources.getString("Listbox_validator_DisplayName"));
            prop_validator.setShortDescription(resources.getString("Listbox_validator_Description"));
            ...
            prop_value.setDisplayName(resources.getString("Listbox_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("Listbox_value_Description"));
            ...
            prop_valueChangeListener.setDisplayName(resources.getString("Listbox_valueChangeListener_DisplayName"));
            prop_valueChangeListener.setShortDescription(resources.getString("Listbox_valueChangeListener_Description"));
