...
abstract class RadioButtonBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), RadioButtonBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>RadioButtonBeanInfoBase</code>.</p>
     */
    public RadioButtonBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.RadioButton.class;
        defaultPropertyName = "selectedValue";
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/RadioButton_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/RadioButton_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/RadioButton_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/RadioButton_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("RadioButton_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("RadioButton_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_bh_radiobutton");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"radioButton");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_palette_bh_propsheets_bh_radiobutton_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"radioButton");
    ...
    public FacetDescriptor[] getFacetDescriptors() {
        ...
        try {
            ...
            facet_image.setDisplayName(resources.getString("RadioButton_image_DisplayName"));
            facet_image.setShortDescription(resources.getString("RadioButton_image_Description"));

            FacetDescriptor facet_label = new FacetDescriptor("label");
            facet_label.setDisplayName(resources.getString("RadioButton_label_DisplayName"));
            facet_label.setShortDescription(resources.getString("RadioButton_label_Description"));
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_labelLevel.setDisplayName(resources.getString("RadioButton_labelLevel_DisplayName"));
            prop_labelLevel.setShortDescription(resources.getString("RadioButton_labelLevel_Description"));
            ...
            prop_imageURL.setDisplayName(resources.getString("RadioButton_imageURL_DisplayName"));
            prop_imageURL.setShortDescription(resources.getString("RadioButton_imageURL_Description"));
            ...
            prop_items.setDisplayName(resources.getString("RadioButton_items_DisplayName"));
            prop_items.setShortDescription(resources.getString("RadioButton_items_Description"));
            ...
            prop_name.setDisplayName(resources.getString("RadioButton_name_DisplayName"));
            prop_name.setShortDescription(resources.getString("RadioButton_name_Description"));
            ...
            prop_selected.setDisplayName(resources.getString("RadioButton_selected_DisplayName"));
            prop_selected.setShortDescription(resources.getString("RadioButton_selected_Description"));
            ...
            prop_selectedValue.setDisplayName(resources.getString("RadioButton_selectedValue_DisplayName"));
            prop_selectedValue.setShortDescription(resources.getString("RadioButton_selectedValue_Description"));
            ...
            prop_disabled.setDisplayName(resources.getString("RadioButton_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("RadioButton_disabled_Description"));
            ...
            prop_label.setDisplayName(resources.getString("RadioButton_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("RadioButton_label_Description"));
            ...
            prop_onBlur.setDisplayName(resources.getString("RadioButton_onBlur_DisplayName"));
            prop_onBlur.setShortDescription(resources.getString("RadioButton_onBlur_Description"));
            ...
            prop_onChange.setDisplayName(resources.getString("RadioButton_onChange_DisplayName"));
            prop_onChange.setShortDescription(resources.getString("RadioButton_onChange_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("RadioButton_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("RadioButton_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("RadioButton_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("RadioButton_onDblClick_Description"));
            ...
            prop_onFocus.setDisplayName(resources.getString("RadioButton_onFocus_DisplayName"));
            prop_onFocus.setShortDescription(resources.getString("RadioButton_onFocus_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("RadioButton_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("RadioButton_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("RadioButton_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("RadioButton_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("RadioButton_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("RadioButton_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("RadioButton_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("RadioButton_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("RadioButton_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("RadioButton_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("RadioButton_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("RadioButton_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("RadioButton_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("RadioButton_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("RadioButton_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("RadioButton_onMouseUp_Description"));
            ...
            prop_onSelect.setDisplayName(resources.getString("RadioButton_onSelect_DisplayName"));
            prop_onSelect.setShortDescription(resources.getString("RadioButton_onSelect_Description"));
            ...
            prop_readOnly.setDisplayName(resources.getString("RadioButton_readOnly_DisplayName"));
            prop_readOnly.setShortDescription(resources.getString("RadioButton_readOnly_Description"));
            ...
            prop_style.setDisplayName(resources.getString("RadioButton_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("RadioButton_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("RadioButton_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("RadioButton_styleClass_Description"));
            ...
            prop_tabIndex.setDisplayName(resources.getString("RadioButton_tabIndex_DisplayName"));
            prop_tabIndex.setShortDescription(resources.getString("RadioButton_tabIndex_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("RadioButton_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("RadioButton_toolTip_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("RadioButton_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("RadioButton_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("RadioButton_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("RadioButton_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("RadioButton_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("RadioButton_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("RadioButton_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("RadioButton_children_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("RadioButton_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("RadioButton_converter_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("RadioButton_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("RadioButton_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("RadioButton_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("RadioButton_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("RadioButton_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("RadioButton_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("RadioButton_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("RadioButton_immediate_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("RadioButton_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("RadioButton_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("RadioButton_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("RadioButton_localValueSet_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("RadioButton_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("RadioButton_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("RadioButton_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("RadioButton_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("RadioButton_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("RadioButton_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("RadioButton_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("RadioButton_rendersChildren_Description"));
            ...
            prop_required.setDisplayName(resources.getString("RadioButton_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("RadioButton_required_Description"));
            ...
            prop_submittedValue.setDisplayName(resources.getString("RadioButton_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("RadioButton_submittedValue_Description"));
            ...
            prop_validator.setDisplayName(resources.getString("RadioButton_validator_DisplayName"));
            prop_validator.setShortDescription(resources.getString("RadioButton_validator_Description"));
            ...
            prop_value.setDisplayName(resources.getString("RadioButton_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("RadioButton_value_Description"));
            ...
            prop_valueChangeListener.setDisplayName(resources.getString("RadioButton_valueChangeListener_DisplayName"));
            prop_valueChangeListener.setShortDescription(resources.getString("RadioButton_valueChangeListener_Description"));
