...
abstract class CheckboxBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), CheckboxBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>CheckboxBeanInfoBase</code>.</p>
     */
    public CheckboxBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.Checkbox.class;
        defaultPropertyName = "selectedValue";
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Checkbox_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Checkbox_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Checkbox_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Checkbox_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("Checkbox_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("Checkbox_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_bh_checkbox");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"checkbox");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_palette_bh_propsheets_bh_checkbox_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"checkbox");
    ...
    public FacetDescriptor[] getFacetDescriptors() {
        ...
        try {
            ...
            facet_image.setDisplayName(resources.getString("Checkbox_image_DisplayName"));
            facet_image.setShortDescription(resources.getString("Checkbox_image_Description"));

            FacetDescriptor facet_label = new FacetDescriptor("label");
            facet_label.setDisplayName(resources.getString("Checkbox_label_DisplayName"));
            facet_label.setShortDescription(resources.getString("Checkbox_label_Description"));
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_labelLevel.setDisplayName(resources.getString("Checkbox_labelLevel_DisplayName"));
            prop_labelLevel.setShortDescription(resources.getString("Checkbox_labelLevel_Description"));
            ...
            attrib = new AttributeDescriptor("labelLevel",false,"3",true);
            ...
            prop_imageURL.setDisplayName(resources.getString("Checkbox_imageURL_DisplayName"));
            prop_imageURL.setShortDescription(resources.getString("Checkbox_imageURL_Description"));
            ...
            prop_items.setDisplayName(resources.getString("Checkbox_items_DisplayName"));
            prop_items.setShortDescription(resources.getString("Checkbox_items_Description"));
            ...
            prop_name.setDisplayName(resources.getString("Checkbox_name_DisplayName"));
            prop_name.setShortDescription(resources.getString("Checkbox_name_Description"));
            prop_name.setPropertyEditorClass(loadClass("com.sun.rave.propertyeditors.StringPropertyEditor"));
            prop_name.setExpert(false);
            prop_name.setHidden(true);
            ...
            prop_selected.setDisplayName(resources.getString("Checkbox_selected_DisplayName"));
            prop_selected.setShortDescription(resources.getString("Checkbox_selected_Description"));
            ...
            prop_selectedValue.setDisplayName(resources.getString("Checkbox_selectedValue_DisplayName"));
            prop_selectedValue.setShortDescription(resources.getString("Checkbox_selectedValue_Description"));
            ...
            prop_disabled.setDisplayName(resources.getString("Checkbox_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("Checkbox_disabled_Description"));
            ...
            prop_label.setDisplayName(resources.getString("Checkbox_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("Checkbox_label_Description"));
            ...
            prop_onBlur.setDisplayName(resources.getString("Checkbox_onBlur_DisplayName"));
            prop_onBlur.setShortDescription(resources.getString("Checkbox_onBlur_Description"));
            ...
            prop_onChange.setDisplayName(resources.getString("Checkbox_onChange_DisplayName"));
            prop_onChange.setShortDescription(resources.getString("Checkbox_onChange_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("Checkbox_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("Checkbox_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("Checkbox_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("Checkbox_onDblClick_Description"));
            ...
            prop_onFocus.setDisplayName(resources.getString("Checkbox_onFocus_DisplayName"));
            prop_onFocus.setShortDescription(resources.getString("Checkbox_onFocus_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("Checkbox_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("Checkbox_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("Checkbox_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("Checkbox_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("Checkbox_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("Checkbox_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("Checkbox_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("Checkbox_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("Checkbox_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("Checkbox_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("Checkbox_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("Checkbox_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("Checkbox_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("Checkbox_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("Checkbox_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("Checkbox_onMouseUp_Description"));
            ...
            prop_onSelect.setDisplayName(resources.getString("Checkbox_onSelect_DisplayName"));
            prop_onSelect.setShortDescription(resources.getString("Checkbox_onSelect_Description"));
            ...
            prop_readOnly.setDisplayName(resources.getString("Checkbox_readOnly_DisplayName"));
            prop_readOnly.setShortDescription(resources.getString("Checkbox_readOnly_Description"));
            ...
            prop_style.setDisplayName(resources.getString("Checkbox_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("Checkbox_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("Checkbox_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("Checkbox_styleClass_Description"));
            ...
            prop_tabIndex.setDisplayName(resources.getString("Checkbox_tabIndex_DisplayName"));
            prop_tabIndex.setShortDescription(resources.getString("Checkbox_tabIndex_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("Checkbox_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("Checkbox_toolTip_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("Checkbox_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("Checkbox_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("Checkbox_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("Checkbox_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("Checkbox_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("Checkbox_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("Checkbox_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("Checkbox_children_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("Checkbox_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("Checkbox_converter_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("Checkbox_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("Checkbox_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("Checkbox_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("Checkbox_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("Checkbox_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("Checkbox_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("Checkbox_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("Checkbox_immediate_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("Checkbox_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("Checkbox_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("Checkbox_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("Checkbox_localValueSet_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("Checkbox_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("Checkbox_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("Checkbox_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("Checkbox_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("Checkbox_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("Checkbox_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("Checkbox_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("Checkbox_rendersChildren_Description"));
            ...
            prop_required.setDisplayName(resources.getString("Checkbox_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("Checkbox_required_Description"));
            ...
            prop_submittedValue.setDisplayName(resources.getString("Checkbox_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("Checkbox_submittedValue_Description"));
            ...
            prop_validator.setDisplayName(resources.getString("Checkbox_validator_DisplayName"));
            prop_validator.setShortDescription(resources.getString("Checkbox_validator_Description"));
            ...
            prop_value.setDisplayName(resources.getString("Checkbox_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("Checkbox_value_Description"));
            ...
            prop_valueChangeListener.setDisplayName(resources.getString("Checkbox_valueChangeListener_DisplayName"));
            prop_valueChangeListener.setShortDescription(resources.getString("Checkbox_valueChangeListener_Description"));
