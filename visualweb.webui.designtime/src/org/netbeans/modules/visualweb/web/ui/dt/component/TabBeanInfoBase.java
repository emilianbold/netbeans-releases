...
abstract class TabBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), TabBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>TabBeanInfoBase</code>.</p>
     */
    public TabBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.Tab.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Tab_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Tab_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Tab_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Tab_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("Tab_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("Tab_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_bh_tab");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"tab");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_palette_bh_propsheets_bh_tab_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"tab");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            PropertyDescriptor prop_selectedChildId = new PropertyDescriptor("selectedChildId",beanClass,"getSelectedChildId","setSelectedChildId");
            prop_selectedChildId.setDisplayName(resources.getString("Tab_selectedChildId_DisplayName"));
            prop_selectedChildId.setShortDescription(resources.getString("Tab_selectedChildId_Description"));
            prop_selectedChildId.setExpert(false);
            prop_selectedChildId.setHidden(true);
            prop_selectedChildId.setPreferred(false);
            attrib = new AttributeDescriptor("selectedChildId",false,null,true);
            prop_selectedChildId.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_selectedChildId.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.GENERAL);

            PropertyDescriptor prop_value = new PropertyDescriptor("value",beanClass,"getValue","setValue");
            prop_value.setDisplayName(resources.getString("Tab_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("Tab_value_Description"));
            ...
            prop_action.setDisplayName(resources.getString("Tab_action_DisplayName"));
            prop_action.setShortDescription(resources.getString("Tab_action_Description"));
            ...
            prop_actionListener.setDisplayName(resources.getString("Tab_actionListener_DisplayName"));
            prop_actionListener.setShortDescription(resources.getString("Tab_actionListener_Description"));
            ...
            prop_disabled.setDisplayName(resources.getString("Tab_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("Tab_disabled_Description"));
            ...
            prop_onBlur.setDisplayName(resources.getString("Tab_onBlur_DisplayName"));
            prop_onBlur.setShortDescription(resources.getString("Tab_onBlur_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("Tab_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("Tab_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("Tab_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("Tab_onDblClick_Description"));
            ...
            prop_onFocus.setDisplayName(resources.getString("Tab_onFocus_DisplayName"));
            prop_onFocus.setShortDescription(resources.getString("Tab_onFocus_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("Tab_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("Tab_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("Tab_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("Tab_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("Tab_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("Tab_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("Tab_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("Tab_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("Tab_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("Tab_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("Tab_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("Tab_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("Tab_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("Tab_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("Tab_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("Tab_onMouseUp_Description"));
            ...
            prop_shape.setDisplayName(resources.getString("Tab_shape_DisplayName"));
            prop_shape.setShortDescription(resources.getString("Tab_shape_Description"));
            ...
            prop_style.setDisplayName(resources.getString("Tab_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("Tab_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("Tab_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("Tab_styleClass_Description"));
            ...
            prop_tabIndex.setDisplayName(resources.getString("Tab_tabIndex_DisplayName"));
            prop_tabIndex.setShortDescription(resources.getString("Tab_tabIndex_Description"));
            ...
            prop_target.setDisplayName(resources.getString("Tab_target_DisplayName"));
            prop_target.setShortDescription(resources.getString("Tab_target_Description"));
            ...
            prop_text.setDisplayName(resources.getString("Tab_text_DisplayName"));
            prop_text.setShortDescription(resources.getString("Tab_text_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("Tab_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("Tab_toolTip_Description"));
            ...
            prop_type.setDisplayName(resources.getString("Tab_type_DisplayName"));
            prop_type.setShortDescription(resources.getString("Tab_type_Description"));
            ...
            prop_url.setDisplayName(resources.getString("Tab_url_DisplayName"));
            prop_url.setShortDescription(resources.getString("Tab_url_Description"));
            ...
            prop_urlLang.setDisplayName(resources.getString("Tab_urlLang_DisplayName"));
            prop_urlLang.setShortDescription(resources.getString("Tab_urlLang_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("Tab_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("Tab_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("Tab_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("Tab_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("Tab_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("Tab_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("Tab_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("Tab_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("Tab_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("Tab_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("Tab_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("Tab_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("Tab_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("Tab_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("Tab_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("Tab_immediate_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("Tab_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("Tab_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("Tab_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("Tab_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("Tab_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("Tab_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("Tab_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("Tab_rendersChildren_Description"));
