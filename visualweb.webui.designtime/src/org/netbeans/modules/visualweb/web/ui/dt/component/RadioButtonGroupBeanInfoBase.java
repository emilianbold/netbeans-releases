...
abstract class RadioButtonGroupBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), RadioButtonGroupBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>RadioButtonGroupBeanInfoBase</code>.</p>
     */
    public RadioButtonGroupBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.RadioButtonGroup.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/RadioButtonGroup_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/RadioButtonGroup_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/RadioButtonGroup_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/RadioButtonGroup_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("RadioButtonGroup_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("RadioButtonGroup_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.HELP_KEY,"projrave_ui_elements_palette_bh_radiobutton_group");
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"radioButtonGroup");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTIES_HELP_KEY,"projrave_ui_elements_palette_bh_propsheets_bh_radiobutton_group_props");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"radioButtonGroup");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_columns.setDisplayName(resources.getString("RadioButtonGroup_columns_DisplayName"));
            prop_columns.setShortDescription(resources.getString("RadioButtonGroup_columns_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("RadioButtonGroup_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("RadioButtonGroup_visible_Description"));
            ...
            prop_disabled.setDisplayName(resources.getString("RadioButtonGroup_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("RadioButtonGroup_disabled_Description"));
            ...
            prop_items.setDisplayName(resources.getString("RadioButtonGroup_items_DisplayName"));
            prop_items.setShortDescription(resources.getString("RadioButtonGroup_items_Description"));
            ...
            prop_label.setDisplayName(resources.getString("RadioButtonGroup_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("RadioButtonGroup_label_Description"));
            ...
            prop_labelLevel.setDisplayName(resources.getString("RadioButtonGroup_labelLevel_DisplayName"));
            prop_labelLevel.setShortDescription(resources.getString("RadioButtonGroup_labelLevel_Description"));
            ...
            prop_onBlur.setDisplayName(resources.getString("RadioButtonGroup_onBlur_DisplayName"));
            prop_onBlur.setShortDescription(resources.getString("RadioButtonGroup_onBlur_Description"));
            ...
            prop_onChange.setDisplayName(resources.getString("RadioButtonGroup_onChange_DisplayName"));
            prop_onChange.setShortDescription(resources.getString("RadioButtonGroup_onChange_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("RadioButtonGroup_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("RadioButtonGroup_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("RadioButtonGroup_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("RadioButtonGroup_onDblClick_Description"));
            ...
            prop_onFocus.setDisplayName(resources.getString("RadioButtonGroup_onFocus_DisplayName"));
            prop_onFocus.setShortDescription(resources.getString("RadioButtonGroup_onFocus_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("RadioButtonGroup_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("RadioButtonGroup_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("RadioButtonGroup_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("RadioButtonGroup_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("RadioButtonGroup_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("RadioButtonGroup_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("RadioButtonGroup_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("RadioButtonGroup_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("RadioButtonGroup_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("RadioButtonGroup_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("RadioButtonGroup_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("RadioButtonGroup_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("RadioButtonGroup_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("RadioButtonGroup_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("RadioButtonGroup_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("RadioButtonGroup_onMouseUp_Description"));
            ...
            prop_onSelect.setDisplayName(resources.getString("RadioButtonGroup_onSelect_DisplayName"));
            prop_onSelect.setShortDescription(resources.getString("RadioButtonGroup_onSelect_Description"));
            ...
            prop_readOnly.setDisplayName(resources.getString("RadioButtonGroup_readOnly_DisplayName"));
            prop_readOnly.setShortDescription(resources.getString("RadioButtonGroup_readOnly_Description"));
            ...
            prop_selected.setDisplayName(resources.getString("RadioButtonGroup_selected_DisplayName"));
            prop_selected.setShortDescription(resources.getString("RadioButtonGroup_selected_Description"));
            ...
            prop_style.setDisplayName(resources.getString("RadioButtonGroup_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("RadioButtonGroup_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("RadioButtonGroup_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("RadioButtonGroup_styleClass_Description"));
            ...
            prop_tabIndex.setDisplayName(resources.getString("RadioButtonGroup_tabIndex_DisplayName"));
            prop_tabIndex.setShortDescription(resources.getString("RadioButtonGroup_tabIndex_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("RadioButtonGroup_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("RadioButtonGroup_toolTip_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("RadioButtonGroup_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("RadioButtonGroup_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("RadioButtonGroup_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("RadioButtonGroup_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("RadioButtonGroup_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("RadioButtonGroup_children_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("RadioButtonGroup_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("RadioButtonGroup_converter_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("RadioButtonGroup_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("RadioButtonGroup_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("RadioButtonGroup_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("RadioButtonGroup_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("RadioButtonGroup_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("RadioButtonGroup_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("RadioButtonGroup_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("RadioButtonGroup_immediate_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("RadioButtonGroup_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("RadioButtonGroup_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("RadioButtonGroup_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("RadioButtonGroup_localValueSet_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("RadioButtonGroup_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("RadioButtonGroup_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("RadioButtonGroup_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("RadioButtonGroup_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("RadioButtonGroup_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("RadioButtonGroup_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("RadioButtonGroup_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("RadioButtonGroup_rendersChildren_Description"));
            ...
            prop_required.setDisplayName(resources.getString("RadioButtonGroup_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("RadioButtonGroup_required_Description"));
            ...
            prop_submittedValue.setDisplayName(resources.getString("RadioButtonGroup_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("RadioButtonGroup_submittedValue_Description"));
            ...
            prop_validator.setDisplayName(resources.getString("RadioButtonGroup_validator_DisplayName"));
            prop_validator.setShortDescription(resources.getString("RadioButtonGroup_validator_Description"));
            ...
            prop_value.setDisplayName(resources.getString("RadioButtonGroup_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("RadioButtonGroup_value_Description"));
            ...
            prop_valueChangeListener.setDisplayName(resources.getString("RadioButtonGroup_valueChangeListener_DisplayName"));
            prop_valueChangeListener.setShortDescription(resources.getString("RadioButtonGroup_valueChangeListener_Description"));
