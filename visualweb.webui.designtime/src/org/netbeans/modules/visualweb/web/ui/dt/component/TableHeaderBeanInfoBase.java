...
abstract class TableHeaderBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), TableHeaderBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>TableHeaderBeanInfoBase</code>.</p>
     */
    public TableHeaderBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.TableHeader.class;
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/TableHeader_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/TableHeader_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/TableHeader_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/TableHeader_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("TableHeader_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("TableHeader_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"tableHeader");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"tableHeader");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_abbr.setDisplayName(resources.getString("TableHeader_abbr_DisplayName"));
            prop_abbr.setShortDescription(resources.getString("TableHeader_abbr_Description"));
            ...
            prop_align.setDisplayName(resources.getString("TableHeader_align_DisplayName"));
            prop_align.setShortDescription(resources.getString("TableHeader_align_Description"));
            ...
            prop_axis.setDisplayName(resources.getString("TableHeader_axis_DisplayName"));
            prop_axis.setShortDescription(resources.getString("TableHeader_axis_Description"));
            ...
            prop_bgColor.setDisplayName(resources.getString("TableHeader_bgColor_DisplayName"));
            prop_bgColor.setShortDescription(resources.getString("TableHeader_bgColor_Description"));
            ...
            prop_char.setDisplayName(resources.getString("TableHeader_char_DisplayName"));
            prop_char.setShortDescription(resources.getString("TableHeader_char_Description"));
            ...
            prop_charOff.setDisplayName(resources.getString("TableHeader_charOff_DisplayName"));
            prop_charOff.setShortDescription(resources.getString("TableHeader_charOff_Description"));
            ...
            prop_colSpan.setDisplayName(resources.getString("TableHeader_colSpan_DisplayName"));
            prop_colSpan.setShortDescription(resources.getString("TableHeader_colSpan_Description"));
            ...
            prop_extraHtml.setDisplayName(resources.getString("TableHeader_extraHtml_DisplayName"));
            prop_extraHtml.setShortDescription(resources.getString("TableHeader_extraHtml_Description"));
            ...
            PropertyDescriptor prop_groupHeader = new PropertyDescriptor("groupHeader",beanClass,"isGroupHeader","setGroupHeader");
            prop_groupHeader.setDisplayName(resources.getString("TableHeader_groupHeader_DisplayName"));
            prop_groupHeader.setShortDescription(resources.getString("TableHeader_groupHeader_Description"));
            prop_groupHeader.setExpert(false);
            prop_groupHeader.setHidden(false);
            prop_groupHeader.setPreferred(false);
            prop_groupHeader.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.GENERAL);

            PropertyDescriptor prop_headers = new PropertyDescriptor("headers",beanClass,"getHeaders","setHeaders");
            prop_headers.setDisplayName(resources.getString("TableHeader_headers_DisplayName"));
            prop_headers.setShortDescription(resources.getString("TableHeader_headers_Description"));
            ...
            prop_height.setDisplayName(resources.getString("TableHeader_height_DisplayName"));
            prop_height.setShortDescription(resources.getString("TableHeader_height_Description"));
            ...
            prop_noWrap.setDisplayName(resources.getString("TableHeader_noWrap_DisplayName"));
            prop_noWrap.setShortDescription(resources.getString("TableHeader_noWrap_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("TableHeader_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("TableHeader_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("TableHeader_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("TableHeader_onDblClick_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("TableHeader_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("TableHeader_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("TableHeader_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("TableHeader_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("TableHeader_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("TableHeader_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("TableHeader_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("TableHeader_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("TableHeader_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("TableHeader_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("TableHeader_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("TableHeader_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("TableHeader_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("TableHeader_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("TableHeader_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("TableHeader_onMouseUp_Description"));
            ...
            prop_rowSpan.setDisplayName(resources.getString("TableHeader_rowSpan_DisplayName"));
            prop_rowSpan.setShortDescription(resources.getString("TableHeader_rowSpan_Description"));
            ...
            prop_scope.setDisplayName(resources.getString("TableHeader_scope_DisplayName"));
            prop_scope.setShortDescription(resources.getString("TableHeader_scope_Description"));
            ...
            PropertyDescriptor prop_selectHeader = new PropertyDescriptor("selectHeader",beanClass,"isSelectHeader","setSelectHeader");
            prop_selectHeader.setDisplayName(resources.getString("TableHeader_selectHeader_DisplayName"));
            prop_selectHeader.setShortDescription(resources.getString("TableHeader_selectHeader_Description"));
            prop_selectHeader.setExpert(false);
            prop_selectHeader.setHidden(false);
            prop_selectHeader.setPreferred(false);
            prop_selectHeader.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.GENERAL);

            PropertyDescriptor prop_sortHeader = new PropertyDescriptor("sortHeader",beanClass,"isSortHeader","setSortHeader");
            prop_sortHeader.setDisplayName(resources.getString("TableHeader_sortHeader_DisplayName"));
            prop_sortHeader.setShortDescription(resources.getString("TableHeader_sortHeader_Description"));
            prop_sortHeader.setExpert(false);
            prop_sortHeader.setHidden(false);
            prop_sortHeader.setPreferred(false);
            prop_sortHeader.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.GENERAL);

            PropertyDescriptor prop_style = new PropertyDescriptor("style",beanClass,"getStyle","setStyle");
            prop_style.setDisplayName(resources.getString("TableHeader_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("TableHeader_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("TableHeader_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("TableHeader_styleClass_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("TableHeader_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("TableHeader_toolTip_Description"));
            ...
            prop_valign.setDisplayName(resources.getString("TableHeader_valign_DisplayName"));
            prop_valign.setShortDescription(resources.getString("TableHeader_valign_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("TableHeader_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("TableHeader_visible_Description"));
            ...
            prop_width.setDisplayName(resources.getString("TableHeader_width_DisplayName"));
            prop_width.setShortDescription(resources.getString("TableHeader_width_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("TableHeader_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("TableHeader_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("TableHeader_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("TableHeader_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("TableHeader_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("TableHeader_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("TableHeader_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("TableHeader_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("TableHeader_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("TableHeader_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("TableHeader_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("TableHeader_id_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("TableHeader_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("TableHeader_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("TableHeader_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("TableHeader_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("TableHeader_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("TableHeader_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("TableHeader_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("TableHeader_rendersChildren_Description"));
