...
abstract class SelectorBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), SelectorBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>SelectorBeanInfoBase</code>.</p>
     */
    public SelectorBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.Selector.class;
        defaultPropertyName = "";
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Selector_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Selector_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Selector_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/Selector_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("Selector_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("Selector_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(true);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"selector");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.FALSE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"selector");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_disabled.setDisplayName(resources.getString("Selector_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("Selector_disabled_Description"));
            ...
            prop_items.setDisplayName(resources.getString("Selector_items_DisplayName"));
            prop_items.setShortDescription(resources.getString("Selector_items_Description"));
            ...
            prop_label.setDisplayName(resources.getString("Selector_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("Selector_label_Description"));
            ...
            prop_labelLevel.setDisplayName(resources.getString("Selector_labelLevel_DisplayName"));
            prop_labelLevel.setShortDescription(resources.getString("Selector_labelLevel_Description"));
            ...
            prop_onBlur.setDisplayName(resources.getString("Selector_onBlur_DisplayName"));
            prop_onBlur.setShortDescription(resources.getString("Selector_onBlur_Description"));
            ...
            prop_onChange.setDisplayName(resources.getString("Selector_onChange_DisplayName"));
            prop_onChange.setShortDescription(resources.getString("Selector_onChange_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("Selector_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("Selector_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("Selector_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("Selector_onDblClick_Description"));
            ...
            prop_onFocus.setDisplayName(resources.getString("Selector_onFocus_DisplayName"));
            prop_onFocus.setShortDescription(resources.getString("Selector_onFocus_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("Selector_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("Selector_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("Selector_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("Selector_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("Selector_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("Selector_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("Selector_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("Selector_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("Selector_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("Selector_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("Selector_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("Selector_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("Selector_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("Selector_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("Selector_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("Selector_onMouseUp_Description"));
            ...
            prop_onSelect.setDisplayName(resources.getString("Selector_onSelect_DisplayName"));
            prop_onSelect.setShortDescription(resources.getString("Selector_onSelect_Description"));
            ...
            prop_readOnly.setDisplayName(resources.getString("Selector_readOnly_DisplayName"));
            prop_readOnly.setShortDescription(resources.getString("Selector_readOnly_Description"));
            ...
            prop_selected.setDisplayName(resources.getString("Selector_selected_DisplayName"));
            prop_selected.setShortDescription(resources.getString("Selector_selected_Description"));
            ...
            prop_style.setDisplayName(resources.getString("Selector_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("Selector_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("Selector_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("Selector_styleClass_Description"));
            ...
            prop_tabIndex.setDisplayName(resources.getString("Selector_tabIndex_DisplayName"));
            prop_tabIndex.setShortDescription(resources.getString("Selector_tabIndex_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("Selector_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("Selector_toolTip_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("Selector_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("Selector_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("Selector_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("Selector_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("Selector_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("Selector_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("Selector_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("Selector_children_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("Selector_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("Selector_converter_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("Selector_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("Selector_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("Selector_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("Selector_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("Selector_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("Selector_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("Selector_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("Selector_immediate_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("Selector_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("Selector_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("Selector_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("Selector_localValueSet_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("Selector_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("Selector_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("Selector_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("Selector_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("Selector_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("Selector_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("Selector_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("Selector_rendersChildren_Description"));
            ...
            prop_required.setDisplayName(resources.getString("Selector_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("Selector_required_Description"));
            ...
            prop_submittedValue.setDisplayName(resources.getString("Selector_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("Selector_submittedValue_Description"));
            ...
            prop_validator.setDisplayName(resources.getString("Selector_validator_DisplayName"));
            prop_validator.setShortDescription(resources.getString("Selector_validator_Description"));
            ...
            prop_value.setDisplayName(resources.getString("Selector_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("Selector_value_Description"));
            ...
            prop_valueChangeListener.setDisplayName(resources.getString("Selector_valueChangeListener_DisplayName"));
            prop_valueChangeListener.setShortDescription(resources.getString("Selector_valueChangeListener_Description"));
