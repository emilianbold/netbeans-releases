...
abstract class RbCbSelectorBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("org.netbeans.modules.visualweb.web.ui.dt.component.Bundle-JSF", Locale.getDefault(), RbCbSelectorBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>RbCbSelectorBeanInfoBase</code>.</p>
     */
    public RbCbSelectorBeanInfoBase() {

        beanClass = com.sun.rave.web.ui.component.RbCbSelector.class;
        defaultPropertyName = "";
        iconFileName_C16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/RbCbSelector_C16";
        iconFileName_C32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/RbCbSelector_C32";
        iconFileName_M16 = "/org/netbeans/modules/visualweb/web/ui/dt/component/RbCbSelector_M16";
        iconFileName_M32 = "/org/netbeans/modules/visualweb/web/ui/dt/component/RbCbSelector_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("RbCbSelector_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("RbCbSelector_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(true);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"rbCbSelectorRbCbSelectorRenderer");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.FALSE);
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"rbCbSelectorRbCbSelectorRenderer");
    ...
    public FacetDescriptor[] getFacetDescriptors() {
        ...
        try {
            ...
            facet_image.setDisplayName(resources.getString("RbCbSelector_image_DisplayName"));
            facet_image.setShortDescription(resources.getString("RbCbSelector_image_Description"));

            FacetDescriptor facet_label = new FacetDescriptor("label");
            facet_label.setDisplayName(resources.getString("RbCbSelector_label_DisplayName"));
            facet_label.setShortDescription(resources.getString("RbCbSelector_label_Description"));
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_imageURL.setDisplayName(resources.getString("RbCbSelector_imageURL_DisplayName"));
            prop_imageURL.setShortDescription(resources.getString("RbCbSelector_imageURL_Description"));
            ...
            prop_items.setDisplayName(resources.getString("RbCbSelector_items_DisplayName"));
            prop_items.setShortDescription(resources.getString("RbCbSelector_items_Description"));
            ...
            prop_items.setValue("bindingPanelClassNames", new Class[] {org.netbeans.modules.visualweb.propertyeditors.binding.data.BindValueToDataProviderPanel.class, org.netbeans.modules.visualweb.propertyeditors.binding.data.BindValueToObjectPanel.class});

            PropertyDescriptor prop_name = new PropertyDescriptor("name",beanClass,"getName","setName");
            prop_name.setDisplayName(resources.getString("RbCbSelector_name_DisplayName"));
            prop_name.setShortDescription(resources.getString("RbCbSelector_name_Description"));
            ...
            prop_name.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.ADVANCED);

            PropertyDescriptor prop_selected = new PropertyDescriptor("selected",beanClass,"getSelected","setSelected");
            prop_selected.setDisplayName(resources.getString("RbCbSelector_selected_DisplayName"));
            prop_selected.setShortDescription(resources.getString("RbCbSelector_selected_Description"));
            prop_selected.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.web.ui.dt.component.propertyeditors.RbCbSelectedPropertyEditor"));
            ...
            PropertyDescriptor prop_selectedValue = new PropertyDescriptor("selectedValue",beanClass,"getSelectedValue","setSelectedValue");
            prop_selectedValue.setDisplayName(resources.getString("RbCbSelector_selectedValue_DisplayName"));
            prop_selectedValue.setShortDescription(resources.getString("RbCbSelector_selectedValue_Description"));
            prop_selectedValue.setPropertyEditorClass(loadClass("com.sun.rave.propertyeditors.StringPropertyEditor"));
            prop_selectedValue.setExpert(false);
            prop_selectedValue.setHidden(false);
            prop_selectedValue.setPreferred(false);
            attrib = new AttributeDescriptor("selectedValue",false,null,true);
            prop_selectedValue.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_selectedValue.setValue(Constants.PropertyDescriptor.CATEGORY,com.sun.rave.designtime.base.CategoryDescriptors.ADVANCED);

            PropertyDescriptor prop_disabled = new PropertyDescriptor("disabled",beanClass,"isDisabled","setDisabled");
            prop_disabled.setDisplayName(resources.getString("RbCbSelector_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("RbCbSelector_disabled_Description"));
            ...
            prop_label.setDisplayName(resources.getString("RbCbSelector_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("RbCbSelector_label_Description"));
            ...
            prop_labelLevel.setDisplayName(resources.getString("RbCbSelector_labelLevel_DisplayName"));
            prop_labelLevel.setShortDescription(resources.getString("RbCbSelector_labelLevel_Description"));
            ...
            prop_onBlur.setDisplayName(resources.getString("RbCbSelector_onBlur_DisplayName"));
            prop_onBlur.setShortDescription(resources.getString("RbCbSelector_onBlur_Description"));
            ...
            prop_onChange.setDisplayName(resources.getString("RbCbSelector_onChange_DisplayName"));
            prop_onChange.setShortDescription(resources.getString("RbCbSelector_onChange_Description"));
            ...
            prop_onClick.setDisplayName(resources.getString("RbCbSelector_onClick_DisplayName"));
            prop_onClick.setShortDescription(resources.getString("RbCbSelector_onClick_Description"));
            ...
            prop_onDblClick.setDisplayName(resources.getString("RbCbSelector_onDblClick_DisplayName"));
            prop_onDblClick.setShortDescription(resources.getString("RbCbSelector_onDblClick_Description"));
            ...
            prop_onFocus.setDisplayName(resources.getString("RbCbSelector_onFocus_DisplayName"));
            prop_onFocus.setShortDescription(resources.getString("RbCbSelector_onFocus_Description"));
            ...
            prop_onKeyDown.setDisplayName(resources.getString("RbCbSelector_onKeyDown_DisplayName"));
            prop_onKeyDown.setShortDescription(resources.getString("RbCbSelector_onKeyDown_Description"));
            ...
            prop_onKeyPress.setDisplayName(resources.getString("RbCbSelector_onKeyPress_DisplayName"));
            prop_onKeyPress.setShortDescription(resources.getString("RbCbSelector_onKeyPress_Description"));
            ...
            prop_onKeyUp.setDisplayName(resources.getString("RbCbSelector_onKeyUp_DisplayName"));
            prop_onKeyUp.setShortDescription(resources.getString("RbCbSelector_onKeyUp_Description"));
            ...
            prop_onMouseDown.setDisplayName(resources.getString("RbCbSelector_onMouseDown_DisplayName"));
            prop_onMouseDown.setShortDescription(resources.getString("RbCbSelector_onMouseDown_Description"));
            ...
            prop_onMouseMove.setDisplayName(resources.getString("RbCbSelector_onMouseMove_DisplayName"));
            prop_onMouseMove.setShortDescription(resources.getString("RbCbSelector_onMouseMove_Description"));
            ...
            prop_onMouseOut.setDisplayName(resources.getString("RbCbSelector_onMouseOut_DisplayName"));
            prop_onMouseOut.setShortDescription(resources.getString("RbCbSelector_onMouseOut_Description"));
            ...
            prop_onMouseOver.setDisplayName(resources.getString("RbCbSelector_onMouseOver_DisplayName"));
            prop_onMouseOver.setShortDescription(resources.getString("RbCbSelector_onMouseOver_Description"));
            ...
            prop_onMouseUp.setDisplayName(resources.getString("RbCbSelector_onMouseUp_DisplayName"));
            prop_onMouseUp.setShortDescription(resources.getString("RbCbSelector_onMouseUp_Description"));
            ...
            prop_onSelect.setDisplayName(resources.getString("RbCbSelector_onSelect_DisplayName"));
            prop_onSelect.setShortDescription(resources.getString("RbCbSelector_onSelect_Description"));
            ...
            prop_readOnly.setDisplayName(resources.getString("RbCbSelector_readOnly_DisplayName"));
            prop_readOnly.setShortDescription(resources.getString("RbCbSelector_readOnly_Description"));
            ...
            prop_style.setDisplayName(resources.getString("RbCbSelector_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("RbCbSelector_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("RbCbSelector_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("RbCbSelector_styleClass_Description"));
            ...
            prop_tabIndex.setDisplayName(resources.getString("RbCbSelector_tabIndex_DisplayName"));
            prop_tabIndex.setShortDescription(resources.getString("RbCbSelector_tabIndex_Description"));
            ...
            prop_toolTip.setDisplayName(resources.getString("RbCbSelector_toolTip_DisplayName"));
            prop_toolTip.setShortDescription(resources.getString("RbCbSelector_toolTip_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("RbCbSelector_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("RbCbSelector_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("RbCbSelector_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("RbCbSelector_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("RbCbSelector_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("RbCbSelector_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("RbCbSelector_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("RbCbSelector_children_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("RbCbSelector_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("RbCbSelector_converter_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("RbCbSelector_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("RbCbSelector_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("RbCbSelector_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("RbCbSelector_family_Description"));
            ...
            prop_id.setDisplayName(resources.getString("RbCbSelector_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("RbCbSelector_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("RbCbSelector_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("RbCbSelector_immediate_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("RbCbSelector_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("RbCbSelector_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("RbCbSelector_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("RbCbSelector_localValueSet_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("RbCbSelector_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("RbCbSelector_parent_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("RbCbSelector_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("RbCbSelector_rendered_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("RbCbSelector_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("RbCbSelector_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("RbCbSelector_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("RbCbSelector_rendersChildren_Description"));
            ...
            prop_required.setDisplayName(resources.getString("RbCbSelector_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("RbCbSelector_required_Description"));
            ...
            prop_submittedValue.setDisplayName(resources.getString("RbCbSelector_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("RbCbSelector_submittedValue_Description"));
            ...
            prop_validator.setDisplayName(resources.getString("RbCbSelector_validator_DisplayName"));
            prop_validator.setShortDescription(resources.getString("RbCbSelector_validator_Description"));
            ...
            prop_value.setDisplayName(resources.getString("RbCbSelector_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("RbCbSelector_value_Description"));
            ...
            prop_valueChangeListener.setDisplayName(resources.getString("RbCbSelector_valueChangeListener_DisplayName"));
            prop_valueChangeListener.setShortDescription(resources.getString("RbCbSelector_valueChangeListener_Description"));
