...
/**
 * Concrete bean wrapper implementation for delimited instances of VirtualDBTable,
 * exposing read-only properties for display in a Virtual DB property sheet. 
 * 
 * @author Ahimanikya Satapathy
 */
public class DelimitedFlatfile extends VirtualTable {
    
    
    public DelimitedFlatfile(VirtualDBTable dbTable) {
        super(dbTable);
    }
    ...
    public String getFieldDelimiter() {
        ...
        if (delimiter == null || delimiter.length() == 0) {
            delimiter = NbBundle.getMessage(DelimitedFlatfile.class, "LBL_none_placeholder");
        } else {
    ...
    public String getTextQualifier() {
        ...
        if (qualifier == null || qualifier.length() == 0) {
            qualifier = NbBundle.getMessage(DelimitedFlatfile.class, "LBL_none_placeholder");
        } else {
            if("''".equals(qualifier)) {
                qualifier = "'"; 
            }
