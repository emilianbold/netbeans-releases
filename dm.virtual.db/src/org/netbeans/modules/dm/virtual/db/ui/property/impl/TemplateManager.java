...
public class TemplateManager {
    ...
    private static final Logger mLogger = Logger.getLogger(TemplateManager.class.getName());
    private VirtualDBResource rManager;
    private TemplateGroup tg;

    public TemplateManager(InputStream in, VirtualDBResource resource) {
        rManager = resource;
    ...
    public PropertyNode getNodeForTemplateName(String templateName) {
        ...
        while (it.hasNext()) {
            ...
            if (name.equals(templateName)) {
                Template template = (Template) map.get(name);
    ...
    private void init(TemplateParser parser, TemplateFactory fac) {
        if (parser == null) {
            mLogger.log(Level.INFO, NbBundle.getMessage(TemplateManager.class, "LOG_TemplateParser",LOG_CATEGORY));
        }
