...
/**
 * Concrete bean wrapper for instances of VirtualDatabaseModel, exposing read-only
...
public class VirtualDatabase {
    ...
    private VirtualDatabaseModel mDelegate;

    public VirtualDatabase(VirtualDatabaseModel dbModel) {
        mDelegate = dbModel;
    }
    ...
    public VirtualDatabaseModel getDeligate() {
        return mDelegate;
    }
}
