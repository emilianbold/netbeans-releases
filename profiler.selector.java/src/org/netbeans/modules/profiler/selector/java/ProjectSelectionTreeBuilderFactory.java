...
public class ProjectSelectionTreeBuilderFactory implements SelectionTreeBuilderFactory {
    public Collection<SelectionTreeBuilder> createBuildersFor(Lookup context) {
        Collection<SelectionTreeBuilder> builders = new ArrayList<SelectionTreeBuilder>();
        for(Project project : context.lookupAll(Project.class)) {
            builders.addAll(project.getLookup().lookupAll(SelectionTreeBuilder.class));
        }
        return builders;
    }
}
