...
public class PhpFrameworkRegistrationProcessor extends LayerGeneratingProcessor {
    ...
    public Set<String> getSupportedAnnotationTypes() {
        return Collections.singleton(PhpFrameworkProvider.Registration.class.getCanonicalName());
    }
    ...
    protected boolean handleProcess(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) throws LayerGenerationException {
        ...
        final TypeMirror phpFrameworkProvider = processingEnv.getElementUtils().getTypeElement(PhpFrameworkProvider.class.getName()).asType();
        for (Element element : roundEnv.getElementsAnnotatedWith(PhpFrameworkProvider.Registration.class)) {
            final PhpFrameworkProvider.Registration registration = element.getAnnotation(PhpFrameworkProvider.Registration.class);
            ...
            switch (element.getKind()) {
                case CLASS:
                    ...
                    if (!processingEnv.getTypeUtils().isAssignable(element.asType(), phpFrameworkProvider)) {
                        throw new LayerGenerationException("Class needs to extend PhpFrameworkProvider");
                    }
                    boolean found = false;
                ...
                case METHOD:
                    ...
                    if (!processingEnv.getTypeUtils().isAssignable(exec.getReturnType(), phpFrameworkProvider)) {
                        throw new LayerGenerationException("Method needs to return PhpFrameworkProvider");
                    }
