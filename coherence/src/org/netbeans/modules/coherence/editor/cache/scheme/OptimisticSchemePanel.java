 ...
 */
public class OptimisticSchemePanel extends JPanel implements SchemePanelInterface, BindingListener {

    /** Creates new form DistributedSchemePanel */
    public OptimisticSchemePanel() {
        initComponents();
        initialise();
    }
    /*
     ...
     * =========================================================================
     */
    public OptimisticSchemePanel(OptimisticScheme scheme, List<Scheme> schemeNameList) {
        this();
        this.scheme = scheme;
     ...
     * Properties
     */
    private static final String BUTTON_TEXT_PREFIX = "Optimistic Scheme";
    private OptimisticScheme scheme = new OptimisticScheme();
    ...
    private void setPanelData(OptimisticScheme scheme) {
    ...
    public void setScheme(Object o) {
        this.scheme = (OptimisticScheme)o;
    ...
    private void initComponents() {
        ...
        jToggleButton1.setText(org.openide.util.NbBundle.getMessage(OptimisticSchemePanel.class, "OptimisticSchemePanel.jToggleButton1.text")); // NOI18N
        jToggleButton1.setActionCommand(org.openide.util.NbBundle.getMessage(OptimisticSchemePanel.class, "OptimisticSchemePanel.jToggleButton1.actionCommand")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(OptimisticSchemePanel.class, "OptimisticSchemePanel.jLabel1.text")); // NOI18N

        jLabel2.setText(org.openide.util.NbBundle.getMessage(OptimisticSchemePanel.class, "OptimisticSchemePanel.jLabel2.text")); // NOI18N

        tfSchemeName.setText(org.openide.util.NbBundle.getMessage(OptimisticSchemePanel.class, "OptimisticSchemePanel.tfSchemeName.text")); // NOI18N

        tfServiceName.setText(org.openide.util.NbBundle.getMessage(OptimisticSchemePanel.class, "OptimisticSchemePanel.tfServiceName.text")); // NOI18N

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(OptimisticSchemePanel.class, "OptimisticSchemePanel.jPanel2.border.title"))); // NOI18N

        cbSchemeRef.setModel(getSchemaRefModel());

        jLabel3.setText(org.openide.util.NbBundle.getMessage(OptimisticSchemePanel.class, "OptimisticSchemePanel.jLabel3.text")); // NOI18N
        ...
        cbAutostart.setText(org.openide.util.NbBundle.getMessage(OptimisticSchemePanel.class, "OptimisticSchemePanel.cbAutostart.text")); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addComponent(tfSchemeName, javax.swing.GroupLayout.DEFAULT_SIZE, 164, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        btnRemove.setText(org.openide.util.NbBundle.getMessage(OptimisticSchemePanel.class, "OptimisticSchemePanel.btnRemove.text")); // NOI18N
