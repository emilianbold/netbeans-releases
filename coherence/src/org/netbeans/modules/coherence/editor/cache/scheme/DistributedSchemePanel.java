 ...
 */
public class DistributedSchemePanel extends JPanel implements SchemePanelInterface, ActionListener, BindingListener {

    /** Creates new form DistributedSchemePanel */
    public DistributedSchemePanel() {
        initComponents();
        initialise();
    }
    /*
    ...
    public DistributedSchemePanel(DistributedScheme scheme, List<Scheme> schemeNameList) {
        this();
        this.scheme = scheme;
     ...
     * Properties
     */
    private static final Logger logger = Logger.getLogger(DistributedSchemePanel.class.getCanonicalName());
    private static final String BUTTON_TEXT_PREFIX = "Distributed Scheme";
    private DistributedScheme scheme = new DistributedScheme();
...
//        setupBindings();
    ...
    private void setPanelData(DistributedScheme scheme) {
    ...
    public void setScheme(Object o) {
        this.scheme = (DistributedScheme) o;
        setPanelData(scheme);
    }
    ...
    private void initComponents() {
        ...
        jToggleButton1.setText(org.openide.util.NbBundle.getMessage(DistributedSchemePanel.class, "DistributedSchemePanel.jToggleButton1.text")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(DistributedSchemePanel.class, "DistributedSchemePanel.jLabel1.text")); // NOI18N

        jLabel2.setText(org.openide.util.NbBundle.getMessage(DistributedSchemePanel.class, "DistributedSchemePanel.jLabel2.text")); // NOI18N

        tfSchemeName.setText(org.openide.util.NbBundle.getMessage(DistributedSchemePanel.class, "DistributedSchemePanel.tfSchemeName.text")); // NOI18N

        tfServiceName.setText(org.openide.util.NbBundle.getMessage(DistributedSchemePanel.class, "DistributedSchemePanel.tfServiceName.text")); // NOI18N

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(DistributedSchemePanel.class, "DistributedSchemePanel.jPanel2.border.title"))); // NOI18N

        cbSchemeRef.setModel(getSchemaRefModel());

        jLabel3.setText(org.openide.util.NbBundle.getMessage(DistributedSchemePanel.class, "DistributedSchemePanel.jLabel3.text")); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(cbSchemeRef, 0, 183, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        cbAutostart.setText(org.openide.util.NbBundle.getMessage(DistributedSchemePanel.class, "DistributedSchemePanel.cbAutostart.text")); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addComponent(tfSchemeName, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cbAutostart))
                            .addComponent(tfServiceName, javax.swing.GroupLayout.DEFAULT_SIZE, 230, Short.MAX_VALUE))))
                .addContainerGap())
        );
        ...
        btnRemove.setText(org.openide.util.NbBundle.getMessage(DistributedSchemePanel.class, "DistributedSchemePanel.btnRemove.text")); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jToggleButton1, javax.swing.GroupLayout.DEFAULT_SIZE, 306, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
