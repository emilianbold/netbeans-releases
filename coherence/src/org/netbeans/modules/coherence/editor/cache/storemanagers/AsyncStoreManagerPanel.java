...
public class AsyncStoreManagerPanel extends javax.swing.JPanel {
    ...
    /** Creates new form AsyncStoreManagerPanel */
    public AsyncStoreManagerPanel() {
        initComponents();
    }
     ...
     * =========================================================================
     */
    public AsyncStoreManagerPanel(AsyncStoreManager manager) {
        this();
     ...
     * Properties
     */
    private AsyncStoreManager manager = null;
    private BindingGroup bindingGroup = new BindingGroup();
    /*
     * Methods
     */

    public AsyncStoreManager getManager() {
        return manager;
    }

    public void setManager(AsyncStoreManager manager) {
        this.manager = manager;
        refreshBindings();
    }
...
//        bindingGroup.addBindingListener(this);
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(AsyncStoreManagerPanel.class, "AsyncStoreManagerPanel.border.title"))); // NOI18N
