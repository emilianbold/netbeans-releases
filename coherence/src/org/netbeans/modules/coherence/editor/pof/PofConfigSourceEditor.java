 ...
 */
public class PofConfigSourceEditor extends CloneableEditor implements MultiViewElement, Runnable {

    private JComponent toolbar;
    private MultiViewElementCallback callback;

    public PofConfigSourceEditor(PofConfigEditorSupport support) {
        super(support);
    }

    public PofConfigSourceEditor() {
    }
    ...
    public Lookup getLookup() {
        return ((PofConfigDataObject) ((PofConfigEditorSupport) cloneableEditorSupport()).getDataObject()).getNodeDelegate().getLookup();
    }
