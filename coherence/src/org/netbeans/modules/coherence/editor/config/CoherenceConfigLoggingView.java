 ...
 */
public class CoherenceConfigLoggingView extends JPanel implements MultiViewDescription, MultiViewElement,
        ExplorerManager.Provider, DocumentListener, PropertyChangeListener, TableModelListener, ListSelectionListener {

    /** Creates new form CoherenceConfigLoggingView */
    public CoherenceConfigLoggingView() {
        initComponents();
    }
     ...
     * =========================================================================
     */
    public CoherenceConfigLoggingView(CoherenceConfigEditorSupport support) {
        this();
