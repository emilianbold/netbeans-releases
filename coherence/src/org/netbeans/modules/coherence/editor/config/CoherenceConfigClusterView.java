 ...
 */
public class CoherenceConfigClusterView extends JPanel implements MultiViewDescription, MultiViewElement,
        ExplorerManager.Provider, DocumentListener, PropertyChangeListener, TableModelListener, ListSelectionListener {

    /** Creates new form CoherenceConfigClusterView */
    public CoherenceConfigClusterView() {
        initComponents();
    }
     ...
     * =========================================================================
     */
    public CoherenceConfigClusterView(CoherenceConfigEditorSupport support) {
        this();
