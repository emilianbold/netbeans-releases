 ...
 */
public class AllowSubclassesImpl extends PofConfigBooleanComponentImpl implements AllowSubclasses {

    public AllowSubclassesImpl(PofConfigModelImpl model, Element e) {
        super(model, e);
    }
    
    public AllowSubclassesImpl(PofConfigModelImpl model) {
        super(model, createNewElement(AllowSubclasses.XML_TAG_NAME, model));
    }
    
    @Override
    public String getTagName() {
        return AllowSubclasses.XML_TAG_NAME;
    }
