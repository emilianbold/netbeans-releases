 ...
 */
public class DefaultSerializerImpl extends SerializerTypeImpl implements DefaultSerializer {

    public DefaultSerializerImpl(PofConfigModelImpl model, Element e) {
        super(model, e);
    }

    public DefaultSerializerImpl(PofConfigModelImpl model) {
        super(model, createNewElement(DefaultSerializer.XML_TAG_NAME, model));
    }

    @Override
    public String getTagName() {
        return DefaultSerializer.XML_TAG_NAME;
    }
