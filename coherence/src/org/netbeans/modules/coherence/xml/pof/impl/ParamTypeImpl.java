...
public class ParamTypeImpl extends PofConfigComponentImpl implements ParamType {
    ...
    public ParamTypeImpl(PofConfigModelImpl model, Element e) {
        super(model, e);
    }
    
    public ParamTypeImpl(PofConfigModelImpl model) {
        super(model, createNewElement(XML_TAG_NAME, model));
    }
    
    @Override
    public String getTagName() {
        return ParamType.XML_TAG_NAME;
    }
    ...
    public void setParamType(Type type) {
        setText(XML_TAG_NAME, type.type());
    }
