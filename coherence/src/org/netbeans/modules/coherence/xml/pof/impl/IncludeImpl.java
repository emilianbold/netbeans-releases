 ...
 */
public class IncludeImpl extends PofConfigTextComponentImpl implements Include {

    public IncludeImpl(PofConfigModelImpl model, Element e) {
        super(model, e);
    }
    
    public IncludeImpl(PofConfigModelImpl model) {
        super(model, createNewElement(XML_TAG_NAME, model));
    }
    
    @Override
    public String getTagName() {
        return Include.XML_TAG_NAME;
    }
