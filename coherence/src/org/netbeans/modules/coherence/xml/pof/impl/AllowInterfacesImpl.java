 ...
 */
public class AllowInterfacesImpl extends PofConfigBooleanComponentImpl implements AllowInterfaces {

    public AllowInterfacesImpl(PofConfigModelImpl model, Element e) {
        super(model, e);
    }

    public AllowInterfacesImpl(PofConfigModelImpl model) {
        super(model, createNewElement(AllowInterfaces.XML_TAG_NAME, model));
    }
    
    @Override
    public String getTagName() {
        return AllowInterfaces.XML_TAG_NAME;
    }
