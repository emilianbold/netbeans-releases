 ...
 */
public class ClassNameImpl extends PofConfigTextComponentImpl implements ClassName {

    public ClassNameImpl(PofConfigModelImpl model, Element e) {
        super(model, e);
    }
    
    public ClassNameImpl(PofConfigModelImpl model) {
        super(model, createNewElement(XML_TAG_NAME, model));
    }
    
    @Override
    public String getTagName() {
        return ClassName.XML_TAG_NAME;
    }
