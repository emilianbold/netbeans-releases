 ...
 * generated in the org.netbeans.modules.coherence.xml.cache package. 
...
public class ObjectFactory {
     ...
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.netbeans.modules.coherence.xml.cache
     ...
     * Create an instance of {@link MemberListener }

     * 

     */

    public MemberListener createMemberListener() {
     ...
     * Create an instance of {@link ProxyQuorumPolicyScheme }

     * 

     */

    public ProxyQuorumPolicyScheme createProxyQuorumPolicyScheme() {

        return new ProxyQuorumPolicyScheme();
     ...
     * Create an instance of {@link TransactionalScheme }

     * 

     */

    public TransactionalScheme createTransactionalScheme() {

        return new TransactionalScheme();
     ...
     * Create an instance of {@link PartitionedQuorumPolicyScheme }

     * 

     */

    public PartitionedQuorumPolicyScheme createPartitionedQuorumPolicyScheme() {

        return new PartitionedQuorumPolicyScheme();
     ...
     * Create an instance of {@link DistributionQuorum }

     * 

     */

    public DistributionQuorum createDistributionQuorum() {

        return new DistributionQuorum();
     ...
     * Create an instance of {@link RestoreQuorum }

     * 

     */

    public RestoreQuorum createRestoreQuorum() {

        return new RestoreQuorum();
     ...
     * Create an instance of {@link ReadQuorum }

     * 

     */

    public ReadQuorum createReadQuorum() {

        return new ReadQuorum();
     ...
     * Create an instance of {@link WriteQuorum }
     ...
     * Create an instance of {@link ConnectQuorum }

     * 

     */

    public ConnectQuorum createConnectQuorum() {

        return new ConnectQuorum();
