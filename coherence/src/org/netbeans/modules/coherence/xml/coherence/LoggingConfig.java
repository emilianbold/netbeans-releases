...
@XmlRootElement(name = "logging-config")
public class LoggingConfig {
    ...
    @XmlElement(name = "logger-name")
    protected LoggerName loggerName;
    @XmlElement(name = "severity-level", required = true)
    protected SeverityLevel severityLevel;
    @XmlElement(name = "message-format", required = true)
    protected MessageFormat messageFormat;
    @XmlElement(name = "character-limit", required = true)
    protected CharacterLimit characterLimit;
     ...
     *     
     */
    public void setLoggerName(LoggerName value) {
     ...
     *     
     */
    public void setCharacterLimit(CharacterLimit value) {
