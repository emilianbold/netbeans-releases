...
@XmlRootElement(name = "tcp-ring-listener")
public class TcpRingListener {
    ...
    @XmlElement(name = "ip-timeout")
    protected String ipTimeout;
    ...
    /**
     * Gets the value of the ipTimeout property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the ipTimeout property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setIpTimeout(String value) {
        this.ipTimeout = value;
    }
