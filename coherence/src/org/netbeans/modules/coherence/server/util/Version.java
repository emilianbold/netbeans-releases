...
/**
 * Update copied class from j2eeserver module (to not depend on enterprise cluster).
 *
...
public final class Version {
    ...
    /**
     * Gets version string consisted from three main version labels (major.minor.micro).
     * @return major.minor.micro version number
     */
    public String getReleaseVersion() {
        return majorNumber + "." + minorNumber + "." + microNumber;
    }
