...
public class DeliciousResponseSchemaTest extends SchemaTestBase {
    ...
    protected String[] getSchemas() {
        return new String[] {"org/netbeans/modules/websvc/saas/services/delicious/resources/DeliciousResponse.xsd"}; //NOI18N
    }


    public static TestSuite suite() {
        return createTestSuite(new DeliciousResponseSchemaTest()); //NOI18N
    }
}
