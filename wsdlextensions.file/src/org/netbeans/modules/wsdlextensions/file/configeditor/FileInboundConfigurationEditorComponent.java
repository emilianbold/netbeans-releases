...
public class FileInboundConfigurationEditorComponent
    ...
    public FileInboundConfigurationEditorComponent(QName qName,
        ...
        if (fileEditorPanel == null) {
            fileEditorPanel = new InboundMessagePanel(qName, component);
        } else {
        ...
        if (project != null) {
            fileEditorPanel.setProject(project);
        }

        if (mController == null) {
            mController = new InboundPersistenceController(component, fileEditorPanel);
        }
    ...
    public void setOperation(Operation operation) {
        if ((fileEditorPanel != null) && (operation != null)) {
            fileEditorPanel.setOperationName(operation.getName());
        }
    }
    ...
    public void enablePayloadProcessing(boolean enable) {
        if (fileEditorPanel != null) {
            fileEditorPanel.enablePayloadProcessing(enable);
        }
    }    
}
