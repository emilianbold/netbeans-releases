...
public class OutboundMessageInStepWizardPanel extends WSDLWizardDescriptorPanel {
     ...
     */
    private OutboundMessageInPanel mPanel;
    ...
    public OutboundMessageInStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new OutboundMessageInPanel(mQName, mWSDLComponent);
        }
        mPanel.setProject(mProject);
        if (mController == null) {
            mController = new OutboundInPersistenceController(mWSDLComponent, 
                    mPanel);
        }
    ...
    public void readSettings(Object settings) {       
       ...
       if ((myContext != null) && (myContext.getWSDLModel() != null)) {
           ...
           mWSDLComponent = FileUtilities.getFileAddress(defs);
           mPortType = FileUtilities.getPortType((FileAddress) mWSDLComponent);
       }        
    }
    ...
    public String getName() {
        return NbBundle.getMessage(OutboundMessageInStepWizardPanel.class,
                "OutboundMessageInStepWizardPanel.StepLabel");        
    }
