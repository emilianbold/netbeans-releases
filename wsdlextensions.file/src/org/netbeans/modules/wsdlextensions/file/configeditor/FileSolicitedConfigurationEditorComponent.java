 ...
 * @author jalmero
 */
public class FileSolicitedConfigurationEditorComponent
    ...
    public FileSolicitedConfigurationEditorComponent(QName qName,
            WSDLComponent component) {
        if (editorPanel == null) {
            editorPanel = new SolicitedReadPanel(qName, component);
        } else {
            editorPanel.populateView(qName, component);
        }
        ...
        if (mController == null) {
            mController = new SolicitedReadPersistenceController(component, 
                    editorPanel);
        }        
