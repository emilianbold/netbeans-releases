 ...
 * @author jalmero
 */
public class FileInboundOutboundConfigurationEditorComponent
        implements ExtensibilityElementConfigurationEditorComponent {

    private InboundOutboundMessagePanel editorPanel = null;
    ...
    private OutboundPersistenceController mOutController = null;
    public FileInboundOutboundConfigurationEditorComponent(QName qName,
        ...
        if (mOutController == null) {
            mOutController = new OutboundPersistenceController(component, 
