...
public class OutboundPersistenceController {
    ...
    private void commitMessageType(Binding binding, String opName,
        ...
        if (partName != null) {
            Collection parts = FileUtilities.getOutputParts(binding, opName);
            ...
            Message newMessage = FileUtilities.
                    createMessage(mWSDLComponent.getModel(), "PollOutputMessage");
            if (newMessage != null) {
