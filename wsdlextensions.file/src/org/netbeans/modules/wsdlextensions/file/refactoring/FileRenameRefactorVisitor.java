...
package org.netbeans.modules.wsdlextensions.file.refactoring;
 ...
 * @author skini
 */
public class FileRenameRefactorVisitor extends ChildVisitor implements WSDLVisitor, FileComponent.Visitor {
    private Referenceable referenced;
    private String oldName;
    
    public FileRenameRefactorVisitor(Referenceable referenced, String oldName) {
    ...
    public void visit(ExtensibilityElement ee) {
        if (ee instanceof FileMessage) {
            visit((FileMessage) ee);
        }
        visitComponent(ee);
    }
