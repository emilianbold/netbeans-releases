...
* @author sweng
*/
public abstract class FileComponentImpl extends GenericExtensibilityElement implements FileComponent {
    public FileComponentImpl(WSDLModel model, Element e) {
        super(model, e);
    }
