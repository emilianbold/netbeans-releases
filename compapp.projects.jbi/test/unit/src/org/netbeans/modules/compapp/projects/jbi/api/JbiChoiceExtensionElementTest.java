 ...
 * @author jqian
 */
public class JbiChoiceExtensionElementTest {
    
    private static final String REDELIVERY_EXTENSION = "RedeliveryExtension";
    
    private JbiChoiceExtensionElement redeliveryOnFailureChoiceExtensionElement;

    public JbiChoiceExtensionElementTest() {
    }
    ...
    public void setUp() throws SAXException {
        ...
        redeliveryOnFailureChoiceExtensionElement = (JbiChoiceExtensionElement)
    ...
    /**
     * Test of getChoices method, of class JbiChoiceExtensionElement.
     */
    @Test
    public void getChoices() {
        System.out.println("getChoices");
        List<String> expResult = new ArrayList<String>();
        expResult.add("delete");
        expResult.add("error-endpoint");
        expResult.add("suspend");
        List<String> result = redeliveryOnFailureChoiceExtensionElement.getChoices();
