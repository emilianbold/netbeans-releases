...
public class JbiJarCustomizer extends javax.swing.JPanel {
    ...
    public JbiJarCustomizer(JbiProjectProperties webProperties) {
        ...
        this.getAccessibleContext().setAccessibleDescription(
                NbBundle.getMessage(JbiJarCustomizer.class, "ACS_Customize_A11YDesc")); // NOI18N
    ...
    private class CategoryView extends JPanel implements ExplorerManager.Provider {
        ...
        CategoryView(Node rootNode) {
            ...
            btv.getAccessibleContext().setAccessibleName(
                    NbBundle.getMessage(JbiJarCustomizer.class, "ACS_CustomizeTree_A11YName")); // NOI18N
            btv.getAccessibleContext().setAccessibleDescription(
                    NbBundle.getMessage(JbiJarCustomizer.class, "ACS_CustomizeTree_A11YDesc")); // NOI18N
        }
    ...
    private static class ConfigurationNode extends AbstractNode {
        ...
        public ConfigurationNode(ConfigurationDescription description) {
            super(description.children == null ? 
                Children.LEAF : new ConfigurationChildren(description.children));
            setName(description.name);
            setDisplayName(description.displayName);
            if (description.iconBase != null) {
                setIconBaseWithExtension(description.iconBase + ".gif"); // NOI18N
            }
