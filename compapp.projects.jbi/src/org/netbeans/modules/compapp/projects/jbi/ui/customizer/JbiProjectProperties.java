...
//    public static final String JAVADOC_PREVIEW = "javadoc.preview"; // NOI18N
    ...
    public static final String SKIP_COMPAPP_VALIDATION_WHEN_BUILD = "skip.compapp.validation.when.build"; // NOI18N
...
//        new PropertyDescriptor(JAVADOC_PREVIEW, PROJECT, BOOLEAN_PARSER),
        ...
        new PropertyDescriptor(SKIP_COMPAPP_VALIDATION_WHEN_BUILD, PROJECT, BOOLEAN_PARSER),
...
//        new PropertyDescriptor(JBI_DEPLOYMENT_CONF_FILE, PRIVATE, STRING_PARSER),
    ...
    public void put(String propertyName, Object value) {
        ...
        if (J2EE_SERVER_INSTANCE.equals(propertyName)) {
            try {
                put(J2EE_SERVER_TYPE, Deployment.getDefault().getServerInstance((String) value).getServerID());
...
//                        }
    ...
    private static Element generateServiceUnitElement(JbiProject jbiProject,
        ...
        String suName;
        String suJarName= ""; // NOI18N
        
        if (isEngine) {
            suName = vi.getProjectName(); 

            if (aa == null) { // aa is null if the SU project has been deleted
                return null;
            } else {
    ...
    public void saveAssemblyInfo() {
        ...
        try {
            // #172430 To create a temp file, the prefix has to be at least 3 chars.
            File tmpNewJbiFile = File.createTempFile("compapp" + project.getName(), "asi"); // NOI18N
                ...
                if (file.startsWith(LIBRARY_PREFIX)) {
                    ...
                    if ((os != null) && (os.length > 0) ) {
                        ...
                        if (os[0] == null){
                            ...
                            while (pObj == null && eval.contains("/")) { // NOI18N
                                eval = eval.substring(0, eval.lastIndexOf("/"));  // NOI18N
                                pObj = fo.getFileObject(eval);
                            }
