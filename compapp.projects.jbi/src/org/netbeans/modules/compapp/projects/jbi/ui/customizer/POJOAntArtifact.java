...
public class POJOAntArtifact extends AntArtifact {

    private final Project project;
    private final String type;
    //private final String locationProperty;
    private URI[] locationURIs= null;
    private final String targetName;
    private final String cleanTargetName;
    private static final String JBI_LOC_PROPERTY="jbi.su.jar.loc";// NOI18N
    /**
     * @see AntProjectHelper#createSimpleAntArtifact
     */
    public POJOAntArtifact(Project project, AntArtifact actual) {
        this.project = project;
        this.type = JbiProjectConstants.POJO_SE_PROJECT_ANT_ARTIFACT_TYPE;
        if ( actual != null) {
            locationURIs = actual.getArtifactLocations();
        } else {
            locationURIs = new URI[] {getArtifactLocation0()};
        }
        this.targetName = "dist_se";// NOI18N
        this.cleanTargetName = "clean";// NOI18N
    }
    ...
    public File getScriptLocation() {
        return getAntProjectHelper(project).resolveFile("build.xml");
    }
    ...
    public String toString() {
        return "Comp App:Java SE: AntArtifact"; // NOI18N
    }
    ...
    private URI getArtifactLocation0() {
        ...
        String locationResolved = projectProperties.getProperty(JBI_LOC_PROPERTY);
