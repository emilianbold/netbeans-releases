...
public abstract class Archive {
    ...
    public String distJarPropName;
    
    public abstract String getName();
    public abstract void open() throws Exception;
    public abstract void close() throws Exception;
    
    public abstract CMap getCMap();
    public abstract ResourceAggregator getResourceAggregator();
    public abstract FileObject getResourceDir();
    public abstract JAXBHandler getJAXBHandler();
