 ...
 * @author echou
 */
public class StatelessAnnoWrapper extends AnnotationWrapperBase {
    
    private String description;
    private String mappedName;
    private String name;
    
    /** Creates a new instance of StatelessAnnoWrapper */
    public StatelessAnnoWrapper(Annotation anno) {
