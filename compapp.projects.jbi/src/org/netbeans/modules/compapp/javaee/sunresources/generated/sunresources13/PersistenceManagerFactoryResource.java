...
@XmlRootElement(name = "persistence-manager-factory-resource")
public class PersistenceManagerFactoryResource {
    ...
    @XmlAttribute(name = "jdbc-resource-jndi-name")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String jdbcResourceJndiName;
    ...
    public String getFactoryClass() {
        if (factoryClass == null) {
            return "com.sun.jdo.spi.persistence.support.sqlstore.impl.PersistenceManagerFactoryImpl";
        } else {
            return factoryClass;
        }
    }
     ...
     *     
     */
    public void setJdbcResourceJndiName(String value) {
        this.jdbcResourceJndiName = value;
    }
