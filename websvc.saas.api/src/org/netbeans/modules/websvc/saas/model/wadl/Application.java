...
public class Application {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "fault", namespace = "http://research.sun.com/wadl/2006/10", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "resource_type", namespace = "http://research.sun.com/wadl/2006/10", type = ResourceType.class, required = false),
        @XmlElementRef(name = "representation", namespace = "http://research.sun.com/wadl/2006/10", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "method", namespace = "http://research.sun.com/wadl/2006/10", type = Method.class, required = false)
    })
