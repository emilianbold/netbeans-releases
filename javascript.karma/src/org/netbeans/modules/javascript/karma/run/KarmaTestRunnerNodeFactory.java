...
public class KarmaTestRunnerNodeFactory extends TestRunnerNodeFactory {

    private final JumpToCallStackAction.Callback callback;


    public KarmaTestRunnerNodeFactory(JumpToCallStackAction.Callback callback) {
    ...
    public Node createCallstackFrameNode(String frameInfo, String displayName) {
        return new KarmaCallstackFrameNode(frameInfo, displayName, callback);
    }
