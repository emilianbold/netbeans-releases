...
public interface Constants {
    ...
    static final Font TAB_FONT = new Font( "Arial", Font.BOLD, FONT_SIZE+2 ); //NOI18N
    static final Font WELCOME_LABEL_FONT = new Font("Arial", Font.BOLD, FONT_SIZE+2 ) ; //NOI18N
    static final Font SECTION_HEADER_FONT = new Font( "Arial", Font.BOLD, FONT_SIZE+18 ); //NOI18N
