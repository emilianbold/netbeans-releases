...
public class MainMenu extends JellyTestCase {
    ...
    private static String separator = ""; //XXX fromBundle(coreBundle, "CTL_newMenuSeparator"); // Separator

    private static String versioning = ""; //XXX fromBundleNotTrimmed("org.netbeans.modules.vcscore.actions.Bundle",  "Menu/Versioning");
    private static String versioningMenuBarOptionsNodePath = menuBarNodeOptionsPath + "|" + versioning;

    private static final String MOVE_UP = "Move Up";
    private static final String MOVE_DOWN = "Move Down";
    private static final String SEPARATOR = ""; //XXX "("+separator+")";
