 ...
 * @author mschovanek
 * @depricated use local 'TestUtil extends AbstractTestUtil ....'
 */
public class TestUtil {
     ...
     */
    public static String nodeToString(TreeNode node) throws TreeException {
     ...
     */
    public static String nodeToString(Object node) throws TreeException {
     ...
     */
    public final static String lastElement(String string, String delim) {
    ...
    public static DataObject getTemplate(String tname) throws DataObjectNotFoundException {
        ...
        String fullName = dataFolder.getPrimaryFile().getPackageName('/') + "/" + tname;
        FileObject fileObject = Repository.getDefault().findResource(fullName);
        if (fileObject == null) {
            throw new IllegalArgumentException("Cannot find template: " + fullName);
        }
