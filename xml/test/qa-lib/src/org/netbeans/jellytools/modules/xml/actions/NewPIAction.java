...
public class NewPIAction extends ActionNoBlock {

    private static final String addPopup =
    Bundle.getStringTrimmed("org.openide.actions.Bundle", "New")
    + "|"
    + Bundle.getStringTrimmed("org.netbeans.modules.xml.tree.nodes.Bundle", "PROP_xmlNewPI");

    /** creates new NewPIAction instance */    
    public NewPIAction() {
        super(null, addPopup);
    }
}