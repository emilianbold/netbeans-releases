...
/** NewEntityReferenceAction class
 * @author <a href="mailto:mschovanek@netbeans.org">Martin Schovanek</a> */
public class NewEntityReferenceAction extends ActionNoBlock {

    private static final String addPopup =
    Bundle.getStringTrimmed("org.openide.actions.Bundle", "New")
    + "|"
    + Bundle.getStringTrimmed("org.netbeans.modules.xml.tree.nodes.Bundle", "PROP_xmlNewGeneralEntityRef");

    /** creates new NewEntityReferenceAction instance */    
