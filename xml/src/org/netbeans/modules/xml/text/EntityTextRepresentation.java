...
/**
 * Takes care about specifics of XML Entity text representation.
 * I.e. no update() is implemented.
 *
 * @author  Libor Kramolis
 * @version 0.1
 */
public class EntityTextRepresentation extends TextRepresentation {

    /** Creates new EntityTextRepresentation */
    public EntityTextRepresentation (TextEditorSupport editor, Synchronizator sync) {
        super (editor, sync);
    }
