 ...
 * @author Petr Hejl
 */
public final class JpaSupportFactory {
    
    public static JpaSupport createJpaSupport(JpaSupportImplementation impl) {
        return Accessor.getDefault().createJpaSupport(impl);
    }
    ...
    public static abstract class Accessor {
        ...
        public abstract JpaSupport createJpaSupport(JpaSupportImplementation impl);
    }
}
