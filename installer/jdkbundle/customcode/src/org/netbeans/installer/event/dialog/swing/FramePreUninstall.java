...
public class FramePreUninstall {
    ...
    public void buttonClickeduninstall(ISControlContext context) {
    ...
    public void initializeUIPreUninstall(ISDialogFrameContext context) {
        ISFrame frame = context.getISFrame();

        ISButton uninstallButton = frame.getButton("uninstall");
