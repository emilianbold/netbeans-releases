...
public class FramePreInstall {
    ...
    public void buttonClickedinstall(ISControlContext context) {
	...
	public void initializeUIPreInstall(ISDialogFrameContext context)
	{
		ISFrame frame = context.getISFrame();
		
		ISButton installButton = frame.getButton("install");
