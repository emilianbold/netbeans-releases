...
<project name="Mac Installer Properties" basedir="." >
    ...
    <!-- Base IDE properties   -->       
    <property name="baseide.version" value="7.1.2"/>
    <property name="appname" value="NetBeans 7.1.2"/> 
    <property name="mpkg.name_nb" value="NetBeans 7.1.2"/> 
    ...
    <property name="appversion" value="7.1.2"/>
    <property name="nb.display.version.long"  value="7.1.2"/>
    <property name="nb.display.version.short" value="7.1.2"/>
...
<!--    <loadresource property="glassfish.v3.build.number">
    ...
    <property name="glassfish_v3_location"     value="http://milestone.in.oracle.com/java/re/glassfish/v3.1.2/promoted/p02/b03/bundles/glassfish-3.1.2.2-b03.zip"/>
    <property name="glassfish_v3_location_ml"  value="http://milestone.in.oracle.com/java/re/glassfish/v3.1.2/promoted/p02/b03/bundles/glassfish-3.1.2.2-b03-ml.zip"/>
    <!--
    ...
    <property name="mpkg.version_jdk" value=" 7u5"/> 
    <property name="jdk.bundle.files.prefix" value="jdk-7u5"/>
    ...
    <property name="jdk_bits_location" value="${gf_builds_host}/java/re/jdk/7u5/promoted/all/b05/bundles/macosx-x64/jdk-7u5-macosx-x64.dmg"/>
    <property name="jdk.package.name" value="JDK\ 7\ Update\ 05"/>
