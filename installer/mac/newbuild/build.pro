...
<project name="Mac Installer Properties" basedir="." >
    ...
    <!-- Base IDE properties   -->       
    <property name="baseide.version" value="8.1 RC2"/>
    <property name="baseide.id" value="8.1_RC2"/>
    <property name="appname" value="NetBeans 8.1 RC2"/> 
    <property name="mpkg.name_nb" value="NetBeans 8.1 RC2"/> 
    ...
    <property name="appversion" value="8.1 RC2"/>
    <property name="nb.display.version.long"  value="8.1 RC2"/>
    <property name="nb.display.version.short" value="8.1 RC2"/>
