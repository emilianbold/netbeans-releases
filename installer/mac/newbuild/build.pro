...
<project name="Mac Installer Properties" basedir="." >
    ...
    <!-- Base IDE properties   -->       
    <property name="baseide.version" value="6.9 Beta"/>
    <property name="appname" value="NetBeans 6.9 Beta"/> 
    <property name="mpkg.name_nb" value="NetBeans 6.9 Beta"/> 
    ...
    <property name="appversion" value="6.9 Beta"/>
    <property name="nb.display.version.long"  value="6.9 Beta"/>
    <property name="nb.display.version.short" value="6.9 Beta"/>

    <property name="servicetag.source" value="NetBeans 6.9 Beta Installer"/>
    
    <!-- Tomcat properties   -->    
    <property name="tomcat.version" value="6.0.26"/>
    <property name="tomcat.id" value="6.0.26"/>
    ...
    <property name="glassfish.v3.sun.location.prefix" value="${gf_builds_host}/java/re/glassfish/3.0.1/promoted"/>
    <!--
    ...
    <property name="glassfish.v3.sun.display.version" value="3.0.1 b${glassfish.v3.sun.build.number}"/>
    ...
    <loadresource property="glassfish.v3.build.number">
	    ...
	    <striplinebreaks/>
            <tokenfilter>
              <replaceregex pattern="(.*)glassfish-3.0.1-b([0-9a-z]+)\.zip(.*)" replace="\2" flags="g"/>
            </tokenfilter>
          </filterchain>
    </loadresource>
    ...
    <property name="glassfish_v3_location"     value="${glassfish.v3.location.prefix}/${glassfish.v3.build.type}/${glassfish.v3.version}/archive/bundles/glassfish-3.0.1-${glassfish.v3.version}-ml.zip"/>
    <!--
