...
<project name="Mac Installer Properties" basedir="." >
    ...
    <!-- Base IDE properties   -->       
    <property name="baseide.version" value="8.0.1 RC1"/>
    <property name="baseide.id" value="8.0.1 RC1"/>
    <property name="appname" value="NetBeans 8.0.1 RC1"/> 
    <property name="mpkg.name_nb" value="NetBeans 8.0.1 RC1"/> 
    ...
    <property name="appversion" value="8.0.1 RC1"/>
    <property name="nb.display.version.long"  value="8.0.1 RC1"/>
    <property name="nb.display.version.short" value="8.0.1 RC1"/>

    <!-- Tomcat properties   -->    
    <property name="tomcat.version" value="8.0.9"/>
    <property name="tomcat.id" value="8.0.9"/>
    ...
    <property name="glassfish.location.prefix" value="${gf_builds_host}/java/re/glassfish/4.0.1/promoted"/>
    ...
    <loadresource property="glassfish.build.number">
	    ...
	    <striplinebreaks/>
            <tokenfilter>
              <replaceregex pattern="(.*)glassfish-4.0.1-b([0-9a-z]+)\.zip(.*)" replace="\2" flags="g"/>
            </tokenfilter>
          </filterchain>
    </loadresource>
    
    <property name="glassfish.display.version" value="4.0.1"/>
