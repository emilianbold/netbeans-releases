...
<project name="Mac Installer Properties" basedir="." >
    ...
    <!-- Base IDE properties   -->       
    <property name="baseide.version" value="7.1.1 Dev"/>
    <property name="appname" value="NetBeans 7.1.1 Dev ${buildnumber}"/> 
    <property name="mpkg.name_nb" value="NetBeans 7.1.1 Dev ${buildnumber}"/> 
    ...
    <property name="appversion" value="7.1.1 Dev"/>
    <property name="nb.display.version.long"  value="7.1.1 Dev ${buildnumber}"/>
    <property name="nb.display.version.short" value="7.1.1 Dev"/>
    ...
    <property name="glassfish.v3.display.version" value="3.1.1"/>
    ...
    <property name="glassfish.v3.install.dir"  value="${install.dir}/glassfish-3.1.1"/>
