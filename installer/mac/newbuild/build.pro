...
<project name="Mac Installer Properties" basedir="." >
    ...
    <!-- Base IDE properties   -->       
    <property name="baseide.version" value="8.0.1"/>
    <property name="baseide.id" value="8.0.1"/>
    <property name="appname" value="NetBeans 8.0.1"/> 
    <property name="mpkg.name_nb" value="NetBeans 8.0.1"/> 
    ...
    <property name="appversion" value="8.0.1"/>
    <property name="nb.display.version.long"  value="8.0.1"/>
    <property name="nb.display.version.short" value="8.0.1"/>
    ...
    <property name="jdk.builds.path" value="${jdk_builds_host}/${jdk_builds_path}/fcs/b01/bundles/macosx-x64"/>
