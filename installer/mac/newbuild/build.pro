...
<project name="Mac Installer Properties" basedir="." >
    ...
    <!-- Base IDE properties   -->       
    <property name="baseide.version" value="7.2 Beta"/>
    <property name="appname" value="NetBeans 7.2 Beta"/> 
    <property name="mpkg.name_nb" value="NetBeans 7.2 Beta"/> 
    ...
    <property name="appversion" value="7.2 Beta"/>
    <property name="nb.display.version.long"  value="7.2 Beta"/>
    <property name="nb.display.version.short" value="7.2 Beta"/>
