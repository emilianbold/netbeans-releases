...
<project name="Mac Installer Properties" basedir="." >
    ...
    <!-- Base IDE properties   -->       
    <property name="baseide.version" value="8.0.2"/>
    <property name="baseide.id" value="8.0.2"/>
    <property name="appname" value="NetBeans 8.0.2"/> 
    <property name="mpkg.name_nb" value="NetBeans 8.0.2"/> 
    ...
    <property name="appversion" value="8.0.2"/>
    <property name="nb.display.version.long"  value="8.0.2"/>
    <property name="nb.display.version.short" value="8.0.2"/>

    <!-- Tomcat properties   -->    
    <property name="tomcat.version" value="8.0.15"/>
    <property name="tomcat.id" value="8.0.15"/>
