...
<project name="Mac Installer Properties" basedir="." >
    ...
    <!-- Base IDE properties   -->       
    <property name="baseide.version" value="7.0.1 Dev"/>
    <property name="appname" value="NetBeans 7.0.1 Dev ${buildnumber}"/> 
    <property name="mpkg.name_nb" value="NetBeans 7.0.1 Dev ${buildnumber}"/> 
    ...
    <property name="appversion" value="7.0.1 Dev"/>
    <property name="nb.display.version.long"  value="7.0.1 Dev ${buildnumber}"/>
    <property name="nb.display.version.short" value="7.0.1 Dev"/>

    <property name="servicetag.source" value="NetBeans IDE ${nb.display.version.short} Installer"/>
    
    <!-- Tomcat properties   -->    
    <property name="tomcat.version" value="7.0.12"/>
    <property name="tomcat.id" value="7.0.12"/>
