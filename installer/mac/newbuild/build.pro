...
<project name="Mac Installer Properties" basedir="." >
    ...
    <property name="glassfish_location" value="${gf_builds_host}/java/re/glassfish/9.1_01/promoted/fcs/b09d/images/mac/glassfish-image-v2ur1-b09d.jar"/>  
    ...
    <property name="openesb_location" value="${openesb_builds_host}/kits/ojc/main/latest/installers/jbi_components_installer.jar"/>
