...
<project name="Mac Installer Properties" basedir="." >
    ...
    <!-- JDK Properties-->    
    <property name="jdk_bits_location" value="${binary_cache_host}/java/re/jdk/7u4/promoted/all/b16/bundles/macosx-amd64/jdk-7u4-ea-bin-b16-macosx-x64-15_mar_2012.dmg"/>
