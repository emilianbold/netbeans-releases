...
<project name="Mac Installer Properties" basedir="." >
    ...
    <!-- Base IDE properties   -->       
    <property name="baseide.version" value="7.1"/>
    <property name="appname" value="NetBeans 7.1"/> 
    <property name="mpkg.name_nb" value="NetBeans 7.1"/> 
    ...
    <property name="appversion" value="7.1"/>
    <property name="nb.display.version.long"  value="7.1"/>
    <property name="nb.display.version.short" value="7.1"/>
