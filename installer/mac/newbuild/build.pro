...
<project name="Mac Installer Properties" basedir="." >
    ...
    <!-- JDK Properties-->    
    <property name="jdk_bits_location" value="${binary_cache_host}/java/re/jdk/7u4/promoted/all/b15/bundles/macosx-amd64/jdk-7u4-ea-bin-b15-macosx-x64-08_mar_2012.dmg"/>
