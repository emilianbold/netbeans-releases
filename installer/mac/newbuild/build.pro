...
<project name="Mac Installer Properties" basedir="." >
    ...
    <!-- Base IDE properties   -->       
    <property name="baseide.version" value="7.3.1"/>
    <property name="appname" value="NetBeans 7.3.1"/> 
    <property name="mpkg.name_nb" value="NetBeans 7.3.1"/> 
    ...
    <property name="appversion" value="7.3.1"/>
    <property name="nb.display.version.long"  value="7.3.1"/>
    <property name="nb.display.version.short" value="7.3.1"/>
    ...
    <property name="jdk_bits_location" value="${jdk_builds_host}/java/re/jdk/7u25/promoted/fcs/b14/bundles/macosx-x64/jdk-7u25-macosx-x64.dmg"/>
