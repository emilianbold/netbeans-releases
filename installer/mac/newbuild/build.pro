...
<project name="Mac Installer Properties" basedir="." >
    ...
    <!-- Base IDE properties   -->       
    <property name="baseide.version" value="7.0 RC2"/>
    <property name="appname" value="NetBeans 7.0 RC2"/> 
    <property name="mpkg.name_nb" value="NetBeans 7.0 RC2"/> 
    ...
    <property name="appversion" value="7.0 RC2"/>
    <property name="nb.display.version.long"  value="7.0 RC2"/>
    <property name="nb.display.version.short" value="7.0 RC2"/>

    <property name="servicetag.source" value="NetBeans ${nb.display.version.short} Installer"/>
    
    <!-- Tomcat properties   -->    
    <property name="tomcat.version" value="7.0.11"/>
    <property name="tomcat.id" value="7.0.11"/>
    ...
    <property name="glassfish.v3.display.version" value="3.1"/>
    ...
    <property name="glassfish.v3.install.dir"  value="${install.dir}/glassfish-3.1"/>
