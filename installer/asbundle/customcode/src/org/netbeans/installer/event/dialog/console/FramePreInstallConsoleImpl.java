...
public class FramePreInstallConsoleImpl {

    public void preConsoleInteractionPreInstall(ISDialogFrameContext context) {
    ...
    public void postConsoleInteractionPreInstall(ISDialogFrameContext context) {
