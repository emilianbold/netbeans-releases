...
public class FrameBeginConsoleImpl {

    public void preConsoleInteractionBegin(ISDialogFrameContext context) {
    ...
    public void postConsoleInteractionBegin(ISDialogFrameContext context) {
