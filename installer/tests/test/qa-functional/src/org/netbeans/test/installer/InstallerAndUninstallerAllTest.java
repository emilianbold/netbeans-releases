 ...
 */
public class InstallerAndUninstallerAllTest extends NbTestCase {
...
//        TestSuite suite = new NbTestSuite(InstallerAndUninstallerAllTest.class);
        TestSuite suite = new NbTestSuite("Installer All Packs bundle test");

        suite.addTest(NbModuleSuite.create(InstallerAndUninstallerAllTest.class, ".*", ".*"));
