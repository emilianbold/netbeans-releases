 ...
 *
 */
class ComponentFinalWizardPanel implements Panel, FinishablePanel,
        ValidatingPanel
{
    ComponentFinalWizardPanel() {
    ...
    public Component getComponent() {
        if (myComponent == null) {
            myComponent = new ComponentFinalVisualPanel( this );
            myComponent.setName(
    ...
    public HelpCtx getHelp() {
        return new HelpCtx( ComponentFinalWizardPanel.class);
    }
    ...
    private ComponentFinalVisualPanel myComponent;
