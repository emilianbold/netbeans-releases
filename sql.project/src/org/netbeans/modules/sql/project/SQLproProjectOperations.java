...
/**
 * Context sensitive menu operations on sql module project
 *
 * @author Bing Lu
 */
public class SQLproProjectOperations implements DeleteOperationImplementation, CopyOperationImplementation, MoveOperationImplementation {
    private SQLproProject project;

    /** Creates a new instance of JbiProjectOperations */
    public SQLproProjectOperations(SQLproProject project) {
    ...
    public void notifyDeleting() throws IOException {
        SQLproActionProvider ap = (SQLproActionProvider) project.getLookup().lookup(SQLproActionProvider.class);
        assert ap != null;
