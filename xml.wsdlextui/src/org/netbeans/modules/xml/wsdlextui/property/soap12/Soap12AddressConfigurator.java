...
public class Soap12AddressConfigurator extends ExtensibilityElementConfigurator {
    
    
    private static QName addressQName = new QName("http://schemas.xmlsoap.org/wsdl/soap12/", "address");
    
    private static QName[] supportedQNames = {addressQName};
    /** Creates a new instance of SoapHeaderConfigurator */
    public Soap12AddressConfigurator() {
    }
        ...
        if (addressQName.equals(qname)) {
            if ("location".equals(attributeName)) {
                ...
                try {
                    ...
                    property.setName(SOAP12Address.LOCATION_PROPERTY);
                    property.setDisplayName(NbBundle.getMessage(Soap12AddressConfigurator.class, "PROP_NAME_ADDRESS_LOCATION"));
    ...
    public String getTypeDisplayName(ExtensibilityElement extensibilityElement, QName qname) {
        return NbBundle.getMessage(Soap12AddressConfigurator.class, "LBL_SoapAddress_TypeDisplayName");
    }
