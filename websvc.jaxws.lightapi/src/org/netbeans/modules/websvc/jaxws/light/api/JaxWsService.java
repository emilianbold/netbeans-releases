...
public class JaxWsService {
    ...
    /** Returns WSDL port name of the web service, useful for WS from WSDL to identify port name for which web service is implemented
     * 
    ...
    /** Sets WSDL port name for web service, useful for WS from WSDL to specify port name for which web service is implemented
     * 
    ...
    /** Returns WSDL service name of the web service, useful for WS from WSDL to identify service name for which web service is implemented
     * 
    ...
    /** Sets WSDL service name for web service, useful for WS from WSDL to specify service name for which web service is implemented
     * 
