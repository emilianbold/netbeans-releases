...
//    public static final void updateNodesInLookup(Node[] nodes, Lookup lookup,
//            InstanceContent lookupContent)
//    {
//        Collection<? extends Node> oldNodes
//                = lookup.lookupAll(Node.class);
//
//        if (oldNodes != null) {
//            for (Node oldNode : oldNodes) {
//               lookupContent.remove(oldNode);
//            }
//        }
//
//        for (int i = 0; nodes != null && i < nodes.length; i++) {
//            lookupContent.add(nodes[i]);
//        }
//    }
            ...
            InstanceContent lookupContent)
    {
        ...
        for (Node node : removedNodes) {
            lookupContent.remove(node);
        }

        for (Node node : addedNodes) {
            lookupContent.add(node);
        }
    }
}
