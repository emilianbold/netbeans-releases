 ...
 * @author anjeleevich
 */
public abstract class DesignViewPanel extends JPanel {
    private DesignView designView;
    
    public DesignViewPanel(DesignView designView) {
    ...
    void selectWidget(Widget widget) {
        designView.selectWidget(widget);
    }
    ...
    public WorklistDataObject getDataObject() {
        return designView.getDataObject();
    }
    ...
    public Lookup getNodeLookup() {
        return designView.getNodeLookup();
    }
