 ...
 * @version 2007.11.19
 */
final class Item extends JMenuItem implements DragGestureListener, Transferable {

    Item(Palette palette, ItemHandler handler) {
        ...
        addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                WlmMapperModel model = (WlmMapperModel) mapper.getModel();
