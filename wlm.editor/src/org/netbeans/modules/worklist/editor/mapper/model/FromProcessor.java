 ...
 * The From WLM entity can have different forms.
...
public class FromProcessor {
    ...
    private WlmMapperModelFactory mFactory;
    private TCopy mContextEntity;
    
    public FromProcessor(WlmMapperModelFactory factory, TCopy fromHolder) {
