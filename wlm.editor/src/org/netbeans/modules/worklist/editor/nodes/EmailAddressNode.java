 ...
 * @author anjeleevich
 */
public class EmailAddressNode extends WLMNode<EmailAddress> {

    private String cachedXPath = null;

    public EmailAddressNode(EmailAddress address, Lookup lookup) {
        this(address, Children.LEAF, lookup);
    }

    public EmailAddressNode(EmailAddress component, Children children, Lookup lookup) {
    ...
    public void updateDisplayName() {
        EmailAddress address = getWLMComponent();

        String xpath = address.getContent();
