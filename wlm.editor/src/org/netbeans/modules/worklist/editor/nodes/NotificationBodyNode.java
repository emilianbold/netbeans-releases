 ...
 * @author anjeleevich
 */
public class NotificationBodyNode extends WLMNode<TNotification> {

    private String cachedXPath;
    private Boolean cachedExists;

    public NotificationBodyNode(TNotification component, Lookup lookup) {
        this(component, Children.LEAF, lookup);
    }

    public NotificationBodyNode(TNotification component, Children children, 
            Lookup lookup)
    {
    ...
    public void updateDisplayName() {
        ...
        TMessage message = notificaion.getMessage();

        MessageBody body = (message == null) ? null : message.getBody();

        String exprString = (body == null) ? null
                : body.getContent();

        Boolean exists = Boolean.valueOf(body != null);
