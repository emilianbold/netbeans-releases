 ...
 * @author anjeleevich
 */
public class ChangeVariablesChildren extends WLMChildren<TAction> {

    public ChangeVariablesChildren(TAction action, Lookup lookup) {
        super(action, lookup);
    }
    ...
    protected Collection<? extends WLMComponent> createKeys() {
        ...
        if (changeVariables != null) {
            result = changeVariables.getCopyList();
        }
