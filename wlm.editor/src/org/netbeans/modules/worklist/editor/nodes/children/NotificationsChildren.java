 ...
 * @author anjeleevich
 */
public class NotificationsChildren extends WLMChildren<TTask> {

    public NotificationsChildren(TTask task, Lookup lookup) {
        super(task, lookup);
    }
    ...
    protected Node[] createNodes(WLMComponent component) {
        if (component instanceof TNotification) {
            TNotification notification = (TNotification) component;
            Lookup lookup = getLookup();
            return new Node[] { new NotificationNode(notification, lookup) };
        }
