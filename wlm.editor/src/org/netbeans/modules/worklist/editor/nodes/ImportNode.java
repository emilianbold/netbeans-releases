 ...
 * @author anjeleevich
 */
public class ImportNode extends WLMNode<TImport> {
    private String cachedLocation = null;

    public ImportNode(TImport component, Lookup lookup) {
        super(component, Children.LEAF, lookup, "import_wsdl.png"); // NOI18N
        updateDisplayName();
    }

    @Override
    public void updateDisplayName() {
        TImport importComponent = getWLMComponent();

        String location = importComponent.getLocation();
        if (location != null) {
        ...
        if (!StringUtils.equals(location, cachedLocation)) {
            ...
            if (location.length() != 0) {
                ...
                builder.append("Undefined location");
                builder.endColor();
            }
