 ...
 * @author radval
 */
public class WorklistWizardPanel1 implements WizardDescriptor.FinishablePanel {
    private WizardDescriptor.Panel mPanel;

    private WorklistWizardBottomPanel1 bottomPanel;
    
    public WorklistWizardPanel1(WizardDescriptor.Panel panel, WorklistWizardBottomPanel1 bottomPanel) {
        this.mPanel = panel;
