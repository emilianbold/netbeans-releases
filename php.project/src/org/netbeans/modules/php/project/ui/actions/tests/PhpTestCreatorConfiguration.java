 ...
 */
public class PhpTestCreatorConfiguration extends TestCreatorConfiguration {

    private Project currentProject;
    private final FileObject[] activatedFileObjects;

    PhpTestCreatorConfiguration(FileObject[] activatedFileObjects) {
    ...
    @NbBundle.Messages({
        ...
        "PhpTestCreatorConfiguration.info=New test will be created using {0}.",
    })
    @Override
    public Component getConfigurationPanel(Context context) {
        ...
        if (phpProject != null) {
            ...
            if (!testingProviders.isEmpty()) {
                ...
                String info = Bundle.PhpTestCreatorConfiguration_info(testingProvider.getDisplayName());
