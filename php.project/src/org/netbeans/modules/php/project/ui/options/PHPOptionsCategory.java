...
public class PHPOptionsCategory extends OptionsCategory {
    ...
    public String getCategoryName() {
        return NbBundle.getMessage(PHPOptionsCategory.class, "PHPOptionsCategory_name");
    }

    @Override
    public String getTitle() {
        return NbBundle.getMessage(PHPOptionsCategory.class, "PHPOptionsCategory_title");
    }
