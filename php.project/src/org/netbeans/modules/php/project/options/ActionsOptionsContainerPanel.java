...
/**
 * Php Actions options panel combined from panels for various settings.
 *
 * @author akorostelev
 */
public class ActionsOptionsContainerPanel extends AdvancedOption {
    
    private static final String TAB_FOLDER = "org.netbeans.modules.php/ActionsOptions";

    private static String CTL_ACTIONS_NAME = "CTL_Actions_DisplayName";

    private static String CTL_ACTIONS_TIP = "CTL_Actions_ToolTip";

    public String getDisplayName() {
        return NbBundle.getMessage(ActionsOptionsContainerPanel.class, 
    ...
    private static final class Controller extends OptionsPanelController {
        ...
        private void init(Lookup masterLookup) {
            ...
            Lookup lookup = Lookups.forPath(TAB_FOLDER); // NOI18N
