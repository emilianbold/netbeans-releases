...
public final class SyncItems {
    ...
    public void add(TransferFile remoteTransferFile, TransferFile localTransferFile, long lastTimestamp) {
        String remotePath = remoteTransferFile != null ? remoteTransferFile.getRemotePath() : localTransferFile.getRemotePath();
        synchronized (itemsByPath) {
            itemsByPath.put(remotePath, new SyncItem(this, remoteTransferFile, localTransferFile, lastTimestamp));
        }
    }
