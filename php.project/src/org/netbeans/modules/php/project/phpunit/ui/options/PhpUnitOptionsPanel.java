...
@OptionsPanelController.Keywords(keywords={"php phpunit unit testing framework coverage", "#PhpUnitOptionsPanel.keywords.coverage"}, location=UiUtils.OPTIONS_PATH, index=2)
