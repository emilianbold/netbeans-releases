...
final class RemoteOperationFactory extends FileOperationFactory {
    ...
    Boolean doRename(RemoteClient client, FileObject source, String oldName) throws RemoteException {
        ...
        TransferFile toTransferFile = TransferFile.fromFileObject(client.new RemoteClientImpl(baseDirectory), null, source);
        TransferFile fromTransferFile = TransferFile.fromFile(client.new RemoteClientImpl(baseDirectory), null, new File(sourceFile.getParentFile(), oldName));
