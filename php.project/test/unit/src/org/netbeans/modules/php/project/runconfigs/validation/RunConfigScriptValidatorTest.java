...
public class RunConfigScriptValidatorTest extends NbTestCase {
    ...
    public void testValidateWorkDir() {
        ...
        assertNotNull(RunConfigScriptValidator.validateWorkDir(index.getAbsolutePath(), false));
        assertNotNull(RunConfigScriptValidator.validateWorkDir(index.getName(), false));
    }

    public void testValidateIndexFile() throws Exception {
        assertNull(RunConfigScriptValidator.validateIndexFile(getWorkDir(), INDEX_NAME));
        // errors
        assertNotNull(RunConfigScriptValidator.validateIndexFile(getWorkDir(), null));
        assertNotNull(RunConfigScriptValidator.validateIndexFile(getWorkDir(), "abc.php"));
        assertNotNull(RunConfigScriptValidator.validateIndexFile(getWorkDir(), "/abc.php"));
        assertNotNull(RunConfigScriptValidator.validateIndexFile(getWorkDir(), "\\abc.php"));
        assertNotNull(RunConfigScriptValidator.validateIndexFile(getWorkDir(), "../" + getWorkDir().getName() + "/" + INDEX_NAME));
        assertNotNull(RunConfigScriptValidator.validateIndexFile(getWorkDir(), "a/../" + INDEX_NAME));
    }
