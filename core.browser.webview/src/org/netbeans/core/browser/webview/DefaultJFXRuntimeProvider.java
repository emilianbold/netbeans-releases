...
/**
 * Provides the location of JavaFX runtime selected by user (if any).
 * @author S. Aubrecht
 */
...
public class DefaultJFXRuntimeProvider implements WebBrowserImplProvider.JFXRuntimePathProvider {
    ...
    static void setJFXRuntimePath( File runtimePath ) {
        if( null == runtimePath )
            getPreferences().remove( KEY );
        else
            getPreferences().put( KEY, runtimePath.getAbsolutePath());
