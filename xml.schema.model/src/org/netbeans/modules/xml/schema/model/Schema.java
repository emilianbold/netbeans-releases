 ...
 */
public interface Schema extends SchemaComponent {
	...
	Collection<SchemaComponent> getSchemaReferences();
	void addExternalReference(SchemaComponent ref);
	void removeExternalReference(SchemaComponent ref);
	Collection<SchemaModel> getImportedSchemas();
	Collection<SchemaModel> getIncludedSchemas();
	Collection<SchemaModel> getRedefinedSchemas();
