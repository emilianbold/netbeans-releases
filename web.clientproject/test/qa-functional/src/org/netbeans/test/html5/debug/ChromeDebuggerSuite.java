 ...
 */
public class ChromeDebuggerSuite extends JavaScriptDebugger {

    public ChromeDebuggerSuite(String args) {
        super(args);
    }

    public static Test suite() {
        NbModuleSuite.Configuration conf = emptyConfiguration();
        conf = conf.addTest(LineDebuggerTest.class, "testOpenProjectChromeNB",
