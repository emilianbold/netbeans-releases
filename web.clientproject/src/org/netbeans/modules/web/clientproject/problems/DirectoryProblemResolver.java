...
public class DirectoryProblemResolver implements ProjectProblemResolver {
    ...
    private static final RequestProcessor RP = new RequestProcessor(DirectoryProblemResolver.class);
    ...
    public DirectoryProblemResolver(ClientSideProject project, String propertyName, String dialogTitle) {
    ...
    public Future<ProjectProblemsProvider.Result> resolve() {
        ...
        // save metadata
        final String reference = project.getReferenceHelper().createForeignFileReference(selectedDir, null);
        RP.post(new Runnable() {
            @Override
            public void run() {
                ClientSideProjectProperties projectProperties = new ClientSideProjectProperties(project);
                projectProperties.save(Collections.singletonMap(propertyName, reference), Collections.<String, String>emptyMap());
            }
        });
