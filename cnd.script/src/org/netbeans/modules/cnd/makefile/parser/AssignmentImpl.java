 ...
 */
public class AssignmentImpl implements MakefileAssignment {

    private final String name;
    private final String value;

    public AssignmentImpl(String name, String value) {
        this.name = name;
        this.value = value;
    }

    @Override
    public MakefileElementKind getKind() {
        return MakefileElementKind.ASSIGNMENT;
    }
