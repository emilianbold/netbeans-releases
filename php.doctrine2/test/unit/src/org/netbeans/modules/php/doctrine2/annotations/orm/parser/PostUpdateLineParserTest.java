...
public class PostUpdateLineParserTest extends NbTestCase {
    ...
    public void testReturnValueIsPostUpdateParsedLine_01() throws Exception {
        assertTrue(parser.parse("PostUpdate") instanceof SimpleAnnotationLineParser.SimpleAnnotationParsedLine);
    }

    public void testReturnValueIsPostUpdateParsedLine_02() throws Exception {
        assertTrue(parser.parse("Annotations\\PostUpdate") instanceof SimpleAnnotationLineParser.SimpleAnnotationParsedLine);
    }

    public void testReturnValueIsPostUpdateParsedLine_03() throws Exception {
        assertTrue(parser.parse("\\Foo\\Bar\\PostUpdate") instanceof SimpleAnnotationLineParser.SimpleAnnotationParsedLine);
    }
