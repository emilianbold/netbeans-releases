...
public class PreRemoveLineParserTest extends NbTestCase {
    ...
    public void testReturnValueIsPreRemoveParsedLine_01() throws Exception {
        assertTrue(parser.parse("PreRemove") instanceof SimpleAnnotationLineParser.SimpleAnnotationParsedLine);
    }

    public void testReturnValueIsPreRemoveParsedLine_02() throws Exception {
        assertTrue(parser.parse("Annotations\\PreRemove") instanceof SimpleAnnotationLineParser.SimpleAnnotationParsedLine);
    }

    public void testReturnValueIsPreRemoveParsedLine_03() throws Exception {
        assertTrue(parser.parse("\\Foo\\Bar\\PreRemove") instanceof SimpleAnnotationLineParser.SimpleAnnotationParsedLine);
    }
