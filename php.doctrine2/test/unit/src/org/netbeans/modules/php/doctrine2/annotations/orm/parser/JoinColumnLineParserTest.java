...
public class JoinColumnLineParserTest extends NbTestCase {
    private JoinColumnLineParser parser;
    ...
    protected void setUp() throws Exception {
        super.setUp();
        this.parser = new JoinColumnLineParser();
    }
    ...
    public void testReturnValueIsJoinColumnParsedLine_01() throws Exception {
        assertTrue(parser.parse("JoinColumn") instanceof JoinColumnParsedLine);
    }

    public void testReturnValueIsJoinColumnParsedLine_02() throws Exception {
        assertTrue(parser.parse("Annotations\\JoinColumn") instanceof JoinColumnParsedLine);
    }

    public void testReturnValueIsJoinColumnParsedLine_03() throws Exception {
        assertTrue(parser.parse("\\Foo\\Bar\\JoinColumn") instanceof JoinColumnParsedLine);
    }

    public void testReturnValueIsJoinColumnParsedLine_04() throws Exception {
        assertTrue(parser.parse("Annotations\\JoinColumn(name=\"customer_id\", referencedColumnName=\"id\")") instanceof JoinColumnParsedLine);
    }
    ...
    public void testValidUseCase_01() throws Exception {
        ...
        assertEquals(JoinColumnLineParser.ANNOTATION_NAME, parsedLine.getName());
