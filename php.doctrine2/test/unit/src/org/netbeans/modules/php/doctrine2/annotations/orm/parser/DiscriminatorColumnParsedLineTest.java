 ...
 */
public class DiscriminatorColumnParsedLineTest extends NbTestCase {
    ...
    public void testCorrectName() throws Exception {
        DiscriminatorColumnParsedLine parsedLine = new DiscriminatorColumnParsedLine("", Collections.EMPTY_MAP);
