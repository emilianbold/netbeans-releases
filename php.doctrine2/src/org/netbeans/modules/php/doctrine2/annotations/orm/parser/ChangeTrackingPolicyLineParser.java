 ...
 */
class ChangeTrackingPolicyLineParser implements AnnotationLineParser {

    static final String ANNOTATION_NAME = "ChangeTrackingPolicy"; //NOI18N
    ...
    public AnnotationParsedLine parse(String line) {
        ...
        if (tokens.length > 0 && AnnotationUtils.isTypeAnnotation(tokens[0], ANNOTATION_NAME)) {
            ...
            result = new ChangeTrackingPolicyParsedLine(description, types);
        }
        return result;
    }
