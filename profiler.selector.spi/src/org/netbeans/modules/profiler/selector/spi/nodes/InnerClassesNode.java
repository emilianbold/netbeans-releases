                ...
                js.runUserActionTask(new CancellableTask<CompilationController>() {
                        ...
                        public void run(CompilationController controller)
                            ...
                            for (TypeElement element : elements) {
                                innerClassNodes.add(new ClassNode(parent.cpInfo, IconResource.CLASS_ICON, element, parent));
                            }
                                ...
                                if ((classElement != null) && (classElement.getKind() == ElementKind.CLASS)) {
                                    ...
                                    if (anonymousInnerClassPattern.matcher(className).matches()) {
                                        ...
                                        if (implementedClassName != null) {
                                            ...
                                            innerClassNodes.add(new ClassNode(parentClass.cpInfo, IconResource.CLASS_ICON,
