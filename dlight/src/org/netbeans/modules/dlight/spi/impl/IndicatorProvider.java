...
public final class IndicatorProvider {
  ...
  private static IndicatorProvider instance = null;
   ...
   */
   public Indicator createIndicator(String toolName, IndicatorConfiguration configuraiton){
    Collection<? extends IndicatorFactory> result = Lookup.getDefault().lookupAll(IndicatorFactory.class);
    if (result.isEmpty()){
      return null;
    }
