...
public final class DataStorageTypeFactory {
  ...
  public synchronized  DataStorageType getDataStorageType(String ig){
    if (storageTypesCache.containsKey(ig)){
      return  storageTypesCache.get(ig);
    }
    DataStorageType type = new DataStorageType(ig);
    storageTypesCache.put(ig, type);
    return type;
  }
