...
public final class ProjectUtilitiesDummyWindowManager extends WindowManager {
    ...
    public ProjectUtilitiesDummyWindowManager() {
    ...
    public boolean isEditorTopComponent(TopComponent tc) {
        Mode md = findMode(tc);
        if (md != null && CloneableEditorSupport.EDITOR_MODE.equals(md.getName())) {
            return true;
        }
        return false;
    }
    ...
    protected Action[] topComponentDefaultActions(TopComponent tc) {
        ...
        synchronized (ProjectUtilitiesDummyWindowManager.class) {
    ...
    private final class W implements Workspace {
        ...
        public void remove() {
            ProjectUtilitiesDummyWindowManager.this.delete(this);
        }
