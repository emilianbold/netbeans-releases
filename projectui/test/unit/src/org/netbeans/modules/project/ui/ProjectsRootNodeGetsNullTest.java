...
public class ProjectsRootNodeGetsNullTest extends NbTestCase {

    private Project toDelete;
    
    public ProjectsRootNodeGetsNullTest(String testName) {
        super(testName);
    }
    ...
    public void testNPEIfObjectNotFound() throws Exception {
        ...
        assertNull("Project has been discarded", toDelete);
        ...
        assertEquals("Just 29 nodes:\n" + arrNodes, 29, arrNodes.size());
        ...
        assertEquals("Just 29 projects", 29, arr.length);
    }

    private void waitForAWTEvents() throws InvocationTargetException, InterruptedException {
    ...
    void invalidateProject() {
        ...
        if (toDelete != null) {
            TestSupport.notifyDeleted(toDelete);
            toDelete = null;
        }
    }
