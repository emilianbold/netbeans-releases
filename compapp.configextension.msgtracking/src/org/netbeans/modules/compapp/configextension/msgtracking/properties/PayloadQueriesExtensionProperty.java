...
/**
 * Extension property of payload queries.
 * 
 * @author jqian
 */
public class PayloadQueriesExtensionProperty
        extends TabularDataExtensionProperty {

    private static final String NAME = "name"; // NOI18N
    private static final String XPATH = "xpath"; // NOI18N

    public PayloadQueriesExtensionProperty(
            CasaNode node,
    ...
    protected TabularDataDescriptor getTabularDataDescriptor() {
        ...
        ret.setName(PayloadQueriesExtensionProperty.this.getName());
        ret.setDisplayName(PayloadQueriesExtensionProperty.this.getDisplayName());
        ret.setDescription(PayloadQueriesExtensionProperty.this.getShortDescription());
        ...
        name.setDisplayName(
                ...
                "JbiExtensions/MessageTrackingExtension/message-tracking/payload-query/name")); // NOI18N
        name.setDescription(
                NbBundle.getMessage(MessageTrackingExtensionPropertyClassProvider.class,
                "JbiExtensions/MessageTrackingExtension/message-tracking/payload-query/name@description")); // NOI18N
        ...
        xpath.setDisplayName(
                NbBundle.getMessage(MessageTrackingExtensionPropertyClassProvider.class,
                "JbiExtensions/MessageTrackingExtension/message-tracking/payload-query/xpath")); // NOI18N
        xpath.setDescription(
                NbBundle.getMessage(MessageTrackingExtensionPropertyClassProvider.class,
                "JbiExtensions/MessageTrackingExtension/message-tracking/payload-query/xpath@description")); // NOI18N
