 ...
 * 
 */
public class CustomerDBSpringSampleWizardIterator extends SampleWizardIterator {
    private static final long serialVersionUID = 1L;
    
    public CustomerDBSpringSampleWizardIterator() {}
    
    public static CustomerDBSpringSampleWizardIterator createIterator() {
        return new CustomerDBSpringSampleWizardIterator();
    }
    
    @Override
    protected WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[] {
            new CustomerDBSpringSampleWizardPanel(),
        };
    }
    ...
    public Set instantiate() throws IOException {
        ...
        //replace tokens
        String[][] tokens = { {"CustomerDBSpring", (String) wiz.getProperty(NAME)} };
        String[] files = 
