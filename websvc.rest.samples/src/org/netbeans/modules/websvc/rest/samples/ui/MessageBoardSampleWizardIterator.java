 ...
 * 
 */
public class MessageBoardSampleWizardIterator extends SampleWizardIterator {
    private static final long serialVersionUID = 1L;
    
    public MessageBoardSampleWizardIterator() {}
    
    public static MessageBoardSampleWizardIterator createIterator() {
        return new MessageBoardSampleWizardIterator();
    }
    
    @Override
    protected WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[] {
            new MessageBoardSampleWizardPanel(),
        };
    }
    ...
    public Set instantiate() throws IOException {
        ...
        //replace tokens
        String[][] tokens = { {"MessageBoard", (String) wiz.getProperty(NAME)} };
        String[] files = 
