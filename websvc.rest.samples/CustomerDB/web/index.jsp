...
<html>
    <head>
        ...
        <script type="text/javascript" src="./restclient/ui/customerdb.js"></script>
        <script type="text/javascript" src="./restclient/Support.js"></script>
        <script type='text/javascript' src='./restclient/customerdb/CustomerDB.js'></script>
	<script type='text/javascript' src='./restclient/customerdb/Customers.js'></script>
	<script type='text/javascript' src='./restclient/customerdb/DiscountCodes.js'></script>
	<script type='text/javascript' src='./restclient/customerdb/Customer.js'></script>
	<script type='text/javascript' src='./restclient/customerdb/DiscountCode.js'></script>
