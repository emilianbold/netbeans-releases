 ...
 *
 */
class ImportImpl extends  HrefSpecImpl implements Import {

    ImportImpl( XslModelImpl model, Element element ) {
        super( model , element );
    }
    
    ImportImpl( XslModelImpl model) {
        super( model , XslElements.IMPORT );
    }
