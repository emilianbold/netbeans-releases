 ...
 *
 */
class KeyImpl extends MatchableQNameableSeqCtorImpl implements Key {


    KeyImpl( XslModelImpl model, Element element ) {
        super( model , element );
    }

    KeyImpl( XslModelImpl model ) {
        super( model , XslElements.KEY );
    }
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.xslt.model.Key#getUse()
     */
    public String getUse() {
        return getAttribute( XslAttributes.USE );
    }

    /* (non-Javadoc)
     * @see org.netbeans.modules.xslt.model.Key#setUse(java.lang.String)
     */
    public void setUse( String use ) {
        setAttribute( XslAttributes.USE, use );
    }
