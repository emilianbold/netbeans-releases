 ...
 *
 */
class SequenceImpl extends AsSeqElementCtorImpl implements Sequence {


    SequenceImpl( XslModelImpl model, Element element ) {
        super( model , element );
    }

    SequenceImpl( XslModelImpl model ) {
        super( model , XslElements.SEQUENCE );
    }
