 ...
 *
 */
class IncludeImpl extends HrefSpecImpl implements Include {

    IncludeImpl( XslModelImpl model, Element element ) {
        super( model , element );
    }

    IncludeImpl( XslModelImpl model ) {
        super( model , XslElements.INCLUDE );
    }
