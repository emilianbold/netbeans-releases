 ...
 *
 */
class CopyOfImpl extends ValidationCopyNsSpecImpl implements CopyOf {


    CopyOfImpl( XslModelImpl model, Element element ) {
        super( model , element );
    }
    
    CopyOfImpl( XslModelImpl model ){
        super( model , XslElements.COPY_OF );
    }
