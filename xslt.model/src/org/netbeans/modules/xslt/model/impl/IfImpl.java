 ...
 *
 */
class IfImpl extends SequenceElementConstructorImpl implements If {

    IfImpl( XslModelImpl model, Element element ) {
        super( model , element );
    }
    
    IfImpl( XslModelImpl model ){
        super( model , XslElements.IF );
    }
