 ...
 *
 */
class OtherwiseImpl extends SequenceConstructorImpl implements Otherwise {

    OtherwiseImpl( XslModelImpl model, Element element ) {
        super( model , element );
    }

    OtherwiseImpl( XslModelImpl model ) {
        super( model ,XslElements.OTHERWISE );
    }
