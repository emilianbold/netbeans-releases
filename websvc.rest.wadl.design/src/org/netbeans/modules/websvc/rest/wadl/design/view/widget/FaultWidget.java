...
public class FaultWidget extends RepresentationTypeWidget {
     ...
     * @param fault
     */
    public FaultWidget(ObjectScene scene, Widget parent, RepresentationType fault, WadlModel model) throws IOException {
        super(scene, parent, fault, model);
    }
    ...
    public String getTitle() {
        return NbBundle.getMessage(MethodWidget.class, "LBL_Fault");
    }
    
    public Image getIcon() {
        return Utilities.loadImage
            ("org/netbeans/modules/websvc/rest/wadl/design/view/resources/fault.png"); // NOI18N
    }
}
