...
public abstract class AbstractTitledWidget extends Widget implements ExpandableWidget {
    ...
    public static final Color TITLE_COLOR_REPRESENTATION = new Color(235,255,255);//new Color(240,240,240);
    public static final Color TITLE_COLOR_FAULT = new Color(235,255,255);//new Color(245,227,225);
    public static final Color TITLE_COLOR_METHOD_BODY = new Color(240,240,240);
...
//        }
    ...
    public static Widget createMoveableComponent (Scene scene, Component component) {
        Widget widget = new Widget (scene);
        widget.setLayout (LayoutFactory.createVerticalFlowLayout ());
        widget.setBorder (BorderFactory.createLineBorder ());
        widget.getActions ().addAction (ActionFactory.createMoveAction ());
//
//        LabelWidget label = new LabelWidget (scene, "Drag this to move widget");
