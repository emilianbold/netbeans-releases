...
public class DefaultOffsetable implements AsmOffsetable {
    ...
    public static AsmOffsetable create(int start, int end) {
        return new DefaultOffsetable(start, end);
    }
    
    private final int start, end;
            
    protected DefaultOffsetable(int start, int end) {
        this.start = start;
        this.end = end;
    }
    
    public DefaultOffsetable(AsmOffsetable off) {
