...
public class DefaultAsmTypesEntry implements AsmTypesEntry {

    private AsmModelProvider model;
    private List<AsmSyntaxProvider> syntaxes;
    
    public DefaultAsmTypesEntry(AsmModelProvider model, 
                                List<AsmSyntaxProvider> syntaxes) {
        this.model = model;
