 ...
 * @version
 */
public class TestGrabOutputAction extends TreeNodeAction {

    /** Creates new TestGrabOutputAction */
    public TestGrabOutputAction() {
    }

    public String getHelpCtx() {
        return "Set actual editor content as Output to actual Call action.";
    }
    ...
    public void performAction(TestNodeDelegate[] activatedNodes) {
        ...
        for(int i=0;i < activatedNodes.length;i++) {
            ...
            ((TestCallAction)(n.getTestNode())).grabOutput();
        }
    }
