...
public class GenerateTests extends Object {
    ...
    private void removeContentExceptCVS() throws IOException {
        FileObject toRemove = Repository.getDefault().findResource(masterPackage+".AppTestPerformer.java");
        
        if (toRemove != null)
            toRemove.delete();
        
        toRemove = Repository.getDefault().findResource(masterPackage+".data.goldenfiles.AppTestPerformer");
    ...
    private void generateTest(Element test, PrintWriter result) throws IOException {
        ...
        FileObject goldenDir = Repository.getDefault().findResource(masterPackage+".data.goldenfiles.AppTestPerformer");
    ...
    private void createAllTests(Element tests) throws IOException {
        ...
        FileObject testFileDir  = Repository.getDefault().findResource(masterPackage);
