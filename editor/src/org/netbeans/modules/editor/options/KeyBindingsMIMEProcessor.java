...
public class KeyBindingsMIMEProcessor extends MIMEProcessor{
    ...
    public static final String PUBLIC_ID = "-//NetBeans//DTD Editor KeyBindings settings 1.0//EN"; // NOI18N
    public static final String SYSTEM_ID = "http://www.netbeans.org/dtds/EditorKeyBindings-1_0.dtd"; // NOI18N
    ...
    public Class getAsociatedMIMEOptionFile() {
        return KeyBindingsMIMEOptionFile.class;
    }
    ...
    public MIMEOptionFile createMIMEOptionFile(BaseOptions o, Object b) {
        return new KeyBindingsMIMEOptionFile(o, b);
    }
