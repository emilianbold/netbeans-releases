 ...
 * @author Erno Mononen
 */
public class TestRecognizerHandlerTest extends TestCase {
    

    public void testAssertEqualsTestUnit() {
    ...
    public void testAssertEqualsRspec() {
        String strings = "expected \"confirmation\", got \"shonfirmation\" (using .eql?)";
        String numbers = "expected 1, got 2 (using .eql?)";
