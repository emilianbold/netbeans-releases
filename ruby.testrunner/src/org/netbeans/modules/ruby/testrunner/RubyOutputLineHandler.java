 ...
 * @author Erno Mononen
 */
final class RubyOutputLineHandler implements OutputLineHandler {

    private final LineConvertor convertor;

    public RubyOutputLineHandler(FileLocator fileLocator) {
        this.convertor = RubyLineConvertorFactory.withStandardConvertors(fileLocator).newLineConvertor();
    }
