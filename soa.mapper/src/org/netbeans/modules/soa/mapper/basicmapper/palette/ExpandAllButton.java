 ...
 * <p>
 *
 * Title: ExpandAllButton</p> <p>
 *
 * Description: ExpandAllButton provides a JButton for the palette view to
 * performs canvas expend all nodes.<p>
 *
 * <p>
 *
...
public class ExpandAllButton
     ...
     */
    public ExpandAllButton(IPaletteView paletteView) {
        mView = paletteView;
        setIcon(new ImageIcon(ExpandAllButton.class.getResource("Expand_All.png")));
        setToolTipText(NbBundle.getBundle(getClass()).getString("TOOLTIP_Palette_ExpandAll_Button"));
    ...
    public void actionPerformed(ActionEvent e) {
        if (this.isEnabled() && this.isVisible()) {
            mView.getViewManager().getCanvasView().getCanvas().expendAllNode();
        }
    }
