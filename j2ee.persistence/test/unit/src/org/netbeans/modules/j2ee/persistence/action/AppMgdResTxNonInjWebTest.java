...
/**
 * Tests for <code>ApplicationManagedResourceTransactionNonInjectableInWeb</code>, 
 * obscure name due to #122544.
 * 
 * @author Erno Mononen
 */
public class AppMgdResTxNonInjWebTest extends EntityManagerGenerationTestSupport {
    
    public AppMgdResTxNonInjWebTest(String testName) {
        super(testName);
    }
