...
public class JPQLEditorController {
    ...
    private Logger logger = Logger.getLogger(JPQLEditorController.class.getName());
...
//    }
//
//    public SessionFactory processAndConstructSessionFactory(String jpql, FileObject configFileObject,
//            ClassLoader customClassLoader, Project project) throws Exception {
//        HibernateEnvironment env = project.getLookup().lookup(HibernateEnvironment.class);
//
//        StringTokenizer jpqlTokenizer = new StringTokenizer(jpql, " \n\r\f\t(),"); //NOI18N
//        List<String> tokenList = new ArrayList<String>();
//        while (jpqlTokenizer.hasMoreTokens()) {
//            tokenList.add(jpqlTokenizer.nextToken());
//        }
//
//        // Process Mappings
...
//                for (String jpqlClassName : tokenList) {
//                    if (foundClassNameMatch(jpqlClassName, className)) {
...
//                for (String jpqlClassName : tokenList) {
//                    if (foundClassNameMatch(jpqlClassName, annotatedClassName)) {
...
//    }
//
//    private boolean foundClassNameMatch(String jpqlClassName, String className) {
//        boolean foundMatch = false;
//        if (jpqlClassName.indexOf(".") != -1) {
//            if (className.endsWith(jpqlClassName)) {
//                foundMatch = true;
//            }
//        } else {
//            if (className.indexOf(".") == -1) {
//                if (className.equals(jpqlClassName)) {
//                    foundMatch = true;
//                }
//            } else {
//                String actualClassName = className.substring(className.lastIndexOf(".") + 1);
//                if (actualClassName.equals(jpqlClassName)) {
//                    foundMatch = true;
//                }
//            }
//        }
