 ...
 * @author jpeska
 */
public class ClosedCategoryNode extends AbstractCategoryNode {

    private JPanel panel;
    private TreeLabel lblName;
    private LinkButton btnOpen;
    private final Object LOCK = new Object();
    private OpenCategoryNodeAction categoryAction;
    ...
    protected JComponent getComponent(Color foreground, Color background, boolean isSelected, boolean hasFocus, int rowWidth) {
        synchronized (LOCK) {
            if (panel == null) {
                ...
                btnOpen = new LinkButton(iconOpen, getCategoryAction());
    ...
    protected Action getCategoryAction() {
        if (categoryAction == null) {
            categoryAction = new OpenCategoryNodeAction(this);
        }
