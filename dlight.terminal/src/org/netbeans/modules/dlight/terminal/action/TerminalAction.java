...
public abstract class TerminalAction extends AbstractAction implements Presenter.Toolbar {
    ...
    public void actionPerformed(final ActionEvent e) {
        ...
        if (term != null) {
            ...
            if (env != null) {
                TerminalSupportImpl.openTerminalImpl(ioContainer, env.getDisplayName(), env, null, TerminalContainerTopComponent.SILENT_MODE_COMMAND.equals(e.getActionCommand()), 0);
            }
        }
    }
