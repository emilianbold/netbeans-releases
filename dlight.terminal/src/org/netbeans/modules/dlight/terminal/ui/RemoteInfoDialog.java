...
public final class RemoteInfoDialog extends javax.swing.JPanel {
    ...
    public RemoteInfoDialog(String user) {
        ...
        hostField.getDocument().addDocumentListener(verifier);
        userField.getDocument().addDocumentListener(verifier);
        portField.getDocument().addDocumentListener(verifier);

        btnNewHost.addItemListener(verifier);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cbKnownHosts, 0, 240, Short.MAX_VALUE))
    ...
    private class Verifier implements DocumentListener, ItemListener {

        private final InputVerifier intVerifier = new IntVerifier();
        private final InputVerifier nonEmptyVerifier = new NonEmptyVerivier();
        ...
        public void update() {
            boolean isVerified = nonEmptyVerifier.verify(userField)
                    && nonEmptyVerifier.verify(hostField)
                    && intVerifier.verify(portField);

            firePropertyChange(NotifyDescriptor.PROP_VALID, !isVerified, isVerified);
        }
        ...
        public void itemStateChanged(ItemEvent e) {
            if (e.getStateChange() == ItemEvent.SELECTED) {
                ...
                firePropertyChange(NotifyDescriptor.PROP_VALID, false, true);
            }
        }
    }
    ...
    private class NonEmptyVerivier extends InputVerifier {
