...
public abstract class CodeNamePresenter extends Presenter {
    ...
    public abstract List<String> getReservedNamesFor (String suggestedMainName);

    public static CodeNamePresenter fixed (String... names) {
        final List<String> namesList = Arrays.asList (names);
        return new CodeNamePresenter () {
