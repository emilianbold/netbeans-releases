 ...
 * @author tim
 */
public class PreupgradedAntTasksTest extends NbTestCase {
    EditableProperties pprops;
    RIPlatformFactory factory;
    File dir;
    public PreupgradedAntTasksTest(String name) {
        super(name);
    }
    ...
    protected void setUp() throws Exception {
        ...
        pprops.load(PreupgradedAntTasksTest.class.getResourceAsStream("PreupgradedAntTasks.properties"));
        clearWorkDir();
        dir = getWorkDir();
    ...
    public void testPreupgradedPlatformIsNotUpgraded() throws Exception {
        FileObject fo = factory.createPlatform();
        assertFalse (factory.antTasksUpdated);
