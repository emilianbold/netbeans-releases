 ...
 * @author avk
 */
public class LocalServerHttpWizardComponent extends WebServerHttpWizardComponent{
    
    private static final String LOCALHOST = "localhost"; //NOI18N
            
    private static Logger LOGGER = Logger.getLogger(
            LocalServerHttpWizardComponent.class.getName());

    public LocalServerHttpWizardComponent( LocalServerHttpWizardPanel panel ) {
        super(panel);
    }
