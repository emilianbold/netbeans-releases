 ...
 * @author avk
 */
public class AbsentProjectConfigProvider implements ProjectConfigProvider{

    public AbsentProjectConfigProvider(AbsentServerProvider provider ) {
        myProvider = provider;
    }
    ...
    public void configureProject(AntProjectHelper helper, WizardDescriptor descriptor) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
