 ...
 * @author avk
 */
public class FtpServerProjectCustomizerPanel extends FtpServerProjectVisual 
        implements ProjectCustomizerComponent
{
    public FtpServerProjectCustomizerPanel(EditableProperties properties) {
    ...
    protected void contextUpdated() {
        ...
        if (hostCandidate != null && hostCandidate instanceof FtpHostImpl) {
            FtpHostImpl host = (FtpHostImpl) hostCandidate;
