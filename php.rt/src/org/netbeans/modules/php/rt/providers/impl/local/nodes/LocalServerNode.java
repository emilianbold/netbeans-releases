 ...
 *
 */
public class LocalServerNode extends AbstractServerNode {


    public LocalServerNode( String name, LocalHostImpl host ) {
        super(new LocalServerNodeChildren(), name, host);
    }
    ...
    private static class LocalServerNodeChildren extends Children.Keys {

        public LocalServerNodeChildren() {
        ...
        protected Node[] createNodes(Object key) {
            if (key instanceof LocalHostImpl) {
                ...
                // web node
                Node webInfo = new WebInfoNode((LocalHostImpl) key);
                // ftp node
                Node fileInfo = new FileInfoNode((LocalHostImpl) key) {};
