...
public class ConnectionErrMessage extends javax.swing.JPanel {
    ...
    private static String createMessage(int seconds) {
        final String reason1 = "<li>"+NbBundle.getMessage(DebugCommandImpl.class, "MSG_ErrDebugSessionReason1")+"</li>";//NOI18N
        final String reason2 = "<li>"+NbBundle.getMessage(DebugCommandImpl.class, "MSG_ErrDebugSessionReason2")+"</li>";//NOI18N
        final String reasons = "<ul>"+reason1+reason2+"</ul>";       
        return "<html>"+NbBundle.getMessage(DebugCommandImpl.class, "MSG_ErrDebugSession", seconds,reasons)+"</html>";//NOI18N
    }
