...
import org.netbeans.modules.php.rt.providers.impl.nodes.AbstractServerNode;
...
import org.netbeans.modules.php.rt.ui.ServerTypeChooserCustomizerComponent;
 ...
 *
 */
public class FtpServerNode extends AbstractServerNode {

    public FtpServerNode(String name, FtpHostImpl host) {
        super(new FtpServerNodeChildren(), name, host);
        //myHost = host;
    }
            ...
            DefaultServerCustomizer parentDialog) 
    {
        ...
        if (host != null) {
            if (host instanceof FtpHostImpl) {
                ...
                return new ServerTypeChooserCustomizerComponent(impl, parentDialog);
            }
        }
        return null;
    }
    ...
    private static class FtpServerNodeChildren extends Children.Keys {

        public FtpServerNodeChildren() {
        ...
        protected Node[] createNodes(Object key) {
            if (key instanceof FtpHostImpl) {

                // web node
                Node webInfo = new WebInfoNode((FtpHostImpl) key);
                // ftp node
                Node fileInfo = new FileInfoNode((FtpHostImpl) key);
