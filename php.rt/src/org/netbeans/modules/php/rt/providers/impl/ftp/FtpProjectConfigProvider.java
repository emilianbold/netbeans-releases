 ...
 *
 */
class FtpProjectConfigProvider extends AbstractProjectConfigProvider {

    FtpProjectConfigProvider( FtpServerProvider provider ){
        myProvider = provider;
    }

    /* (non-Javadoc)
     * @see org.netbeans.modules.php.rt.spi.providers.ProjectConfigProvider#getWizardComponent(org.netbeans.modules.php.rt.spi.providers.Host)
     */
    public ProjectWizardComponent getWizardComponent( Host host ) {
        return new FtpServerProjectWizardPanel( host );
    }
     ...
     */
    public ProjectCustomizerComponent getCustomizerPanel( EditableProperties properties ) {
        return new FtpServerProjectCustomizerPanel( properties );
    }
