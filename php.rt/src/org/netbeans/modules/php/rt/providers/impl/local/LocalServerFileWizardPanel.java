 ...
 *
 */
class LocalServerFileWizardPanel extends AbstractPanel implements FinishablePanel,
    ValidatingPanel
{
    
    private static final String CONFIG_LOCAL_FILE_SERVER     
                = "LBL_ConfigLocalFileServer";               // NOI18N

    public LocalServerFileWizardPanel() {
    ...
    private LocalServerFileWizardComponent getVisual(){
        if (myVisual==null)
            myVisual = new LocalServerFileWizardComponent( this );
        return myVisual;
    }
    ...
    private void initComponent() {
         ...
         */
        getVisual().setName(NbBundle.getBundle( LocalServerFileWizardPanel.class).
                getString( CONFIG_LOCAL_FILE_SERVER  ));
    }
    
    private LocalServerFileWizardComponent myVisual;
