 ...
 */
public enum JsElements {
    EXPRESSION("Expression");

    JsElements( String name ) {
        this ( name , Expression.JS_NAMESPACE_URI);
    }

    JsElements( String name , String nsUri ) {
        myTag = name;
        myNS = nsUri;
    }
    ...
    public QName getQName() {
        if ( getNamespace() == null ) {
            return new QName(Expression.JS_NAMESPACE_URI, getName());
        }
        else {
