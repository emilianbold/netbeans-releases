 ...
 *
 */
public class FinalCounterValueImpl extends ExpressionImpl implements
        FinalCounterValue, AfterSources
{

    FinalCounterValueImpl( BpelModelImpl model, Element e ) {
        super(model, e);
    }

    FinalCounterValueImpl( BpelBuilderImpl builder ) {
        super(builder, BpelElements.FINAL_COUNTER_VALUE.getName() );
    }
