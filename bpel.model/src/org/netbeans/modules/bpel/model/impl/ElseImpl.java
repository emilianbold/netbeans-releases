 ...
 *
 */
public class ElseImpl extends ActivityHolderImpl implements Else, AfterSources {

    ElseImpl( BpelModelImpl model, Element e ) {
        super(model, e);
    }

    ElseImpl( BpelBuilderImpl builder ) {
        super(builder, BpelElements.ELSE.getName() );
    }
