 ...
 *
 */
public class RepeatEveryImpl extends ExpressionImpl
    implements RepeatEvery, AfterSources
{

    RepeatEveryImpl( BpelModelImpl model, Element e ) {
        super(model, e);
    }

    RepeatEveryImpl( BpelBuilderImpl builder ) {
        super(builder, BpelElements.REPEAT_EVERY.getName() );
    }
