...
public class DeadlineExpressionImpl extends ExpressionImpl implements
        DeadlineExpression, AfterSources
{

    DeadlineExpressionImpl( BpelModelImpl model, Element e ) {
        super(model, e);
    }

    DeadlineExpressionImpl( BpelBuilderImpl builder ) {
        super(builder, BpelElements.UNTIL.getName() );
    }
    ...
    public Class<? extends BpelEntity> getElementType() {
        return DeadlineExpression.class;
    }
