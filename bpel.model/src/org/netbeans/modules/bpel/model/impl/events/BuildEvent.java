 ...
 * @author ads
 */
public class BuildEvent<T extends BpelEntity> extends TreeCreatedEvent<T>
        implements OutOfModelEvent
{

    private static final long serialVersionUID = 2686715602277829641L;

    public BuildEvent( T outOfTree, String name ) {
        super(outOfTree, name);
    }
