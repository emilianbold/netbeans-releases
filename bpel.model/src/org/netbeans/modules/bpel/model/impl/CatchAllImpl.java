 ...
 * @author ads
 */
public class CatchAllImpl extends ActivityHolderImpl
    implements CatchAll, AfterSources 
{

    CatchAllImpl( BpelModelImpl model, Element e ) {
        super(model, e);
    }

    CatchAllImpl( BpelBuilderImpl builder ) {
        super(builder , BpelElements.CATCH_ALL.getName() );
    }
    ...
    public Class<? extends BpelEntity> getElementType() {
        return CompensatableActivityHolder.class;
    }
