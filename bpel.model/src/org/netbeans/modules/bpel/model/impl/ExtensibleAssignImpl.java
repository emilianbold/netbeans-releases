 ...
 *
 */
public class ExtensibleAssignImpl extends ExtensibleElementsImpl implements
        ExtensibleAssign, AfterSources
{
    ExtensibleAssignImpl( BpelModelImpl model, Element e ) {
        super(model, e);
    }

    ExtensibleAssignImpl( BpelBuilderImpl builder, String tagName ) {
        super(builder, BpelElements.EXTENSIBLE_ASSIGN.getName() );
    }
