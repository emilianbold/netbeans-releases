 ...
 *
 */
public class BooleanExprImpl extends ExpressionImpl
    implements BooleanExpr, AfterSources
{

    BooleanExprImpl( BpelModelImpl model, Element e ) {
        super(model, e);
    }

    BooleanExprImpl( BpelBuilderImpl builder ) {
        super(builder, BpelElements.CONDITION.getName() );
    }
