 ...
 *
 */
public class MessageExchangeImpl extends NamedElementImpl implements
        MessageExchange
{

    MessageExchangeImpl( BpelModelImpl model, Element e ) {
        super(model, e);
    }

    MessageExchangeImpl( BpelBuilderImpl builder ) {
        super(builder, BpelElements.MESSAGE_EXCHAGE.getName() );
    }
