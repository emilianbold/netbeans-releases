 ...
 *
 */
public class ExtensionImpl extends NamespaceSpecImpl implements Extension {

    ExtensionImpl( BpelModelImpl model, Element e ) {
        super(model, e);
    }


    ExtensionImpl( BpelBuilderImpl builder) {
        super(builder, BpelElements.EXTENSION.getName() );
    }


    /* (non-Javadoc)
     * @see org.netbeans.modules.soa.model.bpel20.api.Extension#getMustUnderstand()
     */
    public TBoolean getMustUnderstand() {
        return getBooleanAttribute( BpelAttributes.MUST_UNDERSTAND );
    }

    /* (non-Javadoc)
     * @see org.netbeans.modules.soa.model.bpel20.api.Extension#setMustUnderstand(org.netbeans.modules.soa.model.bpel20.api.support.TBoolean)
     */
    public void setMustUnderstand( TBoolean value ) {
        setBpelAttribute( BpelAttributes.MUST_UNDERSTAND , value );
    }
    ...
    protected Attribute[] getDomainAttributes() {
        if ( myAttributes.get() == null ){
            ...
            ret[ 0 ] = BpelAttributes.MUST_UNDERSTAND;
