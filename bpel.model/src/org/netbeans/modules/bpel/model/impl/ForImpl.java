 ...
 *
 */
public class ForImpl extends ExpressionImpl implements For, AfterSources {

    ForImpl( BpelModelImpl model, Element e ) {
        super(model, e);
    }

    ForImpl( BpelBuilderImpl builder ) {
        super(builder, BpelElements.FOR.getName() );
    }
