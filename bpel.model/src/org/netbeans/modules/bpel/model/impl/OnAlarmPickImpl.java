 ...
 *
 */
public class OnAlarmPickImpl extends ActivityHolderImpl implements
        OnAlarmPick, AfterSources
{

    OnAlarmPickImpl( BpelModelImpl model, Element e ) {
        super(model, e);
    }

    OnAlarmPickImpl( BpelBuilderImpl builder ) {
        super(builder, BpelElements.ON_ALARM_PICK.getName() );
    }
    ...
    public void setTimeEvent( TimeEvent event ) {
        setChild( event , TimeEvent.class , BpelTypesEnum.ACTIVITIES_GROUP );
    }
    ...
    /* (non-Javadoc)
     * @see org.netbeans.modules.bpel.model.impl.ActivityHolderImpl#create(org.w3c.dom.Element)
     */
    @Override
