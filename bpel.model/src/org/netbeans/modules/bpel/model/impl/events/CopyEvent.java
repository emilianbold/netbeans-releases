 ...
 * @author ads
 */
public class CopyEvent<T extends BpelEntity> extends TreeCreatedEvent<T>
        implements OutOfModelEvent
{

    private static final long serialVersionUID = 4402603138133409686L;

    public CopyEvent( T parent ) {
        super(parent);
    }
