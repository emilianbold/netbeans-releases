...
/**
 * Interface that should be implemented by each intrested on events from OM
 * participant.
 *
 * @author ads
 */
public interface ChangeEventListener extends EventListener {
     ...
     *
     * @param event Notificitaion event.
     */
    void notifyPropertyRemoved( PropertyRemoveEvent event );

    /**
     * Method is called when new entity was inserted ( may be in some position )
     * in OM.
     * 
     * @param event
     *            Notificitaion event
