...
public class FieldBreakpointTest extends DebuggerJPDAApiTestBase {
    ...
    public void testFieldBreakpoints() throws Exception {
        try {
            FieldBreakpoint fb1 = FieldBreakpoint.create(CLASS_NAME, "x", FieldBreakpoint.TYPE_MODIFICATION);
            ...
            FieldBreakpoint fb2 = FieldBreakpoint.create(CLASS_NAME, "y", FieldBreakpoint.TYPE_MODIFICATION);
            ...
            FieldBreakpoint fb3 = FieldBreakpoint.create(CLASS_NAME + "$InnerStatic", "q", FieldBreakpoint.TYPE_MODIFICATION);
            ...
            FieldBreakpoint fb4 = FieldBreakpoint.create(CLASS_NAME + "$InnerStatic", "w", FieldBreakpoint.TYPE_MODIFICATION);
            ...
            FieldBreakpoint fb5 = FieldBreakpoint.create(CLASS_NAME + "$Inner", "w", FieldBreakpoint.TYPE_MODIFICATION);
            ...
            for (;;) {
                support.waitStates(JPDADebugger.STATE_STOPPED, JPDADebugger.STATE_DISCONNECTED, 10000);
