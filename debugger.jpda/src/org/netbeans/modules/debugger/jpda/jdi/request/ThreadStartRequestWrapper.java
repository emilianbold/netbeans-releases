...
/**
 * Wrapper for ThreadStartRequest JDI class.
 ...
 */
public final class ThreadStartRequestWrapper {

    private ThreadStartRequestWrapper() {}

    // DO NOT MODIFY THIS CODE, GENERATED AUTOMATICALLY
    public static void addThreadFilter(com.sun.jdi.request.ThreadStartRequest a, com.sun.jdi.ThreadReference b) throws org.netbeans.modules.debugger.jpda.jdi.InternalExceptionWrapper, org.netbeans.modules.debugger.jpda.jdi.VMDisconnectedExceptionWrapper {
        if (org.netbeans.modules.debugger.jpda.JDIExceptionReporter.isLoggable()) {
            org.netbeans.modules.debugger.jpda.JDIExceptionReporter.logCallStart(
                    ...
                    "addThreadFilter",
                    "JDI CALL: com.sun.jdi.request.ThreadStartRequest({0}).addThreadFilter({1})",
                    new Object[] {a, b});
        }
        try {
            a.addThreadFilter(b);
