 ...
 * @author Rohan Ranade
 */
public class BeanAliasTypeDescriptor extends AbstractBeanTypeDescriptor {

    public BeanAliasTypeDescriptor(String aliasName, FileObject fileObject) {
        super(aliasName, fileObject);
    }
