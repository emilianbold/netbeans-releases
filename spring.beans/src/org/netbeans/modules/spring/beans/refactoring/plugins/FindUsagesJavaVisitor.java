...
/**
 *
 * @author Jan Becicka, // NOTE:Copied from o.n.m.refactoring.java
 */
public class FindUsagesJavaVisitor extends FindVisitor {
    ...
    public FindUsagesJavaVisitor(WorkingCopy workingCopy) {
        super(workingCopy);
    }
    ...
    public FindUsagesJavaVisitor(WorkingCopy workingCopy, boolean findInComments) {
        super(workingCopy);
    ...
    public Tree visitNewClass(NewClassTree node, Element p) {
        ...
        if (classTree != null && p.getKind()==ElementKind.CONSTRUCTOR) {
            ...
            if (anonClass==null) {
                Logger.getLogger("org.netbeans.modules.spring.beans.refactoring").severe("FindUsages cannot resolve " + classTree);
            } else {
