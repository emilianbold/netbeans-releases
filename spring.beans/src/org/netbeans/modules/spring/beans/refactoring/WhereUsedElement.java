...
import org.netbeans.modules.spring.beans.refactoring.plugins.SpringBeansRefactoringFindUsagesPlugin;
import org.netbeans.modules.spring.beans.refactoring.ui.tree.ElementGripFactory;

/**
 * 
 * @author ? , Copied from o.n.m.refactoring.java
 */
...
public class WhereUsedElement extends SimpleRefactoringElementImplementation {
    ...
    public static WhereUsedElement create(CompilationInfo compiler, TreePath tree) {
        ...
        CloneableEditorSupport ces = SpringBeansRefactoringFindUsagesPlugin.findCloneableEditorSupport(dob);
