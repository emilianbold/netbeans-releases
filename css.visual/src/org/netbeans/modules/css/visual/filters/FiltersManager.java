 ...
 * Retouche fixes back as simple as possible. <p> Handles creation and
 * manipulation with boolean state filters.
 *
 * @author Dafe Simomek
 */
public final class FiltersManager {
    ...
    /**
     * Returns true when given filter is selected, false otherwise. Note that
     * this method is thread safe, can be called from any thread (and usually
     * will, as clients will call this from loadContent naturally)
     */
