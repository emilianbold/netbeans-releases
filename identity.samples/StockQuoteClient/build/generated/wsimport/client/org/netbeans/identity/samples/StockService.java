 ...
 * 
 */
@WebServiceClient(name = "StockService", targetNamespace = "http://sun.com/stockquote.wsdl", wsdlLocation = "http://localhost:8080/StockQuoteService/StockService?wsdl")
public class StockService
    extends Service
{

    private final static URL STOCKSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(org.netbeans.identity.samples.StockService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = org.netbeans.identity.samples.StockService.class.getResource(".");
            url = new URL(baseUrl, "http://localhost:8080/StockQuoteService/StockService?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:8080/StockQuoteService/StockService?wsdl', retrying as a local file");
