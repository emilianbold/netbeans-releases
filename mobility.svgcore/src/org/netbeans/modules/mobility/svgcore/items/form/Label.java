 ...
 * @author akorostelev
 */
public class Label extends SVGFormElement{

    private static final String SNIPPET_PATH = "label_snippet.xml_template"; //NOI18N
                        
    
    public Label() {
        super(SVGComponentsSupport.ID_PREFIX_LABEL, SNIPPET_PATH);
    }
}
