 ...
 * @author akorostelev
 */
public class Spinner extends SVGFormElement{

    private static final String SNIPPET_PATH = "spinner_snippet.xml_template"; //NOI18N
    
    public Spinner() {
        super(SVGComponentsSupport.ID_PREFIX_SPINNER, SNIPPET_PATH);
    }
}
