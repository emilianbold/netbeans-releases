 ...
 * @author Pavel Benes
 */
public final class PatchedFontFace extends FontFace implements PatchedElement {
    private String    m_idBackup  = null;
    private SVGObject m_svgObject = null; 
    
    public PatchedFontFace(final DocumentNode ownerDocument) {
        super(ownerDocument);
    }
    ...
    public ElementNode newInstance(final DocumentNode doc) {
        return new PatchedFontFace(doc);
    }    
}
