 ...
 * @author Pavel Benes
 */
public final class PatchedSwitch extends Switch implements PatchedElement {
    private String    m_idBackup  = null;
    private SVGObject m_svgObject = null; 
    
    public PatchedSwitch(final DocumentNode ownerDocument) {
        super(ownerDocument);
    }
