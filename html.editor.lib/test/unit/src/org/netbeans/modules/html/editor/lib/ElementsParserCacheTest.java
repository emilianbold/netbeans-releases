 ...
 * @author marekfukala
 */
public class ElementsParserCacheTest extends NbTestCase {
    ...
    public void testCaching() {
        ...
        Object contentReference = block.blockWeakReference.get();
        ...
        assertGC("CacheBlockContent not GCed", block.blockWeakReference);
