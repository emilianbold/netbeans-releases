...
public class BindingsHandlerNameImpl extends BindingsComponentImpl implements BindingsHandlerName {
    ...
    public BindingsHandlerNameImpl(BindingsModelImpl model, Element element) {
        super(model, element);
    }

    public BindingsHandlerNameImpl(BindingsModelImpl model) {
        this(model, createPrefixedElement(BindingsQName.HANDLER_NAME.getQName(), model));
    }
    ...
    public void setHandlerName(String name) {
        setText(HANDLER_NAME_PROPERTY, name);
    }
}
