...
class IndexedEditorPanel extends javax.swing.JPanel implements ExplorerManager.Provider, PropertyChangeListener,
    ...
    private void initComponents() { //GEN-BEGIN:initComponents
        ...
        detailsButton.setText(
            org.openide.util.NbBundle.getBundle(IndexedEditorPanel.class).getString("CTL_HideDetails")
        );
        ...
        propertiesLabel.setText(
            org.openide.util.NbBundle.getBundle(IndexedEditorPanel.class).getString("CTL_Properties")
        );
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        if (detailsButton.isVisible()) {
            if (showingDetails) {
                ...
                detailsButton.setMnemonic(
                    NbBundle.getBundle(IndexedEditorPanel.class).getString("CTL_HideDetails_Mnemonic").charAt(0)
                );
                ...
                detailsButton.setText(NbBundle.getBundle(IndexedEditorPanel.class).getString("CTL_ShowDetails"));
                detailsButton.setMnemonic(
                    NbBundle.getBundle(IndexedEditorPanel.class).getString("CTL_ShowDetails_Mnemonic").charAt(0)
                );
                detailsButton.getAccessibleContext().setAccessibleDescription(
