...
class DiffFileTreeImpl extends FileTreeView<DiffNode> {
    ...
    private void setupColumns() {
        ...
        properties[0] = new ColumnDescriptor<String>(GitStatusNode.GitStatusProperty.NAME, String.class, GitStatusNode.GitStatusProperty.DISPLAY_NAME, GitStatusNode.GitStatusProperty.DESCRIPTION);
        properties[1] = new ColumnDescriptor<String>(VCSStatusNode.PathProperty.NAME, String.class, VCSStatusNode.PathProperty.DISPLAY_NAME, VCSStatusNode.PathProperty.DESCRIPTION);
    ...
    public void setSelectedNode (DiffNode toSelect) {
        super.setSelectedNode(toSelect);
    }
    ...
    private class RootNodeChildren extends DiffTreeViewChildren {
    ...
    private class NodeChildren extends DiffTreeViewChildren {
        ...
        private Node[] createNodes (List<NodeData> keys) {
            ...
            for (NodeData key : keys) {
                ...
                if (key.nestedNodes.length == 0) {
                    ...
                    node = DiffFileTreeImpl.this.createFilterNode(key.nestedNodes[0]);
                } else {
                    final String name;
                    if (top) {
                        name = key.path;
