...
public class VersioningOperator extends TopComponentOperator {
    ...
    static final String GIT_TITLE = "Git";

    /**
     * Waits for Versioning TopComponent within whole IDE.
     */
    public VersioningOperator() {
        super(waitTopComponent(null, GIT_TITLE, 0, new VersioningSubchooser()));
    }
    ...
    //*****************************************
    /**
     * Performs verification of VersioningOperator by accessing all its
     * components.
     */
    public void verify() {
        tbAll();
     ...
     * org.netbeans.modules.git.ui.status.HgVersioningTopComponent Used in
     * constructor.
     */
    private static final class VersioningSubchooser implements ComponentChooser {

        public boolean checkComponent(Component comp) {
            return comp.getClass().getName().endsWith("GitVersioningTopComponent");
        }

        public String getDescription() {
            return "org.netbeans.modules.git.ui.status.GitVersioningTopComponent";
        }
    }

    /**
     * Chooser which can be used to find a component with given tooltip, for
     * example a button.
     */
