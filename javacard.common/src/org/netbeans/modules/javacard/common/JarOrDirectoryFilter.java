...
public final class JarOrDirectoryFilter extends FileFilter {
    ...
    public boolean accept(File f) {
        //PENDING could use FileUtil.isArchiveFile(), but may be slow
        //since this really reads the file
        return f.isDirectory() || f.getName().endsWith(".jar"); //NOI18N
    }

    @Override
    public String getDescription() {
        return NbBundle.getMessage(JarOrDirectoryFilter.class, 
                "FILE_FILTER_EXTENSION_LIBRARY"); //NOI18N
    }
}
