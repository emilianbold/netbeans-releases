...
public class SuiteCustomizerSplashBrandingFactory implements ProjectCustomizer.CompositeCategoryProvider {
    ...
    public ProjectCustomizer.Category createCategory(Lookup context) {
        return ProjectCustomizer.Category.create(
                SuiteCustomizer.SPLASH_SCREEN, 
                NbBundle.getMessage(SuiteCustomizerSplashBrandingFactory.class, "LBL_SplashBranding"),
                null);
    }
    ...
    public JComponent createComponent(ProjectCustomizer.Category category, Lookup context) {
        ...
        assert props != null;
        return new SuiteCustomizerSplashBranding(props, category);
    }
