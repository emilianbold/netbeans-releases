...
public class UpdateTrackingFileOwnerQueryTest extends TestBase {
    ...
    public void testOwnershipNetBeansOrg() throws Exception {
        // Basic module:
        assertOwnership("ant", "nbbuild/netbeans/ide8/modules/org-apache-tools-ant-module.jar");
        // Explicitly listed additions:
        assertOwnership("ant", "nbbuild/netbeans/ide8/ant/nblib/bridge.jar");
        // Pattern matches (here "ant/lib/"):
        assertTrue("ant module built (cannot scan by pattern unless files exist)", file("nbbuild/netbeans/ide8/ant/lib/ant.jar").isFile());
        assertOwnership("ant", "nbbuild/netbeans/ide8/ant/lib/ant.jar");
