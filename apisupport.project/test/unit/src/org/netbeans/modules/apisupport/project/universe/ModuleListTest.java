...
public class ModuleListTest extends TestBase {
    ...
    public void testParseProperties() throws Exception {
        ...
        assertEquals(file("nbbuild/netbeans/ide8"), PropertyUtils.resolveFile(basedir, eval.getProperty("cluster")));
    ...
    public void testNetBeansOrgEntries() throws Exception {
        ...
        assertEquals("right jarLocation", file("nbbuild/netbeans/ide8/modules/org-netbeans-modules-java-project.jar"), e.getJarLocation());
        ...
        assertTrue("same by other random file", ModuleList.getKnownEntries(file("nbbuild/netbeans/ide8/config/Modules/org-netbeans-modules-java-project.xml")).contains(e));
        ...
        assertEquals("right jarLocation", file("nbbuild/netbeans/platform7/core/org-openide-filesystems.jar"), e.getJarLocation());
        ...
        assertEquals("correct CP extensions (using runtime-relative-path)",
            ":" + file("nbbuild/netbeans/ide8/modules/ext/org-netbeans-tax.jar"),
            e.getClassPathExtensions());
    ...
    public void testExternalEntries() throws Exception {
        ...
        assertEquals("correct CP exts for a nb.org module (using Class-Path only)",
            ":" + file("nbbuild/netbeans/ide8/modules/ext/xerces-2.6.2.jar") + ":" + file("nbbuild/netbeans/ide8/modules/ext/xml-commons-dom-ranges-1.0.b2.jar"),
            e.getClassPathExtensions());
        ...
        assertEquals("and correct JAR location", file("nbbuild/netbeans/ide8/modules/org-netbeans-libs-xerces.jar"), e.getJarLocation());
