...
public class EditableManifestTest extends NbTestCase {
    ...
    public void testReadGeneral() throws Exception {
        ...
        assertEquals(new HashSet(Arrays.asList(new String[] {"Foo", "Bar"})), m.getAttributeNames(null));
        ...
        assertEquals("val1", m.getAttribute("foo", null));
        assertEquals("val2", m.getAttribute("bar", null));
        assertEquals(new HashSet(Arrays.asList(new String[] {"something.class", "other.class"})), m.getSectionNames());
        ...
        assertEquals(new HashSet(Arrays.asList(new String[] {"Foo", "Baz"})), m.getAttributeNames(null));
