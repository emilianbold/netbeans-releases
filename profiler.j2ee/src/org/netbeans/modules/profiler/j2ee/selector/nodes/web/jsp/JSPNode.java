...
public class JSPNode extends SelectorNode {
    ...
    public static final Comparator<JSPNode> COMPARATOR = new Comparator<JSPNode>() {
        public int compare(JSPNode o1, JSPNode o2) {
    ...
    private final SourceCodeSelection rootMethod;
    ...
    public Collection<SourceCodeSelection> getRootMethods(boolean all) {
        Collection<SourceCodeSelection> methods = new ArrayList<SourceCodeSelection>();

        if (all || isFullyChecked()) {
            methods.add(rootMethod);
        }
    ...
    public boolean equals(Object otherJsp) {
        ...
        if (!(otherJsp instanceof JSPNode)) {
            return false;
        }

        JSPNode aJsp = (JSPNode) otherJsp;
