 ...
 */
public class FetchCurrentBranchAction extends ContextAction {
    @Override
    ...
    protected String getBaseName(Node[] nodes) {
        return "CTL_MenuItem_FetchBranchLocal"; //NOI18N
    }
    ...
    public String getName(String role, Node[] activatedNodes) {
        ...
        String name = roots.size() == 1 ? "CTL_MenuItem_FetchBranchRoot" : "CTL_MenuItem_FetchBranchLocal"; //NOI18N
        return roots.size() == 1 ? NbBundle.getMessage(FetchCurrentBranchAction.class, name, roots.iterator().next().getName()) : NbBundle.getMessage(FetchAction.class, name);
    }

    @Override
    @NbBundle.Messages({
        "# {0} - branch name", "MSG_FETCH_BRANCH_PROGRESS=Fetching to {0}..."
    })
