...
public class VersioningOperator extends TopComponentOperator {
    ...
    static final String MERCURIAL_TITLE = "Mercurial";
    
    /** Waits for Versioning TopComponent within whole IDE. */
    public VersioningOperator() {
        super(waitTopComponent(null, MERCURIAL_TITLE, 0, new VersioningSubchooser()));
    }
    
    /** Invokes Versioning main menu item and returns new instance of
     * VersioningOperator.
    ...
    public static VersioningOperator invoke() {
        ...
        String versioningItem = "Mercurial";
        new Action("Window|" + VERSIONING_TITLE + "|" + versioningItem, null).perform();
     ...
     * org.netbeans.modules.mercurial.ui.status.HgVersioningTopComponent
     * Used in constructor.
     */
    private static final class VersioningSubchooser implements ComponentChooser {
        public boolean checkComponent(Component comp) {
            return comp.getClass().getName().endsWith("HgVersioningTopComponent");
        }
        
        public String getDescription() {
            return "org.netbeans.modules.mercurial.ui.status.HgVersioningTopComponent";
        }
    }
