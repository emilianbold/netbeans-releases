 ...
 */
public class MercurvialFileSystemTestStat extends MercurialFileSystemTest {

    public MercurvialFileSystemTestStat(Test test) {
        super(test);
    }
    ...
    public static Test suite() {
        ...
        return new MercurvialFileSystemTestStat(suite);
    }
}
