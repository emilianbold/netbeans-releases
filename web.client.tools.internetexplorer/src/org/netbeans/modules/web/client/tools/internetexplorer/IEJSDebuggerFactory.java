...
public class IEJSDebuggerFactory implements JSDebuggerFactory {
    ...
    public boolean supports(Factory factory) {
        if (factory.getClass().getName().equals("org.netbeans.modules.extbrowser.IExplorerBrowser")) { // NOI18N
            return IEExtensionManager.checkRequiredComponents(factory);
        }
        return false;
    }

    public JSDebugger startDebugging(Factory browser, URI uri) {
        JSDebugger ieJSDebugger = new IEJSDebugger(uri, browser);
        return ieJSDebugger;
    }
