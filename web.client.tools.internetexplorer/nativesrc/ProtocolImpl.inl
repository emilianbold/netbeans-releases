    ...
    LPVOID* ppv, DWORD_PTR dw, IUnknown* punkTarget)
{
    ...
    if (SUCCEEDED(hr))
    {
        //Commented out per suggestion on how to fix VS2005 Crash:
        //http://www.newsgroups-index.com/group/microsoft_-public_-inetsdk_-programming_-urlmonikers_l13.html
