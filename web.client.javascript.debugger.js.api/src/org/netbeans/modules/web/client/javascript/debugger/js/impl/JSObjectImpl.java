...
public class JSObjectImpl extends JSValueImpl implements JSObject {
    ...
    JSObjectImpl(JSCallStackFrameImpl callStackFrame, String fullName, String className) {
        this(callStackFrame, fullName, JSValue.TypeOf.OBJECT, className);
    }

    protected JSObjectImpl(JSCallStackFrameImpl callStackFrame, String fullName, 
            JSValue.TypeOf typeOf, String className) {
    ...
    public JSProperty[] getProperties() {
        if(properties == null) {
            properties = getJSDebugger().getProperties(getCallStackFrame(), getFullName());
        }
        return properties;
    }
    ...
    public void setProperties(JSProperty[] properties) {
