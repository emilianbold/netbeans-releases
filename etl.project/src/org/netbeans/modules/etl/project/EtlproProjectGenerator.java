...
public class EtlproProjectGenerator {
    ...
    private static final String DEFAULT_SRC_FOLDER = "collaborations"; //NOI18N
    ...
    private static final String DEFAULT_DATA_DIR = "data"; //NOI18N
    private static final String DEFAULT_DATABASES_DIR = "databases"; //NOI18N
    ...
    public static AntProjectHelper createProject(File dir, String name, String j2eeLevel) throws IOException {
        ...
        databases = new File(fo.getPath() + "\\" + DEFAULT_NBPROJECT_DIR + "\\" + "private" + "\\" + DEFAULT_DATABASES_DIR);
...
//        ep.setProperty(IcanproProjectProperties.J2EE_SERVER_TYPE, deployment.getServerID (serverInstanceID));
    ...
    private static void createDefaultDatabase(String name) {
        String url = DEFAULT_FLATFILE_JDBC_URL_PREFIX + "Default" + ":" + name + "\\" + "Default";
        File f = new File(name + "\\" + "Default");
