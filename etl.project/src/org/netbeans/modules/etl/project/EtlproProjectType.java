...
public class EtlproProjectType implements AntBasedProjectType {
    ...
    public static final String PROJECT_CONFIGURATION_NAMESPACE = "http://www.netbeans.org/ns/j2ee-etlpro/1";
    public static final String PRIVATE_CONFIGURATION_NAME = "data";
    public static final String PRIVATE_CONFIGURATION_NAMESPACE = "http://www.netbeans.org/ns/j2ee-etlpro-private/1";
    
    
    public EtlproProjectType() {
        int i = 0;
    }
    ...
    public Project createProject(AntProjectHelper helper) throws IOException {
        ...
        return new EtlproProject(helper);
    }
