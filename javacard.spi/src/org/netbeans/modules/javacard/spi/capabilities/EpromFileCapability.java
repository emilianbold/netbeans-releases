...
/**
 * Capability interface for cards, which indicates that eprom data is
 * stored as a file on disk (or somewhere - the returned FileObject could
 * be in a virtual filesystem), where it might be read,
