...
/**
 * An interface that is required to be available in as a capability of any
...
public interface CapabilitiesProvider extends ICardCapability {
     ...
     *
     * @return A set of types which may, in some states, be found as
     * capabilities of this card.  Note that the return value of this method
     * should not change over the lifetime of this card, and may only be
     * checked once.
     */
