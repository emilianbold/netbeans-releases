...
/**
 * Provides services that enable the interactive APDU console to be used with
...
public interface ApduSupport extends ICardCapability {
    ...
    /**
     * The main URL for managing this card over Http.
     * @return The URL
     */
    public String getURL();
    /**
     * The card manager URL for managing this card over Http.  May be null.
     * @return The URL
     */
    public String getManagerURL();

    /**
     * Get the URL which can be sent to list card contents (instances, etc.),
     * if any.  May return null.
     * @return The URL for listing card contents
     */
