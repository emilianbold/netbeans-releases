...
/**
 * Object which should be found in the lookup of JavaCard devices,
 * if any customization is possible.
 *
 * This class is used to provide a customizer, so that the Manage Devices
 * dialog can control when data is actually written back (i.e. if there
