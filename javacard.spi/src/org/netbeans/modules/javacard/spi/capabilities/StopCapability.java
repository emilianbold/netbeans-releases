...
/**
 * Ability to stop a running Card.  This interface should be found as a
 * capability of Card instances which support being stopped (i.e. stopping
 * an emulator process).  May be omitted in cases where that does not make
...
public interface StopCapability extends ICardCapability {
    /**
     * Stop the running card instance.
