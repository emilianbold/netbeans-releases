...
/**
 * Ability to resume a card in its previous state.  Should be present as a
 * Capability of any Card that is capable of being restarted (in the RI,
...
public interface ResumeCapability extends ICardCapability {
    /**
     * Instruct the card to resume running in its previous state
     * @return A Condition object.  This method should return immediately.
     * If the caller wishes to wait for the Card to achieve a running state, it
