...
public class JavaTestCreatorConfigurationProvider extends TestCreatorConfigurationProvider {
    ...
    @Override
    public Component getConfigurationPanel(TestCreatorConfigurationProvider.Context context) {
        initBundle();
        JPanel jpCodeGen;
        try {
