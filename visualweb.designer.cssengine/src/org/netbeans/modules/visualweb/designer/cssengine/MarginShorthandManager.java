...
/**
 * Represents the "margin" shorthand property for setting
...
public class MarginShorthandManager
    ...
    public void setValues(CSSEngine eng,
        ...
        if (second == null) {
            ...
            ph.property(CssConstants.CSS_MARGIN_LEFT_PROPERTY,
                        first, imp);
            ph.property(CssConstants.CSS_MARGIN_RIGHT_PROPERTY,
                        first, imp);
            ph.property(CssConstants.CSS_MARGIN_TOP_PROPERTY,
                        first, imp);
            ph.property(CssConstants.CSS_MARGIN_BOTTOM_PROPERTY,
                        first, imp);
        } else {
