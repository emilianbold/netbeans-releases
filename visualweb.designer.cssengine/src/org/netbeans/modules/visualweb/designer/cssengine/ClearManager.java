...
/**
 * This class provides a manager for the "clear" CSS property
 *
 * @author Tor Norbye
 */
public class ClearManager extends IdentifierManager {
    ...
    static {
        ...
        values.put(CssConstants.CSS_BOTH_VALUE,
                   CssValueConstants.BOTH_VALUE);
    }
    ...
    public String getPropertyName() {
        return CssConstants.CSS_CLEAR_PROPERTY;
    }
