...
/**
 * Represents the "border-color" shorthand property for setting
 * border-left-color, border-right-color, border-top-color and
 * border-bottom-color.
 *
 * @author Tor Norbye
 */
public class BorderColorShorthandManager
    extends AbstractValueFactory
    implements ShorthandManager {

    public String getPropertyName() {
        return CssConstants.CSS_BORDER_COLOR_PROPERTY;
    }
    ...
    public void setValues(CSSEngine eng,
        ...
        if (second == null) {
            ...
            ph.property(CssConstants.CSS_BORDER_LEFT_COLOR_PROPERTY,
                        first, imp);
            ph.property(CssConstants.CSS_BORDER_RIGHT_COLOR_PROPERTY,
                        first, imp);
            ph.property(CssConstants.CSS_BORDER_TOP_COLOR_PROPERTY,
                        first, imp);
            ph.property(CssConstants.CSS_BORDER_BOTTOM_COLOR_PROPERTY,
                        first, imp);
        } else {
