 ...
 * @author radval
 */
public class ExternalTablePollingStreamOperatorComponentImpl extends OperatorComponentImpl implements  ExternalTablePollingStreamOperatorComponent {

    public ExternalTablePollingStreamOperatorComponentImpl(IEPModel model,  Element e) {
        super(model, e);
    }

    public ExternalTablePollingStreamOperatorComponentImpl(IEPModel model) {
        super(model);
    }
