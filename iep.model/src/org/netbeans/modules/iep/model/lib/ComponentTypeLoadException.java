 ...
 * @author Bing Lu
 */
public class ComponentTypeLoadException
     ...
     */
    public ComponentTypeLoadException(String keyName, String bundleName,
                                Object[] params) {
     ...
     *        rethrown.
     */
    public ComponentTypeLoadException(I18nException original) {
        super(original);
    }
}
