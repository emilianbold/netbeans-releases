...
public class ModuleJarAccessibilityQueryImpl implements AccessibilityQueryImplementation {
    private static final Logger LOG = Logger.getLogger(ModuleJarAccessibilityQueryImpl.class.getName());

    private final WeakHashMap<FileObject, List<Pattern>> cache = new WeakHashMap<FileObject, List<Pattern>>();
    private final List<Pattern> NOT_MODULE = new ArrayList<Pattern>();
