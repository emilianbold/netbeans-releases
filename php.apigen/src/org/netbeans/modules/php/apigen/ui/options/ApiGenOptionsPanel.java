...
@OptionsPanelController.Keywords(keywords={"php apigen phpdoc phpdocumentor", "#ApiGenOptionsPanel.keywords.documentation"}, location=UiUtils.OPTIONS_PATH, index=5)
