 ...
 */
public class ThrowsParsedLine implements AnnotationParsedLine {
    private final Map<OffsetRange, String> types;
    private final String description;

    public ThrowsParsedLine(final String description, final Map<OffsetRange, String> types) {
    ...
    public String getName() {
        return ThrowsLineParser.ANNOTATION_NAME;
    }
