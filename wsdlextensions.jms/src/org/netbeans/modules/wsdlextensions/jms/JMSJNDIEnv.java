 ...
 * JMSJNDIEnv
 */
public interface JMSJNDIEnv extends JMSComponent {

    public static final String ELEMENT_JMSJNDIENV = "jndienv";

    /**
     * Gets the collection of jndienventry
     * @return The mapf of JMSOption elements
     */
