 ...
 * @author  jalmero
 */
public class InboundOneWayMainPanel extends javax.swing.JPanel {

    private InboundOneWayMessagePanel mInboundPanel = null;
    private InboundOneWayConsumerPanel mConsumerPanel = null;
    ...
    public InboundOneWayMainPanel(WSDLComponent component) {
    ...
    public void populateView(WSDLComponent component) {
        ...
        if (mConsumerPanel != null) {
            mConsumerPanel.populateView(null, component);                    
        }     
   ...
   void setProject(Project project) {
    ...
    public InboundOneWayConsumerPanel getConsumerPanel() {
        return mConsumerPanel;
    }
    ...
    void setOperationName(String opName) {
        ...
        if (mConsumerPanel != null) {
            mConsumerPanel.setOperationName(opName);
        }   
    ...
    public FileError validateMe(boolean fireEvent) {    
        ...
        if (ExtensibilityElementConfigurationEditorComponent.
            ...
            fileError = mConsumerPanel.validateMe(fireEvent); 
        }
        return fileError;           
    }     
    ...
    private void initCustomComponents() {
        ...
        mConsumerPanel = new InboundOneWayConsumerPanel(mQName, mComponent);
        ...
        jTabbedPane1.addTab(NbBundle.getMessage(InboundOneWayMainPanel.class,
                "InboundMessageConsumerStepWizardPanel.TitleLabel"), mConsumerPanel);
        jTabbedPane1.addTab(NbBundle.getMessage(InboundOneWayMainPanel.class,
