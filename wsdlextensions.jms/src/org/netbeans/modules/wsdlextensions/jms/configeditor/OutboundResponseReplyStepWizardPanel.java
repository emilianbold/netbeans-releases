...
public class OutboundResponseReplyStepWizardPanel extends WSDLWizardDescriptorPanel {
     ...
     */
    OutboundResponseReplyPersistenceController mController = null;
    
    public OutboundResponseReplyStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }
     ...
     */
    private OutboundResponseReplyPanel mPanel;
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new OutboundResponseReplyPanel(mQName, mComponent);
        }

        mPanel.setProject(mProject);
        
        if (mController == null) {
            mController = new OutboundResponseReplyPersistenceController(mComponent, mPanel);
        }
    ...
    public String getName() {
        return NbBundle.getMessage(InboundMessageStepWizardPanel.class,
                "OutboundResponseReplyStepWizardPanel.StepLabel");
    }
