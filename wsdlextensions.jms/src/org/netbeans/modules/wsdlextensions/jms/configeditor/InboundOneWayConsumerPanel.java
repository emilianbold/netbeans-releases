 ...
 * @author  jalmero
 */
public class InboundOneWayConsumerPanel extends javax.swing.JPanel {
    ...
    private static final Logger mLogger = Logger.
            getLogger(InboundOneWayConsumerPanel.class.getName());
    ...
    public InboundOneWayConsumerPanel(QName qName, WSDLComponent component) {
        mQName = qName;
    ...
    public void populateView(QName qName, WSDLComponent component) {
        ...
        destinationPanel.populateView(qName, component);
        destinationPanel.setDescriptionPanel(descPanel);       
        //initListeners();
    }
...
//        }
    ...
    String getDestinationType() {
        return destinationPanel.getDestinationType();
    }
    ...
    String getTransaction() {
        return destinationPanel.getTransaction();
    }
     ...
     */
    String getClientID() {
        return trimTextFieldInput(destinationPanel.getClientID());
    }   
    ...
    String getSubscriptionName() {
        return trimTextFieldInput(destinationPanel.getSubscriptionName());
    }

    String getSubscriptionDurability() {
        return trimTextFieldInput(destinationPanel.getSubscriptionDurability());
    }   
    
    void setProject(Project project) {
        mProject = project;
        if (consumerPanel != null) {
            consumerPanel.setProject(project);
        }
    }
    ...
    void setOperationName(String opName) {
        if (opName != null) {
            ...
            if (destinationPanel != null) {
                destinationPanel.setOperationName(opName);
            }            
        }
    }
    ...
    private void initCustomComponents() {
        destinationPanel = new JMSDestinationPanel(mQName, mComponent);        
        ...
        inputMessagesPanelTab.add(destinationPanel, gridBagConstraints);        

        consumerPanel = new JMSConsumerPanel(mQName, mComponent);        
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jndiLabel, org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.jndiLabel.text")); // NOI18N
        jndiLabel.setName("jndiLabel"); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(connectionFactoryNameLab, org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.connectionFactoryNameLab.text")); // NOI18N
        connectionFactoryNameLab.setName("connectionFactoryNameLab"); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(initialContextFactoryLab, org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.initialContextFactoryLab.text")); // NOI18N
        initialContextFactoryLab.setName("initialContextFactoryLab"); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(providerURLLab, org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.providerURLLab.text")); // NOI18N
        providerURLLab.setName("providerURLLab"); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(securityPrincipalLab, org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.securityPrincipalLab.text")); // NOI18N
        securityPrincipalLab.setName("securityPrincipalLab"); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(securityCredentialLab, org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.securityCredentialLab.text")); // NOI18N
        securityCredentialLab.setName("securityCredentialLab"); // NOI18N

        securityCrendentialsTextField.setText(org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.securityCrendentialsTextField.text")); // NOI18N
        securityCrendentialsTextField.setName("securityCrendentialsTextField"); // NOI18N

        securityPrincipalTextField.setText(org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.securityPrincipalTextField.text")); // NOI18N
        securityPrincipalTextField.setName("securityPrincipalTextField"); // NOI18N

        providerURLTextField.setText(org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.providerURLTextField.text")); // NOI18N
        providerURLTextField.setName("providerURLTextField"); // NOI18N

        initialContextFactoryTextField.setText(org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.initialContextFactoryTextField.text")); // NOI18N
        ...
        connectionFactoryNameTextField.setText(org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.connectionFactoryNameTextField.text")); // NOI18N
        ...
        jTextField1.setText(org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.jTextField1.text_1")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel26, org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.jLabel26.text")); // NOI18N
        jLabel26.setName("jLabel26"); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(portTypeLabel, org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.portTypeLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel42, org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.jLabel42.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(operationNameLabel, org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.operationNameLabel.text_1")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(bindingNameLabel, org.openide.util.NbBundle.getMessage(InboundOneWayConsumerPanel.class, "InboundOneWayConsumerPanel.bindingNameLabel.text")); // NOI18N
...
// TODO add your handling code here:
    if (evt.getStateChange() == java.awt.event.ItemEvent.SELECTED) {
        ...
        if (mComponent != null)  {
            ...
            if (binding != null) {
                mInputJMSMessage = getInputJMSMessage(binding,
                        selectedOperation);
                updateInputMessageView(mInputJMSMessage);
            }
        }
    }
...
//                outputTimestampPartComboBox.addItem(partName);
   ...
   public FileError validateMe() {
    ...
    public FileError validateMe(boolean fireEvent) {  
        ...
        FileError fileError = destinationPanel.validateMe(fireEvent);
        if (ExtensibilityElementConfigurationEditorComponent.
            ...
            fileError = consumerPanel.validateMe();                                  
        }
