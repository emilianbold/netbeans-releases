...
public class InboundResponseMessageConsumerStepWizardPanel extends WSDLWizardDescriptorPanel {
     ...
     */
    InboundRequestResponsePersistenceController mController = null;
    
    /**
     * The visual component that displays this panel. If you need to access the
     * component from this class, just use getComponent().
     */
    private InboundResponseMessageConsumerPanel mPanel;
    
    public InboundResponseMessageConsumerStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new InboundResponseMessageConsumerPanel(mQName, mComponent);
        }

        if (mController == null) {
            mController = new InboundRequestResponsePersistenceController(mComponent, mPanel);
        }
    ...
    public String getName() {
        return NbBundle.getMessage(InboundMessageStepWizardPanel.class,
                "InboundResponseMessageConsumerStepWizardPanel.StepLabel");
    }
