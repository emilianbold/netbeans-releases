...
public class InboundMessageConsumerStepWizardPanel 
     ...
     */
    InboundConsumerPersistenceController mController = null;
    ...
    public InboundMessageConsumerStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }
     ...
     */
    private InboundOneWayConsumerPanel mPanel;
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new InboundOneWayConsumerPanel(mQName, mComponent);
        }
        mPanel.setProject(mProject);
        if (mController == null) {
            mController = new InboundConsumerPersistenceController(mComponent, mPanel);
        }
    ...
    public void readSettings(Object settings) {
       ...
       if ((myContext != null) && (myContext.getWSDLModel() != null)) {
           ...
           if (mComponent != null) {
               mPortType = JMSUtilities.getPortType((JMSAddress) mComponent);
           }
       }        
    }
    ...
    public String getName() {
        return NbBundle.getMessage(InboundMessageStepWizardPanel.class,
                "InboundMessageConsumerStepWizardPanel.StepLabel");
    }
