    ...
    public static String popupJndiBrowserDialog(Project project, Category browseCategory) {
        ...
        try {
            ...
            if (serverInstanceDisplayName == null || serverInstanceDisplayName.equals("")) {
                NotifyDescriptor d = new NotifyDescriptor.Message(java.util.ResourceBundle.getBundle("org/netbeans/modules/wsdlextensions.jms/configeditor/Bundle").getString("Unable_to_determine_server_instance"));
            ...
            if (serverNode == null) {
                NotifyDescriptor d = new NotifyDescriptor.Message(java.util.ResourceBundle.getBundle("org/netbeans/modules/wsdlextensions.jms/configeditor/Bundle").getString("Unable_to_locate_Server_Node"));
                DialogDisplayer.getDefault().notify(d);
                return null;
            }
            ...
            final DialogDescriptor d = new DialogDescriptor(
                    ...
                    java.util.ResourceBundle.getBundle("org/netbeans/modules/wsdlextensions.jms/configeditor/Bundle").getString("Choose_JNDI_name_of_Connector_Resource"),  // title
                    true,  // modal
