 ...
 * @author jalmero
 */
public class InboundOneWayMainConfigurationEditorComponent
        implements ExtensibilityElementConfigurationEditorComponent {

    private InboundOneWayMainPanel editorPanel = null;
    private WSDLComponent component;
    private QName mQName;
  
    private InboundPersistenceController mInController = null;
    private InboundConsumerPersistenceController mConsumerController = null;
    
    public InboundOneWayMainConfigurationEditorComponent(QName qName,
            WSDLComponent component) {
        if (editorPanel == null) {
            editorPanel = new InboundOneWayMainPanel(component);
        } else {
        ...
        if (mConsumerController == null) {
            mConsumerController = new 
                    InboundConsumerPersistenceController(component,
                    editorPanel.getConsumerPanel());        
        }        
    ...
    public String getTitle() {
        return NbBundle.getMessage(InboundOneWayMainConfigurationEditorComponent.class,
    ...
    public boolean commit() {
        ...
        if (status) {
            status = mConsumerController.commit();
        }
        return status;
    }
