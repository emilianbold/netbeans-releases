...
public class SynchronousStepWizardPanel extends WSDLWizardDescriptorPanel {
     ...
     */
    SynchronousReadConsumerPersistenceController mController = null;
    
    public SynchronousStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }
     ...
     */
    private SynchronousReadPanel mPanel;
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new SynchronousReadPanel(mQName, mComponent);
        }

        if (mController == null) {
            mController = new SynchronousReadConsumerPersistenceController(mComponent, mPanel);
        }
    ...
    public String getName() {
        return NbBundle.getMessage(InboundMessageStepWizardPanel.class,
                "InboundMessageStepWizardPanel.StepLabel");
    }
