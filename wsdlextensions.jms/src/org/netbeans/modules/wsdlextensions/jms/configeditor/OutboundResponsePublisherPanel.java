 ...
 * @author  jalmero
 */
public class OutboundResponsePublisherPanel extends javax.swing.JPanel {
    ...
    private static final Logger mLogger = Logger.
            getLogger(OutboundResponsePublisherPanel.class.getName());
    ...
    public OutboundResponsePublisherPanel(QName qName, WSDLComponent component) {
        initComponents();
    ...
    public void populateView(QName qName, WSDLComponent component) {
        ...
        publisherPanel.populateView(qName, component);
        //initListeners();
    }
...
//        }
  ...
  /**
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jndiLabel, org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.jndiLabel.text")); // NOI18N
        jndiLabel.setName("jndiLabel"); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(connectionFactoryNameLab, org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.connectionFactoryNameLab.text")); // NOI18N
        connectionFactoryNameLab.setName("connectionFactoryNameLab"); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(initialContextFactoryLab, org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.initialContextFactoryLab.text")); // NOI18N
        initialContextFactoryLab.setName("initialContextFactoryLab"); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(providerURLLab, org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.providerURLLab.text")); // NOI18N
        providerURLLab.setName("providerURLLab"); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(securityPrincipalLab, org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.securityPrincipalLab.text")); // NOI18N
        securityPrincipalLab.setName("securityPrincipalLab"); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(securityCredentialLab, org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.securityCredentialLab.text")); // NOI18N
        securityCredentialLab.setName("securityCredentialLab"); // NOI18N

        securityCrendentialsTextField.setText(org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.securityCrendentialsTextField.text")); // NOI18N
        securityCrendentialsTextField.setName("securityCrendentialsTextField"); // NOI18N

        securityPrincipalTextField.setText(org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.securityPrincipalTextField.text")); // NOI18N
        securityPrincipalTextField.setName("securityPrincipalTextField"); // NOI18N

        providerURLTextField.setText(org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.providerURLTextField.text")); // NOI18N
        providerURLTextField.setName("providerURLTextField"); // NOI18N

        initialContextFactoryTextField.setText(org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.initialContextFactoryTextField.text")); // NOI18N
        ...
        connectionFactoryNameTextField.setText(org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.connectionFactoryNameTextField.text")); // NOI18N
        ...
        jTextField1.setText(org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.jTextField1.text_1")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel26, org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.jLabel26.text")); // NOI18N
        jLabel26.setName("jLabel26"); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(portTypeLabel, org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.portTypeLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel42, org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.jLabel42.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(operationNameLabel, org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.operationNameLabel.text_1")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(bindingNameLabel, org.openide.util.NbBundle.getMessage(OutboundResponsePublisherPanel.class, "OutboundResponsePublisherPanel.bindingNameLabel.text")); // NOI18N
...
// TODO, if already defined, what to do???            
...
//        outputEncodingStyleTextField.setEnabled(outputEncodingRBtn.isSelected());
    ...
    private Part createPart(Message msg, String name) {
        WSDLModel model = mComponent.getModel();
        Part newPart = null;
        try {
            model.startTransaction();
            newPart = model.getFactory().createPart();
            newPart.setName(name);
            // need to set type still
            msg.addPart(newPart);
        } finally {
