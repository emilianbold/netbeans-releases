...
public class OutboundOneWayPublisherStepWizardPanel extends WSDLWizardDescriptorPanel {
    ...
    public OutboundOneWayPublisherStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }    
    ...
    public Component getComponent() {
        if (component == null) {            
            component = new OutboundOneWayPublisherPanel(mQName, mComponent);
        }
        
        if (mController == null) {
            mController = new OutboundInPersistenceController(mComponent, 
                    (OutboundOneWayPublisherPanel) component);
        }
    ...
    public String getName() {
        return NbBundle.getMessage(OutboundOneWayPublisherStepWizardPanel.class,
                "OutboundOneWayPublisherStepWizardPanel.StepLabel");        
    }
