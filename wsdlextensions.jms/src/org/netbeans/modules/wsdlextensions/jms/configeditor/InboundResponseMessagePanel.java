 ...
 * @author  jalmero
 */
public class InboundResponseMessagePanel extends javax.swing.JPanel {
    ...
    private static final Logger mLogger = Logger.
            getLogger(InboundResponseMessagePanel.class.getName());
    ...
    public InboundResponseMessagePanel(QName qName, WSDLComponent component) {
...
//        return (String) outputTypeComboBox.getSelectedItem();
  ...
  /**
     ...
     */
    String getClientID() {
        return destinationPanel.getClientID();
    }   
    ...
    String getSubscriptionName() {
        return destinationPanel.getSubscriptionName();
    }

    String getSubscriptionDurability() {
        return destinationPanel.getSubscriptionDurability();
    }     
   ...
   void setProject(Project project) {
    ...
    private void initCustomComponents() {
        destinationPanel = new JMSDestinationPanel(null, null); 
        ...
        generalPanel.add(destinationPanel, gridBagConstraints);        
        
        mMessageTypePanel = new MessageTypePanel(mWsdlComponent, null, 
                null, null, false);
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel26, org.openide.util.NbBundle.getMessage(InboundResponseMessagePanel.class, "InboundResponseMessagePanel.jLabel26.text")); // NOI18N
        jLabel26.setName("jLabel26"); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(portTypeLabel, org.openide.util.NbBundle.getMessage(InboundResponseMessagePanel.class, "InboundResponseMessagePanel.portTypeLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel42, org.openide.util.NbBundle.getMessage(InboundResponseMessagePanel.class, "InboundResponseMessagePanel.jLabel42.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(operationNameLabel, org.openide.util.NbBundle.getMessage(InboundResponseMessagePanel.class, "InboundResponseMessagePanel.operationNameLabel.text_1")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(bindingNameLabel, org.openide.util.NbBundle.getMessage(InboundResponseMessagePanel.class, "InboundResponseMessagePanel.bindingNameLabel.text")); // NOI18N
...
// TODO add your handling code here:
    if (evt.getStateChange() == java.awt.event.ItemEvent.SELECTED) {
        ...
        if (mWsdlComponent != null)  {
            ...
            if (binding != null) {
                JMSMessage inputMessage = getOutputJMSMessage(binding,
                        selectedOperation);
...
//        outputTypeComboBox.addItem(JMSConstants.MESSAGE_MESSAGE);
    ...
    public void populateView(QName qName, WSDLComponent component) {
        ...
        destinationPanel.populateView(mQName, mWsdlComponent);
...
//        updateServiceView(jmsAddress);
    ...
    private void updateOutputMessageView(Binding binding, JMSMessage outputMessage) {
        if (outputMessage != null) {

            outputTypeComboBox.setSelectedItem(outputMessage.getMessageType());
            outputTextComboBox.setSelectedItem(outputMessage.getTextPart());

//            if (outputMessage.getUse() != null) {
//                if (outputMessage.getUse().equals(JMSConstants.ENCODED)) {
...
//                    outputMessage.getJMSEncodingStyle());
            
            String part = null;
            if (JMSConstants.BYTES_MESSAGE.equals(outputMessage.getMessageType())) {
                part = outputMessage.getAttribute(JMSMessage.ATTR_BYTES_PART);
            } else {
                part = outputMessage.getTextPart();
            }            
            if ((part == null) || (JMSConstants.CHANGE_ME.equals(part))) {
                // per BC developer, will preselect 1st item that is not <NOT SET>
            ...
            mMessageTypePanel.populateView(mWsdlComponent, mPart, outputMessage, 
                    mProject, operationNameComboBox.getSelectedItem().toString());            
        }
    }
...
//                    outputTypeComboBox.setSelectedItem(inputJMSMessage.
//                            getMessageType());
//                    // get input text
//                    outputTextComboBox.setSelectedItem(inputJMSMessage.
//                            getTextPart());
//                }
    ...
    private void validateTextPart() {        
        if (getOutputMessageText() == null) {
             firePropertyChange(
                    ...
                    NbBundle.getMessage(InboundResponseMessagePanel.class,
