...
public class OutboundResponsePublisherStepWizardPanel extends WSDLWizardDescriptorPanel {
     ...
     */
    OutboundResponsePublisherPersistenceController mController = null;
    ...
    public OutboundResponsePublisherStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }
     ...
     */
    private OutboundResponsePublisherPanel mPanel;   
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new OutboundResponsePublisherPanel(mQName, mComponent);
        }

        if (mController == null) {
            mController = new OutboundResponsePublisherPersistenceController(mComponent, mPanel);
        }
    ...
    public String getName() {
        return NbBundle.getMessage(InboundMessageStepWizardPanel.class,
                "OutboundResponsePublisherStepWizardPanel.StepLabel");
    }
