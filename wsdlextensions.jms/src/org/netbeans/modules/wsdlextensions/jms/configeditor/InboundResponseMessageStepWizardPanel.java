...
public class InboundResponseMessageStepWizardPanel extends WSDLWizardDescriptorPanel {
     ...
     */
    InboundResponsePersistenceController mController = null;
    ...
    public InboundResponseMessageStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }
     ...
     */
    private InboundResponseMessagePanel mPanel;
    ...
    public Component getComponent() {
        if (mPanel == null) {
            mPanel = new InboundResponseMessagePanel(mQName, mComponent);
        }
        mPanel.setProject(mProject);
        if (mController == null) {
            mController = new InboundResponsePersistenceController(mComponent, mPanel);
        }
    ...
    public String getName() {
        return NbBundle.getMessage(InboundMessageStepWizardPanel.class,
                "InboundResponseMessageStepWizardPanel.StepLabel");
    }
