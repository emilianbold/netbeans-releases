...
public class OutboundOneWayConnectionStepWizardPanel extends WSDLWizardDescriptorPanel {
     ...
     */
    private OutboundOneWayConnectionPanel mPanel;
    ...
    public OutboundOneWayConnectionStepWizardPanel(WSDLWizardContext context) {
        super(context);
    }    
    ...
    public Component getComponent() {
        if (mPanel == null) {            
            mPanel = new OutboundOneWayConnectionPanel(mQName, mWSDLComponent);
        }
    ...
    public void readSettings(Object settings) {     
       ...
       if ((myContext != null) && (myContext.getWSDLModel() != null)) {
           ...
           mWSDLComponent = JMSUtilities.getJMSAddress(defs);
           if (mWSDLComponent != null) {
               mPortType = JMSUtilities.getPortType((JMSAddress) mWSDLComponent);
           }
       }        
    }
    ...
    public String getName() {
        return NbBundle.getMessage(OutboundOneWayPublisherStepWizardPanel.class,
                "OutboundOneWayConnectionStepWizardPanel.StepLabel");        
    }
