 ...
 */
public interface Method extends Nameable<WadlComponent>, ReferenceableWadlComponent, WadlComponent {
    
    public static String ID_PROPERTY = "id";
    public static String HREF_PROPERTY = "href";
    public static String REQUEST_PROPERTY = "request";
    public static String RESPONSE_PROPERTY = "response";
