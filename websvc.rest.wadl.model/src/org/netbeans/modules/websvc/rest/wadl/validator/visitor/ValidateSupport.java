...
/**
 * Supports validation of BPEL/Wadl documents.
 *
 * @author  Ayub Khan
 */
public class ValidateSupport  {
    ...
    /** Matching Wadl document not found */
    public static final String VAL_MATCHING_WADL_NOT_FOUND = "VAL_MATCHING_WADL_NOT_FOUND";  // Not I18N
    
    /** Please import matching Wadl document */
    public static final String FIX_MATCHING_WADL_NOT_FOUND = "FIX_MATCHING_WADL_NOT_FOUND";  // Not I18N
    ...
    public boolean assertRequiredAttrib(String value, String name, Component source) {
        if (((source instanceof WadlComponent)
                    && !mValConfig.getBooleanProperty(ValidateConfiguration.WADL_SYNTAX_ATTRIB_REQUIRED))) {
            return true;
        }
    ...
    public boolean assertNCNameAttrib(String value, String name, Component source) {
        if (((source instanceof WadlComponent)
                    && !mValConfig.getBooleanProperty(ValidateConfiguration.WADL_SYNTAX_ATTRIB_NCNAME))) {
            return true;
        }
    ...
    public boolean assertQNameListAttrib(String value, String name, Component source, int category) {
        if ((source instanceof WadlComponent)
                    && !mValConfig.getBooleanProperty(ValidateConfiguration.WADL_SYNTAX_ATTRIB_QNAME)) {
            return true;
        }
    ...
    public boolean assertBooleanAttrib(String value, String name, Component source, int category) {
        if ((source instanceof WadlComponent)
                    && !mValConfig.getBooleanProperty(ValidateConfiguration.WADL_SYNTAX_ATTRIB_BOOLEAN)) {
            return true;
        }
    ...
    public boolean assertMinimumElem(int num, int min, String name, Component source, int category) {
        if (((source instanceof WadlComponent)
                    && !mValConfig.getBooleanProperty(ValidateConfiguration.WADL_SYNTAX_ELEM_MIN))) {
            return true;
        }
    ...
    public boolean assertEnumeratedAttrib(String value, String[] enums, String name, Component source,
                                          int category) {
       if (((source instanceof WadlComponent)
                    && !mValConfig.getBooleanProperty(ValidateConfiguration.WADL_SYNTAX_ATTRIB_ENUMERATED))) {
           return true;
       }
    ...
    public boolean assertRequiredElement(Component subElem, String name, Component source, int category) {
        if (((source instanceof WadlComponent)
                    && !mValConfig.getBooleanProperty(ValidateConfiguration.WADL_SYNTAX_ELEM_REQUIRED))) {
            return true;
        }
