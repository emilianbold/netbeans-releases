...
import org.netbeans.modules.websvc.rest.wadl.model.impl.WadlElementFactoryProvider.*;
...
public class ElementFactoryRegistry {
    ...
    private void initialize(){
        ...
        if (factories.size() == 0) {
            register(new ApplicationFactory());
            register(new DocFactory());
            register(new GrammarsFactory());
            register(new ResourcesFactory());
            register(new ResourceFactory());
            register(new MethodFactory());
            register(new RequestFactory());
            register(new ResponseFactory());
            register(new ParamFactory());
            register(new OptionFactory());
            register(new RepresentationFactory());
            register(new LinkFactory());
            register(new IncludeFactory());
            register(new FaultFactory());
        }
    }
