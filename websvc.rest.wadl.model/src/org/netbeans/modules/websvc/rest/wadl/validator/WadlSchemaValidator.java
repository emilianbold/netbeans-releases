...
import org.netbeans.modules.websvc.rest.wadl.validator.spi.ValidatorSchemaFactory;
...
public class WadlSchemaValidator extends XsdBasedValidator {
    
    /*
     * Uses the Wadl schema from https://wadl.dev.java.net/wadl20061109.xsd
     */
    static final String wadlXSDUrl = "/org/netbeans/modules/websvc/rest/wadl/validator/resources/wadl20061109.xsd";
    
    public String getName() {
        return "WadlSchemaValidator"; //NO I18N
    }
    ...
    protected Schema getSchema(Model model) {
        ...
        InputStream wadlSchemaInputStream = WadlSchemaValidator.class.getResourceAsStream(wadlXSDUrl);
        Source wadlSource = new StreamSource(wadlSchemaInputStream);
        wadlSource.setSystemId(WadlSchemaValidator.class.getResource(wadlXSDUrl).toString());
