...
public interface WadlComponent extends DocumentComponent<WadlComponent>, ValidParam {
    public static final String DOC_PROPERTY = "doc"; //NOI18N
    ...
    void accept(WadlVisitor visitor);
    
    void setDoc(Doc doc);
    Doc getDoc();
    
    /**
     * Creates a global reference to the given target Wadl component.
     * @param target the target WadlComponent
     * @param type actual type of the target
     * @return the global reference.
     */
    <T extends ReferenceableWadlComponent> NamedComponentReference<T> createReferenceTo(T target, Class<T> type);
