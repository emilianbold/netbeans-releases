...
public class VolatileAttributeTest extends AbstractParserTestCase {

	final String fileName = "VolatileAttributeTestFile.java";
	...
	final String[][] expectedTokens = { {"VolatileAttributeTestFile",  "Name"} ,{"{",  "Class Body Start"} ,{"volatile",  "Modifier"} ,{"int",  "Primitive Type"} ,{"a",  "Name"} ,{"}",  "Class Body End"}  };
