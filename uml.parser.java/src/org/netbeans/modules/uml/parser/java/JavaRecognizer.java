...
public JavaRecognizer(ParserSharedInputState state) {
  ...
  astFactory = new ASTFactory(getTokenTypeToASTClassMap());
	...
	public final void enumBlock() throws RecognitionException, TokenStreamException {
		...
		_loop104:
		do {
			if ((LA(1)==IDENT||LA(1)==AT) && (_tokenSet_17.member(LA(2)))) {
				enumConstant();
 ...
 */
	...
	public final void unaryExpression() throws RecognitionException, TokenStreamException {
		...
		case MINUS:
		{
			...
			match(MINUS);
			if ( inputState.guessing==0 ) {
				tmp197_AST.setType(UNARY_MINUS);
			}
			unaryExpression();
			astFactory.addASTChild(currentAST, returnAST);
			unaryExpression_AST = (AST)currentAST.root;
 ...
 */
	...
	private static final long[] mk_tokenSet_17() {
		long[] data = { 0L, 618492069888L, 0L, 0L};
		return data;
	}
