  ...
  astFactory = new ASTFactory(getTokenTypeToASTClassMap());
	...
	public final void classDefinition(
		...
		if ( inputState.guessing==0 ) {
			...
			classDefinition_AST = (AST)astFactory.make( (new ASTArray(7)).add(astFactory.create(CLASS_DEF,"CLASS_DEF")).add(modifiers).add(tmp22_AST).add(tp_AST).add(sc_AST).add(ic_AST).add(cb_AST));
	...
	public final void interfaceDefinition(
		...
		if ( inputState.guessing==0 ) {
			...
			interfaceDefinition_AST = (AST)astFactory.make( (new ASTArray(6)).add(astFactory.create(INTERFACE_DEF,"INTERFACE_DEF")).add(modifiers).add(tmp24_AST).add(tp_AST).add(ie_AST).add(ib_AST));
	...
	public final void enumDefinition(
		...
		if ( inputState.guessing==0 ) {
			...
			enumDefinition_AST = (AST)astFactory.make( (new ASTArray(5)).add(astFactory.create(ENUM_DEF,"ENUM_DEF")).add(modifiers).add(tmp26_AST).add(ic_AST).add(eb_AST));
	...
	public final void annotationDefinition(
		...
		if ( inputState.guessing==0 ) {
			...
			annotationDefinition_AST = (AST)astFactory.make( (new ASTArray(4)).add(astFactory.create(ANNOTATION_DEF,"ANNOTATION_DEF")).add(modifiers).add(tmp29_AST).add(ab_AST));
	...
	public final void interfaceField() throws RecognitionException, TokenStreamException {
		...
		case IDENT:
		{
			...
			if ((LA(1)==IDENT) && (LA(2)==LPAREN)) {
				...
				if ( inputState.guessing==0 ) {
					interfaceField_AST = (AST)currentAST.root;
					interfaceField_AST = (AST)astFactory.make( (new ASTArray(7)).add(astFactory.create(METHOD_DEF,"METHOD_DEF")).add(mods_AST).add(tp_AST).add((AST)astFactory.make( (new ASTArray(2)).add(astFactory.create(TYPE,"TYPE")).add(rt_AST))).add(tmp90_AST).add(param_AST).add(tc_AST));
					currentAST.root = interfaceField_AST;
					currentAST.child = interfaceField_AST!=null &&interfaceField_AST.getFirstChild()!=null ?
						interfaceField_AST.getFirstChild() : interfaceField_AST;
					currentAST.advanceChildToEnd();
		...
		case LITERAL_enum:
		{
			...
			case IDENT:
			{
				...
				if ((LA(1)==IDENT) && (LA(2)==LPAREN)) {
					...
					if ( inputState.guessing==0 ) {
						enumConstantField_AST = (AST)currentAST.root;
						enumConstantField_AST = (AST)astFactory.make( (new ASTArray(8)).add(astFactory.create(METHOD_DEF,"METHOD_DEF")).add(mods_AST).add(tp_AST).add((AST)astFactory.make( (new ASTArray(2)).add(astFactory.create(TYPE,"TYPE")).add(rt_AST))).add(tmp106_AST).add(param_AST).add(tc_AST).add(s2_AST));
						currentAST.root = enumConstantField_AST;
						currentAST.child = enumConstantField_AST!=null &&enumConstantField_AST.getFirstChild()!=null ?
							enumConstantField_AST.getFirstChild() : enumConstantField_AST;
						currentAST.advanceChildToEnd();
