...
public class ZventsResponseSchemaTest extends SchemaTestBase {
    ...
    protected String[] getSchemas() {
        return new String[]{"org/netbeans/modules/websvc/saas/services/zvents/resources/ZventsResponse.xsd"}; //NOI18N
    }

    public static TestSuite suite() {
        return createTestSuite(new ZventsResponseSchemaTest());
    }
}
