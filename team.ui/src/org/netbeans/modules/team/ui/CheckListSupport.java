...
class CheckListSupport extends MouseAdapter implements ListSelectionListener, ActionListener {
    ...
    public CheckListSupport(JList list){
        this.list = list;
        list.setCellRenderer(new TeamServerCheckListRenderer(list.getCellRenderer(), sModel));
