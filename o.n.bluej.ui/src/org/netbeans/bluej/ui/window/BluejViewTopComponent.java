...
public final class BluejViewTopComponent extends TopComponent implements ExplorerManager.Provider {
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblProject, org.openide.util.NbBundle.getMessage(BluejViewTopComponent.class, "lblProject.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(btnUp, org.openide.util.NbBundle.getMessage(BluejViewTopComponent.class, "btnUp.label")); // NOI18N
        ...
        pnlToolbarLayout.setHorizontalGroup(
            ...
            .addGroup(pnlToolbarLayout.createSequentialGroup()
                ...
                .addComponent(comProject, 0, 201, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnUp)
                .addContainerGap())
        );
        pnlToolbarLayout.setVerticalGroup(
            ...
            .addGroup(pnlToolbarLayout.createSequentialGroup()
                ...
                .addGroup(pnlToolbarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblProject)
                    .addComponent(btnUp)
                    .addComponent(comProject, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
