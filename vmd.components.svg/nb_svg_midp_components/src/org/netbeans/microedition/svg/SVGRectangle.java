...
public class SVGRectangle {
    ...
    public SVGRectangle( SVGRect rectangle ){
        this( (int)rectangle.getX(), (int)rectangle.getY(),
    ...
    public boolean contains( int x , int y){
        return getX() <= x && getX() +getWidth() >=x 
                && getY() <=y && getY()+getHeight()>=y;
    }
    ...
    public SVGRectangle union ( SVGRectangle rectangle ){
        float x = Math.min( getX(), rectangle.getX());
        float y =Math.min( getY(), rectangle.getY());;
        float width = Math.max( getX()+getWidth(), 
                rectangle.getX()+ rectangle.getWidth()) -x ;
        float height = Math.max( getY()+getHeight(), 
