...
public class DOMFactoryImplTest extends TestCase {

    public DOMFactoryImplTest(String name) {
        super(name);
    }

    public void testOrderOfAttributes() throws Exception { // #127764
        DocumentBuilderFactory dbf = new DOMFactoryImpl();
