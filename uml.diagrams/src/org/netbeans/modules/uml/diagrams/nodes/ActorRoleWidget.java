...
import org.netbeans.modules.uml.diagrams.nodes.usecase.ActorWidget;

public class ActorRoleWidget extends ActorWidget
{
    public ActorRoleWidget(Scene scene)
    {
        super(scene);
    ...
    {
        Lookup l = getLookup();
        ContextPaletteModel actorPaletteModel = l.lookup(ContextPaletteModel.class);
        ...
        ArrayList<ContextPaletteButtonModel> children = actorPaletteModel.getChildren();
        if (children != null) 
        {
        ...
        removeFromLookup(actorPaletteModel);
