 ...
 * @author thuy
 */
public abstract class SimpleNodeWidget extends UMLNodeWidget
{
    ...
    public SimpleNodeWidget(Scene scene)
    {
        // Context palette is on, customizable Default node is off
        this(scene, true, false);
    }

    public SimpleNodeWidget(Scene scene, boolean contextPalette,
    ...
    public SimpleNodeWidget(Scene scene, String contextPaletteRes,
                             boolean useDefaultNodeResource)
    {
        super(scene, useDefaultNodeResource);
