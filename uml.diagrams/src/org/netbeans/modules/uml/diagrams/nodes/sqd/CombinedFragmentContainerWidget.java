...
public class CombinedFragmentContainerWidget extends ContainerWidget {
    ...
    /**
     * used for combined fragment handling
     * @param scene
     * @param mySceneBounds
     * @return
     */
    ...
    protected boolean removeChildrenOutsideBounds(GraphScene scene, 
                                                Rectangle mySceneBounds)
    {
        boolean changed = super.removeChildrenOutsideBounds(scene,mySceneBounds);//should work for usual containment of nodes
        //for combined fragment need to handle messages, and may be check if after main logic any Lifeline is covered to move lifeline to appropriate operand if covered fully by operand
