...
import org.netbeans.modules.uml.diagrams.nodes.ClassRoleWidget;
 ...
 * @author treyspiva
 */
public class ClassRoleNodeFactory implements NodeWidgetFactory
{

    public Widget createNode(Scene scene)
    {
        return new ClassRoleWidget(scene);
    }
}
