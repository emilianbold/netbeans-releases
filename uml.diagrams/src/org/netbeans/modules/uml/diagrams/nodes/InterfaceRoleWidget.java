...
public class InterfaceRoleWidget extends InterfaceWidget
{
    public InterfaceRoleWidget(Scene scene)
    {
        super(scene);
    ...
    protected DefaultContextPaletteModel initializeContextPalette()
    {
        ...
        DefaultContextPaletteModel interfacePaletteModel = new DefaultContextPaletteModel(this);
        interfacePaletteModel.initialize("UML/context-palette/Interface");
        ArrayList<ContextPaletteButtonModel> children = interfacePaletteModel.getChildren();
