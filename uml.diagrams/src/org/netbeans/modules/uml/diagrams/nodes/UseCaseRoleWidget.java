...
public class UseCaseRoleWidget extends UseCaseWidget
{
    public UseCaseRoleWidget(Scene scene)
    {
        super(scene);
    ...
    {
        Lookup l = getLookup();
        ContextPaletteModel usecasePaletteModel = l.lookup(ContextPaletteModel.class);
        ...
        ArrayList<ContextPaletteButtonModel> children = usecasePaletteModel.getChildren();
        if (children != null) 
        {
        ...
        removeFromLookup(usecasePaletteModel);
