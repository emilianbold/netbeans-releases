...
/**
 * Tries to keep contained Lifelines on vertical level related to scene cooridinates
 * @author sp153251
 */
public class CombinedFragmentContainerLayout implements Layout {
    ...
    public void justify(Widget widget) {
        ...
        {
            Point contPoint60=widget.convertSceneToLocal(new Point(0,60));
