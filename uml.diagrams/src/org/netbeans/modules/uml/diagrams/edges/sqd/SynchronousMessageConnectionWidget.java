 ...
 * @author sp153251
 */
public class SynchronousMessageConnectionWidget extends MessageWidget {
    //

    public SynchronousMessageConnectionWidget(Scene scene) {
        super(scene);
        setTargetAnchorShape(AnchorShape.TRIANGLE_FILLED);
        //setControlPointShape(PointShape.SQUARE_FILLED_BIG);
        setEndPointShape(PointShape.SQUARE_FILLED_BIG);
        //addToLookup(new MessageLabelManager(this));
    }
    @Override
    ...
    public String getWidgetID() {
        return UMLWidgetIDString.SYNCHRONOUSMESSAGECONNECTIONWIDGET.toString();
    }
