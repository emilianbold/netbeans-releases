 ...
 * @author treyspiva
 */
public class AssociationClassPaletteModel implements ContextPaletteButtonModel
{
    ...
    public AssociationClassPaletteModel()
    {
        
    }
    
    public AssociationClassPaletteModel(Image  image,
                                  String tooltip)
    {
        setImage(image);
        setTooltip(tooltip);
    ...
    public WidgetAction[] createActions(Scene scene)
    {
        ...
        if(scene instanceof DesignerScene)
        {
            ...
            AssociationClassConnectProvider connector = new AssociationClassConnectProvider(defaultTargetType);
