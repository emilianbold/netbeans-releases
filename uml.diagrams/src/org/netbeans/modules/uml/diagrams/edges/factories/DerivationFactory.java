...
public class DerivationFactory extends AbstractRelationshipFactory
{
    ...
    public IRelationship create(IElement source, IElement target)
    {
        ...
        {
            retVal = factory.createDerivation((IClassifier)source, (IClassifier)target);
        }
    ...
    public void reconnectSource(IElement relationship, IElement source)
    {
           ...
           (source instanceof IClassifier))
        {
            ...
            derivation.setDerivedClassifier((IClassifier)source);
        }
    }
    ...
    public void reconnectTarget(IElement relationship, IElement target)
    {
        ...
        {
            IDerivation derivation = (IDerivation)relationship;
            derivation.setTemplate((IClassifier)target);
        }
    }
