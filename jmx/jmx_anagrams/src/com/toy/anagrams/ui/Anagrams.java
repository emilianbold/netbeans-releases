...
//Management imports
import com.toy.anagrams.agent.JMXAgent;
import com.toy.anagrams.mbeans.*;
...
public class Anagrams extends JFrame {
    ...
    /**
     * JMX initialization. Creates and initializes a JMX Agent.
     * Connect Anagrams UI components to Management.
     */
    private void initManagement() throws Exception {
       ...
       agent.getAnagramsStats().startThinking();
       agent.getAnagramsStats().setCurrentAnagram(WordLibrary.getScrambledWord(wordIdx));
    }
    ...
    private void nextTrialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextTrialActionPerformed
        ...
        try {
            JMXAgent.getDefault().getAnagramsStats().startThinking();
            JMXAgent.getDefault().getAnagramsStats().setCurrentAnagram(WordLibrary.getScrambledWord(wordIdx));
    ...
    private void guessedWordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guessedWordActionPerformed
        if (WordLibrary.isCorrect(wordIdx, guessedWord.getText())){
            ...
            //Update statistics
            try{
                JMXAgent.getDefault().getAnagramsStats().stopThinking();
            }catch(Exception e) {e.printStackTrace();}
