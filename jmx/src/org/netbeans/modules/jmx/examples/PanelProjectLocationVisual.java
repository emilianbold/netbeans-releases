...
public class PanelProjectLocationVisual extends SettingsPanel implements DocumentListener {
    ...
    public PanelProjectLocationVisual(PanelConfigureProject panel) {
        ...
        Mnemonics.setLocalizedText(projectNameLabel, NbBundle.getMessage(PanelProjectLocationVisual.class, "LBL_NWP1_ProjectName_Label")); // NOI18N
        projectNameLabel.setLabelFor(projectNameTextField);
        projectNameTextField.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(PanelProjectLocationVisual.class, "ACS_LBL_NWP1_ProjectName_A11YDesc"));// NOI18N
        
        Mnemonics.setLocalizedText(projectLocationLabel, NbBundle.getMessage(PanelProjectLocationVisual.class, "LBL_NWP1_ProjectLocation_Label"));// NOI18N
        projectLocationLabel.setLabelFor(projectLocationTextField);
        projectLocationTextField.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(PanelProjectLocationVisual.class, "ACS_LBL_NPW1_ProjectLocation_A11YDesc"));// NOI18N

        Mnemonics.setLocalizedText(Button, NbBundle.getMessage(PanelProjectLocationVisual.class, "LBL_NWP1_BrowseLocation_Button"));// NOI18N
        Button.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(PanelProjectLocationVisual.class, "ACS_LBL_NWP1_BrowseLocation_A11YDesc"));// NOI18N
        
        Mnemonics.setLocalizedText(createdFolderLabel, NbBundle.getMessage(PanelProjectLocationVisual.class, "LBL_NWP1_CreatedProjectFolder_Lablel"));// NOI18N
        createdFolderLabel.setLabelFor(createdFolderTextField);
        createdFolderTextField.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(PanelProjectLocationVisual.class, "ACS_LBL_NWP1_CreatedProjectFolder_A11YDesc"));// NOI18N
    ...
    private void initComponents() {
        ...
        projectNameLabel.getAccessibleContext().setAccessibleDescription("");
        ...
        projectLocationLabel.getAccessibleContext().setAccessibleDescription("");
        ...
        createdFolderLabel.getAccessibleContext().setAccessibleDescription("");
