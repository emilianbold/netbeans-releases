...
public class PanelOptionsVisual extends javax.swing.JPanel {
    ...
    public PanelOptionsVisual(PanelConfigureProject panel) {
        initComponents();
        this.panel = panel;
        Mnemonics.setLocalizedText(setAsMainCheckBox,
                                   NbBundle.getMessage(PanelOptionsVisual.class, "LBL_NWP1_SetAsMain_CheckBox"));// NOI18N
        //Accessibility
        setAsMainCheckBox.getAccessibleContext().setAccessibleName(NbBundle.getMessage(PanelOptionsVisual.class,"ACS_LBL_NWP1_SetAsMain_A11Y"));// NOI18N
        setAsMainCheckBox.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(PanelOptionsVisual.class,"ACS_LBL_NWP1_SetAsMain_A11YDesc"));// NOI18N
