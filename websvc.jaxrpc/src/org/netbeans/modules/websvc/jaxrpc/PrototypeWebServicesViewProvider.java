...
import org.netbeans.modules.websvc.jaxrpc.nodes.PrototypeWebServicesView;
...
public class PrototypeWebServicesViewProvider implements WebServicesViewProvider {

    private PrototypeWebServicesView webServicesViewGenerator = new PrototypeWebServicesView();
	
    /** Creates a new instance of PrototypeWebServicesViewProvider */
    public PrototypeWebServicesViewProvider() {
    }
	
    public WebServicesView findWebServicesView(FileObject file) {
        return WebServicesViewFactory.createWebServicesView(webServicesViewGenerator);
    }
