...
public class CustomizerWsCompile extends javax.swing.JPanel implements WsCompileEditorSupport.Panel, HelpCtx.Provider {
    ...
    private void initComponents() {
        ...
        jLblServices.setDisplayedMnemonic(org.openide.util.NbBundle.getMessage(CustomizerWsCompile.class, "LBL_WebServicesMnemonic").charAt(0));
        jLblServices.setLabelFor(jLstServices);
        jLblServices.setText(org.openide.util.NbBundle.getMessage(CustomizerWsCompile.class, "LBL_WebServices"));
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLblPanelDescription, NbBundle.getMessage(CustomizerWsCompile.class, "LBL_PanelDescriptionService"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLblEnabledFeatures, org.openide.util.NbBundle.getMessage(CustomizerWsCompile.class, "LBL_EnabledFeatures"));
