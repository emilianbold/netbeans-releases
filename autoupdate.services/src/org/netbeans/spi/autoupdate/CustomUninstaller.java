...
public interface CustomUninstaller {
     ...
     * @return true if the uninstallation succeed
     * @throws org.netbeans.api.autoupdate.OperationException 
     */
    public boolean uninstall (String codeName, String specificationVersion, ProgressHandle handle) throws OperationException;
