...
public class DependenciesPanel extends javax.swing.JPanel {
    ...
    void setDependencyType(Dependency.Type dependencyType) {
        ...
        moveOptional.setVisible(dependencyType != Dependency.Type.OPTIONAL);
        ...
        switch (dependencyType) {
            ...
            case OPTIONAL: hiddenButtonText = moveOptional.getText(); break;
        }
    ...
    final void updateButtons() {
        ...
        moveOptional.setEnabled(selectedRows > 0);
    ...
    private void initComponents() {
        ...
        moveOptional = new javax.swing.JButton();
        ...
        org.openide.awt.Mnemonics.setLocalizedText(moveOptional, org.openide.util.NbBundle.getMessage(DependenciesPanel.class, "DependenciesPanel.moveOptional.text")); // NOI18N
        moveOptional.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                moveOptionalActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(moveOptional)
                    .addComponent(moveLabel)
                    .addComponent(dummyButton))
                .addContainerGap())
        );

        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {addButton, dummyButton, editButton, moveDevelopment, moveOptional, moveRegular, removeButton, updateButton});
    ...
    private void moveOptionalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_moveOptionalActionPerformed
        moveSelectedDependencies(Dependency.Type.OPTIONAL);
    }//GEN-LAST:event_moveOptionalActionPerformed
    ...
    private javax.swing.JButton moveOptional;
