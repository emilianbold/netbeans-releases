...
//    };
    ...
    public TransportCommand (JGitRepository repository, GitClassFactory gitFactory, String remote, ProgressMonitor monitor) {
...
//        RemoteConfig config = new RemoteConfig(getRepository().getRepository().getConfig(), remote);
...
//        }
//        try {
//            Transport transport = Transport.open(getRepository().getRepository(), uri);
//            RemoteConfig config = getRemoteConfig();
//            if (config != null) {
