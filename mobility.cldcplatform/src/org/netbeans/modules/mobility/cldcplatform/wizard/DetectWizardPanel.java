 ...
 * @author David Kaspar
 */
public class DetectWizardPanel implements WizardDescriptor.FinishablePanel {
    
    ArrayList<ChangeListener> listeners = new ArrayList<ChangeListener>();
    DetectPanel component = new DetectPanel(this);
    ...
    public HelpCtx getHelp() {
        return new HelpCtx("org.netbeans.modules.mobility.cldcplatform.wizard.DetectWizardPanel");
    }
