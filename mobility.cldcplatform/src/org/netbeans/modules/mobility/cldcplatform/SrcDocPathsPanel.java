...
public class SrcDocPathsPanel extends javax.swing.JPanel implements ListSelectionListener {
    ...
    private void initComponents() {
        ...
        setName(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "TITLE_J2MEWizardIterator_PathsPanel"));
        getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "ACN_SrcDocPathsPanel"));
        getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "ACD_SrcDocPathsPanel"));
        jLabel1.setDisplayedMnemonic(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "MNM_SrcDocPathsPanel_Sources").charAt(0));
        jLabel1.setLabelFor(lSrcPaths);
        jLabel1.setText(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "LBL_SDPathsPanel_Sources"));
        ...
        lSrcPaths.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "ACD_SrcDocPathsPanel_Sources"));
        ...
        bSrcAdd.setMnemonic(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "MNM_SrcDocPathsPanel_SrcAdd").charAt(0));
        bSrcAdd.setText(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "LBL_SDPathsPanel_Add"));
        bSrcAdd.setToolTipText(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "TTT_SrcDocPathsPanel_SrcAdd"));
        ...
        bSrcRemove.setMnemonic(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "MNM_SrcDocPathsPanel_SrcRemove").charAt(0));
        bSrcRemove.setText(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "LBL_SDPathsPanel_Remove"));
        bSrcRemove.setToolTipText(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "TTT_SrcDocPathsPanel_SrcRemove"));
        ...
        jLabel2.setDisplayedMnemonic(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "MNM_SrcDocPathsPanel_Javadoc").charAt(0));
        jLabel2.setLabelFor(lDocPaths);
        jLabel2.setText(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "LBL_SDPathsPanel_JavaDocs"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        lDocPaths.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "ACD_SrcDocPathsPanel_Javadoc"));
        ...
        bDocAdd.setMnemonic(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "MNM_SrcDocPathsPanel_JavadocAdd").charAt(0));
        bDocAdd.setText(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "LBL_SDPathsPanel_Add"));
        bDocAdd.setToolTipText(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "TTT_SrcDocPathsPanel_JavadocAdd"));
        ...
        bDocRemove.setMnemonic(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "MNM_SrcDocPathsPanel_JavadocRemove").charAt(0));
        bDocRemove.setText(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "LBL_SDPathsPanel_Remove"));
        bDocRemove.setToolTipText(org.openide.util.NbBundle.getMessage(SrcDocPathsPanel.class, "TTT_SrcDocPathsPanel_JavadocRemove"));
