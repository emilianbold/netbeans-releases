...
/**
 * Implements {@link com.sun.sql.rowset.SyncResolverX}.
 *
 * Based on the Sun reference implementation SyncResolverImpl.
 */
public class SyncResolverXImpl extends CachedRowSetXImpl implements SyncResolverX {
     ...
     * datasource.
     */
    private CachedRowSetXImpl crsSync;
    ...
    /**
     *  This ArrayList will contain the SQLException of a row
     *  it will be null if no exception occurred.
     */
    ...
    public SyncResolverXImpl() {
        crsSync = CachedRowSetXImpl.createInternalUseInstance();
        crsRes = CachedRowSetXImpl.createInternalUseInstance();
        crw = new CachedRowSetXWriter();
        row = CachedRowSetXImpl.createInternalUseInstance();
        rowStatus = 1;
    }
    ...
    /**
     * Retrieves the conflict's SQLExceptions of the current row of this
     * <code>SyncResolver</code>
     */
    public SQLException getSQLException() {
        return (SQLException)exceptions.get(rowStatus-1);
    }
    ...
    public void setResolvedValue(int index, Object obj) throws SQLException {
        ...
        try {
            ...
            if(index<=0 || index > crsSync.getMetaData().getColumnCount() ) {
                throw new SQLException(MessageFormat.format(rb.getString("INDEX_VALUE_OUT_OF_RANGE"), //NOI18N
                        new Object[] { new Integer(index) }));
            }
            // check whether index col is in conflict
            if(crsRes.getObject(index) == null) {
                throw new SQLException(MessageFormat.format(rb.getString("COLUMN_NOT_IN_CONFLICT"), //NOI18N
                        new Object[] { new Integer(index) }));
            }
        } catch (SQLException sqle) {
        ...
        try {
            ...
            if( ((crsSync.getObject(index)).toString()).equals(obj.toString()) ||
                ...
                /**
                 * Step 2: Change the value in the CachedRowSetXImpl object
                ...
                if(bool) {
                    /**
                     * sync data back using CachedRowSetXWriter
                     * construct the present row and pass it to the writer
                     * to write back to db.
                     **/
                    try {
                        /**
                         * Note : The use of CachedRowSetXWriter to get *same* Connection handle.
                         * The CachedRowSetXWriter uses the connection handle
                         * from the reader, Hence will use the same connection handle
                         * as of original CachedRowSetXImpl
                         **/
                         ...
                         **/
                        throw new SQLException(rb.getString("SYNC_NOT_POSSIBLE")); //NOI18N
                    }
                } //end if(bool)
                
            } else {
                throw new SQLException(rb.getString("VALUE_TO_BE_RESOLVED_CAN_BE")); //NOI18N
    ...
    /**
     * This passes a CachedRowSet as a row the the CachedRowSetXWriter
    ...
    private CachedRowSet buildCachedRow() throws SQLException {
        ...
        RowSetMetaDataXImpl rsmdWrite = (RowSetMetaDataXImpl)crsSync.getMetaData();
        ...
        for(int i =1;i<=iColCount;i++) {
            ...
            rsmdRow.setColumnLabel(i,rsmdWrite.getColumnLabel(i)); 
    ...
    /**
     * This is used to set the SQLException of each row
     * an element can be null if no exception occurred
     **/
    ...
    /**
     * Sets this <code>CachedRowSetXImpl</code> object's command property
    ...
    /**
     * Populates this <code>CachedRowSetXImpl</code> object with data from
     ...
     * <code>CachedRowSetXImpl</code> object's command.
     * <P>
     ...
     *             to be read into this <code>CachedRowSetXImpl</code> object
    ...
    /**
     * Populates this <code>CachedRowSetXImpl</code> object with data,
     ...
     * underlying data source backing this <code>CachedRowSetXImpl</code>
     * object.
     * <P>
    ...
    /**
     * Propagates all row update, insert, and delete changes to the
     * data source backing this <code>CachedRowSetXImpl</code> object
    ...
    /**
     * Restores this <code>CachedRowSetXImpl</code> object to its original state,
    ...
    /**
     * Releases the current contents of this <code>CachedRowSetXImpl</code>
     ...
     * <code>CachedRowSetXImpl</code> object if the row has been inserted, and
     ...
     * that of this <code>CachedRowSetXImpl</code> object and sharing a set of cursors
     * with it. This allows cursors to interate over a shared set of rows, providing
     * multiple views of the underlying data.
     *
     * @return a <code>RowSet</code> object that is a copy of this <code>CachedRowSetXImpl</code>
     ...
     * this <code>CachedRowSetXImpl</code> object's data, including
     ...
     *           completely independent from this <code>CachedRowSetXImpl</code>
     *           object.
     * @throws SQLException if an error occurs in generating the copy of this
     *           of the <code>CachedRowSetXImpl</code>
     * @see #createShared
     * @see javax.sql.RowSetEvent
     * @see javax.sql.RowSetListener
     */
     ...
     * this <code>CachedRowSetXImpl</code> object's table structure
     ...
     * of this <code>CachedRowSetXImpl</code> object's schema and
     ...
     * this <code>CachedRowSetXImpl</code> object's data only.
     * All constraints set in this object will not be there
     * in the returning object.  Updates made
     * on a copy are not visible to the original rowset.
     *
     * @return a new <code>CachedRowSet</code> object that is a deep copy
     * of this <code>CachedRowSetXImpl</code> object and is
     * completely independent from this <code>CachedRowSetXImpl</code> object
    ...
    /**
     * Converts this <code>CachedRowSetXImpl</code> object to a collection
    ...
    /**
     * Returns the specified column of this <code>CachedRowSetXImpl</code> object
     ...
     * with this <code>CachedRowSetXImpl</code> implementation rowset.
     *
    ...
    /**
     * Closes this <code>CachedRowSetXImpl</code> objecy and releases any resources
     * it was using.
     *
     * @throws SQLException if an error occurs when releasing any resources in use
     * by this <code>CachedRowSetXImpl</code> object
     */
    public void close() {
        throw new UnsupportedOperationException();
    }
     ...
     * of this <code>CachedRowSetXImpl</code> object as a
    ...
    /**
     * Retrieves the value of the designated column in the current row
     * of this <code>CachedRowSetXImpl</code> object as an
     * <code>int</code> value.
     *
     * @param columnIndex the first column is <code>1</code>, the second
     *        is <code>2</code>, and so on; must be <code>1</code> or larger
     ...
     * <code>CachedRowSetXImpl</code> object as a <code>java.io.InputStream</code>
     * object.
     *
     ...
     * stream may return <code>0</code> for <code>CachedRowSetXImpl.available()</code>
     ...
     * <code>CachedRowSetXImpl.available()</code> whether there is data
     * available or not.
     *
     * @param columnIndex the first column is <code>1</code>, the second
     * is <code>2</code>, and so on; must be <code>1</code> or larger
     ...
     *        a column in this <code>CachedRowSetXImpl</code> object
    ...
    /**
     * Retrieves the value stored in the designated column
     * of the current row of this <code>CachedRowSetXImpl</code> object
    ...
    /**
     * The first warning reported by calls on this <code>CachedRowSetXImpl</code>
     * object is returned. Subsequent <code>CachedRowSetXImpl</code> warnings will
    ...
    /**
     * Clears all the warnings reporeted for the <code>CachedRowSetXImpl</code>
     ...
     *
     * @return the SQL cursor name for this <code>CachedRowSetXImpl</code> object's
     *         cursor
     * @throws SQLException if an error occurs
     */
     ...
     * <code>RowSetMetaDataXImpl</code> class.
     * <P>
     * For example:
     * <pre>
     * CachedRowSet crs = new CachedRowSetXImpl();
     * RowSetMetaDataXImpl metaData =
     *     (RowSetMetaDataXImpl)crs.getMetaData();
     * // Set the number of columns in the RowSet object for
     * // which this RowSetMetaDataXImpl object was created to the
     * // given number.
     ...
     *         <code>CachedRowSetXImpl</code> object's columns
     * @throws SQLException if an error occurs in generating the RowSet
     * meta data; or if the <code>CachedRowSetXImpl</code> is empty.
    ...
    /**
     * Maps the given column name for one of this <code>CachedRowSetXImpl</code>
    ...
    /**
     * Returns the number of rows in this <code>CachedRowSetXImpl</code> object.
     *
    ...
    /**
     * Moves this <code>CachedRowSetXImpl</code> object's cursor to the front of
    ...
    /**
     * Moves this <code>CachedRowSetXImpl</code> object's cursor to the end of
    ...
    /**
     * Moves this <code>CachedRowSetXImpl</code> object's cursor to the first row
    ...
    /**
     * Moves this <code>CachedRowSetXImpl</code> object's cursor to the first
    ...
    /**
     * Moves this <code>CachedRowSetXImpl</code> object's cursor to the last row
     * and returns <code>true</code> if the operation was successful.  This
     * method also notifies registered listeners that the cursor has moved.
     *
     * @return <code>true</code> if the cursor is on a valid row;
    ...
    /**
     * Moves this <code>CachedRowSetXImpl</code> object's cursor to the last
     * row and returns <code>true</code> if the operation is successful.
     * <P>
    ...
    /**
     * Returns the number of the current row in this <code>CachedRowSetXImpl</code>
    ...
    /**
     * Moves this <code>CachedRowSetXImpl</code> object's cursor to the row number
     * specified.
     *
     ...
     * <code>crs</code> is a <code>CachedRowSetXImpl</code> object, moves the cursor
     ...
     * If the <code>CachedRowSetXImpl</code> object <code>crs</code> has five rows,
     ...
     * <code>crs</code> is a <code>CachedRowSetXImpl</code> object with 100 rows,
     ...
     *         <code>CachedRowSetXImpl</code> object; <code>false</code>
     *         otherwise
    ...
    /**
     * Moves this <code>CachedRowSetXImpl</code> object's cursor to the
     ...
     * <code>CachedRowSetXImpl</code> object that its cursor has moved.
     * <P>
     ...
     * the <code>CachedRowSetXImpl</code> object <code>crs</code>, which has
    ...
    /**
     * Moves the cursor to the previous row in this <code>CachedRowSetXImpl</code>
    ...
    /**
     * Indicates whether the current row of this <code>CachedRowSetXImpl</code>
     ...
     * this <code>CachedRowSetXImpl</code> object has been updated. The
     ...
     * insert row of this <code>CachedRowSetXImpl</code> object with
     ...
     * row of this <code>CachedRowSetXImpl</code> object with the given
     * <code>boolean</code> value.
     * <P>
     * This method updates a column value in the current row or the insert
    ...
    /**
     * Inserts the contents of this <code>CachedRowSetXImpl</code> object's insert
    ...
    /**
     * Marks the current row of this <code>CachedRowSetXImpl</code> object as
    ...
    /**
     * Deletes the current row from this <code>CachedRowSetXImpl</code> object and
     ...
     * <code>CachedRowSetXImpl</code> object and notifies listeners that
    ...
    /**
     * Moves the cursor for this <code>CachedRowSetXImpl</code> object
     ...
     * undetermined.
     *
     * @throws SQLException if this <code>CachedRowSetXImpl</code> object is
     *            <code>ResultSet.CONCUR_READ_ONLY</code>
     */
    ...
    /**
     * Moves the cursor for this <code>CachedRowSetXImpl</code> object to
     ...
     * <code>CachedRowSetXImpl</code> object as an <code>Object</code> in
    ...
    /**
     * Retrieves the value of the designated column in this
     * <code>CachedRowSetXImpl</code> object as a <code>Ref</code> object
    ...
    /**
     * Retrieves the value of the designated column in this
     * <code>CachedRowSetXImpl</code> object as a <code>Blob</code> object
     * in the Java programming language.
     *
     * @param columnIndex the first column is <code>1</code>, the second
     *        is <code>2</code>, and so on; must be <code>1</code> or larger
    ...
    /**
     * Retrieves the value of the designated column in this
     * <code>CachedRowSetXImpl</code> object as a <code>Clob</code> object
     * in the Java programming language.
     *
     * @param columnIndex the first column is <code>1</code>, the second
     *        is <code>2</code>, and so on; must be <code>1</code> or larger
    ...
    /**
     * Retrieves the value of the designated column in this
     * <code>CachedRowSetXImpl</code> object as an <code>Array</code> object
     * in the Java programming language.
     *
     * @param columnIndex the first column is <code>1</code>, the second
     *        is <code>2</code>, and so on; must be <code>1</code> or larger
    ...
    /**
     * Retrieves the value of the designated column in the current row
     * of this <code>CachedRowSetXImpl</code> object as a <code>java.sql.Date</code>
    ...
    /**
     * Retrieves the value of the designated column in the current row
     * of this <code>CachedRowSetXImpl</code> object as a <code>java.sql.Time</code>
     * object, using the given <code>Calendar</code> object to construct an
     * appropriate millisecond value for the date.
     *
     * @param columnIndex the first column is <code>1</code>, the second
    ...
    /**
     * Retrieves the value of the designated column in the current row
     * of this <code>CachedRowSetXImpl</code> object as a <code>java.sql.Timestamp</code>
     * object, using the given <code>Calendar</code> object to construct an
     * appropriate millisecond value for the date.
     *
     * @param columnIndex the first column is <code>1</code>, the second
    ...
    /**
     * Sets the metadata for this <code>CachedRowSetXImpl</code> object
     ...
     * original value is the state of the <code>CachedRowSetXImpl</code> after the
     ...
     * row only.
     * The original value is the state of the <code>CachedRowSetXImpl</code> after
     ...
     *         which this <code>CachedRowSetXImpl</code> object was derived
     * @throws SQLException if an error occurs
     */
     ...
     * 		table from which this <code>CachedRowSetXImpl</code> object
     * 		was derived
     * @throws SQLException if an error occurs
     */
     ...
     * row in this <code>CachedRowSetXImpl</code> object.
     *
    ...
    /**
     * Sets this <code>CachedRowSetXImpl</code> object's
     ...
     *        <code>CachedRowSetXImpl</code> object; every
    ...
    /**
     * Retrieves the value of the designated column in this
     * <code>CachedRowSetXImpl</code> object as a <code>java.net.URL</code> object
     * in the Java programming language.
     *
     ...
     * as was set.
     *
     * @param columnIdxes the columnIndexes to unset
     * @throws SQLException if an error occurs or the
    ...
    /**
     * The nextPage gets the next page, that is a <code>CachedRowSetXImpl</code> object
