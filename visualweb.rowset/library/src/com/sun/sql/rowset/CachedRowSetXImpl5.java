...
public abstract class CachedRowSetXImpl5 extends BaseRowSetX implements CachedRowSetX, RowSetInternal, Serializable, Cloneable {
     ...
     public CachedRowSet createCopyNoConstraints() throws SQLException {
         ...
         CachedRowSetXImpl5 crs;
         crs = (CachedRowSetXImpl5)this.createCopy();
     ...
     public Collection toCollection(int column) throws SQLException {
         ...
         // create a copy
         CachedRowSetXImpl5 crsTemp;
         crsTemp = (CachedRowSetXImpl5) this.createCopy();
