...
public class SNMPValidatorSchemaFactory extends ValidatorSchemaFactory{
    ...
    public String getNamespaceURI() {
        return "http://schemas.sun.com/jbi/wsdl-extensions/snmp/";
    }
    
    public InputStream getSchemaInputStream() {
        InputStream is = SNMPValidatorSchemaFactory.class.getResourceAsStream(snmpXSDUrl);
        return is;
    }
    ...
    public Source getSchemaSource() {
        InputStream in = SNMPValidatorSchemaFactory.class.getResourceAsStream(snmpXSDUrl);
        Source s = new StreamSource(in);
        s.setSystemId(SNMPValidatorSchemaFactory.class.getResource(snmpXSDUrl).toString());
        return s;
    }
}
