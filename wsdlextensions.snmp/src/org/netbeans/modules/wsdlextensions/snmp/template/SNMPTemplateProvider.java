...
package org.netbeans.modules.wsdlextensions.snmp.template;
...
public class SNMPTemplateProvider extends ExtensibilityElementTemplateProvider {
    ...
    public InputStream getTemplateInputStream() {
        return SNMPTemplateProvider.class.getResourceAsStream(snmpTemplateUrl);
    }

    public String getLocalizedMessage(String str, Object[] objects) {
        return NbBundle.getMessage(SNMPTemplateProvider.class, str, objects);
    }
}
