...
public class SelectionTreeBuilderFactoryImpl extends SelectionTreeBuilderFactoryProvider {
    ...
    @Override
    public List<SelectionTreeBuilder> buildersForProject(Provider project) {
        return new ArrayList<SelectionTreeBuilder>(project.getLookup().lookupAll(SelectionTreeBuilder.class));
    }
}
