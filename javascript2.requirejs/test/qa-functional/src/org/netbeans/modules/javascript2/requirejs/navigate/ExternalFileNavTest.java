 ...
 */
public class ExternalFileNavTest extends GeneralRequire {

    public ExternalFileNavTest(String arg0) {
        super(arg0);
    }

    public static Test suite() {
        return NbModuleSuite.create(
                NbModuleSuite.createConfiguration(ExternalFileNavTest.class).addTest(
                        "openProject",
                        "testNavigateFromDep",
                        "testNavigateFromPar"
    ...
    public void openProject() throws Exception {
        startTest();
        ExternalFileNavTest.currentProject = "SimpleRequire";
        JemmyProperties.setCurrentTimeout("ActionProducer.MaxActionTime", 180000);
        openDataProjects("SimpleRequire");
        openFile("js|app|mytest.js", "SimpleRequire");
        endTest();
    }

    public void testNavigateFromDep() throws Exception {
        startTest();
        navigate("mytest.js", "external.js", 6, 14, 1, 1);
        endTest();
    }

    public void testNavigateFromPar() throws Exception {
        startTest();
        navigate("mytest.js", "external.js", 6, 53, 1, 1);
        endTest();
    }
