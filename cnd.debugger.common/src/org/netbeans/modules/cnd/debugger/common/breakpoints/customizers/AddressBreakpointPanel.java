...
//
public class AddressBreakpointPanel extends JPanel implements Controller, ControllerProvider {
    ...
    private void initComponents() {
        ...
        lAddress.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/cnd/debugger/common/breakpoints/customizers/Bundle").getString("MN_L_AddressBreakpoint").charAt(0));
