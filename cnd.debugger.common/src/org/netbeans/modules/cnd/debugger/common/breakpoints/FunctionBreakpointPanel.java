...
//                ("CTL_Function_Breakpoint_Print_Text")); // NOI18N
     ...
     * Creates new form FunctionBreakpointPanel
     */
    public FunctionBreakpointPanel(CndBreakpoint b) {
//        breakpoint = b;
        initComponents();

//        tfFunctionName.setText(b.getFunctionName());
        tfFunctionName.setText(""); // NOI18N
    ...
    private void initComponents() {
        ...
        lFunctionName.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/cnd/debugger/common/breakpoints/Bundle").getString("MN_L_Function_Breakpoint_Function_Name").charAt(0));
