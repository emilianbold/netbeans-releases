 ...
 */
public final class CndBreakpointEvent extends EventObject {
    ...
    /**
     * Creates a new instance of CndBreakpointEvent. This method should be
     * called from cnd debugger modules only. Do not create a new instances
     * of this class!
     * 
    ...
    /**
     * Creates a new instance of CndBreakpointEvent.
     * 
     * @param sourceBreakpoint a breakpoint
    ...
    /**
     * Returns CndDebugger instance this breakpoint has been reached in.
     * 
     ...
     * You should not call CndDebugger.resume() during breakpoint event
     * evaluation!
     */
    public void resume() {
        resume = true;
