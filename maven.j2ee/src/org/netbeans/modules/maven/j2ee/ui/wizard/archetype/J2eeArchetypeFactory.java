...
public final class J2eeArchetypeFactory {
    ...
    private static class AppClientArchetypes extends BaseJ2eeArchetypeProvider {
        ...
        protected void setUpProjectArchetypes() {
            addMojoArchetype(Profile.JAVA_EE_7_FULL, "0.3-SNAPSHOT", "appclient-javaee7"); //NOI18N
    ...
    private static class EarArchetypes extends BaseJ2eeArchetypeProvider {
        @Override
        protected void setUpProjectArchetypes() {
            addMojoArchetype(Profile.JAVA_EE_7_FULL, "0.3-SNAPSHOT", "ear-javaee7"); //NOI18N
    ...
    private static class EjbArchetypes extends BaseJ2eeArchetypeProvider {
        @Override
        protected void setUpProjectArchetypes() {
            addMojoArchetype(Profile.JAVA_EE_7_FULL, "0.3-SNAPSHOT", "ejb-javaee7"); //NOI18N
    ...
    private static class WebArchetypes extends BaseJ2eeArchetypeProvider {
        @Override
        protected void setUpProjectArchetypes() {
            addMojoArchetype(Profile.JAVA_EE_7_WEB, "0.3-SNAPSHOT", "webapp-javaee7"); //NOI18N
            ...
            addMojoArchetype(Profile.JAVA_EE_7_FULL, "0.3-SNAPSHOT", "webapp-javaee7"); //NOI18N
