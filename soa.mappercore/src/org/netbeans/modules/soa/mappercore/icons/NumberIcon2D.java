 ...
 * @author anjeleevich
 */
public class NumberIcon2D implements Icon2D {
    
    private double radius;
    private Color color;
    
    
    public NumberIcon2D(Color color, double radius) {
        this.radius = radius;
        this.color = color;
    }
    ...
    static {
        ...
        Area area = new Area(font.createGlyphVector(new FontRenderContext(null, true, true), 
                "#").getOutline());
