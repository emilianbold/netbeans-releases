...
hfds base,keepBlocking,modal,nameCounter,resizable,serialVersionUID,showAppContext,title,undecorated
hcls WakingRunnable
...
hfds OPENED,alwaysOnTop,base,beforeFirstShow,dbg,focusMgr,focusableWindowState,inputContext,inputContextLock,locationByPlatform,locationByPlatformProp,modalExcluded,nameCounter,ownedWindowList,serialVersionUID,showWithParent,state,syncLWRequests,systemSyncLWRequests,temporaryLostComponent,warningString,weakThis,windowFocusListener,windowListener,windowSerializedDataVersion,windowStateListener
...
hfds defaultCloseOperation,defaultLookAndFeelDecoratedKey
...
supr java.lang.Object
hfds LOCK,LOG_GET_ARRAY,PR,array,entries,initThread,map,parent
hcls Dupl,Empty,Entry,Info
...
cons public IndexedPropertySupport({org.openide.nodes.IndexedPropertySupport%0},java.lang.Class<{org.openide.nodes.IndexedPropertySupport%0}>,java.lang.Class<{org.openide.nodes.IndexedPropertySupport%1}>,java.lang.reflect.Method,java.lang.reflect.Method,java.lang.reflect.Method,java.lang.reflect.Method)
fld protected {org.openide.nodes.IndexedPropertySupport%0} instance
...
hfds add,delta,from,indices,serialVersionUID
...
meth public java.lang.String toString()
supr org.openide.nodes.NodeEvent
hfds newIndices,serialVersionUID
