...
public abstract class Children extends Object {
    ...
    */
    ...
    final void setEntries(Collection entries) {
        ...
        if (holder == null) {
            ...
            if (map != null) {
                map.keySet().retainAll(new HashSet(entries));
            }
    ...
    */
    private List refreshOrder(Entry entry, Collection oldNodes, Collection newNodes) {
        ...
        int[] perm = NodeOp.computePermutation((Node[]) oldNodes.toArray(new Node[oldNodes.size()]), permArray);
    ...
    */
    private static class Dupl implements Cloneable {
        ...
        */
        public final void updateList(java.util.Collection src, java.util.Collection target) {
        ...
        * a Dupl for the object is created to encapsulate it.
        */
        public final void updateList(Object[] arr, java.util.Collection target) {
        ...
        */
        public final void updateListAndMap(Object obj, java.util.Collection list, java.util.Map map) {
