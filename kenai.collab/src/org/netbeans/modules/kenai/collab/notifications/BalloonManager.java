 ...
 * TODO: copy/paste from AU. Should be apified
 * @author S. Aubrecht
 */
public class BalloonManager {
    ...
    private static class Balloon extends JPanel {
        ...
        public Balloon( final JComponent content, final Action defaultAction, final int timeoutMillis ) {
            ...
            add( content, new GridBagConstraints(0,0,1,1,1.0,1.0,GridBagConstraints.NORTH,GridBagConstraints.BOTH,new Insets(10,15,0,0),0,0));
