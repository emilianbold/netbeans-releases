...
/** Used to call "Remove" popup menu item or
 * "org.netbeans.modules.j2ee.deployment.impl.ui.actions.RemoveInstanceAction".
 * @see Action
 * @author Martin.Schovanek@sun.com */
public class RemoveInstanceAction extends Action {

    private static final String popupPath = Bundle.getStringTrimmed(
            "org.netbeans.modules.j2ee.deployment.impl.ui.actions.Bundle",
            "LBL_Remove");

    /** creates new RemoveInstanceAction instance */
    public RemoveInstanceAction() {
        super(null, popupPath, "org.netbeans.modules.j2ee.deployment.impl.ui" +
                ".actions.RemoveInstanceAction");
    }
}
