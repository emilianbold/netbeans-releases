...
//out("Vadlidate model: " + model);
            ...
            private void checkExpressions(BpelEntity entity) {
                ...
                List<String> list = Expression.getUsedVariables(expression);
                ...
                String key = set.size() > 1 ? "FIX_Variables" : "FIX_Variable"; // NOI18N
...
//out();
//out("  refer: " + reference.getClass().getName() + " code: " + reference.hashCode() + " [Broken]: " + reference.isBroken() + " " + reference.get());
//out();
