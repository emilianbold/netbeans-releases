...
public abstract class CMPaintComponent {
    
}

//public abstract class CMPaintComponent extends JPanel {
//            
//    CMPaintComponent.DrawState drawState = new CMPaintComponent.DrawState();
//    
...
//   // private String text;
//    
//    private ArrayList<CMPaintComponent.PostfixString> postfixes;
//    
...
//    public CMPaintComponent(){
//        super(layout, true);        
//        setBorder(BORDER);
//        postfixes = new ArrayList<CMPaintComponent.PostfixString>();        
//    }
//    
...
//            while(iter.hasNext()) {
//                ((CMPaintComponent.PostfixString) iter.next()).Draw(g);
//                if(iter.hasNext()) {
//                    drawString(g, ",  ", postfixColor); // NOI18N
//                }
//            } 
...
//        postfixes.add(new CMPaintComponent.PostfixString(text, c, font));
//    }
//    
...
//    }
//      
//    CMPaintComponent.DrawState getDrawState() {
//        return drawState;
//    }
//    
//    void setDrawState(CMPaintComponent.DrawState drawState) {
...
//            this(text, LFCustoms.shiftColor(CMPaintComponent.POSTFIX_COLOR), fontStyle);
//        }
//        
//        void Draw(Graphics g) {            
//            CMPaintComponent.this.drawString(g, text, c, new Font(getDrawFont().getName(), 
...
//    }
//    
//    public static class NamespacePaintComponent extends CMPaintComponent{
//
...
//    }
//    
//    public static class NamespaceAliasPaintComponent extends CMPaintComponent{
//
...
//    }
//
//    public static class EnumPaintComponent extends CMPaintComponent {
//        
...
//    }
//    
//    public static class EnumeratorPaintComponent extends CMPaintComponent {
//        
...
//    }
//    
//    public static class ClassPaintComponent extends CMPaintComponent{
//        
...
//
//    
//    public static class TypedefPaintComponent extends CMPaintComponent{
//        
...
//    }
//
//    public static class StructPaintComponent extends CMPaintComponent.ClassPaintComponent{
//        
...
//    }
//    
//    public static class UnionPaintComponent extends CMPaintComponent.ClassPaintComponent{
//        
...
//    }
//    
//    public static class FieldPaintComponent extends CMPaintComponent{
...
//    }
//    
//    public static class LocalVariablePaintComponent extends CMPaintComponent.FieldPaintComponent {
...
//    }
//    
//    public static class FileLocalVariablePaintComponent extends CMPaintComponent.FieldPaintComponent {
...
//    }
//    
//    public static class GlobalVariablePaintComponent extends CMPaintComponent.FieldPaintComponent {
//        private Color VARIABLE_COLOR = LFCustoms.shiftColor(new Color(64,64,255));
//        
...
//    }
//    
//    public static class MacroPaintComponent extends CMPaintComponent{
...
//    }
//    
//    public static class TemplateParameterPaintComponent extends CMPaintComponent{
...
//    }
//
//    public static class LabelPaintComponent extends  CMPaintComponent {
...
//    }
//    
//    public static class ConstructorPaintComponent extends CMPaintComponent{
//        
...
//    }
//    
//    public static class MethodPaintComponent extends CMPaintComponent.ConstructorPaintComponent {
//        
...
//    }
//
//    public static class FileLocalFunctionPaintComponent extends CMPaintComponent.MethodPaintComponent {
...
//    }
//    
//    public static class GlobalFunctionPaintComponent extends CMPaintComponent.MethodPaintComponent {
//        private Color FUN_COLOR = LFCustoms.getTextFgColor();
//        
...
//    }
//    
//    public static class CMPaintComponentWrapper extends CMPaintComponent {    
//        private CMPaintComponent comp;
//        private boolean drawTypeAsPrefix = true;
//        
//        public CMPaintComponentWrapper() {
//            super();        
//        }
//        
//        public void setCsmComponent(CMPaintComponent comp) {           
//            this.comp = comp;
//        }
//
//        @Override
...
//            if (comp != null) {
//                if (drawTypeAsPrefix) {
//                    if (comp instanceof CMPaintComponent.FieldPaintComponent) {
//                        ((CMPaintComponent.FieldPaintComponent)comp).setDrawTypeAsPrefix(true);
//                    } else if (comp instanceof CMPaintComponent.MethodPaintComponent) {
//                        ((CMPaintComponent.MethodPaintComponent)comp).setDrawTypeAsPrefix(true);
//                    }                
//                }
//                comp.draw(g);          
//                if (drawTypeAsPrefix) {
//                    if (comp instanceof CMPaintComponent.FieldPaintComponent) {
//                        ((CMPaintComponent.FieldPaintComponent)comp).setDrawTypeAsPrefix(false);
//                    } else if (comp instanceof CMPaintComponent.MethodPaintComponent) {
//                        ((CMPaintComponent.MethodPaintComponent)comp).setDrawTypeAsPrefix(false);
//                    }                
//                }
...
//    } 
//    
//    public static class StringPaintComponent extends CMPaintComponent {
//
//        private String str;
//
