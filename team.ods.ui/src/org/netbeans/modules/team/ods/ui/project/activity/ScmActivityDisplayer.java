...
public class ScmActivityDisplayer extends ActivityDisplayer {
    ...
    public Icon getActivityIcon() {
        return ImageUtilities.loadImageIcon("org/netbeans/modules/team/ods/ui/resources/activity_commit.png", true); //NOI18N
    }

    private String getCommitUrl() {
        String url = scmUrl.replaceFirst("/s/", "/#projects/"); //NOI18N
