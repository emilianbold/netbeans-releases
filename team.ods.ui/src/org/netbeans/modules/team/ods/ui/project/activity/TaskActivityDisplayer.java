...
public class TaskActivityDisplayer extends ActivityDisplayer {
    ...
    public Icon getActivityIcon() {
        ...
        ImageIcon icon = ImageUtilities.loadImageIcon("org/netbeans/modules/team/ods/ui/resources/activity_task_" + iconSuffix + ".png", true); //NOI18N
        if (icon == null) {
            icon = ImageUtilities.loadImageIcon("org/netbeans/modules/team/ods/ui/resources/activity_task.png", true); //NOI18N
        }
        return icon;
    }
