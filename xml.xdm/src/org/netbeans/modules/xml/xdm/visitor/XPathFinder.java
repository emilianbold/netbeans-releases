...
public class XPathFinder extends ChildVisitor {
    ...
    private static int xpathIndexOf(Node parentNode, Element child) {
        ...
        Element parent = (Element) ((parentNode instanceof Document) ?
            ((Document)parentNode).getDocumentElement() : parentNode);
        ...
        for (int i = 0; i<children.getLength(); i++) {
            ...
            String prefix = n.getPrefix();
            if (prefix != null && ! prefix.equals(child.getPrefix())) {
                continue;
            }
    ...
    private Element toElement(org.w3c.dom.Node n) {
    ...
    private void init(Document root, String xpath) {
        initTokens(xpath);
        toElement(root.getDocumentElement()).accept(this);
    }
    ...
    private static class XPathSegment {
        ...
        public boolean checkTypeAndName(Node e, Element parent) {
