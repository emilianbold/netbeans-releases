...
public class NodeByPositionVisitorTest extends TestCase{
    ...
    public void testFindPosition(){
        ...
        System.out.println("foundCompany: " + findCompany);        
        ...
        this.assertEquals("Found first employee by position",firstEmployee, 
				findFirstEmployee);
        System.out.println("found First Employee: " + findFirstEmployee);
        ...
        System.out.println("find first Employee Again: " + findFirstEmployeeAgain);
        ...
        System.out.println("found Second Employee: " + findSecondEmployee);
        ...
        System.out.println("find Second Employee Again: " + findSecondEmployeeAgain);		
    }
