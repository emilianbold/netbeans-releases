...
package org.netbeans.modules.groovy.ejbproject;
...
public class EjbGroovyActionProvider implements ActionProvider {
    ...
    public void invokeAction(final String command, final Lookup context) throws IllegalArgumentException {
            ...
            public void run () {
                ...
                try {
                    ...
                    if (buildFo == null || !buildFo.isValid()) {
                        ...
                        NotifyDescriptor nd = new NotifyDescriptor.Message(NbBundle.getMessage(EjbGroovyActionProvider.class,
        ...
        if (supportedActions.containsKey(command)) {
            ScanDialog.runWhenScanFinished(action, NbBundle.getMessage (EjbGroovyActionProvider.class,"ACTION_"+command));   //NOI18N
        } else {
            action.run();
        }
    }
