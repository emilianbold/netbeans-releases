 ...
 * @author Filip Zamboj
 */
public class DebuggingActionsTestSuite extends JellyTestCase {

    public DebuggingActionsTestSuite(String name) {
        super(name);
    }
...
//        } else {
        return NbModuleSuite.create(NbModuleSuite.emptyConfiguration().addTest(DebuggingActionsTest.class,
                "testStartDebugging",
                "testContinue",
