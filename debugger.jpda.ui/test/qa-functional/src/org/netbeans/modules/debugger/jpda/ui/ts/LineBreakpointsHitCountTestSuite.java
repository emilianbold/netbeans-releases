 ...
 */
public class LineBreakpointsHitCountTestSuite extends JellyTestCase {

    public LineBreakpointsHitCountTestSuite(String name) {
        super(name);
    }
...
//        } else {
            return NbModuleSuite.create(NbModuleSuite.emptyConfiguration()
                .addTest(LineBreakpointsHitCountTest.class,
