...
public class JaxWsRootNode extends AbstractNode {
    ...
    public JaxWsRootNode(Project project, WebServiceData wsData) {
        super(new JaxWsRootChildren(wsData), Lookups.fixed(project, new WsPrivilegedTemplates()));
